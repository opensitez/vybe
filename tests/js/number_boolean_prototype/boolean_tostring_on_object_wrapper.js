// vybe-test: js/number_boolean_prototype/boolean_tostring_on_object_wrapper
...
__p(__line(Object.prototype.toString.call(new Boolean(true))));
__checkLater("[object Boolean]");
