// vybe-test: js/private_brand_errors/private_static_field_outside_class_throws
...
class C{static #s=1; static read(o){return o.#s;}} try{__p(__line(C.read({})));}catch(e){__p(__line(e instanceof TypeError));}
__checkLater("true");
