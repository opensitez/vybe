// vybe-test: js/private_brand_errors/private_getter_outside_class_throws
...
class C{get #v(){return 1;} static read(o){return o.#v;}} try{__p(__line(C.read({})));}catch(e){__p(__line(e instanceof TypeError));}
__checkLater("true");
