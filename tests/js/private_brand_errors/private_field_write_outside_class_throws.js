// vybe-test: js/private_brand_errors/private_field_write_outside_class_throws
...
class C{#x=1;static write(o){o.#x=2;}} try{C.write({});}catch(e){__p(__line(e instanceof TypeError));}
__checkLater("true");
