// vybe-test: js/private_brand_errors/private_method_call_outside_class_throws
...
class C{#m(){return 1;} static call(o){return o.#m();}} try{__p(__line(C.call({})));}catch(e){__p(__line(e instanceof TypeError));}
__checkLater("true");
