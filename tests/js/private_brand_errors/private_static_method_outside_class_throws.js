// vybe-test: js/private_brand_errors/private_static_method_outside_class_throws
...
class C{static #m(){return 1;} static call(o){return o.#m();}} try{__p(__line(C.call({})));}catch(e){__p(__line(e instanceof TypeError));}
__checkLater("true");
