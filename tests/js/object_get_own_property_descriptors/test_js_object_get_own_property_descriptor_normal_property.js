// vybe-test: js/object_get_own_property_descriptors/test_js_object_get_own_property_descriptor_normal_property
...
__p(__line(desc.value + "|" + desc.writable + "|" + desc.enumerable + "|" + desc.configurable));
__checkLater("10|true|true|true");
