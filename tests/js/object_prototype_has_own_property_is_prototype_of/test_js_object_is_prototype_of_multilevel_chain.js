// vybe-test: js/object_prototype_has_own_property_is_prototype_of/test_js_object_is_prototype_of_multilevel_chain
...
__p(__line(grandParent.isPrototypeOf(child)));
__p(__line(parent.isPrototypeOf(child)));
__p(__line(Object.prototype.isPrototypeOf(child)));
__checkLater("true\ntrue\ntrue");
