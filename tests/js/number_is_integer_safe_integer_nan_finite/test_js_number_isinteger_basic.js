// vybe-test: js/number_is_integer_safe_integer_nan_finite/test_js_number_isinteger_basic
...
__p(__line(`${Number.isInteger(10)}:${Number.isInteger(10.5)}:${Number.isInteger("10")}:${Number.isInteger(NaN)}`));
__checkLater("true:false:false:false");
