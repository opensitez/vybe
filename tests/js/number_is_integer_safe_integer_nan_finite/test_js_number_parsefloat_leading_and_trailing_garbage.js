// vybe-test: js/number_is_integer_safe_integer_nan_finite/test_js_number_parsefloat_leading_and_trailing_garbage
...
__p(__line(`${Number.parseFloat("  123.456xyz")}:${Number.parseFloat("abc123")}`));
__checkLater("123.456:NaN");
