...
__p(__line(`${Number.isSafeInteger(maxSafe)}:${Number.isSafeInteger(maxSafe + 1)}:${Number.isSafeInteger(-maxSafe)}:${Number.isSafeInteger(-maxSafe - 1)}`));
__checkLater("true:false:true:false");
