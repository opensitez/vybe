// vybe-test: js/number_is_integer_safe_integer_nan_finite/test_js_number_parseint_parsefloat_on_number_object
...
__p(__line(`${Number.parseInt("42px")}:${Number.parseFloat("3.14159")}`));
__checkLater("42:3.14159");
