...
__p(__line([1, 2, 3].some(x => x > 2)));
        __p(__line([1, 2, 3].some(x => x > 10)));
        __p(__line([2, 4, 6].every(x => x % 2 === 0)));
        __p(__line([2, 3, 6].every(x => x % 2 === 0)));
        __p(__line([].some(x => true)));
        __p(__line([].every(x => false)));
__checkLater("true\nfalse\ntrue\nfalse\nfalse\ntrue");
