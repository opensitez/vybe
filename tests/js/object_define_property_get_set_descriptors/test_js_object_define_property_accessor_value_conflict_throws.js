// vybe-test: js/object_define_property_get_set_descriptors/test_js_object_define_property_accessor_value_conflict_throws
...
try {
    ...
    __p(__line("Conflict: " + e.name));
}
__checkLater("Conflict: TypeError");
