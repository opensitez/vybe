// vybe-test: js/atomics_is_lock_free_buffer_size/test_js_atomics_is_lock_free_property_descriptor
...
__p(__line(`${desc.writable}:${desc.enumerable}:${desc.configurable}:${Atomics.isLockFree.length}`));
__checkLater("true:false:true:1");
