// vybe-test: js/atomics_is_lock_free_buffer_size/test_js_atomics_is_lock_free_symbol_throws_typeerror
...
try {
    ...
    __p(__line("isLockFree Symbol TypeError"));
}
__checkLater("isLockFree Symbol TypeError");
