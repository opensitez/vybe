// vybe-test: js/reflect_ownkeys_has_deleteproperty/test_js_reflect_ownkeys_function_object
...
__p(__line(keys.includes("length") + "|" + keys.includes("name") + "|" + keys.includes("prototype")));
