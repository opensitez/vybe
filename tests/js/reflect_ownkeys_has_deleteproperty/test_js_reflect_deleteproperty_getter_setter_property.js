// vybe-test: js/reflect_ownkeys_has_deleteproperty/test_js_reflect_deleteproperty_getter_setter_property
...
__p(__line(res + "|hasAccessor=" + ("accessor" in obj)));
__checkLater("true|hasAccessor=false");
