// vybe-test: js/reflect_ownkeys_has_deleteproperty/test_js_reflect_deleteproperty_symbol_property
...
__p(__line(res + "|hasSym=" + (sym in obj)));
__checkLater("true|hasSym=false");
