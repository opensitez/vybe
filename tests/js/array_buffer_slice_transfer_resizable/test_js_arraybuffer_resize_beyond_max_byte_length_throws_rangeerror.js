// vybe-test: js/array_buffer_slice_transfer_resizable/test_js_arraybuffer_resize_beyond_max_byte_length_throws_rangeerror
...
try {
    ...
    __p(__line("Resize Exceeds MaxByteLength RangeError"));
}
__checkLater("Resize Exceeds MaxByteLength RangeError");
