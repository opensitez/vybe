// vybe-test: js/array_buffer_slice_transfer_resizable/test_js_arraybuffer_transfer_to_smaller_size
...
__p(__line(transferred.byteLength + "|oldDetached=" + buf.detached));
__checkLater("8|oldDetached=true");
