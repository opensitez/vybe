// vybe-test: js/array_buffer_slice_transfer_resizable/test_js_arraybuffer_transfertofixedlength_es2024
...
__p(__line(fixed.resizable + "|" + fixed.byteLength));
__checkLater("false|8");
