// vybe-test: js/function_metadata_constructor/getter_name_includes_get_prefix
...
__p(__line(Object.getOwnPropertyDescriptor(obj, "size").get.name));
__checkLater("get size");
