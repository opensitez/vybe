// vybe-test: js/class_inheritance_deep/instanceof_checks_entire_prototype_chain
...
class C extends B {}
const c = new C();
__p(__line(c instanceof C));
__p(__line(c instanceof B));
__p(__line(c instanceof A));
__p(__line(c instanceof Object));
__checkLater("true\ntrue\ntrue\ntrue");
