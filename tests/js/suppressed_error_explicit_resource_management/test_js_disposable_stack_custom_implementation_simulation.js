// vybe-test: js/suppressed_error_explicit_resource_management/test_js_disposable_stack_custom_implementation_simulation
...
stack.dispose();
__p(__line(log.join(","))); // Disposed in LIFO order!
__checkLater("R2,R1");
