// vybe-test: js/suppressed_error_explicit_resource_management/test_js_suppressed_error_prototype_name
...
__p(__line(SuppressedError.prototype.name));
__checkLater("SuppressedError");
