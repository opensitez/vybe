...
__p(__line(d.getUTCFullYear()));
__p(__line(d.getUTCMonth())); // 2 (March, 0-indexed)
__p(__line(d.getUTCDate()));
__p(__line(d.getUTCHours()));
__p(__line(d.getUTCMinutes()));
__p(__line(d.getUTCSeconds()));
__p(__line(d.getUTCMilliseconds()));
__checkLater("2024\n2\n15\n10\n30\n45\n500");
