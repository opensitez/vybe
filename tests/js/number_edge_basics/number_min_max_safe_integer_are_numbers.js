// vybe-test: js/number_edge_basics/number_min_max_safe_integer_are_numbers
...
__p(__line(Number.MIN_SAFE_INTEGER));
__p(__line(Number.MAX_SAFE_INTEGER));
__p(__line(Number.MIN_SAFE_INTEGER + 2));
__checkLater("-9007199254740991\n9007199254740991\n-9007199254740989");
