...
__p(__line(Number.isInteger(10)));
__p(__line(Number.isInteger(10.1)));
__p(__line(Number.isSafeInteger(9007199254740991)));
__p(__line(Number.isSafeInteger(9007199254740992)));
__checkLater("true\nfalse\ntrue\nfalse");
