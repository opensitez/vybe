// vybe-test: js/string_is_well_formed_to_well_formed/test_js_string_to_well_formed_property_descriptor
...
__p(__line(`${desc.writable}:${desc.enumerable}:${desc.configurable}:${String.prototype.toWellFormed.length}`));
__checkLater("true:false:true:0");
