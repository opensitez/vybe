// vybe-test: js/string_is_well_formed_to_well_formed/test_js_string_to_well_formed_name_property
...
__p(__line(String.prototype.toWellFormed.name));
__checkLater("toWellFormed");
