// vybe-test: js/labeled_statements_break_continue_control_flow/test_js_continue_non_loop_label_throws_syntaxerror
...
try {
    ...
    __p(__line("Continue Non-Loop Label SyntaxError"));
}
__checkLater("Continue Non-Loop Label SyntaxError");
