// vybe-test: js/dataview_endian_access/dataview_float64_negative_zero
...
const v=new DataView(new ArrayBuffer(8)); v.setFloat64(0,-0,true); __p(__line(1/v.getFloat64(0,true)<0));
__checkLater("true");
