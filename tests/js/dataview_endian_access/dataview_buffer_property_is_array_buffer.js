// vybe-test: js/dataview_endian_access/dataview_buffer_property_is_array_buffer
...
const buf=new ArrayBuffer(4); const v=new DataView(buf); __p(__line(v.buffer===buf));
__checkLater("true");
