// vybe-test: js/async_await_error_recovery/async_try_nested_catch_different_errors
...
async function main(){try{try{await Promise.reject(new TypeError("t"));}catch(e){if(e instanceof TypeError)throw new RangeError("r");}}catch(e){__p(__line(e.name));}}main();
__checkLater("RangeError");
