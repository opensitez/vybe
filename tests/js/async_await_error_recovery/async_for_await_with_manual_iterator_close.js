...
async function main(){const o=[];async function* g(){try{yield 1;throw "x";}finally{o.push("cl");}}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,cl,e:x");
