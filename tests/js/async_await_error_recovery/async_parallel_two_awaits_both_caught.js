...
async function main(){const o=[];const a=(async()=>{try{await Promise.reject("1");}catch(e){o.push(e);}})();const b=(async()=>{try{await Promise.reject("2");}catch(e){o.push(e);}})();await Promise.all([a,b]);__p(__line(o.sort().join(",")));}main();
__checkLater("1,2");
