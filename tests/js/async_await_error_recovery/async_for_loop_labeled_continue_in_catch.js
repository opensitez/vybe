// vybe-test: js/async_await_error_recovery/async_for_loop_labeled_continue_in_catch
...
async function main(){const o=[];outer:for(let i=0;i<3;i++){try{await Promise.reject(i);}catch(e){o.push("c"+e);continue outer;o.push("skip");}}__p(__line(o.join(",")));}main();
__checkLater("c0,c1,c2");
