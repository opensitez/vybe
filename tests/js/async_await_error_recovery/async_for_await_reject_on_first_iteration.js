// vybe-test: js/async_await_error_recovery/async_for_await_reject_on_first_iteration
...
async function main(){const o=[];async function* g(){throw "first";yield 1;}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("e:first");
