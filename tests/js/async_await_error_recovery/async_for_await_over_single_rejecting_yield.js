...
async function main(){const o=[];async function* g(){yield Promise.reject("only");}try{for await(const v of g())o.push(await v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("e:only");
