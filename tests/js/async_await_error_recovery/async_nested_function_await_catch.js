// vybe-test: js/async_await_error_recovery/async_nested_function_await_catch
...
async function main(){async function inner(){try{await Promise.reject("in");}catch(e){return e;}}__p(__line(await inner()));}main();
__checkLater("in");
