...
async function main(){const o=[];async function* g(){yield 1;yield 2;}for await(const v of g()){try{if(v===2)throw "v2";o.push(v);}catch(e){o.push("e:"+e);}}__p(__line(o.join(",")));}main();
__checkLater("1,e:v2");
