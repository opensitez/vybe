...
async function main(){const o=[];async function* inner(){yield 1;throw "d";}async function* outer(){yield* inner();}try{for await(const v of outer())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,e:d");
