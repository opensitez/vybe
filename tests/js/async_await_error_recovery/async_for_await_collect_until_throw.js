...
async function main(){const o=[];async function* gen(){yield 1;yield 2;throw "stop";yield 3;}try{for await(const v of gen())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,2,e:stop");
