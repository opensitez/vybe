// vybe-test: js/async_await_error_recovery/async_nested_loops_inner_catch
...
async function main(){const o=[];for(let i=0;i<2;i++){for(let j=0;j<2;j++){try{await Promise.reject(i+""+j);}catch(e){o.push(e);}}}__p(__line(o.join(",")));}main();
__checkLater("00,01,10,11");
