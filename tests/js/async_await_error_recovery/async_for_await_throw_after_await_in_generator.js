// vybe-test: js/async_await_error_recovery/async_for_await_throw_after_await_in_generator
...
async function main(){const o=[];async function* g(){const x=await Promise.resolve(1);yield x;throw "after:"+x;}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,e:after:1");
