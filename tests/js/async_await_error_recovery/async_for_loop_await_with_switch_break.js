...
async function main(){const o=[];for(let i=0;i<3;i++){switch(i){case 0:try{await Promise.reject("s");}catch(e){o.push(e);}break;case 1:o.push("m");break;}}__p(__line(o.join(",")));}main();
__checkLater("s,m");
