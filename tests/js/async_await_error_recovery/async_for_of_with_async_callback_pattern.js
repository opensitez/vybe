...
async function main(){const o=[];const items=[1,2];for(const x of items){const v=await(async()=>{try{return await Promise.resolve(x*2);}catch{return -1;}})();o.push(v);}__p(__line(o.join(",")));}main();
__checkLater("2,4");
