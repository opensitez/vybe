// vybe-test: js/async_await_error_recovery/async_for_await_sync_throw_in_generator
...
async function main(){const o=[];async function* g(){yield 1;(()=>{throw "sync";})();}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,e:sync");
