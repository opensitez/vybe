// vybe-test: js/async_await_error_recovery/async_await_reject_in_try_after_resolve
...
async function main(){try{const a=await Promise.resolve(1);const b=await Promise.reject("after:"+a);__p(__line(b));}catch(e){__p(__line(e));}}main();
__checkLater("after:1");
