...
async function main(){const o=[];async function* a(){yield 1;}async function* b(){throw "b";}for(const gen of[a(),b()]){try{for await(const v of gen)o.push(v);}catch(e){o.push("e:"+e);}}__p(__line(o.join(",")));}main();
__checkLater("1,e:b");
