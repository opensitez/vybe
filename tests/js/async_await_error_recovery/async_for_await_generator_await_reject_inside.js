...
async function main(){const o=[];async function* g(){yield 1;yield await Promise.reject("inner");}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
