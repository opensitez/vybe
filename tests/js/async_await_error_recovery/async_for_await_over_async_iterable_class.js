...
async function main(){const o=[];class It{async*[Symbol.asyncIterator](){yield 1;throw "cls";}}try{for await(const v of new It())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,e:cls");
