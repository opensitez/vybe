...
async function main(){const ps=[Promise.resolve(1),Promise.reject("b"),Promise.resolve(3)];const o=[];for(const p of ps){try{o.push(await p);}catch(e){o.push("e:"+e);}}__p(__line(o.join(",")));}main();
__checkLater("1,e:b,3");
