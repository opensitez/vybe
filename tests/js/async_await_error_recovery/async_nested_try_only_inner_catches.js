// vybe-test: js/async_await_error_recovery/async_nested_try_only_inner_catches
...
async function main(){try{try{await Promise.reject("in");}catch(e){__p(__line("inner:"+e));}}catch{__p(__line("outer"));}}main();
__checkLater("inner:in");
