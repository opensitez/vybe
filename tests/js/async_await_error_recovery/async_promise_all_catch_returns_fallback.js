// vybe-test: js/async_await_error_recovery/async_promise_all_catch_returns_fallback
...
async function main() { const res = await Promise.all([Promise.resolve(1), Promise.reject("err")]).catch(() => "fallback"); __p(__line(res)); } main();
__checkLater("fallback");
