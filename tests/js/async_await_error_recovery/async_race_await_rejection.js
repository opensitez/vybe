// vybe-test: js/async_await_error_recovery/async_race_await_rejection
...
async function main(){try{await Promise.race([Promise.reject("fast"),new Promise(()=>{})]);}catch(e){__p(__line(e));}}main();
__checkLater("fast");
