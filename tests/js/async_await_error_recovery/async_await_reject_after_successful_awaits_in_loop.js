...
async function main(){const o=[];for(let i=0;i<3;i++){try{o.push(await Promise.resolve(i));if(i===2)await Promise.reject("done");}catch(e){o.push("e:"+e);}}__p(__line(o.join(",")));}main();
__checkLater("0,1,2,e:done");
