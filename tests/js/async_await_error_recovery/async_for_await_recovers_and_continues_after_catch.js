// vybe-test: js/async_await_error_recovery/async_for_await_recovers_and_continues_after_catch
...
async function main(){const o=[];async function* g(){yield 1;yield Promise.reject("mid").catch(()=>"fixed");yield 3;}for await(const v of g())o.push(await v);__p(__line(o.join(",")));}main();
__checkLater("1,fixed,3");
