// vybe-test: js/async_await_error_recovery/async_for_await_with_spread_values
...
async function main(){const o=[];async function* g(){yield...[1,2];throw "s";}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,2,e:s");
