...
async function main(){const o=[];async function* g(){yield 1;yield 2;yield 3;}for await(const v of g()){try{if(v===2)throw "stop";o.push(v);}catch{break;}}__p(__line(o.join(",")));}main();
__checkLater("1");
