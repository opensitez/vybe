// vybe-test: js/async_await_error_recovery/async_for_await_async_iterable_reject
...
async function main(){const o=[];const it={async*[Symbol.asyncIterator](){yield 1;throw "iter";}};try{for await(const v of it)o.push(v);}catch(e){o.push("c:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,c:iter");
