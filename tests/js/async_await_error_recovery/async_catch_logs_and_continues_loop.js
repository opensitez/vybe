// vybe-test: js/async_await_error_recovery/async_catch_logs_and_continues_loop
...
async function main(){const o=[];for(let i=0;i<3;i++){try{await Promise.reject(i);}catch(e){o.push("e"+e);continue;}o.push("ok");}__p(__line(o.join(",")));}main();
__checkLater("e0,e1,e2");
