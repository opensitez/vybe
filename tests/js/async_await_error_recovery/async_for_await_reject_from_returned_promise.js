...
async function main(){const o=[];async function* g(){yield Promise.resolve(1);yield Promise.reject("rp");}try{for await(const v of g())o.push(await v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,e:rp");
