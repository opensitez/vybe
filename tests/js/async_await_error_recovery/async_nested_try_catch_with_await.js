// vybe-test: js/async_await_error_recovery/async_nested_try_catch_with_await
...
async function main(){try{try{await Promise.reject("a");}catch(e){throw "b:"+e;}}catch(e){__p(__line(e));}}main();
__checkLater("b:a");
