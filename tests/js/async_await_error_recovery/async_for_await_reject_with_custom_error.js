...
async function main(){const o=[];class E extends Error{}async function* g(){yield 1;throw new E("custom");}try{for await(const v of g())o.push(v);}catch(e){o.push(e instanceof E?"e:custom":"other");}__p(__line(o.join(",")));}main();
__checkLater("1,e:custom");
