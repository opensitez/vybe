...
async function main(){const o=[];for(const k of [1,2]){switch(k){case 1:try{await Promise.reject("s");}catch(e){o.push(e);}break;case 2:o.push("ok");}}__p(__line(o.join(",")));}main();
__checkLater("s,ok");
