// vybe-test: js/async_await_error_recovery/async_await_in_catch_block
...
async function main(){try{throw "sync";}catch(e){const v=await Promise.resolve("async:"+e);__p(__line(v));}}main();
__checkLater("async:sync");
