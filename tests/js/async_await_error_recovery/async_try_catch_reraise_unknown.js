// vybe-test: js/async_await_error_recovery/async_try_catch_reraise_unknown
...
async function main(){try{try{await Promise.reject(new TypeError("t"));}catch(e){if(e instanceof RangeError)throw e;throw "filtered";}}catch(e){__p(__line(e));}}main();
__checkLater("filtered");
