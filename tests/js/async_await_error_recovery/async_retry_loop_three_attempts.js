// vybe-test: js/async_await_error_recovery/async_retry_loop_three_attempts
...
async function main(){let n=0,o=[];for(let i=0;i<3;i++){try{if(++n<3)await Promise.reject("try"+n);else o.push("ok");}catch(e){o.push(e);}}__p(__line(o.join(",")));}main();
__checkLater("try1,try2,ok");
