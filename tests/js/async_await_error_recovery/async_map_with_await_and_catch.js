// vybe-test: js/async_await_error_recovery/async_map_with_await_and_catch
...
async function main(){const xs=[1,2,3];const o=[];for(const x of xs){try{await Promise.reject(x);}catch(e){o.push(e*10);}}__p(__line(o.join(",")));}main();
__checkLater("10,20,30");
