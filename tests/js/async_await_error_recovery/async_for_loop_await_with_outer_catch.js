// vybe-test: js/async_await_error_recovery/async_for_loop_await_with_outer_catch
...
async function main(){const o=[];try{for(let i=0;i<2;i++){await Promise.reject(i);}}catch(e){o.push("outer:"+e);}__p(__line(o.join(",")));}main();
__checkLater("outer:0");
