// vybe-test: js/async_await_error_recovery/async_for_await_over_rejecting_promise_directly
...
async function main(){const o=[];try{for await(const v of Promise.reject("direct"))o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("e:direct");
