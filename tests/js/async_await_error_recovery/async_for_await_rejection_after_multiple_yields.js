// vybe-test: js/async_await_error_recovery/async_for_await_rejection_after_multiple_yields
...
async function main(){const o=[];async function* g(){yield 1;yield 2;yield 3;throw "end";}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,2,3,e:end");
