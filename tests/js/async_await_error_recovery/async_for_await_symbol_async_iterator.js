...
async function main(){const o=[];const it={[Symbol.asyncIterator]:async function*(){yield 5;throw "sym";}};try{for await(const v of it)o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("5,e:sym");
