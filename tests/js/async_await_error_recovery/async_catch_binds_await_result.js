// vybe-test: js/async_await_error_recovery/async_catch_binds_await_result
...
async function main(){try{throw "s";}catch(e){__p(__line(await Promise.resolve("c:"+e)));}}main();
__checkLater("c:s");
