...
async function main(){const o=[];async function* g(){yield await Promise.resolve(1);throw "g";}try{for await(const v of g())o.push(v);}catch(e){o.push("e:"+e);}__p(__line(o.join(",")));}main();
__checkLater("1,e:g");
