// vybe-test: js/async_await_error_recovery/async_catch_on_awaited_async_throw
...
async function main(){try{await(async function(){throw new SyntaxError("s");})();}catch(e){__p(__line(e.name));}}main();
__checkLater("SyntaxError");
