// vybe-test: js/function_declaration_hoisting_in_blocks/test_js_function_declaration_overwrites_var_declaration
...
__p(__line(typeof test)); // Function declaration is hoisted first, then var initialization 'test = "varVal"' assigns string!
__checkLater("string");
