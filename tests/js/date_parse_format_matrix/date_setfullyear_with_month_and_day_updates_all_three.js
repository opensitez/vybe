// vybe-test: js/date_parse_format_matrix/date_setfullyear_with_month_and_day_updates_all_three
...
__p(__line(d.getFullYear()));
__p(__line(d.getMonth()));
__p(__line(d.getDate()));
__checkLater("2025\n5\n15");
