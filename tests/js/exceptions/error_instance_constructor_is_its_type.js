// vybe-test: js/exceptions/error_instance_constructor_is_its_type
...
__p(__line(new TypeError("x").constructor === TypeError));
__p(__line(new Error("x").constructor === Error));
__checkLater("true\ntrue");
