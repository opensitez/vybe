...
__p(__line(Int8Array.BYTES_PER_ELEMENT));
__p(__line(Int16Array.BYTES_PER_ELEMENT));
__p(__line(Int32Array.BYTES_PER_ELEMENT));
__p(__line(Float64Array.BYTES_PER_ELEMENT));
__checkLater("1\n2\n4\n8");
