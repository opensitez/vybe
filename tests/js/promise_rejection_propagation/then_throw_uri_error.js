// vybe-test: js/promise_rejection_propagation/then_throw_uri_error
...
Promise.resolve(0).then(()=>{throw new URIError("uri");}).catch(e=>__p(__line(e.name)));
__checkLater("URIError");
