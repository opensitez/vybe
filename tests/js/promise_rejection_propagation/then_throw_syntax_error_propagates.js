// vybe-test: js/promise_rejection_propagation/then_throw_syntax_error_propagates
...
Promise.resolve(0).then(()=>{throw new SyntaxError("parse");}).catch(e=>__p(__line(e.name)));
