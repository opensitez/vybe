// vybe-test: js/promise_rejection_propagation/thenable_sync_throw_before_executor_returns
...
Promise.resolve({then(){throw "syncThen";}}).catch(e=>__p(__line(e)));
__checkLater("syncThen");
