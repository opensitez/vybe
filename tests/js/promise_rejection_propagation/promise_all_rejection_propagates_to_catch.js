// vybe-test: js/promise_rejection_propagation/promise_all_rejection_propagates_to_catch
...
Promise.all([Promise.resolve(1),Promise.reject("all")]).catch(e=>__p(__line(e)));
__checkLater("all");
