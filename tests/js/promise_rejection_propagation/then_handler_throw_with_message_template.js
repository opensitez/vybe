// vybe-test: js/promise_rejection_propagation/then_handler_throw_with_message_template
...
Promise.resolve("world").then(w=>{throw new Error(`hello ${w}`);}).catch(e=>__p(__line(e.message)));
