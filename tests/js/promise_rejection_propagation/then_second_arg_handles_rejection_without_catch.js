// vybe-test: js/promise_rejection_propagation/then_second_arg_handles_rejection_without_catch
...
Promise.reject("no").then(v=>__p(__line("ful:"+v)),e=>__p(__line("rej:"+e)));
__checkLater("rej:no");
