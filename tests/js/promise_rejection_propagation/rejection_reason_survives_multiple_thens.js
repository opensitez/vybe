// vybe-test: js/promise_rejection_propagation/rejection_reason_survives_multiple_thens
...
Promise.reject("persist").then(null,e=>e+"!").then(v=>__p(__line(v)));
__checkLater("persist!");
