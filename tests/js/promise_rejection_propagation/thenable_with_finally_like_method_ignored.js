// vybe-test: js/promise_rejection_propagation/thenable_with_finally_like_method_ignored
...
Promise.resolve({then(res){res(4);},finally(){throw "no";}}).then(v=>__p(__line(v)));
__checkLater("4");
