// vybe-test: js/promise_rejection_propagation/chain_alternating_resolve_reject_with_catch
...
Promise.resolve(1).then(()=>Promise.reject("r")).catch(e=>e+"!").then(v=>__p(__line(v)));
__checkLater("r!");
