// vybe-test: js/promise_rejection_propagation/multiple_sequential_catches_on_same_promise_branch
...
Promise.reject("a").catch(e=>"b:"+e).then(v=>{throw v;}).catch(e=>__p(__line(e)));
__checkLater("b:a");
