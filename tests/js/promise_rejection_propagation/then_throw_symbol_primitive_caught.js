// vybe-test: js/promise_rejection_propagation/then_throw_symbol_primitive_caught
...
const s = Symbol("err_sym"); Promise.resolve().then(() => { throw s; }).catch(e => __p(__line(e === s)));
__checkLater("true");
