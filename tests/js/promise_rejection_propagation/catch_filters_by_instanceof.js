// vybe-test: js/promise_rejection_propagation/catch_filters_by_instanceof
...
Promise.reject(new TypeError("t")).catch(e=>e instanceof TypeError?"typed":"other").then(v=>__p(__line(v)));
__checkLater("typed");
