// vybe-test: js/promise_rejection_propagation/then_throw_after_catch_recovery_restarts_chain
...
Promise.reject("a").catch(()=>"ok").then(v=>{throw v+"!";}).catch(e=>__p(__line(e)));
__checkLater("ok!");
