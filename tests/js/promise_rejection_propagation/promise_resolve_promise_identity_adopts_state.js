// vybe-test: js/promise_rejection_propagation/promise_resolve_promise_identity_adopts_state
...
Promise.resolve(Promise.reject("adopted")).catch(e=>__p(__line(e)));
__checkLater("adopted");
