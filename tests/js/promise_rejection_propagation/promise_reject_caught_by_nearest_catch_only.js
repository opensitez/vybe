// vybe-test: js/promise_rejection_propagation/promise_reject_caught_by_nearest_catch_only
...
const o=[];Promise.reject(1).catch(e=>o.push("n:"+e)).then(()=>o.push("between")).catch(e=>o.push("far:"+e)).then(()=>__p(__line(o.join(","))));
__checkLater("n:1,between");
