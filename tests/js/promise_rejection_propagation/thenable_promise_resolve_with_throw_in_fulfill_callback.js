// vybe-test: js/promise_rejection_propagation/thenable_promise_resolve_with_throw_in_fulfill_callback
...
new Promise(res=>res(1)).then(()=>{throw "cb";}).catch(e=>__p(__line(e)));
__checkLater("cb");
