// vybe-test: js/promise_rejection_propagation/promise_race_rejection_reaches_catch
...
Promise.race([new Promise((_,r)=>setTimeout(()=>r("slow"),50)),Promise.reject("fast")]).catch(e=>__p(__line(e)));
__checkLater("fast");
