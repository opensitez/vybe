// vybe-test: js/promise_rejection_propagation/then_catch_preserves_custom_error_name
...
class NamedErr extends Error{constructor(m,n){super(m);this.name=n;}}Promise.resolve(0).then(()=>{throw new NamedErr("d","AbortError");}).catch(e=>__p(__line(e.name)));
__checkLater("AbortError");
