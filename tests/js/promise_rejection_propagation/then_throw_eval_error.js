// vybe-test: js/promise_rejection_propagation/then_throw_eval_error
...
Promise.resolve(0).then(()=>{throw new EvalError("eval");}).catch(e=>__p(__line(e.name)));
__checkLater("EvalError");
