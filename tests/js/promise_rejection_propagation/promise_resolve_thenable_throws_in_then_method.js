// vybe-test: js/promise_rejection_propagation/promise_resolve_thenable_throws_in_then_method
...
Promise.resolve({then(){throw new Error("thenThrow");}}).catch(e=>__p(__line(e.message)));
__checkLater("thenThrow");
