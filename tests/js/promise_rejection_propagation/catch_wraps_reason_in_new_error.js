// vybe-test: js/promise_rejection_propagation/catch_wraps_reason_in_new_error
...
Promise.reject("raw").catch(e=>{throw new Error("wrap:"+e);}).catch(e=>__p(__line(e.message)));
__checkLater("wrap:raw");
