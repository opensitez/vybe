// vybe-test: js/promise_rejection_propagation/promise_resolve_thenable_rejects_then_catch_recovers
...
Promise.resolve({then(_,rej){rej("fromThenable");}}).catch(e=>"caught:"+e).then(v=>__p(__line(v)));
__checkLater("caught:fromThenable");
