// vybe-test: js/promise_rejection_propagation/chain_catch_at_beginning_not_possible_use_then_second
...
Promise.reject("x").then(null,e=>"handled").then(v=>__p(__line(v)));
__checkLater("handled");
