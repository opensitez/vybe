// vybe-test: js/promise_rejection_propagation/rejection_from_awaited_promise_in_then
...
Promise.resolve(0).then(async()=>{throw "asyncThrow";}).catch(e=>__p(__line(e)));
__checkLater("asyncThrow");
