// vybe-test: js/generator_return_throw_next_state_machine/test_js_generator_return_without_yield
...
__p(__line(JSON.stringify(gen().next())));
__checkLater("{\"value\":\"DirectReturn\",\"done\":true}");
