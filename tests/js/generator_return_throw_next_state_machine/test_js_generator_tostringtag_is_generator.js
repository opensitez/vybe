// vybe-test: js/generator_return_throw_next_state_machine/test_js_generator_tostringtag_is_generator
...
function* gen() {}
__p(__line(gen()[Symbol.toStringTag]));
__checkLater("Generator");
