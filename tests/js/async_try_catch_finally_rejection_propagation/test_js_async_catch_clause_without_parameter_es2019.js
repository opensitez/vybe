// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_catch_clause_without_parameter_es2019
...
async function optionalCatch() {
    try {
        ...
        __p(__line("Caught Without Parameter"));
    }
}
optionalCatch();
__checkLater("Caught Without Parameter");
