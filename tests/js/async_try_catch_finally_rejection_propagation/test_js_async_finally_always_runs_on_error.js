// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_finally_always_runs_on_error
...
async function run() {
    try {
        ...
        __p(__line("Error Handled"));
    } finally {
        __p(__line("Cleanup Always"));
    }
}
run();
__checkLater("Error Handled\nCleanup Always");
