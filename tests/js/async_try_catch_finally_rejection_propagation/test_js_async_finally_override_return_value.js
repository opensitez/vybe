// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_finally_override_return_value
...
testOverride().then(res => __p(__line(res)));
__checkLater("FinallyVal");
