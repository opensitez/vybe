// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_try_catch_aggregate_error_handling
...
async function processAll() {
    try {
        ...
        __p(__line(e.name + "|Count=" + e.errors.length));
    }
}
processAll();
__checkLater("AggregateError|Count=2");
