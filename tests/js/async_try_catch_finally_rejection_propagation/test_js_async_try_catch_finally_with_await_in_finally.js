// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_try_catch_finally_with_await_in_finally
...
awaitInFinally().then(res => __p(__line("Returned: " + res)));
__checkLater("AsyncCleanupDone\nReturned: Data");
