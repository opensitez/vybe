// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_try_catch_rejection_of_thenable_object
...
async function catchThenable() {
    try {
        ...
        __p(__line("Caught Thenable: " + e));
    }
}
catchThenable();
__checkLater("Caught Thenable: ThenableFail");
