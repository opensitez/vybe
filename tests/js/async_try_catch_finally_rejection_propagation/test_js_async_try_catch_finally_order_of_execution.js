// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_try_catch_finally_order_of_execution
...
checkOrder().then(res => __p(__line(res)));
__checkLater("Try->Catch->Finally");
