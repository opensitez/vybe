// vybe-test: js/async_try_catch_finally_rejection_propagation/test_js_async_try_catch_finally_await_in_catch
...
awaitInCatch().then(res => __p(__line(res)));
__checkLater("InitialFail->AsyncRecovery");
