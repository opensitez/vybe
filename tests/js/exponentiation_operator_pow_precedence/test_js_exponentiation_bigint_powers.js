// vybe-test: js/exponentiation_operator_pow_precedence/test_js_exponentiation_bigint_powers
...
__p(__line((2n ** 100n).toString()));
__checkLater("1267650600228229401496703205376");
