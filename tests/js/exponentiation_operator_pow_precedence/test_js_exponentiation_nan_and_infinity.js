// vybe-test: js/exponentiation_operator_pow_precedence/test_js_exponentiation_nan_and_infinity
...
__p(__line(`${NaN ** 2}:${2 ** NaN}:${Infinity ** 0}:${1 ** Infinity}`));
__checkLater("NaN:NaN:1:NaN");
