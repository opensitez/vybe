// vybe-test: js/exponentiation_operator_pow_precedence/test_js_exponentiation_zero_and_negative_zero_sign_preservation
...
__p(__line(`${0 ** -1}:${(-0) ** -1}:${(-0) ** -2}:${Object.is((-0) ** 3, -0)}:${Object.is((-0) ** 2, 0)}`));
__checkLater("Infinity:-Infinity:Infinity:true:true");
