// vybe-test: js/function_prototype_metadata/function_to_string_contains_parameter_list
...
function pair(a, b) {} __p(__line(Function.prototype.toString.call(pair).includes("pair")));
__checkLater("true");
