// vybe-test: js/function_prototype_metadata/bound_function_name_reflects_target_name
...
function target() {} const b = target.bind(null); __p(__line(b.name.includes("target")));
__checkLater("true");
