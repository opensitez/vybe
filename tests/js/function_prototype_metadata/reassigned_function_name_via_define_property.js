// vybe-test: js/function_prototype_metadata/reassigned_function_name_via_define_property
...
function f() {} Object.defineProperty(f, "name", { value: "renamed" }); __p(__line(f.name));
__checkLater("renamed");
