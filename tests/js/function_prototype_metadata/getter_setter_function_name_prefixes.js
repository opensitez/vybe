...
const obj = { get prop() {}, set prop(v) {} }; const desc = Object.getOwnPropertyDescriptor(obj, "prop"); __p(__line(desc.get.name + "|" + desc.set.name));
__checkLater("get prop|set prop");
