// vybe-test: js/function_prototype_metadata/call_does_not_change_function_name
...
function labeled() {} labeled.call(null); __p(__line(labeled.name));
__checkLater("labeled");
