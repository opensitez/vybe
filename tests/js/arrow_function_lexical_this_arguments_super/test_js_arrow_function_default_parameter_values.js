// vybe-test: js/arrow_function_lexical_this_arguments_super/test_js_arrow_function_default_parameter_values
...
__p(__line(greet() + "|" + greet("Alice")));
__checkLater("Hello Guest|Hello Alice");
