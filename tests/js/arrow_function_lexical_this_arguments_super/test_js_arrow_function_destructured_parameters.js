// vybe-test: js/arrow_function_lexical_this_arguments_super/test_js_arrow_function_destructured_parameters
...
__p(__line(getFullName({ first: "John", last: "Doe" })));
__checkLater("John Doe");
