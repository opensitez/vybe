// vybe-test: js/string_processing_deep/levenshtein_distance
...
__p(__line(levenshtein("kitten", "sitting")));
__p(__line(levenshtein("", "hello")));
__p(__line(levenshtein("abc", "abc")));
__checkLater("3\n5\n0");
