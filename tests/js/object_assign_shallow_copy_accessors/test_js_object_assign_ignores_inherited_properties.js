// vybe-test: js/object_assign_shallow_copy_accessors/test_js_object_assign_ignores_inherited_properties
...
__p(__line(`${target.own}:${"inherited" in target}`));
__checkLater("ownVal:false");
