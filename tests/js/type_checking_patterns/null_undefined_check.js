...
__p(__line(isNullOrUndefined(null)));
__p(__line(isNullOrUndefined(undefined)));
__p(__line(isNullOrUndefined(0)));
__p(__line(isNullOrUndefined("")));
__p(__line(isNullOrUndefined(false)));
__checkLater("true\ntrue\nfalse\nfalse\nfalse");
