// vybe-test: js/bigint_bitwise_operations_masks/test_js_bigint_bitwise_or_with_zero
...
__p(__line((1234567890123456789n | 0n).toString()));
__checkLater("1234567890123456789");
