// vybe-test: js/bigint_bitwise_operations_masks/test_js_bigint_asintn_sign_extension_utility
...
__p(__line(BigInt.asIntN(16, val).toString() + "|" + BigInt.asIntN(32, val).toString()));
__checkLater("-1|65535");
