// vybe-test: js/bigint_bitwise_operations_masks/test_js_bigint_asintn_negative_bits_throws_rangeerror
...
try {
    ...
    __p(__line("asIntN Negative Bits RangeError"));
}
__checkLater("asIntN Negative Bits RangeError");
