// vybe-test: js/bigint_bitwise_operations_masks/test_js_bigint_asuintn_negative_bits_throws_rangeerror
...
try {
    ...
    __p(__line("asUintN Negative Bits RangeError"));
}
__checkLater("asUintN Negative Bits RangeError");
