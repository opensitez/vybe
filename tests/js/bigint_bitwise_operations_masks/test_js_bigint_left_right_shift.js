// vybe-test: js/bigint_bitwise_operations_masks/test_js_bigint_left_right_shift
...
__p(__line(`${(1n << 64n).toString()}:${(100n >> 2n).toString()}`));
__checkLater("18446744073709551616:25");
