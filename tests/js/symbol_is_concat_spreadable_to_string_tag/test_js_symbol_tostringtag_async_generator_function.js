// vybe-test: js/symbol_is_concat_spreadable_to_string_tag/test_js_symbol_tostringtag_async_generator_function
...
__p(__line(Object.prototype.toString.call(myAsyncGen())));
__checkLater("[object AsyncGenerator]");
