// vybe-test: js/symbol_is_concat_spreadable_to_string_tag/test_js_symbol_tostringtag_builtin_objects
...
__p(__line(`${Object.prototype.toString.call(new Map())}:${Object.prototype.toString.call(new Set())}:${Object.prototype.toString.call(Promise.resolve())}`));
__checkLater("[object Map]:[object Set]:[object Promise]");
