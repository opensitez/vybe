// vybe-test: js/symbol_is_concat_spreadable_to_string_tag/test_js_symbol_tostringtag_bigint_prototype
...
const b = 100n;
__p(__line(Object.prototype.toString.call(b)));
__checkLater("[object BigInt]");
