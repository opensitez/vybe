...
fs.writeFileSync("/tmp/vybe_stat_test.txt", "hello");
        let info = fs.statSync("/tmp/vybe_stat_test.txt");
        __p(__line(info.isFile(), info.size));
        fs.unlinkSync("/tmp/vybe_stat_test.txt");
__checkLater("true 5");
