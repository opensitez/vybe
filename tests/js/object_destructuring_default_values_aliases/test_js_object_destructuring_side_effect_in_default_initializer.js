// vybe-test: js/object_destructuring_default_values_aliases/test_js_object_destructuring_side_effect_in_default_initializer
...
const { b = getDefault() } = {};
__p(__line(a + "|" + b + "|count=" + count));
__checkLater("50|1|count=1");
