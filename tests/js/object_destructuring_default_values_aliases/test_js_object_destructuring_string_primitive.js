// vybe-test: js/object_destructuring_default_values_aliases/test_js_object_destructuring_string_primitive
...
__p(__line(length + "|" + typeof slice));
__checkLater("5|function");
