// vybe-test: js/object_destructuring_default_values_aliases/test_js_object_destructuring_getter_invocation
...
const { prop } = obj;
__p(__line(prop + "|Reads=" + readCount));
__checkLater("Value|Reads=1");
