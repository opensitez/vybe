// vybe-test: js/object_destructuring_default_values_aliases/test_js_object_destructuring_undefined_target_throws_typeerror
...
try {
    ...
    __p(__line("Destructure Undefined TypeError"));
}
__checkLater("Destructure Undefined TypeError");
