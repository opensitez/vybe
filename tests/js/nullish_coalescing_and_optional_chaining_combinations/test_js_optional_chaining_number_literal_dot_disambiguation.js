// vybe-test: js/nullish_coalescing_and_optional_chaining_combinations/test_js_optional_chaining_number_literal_dot_disambiguation
...
__p(__line((1)?.toString() + "|" + (0?.toString() === undefined)));
__checkLater("1|false");
