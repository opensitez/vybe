// vybe-test: js/nullish_coalescing_and_optional_chaining_combinations/test_js_nullish_coalescing_right_side_short_circuited
...
__p(__line(val + "|Evaluated=" + evaluated));
__checkLater("10|Evaluated=false");
