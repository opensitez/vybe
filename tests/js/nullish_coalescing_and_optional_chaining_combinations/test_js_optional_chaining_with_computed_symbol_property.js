// vybe-test: js/nullish_coalescing_and_optional_chaining_combinations/test_js_optional_chaining_with_computed_symbol_property
...
const missing = null;
__p(__line(obj?.[sym] + "|" + (missing?.[sym] === undefined)));
__checkLater("SymbolValue|true");
