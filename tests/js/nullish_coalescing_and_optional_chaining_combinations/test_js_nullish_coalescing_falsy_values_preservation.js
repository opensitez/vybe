// vybe-test: js/nullish_coalescing_and_optional_chaining_combinations/test_js_nullish_coalescing_falsy_values_preservation
...
__p(__line(`${0 ?? 100}:${"" ?? "default"}:${false ?? true}:${NaN ?? 42}`));
__checkLater("0::false:NaN");
