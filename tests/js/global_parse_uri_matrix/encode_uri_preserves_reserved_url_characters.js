// vybe-test: js/global_parse_uri_matrix/encode_uri_preserves_reserved_url_characters
...
__p(__line(encodeURI("https://example.com/a?b=c&d=e#f")));
__checkLater("https://example.com/a?b=c&d=e#f");
