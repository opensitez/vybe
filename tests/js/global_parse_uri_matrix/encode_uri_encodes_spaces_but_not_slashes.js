// vybe-test: js/global_parse_uri_matrix/encode_uri_encodes_spaces_but_not_slashes
...
__p(__line(encodeURI("https://example.com/a b/c d")));
__checkLater("https://example.com/a%20b/c%20d");
