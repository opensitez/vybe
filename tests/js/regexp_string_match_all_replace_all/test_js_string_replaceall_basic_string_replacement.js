// vybe-test: js/regexp_string_match_all_replace_all/test_js_string_replaceall_basic_string_replacement
...
__p(__line(str.replaceAll("foo", "baz")));
__checkLater("baz-bar-baz");
