// vybe-test: js/regexp_string_match_all_replace_all/test_js_string_replaceall_with_global_regexp
...
__p(__line(str.replaceAll(/apple/g, "orange")));
__checkLater("orange banana orange");
