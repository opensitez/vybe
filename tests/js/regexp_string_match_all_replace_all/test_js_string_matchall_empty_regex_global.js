// vybe-test: js/regexp_string_match_all_replace_all/test_js_string_matchall_empty_regex_global
...
__p(__line(matches.length + "|" + matches.map(m => m.index).join(",")));
__checkLater("3|0,1,2");
