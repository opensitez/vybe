// vybe-test: js/regexp_string_match_all_replace_all/test_js_string_replaceall_function_replacer_arguments
...
str.replaceAll(/(a)/g, (match, p1, offset, string) => {
    __p(__line(`${match}:${p1}:${offset}:${string}`));
    return "X";
});
__checkLater("a:a:1:cat");
