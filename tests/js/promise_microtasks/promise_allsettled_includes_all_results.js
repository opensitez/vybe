...
Promise.allSettled([
    ...
    __p(__line(results[0].status + ":" + results[0].value));
    __p(__line(results[1].status + ":" + results[1].reason));
    __p(__line(results[2].status + ":" + results[2].value));
});
__checkLater("fulfilled:ok\nrejected:err\nfulfilled:ok2");
