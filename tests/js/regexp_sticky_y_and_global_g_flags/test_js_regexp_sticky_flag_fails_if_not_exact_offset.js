// vybe-test: js/regexp_sticky_y_and_global_g_flags/test_js_regexp_sticky_flag_fails_if_not_exact_offset
...
__p(__line(re.test("123foo") + "|lastIndex=" + re.lastIndex));
__checkLater("false|lastIndex=0");
