// vybe-test: js/structured_clone_circular_references/test_js_structured_clone_function_throws_datacloneerror
...
try {
    ...
    __p(__line("DataCloneError Function"));
}
__checkLater("DataCloneError Function");
