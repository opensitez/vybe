...
__p(__line(`${structuredClone(123)}:${structuredClone("str")}:${structuredClone(true)}:${structuredClone(null)}:${structuredClone(undefined)}`));
__checkLater("123:str:true:null:undefined");
