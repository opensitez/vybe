...
const t={}; Object.defineProperty(t,"x",{value:1,configurable:false}); const p=new Proxy(t,{getOwnPropertyDescriptor(){return {value:2,configurable:false,enumerable:true,writable:true};}}); try{Object.getOwnPropertyDescriptor(p,"x");}catch(e){__p(__line(e instanceof TypeError));}
__checkLater("true");
