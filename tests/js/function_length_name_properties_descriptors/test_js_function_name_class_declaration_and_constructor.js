// vybe-test: js/function_length_name_properties_descriptors/test_js_function_name_class_declaration_and_constructor
...
__p(__line(Person.name + "|" + Person.prototype.constructor.name));
__checkLater("Person|Person");
