// vybe-test: js/function_length_name_properties_descriptors/test_js_function_name_class_expression_variable_inference
...
__p(__line(CustomClass.name));
__checkLater("CustomClass");
