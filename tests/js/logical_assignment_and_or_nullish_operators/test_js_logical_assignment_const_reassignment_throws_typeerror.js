// vybe-test: js/logical_assignment_and_or_nullish_operators/test_js_logical_assignment_const_reassignment_throws_typeerror
...
try {
    ...
    __p(__line("Const Logical Assignment TypeError"));
}
__checkLater("Const Logical Assignment TypeError");
