// vybe-test: js/logical_assignment_and_or_nullish_operators/test_js_logical_and_assignment_falsy_target_short_circuits
...
let evaluated = false;
a &&= (evaluated = true, 5);
__p(__line(a + "|Evaluated=" + evaluated));
__checkLater("0|Evaluated=false");
