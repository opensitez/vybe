// vybe-test: js/logical_assignment_and_or_nullish_operators/test_js_logical_assignment_setter_called_when_evaluated
...
__p(__line(obj.val + "|Setters=" + setterCount));
__checkLater("AssignedValue|Setters=1");
