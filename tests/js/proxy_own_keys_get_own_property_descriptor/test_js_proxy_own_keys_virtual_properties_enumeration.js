// vybe-test: js/proxy_own_keys_get_own_property_descriptor/test_js_proxy_own_keys_virtual_properties_enumeration
...
__p(__line(Object.keys(proxy).join(",")));
__checkLater("v1,v2,v3");
