// vybe-test: js/proxy_own_keys_get_own_property_descriptor/test_js_proxy_get_own_property_descriptor_defaults_all_boolean_attributes
...
__p(__line(desc.writable + "|" + desc.enumerable + "|" + desc.configurable));
