// vybe-test: js/date_mutation_more_matrix/date_toutcstring_on_epoch_exact_value
...
__p(__line(new Date(0).toUTCString()));
__checkLater("Thu, 01 Jan 1970 00:00:00 GMT");
