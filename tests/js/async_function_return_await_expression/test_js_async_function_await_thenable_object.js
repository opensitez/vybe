// vybe-test: js/async_function_return_await_expression/test_js_async_function_await_thenable_object
...
getThenable().then(res => __p(__line(res)));
__checkLater("ThenableResolved");
