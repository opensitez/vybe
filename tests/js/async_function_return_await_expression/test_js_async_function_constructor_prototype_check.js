// vybe-test: js/async_function_return_await_expression/test_js_async_function_constructor_prototype_check
...
__p(__line(AsyncFunction.name));
__checkLater("AsyncFunction");
