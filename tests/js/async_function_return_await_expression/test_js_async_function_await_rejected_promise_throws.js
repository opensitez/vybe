// vybe-test: js/async_function_return_await_expression/test_js_async_function_await_rejected_promise_throws
...
async function fail() {
    try {
        ...
        __p(__line("Caught: " + err));
    }
}
fail();
__checkLater("Caught: AsyncRejection");
