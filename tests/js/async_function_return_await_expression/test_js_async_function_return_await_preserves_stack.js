// vybe-test: js/async_function_return_await_expression/test_js_async_function_return_await_preserves_stack
...
outer().catch(err => __p(__line(err.message)));
__checkLater("InnerFail");
