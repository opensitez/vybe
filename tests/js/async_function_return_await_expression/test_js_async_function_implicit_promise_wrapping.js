// vybe-test: js/async_function_return_await_expression/test_js_async_function_implicit_promise_wrapping
...
getVal().then(v => __p(__line(v + "|" + (getVal() instanceof Promise))));
__checkLater("42|true");
