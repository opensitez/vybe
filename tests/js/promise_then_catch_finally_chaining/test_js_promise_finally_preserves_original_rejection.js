// vybe-test: js/promise_then_catch_finally_chaining/test_js_promise_finally_preserves_original_rejection
...
Promise.reject("OriginalError")
    ...
    .catch(err => __p(__line(err)));
__checkLater("OriginalError");
