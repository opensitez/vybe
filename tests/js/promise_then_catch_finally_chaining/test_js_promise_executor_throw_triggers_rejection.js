// vybe-test: js/promise_then_catch_finally_chaining/test_js_promise_executor_throw_triggers_rejection
...
.catch(err => __p(__line(err.message)));
__checkLater("Executor Exception");
