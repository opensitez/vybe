// vybe-test: js/atomics_compare_exchange_store_load/test_js_atomics_store_property_descriptor
...
__p(__line(`${desc.writable}:${desc.enumerable}:${desc.configurable}:${Atomics.store.length}`));
__checkLater("true:false:true:3");
