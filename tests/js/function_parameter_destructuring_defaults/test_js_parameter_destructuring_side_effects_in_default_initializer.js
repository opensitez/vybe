// vybe-test: js/function_parameter_destructuring_defaults/test_js_parameter_destructuring_side_effects_in_default_initializer
...
__p(__line(log({ val: 100 }) + "|" + log() + "|Calls=" + calls));
__checkLater("100|1|Calls=1");
