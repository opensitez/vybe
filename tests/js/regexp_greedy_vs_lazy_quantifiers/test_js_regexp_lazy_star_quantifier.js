// vybe-test: js/regexp_greedy_vs_lazy_quantifiers/test_js_regexp_lazy_star_quantifier
...
__p(__line(html.match(/<div>.*?<\/div>/g).join("|")));
__checkLater("<div>first</div>|<div>second</div>");
