// vybe-test: js/map_set_prototype_methods/set_for_each_values_as_both_args
...
const s=new Set([1,2]); const o=[]; s.forEach((v,k)=>o.push(v+":"+k)); __p(__line(o.join(",")));
__checkLater("1:1,2:2");
