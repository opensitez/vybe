// vybe-test: js/intl_numberformat_currency_compact_unit/test_js_intl_numberformat_decimal_formatting_default_locale
...
__p(__line(formatter.format(1234567.89)));
__checkLater("1,234,567.89");
