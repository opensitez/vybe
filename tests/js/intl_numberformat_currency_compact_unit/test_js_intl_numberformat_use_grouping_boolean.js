// vybe-test: js/intl_numberformat_currency_compact_unit/test_js_intl_numberformat_use_grouping_boolean
...
__p(__line(formatter.format(1000000)));
__checkLater("1000000");
