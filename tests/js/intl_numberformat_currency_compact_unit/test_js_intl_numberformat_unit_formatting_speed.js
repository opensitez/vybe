// vybe-test: js/intl_numberformat_currency_compact_unit/test_js_intl_numberformat_unit_formatting_speed
...
__p(__line(formatter.format(120)));
__checkLater("120 km/h");
