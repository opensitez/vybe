// vybe-test: js/intl_numberformat_currency_compact_unit/test_js_intl_numberformat_resolved_options
...
__p(__line(opts.locale + "|" + opts.style + "|" + opts.currency));
__checkLater("en-US|currency|EUR");
