// vybe-test: js/intl_numberformat_currency_compact_unit/test_js_intl_numberformat_bigint_formatting
...
__p(__line(formatter.format(1000000000000000n)));
__checkLater("1,000,000,000,000,000");
