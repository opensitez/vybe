// vybe-test: js/class_static_initialization_blocks/test_js_class_static_block_await_expression_syntaxerror
...
try {
    ...
    __p(__line("Await in Static Block Error"));
}
__checkLater("Await in Static Block Error");
