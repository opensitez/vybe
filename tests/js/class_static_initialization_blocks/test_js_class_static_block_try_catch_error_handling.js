// vybe-test: js/class_static_initialization_blocks/test_js_class_static_block_try_catch_error_handling
...
__p(__line(SafeInit.status));
__checkLater("FallbackStatus");
