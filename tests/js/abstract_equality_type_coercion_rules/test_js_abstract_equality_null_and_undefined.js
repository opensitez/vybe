// vybe-test: js/abstract_equality_type_coercion_rules/test_js_abstract_equality_null_and_undefined
...
__p(__line(`${null == undefined}:${null == null}:${undefined == undefined}:${null == 0}:${undefined == false}`));
__checkLater("true:true:true:false:false");
