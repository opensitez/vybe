// vybe-test: js/abstract_equality_type_coercion_rules/test_js_abstract_equality_nan_is_never_equal_to_anything
...
__p(__line(`${NaN == NaN}:${NaN == 0}:${NaN == false}:${NaN == null}`));
