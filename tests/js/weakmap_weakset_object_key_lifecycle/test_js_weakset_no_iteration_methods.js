// vybe-test: js/weakmap_weakset_object_key_lifecycle/test_js_weakset_no_iteration_methods
...
__p(__line((ws.keys === undefined) + "|" + (ws.values === undefined) + "|" + (ws.forEach === undefined)));
