// vybe-test: js/weakmap_weakset_object_key_lifecycle/test_js_weakset_primitive_element_throws_typeerror
...
try {
    ...
    __p(__line("WeakSet Primitive Element TypeError"));
}
__checkLater("WeakSet Primitive Element TypeError");
