// vybe-test: js/weakmap_weakset_object_key_lifecycle/test_js_weakmap_primitive_key_throws_typeerror
...
try {
    ...
    __p(__line("WeakMap Primitive Key TypeError"));
}
__checkLater("WeakMap Primitive Key TypeError");
