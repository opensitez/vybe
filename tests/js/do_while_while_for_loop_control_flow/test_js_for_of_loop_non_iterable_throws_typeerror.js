// vybe-test: js/do_while_while_for_loop_control_flow/test_js_for_of_loop_non_iterable_throws_typeerror
...
try {
    ...
    __p(__line("for...of Non-Iterable TypeError"));
}
__checkLater("for...of Non-Iterable TypeError");
