// vybe-test: js/do_while_while_for_loop_control_flow/test_js_for_in_loop_includes_inherited_enumerable_properties
...
__p(__line(keys.join(",")));
__checkLater("ownProp,protoProp");
