// vybe-test: js/do_while_while_for_loop_control_flow/test_js_while_loop_finally_runs_on_continue
...
__p(__line(log.join(",")));
__checkLater("try-0,finally-1,try-1,finally-2,try-2,finally-3");
