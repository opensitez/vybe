...
__p(__line(Number.isInteger(42)));
__p(__line(Number.isInteger(42.0)));
__p(__line(Number.isInteger(42.5)));
__p(__line(Number.isInteger(Infinity)));
__p(__line(Number.isInteger(NaN)));
__checkLater("true\ntrue\nfalse\nfalse\nfalse");
