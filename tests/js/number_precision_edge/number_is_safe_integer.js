...
__p(__line(Number.isSafeInteger(42)));
__p(__line(Number.isSafeInteger(Number.MAX_SAFE_INTEGER)));
__p(__line(Number.isSafeInteger(Number.MAX_SAFE_INTEGER + 1)));
__p(__line(Number.isSafeInteger(3.5)));
__checkLater("true\ntrue\nfalse\nfalse");
