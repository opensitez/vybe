// vybe-test: js/function_bind_currying_bound_this/test_js_bound_function_call_and_apply_cannot_override_bound_this
...
__p(__line(bound.call({ val: "CallVal" }) + "|" + bound.apply({ val: "ApplyVal" })));
__checkLater("BoundVal|BoundVal");
