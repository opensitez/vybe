// vybe-test: js/relational_in_instanceof_less_greater_operators/test_js_instanceof_operator_builtin_objects
...
__p(__line(`${[] instanceof Array}:${({}) instanceof Object}:${(new Map()) instanceof Map}:${(new Date()) instanceof Date}`));
__checkLater("true:true:true:true");
