// vybe-test: js/relational_in_instanceof_less_greater_operators/test_js_relational_boolean_and_number_coercion
...
__p(__line(`${false < true}:${false <= 0}:${true > false}:${true >= 1}`));
