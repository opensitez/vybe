// vybe-test: js/relational_in_instanceof_less_greater_operators/test_js_relational_infinity_comparisons
...
__p(__line(`${Infinity > 1e300}:${-Infinity < -1e300}:${Infinity >= Infinity}`));
