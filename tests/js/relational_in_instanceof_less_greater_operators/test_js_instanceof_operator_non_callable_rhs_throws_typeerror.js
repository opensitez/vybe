// vybe-test: js/relational_in_instanceof_less_greater_operators/test_js_instanceof_operator_non_callable_rhs_throws_typeerror
...
try {
    ...
    __p(__line("instanceof Non-Callable RHS TypeError"));
}
__checkLater("instanceof Non-Callable RHS TypeError");
