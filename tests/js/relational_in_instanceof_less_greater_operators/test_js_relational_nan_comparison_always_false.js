// vybe-test: js/relational_in_instanceof_less_greater_operators/test_js_relational_nan_comparison_always_false
...
__p(__line(`${NaN < 5}:${NaN > 5}:${NaN <= 5}:${NaN >= 5}:${NaN < NaN}:${NaN <= NaN}`));
__checkLater("false:false:false:false:false:false");
