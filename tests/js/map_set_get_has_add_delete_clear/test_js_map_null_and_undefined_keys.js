// vybe-test: js/map_set_get_has_add_delete_clear/test_js_map_null_and_undefined_keys
...
__p(__line(map.get(null) + "|" + map.get(undefined)));
__checkLater("NullVal|UndefVal");
