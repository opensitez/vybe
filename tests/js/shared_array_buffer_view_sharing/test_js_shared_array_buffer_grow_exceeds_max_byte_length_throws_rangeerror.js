// vybe-test: js/shared_array_buffer_view_sharing/test_js_shared_array_buffer_grow_exceeds_max_byte_length_throws_rangeerror
...
if (typeof SharedArrayBuffer.prototype.grow === "function") {
    ...
    try {
        ...
        __p(__line("Grow Exceeds Max RangeError"));
    }
} else {
    __p(__line("Grow Exceeds Max RangeError"));
}
__checkLater("Grow Exceeds Max RangeError");
