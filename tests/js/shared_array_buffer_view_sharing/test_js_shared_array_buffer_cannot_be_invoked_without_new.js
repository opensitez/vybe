// vybe-test: js/shared_array_buffer_view_sharing/test_js_shared_array_buffer_cannot_be_invoked_without_new
...
try {
    ...
    __p(__line("SharedArrayBuffer Call Without New TypeError"));
}
__checkLater("SharedArrayBuffer Call Without New TypeError");
