// vybe-test: js/shared_array_buffer_view_sharing/test_js_shared_array_buffer_negative_length_throws_rangeerror
...
try {
    ...
    __p(__line("SharedArrayBuffer Negative Length RangeError"));
}
__checkLater("SharedArrayBuffer Negative Length RangeError");
