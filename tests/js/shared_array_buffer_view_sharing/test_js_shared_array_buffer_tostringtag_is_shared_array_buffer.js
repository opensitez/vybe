// vybe-test: js/shared_array_buffer_view_sharing/test_js_shared_array_buffer_tostringtag_is_shared_array_buffer
...
__p(__line(sab[Symbol.toStringTag]));
__checkLater("SharedArrayBuffer");
