// vybe-test: js/typed_array_subarray_slice_set_copywithin/test_js_typedarray_set_negative_offset_throws_rangeerror
...
try {
    ...
    __p(__line("Negative Offset RangeError"));
}
__checkLater("Negative Offset RangeError");
