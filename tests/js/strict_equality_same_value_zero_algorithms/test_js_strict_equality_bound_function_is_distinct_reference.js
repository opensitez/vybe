// vybe-test: js/strict_equality_same_value_zero_algorithms/test_js_strict_equality_bound_function_is_distinct_reference
...
__p(__line(`${base === bound}:${Object.is(base, bound)}:${bound === bound}`));
__checkLater("false:false:true");
