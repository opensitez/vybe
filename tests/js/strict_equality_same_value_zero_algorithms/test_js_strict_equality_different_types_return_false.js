// vybe-test: js/strict_equality_same_value_zero_algorithms/test_js_strict_equality_different_types_return_false
...
__p(__line(`${"5" === 5}:${true === 1}:${null === undefined}:${[] === false}`));
__checkLater("false:false:false:false");
