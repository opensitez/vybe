// vybe-test: js/strict_equality_same_value_zero_algorithms/test_js_object_is_same_value_algorithm_signed_zeros
...
__p(__line(`${Object.is(+0, -0)}:${Object.is(+0, +0)}:${Object.is(-0, -0)}`));
__checkLater("false:true:true");
