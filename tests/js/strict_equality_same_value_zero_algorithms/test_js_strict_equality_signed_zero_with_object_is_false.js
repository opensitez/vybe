// vybe-test: js/strict_equality_same_value_zero_algorithms/test_js_strict_equality_signed_zero_with_object_is_false
...
__p(__line(`${Object.is(+0, -0)}:${+0 === -0}:${Object.is(-0, -0)}:${Object.is(+0, +0)}`));
__checkLater("false:true:true:true");
