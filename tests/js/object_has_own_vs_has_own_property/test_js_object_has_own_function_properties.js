// vybe-test: js/object_has_own_vs_has_own_property/test_js_object_has_own_function_properties
...
function fn() {}
__p(__line(`${Object.hasOwn(fn, "name")}:${Object.hasOwn(fn, "length")}:${Object.hasOwn(fn, "prototype")}`));
