// vybe-test: js/generator_function_prototype/generator_expression_name_from_property_assignment
...
const tools = { maker: function* () { yield 1; } }; __p(__line(tools.maker.name));
__checkLater("maker");
