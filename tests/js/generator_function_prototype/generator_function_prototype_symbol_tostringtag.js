// vybe-test: js/generator_function_prototype/generator_function_prototype_symbol_tostringtag
...
__p(__line(GeneratorFunction.prototype[Symbol.toStringTag]));
__checkLater("GeneratorFunction");
