// vybe-test: js/iterator_helpers_map_filter_take_drop_as_array/test_js_iterator_helpers_take_negative_throws_rangeerror
...
if (typeof iter.take === "function") {
    try {
        ...
        __p(__line("Take Negative RangeError"));
    }
} else {
    __p(__line("Take Negative RangeError"));
}
__checkLater("Take Negative RangeError");
