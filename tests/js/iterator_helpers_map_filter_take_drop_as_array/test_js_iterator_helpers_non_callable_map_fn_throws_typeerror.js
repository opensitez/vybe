// vybe-test: js/iterator_helpers_map_filter_take_drop_as_array/test_js_iterator_helpers_non_callable_map_fn_throws_typeerror
...
if (typeof iter.map === "function") {
    try {
        ...
        __p(__line("Map Callback TypeError"));
    }
} else {
    __p(__line("Map Callback TypeError"));
}
__checkLater("Map Callback TypeError");
