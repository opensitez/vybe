// vybe-test: js/iterator_helpers_map_filter_take_drop_as_array/test_js_iterator_helpers_drop_negative_throws_rangeerror
...
if (typeof iter.drop === "function") {
    try {
        ...
        __p(__line("Drop Negative RangeError"));
    }
} else {
    __p(__line("Drop Negative RangeError"));
}
__checkLater("Drop Negative RangeError");
