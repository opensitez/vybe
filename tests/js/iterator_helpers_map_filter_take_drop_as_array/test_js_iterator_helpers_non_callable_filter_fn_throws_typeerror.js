// vybe-test: js/iterator_helpers_map_filter_take_drop_as_array/test_js_iterator_helpers_non_callable_filter_fn_throws_typeerror
...
if (typeof iter.filter === "function") {
    try {
        ...
        __p(__line("Filter Callback TypeError"));
    }
} else {
    __p(__line("Filter Callback TypeError"));
}
__checkLater("Filter Callback TypeError");
