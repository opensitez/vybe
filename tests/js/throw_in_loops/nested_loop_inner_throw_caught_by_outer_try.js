...
let o=[];try{for(let i=0;i<2;i++){for(let j=0;j<2;j++){if(i===1&&j===1)throw new Error("deep");o.push(i+""+j);}}}catch(e){o.push(e.message);}__p(__line(o.join(",")));
__checkLater("00,01,10,deep");
