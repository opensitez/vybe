...
async function main(){const o=[];async function* g(){yield 1;throw new Error("async");}try{for await(const v of g())o.push(v);}catch(e){o.push(e.message);}__p(__line(o.join(",")));}main();
__checkLater("1,async");
