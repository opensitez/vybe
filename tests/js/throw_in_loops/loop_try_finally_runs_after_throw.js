// vybe-test: js/throw_in_loops/loop_try_finally_runs_after_throw
...
let o=[];for(let i=0;i<2;i++){try{try{if(i===1)throw "t";o.push(i);}finally{o.push("f");}}catch(e){o.push(String(e));}}__p(__line(o.join(",")));
__checkLater("0,f,f,t");
