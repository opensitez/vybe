...
let o=[];let run=true;do{try{if(run)throw new Error("once");}catch(e){o.push(e.message);run=false;}o.push("body");}while(false);__p(__line(o.join(",")));
__checkLater("once,body");
