...
let o=[]; try { const bad = { [Symbol.iterator]() { return { next() { throw new Error("next_err"); } }; } }; for (const x of bad) {} } catch(e) { o.push(e.message); } __p(__line(o.join(",")));
__checkLater("next_err");
