...
__p(__line(0 ?? "default"));      // 0 — not null/undefined
__p(__line("" ?? "default"));     // "" — not null/undefined
__p(__line(false ?? "default"));  // false — not null/undefined
__p(__line(null ?? "default"));   // "default"
__p(__line(undefined ?? "default")); // "default"
__checkLater("0\n\nfalse\ndefault\ndefault");
