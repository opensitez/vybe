// vybe-test: js/property_accessors_getters_setters_inheritance/test_js_getter_deleting_self_property
...
__p(__line(obj.temp + "|" + obj.temp));
__checkLater("CachedVal|CachedVal");
