...
const n = 255;
__p(__line(n.toString(2)));
__p(__line(n.toString(8)));
__p(__line(n.toString(16)));
__p(__line(n.toString(36)));
// And parsing back
__p(__line(parseInt("ff", 16)));
__p(__line(parseInt("11111111", 2)));
__checkLater("11111111\n377\nff\n73\n255\n255");
