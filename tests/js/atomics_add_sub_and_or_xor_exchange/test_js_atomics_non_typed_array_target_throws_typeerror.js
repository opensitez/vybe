// vybe-test: js/atomics_add_sub_and_or_xor_exchange/test_js_atomics_non_typed_array_target_throws_typeerror
...
try {
    ...
    __p(__line("Atomics Non-TypedArray TypeError"));
}
__checkLater("Atomics Non-TypedArray TypeError");
