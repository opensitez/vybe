// vybe-test: js/atomics_add_sub_and_or_xor_exchange/test_js_atomics_cannot_be_constructed_with_new
...
try {
    ...
    __p(__line("Atomics Constructor TypeError"));
}
__checkLater("Atomics Constructor TypeError");
