// vybe-test: js/atomics_add_sub_and_or_xor_exchange/test_js_atomics_add_property_descriptors
...
__p(__line(`${desc.writable}:${desc.enumerable}:${desc.configurable}:${Atomics.add.length}`));
