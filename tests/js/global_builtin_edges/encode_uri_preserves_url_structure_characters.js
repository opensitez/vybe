// vybe-test: js/global_builtin_edges/encode_uri_preserves_url_structure_characters
...
__p(__line(encodeURI("https://example.com/a path?q=hello world#hash")));
__checkLater("https://example.com/a%20path?q=hello%20world#hash");
