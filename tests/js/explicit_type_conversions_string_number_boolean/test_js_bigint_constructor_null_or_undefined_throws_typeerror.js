// vybe-test: js/explicit_type_conversions_string_number_boolean/test_js_bigint_constructor_null_or_undefined_throws_typeerror
...
try {
    ...
    __p(__line("BigInt Null TypeError"));
}
__checkLater("BigInt Null TypeError");
