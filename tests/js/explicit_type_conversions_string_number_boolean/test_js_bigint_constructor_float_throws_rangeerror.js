// vybe-test: js/explicit_type_conversions_string_number_boolean/test_js_bigint_constructor_float_throws_rangeerror
...
try {
    ...
    __p(__line("BigInt Float RangeError"));
}
__checkLater("BigInt Float RangeError");
