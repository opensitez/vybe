// vybe-test: js/explicit_type_conversions_string_number_boolean/test_js_number_constructor_symbol_throws_typeerror
...
try {
    ...
    __p(__line("Number Symbol TypeError"));
}
__checkLater("Number Symbol TypeError");
