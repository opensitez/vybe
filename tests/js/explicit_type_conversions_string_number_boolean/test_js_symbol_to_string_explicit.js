// vybe-test: js/explicit_type_conversions_string_number_boolean/test_js_symbol_to_string_explicit
...
const s = Symbol("desc");
__p(__line(String(s) + "|" + s.toString()));
__checkLater("Symbol(desc)|Symbol(desc)");
