...
__p(__line("javascript".startsWith("java")));
__p(__line("javascript".startsWith("ava", 1)));
__p(__line("javascript".endsWith("ipt")));
__p(__line("javascript".endsWith("java", 4)));
__p(__line("javascript".includes("script")));
__p(__line("javascript".includes("java", 1)));
__checkLater("true\ntrue\ntrue\ntrue\ntrue\nfalse");
