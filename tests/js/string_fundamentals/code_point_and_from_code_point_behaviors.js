...
__p(__line(String.fromCodePoint(0x1F600).length));
__p(__line(String.fromCodePoint(0x1F600).charCodeAt(0)));
__p(__line(String.fromCodePoint(0x1F600).charCodeAt(1)));
__p(__line(String.fromCharCode(0x41).length));
__checkLater("2\n55357\n56832\n1");
