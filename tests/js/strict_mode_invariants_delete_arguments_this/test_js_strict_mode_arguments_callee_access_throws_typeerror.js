// vybe-test: js/strict_mode_invariants_delete_arguments_this/test_js_strict_mode_arguments_callee_access_throws_typeerror
...
try {
    ...
    __p(__line("Strict arguments.callee TypeError"));
}
__checkLater("Strict arguments.callee TypeError");
