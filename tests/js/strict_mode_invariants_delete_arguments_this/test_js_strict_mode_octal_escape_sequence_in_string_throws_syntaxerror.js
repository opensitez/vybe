// vybe-test: js/strict_mode_invariants_delete_arguments_this/test_js_strict_mode_octal_escape_sequence_in_string_throws_syntaxerror
...
try {
    ...
    __p(__line("Strict Legacy Octal Escape SyntaxError"));
}
__checkLater("Strict Legacy Octal Escape SyntaxError");
