// vybe-test: js/strict_mode_invariants_delete_arguments_this/test_js_strict_mode_class_body_is_implicitly_strict
...
class StrictClass {
    method() {
        try {
            ...
            __p(__line("Implicit Class Strict ReferenceError"));
        }
    }
}
new StrictClass().method();
__checkLater("Implicit Class Strict ReferenceError");
