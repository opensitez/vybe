// vybe-test: js/strict_mode_invariants_delete_arguments_this/test_js_strict_mode_assignment_to_undeclared_variable_throws_referenceerror
...
try {
    ...
    __p(__line("Strict Undeclared Variable ReferenceError"));
}
__checkLater("Strict Undeclared Variable ReferenceError");
