// vybe-test: js/strict_mode_invariants_delete_arguments_this/test_js_strict_mode_octal_literal_prohibited_throws_syntaxerror
...
try {
    ...
    __p(__line("Strict Legacy Octal Literal SyntaxError"));
}
__checkLater("Strict Legacy Octal Literal SyntaxError");
