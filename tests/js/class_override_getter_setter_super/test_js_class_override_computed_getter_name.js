// vybe-test: js/class_override_getter_setter_super/test_js_class_override_computed_getter_name
...
__p(__line(new Derived().dynamicKey));
__checkLater("BaseVal_Derived");
