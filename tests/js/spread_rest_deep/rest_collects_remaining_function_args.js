// vybe-test: js/spread_rest_deep/rest_collects_remaining_function_args
...
__p(__line(log("INFO", "Starting", "connecting", "ready")));
__checkLater("INFO: Starting, connecting, ready");
