// vybe-test: js/error_aggregate_error_cause_property/test_js_aggregate_error_promise_any_rejection
...
(async () => {
    try {
        ...
        __p(__line((e instanceof AggregateError) + "|" + e.errors.join(",")));
    }
})();
__checkLater("true|FailA,FailB");
