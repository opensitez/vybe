// vybe-test: js/error_aggregate_error_cause_property/test_js_aggregate_error_factory_call_without_new
...
__p(__line(agg.message + "|" + (agg instanceof AggregateError)));
__checkLater("NoNew|true");
