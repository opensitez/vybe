// vybe-test: js/error_aggregate_error_cause_property/test_js_aggregate_error_prototype_name
...
__p(__line(AggregateError.prototype.name));
__checkLater("AggregateError");
