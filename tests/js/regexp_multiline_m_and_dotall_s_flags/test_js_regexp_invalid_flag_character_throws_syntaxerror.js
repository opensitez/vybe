// vybe-test: js/regexp_multiline_m_and_dotall_s_flags/test_js_regexp_invalid_flag_character_throws_syntaxerror
...
try {
    ...
    __p(__line("Invalid Flag SyntaxError"));
}
__checkLater("Invalid Flag SyntaxError");
