// vybe-test: js/regexp_multiline_m_and_dotall_s_flags/test_js_regexp_duplicate_flags_throws_syntaxerror
...
try {
    ...
    __p(__line("Duplicate Flags SyntaxError"));
}
__checkLater("Duplicate Flags SyntaxError");
