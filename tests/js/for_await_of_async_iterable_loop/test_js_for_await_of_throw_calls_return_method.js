// vybe-test: js/for_await_of_async_iterable_loop/test_js_for_await_of_throw_calls_return_method
...
(async () => {
    try {
        ...
        __p(__line(e.message + "|ReturnCalled=" + returnCalled));
    }
})();
__checkLater("LoopCrash|ReturnCalled=true");
