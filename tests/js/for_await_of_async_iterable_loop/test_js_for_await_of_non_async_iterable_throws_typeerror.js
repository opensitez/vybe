// vybe-test: js/for_await_of_async_iterable_loop/test_js_for_await_of_non_async_iterable_throws_typeerror
...
(async () => {
    try {
        ...
        __p(__line("For-Await-Of Non-Iterable TypeError"));
    }
})();
__checkLater("For-Await-Of Non-Iterable TypeError");
