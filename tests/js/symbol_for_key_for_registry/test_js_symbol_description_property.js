// vybe-test: js/symbol_for_key_for_registry/test_js_symbol_description_property
...
const s3 = Symbol();
__p(__line(`${s1.description}:${s2.description}:${s3.description}`));
__checkLater("desc1:desc2:undefined");
