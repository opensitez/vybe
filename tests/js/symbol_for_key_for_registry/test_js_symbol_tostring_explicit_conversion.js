// vybe-test: js/symbol_for_key_for_registry/test_js_symbol_tostring_explicit_conversion
...
__p(__line(sym.toString() + "|" + String(sym)));
__checkLater("Symbol(tag)|Symbol(tag)");
