// vybe-test: js/symbol_for_key_for_registry/test_js_symbol_cannot_be_constructed_with_new
...
try {
    ...
    __p(__line("New Symbol TypeError"));
}
__checkLater("New Symbol TypeError");
