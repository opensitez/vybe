// vybe-test: js/symbol_for_key_for_registry/test_js_symbol_implicit_string_concatenation_throws_typeerror
...
try {
    ...
    __p(__line("Implicit Symbol String Coercion TypeError"));
}
__checkLater("Implicit Symbol String Coercion TypeError");
