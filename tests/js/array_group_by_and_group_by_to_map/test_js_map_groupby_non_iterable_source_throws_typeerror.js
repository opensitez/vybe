// vybe-test: js/array_group_by_and_group_by_to_map/test_js_map_groupby_non_iterable_source_throws_typeerror
...
try {
    ...
    __p(__line("Map.groupBy Non-Iterable TypeError"));
}
__checkLater("Map.groupBy Non-Iterable TypeError");
