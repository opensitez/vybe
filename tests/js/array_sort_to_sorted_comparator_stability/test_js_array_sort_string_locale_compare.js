// vybe-test: js/array_sort_to_sorted_comparator_stability/test_js_array_sort_string_locale_compare
...
__p(__line(words.join(",")));
__checkLater("adieu,cliché,premier,réservé");
