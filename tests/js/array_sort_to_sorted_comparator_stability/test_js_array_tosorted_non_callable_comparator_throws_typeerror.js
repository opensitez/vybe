// vybe-test: js/array_sort_to_sorted_comparator_stability/test_js_array_tosorted_non_callable_comparator_throws_typeerror
...
try {
    ...
    __p(__line("toSorted Invalid Comparator TypeError"));
}
__checkLater("toSorted Invalid Comparator TypeError");
