// vybe-test: js/array_sort_to_sorted_comparator_stability/test_js_array_sort_undefined_values_moved_to_end
...
arr.sort((a, b) => a - b);
__p(__line(arr.map(x => String(x)).join(",")));
__checkLater("1,2,3,undefined,undefined");
