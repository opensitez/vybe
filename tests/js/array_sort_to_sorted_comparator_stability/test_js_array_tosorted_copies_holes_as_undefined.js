// vybe-test: js/array_sort_to_sorted_comparator_stability/test_js_array_tosorted_copies_holes_as_undefined
...
__p(__line(sorted.length + "|" + sorted.map(x => String(x)).join(",")));
__checkLater("3|1,2,undefined");
