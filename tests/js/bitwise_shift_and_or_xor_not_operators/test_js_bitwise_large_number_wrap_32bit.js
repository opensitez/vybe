// vybe-test: js/bitwise_shift_and_or_xor_not_operators/test_js_bitwise_large_number_wrap_32bit
...
__p(__line((maxInt32PlusOne | 0) + "|" + (maxInt32PlusOne >>> 0)));
__checkLater("-2147483648|2147483648");
