// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_has_trap_after_revoke_throws_typeerror
...
try {
    ...
    __p(__line("Revoked Proxy Has TypeError"));
}
__checkLater("Revoked Proxy Has TypeError");
