// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_is_extensible_after_revoke_throws
...
try {
    ...
    __p(__line("Revoked Proxy IsExtensible TypeError"));
}
__checkLater("Revoked Proxy IsExtensible TypeError");
