// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_delete_property_after_revoke_throws_typeerror
...
try {
    ...
    __p(__line("Revoked Proxy Delete TypeError"));
}
__checkLater("Revoked Proxy Delete TypeError");
