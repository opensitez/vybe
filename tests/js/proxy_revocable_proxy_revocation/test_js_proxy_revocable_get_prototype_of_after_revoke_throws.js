// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_get_prototype_of_after_revoke_throws
...
try {
    ...
    __p(__line("Revoked Proxy GetPrototypeOf TypeError"));
}
__checkLater("Revoked Proxy GetPrototypeOf TypeError");
