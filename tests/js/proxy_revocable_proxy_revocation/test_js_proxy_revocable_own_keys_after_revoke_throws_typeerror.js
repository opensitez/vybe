// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_own_keys_after_revoke_throws_typeerror
...
try {
    ...
    __p(__line("Revoked Proxy OwnKeys TypeError"));
}
__checkLater("Revoked Proxy OwnKeys TypeError");
