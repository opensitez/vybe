// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_get_trap_after_revoke_throws_typeerror
...
try {
    ...
    __p(__line("Revoked Proxy Get TypeError"));
}
__checkLater("Revoked Proxy Get TypeError");
