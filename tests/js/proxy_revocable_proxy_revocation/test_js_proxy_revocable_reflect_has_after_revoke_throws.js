// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_reflect_has_after_revoke_throws
...
try {
    ...
    __p(__line("Reflect Has Revoked Error"));
}
__checkLater("Reflect Has Revoked Error");
