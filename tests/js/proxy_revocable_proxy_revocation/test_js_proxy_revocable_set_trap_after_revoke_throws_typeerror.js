// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_set_trap_after_revoke_throws_typeerror
...
try {
    ...
    __p(__line("Revoked Proxy Set TypeError"));
}
__checkLater("Revoked Proxy Set TypeError");
