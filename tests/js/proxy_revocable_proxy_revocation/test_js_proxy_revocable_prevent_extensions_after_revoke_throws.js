// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_prevent_extensions_after_revoke_throws
...
try {
    ...
    __p(__line("Revoked Proxy PreventExtensions TypeError"));
}
__checkLater("Revoked Proxy PreventExtensions TypeError");
