// vybe-test: js/proxy_revocable_proxy_revocation/test_js_proxy_revocable_set_prototype_of_after_revoke_throws
...
try {
    ...
    __p(__line("Revoked Proxy SetPrototypeOf TypeError"));
}
__checkLater("Revoked Proxy SetPrototypeOf TypeError");
