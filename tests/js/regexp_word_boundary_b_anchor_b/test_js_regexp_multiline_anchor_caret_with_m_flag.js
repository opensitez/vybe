// vybe-test: js/regexp_word_boundary_b_anchor_b/test_js_regexp_multiline_anchor_caret_with_m_flag
...
const str = "line1\nline2\nline3";
__p(__line(str.match(/^line\d/gm).join(",")));
__checkLater("line1,line2,line3");
