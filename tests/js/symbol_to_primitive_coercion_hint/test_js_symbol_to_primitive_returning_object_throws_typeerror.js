// vybe-test: js/symbol_to_primitive_coercion_hint/test_js_symbol_to_primitive_returning_object_throws_typeerror
...
try {
    ...
    __p(__line("ToPrimitive Non-Primitive TypeError"));
}
__checkLater("ToPrimitive Non-Primitive TypeError");
