// vybe-test: js/symbol_to_primitive_coercion_hint/test_js_symbol_to_primitive_default_hint
...
__p(__line(obj + "!")); // '+' operator triggers 'default' hint
__checkLater("DefaultValue!");
