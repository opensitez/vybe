// vybe-test: js/symbol_to_primitive_coercion_hint/test_js_symbol_to_primitive_template_literal_string_hint
...
__p(__line(`Value: ${obj}`));
__checkLater("Value: TemplateStringVal");
