// vybe-test: js/regexp_unicode_property_escapes_p_category/test_js_regexp_unicode_property_without_unicode_flag_throws_syntaxerror
...
try {
    eval("const re = /\\p{NotACategory}/u;"); // \\p without u or v flag is a SyntaxError!
} catch (e) {
    __p(__line("Unicode Property Escape Without u Flag SyntaxError"));
}
__checkLater("Unicode Property Escape Without u Flag SyntaxError");
