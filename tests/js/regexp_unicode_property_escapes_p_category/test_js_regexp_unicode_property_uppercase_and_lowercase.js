// vybe-test: js/regexp_unicode_property_escapes_p_category/test_js_regexp_unicode_property_uppercase_and_lowercase
...
__p(__line(`${upper}|${lower}`));
__checkLater("B,D|a,c");
