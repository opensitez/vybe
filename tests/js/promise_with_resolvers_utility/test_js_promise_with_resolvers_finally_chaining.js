// vybe-test: js/promise_with_resolvers_utility/test_js_promise_with_resolvers_finally_chaining
...
(async () => {
    await fin;
    __p(__line("FinallyCalled=" + finallyCalled));
})();
__checkLater("FinallyCalled=true");
