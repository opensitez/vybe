// vybe-test: js/promise_with_resolvers_utility/test_js_promise_with_resolvers_name_property
...
__p(__line(Promise.withResolvers.name));
__checkLater("withResolvers");
