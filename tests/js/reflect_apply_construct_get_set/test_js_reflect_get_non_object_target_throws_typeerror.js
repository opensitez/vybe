// vybe-test: js/reflect_apply_construct_get_set/test_js_reflect_get_non_object_target_throws_typeerror
...
try {
    ...
    __p(__line("Reflect.get Non-Object TypeError"));
}
__checkLater("Reflect.get Non-Object TypeError");
