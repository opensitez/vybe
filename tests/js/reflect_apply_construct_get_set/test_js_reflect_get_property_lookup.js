// vybe-test: js/reflect_apply_construct_get_set/test_js_reflect_get_property_lookup
...
const obj = { x: 10, y: 20 };
__p(__line(Reflect.get(obj, "x") + "|" + Reflect.get(obj, "missing")));
__checkLater("10|undefined");
