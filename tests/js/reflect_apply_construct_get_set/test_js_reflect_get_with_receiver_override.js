// vybe-test: js/reflect_apply_construct_get_set/test_js_reflect_get_with_receiver_override
...
__p(__line(Reflect.get(proto, "val", receiver)));
__checkLater("ReceiverValue");
