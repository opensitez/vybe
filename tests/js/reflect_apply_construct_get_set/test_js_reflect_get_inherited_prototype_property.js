// vybe-test: js/reflect_apply_construct_get_set/test_js_reflect_get_inherited_prototype_property
...
__p(__line(Reflect.get(obj, "parentProp")));
__checkLater("ParentValue");
