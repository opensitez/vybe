// vybe-test: js/reflect_apply_construct_get_set/test_js_reflect_set_non_extensible_object_returns_false
...
__p(__line(success + "|hasB=" + ("b" in obj)));
__checkLater("false|hasB=false");
