// vybe-test: js/reflect_apply_construct_get_set/test_js_reflect_apply_non_callable_throws_typeerror
...
try {
    ...
    __p(__line("Reflect.apply Non-Callable TypeError"));
}
__checkLater("Reflect.apply Non-Callable TypeError");
