// vybe-test: js/reflect_apply_construct_get_set/test_js_reflect_set_non_object_target_throws_typeerror
...
try {
    ...
    __p(__line("Reflect.set Non-Object TypeError"));
}
__checkLater("Reflect.set Non-Object TypeError");
