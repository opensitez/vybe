// vybe-test: js/function_call_apply_arguments_array/test_js_function_apply_non_object_non_null_args_throws_typeerror
...
try {
    ...
    __p(__line("apply Non-Object Args TypeError"));
}
__checkLater("apply Non-Object Args TypeError");
