// vybe-test: js/comma_operator_evaluation_and_expression_values/test_js_comma_operator_in_ternary_condition
...
__p(__line(res + "|Evaluated=" + evaluated));
__checkLater("no|Evaluated=true");
