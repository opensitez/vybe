// vybe-test: js/array_destructuring_elision_rest_element/test_js_array_destructuring_null_target_throws_typeerror
...
try {
    ...
    __p(__line("Array Destructure Null TypeError"));
}
__checkLater("Array Destructure Null TypeError");
