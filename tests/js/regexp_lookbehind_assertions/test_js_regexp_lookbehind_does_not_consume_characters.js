// vybe-test: js/regexp_lookbehind_assertions/test_js_regexp_lookbehind_does_not_consume_characters
...
__p(__line(match[0] + "|index=" + match.index)); // Index points to start of matched string 'coding'
__checkLater("coding|index=6");
