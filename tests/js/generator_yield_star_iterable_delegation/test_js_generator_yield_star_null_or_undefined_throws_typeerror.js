// vybe-test: js/generator_yield_star_iterable_delegation/test_js_generator_yield_star_null_or_undefined_throws_typeerror
...
try {
    ...
    __p(__line("yield* Null TypeError"));
}
__checkLater("yield* Null TypeError");
