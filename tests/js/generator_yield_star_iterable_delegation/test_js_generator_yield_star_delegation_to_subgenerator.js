// vybe-test: js/generator_yield_star_iterable_delegation/test_js_generator_yield_star_delegation_to_subgenerator
...
__p(__line([...outer()].join(",")));
__checkLater("a,b,innerDone");
