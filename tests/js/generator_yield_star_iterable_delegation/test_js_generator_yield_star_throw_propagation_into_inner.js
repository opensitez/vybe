// vybe-test: js/generator_yield_star_iterable_delegation/test_js_generator_yield_star_throw_propagation_into_inner
...
const g = outer();
g.next();
__p(__line(g.throw(new Error("DelegatedError")).value));
__checkLater("innerCaught: DelegatedError");
