// vybe-test: js/string_unicode_normalization/string_tostring_on_object_wrapper
...
__p(__line(Object.prototype.toString.call(new String("hi"))));
__checkLater("[object String]");
