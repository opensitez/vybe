// vybe-test: js/string_algorithms/is_palindrome_string
...
__p(__line(isPalindrome("A man, a plan, a canal: Panama")));
__p(__line(isPalindrome("race a car")));
__p(__line(isPalindrome("Was it a car or a cat I saw?")));
__checkLater("true\nfalse\ntrue");
