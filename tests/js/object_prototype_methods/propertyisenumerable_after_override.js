// vybe-test: js/object_prototype_methods/propertyisenumerable_after_override
...
const o={propertyIsEnumerable(){return true}}; __p(__line(o.propertyIsEnumerable("missing")));
__checkLater("true");
