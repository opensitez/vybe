// vybe-test: js/object_prototype_methods/object_tostring_tag_arraybuffer
...
__p(__line(Object.prototype.toString.call(new ArrayBuffer(8)).slice(8,-1)));
__checkLater("ArrayBuffer");
