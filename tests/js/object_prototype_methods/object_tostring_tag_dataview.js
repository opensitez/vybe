// vybe-test: js/object_prototype_methods/object_tostring_tag_dataview
...
__p(__line(Object.prototype.toString.call(new DataView(new ArrayBuffer(4))).slice(8,-1)));
__checkLater("DataView");
