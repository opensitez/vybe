// vybe-test: js/object_prototype_methods/tostring_call_arguments_object
...
function f(){__p(__line(Object.prototype.toString.call(arguments).slice(8,-1)));} f(1);
__checkLater("Arguments");
