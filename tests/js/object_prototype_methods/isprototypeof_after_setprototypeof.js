...
const a={}; const b={}; const c={}; Object.setPrototypeOf(c,a); __p(__line(a.isPrototypeOf(c))); Object.setPrototypeOf(c,b); __p(__line(a.isPrototypeOf(c))); __p(__line(b.isPrototypeOf(c)));
__checkLater("true\nfalse\ntrue");
