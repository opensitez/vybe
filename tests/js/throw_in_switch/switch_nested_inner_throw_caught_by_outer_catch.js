// vybe-test: js/throw_in_switch/switch_nested_inner_throw_caught_by_outer_catch
...
let o=[];try{switch(1){case 1:try{switch(2){case 2:throw new Error("inner");}}catch(e){o.push("in:"+e.message);}break;}}catch(e){o.push("out");}__p(__line(o.join(",")));
__checkLater("in:inner");
