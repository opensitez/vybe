// vybe-test: js/throw_in_switch/switch_case_assignments_run_before_throw
...
let o=[];try{switch(1){case 1:o.push("pre");throw new Error("post");default:o.push("d");}}catch(e){o.push(e.message);}__p(__line(o.join(",")));
__checkLater("pre,post");
