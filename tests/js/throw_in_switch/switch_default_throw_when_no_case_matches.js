// vybe-test: js/throw_in_switch/switch_default_throw_when_no_case_matches
...
let o=[];try{switch(99){case 1:throw new Error("case");default:throw new Error("default");}}catch(e){o.push(e.message);}__p(__line(o.join(",")));
__checkLater("default");
