// vybe-test: js/throw_in_switch/switch_null_discriminant_matches_null_case
...
let o=[];try{switch(null){case null:throw new Error("null-case");default:o.push("d");}}catch(e){o.push(e.message);}__p(__line(o.join(",")));
__checkLater("null-case");
