// vybe-test: js/ecma_strings/string_search_methods_with_positions
...
__p(__line("hello world".indexOf("o", 5)));
__p(__line("hello world".search(/world/)));
__p(__line("hello world".match(/o/g).length));
__checkLater("7\n6\n2");
