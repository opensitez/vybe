// vybe-test: js/error_subclasses_eval_range_reference_syntax_type_uri/test_js_error_subclasses_cause_support
...
__p(__line(err.cause.message));
__checkLater("Disk Full");
