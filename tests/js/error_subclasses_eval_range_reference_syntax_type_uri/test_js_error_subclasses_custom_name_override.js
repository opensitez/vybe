// vybe-test: js/error_subclasses_eval_range_reference_syntax_type_uri/test_js_error_subclasses_custom_name_override
...
__p(__line(err.toString()));
__checkLater("CustomSyntaxError: Bad Code");
