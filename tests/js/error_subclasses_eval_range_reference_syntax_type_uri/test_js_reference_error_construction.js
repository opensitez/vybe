// vybe-test: js/error_subclasses_eval_range_reference_syntax_type_uri/test_js_reference_error_construction
...
__p(__line(err.name + "|" + err.message + "|" + (err instanceof Error)));
__checkLater("ReferenceError|Variable Not Defined|true");
