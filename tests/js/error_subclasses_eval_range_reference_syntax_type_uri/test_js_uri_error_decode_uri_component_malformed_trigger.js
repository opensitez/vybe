// vybe-test: js/error_subclasses_eval_range_reference_syntax_type_uri/test_js_uri_error_decode_uri_component_malformed_trigger
...
try {
    ...
    __p(__line(e.name + "|" + (e instanceof URIError)));
}
__checkLater("URIError|true");
