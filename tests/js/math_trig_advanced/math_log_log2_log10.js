// vybe-test: js/math_trig_advanced/math_log_log2_log10
...
__p(__line(Math.log(1)));
__p(__line(Math.log(Math.E).toFixed(10)));
__p(__line(Math.log2(8)));
__p(__line(Math.log10(1000)));
__checkLater("0\n1.0000000000\n3\n3");
