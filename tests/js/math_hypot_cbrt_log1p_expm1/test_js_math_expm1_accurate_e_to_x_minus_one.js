// vybe-test: js/math_hypot_cbrt_log1p_expm1/test_js_math_expm1_accurate_e_to_x_minus_one
...
__p(__line(`${Math.expm1(0)}:${Math.expm1(-Infinity)}:${Math.expm1(1e-15) > 0}`));
__checkLater("0:-1:true");
