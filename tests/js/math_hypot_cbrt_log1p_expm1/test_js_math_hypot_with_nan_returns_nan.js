// vybe-test: js/math_hypot_cbrt_log1p_expm1/test_js_math_hypot_with_nan_returns_nan
...
__p(__line(Math.hypot(3, NaN) + "|" + Math.hypot(NaN, Infinity))); // Infinity takes precedence over NaN
__checkLater("NaN|Infinity");
