// vybe-test: js/math_hypot_cbrt_log1p_expm1/test_js_math_hypot_symbol_throws_typeerror
...
try {
    ...
    __p(__line("hypot Symbol TypeError"));
}
__checkLater("hypot Symbol TypeError");
