// vybe-test: js/intl_relative_time_format_duration/test_js_intl_relativetimeformat_invalid_unit_throws_rangeerror
...
try {
    ...
    __p(__line("Invalid Unit RangeError"));
}
__checkLater("Invalid Unit RangeError");
