// vybe-test: js/intl_relative_time_format_duration/test_js_intl_relativetimeformat_units_weeks_months_years
...
__p(__line(`${rtf.format(-1, "week")}:${rtf.format(3, "month")}:${rtf.format(-10, "year")}`));
__checkLater("1 week ago:in 3 months:10 years ago");
