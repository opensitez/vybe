// vybe-test: js/intl_relative_time_format_duration/test_js_intl_relativetimeformat_auto_numeric_yesterday_tomorrow
...
__p(__line(rtf.format(-1, "day") + "|" + rtf.format(1, "day") + "|" + rtf.format(0, "day")));
__checkLater("yesterday|tomorrow|today");
