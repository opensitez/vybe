// vybe-test: js/intl_relative_time_format_duration/test_js_intl_relativetimeformat_auto_numeric_quarter_this_last_next
...
__p(__line(rtf.format(-1, "quarter") + "|" + rtf.format(1, "quarter") + "|" + rtf.format(0, "quarter")));
__checkLater("last quarter|next quarter|this quarter");
