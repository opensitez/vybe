// vybe-test: js/class_expression_named_anonymous/test_js_class_expression_in_array_elements
...
__p(__line(new classList[0]().getType() + "|" + new classList[1]().getType()));
__checkLater("TypeA|TypeB");
