// vybe-test: js/class_expression_named_anonymous/test_js_class_expression_async_methods
...
new AsyncClass().fetch().then(res => __p(__line(res)));
__checkLater("AsyncResult");
