// vybe-test: js/class_expression_named_anonymous/test_js_class_expression_computed_method_names
...
__p(__line(new DynamicClass().dynamicExec()));
__checkLater("ExecSuccess");
