// vybe-test: js/promise_all_allsettled_race_any_combinators/test_js_promise_all_custom_iterable_input
...
Promise.all(generatePromises()).then(results => __p(__line(results.join(","))));
__checkLater("1,2");
