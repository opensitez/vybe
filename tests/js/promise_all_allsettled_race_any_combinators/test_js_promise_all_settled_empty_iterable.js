// vybe-test: js/promise_all_allsettled_race_any_combinators/test_js_promise_all_settled_empty_iterable
...
Promise.allSettled([]).then(results => __p(__line(results.length)));
__checkLater("0");
