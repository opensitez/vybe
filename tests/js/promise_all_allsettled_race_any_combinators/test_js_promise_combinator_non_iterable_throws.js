// vybe-test: js/promise_all_allsettled_race_any_combinators/test_js_promise_combinator_non_iterable_throws
...
try {
    ...
    __p(__line("Promise.all Non-Iterable TypeError"));
}
__checkLater("Promise.all Non-Iterable TypeError");
