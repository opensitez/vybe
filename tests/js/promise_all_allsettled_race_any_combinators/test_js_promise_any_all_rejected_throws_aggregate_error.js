// vybe-test: js/promise_all_allsettled_race_any_combinators/test_js_promise_any_all_rejected_throws_aggregate_error
...
Promise.any([
    ...
    __p(__line((err instanceof AggregateError) + "|" + err.errors.join(",")));
});
__checkLater("true|Error1,Error2");
