// vybe-test: js/promise_all_allsettled_race_any_combinators/test_js_promise_all_thenable_integration
...
Promise.all([thenable]).then(res => __p(__line(res[0])));
__checkLater("ThenableValue");
