// vybe-test: js/dataview_get_set_endianness_methods/test_js_dataview_constructor_non_arraybuffer_throws_typeerror
...
try {
    ...
    __p(__line("DataView Non-ArrayBuffer TypeError"));
}
__checkLater("DataView Non-ArrayBuffer TypeError");
