...
__p(__line(`BigEndian=0x${dv.getInt16(0, false).toString(16)}|LittleEndian=0x${dv.getInt16(0, true).toString(16)}`));
__checkLater("BigEndian=0x1234|LittleEndian=0x3412");
