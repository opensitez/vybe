// vybe-test: js/async_function_prototype/async_function_prototype_is_prototype_of_async_instances
...
async function f() {} __p(__line(AsyncFunction.prototype.isPrototypeOf(f)));
__checkLater("true");
