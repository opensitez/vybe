// vybe-test: js/async_function_prototype/async_function_apply_returns_promise
...
async function value() { return 4; } __p(__line(value.apply(null, []) instanceof Promise));
__checkLater("true");
