// vybe-test: js/class_static_private_fields_methods/test_js_class_static_private_method_async
...
AsyncLoader.fetch().then(res => __p(__line(res)));
__checkLater("AsyncData");
