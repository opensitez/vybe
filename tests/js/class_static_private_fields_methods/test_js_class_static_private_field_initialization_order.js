// vybe-test: js/class_static_private_fields_methods/test_js_class_static_private_field_initialization_order
...
__p(__line(OrderTracker.run() + "|Order=" + order.join(",")));
__checkLater("3|Order=Init A,Init B");
