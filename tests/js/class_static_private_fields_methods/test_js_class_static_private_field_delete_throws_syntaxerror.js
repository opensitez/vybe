// vybe-test: js/class_static_private_fields_methods/test_js_class_static_private_field_delete_throws_syntaxerror
...
class Target {
    ...
    static tryDelete() {
        try {
            ...
            __p(__line("Delete Static Private Error"));
        }
    }
}
Target.tryDelete();
__checkLater("Delete Static Private Error");
