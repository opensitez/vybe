// vybe-test: js/class_static_private_fields_methods/test_js_class_static_private_method_with_default_params
...
__p(__line(Formatter.format("Loaded")));
__checkLater("[APP] Loaded");
