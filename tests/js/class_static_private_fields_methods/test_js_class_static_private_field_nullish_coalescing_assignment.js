// vybe-test: js/class_static_private_fields_methods/test_js_class_static_private_field_nullish_coalescing_assignment
...
__p(__line(DB.connect()));
__checkLater("ActiveConnection");
