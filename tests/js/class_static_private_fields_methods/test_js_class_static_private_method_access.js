// vybe-test: js/class_static_private_fields_methods/test_js_class_static_private_method_access
...
__p(__line(Logger.log("App Started")));
__checkLater("[LOG] App Started");
