// vybe-test: js/intl_collator_compare_locale_options/test_js_intl_collator_numeric_sorting_option
...
__p(__line(defaultSort.join(",") + "|" + numericSort.join(",")));
__checkLater("file1,file10,file2|file1,file2,file10");
