// vybe-test: js/intl_collator_compare_locale_options/test_js_intl_collator_sensitivity_base_case_accent_ignored
...
__p(__line((collator.compare("a", "A") === 0) + "|" + (collator.compare("a", "á") === 0)));
