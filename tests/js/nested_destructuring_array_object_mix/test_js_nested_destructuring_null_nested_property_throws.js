// vybe-test: js/nested_destructuring_array_object_mix/test_js_nested_destructuring_null_nested_property_throws
...
try {
    ...
    __p(__line("Nested Null TypeError"));
}
__checkLater("Nested Null TypeError");
