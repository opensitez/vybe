// vybe-test: js/nested_destructuring_array_object_mix/test_js_nested_destructuring_mixed_primitive_wrappers
...
__p(__line(strLen + "|" + (typeof toFixed)));
__checkLater("3|function");
