// vybe-test: js/string_normalize_nfc_nfd_nfkc_nfkd/test_js_string_normalize_name_property
...
__p(__line(String.prototype.normalize.name));
__checkLater("normalize");
