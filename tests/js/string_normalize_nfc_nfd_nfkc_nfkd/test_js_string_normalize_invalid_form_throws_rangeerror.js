// vybe-test: js/string_normalize_nfc_nfd_nfkc_nfkd/test_js_string_normalize_invalid_form_throws_rangeerror
...
try {
    ...
    __p(__line("normalize Invalid Form RangeError"));
}
__checkLater("normalize Invalid Form RangeError");
