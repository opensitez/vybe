// vybe-test: js/promise_finally_errors/finally_return_on_allsettled
...
Promise.allSettled([Promise.reject("a")]).finally(()=>"fs").then(v=>__p(__line(v[0].status)));
__checkLater("rejected");
