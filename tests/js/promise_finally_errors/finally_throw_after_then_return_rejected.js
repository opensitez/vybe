// vybe-test: js/promise_finally_errors/finally_throw_after_then_return_rejected
...
Promise.resolve(0).then(()=>Promise.reject("tr")).finally(()=>{throw "f";}).catch(e=>__p(__line(e)));
__checkLater("f");
