// vybe-test: js/promise_finally_errors/finally_throw_reference_error
...
Promise.resolve(0).finally(()=>{throw new ReferenceError("ref");}).catch(e=>__p(__line(e.name)));
__checkLater("ReferenceError");
