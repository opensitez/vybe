// vybe-test: js/promise_finally_errors/finally_throw_from_nested_try
...
Promise.resolve(0).finally(()=>{try{throw "inner";}catch(e){throw "wrap:"+e;}}).catch(e=>__p(__line(e)));
__checkLater("wrap:inner");
