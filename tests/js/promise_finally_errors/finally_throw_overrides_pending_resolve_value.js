// vybe-test: js/promise_finally_errors/finally_throw_overrides_pending_resolve_value
...
Promise.resolve("pending").finally(()=>{throw "override";}).catch(e=>__p(__line(e)));
__checkLater("override");
