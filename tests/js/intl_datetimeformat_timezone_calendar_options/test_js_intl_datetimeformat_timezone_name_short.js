// vybe-test: js/intl_datetimeformat_timezone_calendar_options/test_js_intl_datetimeformat_timezone_name_short
...
__check(__line(formatter.format(date).includes("UTC")), "true");
