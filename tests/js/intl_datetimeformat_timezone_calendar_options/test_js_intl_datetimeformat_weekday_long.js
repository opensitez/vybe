// vybe-test: js/intl_datetimeformat_timezone_calendar_options/test_js_intl_datetimeformat_weekday_long
...
__p(__line(formatter.format(date)));
__checkLater("Wednesday");
