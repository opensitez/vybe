// vybe-test: js/intl_datetimeformat_timezone_calendar_options/test_js_intl_datetimeformat_format_to_parts
...
__p(__line(parts.map(p => `${p.type}:${p.value}`).join("|")));
__checkLater("month:7|literal:/|day:22|literal:/|year:2026");
