// vybe-test: js/string_code_point_at_from_code_point_surrogates/test_js_string_from_code_point_nan_throws_rangeerror
...
try {
    ...
    __p(__line("fromCodePoint NaN RangeError"));
}
__checkLater("fromCodePoint NaN RangeError");
