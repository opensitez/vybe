// vybe-test: js/string_code_point_at_from_code_point_surrogates/test_js_string_from_code_point_negative_code_point_throws_rangeerror
...
try {
    ...
    __p(__line("fromCodePoint Negative RangeError"));
}
__checkLater("fromCodePoint Negative RangeError");
