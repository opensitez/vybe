// vybe-test: js/string_code_point_at_from_code_point_surrogates/test_js_string_code_point_at_bmp_characters
...
const str = "ABC";
__p(__line(`${str.codePointAt(0)}:${str.codePointAt(1)}:${str.codePointAt(2)}`));
__checkLater("65:66:67");
