// vybe-test: js/string_code_point_at_from_code_point_surrogates/test_js_string_code_point_at_hex_formatting
...
const emoji = "🚀";
__p(__line("U+" + emoji.codePointAt(0).toString(16).toUpperCase()));
__checkLater("U+1F680");
