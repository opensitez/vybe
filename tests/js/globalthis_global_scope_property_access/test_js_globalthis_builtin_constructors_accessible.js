// vybe-test: js/globalthis_global_scope_property_access/test_js_globalthis_builtin_constructors_accessible
...
__p(__line(`${globalThis.Object === Object}:${globalThis.Array === Array}:${globalThis.Function === Function}`));
__checkLater("true:true:true");
