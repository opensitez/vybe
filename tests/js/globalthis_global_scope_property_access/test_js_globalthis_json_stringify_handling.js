// vybe-test: js/globalthis_global_scope_property_access/test_js_globalthis_json_stringify_handling
...
try {
    ...
    __p(__line("GlobalThis JSON Cycle TypeError"));
}
__checkLater("GlobalThis JSON Cycle TypeError");
