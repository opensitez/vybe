// vybe-test: js/async_generator_function_prototype/async_generator_method_instanceof_async_generator_function
...
const obj = { async *step() { yield 1; } }; __p(__line(obj.step instanceof AsyncGeneratorFunction));
__checkLater("true");
