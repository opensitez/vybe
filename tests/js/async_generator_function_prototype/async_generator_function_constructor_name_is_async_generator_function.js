// vybe-test: js/async_generator_function_prototype/async_generator_function_constructor_name_is_async_generator_function
...
__p(__line(AsyncGeneratorFunction.name));
__checkLater("AsyncGeneratorFunction");
