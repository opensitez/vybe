// vybe-test: js/async_generator_function_prototype/async_generator_function_apply_returns_async_iterator_object
...
async function* value() { yield 4; } __p(__line(typeof value.apply(null, []).next));
