...
async function* sum(a, b, c) { yield a + b + c; } const partial = AsyncGeneratorFunction.prototype.bind.call(sum, null, 1, 2); __p(__line(partial instanceof AsyncGeneratorFunction));
__checkLater("true");
