...
__p(__line(Number("42")));
__p(__line(Number("  3.14  "))); // trims whitespace
__p(__line(Number("")));
__p(__line(Number(null)));
__p(__line(Number(undefined)));
__p(__line(Number(true)));
__p(__line(Number(false)));
__checkLater("42\n3.14\n0\n0\nNaN\n1\n0");
