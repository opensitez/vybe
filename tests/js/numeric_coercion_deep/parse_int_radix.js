// vybe-test: js/numeric_coercion_deep/parse_int_radix
...
__p(__line(parseInt("0xFF", 16)));
__p(__line(parseInt("1010", 2)));
__p(__line(parseInt("37", 8)));
__p(__line(parseInt("z", 36)));
__checkLater("255\n10\n31\n35");
