// vybe-test: js/error_prototype_methods/custom_error_subclass_tostring_uses_subclass_name
...
class AppError extends Error {} __p(__line(new AppError("app").toString()));
__checkLater("Error: app");
