// vybe-test: js/atomics_operations_matrix/atomics_compare_exchange_succeeds_when_equal
...
const sab=new SharedArrayBuffer(4); const ia=new Int32Array(sab); ia[0]=5; __p(__line(Atomics.compareExchange(ia,0,5,9)));__p(__line(ia[0]));
__checkLater("5\n9");
