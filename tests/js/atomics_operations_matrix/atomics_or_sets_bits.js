// vybe-test: js/atomics_operations_matrix/atomics_or_sets_bits
...
const sab=new SharedArrayBuffer(4); const ia=new Int32Array(sab); ia[0]=1; Atomics.or(ia,0,8); __p(__line(ia[0]));
__checkLater("9");
