// vybe-test: js/atomics_operations_matrix/atomics_out_of_bounds_throws
...
const sab=new SharedArrayBuffer(4); const ia=new Int32Array(sab); try{Atomics.load(ia,1);}catch(e){__p(__line(e instanceof RangeError));}
__checkLater("true");
