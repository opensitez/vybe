// vybe-test: js/atomics_operations_matrix/atomics_exchange_replaces_with_new_value
...
const sab=new SharedArrayBuffer(4); const ia=new Int32Array(sab); ia[0]=7; __p(__line(Atomics.exchange(ia,0,99)));__p(__line(ia[0]));
__checkLater("7\n99");
