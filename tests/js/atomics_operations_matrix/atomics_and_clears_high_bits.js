// vybe-test: js/atomics_operations_matrix/atomics_and_clears_high_bits
...
const sab=new SharedArrayBuffer(4); const ia=new Int32Array(sab); ia[0]=255; Atomics.and(ia,0,15); __p(__line(ia[0]));
__checkLater("15");
