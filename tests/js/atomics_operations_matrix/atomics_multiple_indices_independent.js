...
const sab=new SharedArrayBuffer(8); const ia=new Int32Array(sab); Atomics.store(ia,0,1); Atomics.store(ia,1,2); __p(__line(Atomics.load(ia,0)));__p(__line(Atomics.load(ia,1)));
__checkLater("1\n2");
