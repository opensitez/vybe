// vybe-test: js/proxy_getprototypeof_setprototypeof/test_js_proxy_setprototypeof_returns_false_throws_in_strict
...
try {
    ...
    __p(__line("setPrototypeOf Returned False TypeError"));
}
__checkLater("setPrototypeOf Returned False TypeError");
