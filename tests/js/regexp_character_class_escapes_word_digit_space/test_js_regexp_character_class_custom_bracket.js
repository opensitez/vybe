// vybe-test: js/regexp_character_class_escapes_word_digit_space/test_js_regexp_character_class_custom_bracket
...
__p(__line(str.match(/[cbm]at/g).join(",")));
__checkLater("cat,bat,mat");
