// vybe-test: js/regexp_character_class_escapes_word_digit_space/test_js_regexp_character_class_ranges
...
const str = "a5z9!";
__p(__line(str.match(/[a-z]/g).join(",") + "|" + str.match(/[0-9]/g).join(",")));
__checkLater("a,z|5,9");
