// vybe-test: js/function_constructor_dynamic_code_creation/test_js_function_constructor_destructuring_parameters
...
__p(__line(fn({ name: "Bob", age: 30 })));
__checkLater("Bob is 30");
