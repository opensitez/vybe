// vybe-test: js/function_constructor_dynamic_code_creation/test_js_function_constructor_invalid_syntax_throws_syntaxerror
...
try {
    ...
    __p(__line("Function Constructor SyntaxError"));
}
__checkLater("Function Constructor SyntaxError");
