// vybe-test: js/atomics_wait_notify_async_wait/test_js_atomics_wait_zero_timeout_returns_timed_out_immediately
...
i32[0] = 7;
__p(__line(Atomics.wait(i32, 0, 7, 0)));
__checkLater("timed-out");
