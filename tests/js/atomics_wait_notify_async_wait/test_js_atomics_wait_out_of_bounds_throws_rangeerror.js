// vybe-test: js/atomics_wait_notify_async_wait/test_js_atomics_wait_out_of_bounds_throws_rangeerror
...
try {
    ...
    __p(__line("Atomics.wait Out of Bounds RangeError"));
}
__checkLater("Atomics.wait Out of Bounds RangeError");
