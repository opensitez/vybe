...
const obj = {};
__p(__line(Object.isSealed(obj)));  // false
__p(__line(Object.isFrozen(obj)));  // false (empty non-extensible would be frozen/sealed)
Object.seal(obj);
__p(__line(Object.isSealed(obj)));  // true
__checkLater("false\nfalse\ntrue");
