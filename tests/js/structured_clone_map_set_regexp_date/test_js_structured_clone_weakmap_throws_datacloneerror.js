// vybe-test: js/structured_clone_map_set_regexp_date/test_js_structured_clone_weakmap_throws_datacloneerror
...
try {
    ...
    __p(__line("DataCloneError WeakMap"));
}
__checkLater("DataCloneError WeakMap");
