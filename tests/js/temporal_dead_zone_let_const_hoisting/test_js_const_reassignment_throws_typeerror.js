// vybe-test: js/temporal_dead_zone_let_const_hoisting/test_js_const_reassignment_throws_typeerror
...
try {
    ...
    __p(__line("Const Reassignment TypeError"));
}
__checkLater("Const Reassignment TypeError");
