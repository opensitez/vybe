// vybe-test: js/temporal_dead_zone_let_const_hoisting/test_js_redeclaring_let_or_const_in_same_scope_throws_syntaxerror
...
try {
    ...
    __p(__line("Redeclare let SyntaxError"));
}
__checkLater("Redeclare let SyntaxError");
