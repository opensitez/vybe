// vybe-test: js/temporal_dead_zone_let_const_hoisting/test_js_tdz_typeof_operator_throws_referenceerror
...
try {
    ...
    __p(__line("TDZ typeof ReferenceError"));
}
__checkLater("TDZ typeof ReferenceError");
