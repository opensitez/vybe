// vybe-test: js/temporal_dead_zone_let_const_hoisting/test_js_tdz_class_declaration_access_before_declaration_throws
...
try {
    ...
    __p(__line("TDZ Class ReferenceError"));
}
__checkLater("TDZ Class ReferenceError");
