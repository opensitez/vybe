// vybe-test: js/temporal_dead_zone_let_const_hoisting/test_js_tdz_function_parameter_default_later_param_reference_throws
...
try {
    ...
    __p(__line("TDZ Default Later-Param ReferenceError"));
}
__checkLater("TDZ Default Later-Param ReferenceError");
