// vybe-test: js/implicit_type_coercion_addition_concatenation/test_js_plus_operator_bigint_and_string_concatenation
...
__p(__line((10n + "5") + "|" + ("5" + 10n)));
__checkLater("105|510");
