// vybe-test: js/implicit_type_coercion_addition_concatenation/test_js_implicit_coercion_in_template_literals
...
__p(__line(`${10}${true}${null}${undefined}`));
__checkLater("10truenullundefined");
