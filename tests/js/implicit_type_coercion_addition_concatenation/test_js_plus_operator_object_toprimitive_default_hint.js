// vybe-test: js/implicit_type_coercion_addition_concatenation/test_js_plus_operator_object_toprimitive_default_hint
...
__p(__line(obj + 10)); // + operator uses "default" hint!
__checkLater("defaultVal10");
