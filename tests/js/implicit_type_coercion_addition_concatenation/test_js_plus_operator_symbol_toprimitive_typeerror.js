// vybe-test: js/implicit_type_coercion_addition_concatenation/test_js_plus_operator_symbol_toprimitive_typeerror
...
try {
    ...
    __p(__line("Symbol ToPrimitive TypeError"));
}
__checkLater("Symbol ToPrimitive TypeError");
