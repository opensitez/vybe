...
class A{constructor(){this.chain=new.target.name;}} class B extends A{constructor(){super();}} class C extends B{constructor(){super();}} const c=new C();__p(__line(c.chain));
__checkLater("C");
