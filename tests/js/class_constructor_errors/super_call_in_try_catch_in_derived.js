...
class B{constructor(){throw new Error("b");}} class D extends B{constructor(){try{super();}catch(e){__p(__line(e.message));}}} try{new D();}catch(e){__p(__line(e instanceof ReferenceError));}
__checkLater("b\ntrue");
