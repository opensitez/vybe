...
__p(__line(Object.getPrototypeOf(proto) === Object.prototype));
__p(__line(Object.prototype.isPrototypeOf(obj)));
try {
    __p(__line(Object.prototype.isPrototypeOf(1)));
} catch (e) {
    __p(__line("PrimitiveTypeError"));
}
__checkLater("true\ntrue\nfalse");
