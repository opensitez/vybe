...
__p(__line(handle(new ValidationError("email", "invalid"))));
__p(__line(handle(new AuthError("forbidden"))));
__p(__line(handle(new Error("generic"))));
__checkLater("validation:email\nauth:forbidden\nunknown");
