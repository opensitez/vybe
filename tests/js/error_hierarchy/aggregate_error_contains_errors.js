...
__p(__line(agg instanceof AggregateError));
__p(__line(agg instanceof Error));
__p(__line(agg.message));
__p(__line(agg.errors.length));
__p(__line(agg.errors[0].message));
__checkLater("true\ntrue\nmultiple failures\n2\ne1");
