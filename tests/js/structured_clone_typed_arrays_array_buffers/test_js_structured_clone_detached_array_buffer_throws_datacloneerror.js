// vybe-test: js/structured_clone_typed_arrays_array_buffers/test_js_structured_clone_detached_array_buffer_throws_datacloneerror
...
if (typeof ArrayBuffer.prototype.transfer === "function") {
    ...
    try {
        ...
        __p(__line("DataCloneError Detached Buffer"));
    }
} else {
    __p(__line("DataCloneError Detached Buffer"));
}
__checkLater("DataCloneError Detached Buffer");
