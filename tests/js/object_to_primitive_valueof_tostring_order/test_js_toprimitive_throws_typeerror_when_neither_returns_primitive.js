// vybe-test: js/object_to_primitive_valueof_tostring_order/test_js_toprimitive_throws_typeerror_when_neither_returns_primitive
...
try {
    ...
    __p(__line("ToPrimitive TypeError"));
}
__checkLater("ToPrimitive TypeError");
