// vybe-test: js/object_to_primitive_valueof_tostring_order/test_js_toprimitive_string_hint_prefers_tostring
...
__p(__line(res + "|" + log.join(",")));
__checkLater("hello|toString");
