// vybe-test: js/json_parse_reviver_stringify_replacer_tojson/test_js_json_parse_invalid_syntax_throws_syntaxerror
...
try {
    ...
    __p(__line("JSON.parse SyntaxError"));
}
__checkLater("JSON.parse SyntaxError");
