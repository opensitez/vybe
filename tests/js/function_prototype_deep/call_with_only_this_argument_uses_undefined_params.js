// vybe-test: js/function_prototype_deep/call_with_only_this_argument_uses_undefined_params
...
function pair(a, b) { return [a, b]; } __p(__line(JSON.stringify(pair.call(null))));
__checkLater("[null,null]");
