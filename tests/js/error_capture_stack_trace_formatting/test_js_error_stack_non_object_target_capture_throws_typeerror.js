// vybe-test: js/error_capture_stack_trace_formatting/test_js_error_stack_non_object_target_capture_throws_typeerror
...
try {
    ...
    __p(__line("captureStackTrace Non-Object TypeError"));
}
__checkLater("captureStackTrace Non-Object TypeError");
