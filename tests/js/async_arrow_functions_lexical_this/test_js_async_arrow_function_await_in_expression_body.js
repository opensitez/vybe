// vybe-test: js/async_arrow_functions_lexical_this/test_js_async_arrow_function_await_in_expression_body
...
fetchVal().then(res => __p(__line(res)));
__checkLater("DirectExpression");
