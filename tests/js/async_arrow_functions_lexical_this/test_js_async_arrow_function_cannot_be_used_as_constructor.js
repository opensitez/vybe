// vybe-test: js/async_arrow_functions_lexical_this/test_js_async_arrow_function_cannot_be_used_as_constructor
...
try {
    ...
    __p(__line("Async Arrow Constructor TypeError"));
}
__checkLater("Async Arrow Constructor TypeError");
