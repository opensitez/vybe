// vybe-test: js/async_arrow_functions_lexical_this/test_js_async_arrow_function_immediately_invoked
...
(async () => "AsyncIIFE")().then(res => __p(__line(res)));
__checkLater("AsyncIIFE");
