// vybe-test: js/symbol_iterator_async_iterator_protocol/test_js_symbol_iterator_string_primitive
...
__p(__line(iter.next().value + "|done=" + iter.next().done));
__checkLater("A|done=true");
