// vybe-test: js/json_semantics_matrix/json_stringify_nan_and_infinity_in_array_become_null
...
__p(__line(JSON.stringify([NaN, Infinity, -Infinity])));
__checkLater("[null,null,null]");
