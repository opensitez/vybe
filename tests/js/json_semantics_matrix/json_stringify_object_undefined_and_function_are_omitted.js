// vybe-test: js/json_semantics_matrix/json_stringify_object_undefined_and_function_are_omitted
...
__p(__line(JSON.stringify({ a: 1, b: undefined, c: function () {}, d: null })));
__checkLater("{\"a\":1,\"d\":null}");
