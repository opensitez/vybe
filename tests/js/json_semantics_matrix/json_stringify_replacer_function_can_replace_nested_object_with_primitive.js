// vybe-test: js/json_semantics_matrix/json_stringify_replacer_function_can_replace_nested_object_with_primitive
...
__p(__line(JSON.stringify({ a: { b: 2 } }, (key, value) => {
    return key === "a" ? "boxed" : value;
})));
__checkLater("{\"a\":\"boxed\"}");
