// vybe-test: js/json_semantics_matrix/json_stringify_array_undefined_and_function_become_null
...
__p(__line(JSON.stringify([undefined, function () {}, 3])));
__checkLater("[null,null,3]");
