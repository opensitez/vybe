// vybe-test: js/json_semantics_matrix/json_stringify_nan_and_infinity_in_object_become_null
...
__p(__line(JSON.stringify({ a: NaN, b: Infinity, c: -Infinity })));
__checkLater("{\"a\":null,\"b\":null,\"c\":null}");
