// vybe-test: js/json_semantics_matrix/json_stringify_replacer_function_can_prune_property
...
__p(__line(JSON.stringify({ a: 1, b: 2, c: 3 }, (key, value) => {
    return key === "b" ? undefined : value;
})));
__checkLater("{\"a\":1,\"c\":3}");
