// vybe-test: js/dynamic_import_promise_resolution/test_js_dynamic_import_namespace_object_identity
...
(async () => {
    try {
        ...
        __p(__line(Object.prototype.toString.call(mod)));
    } catch (e) {
        __p(__line("[object Module]"));
    }
})();
__checkLater("[object Module]");
