// vybe-test: js/dynamic_import_promise_resolution/test_js_dynamic_import_side_effect_execution_order
...
(async () => {
    try {
        ...
        __p(__line("SideEffectExecuted"));
    }
})();
__checkLater("SideEffectExecuted");
