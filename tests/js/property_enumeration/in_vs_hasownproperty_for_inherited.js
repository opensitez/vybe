...
obj.own = 1;
__p(__line("own" in obj));
__p(__line("inherited" in obj));   // user-defined inherited property
__p(__line(obj.hasOwnProperty("own")));
__p(__line(obj.hasOwnProperty("inherited")));
__checkLater("true\ntrue\ntrue\nfalse");
