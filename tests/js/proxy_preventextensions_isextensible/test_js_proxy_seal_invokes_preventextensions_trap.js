// vybe-test: js/proxy_preventextensions_isextensible/test_js_proxy_seal_invokes_preventextensions_trap
...
Object.seal(proxy);
__p(__line(preventCalled + "|isSealed=" + Object.isSealed(proxy)));
__checkLater("true|isSealed=true");
