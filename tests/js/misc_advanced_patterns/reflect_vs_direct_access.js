...
__p(__line(Reflect.get(obj, "x")));
__p(__line(Reflect.has(obj, "y")));
__p(__line(Reflect.ownKeys(obj).join(",")));
__p(__line(Reflect.deleteProperty(obj, "x")));
__p(__line(Reflect.deleteProperty(obj, "y")));
__checkLater("1\ntrue\nx,y\ntrue\nfalse");
