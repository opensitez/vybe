// vybe-test: js/async_generator_yield_await_interleaving/test_js_async_generator_exhausted_subsequent_calls
...
(async () => {
    ...
    __p(__line(`${r3.value}:${r3.done}`));
})();
__checkLater("undefined:true");
