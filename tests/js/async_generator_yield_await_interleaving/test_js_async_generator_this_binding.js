// vybe-test: js/async_generator_yield_await_interleaving/test_js_async_generator_this_binding
...
(async () => {
    ...
    for await (const item of s.generate()) __p(__line(item));
})();
__checkLater("Stream_1");
