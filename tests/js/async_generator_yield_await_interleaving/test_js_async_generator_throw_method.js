// vybe-test: js/async_generator_yield_await_interleaving/test_js_async_generator_throw_method
...
(async () => {
    ...
    __p(__line(res.value));
})();
__checkLater("HandledInAsyncGen: AsyncError");
