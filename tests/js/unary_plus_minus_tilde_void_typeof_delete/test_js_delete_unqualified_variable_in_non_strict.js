// vybe-test: js/unary_plus_minus_tilde_void_typeof_delete/test_js_delete_unqualified_variable_in_non_strict
...
__p(__line(res + "|hasGlob=" + ("gVar" in globalThis)));
__checkLater("true|hasGlob=false");
