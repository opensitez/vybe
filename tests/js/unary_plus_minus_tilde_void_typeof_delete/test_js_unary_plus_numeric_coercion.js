// vybe-test: js/unary_plus_minus_tilde_void_typeof_delete/test_js_unary_plus_numeric_coercion
...
__p(__line(`${+"42"}:${+true}:${+false}:${+null}:${+undefined}:${+""}`));
__checkLater("42:1:0:0:NaN:0");
