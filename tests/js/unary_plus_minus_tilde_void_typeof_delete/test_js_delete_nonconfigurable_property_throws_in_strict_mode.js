// vybe-test: js/unary_plus_minus_tilde_void_typeof_delete/test_js_delete_nonconfigurable_property_throws_in_strict_mode
...
try {
    ...
    __p(__line("Delete NonConfigurable Strict TypeError"));
}
__checkLater("Delete NonConfigurable Strict TypeError");
