// vybe-test: js/unary_plus_minus_tilde_void_typeof_delete/test_js_unary_plus_bigint_throws_typeerror
...
try {
    ...
    __p(__line("Unary Plus BigInt TypeError"));
}
__checkLater("Unary Plus BigInt TypeError");
