// vybe-test: js/unary_plus_minus_tilde_void_typeof_delete/test_js_unary_minus_numeric_negation
...
__p(__line(`${-"5"}:${-(-10)}:${-true}:${-null}:${-undefined}`));
__checkLater("-5:10:-1:0:NaN");
