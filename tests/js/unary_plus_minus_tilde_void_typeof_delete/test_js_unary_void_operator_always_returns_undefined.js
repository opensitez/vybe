// vybe-test: js/unary_plus_minus_tilde_void_typeof_delete/test_js_unary_void_operator_always_returns_undefined
...
__p(__line((res === undefined) + "|SideEffect=" + sideEffect));
__checkLater("true|SideEffect=100");
