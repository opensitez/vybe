// vybe-test: js/unary_plus_minus_tilde_void_typeof_delete/test_js_delete_declared_var_in_non_strict_returns_false
...
__p(__line(res + "|declaredVar=" + declaredVar));
__checkLater("false|declaredVar=50");
