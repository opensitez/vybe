// vybe-test: js/intl_pluralrules_select_ordinal_cardinal/test_js_intl_pluralrules_minimum_fraction_digits
...
__p(__line(rules.select(1))); // 1.00 in en-US is 'other' for cardinal!
__checkLater("other");
