// vybe-test: js/intl_pluralrules_select_ordinal_cardinal/test_js_intl_pluralrules_select_range_cardinal
...
__p(__line(rules.selectRange(0, 1) + "|" + rules.selectRange(1, 2)));
__checkLater("other|other");
