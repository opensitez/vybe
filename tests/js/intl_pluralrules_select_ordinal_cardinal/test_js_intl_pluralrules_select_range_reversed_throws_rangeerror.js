// vybe-test: js/intl_pluralrules_select_ordinal_cardinal/test_js_intl_pluralrules_select_range_reversed_throws_rangeerror
...
try {
    ...
    __p(__line("selectRange Reversed RangeError"));
}
__checkLater("selectRange Reversed RangeError");
