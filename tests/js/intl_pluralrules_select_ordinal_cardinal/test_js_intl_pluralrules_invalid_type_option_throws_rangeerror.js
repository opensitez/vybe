// vybe-test: js/intl_pluralrules_select_ordinal_cardinal/test_js_intl_pluralrules_invalid_type_option_throws_rangeerror
...
try {
    ...
    __p(__line("Invalid PluralRules Type RangeError"));
}
__checkLater("Invalid PluralRules Type RangeError");
