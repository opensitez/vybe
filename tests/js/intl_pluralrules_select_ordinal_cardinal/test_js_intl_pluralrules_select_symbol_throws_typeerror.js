// vybe-test: js/intl_pluralrules_select_ordinal_cardinal/test_js_intl_pluralrules_select_symbol_throws_typeerror
...
try {
    ...
    __p(__line("PluralRules Select Symbol TypeError"));
}
__checkLater("PluralRules Select Symbol TypeError");
