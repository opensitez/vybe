// vybe-test: js/intl_pluralrules_select_ordinal_cardinal/test_js_intl_pluralrules_select_range_nan_throws_rangeerror
...
try {
    ...
    __p(__line("selectRange NaN RangeError"));
}
__checkLater("selectRange NaN RangeError");
