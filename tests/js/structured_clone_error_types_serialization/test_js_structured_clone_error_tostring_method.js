// vybe-test: js/structured_clone_error_types_serialization/test_js_structured_clone_error_tostring_method
...
__p(__line(clone.toString()));
__checkLater("TypeError: Invalid Type");
