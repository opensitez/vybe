// vybe-test: js/structured_clone_error_types_serialization/test_js_structured_clone_type_error_subclass
...
__p(__line((clone instanceof TypeError) + "|" + (clone.name === "TypeError") + "|" + (clone.message === "Invalid argument")));
