// vybe-test: js/structured_clone_error_types_serialization/test_js_structured_clone_reference_error_subclass
...
__p(__line((clone instanceof ReferenceError) + "|" + clone.message));
__checkLater("true|Not defined");
