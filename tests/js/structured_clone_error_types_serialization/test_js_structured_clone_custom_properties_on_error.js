// vybe-test: js/structured_clone_error_types_serialization/test_js_structured_clone_custom_properties_on_error
...
__check(__line(clone.code + "|" + clone.status), "ERR_NOT_FOUND|404");
