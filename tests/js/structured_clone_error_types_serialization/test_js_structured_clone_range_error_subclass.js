// vybe-test: js/structured_clone_error_types_serialization/test_js_structured_clone_range_error_subclass
...
__p(__line((clone instanceof RangeError) + "|" + clone.message));
__checkLater("true|Out of bounds");
