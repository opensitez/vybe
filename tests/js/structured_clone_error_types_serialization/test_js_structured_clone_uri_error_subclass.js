// vybe-test: js/structured_clone_error_types_serialization/test_js_structured_clone_uri_error_subclass
...
__p(__line((clone instanceof URIError) + "|" + clone.message));
__checkLater("true|URI error");
