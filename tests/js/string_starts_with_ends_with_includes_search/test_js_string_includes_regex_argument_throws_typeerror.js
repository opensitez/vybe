// vybe-test: js/string_starts_with_ends_with_includes_search/test_js_string_includes_regex_argument_throws_typeerror
...
try {
    ...
    __p(__line("includes RegEx TypeError"));
}
__checkLater("includes RegEx TypeError");
