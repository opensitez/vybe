// vybe-test: js/string_starts_with_ends_with_includes_search/test_js_string_ends_with_regex_argument_throws_typeerror
...
try {
    ...
    __p(__line("endsWith RegEx TypeError"));
}
__checkLater("endsWith RegEx TypeError");
