// vybe-test: js/prototype_chain_shadowing_property_lookup/test_js_prototype_chain_for_in_loop_shadowing_hides_prototype_key
...
__p(__line(keys.join(",") + "|Count=" + keys.length));
__checkLater("key|Count=1");
