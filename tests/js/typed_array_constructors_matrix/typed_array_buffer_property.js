// vybe-test: js/typed_array_constructors_matrix/typed_array_buffer_property
...
const buf=new ArrayBuffer(8); const a=new Uint8Array(buf); __p(__line(a.buffer===buf));
__checkLater("true");
