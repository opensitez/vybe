// vybe-test: js/typed_array_constructors_matrix/biguint64array_large_bigint
...
const a=new BigUint64Array([18446744073709551615n]); __p(__line(a[0]));
__checkLater("18446744073709551615n");
