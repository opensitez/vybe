// vybe-test: js/array_find_last_and_find_last_index/test_js_array_find_last_non_callable_predicate_throws_typeerror
...
try {
    ...
    __p(__line("findLast Predicate TypeError"));
}
__checkLater("findLast Predicate TypeError");
