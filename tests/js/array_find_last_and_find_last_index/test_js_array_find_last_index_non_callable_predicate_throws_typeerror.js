// vybe-test: js/array_find_last_and_find_last_index/test_js_array_find_last_index_non_callable_predicate_throws_typeerror
...
try {
    ...
    __p(__line("findLastIndex Predicate TypeError"));
}
__checkLater("findLastIndex Predicate TypeError");
