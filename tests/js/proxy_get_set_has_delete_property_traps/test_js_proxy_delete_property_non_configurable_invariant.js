// vybe-test: js/proxy_get_set_has_delete_property_traps/test_js_proxy_delete_property_non_configurable_invariant
...
try {
    ...
    __p(__line("Delete Non-Configurable Invariant Error"));
}
__checkLater("Delete Non-Configurable Invariant Error");
