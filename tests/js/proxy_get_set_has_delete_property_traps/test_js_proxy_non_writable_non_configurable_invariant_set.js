// vybe-test: js/proxy_get_set_has_delete_property_traps/test_js_proxy_non_writable_non_configurable_invariant_set
...
try {
    ...
    __p(__line("Proxy Invariant Set Violation"));
}
__checkLater("Proxy Invariant Set Violation");
