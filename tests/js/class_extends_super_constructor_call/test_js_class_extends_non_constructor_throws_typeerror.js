// vybe-test: js/class_extends_super_constructor_call/test_js_class_extends_non_constructor_throws_typeerror
...
try {
    ...
    __p(__line("Extends Non-Constructor TypeError"));
}
__checkLater("Extends Non-Constructor TypeError");
