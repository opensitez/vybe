// vybe-test: js/class_extends_super_constructor_call/test_js_class_derived_ctor_returning_custom_object_overrides_this
...
const s = new Sub();
__p(__line(s.custom + "|" + (s instanceof Sub)));
__checkLater("OverrideThis|false");
