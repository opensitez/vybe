// vybe-test: js/array_find_findindex_findlast_findlastindex/test_js_array_findlast_sparse_array_holes_visited_as_undefined
...
__p(__line(visited.join(",")));
__checkLater("3,undefined,1");
