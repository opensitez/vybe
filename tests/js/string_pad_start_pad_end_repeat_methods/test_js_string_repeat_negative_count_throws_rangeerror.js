// vybe-test: js/string_pad_start_pad_end_repeat_methods/test_js_string_repeat_negative_count_throws_rangeerror
...
try {
    ...
    __p(__line("repeat Negative RangeError"));
}
__checkLater("repeat Negative RangeError");
