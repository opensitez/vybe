// vybe-test: js/string_pad_start_pad_end_repeat_methods/test_js_string_repeat_infinity_count_throws_rangeerror
...
try {
    ...
    __p(__line("repeat Infinity RangeError"));
}
__checkLater("repeat Infinity RangeError");
