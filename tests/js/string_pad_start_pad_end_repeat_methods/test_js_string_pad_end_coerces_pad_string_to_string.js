// vybe-test: js/string_pad_start_pad_end_repeat_methods/test_js_string_pad_end_coerces_pad_string_to_string
...
const str = "val:";
__p(__line(str.padEnd(8, 123)));
__checkLater("val:1231");
