// vybe-test: js/string_pad_start_pad_end_repeat_methods/test_js_string_pad_start_null_or_undefined_this_throws_typeerror
...
try {
    ...
    __p(__line("padStart Null This TypeError"));
}
__checkLater("padStart Null This TypeError");
