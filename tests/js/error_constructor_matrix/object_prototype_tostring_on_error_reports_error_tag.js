// vybe-test: js/error_constructor_matrix/object_prototype_tostring_on_error_reports_error_tag
...
__p(__line(Object.prototype.toString.call(new Error("x"))));
__checkLater("[object Error]");
