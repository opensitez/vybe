// vybe-test: js/class_private_fields_get_set_access/test_js_class_private_field_duplicate_declaration_throws_syntaxerror
...
try {
    ...
    __p(__line("Duplicate Private Field SyntaxError"));
}
__checkLater("Duplicate Private Field SyntaxError");
