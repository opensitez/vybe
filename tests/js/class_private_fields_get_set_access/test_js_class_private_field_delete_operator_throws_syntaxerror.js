// vybe-test: js/class_private_fields_get_set_access/test_js_class_private_field_delete_operator_throws_syntaxerror
...
class Lock {
    ...
    tryDelete() {
        try {
            ...
            __p(__line("Delete Private Field Error"));
        }
    }
}
new Lock().tryDelete();
__checkLater("Delete Private Field Error");
