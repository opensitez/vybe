// vybe-test: js/promise_resolve_reject_deferred_execution/test_js_promise_with_resolvers_utility_es2024
...
promise.then(v => __p(__line("WithResolvers: " + v)));
resolve("SuccessVal");
__checkLater("WithResolvers: SuccessVal");
