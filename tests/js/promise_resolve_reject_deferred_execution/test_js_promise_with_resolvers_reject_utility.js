// vybe-test: js/promise_resolve_reject_deferred_execution/test_js_promise_with_resolvers_reject_utility
...
promise.catch(err => __p(__line("WithResolversError: " + err)));
reject("FailReason");
__checkLater("WithResolversError: FailReason");
