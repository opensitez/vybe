// vybe-test: js/promise_resolve_reject_deferred_execution/test_js_promise_then_callbacks_always_asynchronous_microtask
...
__p(__line("Start"));
Promise.resolve().then(() => __p(__line("Microtask 1")));
__p(__line("End"));
__checkLater("Start\nEnd\nMicrotask 1");
