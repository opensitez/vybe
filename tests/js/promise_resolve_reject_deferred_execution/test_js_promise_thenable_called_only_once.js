// vybe-test: js/promise_resolve_reject_deferred_execution/test_js_promise_thenable_called_only_once
...
Promise.resolve(multicallThenable).then(res => __p(__line(res)));
__checkLater("FirstCall");
