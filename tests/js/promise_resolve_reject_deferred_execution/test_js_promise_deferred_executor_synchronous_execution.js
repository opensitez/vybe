// vybe-test: js/promise_resolve_reject_deferred_execution/test_js_promise_deferred_executor_synchronous_execution
...
__p(__line("Before Promise"));
new Promise(resolve => {
    __p(__line("Inside Executor"));
    resolve("Done");
});
__p(__line("After Promise"));
__checkLater("Before Promise\nInside Executor\nAfter Promise");
