// vybe-test: js/typed_array_from_of_constructors/test_js_typedarray_from_null_iterable_throws_typeerror
...
try {
    ...
    __p(__line("Uint8Array.from Null TypeError"));
}
__checkLater("Uint8Array.from Null TypeError");
