// vybe-test: js/typed_array_from_of_constructors/test_js_typedarray_from_subclass_constructor_inheritance
...
__p(__line(cu8.join(",") + "|isCustom=" + (cu8 instanceof CustomUint8)));
__checkLater("1,2,3|isCustom=true");
