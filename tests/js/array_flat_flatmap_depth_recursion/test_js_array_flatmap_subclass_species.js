// vybe-test: js/array_flat_flatmap_depth_recursion/test_js_array_flatmap_subclass_species
...
__p(__line(res.join(",") + "|isCustom=" + (res instanceof CustomArray)));
__checkLater("2,4|isCustom=true");
