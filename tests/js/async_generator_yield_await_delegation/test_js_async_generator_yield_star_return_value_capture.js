// vybe-test: js/async_generator_yield_await_delegation/test_js_async_generator_yield_star_return_value_capture
...
(async () => {
    ...
    __p(__line(items.join(",")));
})();
__checkLater("1,Captured: ReturnValue");
