// vybe-test: js/array_splice_to_spliced_slice_mutation/test_js_array_tospliced_species_returns_base_array
...
__p(__line(spliced.join(",") + "|isCustom=" + (spliced instanceof CustomArray)));
__checkLater("2,3|isCustom=false");
