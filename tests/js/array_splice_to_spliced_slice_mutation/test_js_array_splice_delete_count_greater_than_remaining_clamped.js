// vybe-test: js/array_splice_to_spliced_slice_mutation/test_js_array_splice_delete_count_greater_than_remaining_clamped
...
__p(__line(arr.join(",") + "|removed=" + removed.join(",")));
__checkLater("1|removed=2,3,4");
