// vybe-test: js/array_splice_to_spliced_slice_mutation/test_js_array_splice_zero_delete_count_inserts_only
...
__p(__line(arr.join(",") + "|removedLen=" + removed.length));
__checkLater("1,2,3,4|removedLen=0");
