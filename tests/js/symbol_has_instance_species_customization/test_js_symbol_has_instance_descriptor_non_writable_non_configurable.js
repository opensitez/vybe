// vybe-test: js/symbol_has_instance_species_customization/test_js_symbol_has_instance_descriptor_non_writable_non_configurable
...
__p(__line(desc.writable + "|" + desc.configurable));
