// vybe-test: js/symbol_has_instance_species_customization/test_js_symbol_has_instance_non_object_rhs_throws_typeerror
...
try {
    ...
    __p(__line("instanceof Right-Hand Side Null TypeError"));
}
__checkLater("instanceof Right-Hand Side Null TypeError");
