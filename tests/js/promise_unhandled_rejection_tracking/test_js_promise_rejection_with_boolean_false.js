// vybe-test: js/promise_unhandled_rejection_tracking/test_js_promise_rejection_with_boolean_false
...
Promise.reject(false).catch(err => __p(__line("Rejected False: " + err)));
__checkLater("Rejected False: false");
