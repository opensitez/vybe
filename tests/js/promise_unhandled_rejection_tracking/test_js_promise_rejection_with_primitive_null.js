// vybe-test: js/promise_unhandled_rejection_tracking/test_js_promise_rejection_with_primitive_null
...
Promise.reject(null)
    .catch(err => __p(__line("Rejected Null: " + (err === null))));
__checkLater("Rejected Null: true");
