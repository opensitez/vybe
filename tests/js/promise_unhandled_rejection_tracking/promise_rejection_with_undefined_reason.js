// vybe-test: js/promise_unhandled_rejection_tracking/promise_rejection_with_undefined_reason
...
Promise.reject(undefined).catch(reason => __p(__line(reason === undefined)));
__checkLater("true");
