// vybe-test: js/promise_unhandled_rejection_tracking/test_js_promise_error_stack_trace_preservation
...
Promise.reject(err).catch(e => __p(__line(e.stack !== undefined)));
__checkLater("true");
