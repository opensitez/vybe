// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_function_call_expressions
...
__p(__line(`Hello ${formatName("bob")}`));
__checkLater("Hello BOB");
