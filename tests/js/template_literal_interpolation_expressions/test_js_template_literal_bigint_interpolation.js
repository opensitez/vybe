// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_bigint_interpolation
...
__p(__line(`BigInt: ${big}`));
__checkLater("BigInt: 9007199254740991");
