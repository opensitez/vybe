// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_logical_assignment_expression
...
let config = { port: 0 };
__p(__line(`Port: ${config.port ||= 8080}`));
__checkLater("Port: 8080");
