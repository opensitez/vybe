// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_optional_chaining_expression
...
__p(__line(`Address: ${data.user?.address?.city}`));
__checkLater("Address: undefined");
