// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_string_raw_preserves_backslashes
...
__p(__line(`Path: ${value}`));
__checkLater("Path: C:\\Program Files\\Node");
