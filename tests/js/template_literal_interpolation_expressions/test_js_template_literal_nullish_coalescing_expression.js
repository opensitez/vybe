// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_nullish_coalescing_expression
...
const value = null;
__p(__line(`Output: ${value ?? "DefaultFallback"}`));
__checkLater("Output: DefaultFallback");
