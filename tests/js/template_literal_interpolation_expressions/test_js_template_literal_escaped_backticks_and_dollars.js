// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_escaped_backticks_and_dollars
...
const amount = 50;
__p(__line(`Price: \$${amount} \`code\``));
__checkLater("Price: $50 `code`");
