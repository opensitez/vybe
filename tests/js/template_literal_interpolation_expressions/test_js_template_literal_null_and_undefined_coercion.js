// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_null_and_undefined_coercion
...
__p(__line(`Values: ${null} and ${undefined}`));
__checkLater("Values: null and undefined");
