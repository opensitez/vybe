// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_explicitly_constructed_expression_marker
...
const suffix = "value}";
__p(__line(`literal: ${"${" + suffix}`));
__checkLater("literal: ${value}");
