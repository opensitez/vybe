// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_implicit_to_string_conversion
...
__p(__line(`Result: ${customObj}`));
__checkLater("Result: CustomObjString");
