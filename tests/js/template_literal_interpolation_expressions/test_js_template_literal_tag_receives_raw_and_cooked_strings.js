...
function capture(strings, value) {
    __p(__line(strings.length));
    __p(__line(strings.raw.length));
    __p(__line(strings[0] === "a\nb"));
    __p(__line(strings.raw[0] === "a\\nb"));
    __p(__line(value));
    __p(__line(strings[1] === "c"));
    __p(__line(strings.raw[1] === "c"));
}
capture`a\nb${42}c`;
__checkLater("2\n2\ntrue\ntrue\n42\ntrue\ntrue");
