// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_array_method_expressions
...
__p(__line(`Items: ${items.join(" & ")}`));
__checkLater("Items: apple & banana");
