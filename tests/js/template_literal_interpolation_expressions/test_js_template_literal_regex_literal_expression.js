// vybe-test: js/template_literal_interpolation_expressions/test_js_template_literal_regex_literal_expression
...
__p(__line(`Match: ${/abc/.test("abcdef")}`));
__checkLater("Match: true");
