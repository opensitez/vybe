// vybe-test: js/math_imul_fround_clz32_trunc/test_js_math_imul_symbol_argument_throws_typeerror
...
try {
    ...
    __p(__line("imul Symbol TypeError"));
}
__checkLater("imul Symbol TypeError");
