// vybe-test: js/math_imul_fround_clz32_trunc/test_js_math_fround_single_precision_float
...
__p(__line(Math.fround(1.5) + "|" + (Math.fround(1.337) !== 1.337)));
__checkLater("1.5|true");
