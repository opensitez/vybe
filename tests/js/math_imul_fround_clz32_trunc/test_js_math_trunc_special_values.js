// vybe-test: js/math_imul_fround_clz32_trunc/test_js_math_trunc_special_values
...
__p(__line(`${Math.trunc(NaN)}:${Math.trunc(Infinity)}:${Math.trunc(-Infinity)}`));
__checkLater("NaN:Infinity:-Infinity");
