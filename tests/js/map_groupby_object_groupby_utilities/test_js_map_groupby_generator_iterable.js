// vybe-test: js/map_groupby_object_groupby_utilities/test_js_map_groupby_generator_iterable
...
__p(__line(grouped.get(3).join(",") + "|" + grouped.get(8).join(",")));
__checkLater("cat,dog|elephant");
