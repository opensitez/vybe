// vybe-test: js/reflect_apply_construct_get_set_methods/test_js_reflect_is_extensible_primitives_throw_typeerror
...
try {
    ...
    __p(__line("Reflect Primitive TypeError"));
}
__checkLater("Reflect Primitive TypeError");
