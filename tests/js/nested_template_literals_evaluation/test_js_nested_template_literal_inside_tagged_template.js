// vybe-test: js/nested_template_literals_evaluation/test_js_nested_template_literal_inside_tagged_template
...
const val = 42;
__p(__line(tag`Result: ${`Value = ${val}`}`));
__checkLater("Result: Value = 42");
