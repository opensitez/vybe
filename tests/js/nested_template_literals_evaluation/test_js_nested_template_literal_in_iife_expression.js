// vybe-test: js/nested_template_literals_evaluation/test_js_nested_template_literal_in_iife_expression
...
__p(__line((() => `IIFE_${`Value_${123}`}`)()));
__checkLater("IIFE_Value_123");
