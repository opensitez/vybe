// vybe-test: js/nested_template_literals_evaluation/test_js_nested_template_literal_conditional_rendering
...
__p(__line(`User Info: ${user.name} ${user.role ? `[Role: ${user.role.toUpperCase()}]` : ""}`));
__checkLater("User Info: Alice [Role: ADMIN]");
