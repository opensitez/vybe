// vybe-test: js/nested_template_literals_evaluation/test_js_nested_template_literal_closure_lexical_scope
...
__p(__line(fmt("World")));
__checkLater("LOG: Hello World");
