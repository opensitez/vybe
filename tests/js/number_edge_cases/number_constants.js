...
__p(__line(Number.MAX_SAFE_INTEGER === 2**53 - 1));
__p(__line(Number.MIN_SAFE_INTEGER === -(2**53 - 1)));
__p(__line(Number.POSITIVE_INFINITY === Infinity));
__p(__line(Number.NEGATIVE_INFINITY === -Infinity));
__p(__line(Number.isNaN(Number.NaN)));
__checkLater("true\ntrue\ntrue\ntrue\ntrue");
