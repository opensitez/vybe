// vybe-test: js/finally_return_override/finally_return_overrides_catch_return
...
function f(){try{throw 1;}catch{return "catch";}finally{return "finally";}}__p(__line(f()));
__checkLater("finally");
