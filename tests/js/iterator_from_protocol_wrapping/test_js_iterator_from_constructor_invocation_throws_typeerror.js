// vybe-test: js/iterator_from_protocol_wrapping/test_js_iterator_from_constructor_invocation_throws_typeerror
...
if (typeof Iterator !== "undefined" && typeof Iterator.from === "function") {
    try {
        ...
        __p(__line("Iterator.from Constructor TypeError"));
    }
} else {
    __p(__line("Iterator.from Constructor TypeError"));
}
__checkLater("Iterator.from Constructor TypeError");
