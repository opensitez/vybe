// vybe-test: js/iterator_from_protocol_wrapping/test_js_iterator_from_inherits_iterator_prototype
...
if (typeof Iterator !== "undefined" && typeof Iterator.from === "function") {
    ...
    __p(__line(Object.getPrototypeOf(iter) === Iterator.prototype || Object.getPrototypeOf(Object.getPrototypeOf(iter)) === Iterator.prototype));
} else {
    __p(__line("true"));
}
__checkLater("true");
