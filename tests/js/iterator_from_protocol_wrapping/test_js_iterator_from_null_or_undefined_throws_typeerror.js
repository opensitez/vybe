// vybe-test: js/iterator_from_protocol_wrapping/test_js_iterator_from_null_or_undefined_throws_typeerror
...
if (typeof Iterator !== "undefined" && typeof Iterator.from === "function") {
    try {
        ...
        __p(__line("Iterator.from Null TypeError"));
    }
} else {
    __p(__line("Iterator.from Null TypeError"));
}
__checkLater("Iterator.from Null TypeError");
