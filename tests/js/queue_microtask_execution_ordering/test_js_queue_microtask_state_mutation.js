// vybe-test: js/queue_microtask_execution_ordering/test_js_queue_microtask_state_mutation
...
queueMicrotask(() => { __p(__line("Final State: " + state)); });
__checkLater("Final State: 20");
