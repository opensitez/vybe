// vybe-test: js/queue_microtask_execution_ordering/test_js_queue_microtask_with_arguments_binding
...
function schedule(val) {
    queueMicrotask(() => __p(__line("Scheduled: " + val)));
}
schedule("A");
schedule("B");
__checkLater("Scheduled: A\nScheduled: B");
