// vybe-test: js/change_array_by_copy_to_reversed_to_spliced_to_sorted_with/test_js_array_to_spliced_negative_delete_count_clamped_to_zero
...
__p(__line(spliced.join(",")));
__checkLater("1,99,2,3");
