// vybe-test: js/change_array_by_copy_to_reversed_to_spliced_to_sorted_with/test_js_array_to_sorted_returns_new_array
...
__p(__line(orig.join(",") + "|" + sorted.join(",") + "|" + (orig !== sorted)));
__checkLater("3,1,2|1,2,3|true");
