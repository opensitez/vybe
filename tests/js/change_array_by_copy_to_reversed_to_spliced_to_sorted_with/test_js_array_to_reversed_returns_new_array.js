// vybe-test: js/change_array_by_copy_to_reversed_to_spliced_to_sorted_with/test_js_array_to_reversed_returns_new_array
...
__p(__line(orig.join(",") + "|" + reversed.join(",") + "|" + (orig !== reversed)));
__checkLater("1,2,3|3,2,1|true");
