// vybe-test: js/change_array_by_copy_to_reversed_to_spliced_to_sorted_with/test_js_array_to_spliced_insertion_deletion
...
__p(__line(orig.join(",") + "|" + spliced.join(",")));
__checkLater("a,b,e|a,b,c,d,e");
