// vybe-test: js/change_array_by_copy_to_reversed_to_spliced_to_sorted_with/test_js_array_to_reversed_array_like_object
...
__p(__line(Array.isArray(reversed) + "|" + reversed.join(",")));
__checkLater("true|b,a");
