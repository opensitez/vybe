// vybe-test: js/change_array_by_copy_to_reversed_to_spliced_to_sorted_with/test_js_typed_array_with_method
...
__p(__line((updated instanceof Uint8Array) + "|" + updated.join(",")));
__checkLater("true|10,99,30");
