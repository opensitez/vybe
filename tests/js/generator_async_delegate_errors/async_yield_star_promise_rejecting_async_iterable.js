...
async function* bad(){yield 1;await Promise.reject("nope");} async function* wrap(){try{yield* bad();}catch(e){yield "e:"+e;}} (async()=>{const a=[];for await(const v of wrap())a.push(v);__p(__line(a.join(",")));})();
__checkLater("1,e:nope");
