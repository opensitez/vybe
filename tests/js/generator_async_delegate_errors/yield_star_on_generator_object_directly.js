// vybe-test: js/generator_async_delegate_errors/yield_star_on_generator_object_directly
...
function* inner(){yield "x";} function* outer(){yield* inner();} __p(__line(outer().next().value));
__checkLater("x");
