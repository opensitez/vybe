...
async function* g() { try { yield 1; } catch (e) { yield "caught:" + e; } } (async () => { const gen = g(); await gen.next(); const r = await gen.throw("err"); __p(__line(r.value)); })();
__checkLater("caught:err");
