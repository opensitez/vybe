...
(async () => { async function* g() { yield 1; yield 2; } const gen = g(); await gen.next(); const r = await gen.return("custom_ret"); __p(__line(r.value + "|" + r.done)); })();
__checkLater("custom_ret|true");
