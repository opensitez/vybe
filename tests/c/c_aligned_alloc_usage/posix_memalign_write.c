// vybe-test: c/c_aligned_alloc_usage/posix_memalign_write
...
int __n = 1, __i = 0;
 int *p; posix_memalign((void**)&p, sizeof(void*), sizeof(int)); *p = 99; { char __t[512]; snprintf(__t, sizeof(__t), "%d", *p);
