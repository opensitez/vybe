// vybe-test: c/c_stdio_temp_files_mkstemp/mkstemp_basic
...
int __n = 1, __i = 0;
 char tmpl[] = "test_mkstemp_XXXXXX"; int fd = mkstemp(tmpl); { char __t[512]; snprintf(__t, sizeof(__t), "%d %d", fd >= 0, tmpl[14] != 'X');
