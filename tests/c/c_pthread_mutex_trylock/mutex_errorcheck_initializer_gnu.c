// vybe-test: c/c_pthread_mutex_trylock/mutex_errorcheck_initializer_gnu
...
int __n = 1, __i = 0;
 pthread_mutex_lock(&m); int r = pthread_mutex_lock(&m); { char __t[512]; snprintf(__t, sizeof(__t), "%d", r != 0);
