// vybe-test: c/c_posix_socket_unix/unix_socketpair
...
int __n = 1, __i = 0;
 int fd[2]; int r = socketpair(AF_UNIX, SOCK_STREAM, 0, fd); { char __t[512]; snprintf(__t, sizeof(__t), "%d %d %d", r == 0, fd[0] >= 0, fd[1] >= 0);
