// vybe-test: c/c_io_file_read_write_fread_fwrite/fputc_fgetc_basic
...
int __n = 1, __i = 0;
 FILE *f = fopen("test_char.txt", "w+"); fputc('X', f); rewind(f); { char __t[512]; snprintf(__t, sizeof(__t), "%c", fgetc(f));
