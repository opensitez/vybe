// vybe-test: c/c_posix_pipe_dup2/pipe_read_write
...
int __n = 1, __i = 0;
 int fd[2]; pipe(fd); write(fd[1], "abc", 3); char buf[4] = {0}; read(fd[0], buf, 3); { char __t[512]; snprintf(__t, sizeof(__t), "%s", buf);
