// vybe-test: c/c_stdio_error_handling_clearerr/clearerr_no_op
...
int __n = 1, __i = 0;
 FILE *f = fopen("test_clearnoop.txt", "w+"); clearerr(f); { char __t[512]; snprintf(__t, sizeof(__t), "%d %d", ferror(f), feof(f));
