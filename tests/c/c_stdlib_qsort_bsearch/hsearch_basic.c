...
int __n = 1, __i = 0;
 hcreate(10); ENTRY e, *ep; e.key = strdup("foo"); e.data = (void*)42; hsearch(e, ENTER); e.key = "foo"; ep = hsearch(e, FIND); { char __t[512]; snprintf(__t, sizeof(__t), "%ld", (long)ep->data);
