// vybe-test: c/lang_switch_case_fallthrough/fallthrough_from_matched_default_path
...
const char *__w[] = {"7\n"};
int __n = 1, __i = 0;
switch(7){ case 1: { char __t[512]; snprintf(__t, sizeof(__t), "1\n");
  if (__i >= __n || strcmp(__t, __w[__i]) != 0) { printf("FAIL at line %d: got [%s]\n", __i, __t); assert(0); } __i++; } break; default: { char __t[512]; snprintf(__t, sizeof(__t), "d\n");
  if (__i >= __n || strcmp(__t, __w[__i]) != 0) { printf("FAIL at line %d: got [%s]\n", __i, __t); assert(0); } __i++; } case 7: { char __t[512]; snprintf(__t, sizeof(__t), "7\n");
