// vybe-test: c/c_stdio_buffering_setvbuf/setbuf_null_buffer
...
int __n = 1, __i = 0;
 FILE *f = fopen("test_buf_null.txt", "w"); setbuf(f, NULL); fputs("X", f); { char __t[512]; snprintf(__t, sizeof(__t), "ok");
