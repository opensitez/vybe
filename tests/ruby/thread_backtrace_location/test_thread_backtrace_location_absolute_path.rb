# vybe-test: ruby/thread_backtrace_location/test_thread_backtrace_location_absolute_path
# origin: languages/ruby/tests/ruby/test_thread_backtrace_location.rs
