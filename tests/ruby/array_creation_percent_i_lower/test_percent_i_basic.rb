# vybe-test: ruby/array_creation_percent_i_lower/test_percent_i_basic
# origin: languages/ruby/tests/ruby/test_array_creation_percent_i_lower.rs
...
__vybe_check("Symbol-Symbol-Symbol")
