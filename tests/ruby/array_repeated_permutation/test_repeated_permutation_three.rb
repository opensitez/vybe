# vybe-test: ruby/array_repeated_permutation/test_repeated_permutation_three
# origin: languages/ruby/tests/ruby/test_array_repeated_permutation.rs
...
__vybe_check("111-112-121-122-211-212-221-222")
