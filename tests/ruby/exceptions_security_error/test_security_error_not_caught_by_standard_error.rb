# vybe-test: ruby/exceptions_security_error/test_security_error_not_caught_by_standard_error
# origin: languages/ruby/tests/ruby/test_exceptions_security_error.rs
