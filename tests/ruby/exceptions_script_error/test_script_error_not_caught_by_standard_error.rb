# vybe-test: ruby/exceptions_script_error/test_script_error_not_caught_by_standard_error
# origin: languages/ruby/tests/ruby/test_exceptions_script_error.rs
