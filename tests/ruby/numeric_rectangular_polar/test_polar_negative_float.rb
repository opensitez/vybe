# vybe-test: ruby/numeric_rectangular_polar/test_polar_negative_float
# origin: languages/ruby/tests/ruby/test_numeric_rectangular_polar.rs
...
__vybe_check("1.5-3.141592653589793")
