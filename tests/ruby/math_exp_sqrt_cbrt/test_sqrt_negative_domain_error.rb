# vybe-test: ruby/math_exp_sqrt_cbrt/test_sqrt_negative_domain_error
# origin: languages/ruby/tests/ruby/test_math_exp_sqrt_cbrt.rs
...
begin; Math.sqrt(-1); rescue Math::DomainError; puts 'err'; end
