# vybe-test: ruby/enumerator_arithmetic_sequence/test_enumerator_arithmetic_sequence_basic
# origin: languages/ruby/tests/ruby/test_enumerator_arithmetic_sequence.rs
...
__vybe_check("Enumerator::ArithmeticSequence")
