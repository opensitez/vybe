# vybe-test: ruby/symbol_interning/test_symbol_all_symbols
# origin: languages/ruby/tests/ruby/test_symbol_interning.rs
...
puts Symbol.all_symbols.include?(:hello).to_s
