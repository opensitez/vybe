# vybe-test: ruby/exceptions_signal_exception/test_signal_exception_not_caught_by_standard_error
# origin: languages/ruby/tests/ruby/test_exceptions_signal_exception.rs
