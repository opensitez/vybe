# vybe-test: ruby/numeric_fdiv/test_fdiv_rational
# origin: languages/ruby/tests/ruby/test_numeric_fdiv.rs
...
puts Rational(1, 2).fdiv(3)

__vybe_check("0.16666666666666666")
