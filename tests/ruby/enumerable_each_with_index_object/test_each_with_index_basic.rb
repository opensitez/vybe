# vybe-test: ruby/enumerable_each_with_index_object/test_each_with_index_basic
# origin: languages/ruby/tests/ruby/test_enumerable_each_with_index_object.rs
