# vybe-test: ruby/string_b_byteslice/test_byteslice_index_negative
# origin: languages/ruby/tests/ruby/test_string_b_byteslice.rs
...
__vybe_check("\"\\xC3\".force_encoding('UTF-8')")
