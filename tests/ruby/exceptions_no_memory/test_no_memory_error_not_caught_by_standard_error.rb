# vybe-test: ruby/exceptions_no_memory/test_no_memory_error_not_caught_by_standard_error
# origin: languages/ruby/tests/ruby/test_exceptions_no_memory.rs
