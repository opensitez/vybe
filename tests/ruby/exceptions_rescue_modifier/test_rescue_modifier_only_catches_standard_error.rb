# vybe-test: ruby/exceptions_rescue_modifier/test_rescue_modifier_only_catches_standard_error
# origin: languages/ruby/tests/ruby/test_exceptions_rescue_modifier.rs
