# vybe-test: ruby/kernel_control/test_kernel_caller_locations
# origin: languages/ruby/tests/ruby/test_kernel_control.rs
...
__vybe_check("Thread::Backtrace::Location")
