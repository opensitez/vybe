# vybe-test: ruby/hash_transform_values_advanced/test_transform_values_preserves_default
# origin: languages/ruby/tests/ruby/test_hash_transform_values_advanced.rs
