# vybe-test: ruby/gc_module/test_gc_latest_gc_info
# origin: languages/ruby/tests/ruby/test_gc_module.rs
...
puts GC.latest_gc_info.is_a?(Hash) || GC.latest_gc_info.nil?
