# vybe-test: ruby/enumerable_group/test_enumerable_chunk_basic
# origin: languages/ruby/tests/ruby/test_enumerable_group.rs
...
__vybe_check("false:1|true:2-2|false:3")
