# vybe-test: ruby/exception_classes/test_exception_classes_zerodivisionerror
# origin: languages/ruby/tests/ruby/test_exception_classes.rs
...
__vybe_check("ZeroDivisionError")
