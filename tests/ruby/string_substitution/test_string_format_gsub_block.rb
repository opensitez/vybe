# vybe-test: ruby/string_substitution/test_string_format_gsub_block
# origin: languages/ruby/tests/ruby/test_string_substitution.rs
...
__vybe_check("104-101-108-108-111-")
