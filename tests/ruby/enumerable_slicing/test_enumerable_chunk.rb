# vybe-test: ruby/enumerable_slicing/test_enumerable_chunk
# origin: languages/ruby/tests/ruby/test_enumerable_slicing.rs
...
__vybe_check("false:1-true:2,2-false:3-true:4,4")
