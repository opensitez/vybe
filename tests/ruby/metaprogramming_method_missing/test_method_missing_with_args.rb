# vybe-test: ruby/metaprogramming_method_missing/test_method_missing_with_args
# origin: languages/ruby/tests/ruby/test_metaprogramming_method_missing.rs
