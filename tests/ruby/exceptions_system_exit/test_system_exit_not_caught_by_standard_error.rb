# vybe-test: ruby/exceptions_system_exit/test_system_exit_not_caught_by_standard_error
# origin: languages/ruby/tests/ruby/test_exceptions_system_exit.rs
