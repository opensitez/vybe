# vybe-test: ruby/hash_compare_by_identity/test_compare_by_identity_fetch_different_object
# origin: languages/ruby/tests/ruby/test_hash_compare_by_identity.rs
