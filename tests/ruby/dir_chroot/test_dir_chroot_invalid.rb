# vybe-test: ruby/dir_chroot/test_dir_chroot_invalid
# origin: languages/ruby/tests/ruby/test_dir_chroot.rs
...
begin; Dir.chroot('/non_existent_dir_123'); rescue Errno::ENOENT, NotImplementedError; puts 'err'; end
