# vybe-test: ruby/string_succ_next/test_string_upto_exclusive
# origin: languages/ruby/tests/ruby/test_string_succ_next.rs
...
acc = []; 'a'.upto('c', true) { |s| acc << s }; puts acc.join('-')
