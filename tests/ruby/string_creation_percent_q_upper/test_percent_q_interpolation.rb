# vybe-test: ruby/string_creation_percent_q_upper/test_percent_q_interpolation
# origin: languages/ruby/tests/ruby/test_string_creation_percent_q_upper.rs
...
name = 'x'; puts %Q(hello #{name})

__vybe_check("hello x")
