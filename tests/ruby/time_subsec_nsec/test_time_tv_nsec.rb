# vybe-test: ruby/time_subsec_nsec/test_time_tv_nsec
# origin: languages/ruby/tests/ruby/test_time_subsec_nsec.rs
...
puts Time.at(0.5).tv_nsec

__vybe_check("500000000")
