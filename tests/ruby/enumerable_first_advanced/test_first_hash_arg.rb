# vybe-test: ruby/enumerable_first_advanced/test_first_hash_arg
# origin: languages/ruby/tests/ruby/test_enumerable_first_advanced.rs
...
puts ({a: 1, b: 2}.first(2).map{|kv| kv.join(':')}.join('-'))
