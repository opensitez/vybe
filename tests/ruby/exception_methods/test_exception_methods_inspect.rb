# vybe-test: ruby/exception_methods/test_exception_methods_inspect
# origin: languages/ruby/tests/ruby/test_exception_methods.rs
...
__vybe_check("\#<StandardError: err>")
