...
fun main() {
            ...
            __p((value.substringBefore("/")).toString())
            __p((value.substringAfter("/")).toString())
            __p((value.substringAfterLast("/")).toString())
            __p((value.substringBeforeLast("/")).toString())
            __p((value.substringBefore("x", "missing")).toString())
            __p((value.substringAfter("x", "missing")).toString())
