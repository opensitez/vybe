...
fun main() {
            ...
            __p((path.fileName.toString()).toString())
            __p((path.fileName.toString().length).toString())
            __p((path.parent?.fileName?.toString()).toString())
            __p((path.root?.toString()).toString())
