...
fun main() {
            ...
            __p((left.distinct().joinToString(",")).toString())
            __p(((left.toSet() intersect right.toSet()).joinToString(",")).toString())
            __p(((left.toSet() union right.toSet()).joinToString(",")).toString())
