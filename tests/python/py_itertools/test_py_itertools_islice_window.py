# vybe-test: python/py_itertools/test_py_itertools_islice_window
...
__check(__line(first_five), "[0, 1, 2, 3, 4]")

middle = list(itertools.islice(data, 2, 7))
__check(__line(middle), "[2, 3, 4, 5, 6]")

stepped = list(itertools.islice(data, 0, 10, 2))
__check(__line(stepped), "[0, 2, 4, 6, 8]")
