# vybe-test: python/py_str_bytes_bytearray_conversions/test_py_bytes_immutability
...
try:
    ...
    __p(__line("TypeError: bytes object does not support item assignment"))
__check(__buf, "TypeError: bytes object does not support item assignment")
