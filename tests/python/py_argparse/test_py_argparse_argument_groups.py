# vybe-test: python/py_argparse/test_py_argparse_argument_groups
...
__check(__line(args.host), "example.com")
__check(__line(args.port), "443")
__check(__line(args.log_level), "INFO")
