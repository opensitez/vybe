# vybe-test: python/py_argparse/test_py_argparse_subcommands
...
__check(__line(args.command), "push")
__check(__line(args.remote), "upstream")

args2 = parser.parse_args(["pull", "--rebase"])
__check(__line(args2.command), "pull")
__check(__line(args2.rebase), "True")
