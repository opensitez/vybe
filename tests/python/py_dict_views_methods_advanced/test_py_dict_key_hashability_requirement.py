# vybe-test: python/py_dict_views_methods_advanced/test_py_dict_key_hashability_requirement
...
try:
    ...
    __p(__line("TypeError: unhashable type: 'list'"))
__check(__buf, "TypeError: unhashable type: 'list'")
