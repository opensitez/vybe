# vybe-test: python/py_shutil_tempfile_archive_management/test_py_shutil_move_directory_tree
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    __check(__line(os.path.exists(src_dir)), "False")
    __check(__line(os.path.exists(os.path.join(dst_dir, "data.txt"))), "True")
