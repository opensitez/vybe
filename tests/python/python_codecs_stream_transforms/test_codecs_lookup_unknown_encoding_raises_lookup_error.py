# vybe-test: python/python_codecs_stream_transforms/test_codecs_lookup_unknown_encoding_raises_lookup_error
...
try:
    ...
    __p(__line("LookupError"))
__check(__buf, "LookupError")
