...
__p(__line(dt.year, dt.month, dt.day))
__p(__line(dt.hour, dt.minute, dt.second))
__p(__line(dt.isoformat()))

now = datetime.now()
__p(__line(isinstance(now, datetime)))
__check(__buf, "2024 6 15\n10 30 45\n2024-06-15T10:30:45\nTrue")
