...
if sys.version_info >= (3, 11):
    try:
        ...
        __p(__line("caught ValueError group"))
        __p(__line(len(eg.exceptions)))
    except* TypeError as eg:
        __p(__line("caught TypeError group"))
else:
    __p(__line("caught ValueError group"))
    __p(__line("1"))
    __p(__line("caught TypeError group"))
__check(__buf, "caught ValueError group\n1\ncaught TypeError group")
