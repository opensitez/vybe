# vybe-test: python/python_subprocess_execution_pipes/test_subprocess_run_echo_stdout
...
__check(__line(res.returncode), "0")
__check(__line(res.stdout.strip()), "hello subprocess")
