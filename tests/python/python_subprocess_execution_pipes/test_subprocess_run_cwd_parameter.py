# vybe-test: python/python_subprocess_execution_pipes/test_subprocess_run_cwd_parameter
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    __check(__line(res.stdout.strip() == tmpdir or os.path.samefile(res.stdout.strip(), tmpdir)), "True")
