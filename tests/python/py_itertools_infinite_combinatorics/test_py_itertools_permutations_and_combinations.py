...
items = [1, 2, 3]
__p(__line(list(permutations(items, 2))))
__p(__line(list(combinations(items, 2))))
__p(__line(list(combinations_with_replacement("AB", 2))))
__check(__buf, "[(1, 2), (1, 3), (2, 1), (2, 3), (3, 1), (3, 2)]\n[(1, 2), (1, 3), (2, 3)]\n[('A', 'A'), ('A', 'B'), ('B', 'B')]")
