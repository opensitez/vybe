...
__p(__line(inspect.isgeneratorfunction(regular)))
__p(__line(inspect.isgeneratorfunction(generator)))
__p(__line(inspect.iscoroutinefunction(coroutine)))
__p(__line(inspect.isasyncgenfunction(async_gen)))
__check(__buf, "False\nTrue\nTrue\nTrue")
