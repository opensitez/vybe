...
__p(__line(a.issubset(b)))
__p(__line(a <= b))
__p(__line(a < b))   # proper subset

__p(__line(b.issuperset(a)))
__p(__line(b >= a))
__p(__line(b > a))   # proper superset

__p(__line(a.isdisjoint(c)))
__p(__line(a.isdisjoint(b)))
__check(__buf, "True\nTrue\nTrue\nTrue\nTrue\nTrue\nTrue\nFalse")
