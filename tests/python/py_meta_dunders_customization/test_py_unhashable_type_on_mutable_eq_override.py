# vybe-test: python/py_meta_dunders_customization/test_py_unhashable_type_on_mutable_eq_override
...
try:
    ...
    __p(__line("TypeError: unhashable type"))
__check(__buf, "TypeError: unhashable type")
