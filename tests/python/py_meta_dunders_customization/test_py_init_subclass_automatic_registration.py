# vybe-test: python/py_meta_dunders_customization/test_py_init_subclass_automatic_registration
...
__p(__line(sorted(PluginRegistry.plugins.keys())))
__check(__buf, "['audio', 'video']")
