# vybe-test: python/python_logging_handlers_formatters/test_logging_log_with_extra_dict
...
__p(__line(stream.getvalue().strip()))
__check(__buf, "192.168.1.1 - Request processed")
