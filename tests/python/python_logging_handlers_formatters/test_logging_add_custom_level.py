# vybe-test: python/python_logging_handlers_formatters/test_logging_add_custom_level
...
__p(__line(logging.getLevelName(15)))
__p(__line(logging.getLevelName("VERBOSE")))
