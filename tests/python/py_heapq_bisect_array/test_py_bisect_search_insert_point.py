...
data = [1, 3, 5, 7, 9, 11]
__p(__line(bisect.bisect_left(data, 5)))   # index of first 5
__p(__line(bisect.bisect_right(data, 5)))  # index after last 5
__p(__line(bisect.bisect_left(data, 6)))   # where 6 would go
__p(__line(bisect.bisect_right(data, 4)))
__check(__buf, "2\n3\n3\n2")
