# vybe-test: python/python_site_directory_configuration/test_site_addsitedir_pth_file_import_exec
...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    __p(__line(getattr(sys, '_pth_test_var', None)))
__check(__buf, "executed")
