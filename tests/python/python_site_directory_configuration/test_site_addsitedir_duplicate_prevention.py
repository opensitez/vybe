# vybe-test: python/python_site_directory_configuration/test_site_addsitedir_duplicate_prevention
...
__check(__line(count1 == 1), "True")
__check(__line(count2 == 1), "True")
