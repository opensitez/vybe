# vybe-test: python/python_itertools_utilities/test_python_itertools_accumulate
...
import itertools
__p(__line(list(itertools.accumulate([1, 2, 3, 4], initial=0))))
__check(__buf, "[0, 1, 3, 6, 10]")
