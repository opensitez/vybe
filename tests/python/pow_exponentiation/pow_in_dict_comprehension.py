# vybe-test: python/pow_exponentiation/pow_in_dict_comprehension
# origin: languages/python/tests/python/test_pow_exponentiation.rs
...
__p(__line({n: n ** 2 for n in range(4)}))
__check(__buf, "{0: 0, 1: 1, 2: 4, 3: 9}")
