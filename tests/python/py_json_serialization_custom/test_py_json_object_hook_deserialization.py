# vybe-test: python/py_json_serialization_custom/test_py_json_object_hook_deserialization
...
__check(__line(type(p).__name__), "Point")
__check(__line(p), "Point(10, 20)")
