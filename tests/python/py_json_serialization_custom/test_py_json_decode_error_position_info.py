# vybe-test: python/py_json_serialization_custom/test_py_json_decode_error_position_info
...
try:
    ...
    __p(__line(f"JSONDecodeError at line {e.lineno} col {e.colno}"))
__check(__buf, "JSONDecodeError at line 1 col 9")
