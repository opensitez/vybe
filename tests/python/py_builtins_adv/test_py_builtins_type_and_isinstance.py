...
__p(__line(type(42).__name__))
__p(__line(type("hello").__name__))
__p(__line(type([1, 2]).__name__))
__p(__line(type({"a": 1}).__name__))
__p(__line(type(None).__name__))
__p(__line(type(lambda: None).__name__))
__check(__buf, "int\nstr\nlist\ndict\nNoneType\nfunction")
