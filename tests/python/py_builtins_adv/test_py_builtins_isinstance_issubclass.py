...
d = Dog()
__p(__line(isinstance(d, Dog)))
__p(__line(isinstance(d, Animal)))
__p(__line(isinstance(d, (Cat, Dog))))  # checks multiple types
__p(__line(isinstance(d, Cat)))
__p(__line(issubclass(Dog, Animal)))
__p(__line(issubclass(Dog, (Cat, Animal))))
__check(__buf, "True\nTrue\nTrue\nFalse\nTrue\nTrue")
