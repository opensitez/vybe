# vybe-test: python/python_os_environ/test_environ_keys_values_type
...
import os
__p(__line(type(os.environ.keys()).__name__))
__p(__line(len(os.environ.keys()) > 0))
__check(__buf, "KeysView\nTrue")
