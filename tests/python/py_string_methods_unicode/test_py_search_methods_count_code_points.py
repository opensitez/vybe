# vybe-test: python/py_string_methods_unicode/test_py_search_methods_count_code_points
...
__p(__line(s.index("b"), s.find("b"), s.rfind("c"), s.rindex("c")))
__p(__line(len(s), s[1], s[1:3]))
__check(__buf, "2 2 4 4\n5 😀 😀b")
