# vybe-test: python/py_data_formats/test_py_xml_etree_build_and_write
...
__check(__line("localhost" in output), "True")
__check(__line("5432" in output), "True")
__check(__line("database" in output), "True")
