# vybe-test: python/python_difflib_sequencematcher_diff/test_difflib_find_longest_match
...
__p(__line(f"a={match.a}, b={match.b}, size={match.size}"))
__check(__buf, "a=3, b=3, size=3")
