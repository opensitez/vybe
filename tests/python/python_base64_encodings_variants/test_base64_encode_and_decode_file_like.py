# vybe-test: python/python_base64_encodings_variants/test_base64_encode_and_decode_file_like
...
__p(__line(decoded_stream.getvalue()))
__check(__buf, "b'file stream data'")
