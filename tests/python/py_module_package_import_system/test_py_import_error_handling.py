# vybe-test: python/py_module_package_import_system/test_py_import_error_handling
...
try:
    ...
    __p(__line(f"ImportError: {e.name}"))
__check(__buf, "ImportError: nonexistent_module_abc_xyz")
