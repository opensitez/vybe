# vybe-test: python/py_functools_lru_singledispatch/test_py_functools_wraps_update_wrapper
...
__p(__line(target.__name__))
__p(__line(target.__doc__))
__check(__buf, "target\nTarget function docstring")
