# vybe-test: python/py_functools_lru_singledispatch/test_py_functools_cmp_to_key_conversion
...
__p(__line(sorted(words, key=cmp_to_key(custom_compare))))
__check(__buf, "['fig', 'date', 'apple', 'banana', 'cherry']")
