# vybe-test: python/python_traceback_formatting_stack/test_traceback_traceback_exception_from_exception
...
try:
    ...
    __p(__line(te.exc_type.__name__))
    formatted = "".join(te.format())
    __p(__line("KeyError: 'missing'" in formatted))
