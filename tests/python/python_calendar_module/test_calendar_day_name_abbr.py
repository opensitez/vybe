# vybe-test: python/python_calendar_module/test_calendar_day_name_abbr
...
import calendar
__p(__line(list(calendar.day_name)[0]))
__p(__line(list(calendar.day_abbr)[0]))
__check(__buf, "Monday\nMon")
