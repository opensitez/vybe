# vybe-test: python/python_socketserver_tcp_udp/test_socketserver_base_request_handler_attributes
...
server.server_close()
t.join()
__check(__line(captured[0] in ("127.0.0.1", "localhost")), "True")
__check(__line(captured[1]), "True")
