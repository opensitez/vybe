# vybe-test: python/python_socketserver_tcp_udp/test_socketserver_shutdown_request
...
t.join(10)
server.server_close()
__p(__line("shutdown_request_passed"))
__check(__buf, "shutdown_request_passed")
