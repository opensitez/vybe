# vybe-test: python/python_fnmatch_translate_case/test_fnmatch_filter_selects_matching_names
...
__p(__line(sorted(result)))
__check(__buf, "['main.py', 'test.py', 'utils.py']")
