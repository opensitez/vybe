# vybe-test: python/python_string_translate/test_translate_unicode
# origin: languages/python/tests/python/test_python_string_translate.rs
...
s = "caf\u00e9 \u00e0 la mode"
__p(__line(s.translate(table)))
__check(__buf, "cafe a la mode")
