# vybe-test: python/py_gettext_locale/test_py_gettext_gnu_translations_dict
...
__check(__line(trans.gettext("Hello World")), "Bonjour le monde")
__check(__line(trans.gettext("Goodbye")), "Au revoir")
__check(__line(trans.gettext("Unknown")), "Unknown")
