...
__p(__line(re.search(r"\d+", "abc 123 def").group()))
__p(__line(re.match(r"\d+", "123abc").group()))
__p(__line(re.match(r"\d+", "abc123") is None))
__p(__line(re.fullmatch(r"\d{3}", "123") is not None))
__p(__line(re.fullmatch(r"\d{3}", "1234") is None))
__check(__buf, "123\n123\nTrue\nTrue\nTrue")
