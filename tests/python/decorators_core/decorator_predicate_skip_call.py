# vybe-test: python/decorators_core/decorator_predicate_skip_call
# origin: languages/python/tests/python/test_decorators_core.rs
...
def rec(x):
 return x
__p(__line(skip_zero(rec)(0), skip_zero(rec)(2)))
__check(__buf, "None 2")
