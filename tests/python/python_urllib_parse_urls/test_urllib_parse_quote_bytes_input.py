# vybe-test: python/python_urllib_parse_urls/test_urllib_parse_quote_bytes_input
...
__p(__line(quote_from_bytes(b"hello world\xff")))
__check(__buf, "hello%20world%FF")
