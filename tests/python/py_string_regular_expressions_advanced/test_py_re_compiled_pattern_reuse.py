# vybe-test: python/py_string_regular_expressions_advanced/test_py_re_compiled_pattern_reuse
...
__p(__line(regex.findall("Alice and Bob went to Charlie")))
__check(__buf, "['Alice', 'Bob', 'Charlie']")
