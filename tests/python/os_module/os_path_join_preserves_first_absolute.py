# vybe-test: python/os_module/os_path_join_preserves_first_absolute
# origin: languages/python/tests/python/test_os_module.rs
...
import os
__p(__line(os.path.join('/root', 'sub', 'leaf')))
__check(__buf, "/root/sub/leaf")
