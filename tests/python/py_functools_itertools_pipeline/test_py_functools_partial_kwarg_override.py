# vybe-test: python/py_functools_itertools_pipeline/test_py_functools_partial_kwarg_override
...
__p(__line(log_error("Failed to connect")))
__check(__buf, "[ERROR] Failed to connect")
