...
d = Decimal("2.5")
__p(__line(d.quantize(Decimal("1"), rounding=ROUND_HALF_UP)))
__p(__line(d.quantize(Decimal("1"), rounding=ROUND_HALF_EVEN)))
__p(__line(d.quantize(Decimal("1"), rounding=ROUND_FLOOR)))
__check(__buf, "3\n2\n2")
