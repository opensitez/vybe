...
__p(__line("{} and {}".format("Alice", "Bob")))
__p(__line("{name} is {age}".format(name="Charlie", age=25)))
__p(__line("{0[key]}".format({"key": "value"})))
__p(__line("{:.3f}".format(3.14159)))
__check(__buf, "Alice and Bob\nCharlie is 25\nvalue\n3.142")
