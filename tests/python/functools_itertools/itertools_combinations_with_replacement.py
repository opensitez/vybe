# vybe-test: python/functools_itertools/itertools_combinations_with_replacement
...
import itertools
__p(__line(list(itertools.combinations_with_replacement([1, 2], 2))))
__check(__buf, "[(1, 1), (1, 2), (2, 2)]")
