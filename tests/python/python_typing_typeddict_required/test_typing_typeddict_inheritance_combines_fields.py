# vybe-test: python/python_typing_typeddict_required/test_typing_typeddict_inheritance_combines_fields
...
__p(__line(e["name"], e["employee_id"]))
__check(__buf, "Alice 99")
