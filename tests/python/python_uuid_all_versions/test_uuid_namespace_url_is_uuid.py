# vybe-test: python/python_uuid_all_versions/test_uuid_namespace_url_is_uuid
...
import uuid
__p(__line(str(uuid.NAMESPACE_URL)))
__check(__buf, "6ba7b811-9dad-11d1-80b4-00c04fd430c8")
