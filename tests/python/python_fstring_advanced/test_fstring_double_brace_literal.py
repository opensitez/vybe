# vybe-test: python/python_fstring_advanced/test_fstring_double_brace_literal
# origin: languages/python/tests/python/test_python_fstring_advanced.rs
...
__p(__line(f"{{not interpolated}}"))
__check(__buf, "{not interpolated}")
