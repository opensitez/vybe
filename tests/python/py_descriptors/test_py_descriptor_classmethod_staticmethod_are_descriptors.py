...
__p(__line(isinstance(Foo.__dict__['cls_method'], classmethod)))
__p(__line(isinstance(Foo.__dict__['static_method'], staticmethod)))
__p(__line(Foo.cls_method()))
__p(__line(Foo.static_method(5)))
__check(__buf, "True\nTrue\nFoo\n10")
