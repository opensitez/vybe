# vybe-test: python/py_descriptors/test_py_descriptor_delete_protocol
...
class Tracked:
    ...
    def __delete__(self, obj):
        __check(__line(f"Deleting {self.name}"), "Alice")
...
u = User()
u.name = "Alice"
__check(__line(u.name), "Deleting name")
del u.name
__check(__line(u.name), "None")
