# vybe-test: python/py_security/test_py_hashlib_sha256_correct_digest
...
__check(__line(len(correct.hexdigest())), "64")
__check(__line(correct.hexdigest() != ""), "True")
__check(__line(correct.digest_size == 32), "True")
