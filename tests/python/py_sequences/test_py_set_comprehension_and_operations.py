...
a = {1, 2, 3, 4}
b = {3, 4, 5, 6}
__p(__line(sorted(a | b)))    # union
__p(__line(sorted(a & b)))    # intersection
__p(__line(sorted(a - b)))    # difference
__p(__line(sorted(a ^ b)))    # symmetric difference

squares = {x**2 for x in range(6)}
__p(__line(sorted(squares)))
__check(__buf, "[1, 2, 3, 4, 5, 6]\n[3, 4]\n[1, 2]\n[1, 2, 5, 6]\n[0, 1, 4, 9, 16, 25]")
