...
__p(__line(sorted(words)))
__p(__line(sorted(words, key=len)))
__p(__line(sorted(words, key=lambda w: w[-1])))

people = [("Alice", 30), ("Bob", 25), ("Charlie", 35)]
__p(__line(sorted(people, key=lambda p: p[1])))
__check(__buf, "['apple', 'banana', 'cherry', 'kiwi']\n['kiwi', 'apple', 'banana', 'cherry']\n['banana', 'apple', 'kiwi', 'cherry']\n[('Bob', 25), ('Alice', 30), ('Charlie', 35)]")
