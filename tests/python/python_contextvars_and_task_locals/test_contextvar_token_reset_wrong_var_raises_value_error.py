# vybe-test: python/python_contextvars_and_task_locals/test_contextvar_token_reset_wrong_var_raises_value_error
...
try:
    ...
    __p(__line('WRONG_VAR_TOKEN'))
__check(__buf, "WRONG_VAR_TOKEN")
