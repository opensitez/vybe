# vybe-test: python/python_contextvars_and_task_locals/test_contextvar_token_used_twice_raises_runtime_error
...
try:
    ...
    __p(__line('TOKEN_REUSED_ERROR'))
__check(__buf, "TOKEN_REUSED_ERROR")
