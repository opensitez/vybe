# vybe-test: python/py_meta_class_creation_hooks/test_py_metaclass_instance_check_override
...
__check(__line(isinstance(Implementation(), CustomProtocolInterface)), "True")
__check(__line(isinstance(Other(), CustomProtocolInterface)), "False")
