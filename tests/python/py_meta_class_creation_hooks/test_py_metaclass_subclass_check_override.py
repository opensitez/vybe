# vybe-test: python/py_meta_class_creation_hooks/test_py_metaclass_subclass_check_override
...
__check(__line(issubclass(CompatibleClass, Interface)), "True")
__check(__line(issubclass(IncompatibleClass, Interface)), "False")
