# vybe-test: python/py_meta_class_creation_hooks/test_py_metaclass_registration_pattern
...
__p(__line(sorted(registry.keys())))
__check(__buf, "['FTPHandler', 'HTTPHandler']")
