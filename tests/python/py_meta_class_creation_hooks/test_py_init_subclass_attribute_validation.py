# vybe-test: python/py_meta_class_creation_hooks/test_py_init_subclass_attribute_validation
...
__check(__line(ValidChild.version), "1.0")

try:
    class InvalidChild(BaseValidated, required_attr="missing"):
        pass
except TypeError as e:
    __check(__line(e), "Class InvalidChild missing required attribute 'missing'")
