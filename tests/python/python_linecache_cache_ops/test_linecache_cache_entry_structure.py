# vybe-test: python/python_linecache_cache_ops/test_linecache_cache_entry_structure
...
__check(__line(len(entry) == 4), "True")
__check(__line(isinstance(entry[2], list)), "True")
os.unlink(f.name)
