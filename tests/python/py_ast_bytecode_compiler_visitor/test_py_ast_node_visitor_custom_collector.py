# vybe-test: python/py_ast_bytecode_compiler_visitor/test_py_ast_node_visitor_custom_collector
...
__p(__line(sorted(list(set(collector.vars)))))
__check(__buf, "['a', 'b', 'c', 'x']")
