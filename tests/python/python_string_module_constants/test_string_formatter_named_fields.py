# vybe-test: python/python_string_module_constants/test_string_formatter_named_fields
...
import string
f = string.Formatter()
__p(__line(f.format("{name} is {age}", name="Alice", age=30)))
__check(__buf, "Alice is 30")
