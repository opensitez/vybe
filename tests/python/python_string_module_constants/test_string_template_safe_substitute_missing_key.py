# vybe-test: python/python_string_module_constants/test_string_template_safe_substitute_missing_key
...
__p(__line(t.safe_substitute(name="Alice")))
__check(__buf, "Hello Alice, you have $count messages")
