# vybe-test: python/python_string_module_constants/test_string_template_substitute_with_braces
...
__p(__line(t.substitute(item="book")))
__check(__buf, "books are available")
