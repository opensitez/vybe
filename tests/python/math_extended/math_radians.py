# vybe-test: python/math_extended/math_radians
# origin: languages/python/tests/python/test_math_extended.rs
...
import math
__p(__line(math.radians(180)))
__check(__buf, "3.141592653589793")
