# vybe-test: python/py_async_coroutine_eventloop/test_py_async_gather_return_exceptions
...
async def main():
    ...
    __check(__line(results[0]), "OK")
    __check(__line(type(results[1]).__name__, str(results[1])), "ValueError FAIL")
