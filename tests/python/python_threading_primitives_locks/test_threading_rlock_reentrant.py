# vybe-test: python/python_threading_primitives_locks/test_threading_rlock_reentrant
...
with rlock:
    with rlock:
        __p(__line("re-acquired successfully"))
__check(__buf, "re-acquired successfully")
