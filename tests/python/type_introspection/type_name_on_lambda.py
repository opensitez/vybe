# vybe-test: python/type_introspection/type_name_on_lambda
# origin: languages/python/tests/python/test_type_introspection.rs
...
__p(__line(type(lambda: 0).__name__))
__check(__buf, "function")
