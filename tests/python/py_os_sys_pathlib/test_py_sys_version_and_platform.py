...
__p(__line(isinstance(sys.version, str)))
__p(__line(isinstance(sys.version_info.major, int)))
__p(__line(sys.version_info.major >= 3))
__p(__line(isinstance(sys.platform, str)))
__check(__buf, "True\nTrue\nTrue\nTrue")
