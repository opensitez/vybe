...
__p(__line(os.environ["MY_TEST_VAR"]))
__p(__line(os.getenv("MY_TEST_VAR")))
__p(__line(os.getenv("NONEXISTENT_VAR", "fallback")))
del os.environ["MY_TEST_VAR"]
__p(__line(os.getenv("MY_TEST_VAR") is None))
__check(__buf, "hello_world\nhello_world\nfallback\nTrue")
