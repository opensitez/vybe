# vybe-test: python/py_dataclass_advanced_features/test_py_dataclass_mutable_default_raises_value_error
...
try:
    ...
    __p(__line("ValueError: mutable default not allowed"))
__check(__buf, "ValueError: mutable default not allowed")
