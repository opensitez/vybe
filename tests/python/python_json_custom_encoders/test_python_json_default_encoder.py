# vybe-test: python/python_json_custom_encoders/test_python_json_default_encoder
# origin: languages/python/tests/python/test_python_json_custom_encoders.rs
...
__p(__line(json.dumps({'day': datetime(2026, 7, 26)}, default=encoder)))
__check(__buf, "{\"day\": \"2026-07-26\"}")
