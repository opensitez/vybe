# vybe-test: python/py_control_flow_generators_iterators/test_py_yield_from_subgenerator_delegation
...
__p(__line(list(parent())))
__check(__buf, "[10, 20, 'parent_got:sub_done']")
