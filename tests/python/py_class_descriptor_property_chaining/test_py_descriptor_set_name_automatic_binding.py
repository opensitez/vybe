# vybe-test: python/py_class_descriptor_property_chaining/test_py_descriptor_set_name_automatic_binding
...
p.first_name = "John"
p.last_name = "Doe"
__p(__line(p.first_name, p.last_name))
__p(__line(p._first_name))
__check(__buf, "John Doe\nJohn")
