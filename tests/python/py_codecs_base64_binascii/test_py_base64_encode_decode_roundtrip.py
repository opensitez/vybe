# vybe-test: python/py_codecs_base64_binascii/test_py_base64_encode_decode_roundtrip
...
__p(__line(encoded.decode("ascii")))

decoded = base64.b64decode(encoded)
__p(__line(decoded == data))
__check(__buf, "UHl0aG9uIDMuMTIgV2ViIEFwcA==\nTrue")
