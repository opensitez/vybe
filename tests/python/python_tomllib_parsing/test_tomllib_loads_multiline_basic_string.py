# vybe-test: python/python_tomllib_parsing/test_tomllib_loads_multiline_basic_string
...
__p(__line(d["str"].strip()))
__check(__buf, "The quick brown fox jumps over the lazy dog.")
