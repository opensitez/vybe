# vybe-test: python/py_functools/test_py_functools_cmp_to_key
...
__p(__line(sorted(words, key=functools.cmp_to_key(compare_lengths))))
__check(__buf, "['fig', 'kiwi', 'apple', 'banana', 'cherry']")
