# vybe-test: python/py_json/test_py_json_basic_serialize_deserialize
...
__p(__line(parsed["name"]))
__p(__line(parsed["age"]))
__p(__line(parsed["active"]))
__p(__line(parsed["score"] is None))
__check(__buf, "Alice\n30\nTrue\nTrue")
