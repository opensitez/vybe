...
__p(__line(unicodedata.category("A")))  # Lu = Letter, uppercase
__p(__line(unicodedata.category("1")))  # Nd = Number, decimal digit
__p(__line(unicodedata.category(" ")))  # Zs = Separator, space

__p(__line(unicodedata.numeric("5")))
__p(__line(unicodedata.numeric("½")))
__check(__buf, "Lu\nNd\nZs\n5.0\n0.5")
