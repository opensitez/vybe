# vybe-test: python/py_exception_hierarchy_custom/test_py_assertion_error_with_msg
...
try:
    ...
    __p(__line(f"AssertionError: {e}"))
__check(__buf, "AssertionError: 1 does not equal 2")
