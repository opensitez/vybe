# vybe-test: python/py_exception_hierarchy_custom/test_py_custom_domain_exception_tree
...
try:
    ...
    __p(__line(f"Domain error: {type(e).__name__} - {e}"))
__check(__buf, "Domain error: UserNotFoundError - User 123 not found")
