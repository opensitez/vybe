# vybe-test: python/py_exception_hierarchy_custom/test_py_attribute_error_missing_attr
...
try:
    ...
    __p(__line("AttributeError caught"))
__check(__buf, "AttributeError caught")
