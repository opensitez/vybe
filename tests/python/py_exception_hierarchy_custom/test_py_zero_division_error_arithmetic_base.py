# vybe-test: python/py_exception_hierarchy_custom/test_py_zero_division_error_arithmetic_base
...
try:
    ...
    __p(__line(f"Arithmetic error: {type(e).__name__}"))
__check(__buf, "Arithmetic error: ZeroDivisionError")
