# vybe-test: python/py_sqlite_database_transactions/test_py_sqlite_iterdump_sql_dump
...
dump = "\n".join(conn.iterdump())
__p(__line("CREATE TABLE test" in dump))
__p(__line("INSERT INTO \"test\" VALUES(1)" in dump))
conn.close()
__check(__buf, "True\nTrue")
