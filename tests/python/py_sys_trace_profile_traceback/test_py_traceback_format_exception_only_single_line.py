# vybe-test: python/py_sys_trace_profile_traceback/test_py_traceback_format_exception_only_single_line
...
__p(__line(formatted))
__check(__buf, "ValueError: invalid value")
