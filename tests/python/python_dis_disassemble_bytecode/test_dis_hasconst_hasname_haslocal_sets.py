...
import dis
__p(__line(isinstance(dis.hasconst, list) or isinstance(dis.hasconst, set) or isinstance(dis.hasconst, tuple)))
__p(__line(isinstance(dis.hasname, list) or isinstance(dis.hasname, set) or isinstance(dis.hasname, tuple)))
__check(__buf, "True\nTrue")
