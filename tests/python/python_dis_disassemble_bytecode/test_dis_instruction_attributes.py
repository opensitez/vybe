...
__p(__line(hasattr(inst, "opcode")))
__p(__line(hasattr(inst, "opname")))
__p(__line(hasattr(inst, "arg")))
__p(__line(hasattr(inst, "argval")))
__p(__line(hasattr(inst, "starts_line")))
__check(__buf, "True\nTrue\nTrue\nTrue\nTrue")
