# vybe-test: python/python_asyncio_tasks_threads/test_asyncio_gather_return_exceptions
...
async def fn():
    ...
    __check(__line(res[0]), "success")
    __check(__line(type(res[1]).__name__), "ValueError")
