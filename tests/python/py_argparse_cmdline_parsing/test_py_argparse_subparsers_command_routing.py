# vybe-test: python/py_argparse_cmdline_parsing/test_py_argparse_subparsers_command_routing
...
__check(__line(args.subcommand), "build")
__check(__line(args.target), "web")
