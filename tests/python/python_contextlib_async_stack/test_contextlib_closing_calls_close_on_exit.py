# vybe-test: python/python_contextlib_async_stack/test_contextlib_closing_calls_close_on_exit
...
with contextlib.closing(res):
    __check(__line(res.is_closed), "False")

__check(__line(res.is_closed), "True")
