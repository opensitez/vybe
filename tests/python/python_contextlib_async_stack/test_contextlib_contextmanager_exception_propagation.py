# vybe-test: python/python_contextlib_async_stack/test_contextlib_contextmanager_exception_propagation
...
def handle():
    try:
        ...
        __p(__line(f"caught in manager: {e}"))

with handle():
    raise ValueError("test_err")
__check(__buf, "caught in manager: test_err")
