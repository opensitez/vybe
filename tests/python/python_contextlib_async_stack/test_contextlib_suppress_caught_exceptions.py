# vybe-test: python/python_contextlib_async_stack/test_contextlib_suppress_caught_exceptions
...
__p(__line("execution continues"))
__check(__buf, "execution continues")
