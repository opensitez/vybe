# vybe-test: python/python_unittest_mock_objects/test_mock_patch_dict
...
with patch.dict(os.environ, env_override, clear=False):
    __p(__line(os.environ.get("MY_VAR")))

__p(__line(os.environ.get("MY_VAR") is None))
__check(__buf, "mocked_val\nTrue")
