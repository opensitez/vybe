# vybe-test: python/python_unittest_mock_objects/test_mock_assert_called_once_with
...
__p(__line("assert_called_once_with passed"))
__check(__buf, "assert_called_once_with passed")
