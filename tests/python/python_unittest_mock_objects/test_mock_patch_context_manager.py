# vybe-test: python/python_unittest_mock_objects/test_mock_patch_context_manager
...
with patch("sys.platform", "mocked_os"):
    __p(__line(sys.platform))

__p(__line(sys.platform != "mocked_os"))
__check(__buf, "mocked_os\nTrue")
