# vybe-test: python/py_subprocess_process_management/test_py_subprocess_called_process_error_check
...
try:
    ...
    __p(__line(f"CalledProcessError returncode={e.returncode}"))
__check(__buf, "CalledProcessError returncode=42")
