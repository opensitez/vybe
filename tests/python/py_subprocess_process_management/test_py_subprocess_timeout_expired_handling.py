# vybe-test: python/py_subprocess_process_management/test_py_subprocess_timeout_expired_handling
...
try:
    ...
    __p(__line("TimeoutExpired caught"))
__check(__buf, "TimeoutExpired caught")
