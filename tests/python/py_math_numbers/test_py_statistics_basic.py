...
__p(__line(statistics.mean(data)))
__p(__line(statistics.median(data)))
__p(__line(statistics.mode(data)))
__p(__line(round(statistics.stdev(data), 4)))
__p(__line(round(statistics.variance(data), 4)))
__check(__buf, '4.555555555555555\n5\n5\n2.2973\n5.2778\n')
