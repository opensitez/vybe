...
__p(__line(round(math.sin(math.pi / 2), 5)))
__p(__line(round(math.cos(0), 5)))
__p(__line(round(math.tan(math.pi / 4), 5)))
__p(__line(round(math.degrees(math.pi), 5)))
__p(__line(round(math.radians(180), 5)))
__check(__buf, "1.0\n1.0\n1.0\n180.0\n3.14159")
