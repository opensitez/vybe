...
__p(__line(round(math.log(math.e), 5)))
__p(__line(round(math.log(100, 10), 5)))
__p(__line(round(math.log2(8), 5)))
__p(__line(round(math.log10(1000), 5)))
__p(__line(round(math.exp(1), 5)))
__check(__buf, "1.0\n2.0\n3.0\n3.0\n2.71828")
