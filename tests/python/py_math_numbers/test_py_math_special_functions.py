...
__p(__line(math.gcd(12, 8)))
__p(__line(math.gcd(100, 75)))
__p(__line(math.lcm(4, 6)))
__p(__line(math.isfinite(float('inf'))))
__p(__line(math.isinf(float('inf'))))
__p(__line(math.isnan(float('nan'))))
__p(__line(math.copysign(3, -1)))
__check(__buf, "4\n25\n12\nFalse\nTrue\nTrue\n-3.0")
