# vybe-test: python/python_queue_thread_safe_datastructures/test_simple_queue_empty_exception
...
try:
    ...
    __p(__line("SIMPLE_QUEUE_EMPTY"))
__check(__buf, "SIMPLE_QUEUE_EMPTY")
