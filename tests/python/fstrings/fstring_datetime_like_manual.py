# vybe-test: python/fstrings/fstring_datetime_like_manual
# origin: languages/python/tests/python/test_fstrings.rs
...
y, m, d = 2024, 5, 9
__p(__line(f'{y}-{m:02d}-{d:02d}'))
__check(__buf, "2024-05-09")
