...
if sys.version_info >= (3, 11):
    ...
    __p(__line(eg.message))
    __p(__line([type(e).__name__ for e in eg.exceptions]))
else:
    __p(__line("Multiple errors"))
    __p(__line("['ValueError', 'TypeError']"))
__check(__buf, "Multiple errors\n['ValueError', 'TypeError']")
