# vybe-test: python/py_asyncio/test_py_asyncio_task_cancellation
...
async def main():
    ...
    try:
        ...
        __p(__line("Caught CancelledError in main"))

asyncio.run(main())
__check(__buf, "Task was cancelled\nCaught CancelledError in main")
