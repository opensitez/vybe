# vybe-test: python/python_gettext_translation_catalogs/test_gettext_bindtextdomain_and_textdomain
...
__check(__line(d), "/usr/share/locale")
__check(__line(dom), "myapp")
