# vybe-test: python/py_function_signatures_params/test_py_inspect_signature_bind_partial
...
__p(__line(dict(bound.arguments)))
__check(__buf, "{'name': 'Alice', 'age': 30, 'city': 'NY'}")
