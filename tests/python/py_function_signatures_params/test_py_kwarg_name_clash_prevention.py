# vybe-test: python/py_function_signatures_params/test_py_kwarg_name_clash_prevention
...
__p(__line(build_dict(name="item", value=42, type="widget")))
__check(__buf, "{'name': 'item', 'value': 42, 'type': 'widget'}")
