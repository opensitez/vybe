# vybe-test: python/py_function_signatures_params/test_py_positional_only_slash_syntax
...
__p(__line(pos_only(1, 2)))
__p(__line(pos_only(1, 2, c=30)))

try:
    pos_only(a=1, b=2)
except TypeError:
    __p(__line("TypeError: positional-only"))
__check(__buf, "13\n33\nTypeError: positional-only")
