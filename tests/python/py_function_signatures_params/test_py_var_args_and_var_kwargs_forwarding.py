# vybe-test: python/py_function_signatures_params/test_py_var_args_and_var_kwargs_forwarding
...
__p(__line(proxy(1, 2)))
__p(__line(proxy(1, 2, 3, debug=True)))
__check(__buf, "a=1, b=2, c=0, debug=False\na=1, b=2, c=3, debug=True")
