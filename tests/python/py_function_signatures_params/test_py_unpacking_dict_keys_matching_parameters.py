# vybe-test: python/py_function_signatures_params/test_py_unpacking_dict_keys_matching_parameters
...
__p(__line(config(**params)))
__check(__buf, "localhost:9090 (timeout=60s)")
