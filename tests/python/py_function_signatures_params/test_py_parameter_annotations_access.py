# vybe-test: python/py_function_signatures_params/test_py_parameter_annotations_access
...
__p(__line(add.__annotations__))
__check(__buf, "{'x': <class 'int'>, 'y': <class 'int'>, 'return': <class 'int'>}")
