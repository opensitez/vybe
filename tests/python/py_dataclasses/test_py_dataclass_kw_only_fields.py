# vybe-test: python/py_dataclasses/test_py_dataclass_kw_only_fields
...
__p(__line(s.debug, s.timeout))
try:
    Settings(True, 60)  # positional not allowed!
except TypeError:
    __p(__line("TypeError: no positional args allowed"))
__check(__buf, "True 60\nTypeError: no positional args allowed")
