# vybe-test: python/py_dataclasses/test_py_dataclass_mutable_default_raises_valueerror
...
try:
    ...
    __p(__line("ValueError: mutable default"))
__check(__buf, "ValueError: mutable default")
