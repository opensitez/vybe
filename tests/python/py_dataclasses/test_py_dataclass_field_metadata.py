# vybe-test: python/py_dataclasses/test_py_dataclass_field_metadata
...
f = fields(Schema)[0]
__p(__line(f.metadata["validator"]))
__p(__line(f.metadata["required"]))
__check(__buf, "email_format\nTrue")
