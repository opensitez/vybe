# vybe-test: python/radix_literals/decimal_with_underscore_separators
# origin: languages/python/tests/python/test_radix_literals.rs
...
__p(__line(1_000_000))
__check(__buf, "1000000")
