# vybe-test: python/py_contextlib/test_py_contextlib_exit_stack_callback
...
__p(__line(log))  # callbacks run in LIFO order
__check(__buf, "['body', 'callback_2', 'callback_1']")
