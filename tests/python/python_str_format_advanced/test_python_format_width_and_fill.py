# vybe-test: python/python_str_format_advanced/test_python_format_width_and_fill
...
__p(__line('{:0>8}'.format(123)))
__p(__line('{name:<8}|'.format(name='x')))
__check(__buf, "00000123\nx       |")
