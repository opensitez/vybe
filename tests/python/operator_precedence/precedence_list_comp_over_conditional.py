# vybe-test: python/operator_precedence/precedence_list_comp_over_conditional
# origin: languages/python/tests/python/test_operator_precedence.rs
...
__p(__line([x for x in range(3) if x]))
__check(__buf, "[1, 2]")
