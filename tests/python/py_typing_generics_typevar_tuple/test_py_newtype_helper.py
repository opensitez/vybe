# vybe-test: python/py_typing_generics_typevar_tuple/test_py_newtype_helper
...
uid = UserId(1001)
__p(__line(get_user_profile(uid)))
__p(__line(isinstance(uid, int)))
__check(__buf, "Profile for user 1001\nTrue")
