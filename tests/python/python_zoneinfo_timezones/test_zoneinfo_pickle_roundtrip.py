# vybe-test: python/python_zoneinfo_timezones/test_zoneinfo_pickle_roundtrip
...
__p(__line(restored.key))
__p(__line(restored is zi))
__check(__buf, "Pacific/Auckland\nTrue")
