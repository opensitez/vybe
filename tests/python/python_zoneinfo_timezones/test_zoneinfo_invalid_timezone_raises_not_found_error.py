# vybe-test: python/python_zoneinfo_timezones/test_zoneinfo_invalid_timezone_raises_not_found_error
...
try:
    ...
    __p(__line("ZoneInfoNotFoundError"))
__check(__buf, "ZoneInfoNotFoundError")
