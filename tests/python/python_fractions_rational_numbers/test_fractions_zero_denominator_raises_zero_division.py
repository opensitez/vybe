# vybe-test: python/python_fractions_rational_numbers/test_fractions_zero_denominator_raises_zero_division
...
try:
    ...
    __p(__line("ZeroDivisionError"))
__check(__buf, "ZeroDivisionError")
