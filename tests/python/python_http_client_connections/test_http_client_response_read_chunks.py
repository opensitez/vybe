# vybe-test: python/python_http_client_connections/test_http_client_response_read_chunks
...
resp.begin()
__check(__line(resp.status), "200")
__check(__line(resp.reason), "OK")
__check(__line(resp.read().decode()), "Hello World")
