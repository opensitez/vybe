# vybe-test: python/python_http_client_connections/test_http_client_putrequest_and_putheader
...
__check(__line("GET /api/v1/users HTTP/1.1" in data), "True")
__check(__line("Accept: application/json" in data), "True")
conn.close()
