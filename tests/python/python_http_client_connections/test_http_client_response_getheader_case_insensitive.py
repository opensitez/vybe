# vybe-test: python/python_http_client_connections/test_http_client_response_getheader_case_insensitive
...
resp.begin()
__p(__line(resp.getheader("x-custom-header")))
__p(__line(resp.getheader("X-CUSTOM-HEADER")))
__check(__buf, "TestVal\nTestVal")
