# vybe-test: python/python_http_client_connections/test_http_client_tunnel_set_proxy
...
__p(__line(conn._tunnel_host))
__p(__line(conn._tunnel_port))
conn.close()
__check(__buf, "target.local\n443")
