# vybe-test: python/python_http_client_connections/test_http_client_parse_headers_from_file_like
...
__p(__line(msg.get_content_type()))
__p(__line(msg["content-length"]))
__check(__buf, "text/html\n100")
