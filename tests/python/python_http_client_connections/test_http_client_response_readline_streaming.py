# vybe-test: python/python_http_client_connections/test_http_client_response_readline_streaming
...
resp.begin()
__check(__line(resp.readline().decode().strip()), "line1")
__check(__line(resp.readline().decode().strip()), "line2")
