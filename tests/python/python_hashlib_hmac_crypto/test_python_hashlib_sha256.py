# vybe-test: python/python_hashlib_hmac_crypto/test_python_hashlib_sha256
# origin: languages/python/tests/python/test_python_hashlib_hmac_crypto.rs
...
import hashlib
__p(__line(hashlib.sha256(b'abc').hexdigest()))
__check(__buf, "ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad")
