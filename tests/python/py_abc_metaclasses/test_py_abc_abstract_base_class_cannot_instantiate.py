# vybe-test: python/py_abc_metaclasses/test_py_abc_abstract_base_class_cannot_instantiate
...
try:
    ...
    __p(__line("Cannot instantiate abstract class"))
__check(__buf, "Cannot instantiate abstract class")
