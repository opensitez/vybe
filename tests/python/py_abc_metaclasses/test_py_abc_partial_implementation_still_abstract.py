# vybe-test: python/py_abc_metaclasses/test_py_abc_partial_implementation_still_abstract
...
try:
    ...
    __p(__line("Still abstract — method_b missing"))
__check(__buf, "Still abstract — method_b missing")
