# vybe-test: python/python_sched_event_scheduler/test_sched_scheduling_event_from_within_event_handler
...
__check(__line(executed), "['step1', 'step2']")
__check(__line(vtime), "10")
