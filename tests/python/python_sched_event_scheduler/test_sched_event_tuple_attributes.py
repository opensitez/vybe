...
__p(__line(hasattr(e, "time")))
__p(__line(hasattr(e, "priority")))
__p(__line(hasattr(e, "action")))
__p(__line(hasattr(e, "argument")))
__p(__line(hasattr(e, "kwargs")))
__p(__line(e.priority))
__check(__buf, "True\nTrue\nTrue\nTrue\nTrue\n2")
