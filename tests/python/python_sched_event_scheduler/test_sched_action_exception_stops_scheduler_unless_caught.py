# vybe-test: python/python_sched_event_scheduler/test_sched_action_exception_stops_scheduler_unless_caught
...
try:
    ...
    __p(__line("RuntimeError"))
__check(__buf, "RuntimeError")
