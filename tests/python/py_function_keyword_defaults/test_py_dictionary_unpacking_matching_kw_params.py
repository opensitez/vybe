# vybe-test: python/py_function_keyword_defaults/test_py_dictionary_unpacking_matching_kw_params
...
__p(__line(configure(**config_dict)))
__check(__buf, "127.0.0.1:9000")
