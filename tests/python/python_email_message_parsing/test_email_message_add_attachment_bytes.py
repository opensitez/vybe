# vybe-test: python/python_email_message_parsing/test_email_message_add_attachment_bytes
...
__check(__line(msg.is_multipart()), "True")
parts = list(msg.iter_parts())
__check(__line(len(parts)), "2")
__check(__line(parts[1].get_filename()), "doc.pdf")
