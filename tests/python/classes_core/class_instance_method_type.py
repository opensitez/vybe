# vybe-test: python/classes_core/class_instance_method_type
# origin: languages/python/tests/python/test_classes_core.rs
...
class C:
 def f(self):
  pass
__p(__line(type(C().f).__name__))
__check(__buf, "method")
