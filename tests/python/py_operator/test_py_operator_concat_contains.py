...
__p(__line(operator.concat([1, 2], [3, 4])))
__p(__line(operator.concat("Hello", " World")))
__p(__line(operator.contains([1, 2, 3], 2)))
__p(__line(operator.contains([1, 2, 3], 5)))
__p(__line(operator.length_hint([1, 2, 3])))
