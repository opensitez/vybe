...
__p(__line(operator.lt(3, 5)))
__p(__line(operator.le(5, 5)))
__p(__line(operator.gt(7, 3)))
__p(__line(operator.ge(3, 3)))
__p(__line(operator.eq(4, 4)))
__p(__line(operator.ne(4, 5)))
__check(__buf, "True\nTrue\nTrue\nTrue\nTrue\nTrue")
