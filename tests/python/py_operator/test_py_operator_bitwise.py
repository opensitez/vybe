...
__p(__line(operator.and_(0b1100, 0b1010)))
__p(__line(operator.or_(0b1100, 0b1010)))
__p(__line(operator.xor(0b1100, 0b1010)))
__p(__line(operator.invert(~5 - 1)))
__p(__line(operator.lshift(1, 4)))
__p(__line(operator.rshift(256, 4)))
__check(__buf, '8\n14\n6\n6\n16\n16\n')
