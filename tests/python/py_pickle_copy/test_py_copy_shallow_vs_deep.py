...
__p(__line(original["key"]))  # modified! (shared reference)
__p(__line(shallow["key"]))

deep["nested"]["inner"] = 99
__p(__line(original["nested"]["inner"]))  # NOT modified (deep copy)
__p(__line(deep["nested"]["inner"]))
__check(__buf, "[1, 2, 3, 99]\n[1, 2, 3, 99]\n42\n99")
