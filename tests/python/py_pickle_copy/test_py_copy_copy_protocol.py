# vybe-test: python/py_pickle_copy/test_py_copy_copy_protocol
...
__check(__line(shallow.host, shallow.port), "localhost_copy 8080")
__check(__line(deep.host, deep.port), "deep_localhost 9080")
