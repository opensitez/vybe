# vybe-test: python/python_itertools_combinatorics/test_python_itertools_combinations
# origin: languages/python/tests/python/test_python_itertools_combinatorics.rs
...
import itertools
__p(__line(list(itertools.combinations([1, 2, 3, 4], 2))))
__check(__buf, "[(1, 2), (1, 3), (1, 4), (2, 3), (2, 4), (3, 4)]")
