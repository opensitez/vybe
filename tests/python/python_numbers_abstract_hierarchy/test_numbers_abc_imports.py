...
__p(__line(hasattr(numbers, 'Number')))
__p(__line(hasattr(numbers, 'Complex')))
__p(__line(hasattr(numbers, 'Real')))
__p(__line(hasattr(numbers, 'Rational')))
__p(__line(hasattr(numbers, 'Integral')))
__check(__buf, "True\nTrue\nTrue\nTrue\nTrue")
