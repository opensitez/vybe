...
f = Fraction(5, 8)
__p(__line(isinstance(f, numbers.Rational)))
__p(__line(f.numerator))
__p(__line(f.denominator))

i = 7
__p(__line(isinstance(i, numbers.Rational)))
__p(__line(i.numerator))
__p(__line(i.denominator))
__check(__buf, "True\n5\n8\nTrue\n7\n1")
