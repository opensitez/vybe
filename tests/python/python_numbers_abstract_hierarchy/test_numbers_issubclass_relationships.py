...
__p(__line(issubclass(numbers.Integral, numbers.Rational)))
__p(__line(issubclass(numbers.Rational, numbers.Real)))
__p(__line(issubclass(numbers.Real, numbers.Complex)))
__p(__line(issubclass(numbers.Complex, numbers.Number)))
__check(__buf, "True\nTrue\nTrue\nTrue")
