...
__p(__line(isinstance(a & b, numbers.Integral)))
__p(__line(isinstance(a | b, numbers.Integral)))
__p(__line(isinstance(a ^ b, numbers.Integral)))
__p(__line(isinstance(~a, numbers.Integral)))
__p(__line(isinstance(a << 2, numbers.Integral)))
__p(__line(isinstance(b >> 1, numbers.Integral)))
__check(__buf, "True\nTrue\nTrue\nTrue\nTrue\nTrue")
