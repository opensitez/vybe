...
x = Fraction(3, 4)
__p(__line(isinstance(x, numbers.Number)))
__p(__line(isinstance(x, numbers.Complex)))
__p(__line(isinstance(x, numbers.Real)))
__p(__line(isinstance(x, numbers.Rational)))
__p(__line(isinstance(x, numbers.Integral)))
__check(__buf, "True\nTrue\nTrue\nTrue\nFalse")
