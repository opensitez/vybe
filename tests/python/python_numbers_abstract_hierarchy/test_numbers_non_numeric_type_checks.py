...
__p(__line(isinstance("123", numbers.Number)))
__p(__line(isinstance([1, 2, 3], numbers.Number)))
__p(__line(isinstance({'a': 1}, numbers.Number)))
__p(__line(isinstance((1, 2), numbers.Number)))
__p(__line(isinstance(None, numbers.Number)))
__check(__buf, "False\nFalse\nFalse\nFalse\nFalse")
