# vybe-test: python/collections_stdlib/counter_from_list_counts
# origin: languages/python/tests/python/test_collections_stdlib.rs
...
__p(__line(list(Counter('aabbc').items())))
__check(__buf, "[('a', 2), ('b', 2), ('c', 1)]")
