...
__p(__line(describe_type("hello")))
__p(__line(describe_type(42)))
__p(__line(describe_type(-5)))
__p(__line(describe_type([1, 2, 3])))
__p(__line(describe_type(3.14)))
__check(__buf, "string: 'hello'\npositive int: 42\nnon-positive int: -5\nlist of 3\nother")
