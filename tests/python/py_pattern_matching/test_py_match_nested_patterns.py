# vybe-test: python/py_pattern_matching/test_py_match_nested_patterns
...
__p(__line(describe_matrix([[1, 2], [3, 4]])))
__p(__line(describe_matrix([[5, 6, 7], [8, 9, 10]])))
__check(__buf, "2x2: 1,2,3,4\nmatrix starting with 5")
