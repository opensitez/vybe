...
__p(__line(handle_event({"type": "click", "x": 10, "y": 20})))
__p(__line(handle_event({"type": "keypress", "key": "Enter"})))
__p(__line(handle_event({"type": "scroll"})))
__check(__buf, "click at (10, 20)\nkey: Enter\nunknown type: scroll")
