# vybe-test: python/python_functools_lru_cache_cmp/test_functools_lru_cache_parameters_inspection
...
__p(__line(g.cache_parameters()))
__check(__buf, "{'maxsize': 32, 'typed': False}")
