# vybe-test: python/py_contextlib_resource_management/test_py_contextlib_nullcontext_optional_lock
...
__p(__line(process_data()))
__check(__buf, "Processed with dummy_res")
