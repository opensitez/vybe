# vybe-test: python/python_token_tokenize/test_tokenize_tokeninfo_start_end
...
__p(__line(num.start[0]))  # line 1
__p(__line(num.end[0]))    # same line
__p(__line(num.start[1] < num.end[1]))  # col start < col end
__check(__buf, "1\n1\nTrue")
