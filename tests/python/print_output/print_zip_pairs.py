# vybe-test: python/print_output/print_zip_pairs
# origin: languages/python/tests/python/test_print_output.rs
...
__p(__line(list(zip([1, 2], ['a', 'b']))))
__check(__buf, "[(1, 'a'), (2, 'b')]")
