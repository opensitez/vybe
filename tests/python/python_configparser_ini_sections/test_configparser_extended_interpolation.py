# vybe-test: python/python_configparser_ini_sections/test_configparser_extended_interpolation
...
__p(__line(config.get("user_paths", "downloads")))
__check(__buf, "/home/user/Downloads")
