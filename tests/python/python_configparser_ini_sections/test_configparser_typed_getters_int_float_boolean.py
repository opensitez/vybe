...
__p(__line(config.getint("settings", "port")))
__p(__line(config.getfloat("settings", "ratio")))
__p(__line(config.getboolean("settings", "debug")))
__p(__line(config.getboolean("settings", "enabled")))
__p(__line(config.getboolean("settings", "offline")))
__check(__buf, "8080\n0.75\nTrue\nTrue\nFalse")
