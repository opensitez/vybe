# vybe-test: python/python_configparser_ini_sections/test_configparser_raw_config_parser_no_interpolation
...
__p(__line(config.get("sec", "pattern")))
__check(__buf, "%(not_interpolated)s")
