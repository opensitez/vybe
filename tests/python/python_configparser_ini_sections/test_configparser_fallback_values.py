# vybe-test: python/python_configparser_ini_sections/test_configparser_fallback_values
...
__p(__line(config.get("section", "missing_key", fallback="default_val")))
__p(__line(config.getint("section", "missing_int", fallback=42)))
__check(__buf, "default_val\n42")
