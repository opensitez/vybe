# vybe-test: python/python_configparser_ini_sections/test_configparser_duplicate_section_error
...
try:
    ...
    __p(__line("DuplicateSectionError"))
__check(__buf, "DuplicateSectionError")
