# vybe-test: python/python_html_parser_entities/test_html_escape_special_chars
# origin: languages/python/tests/python/test_python_html_parser_entities.rs
...
import html
__p(__line(html.escape("<script>alert('xss')</script>")))
__check(__buf, "&lt;script&gt;alert(&#x27;xss&#x27;)&lt;/script&gt;")
