# vybe-test: python/python_textwrap_fill_dedent/test_textwrap_textwrapper_initial_indent
...
__check(__line(lines[0]), ">>> one two three")
__check(__line(lines[1].startswith("    ")), "True")
