# vybe-test: python/python_symtable_symbol_tables/test_symtable_has_children_check
...
__check(__line(st1.has_children()), "False")
__check(__line(st2.has_children()), "True")
