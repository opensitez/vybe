# vybe-test: python/python_symtable_symbol_tables/test_symtable_is_optimized_function_scope
...
__check(__line(st_mod.is_optimized()), "False")
__check(__line(st_func.is_optimized()), "True")
