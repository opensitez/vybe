# vybe-test: python/python_glob_recursive_patterns/test_glob_recursive_finds_deep_nesting
...
__check(__line(len(results) == 1), "True")
__check(__line(results[0].endswith("deep.py")), "True")
shutil.rmtree(d)
