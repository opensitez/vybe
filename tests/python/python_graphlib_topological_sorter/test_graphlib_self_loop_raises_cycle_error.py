# vybe-test: python/python_graphlib_topological_sorter/test_graphlib_self_loop_raises_cycle_error
...
try:
    ...
    __p(__line("CycleErrorCaught"))
__check(__buf, "CycleErrorCaught")
