# vybe-test: python/py_weakref_reference_tracking/test_py_weakref_cannot_ref_builtin_types
...
try:
    ...
    __p(__line("TypeError: cannot create weak reference to 'int'"))
__check(__buf, "TypeError: cannot create weak reference to 'int'")
