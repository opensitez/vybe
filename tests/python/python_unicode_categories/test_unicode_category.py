...
import unicodedata
__p(__line(unicodedata.category('A')))   # Lu - uppercase letter
__p(__line(unicodedata.category('a')))   # Ll - lowercase letter
__p(__line(unicodedata.category('1')))   # Nd - decimal digit
__p(__line(unicodedata.category(' ')))   # Zs - space separator
__check(__buf, "Lu\nLl\nNd\nZs")
