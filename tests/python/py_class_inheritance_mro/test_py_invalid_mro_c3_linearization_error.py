# vybe-test: python/py_class_inheritance_mro/test_py_invalid_mro_c3_linearization_error
...
try:
    ...
    __p(__line("TypeError: Cannot create a consistent method resolution order"))
__check(__buf, "TypeError: Cannot create a consistent method resolution order")
