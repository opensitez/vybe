// vybe-test: java/polymorphism/virtual_dispatch_in_loop_over_mixed_types
...
Node[] nodes = new Node[] { new A(), new B() }; int sum = 0; for (int i = 0; i < nodes.length; i++) { sum = sum + nodes[i].val(); } __p(sum);
__check("3");
    }
}
