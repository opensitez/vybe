// vybe-test: java/throw_declares/catch_and_wrap_custom_exception_changes_message
...
try { try { throw new LowError("low"); } catch (LowError e) { throw new HighError("high"); } } catch (HighError e) { __p(e.getMessage()); }
__check("high");
    }
}
