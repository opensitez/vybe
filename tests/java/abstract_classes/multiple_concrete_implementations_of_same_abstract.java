// vybe-test: java/abstract_classes/multiple_concrete_implementations_of_same_abstract
...
Codec h = new HexCodec(); Codec d = new DecCodec(); __p(h.encode(1)); __p(d.encode(1));
__check("h1\nd1");
    }
}
