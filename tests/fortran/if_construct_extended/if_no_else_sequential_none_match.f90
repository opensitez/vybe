! vybe-test: fortran/if_construct_extended/if_no_else_sequential_none_match
...
if (trim("end") /= trim(vybe_check_w(vybe_check_i))) then
    print *, "FAIL at ", vybe_check_i, " got [", "end", "]"
    stop 1
end if
if (vybe_check_i /= 1) then
