! vybe-test: fortran/full_programs/fft_unit_impulse_real_only_runtime
! origin: languages/fortran/tests/fortran/test_full_programs.rs
integer :: vybe_check_i = 0
integer :: vybe_check_w(4) = [ 1, 1, 1, 1 ]
...
program t
    ...
    do i = 1, 4
        ...
        if ((nint(real(x(i)))) /= vybe_check_w(vybe_check_i)) then
            print *, "FAIL at ", vybe_check_i, " got [", nint(real(x(i))), "]"
            stop 1
        end if
    end do
if (vybe_check_i /= 4) then
