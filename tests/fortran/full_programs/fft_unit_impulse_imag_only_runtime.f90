! vybe-test: fortran/full_programs/fft_unit_impulse_imag_only_runtime
! origin: languages/fortran/tests/fortran/test_full_programs.rs
integer :: vybe_check_i = 0
integer :: vybe_check_w(4) = [ 0, 0, 0, 0 ]
...
program t
    ...
    do i = 1, 4
        ...
        if ((nint(aimag(x(i)))) /= vybe_check_w(vybe_check_i)) then
            print *, "FAIL at ", vybe_check_i, " got [", nint(aimag(x(i))), "]"
            stop 1
        end if
    end do
if (vybe_check_i /= 4) then
