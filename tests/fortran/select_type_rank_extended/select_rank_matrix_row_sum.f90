! vybe-test: fortran/select_type_rank_extended/select_rank_matrix_row_sum
...
if ((x(1,1) + x(1,2)) /= vybe_check_w(vybe_check_i)) then
    print *, "FAIL at ", vybe_check_i, " got [", x(1,1) + x(1,2), "]"
    stop 1
end if
rank default
vybe_check_i = vybe_check_i + 1
