! vybe-test: fortran/select_type_rank_extended/select_rank_real_matrix
...
if ((int(x(1,1) + x(2,2))) /= vybe_check_w(vybe_check_i)) then
    print *, "FAIL at ", vybe_check_i, " got [", int(x(1,1) + x(2,2)), "]"
    stop 1
end if
rank default
vybe_check_i = vybe_check_i + 1
