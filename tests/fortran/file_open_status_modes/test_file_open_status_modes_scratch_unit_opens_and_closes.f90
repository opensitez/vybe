! vybe-test: fortran/file_open_status_modes/test_file_open_status_modes_scratch_unit_opens_and_closes
! origin: languages/fortran/tests/fortran/test_file_open_status_modes.rs
