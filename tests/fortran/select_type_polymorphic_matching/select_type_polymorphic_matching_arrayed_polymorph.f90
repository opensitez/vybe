! vybe-test: fortran/select_type_polymorphic_matching/select_type_polymorphic_matching_arrayed_polymorph
...
integer :: vybe_check_w(1) = [ 1 ]
    ...
    type is (integer)
        ...
        if ((value(1)) /= vybe_check_w(vybe_check_i)) then
            print *, "FAIL at ", vybe_check_i, " got [", value(1), "]"
            stop 1
        end if
    class default
                vybe_check_i = vybe_check_i + 1
