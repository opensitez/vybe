! vybe-test: fortran/sql/sql_cursor_open_09
! origin: languages/fortran/tests/fortran/test_sql_cics.rs
program sql_cursor_open_09
use iso_c_binding
implicit none
interface
...
db = c_null_ptr
errmsg = c_null_ptr
rc = sqlite3_open(c_char_"sql_cursor_open_09.db"//c_null_char, db)
if (rc /= 0) then
...
end program sql_cursor_open_09
