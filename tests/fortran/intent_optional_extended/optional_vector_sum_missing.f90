! vybe-test: fortran/intent_optional_extended/optional_vector_sum_missing
...
if ((sum_opt(v, 3)) /= vybe_check_w(vybe_check_i)) then
    print *, "FAIL at ", vybe_check_i, " got [", sum_opt(v, 3), "]"
    stop 1
end if
if (vybe_check_i /= 1) then
