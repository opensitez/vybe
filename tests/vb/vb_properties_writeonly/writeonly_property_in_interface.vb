' vybe-test: vb/vb_properties_writeonly/writeonly_property_in_interface
...
Class User
    ...
    Public WriteOnly Property Password As String Implements IPasswordSettable.Password
        Set(value As String)
            __P(CStr("Password set to length: " & value.Length.ToString()))
        End Set
    End Property
End Class
...
Module M
    Sub Main()
        ...
        __Check("Password set to length: 9")
    End Sub
End Module
