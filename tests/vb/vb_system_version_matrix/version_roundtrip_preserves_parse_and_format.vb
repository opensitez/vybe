...
Module M
    Sub Main()
        ...
        __P(CStr(source.Major = roundTrip.Major))
        __P(CStr(source.Minor = roundTrip.Minor))
        __P(CStr(source.Build = roundTrip.Build))
        __P(CStr(source.Revision = roundTrip.Revision))
        __Check("True
True
True
True")
