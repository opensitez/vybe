' vybe-test: vb/vb_optional_arguments/optional_arguments_work_in_shared_methods
...
Module M
    Sub Main()
        __Check(CStr(Formatter.Wrap("core")), "[core]")
        __Check(CStr(Formatter.Wrap("value", "<", ">")), "<value>")
    End Sub
End Module
