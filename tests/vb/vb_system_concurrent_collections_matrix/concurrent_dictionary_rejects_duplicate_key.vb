' vybe-test: vb/vb_system_concurrent_collections_matrix/concurrent_dictionary_rejects_duplicate_key
...
Module M
    Sub Main()
        ...
        __Check(CStr(duplicate), "False")
        __Check(CStr(values("alpha")), "1")
    End Sub
End Module
