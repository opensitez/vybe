' vybe-test: vb/vb_reflection_constructors_create_instance/test_vb_reflection_private_constructor_invoke_binding_flags
...
Class Singleton
    Private Sub New()
        __P(CStr("Private Constructor Invoked"))
    End Sub
End Class
...
Module Program
    Sub Main()
        ...
        __P(CStr(instance IsNot Nothing))
        __Check("Private Constructor Invoked
True")
    End Sub
End Module
