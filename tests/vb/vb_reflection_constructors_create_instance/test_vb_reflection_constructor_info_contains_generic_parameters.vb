' vybe-test: vb/vb_reflection_constructors_create_instance/test_vb_reflection_constructor_info_contains_generic_parameters
...
Module Program
    Sub Main()
        ...
        __Check(CStr(ctor.GetParameters()(0).ParameterType.Name), "String")
    End Sub
End Module
