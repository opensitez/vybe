' vybe-test: vb/vb_task_completion_source_set_result/test_vb_tcs_with_tuple_payload
...
Module Program
    Sub Main()
        ...
        __P(CStr(tcs.Task.Result.Code & " " & tcs.Task.Result.Msg))
        __Check("404 Not Found")
    End Sub
End Module
