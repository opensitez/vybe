' vybe-test: vb/vb_async_configure_await_false/test_vb_async_configure_await_returning_tuple
...
Module Program
    ...
    Sub Main()
        Dim t = GetTupleAsync()
        __P(CStr(t.Result.Code & " " & t.Result.Message))
        __Check("200 SuccessTuple")
    End Sub
End Module
