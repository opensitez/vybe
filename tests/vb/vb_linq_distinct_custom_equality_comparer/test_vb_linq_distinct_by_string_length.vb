' vybe-test: vb/vb_linq_distinct_custom_equality_comparer/test_vb_linq_distinct_by_string_length
...
Module Program
    Sub Main()
        ...
        __P(CStr(String.Join(",", uniqueLengths)))
        __Check("cat,elephant,bear")
    End Sub
End Module
