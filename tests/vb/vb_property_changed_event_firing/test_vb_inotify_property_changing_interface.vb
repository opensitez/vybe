...
Module Program
    Sub Main()
        ...
        AddHandler item.PropertyChanging, Sub(s, e) __P(CStr("Changing:" & e.PropertyName))
        AddHandler item.PropertyChanged, Sub(s, e) __P(CStr("Changed:" & e.PropertyName))
        item.Score = 95
        __Check("Changing:Score
Changed:Score")
    End Sub
End Module
