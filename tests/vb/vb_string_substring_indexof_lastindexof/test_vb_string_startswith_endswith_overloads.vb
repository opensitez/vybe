...
Module Program
    Sub Main()
        ...
        __P(CStr(s.StartsWith("HTTPS", StringComparison.OrdinalIgnoreCase)))
        __P(CStr(s.EndsWith(".HTML", StringComparison.OrdinalIgnoreCase)))
        __P(CStr(s.StartsWith("http://")))
        __P(CStr(s.EndsWith(".php")))
        __Check("True
True
False
False")
