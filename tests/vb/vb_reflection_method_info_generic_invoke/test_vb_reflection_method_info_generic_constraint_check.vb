' vybe-test: vb/vb_reflection_method_info_generic_invoke/test_vb_reflection_method_info_generic_constraint_check
...
Module Program
    Sub Main()
        ...
        __P(CStr(tParam.GenericParameterAttributes.ToString()))
        __Check("ReferenceTypeConstraint")
    End Sub
End Module
