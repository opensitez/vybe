' vybe-test: vb/vb_object_late_bound_method_call/test_vb_late_bound_method_overload_resolution
...
Module Program
    ...
    Sub Main()
        ...
        __P(CStr(CStr(obj.Print(42)) & "|" & CStr(obj.Print("Hello"))))
        __Check("Int:42|Str:Hello")
    End Sub
End Module
