' vybe-test: vb/vb_guid_parse_parse_exact_formats/test_vb_guid_to_string_format_specifiers_n_d_b_p_x
...
Module Program
    Sub Main()
        ...
        __P(CStr(formatN.Length & "|" & formatB.StartsWith("{") & "|" & formatP.StartsWith("(")))
        __Check("32|True|True")
    End Sub
End Module
