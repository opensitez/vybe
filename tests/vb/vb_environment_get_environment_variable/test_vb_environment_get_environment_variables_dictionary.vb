' vybe-test: vb/vb_environment_get_environment_variable/test_vb_environment_get_environment_variables_dictionary
...
Module Program
    Sub Main()
        ...
        __P(CStr(dict.Contains("VYBE_DICT_VAR") & "|" & dict("VYBE_DICT_VAR")))
        __Check("True|DictVal")
    End Sub
End Module
