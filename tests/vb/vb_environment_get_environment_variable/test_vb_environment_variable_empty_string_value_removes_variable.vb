' vybe-test: vb/vb_environment_get_environment_variable/test_vb_environment_variable_empty_string_value_removes_variable
...
Module Program
    Sub Main()
        ...
        __Check(CStr(val Is Nothing OrElse val = ""), "True")
    End Sub
End Module
