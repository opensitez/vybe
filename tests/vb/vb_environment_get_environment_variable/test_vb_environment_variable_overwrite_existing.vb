' vybe-test: vb/vb_environment_get_environment_variable/test_vb_environment_variable_overwrite_existing
...
Module Program
    Sub Main()
        ...
        __Check(CStr(Environment.GetEnvironmentVariable("OVERWRITE_VAR")), "V2")
    End Sub
End Module
