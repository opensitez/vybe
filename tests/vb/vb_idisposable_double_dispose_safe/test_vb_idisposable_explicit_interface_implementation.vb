' vybe-test: vb/vb_idisposable_double_dispose_safe/test_vb_idisposable_explicit_interface_implementation
...
Class ExplicitDisposable
    ...
    Private Sub IDisposable_Dispose() Implements IDisposable.Dispose
        __P(CStr("Explicit IDisposable.Dispose"))
    End Sub
End Class
...
Module Program
    Sub Main()
        ...
        d.Dispose()
        __Check("Explicit IDisposable.Dispose")
    End Sub
End Module
