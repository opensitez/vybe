' vybe-test: vb/vb_safe_handle_invalid_check/test_vb_safe_handle_critical_finalizer_object_heritage
...
Module Program
    Sub Main()
        ...
        __Check(CStr(TypeOf h Is ConstrainedExecution.CriticalFinalizerObject), "True")
    End Sub
End Module
