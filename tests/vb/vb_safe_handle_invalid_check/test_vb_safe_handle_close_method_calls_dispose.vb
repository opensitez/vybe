' vybe-test: vb/vb_safe_handle_invalid_check/test_vb_safe_handle_close_method_calls_dispose
...
Class ClosableSafeHandle
    ...
    Protected Overrides Function ReleaseHandle() As Boolean
        __Check(CStr("ReleaseHandle Executed"), "ReleaseHandle Executed")
        Return True
    End Function
End Class
