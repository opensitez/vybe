' vybe-test: vb/vb_date_time_offset_utc_conversion/test_vb_date_time_offset_add_hours_preserves_offset
...
Module Program
    Sub Main()
        ...
        __Check(CStr(updated.Hour & "|" & updated.Offset.Hours), "15|3")
    End Sub
End Module
