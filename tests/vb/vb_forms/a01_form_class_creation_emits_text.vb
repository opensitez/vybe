' vybe-test: vb/vb_forms/a01_form_class_creation_emits_text

' RECONSTRUCTED. The extractor wrote this file's expected VALUE out as its
' source — the whole program was the single word `form1`, which parses as a
