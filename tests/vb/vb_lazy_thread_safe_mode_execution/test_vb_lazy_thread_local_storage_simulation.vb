' vybe-test: vb/vb_lazy_thread_safe_mode_execution/test_vb_lazy_thread_local_storage_simulation
...
Module Program
    Sub Main()
        ...
        __Check(CStr(threadLocalVal.IsValueCreated & "|" & (threadLocalVal.Value > 0)), "False|True")
    End Sub
End Module
