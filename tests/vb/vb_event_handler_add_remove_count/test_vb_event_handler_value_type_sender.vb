' vybe-test: vb/vb_event_handler_add_remove_count/test_vb_event_handler_value_type_sender
...
Module Program
    Sub Main()
        ...
        AddHandler n.CustomEvent, Sub(s, e) __P(CStr("Sender Value: " & s.ToString()))
        n.TriggerValueSender()
        __Check("Sender Value: 100")
    End Sub
End Module
