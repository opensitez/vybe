' vybe-test: vb/vb_system_threading_pool_matrix/threadpool_get_and_set_max_threads_round_trip
...
Module M
    Sub Main()
        ...
        __Check(CStr(reapply), "True")
        __Check(CStr(workerThreads > 0), "True")
        __Check(CStr(completionThreads >= 0), "True")
    End Sub
End Module
