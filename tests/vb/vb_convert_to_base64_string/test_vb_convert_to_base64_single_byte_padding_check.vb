' vybe-test: vb/vb_convert_to_base64_string/test_vb_convert_to_base64_single_byte_padding_check
...
Module Program
    Sub Main()
        ...
        __P(CStr(b64 & "|EndsWith==" & b64.EndsWith("==")))
        __Check("QQ==|EndsWith==True")
    End Sub
End Module
