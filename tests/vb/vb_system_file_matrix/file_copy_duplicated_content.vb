' vybe-test: vb/vb_system_file_matrix/file_copy_duplicated_content
...
Module M
    Sub Main()
        ...
        __Check(CStr(File.ReadAllText(destination)), "copy-me")
        __Check(CStr(File.ReadAllText(source) = File.ReadAllText(destination)), "True")
        File.Delete(source)
