...
Module Program
    Sub Main()
        Dim fmt = "{0:+#,##0;-#,##0;ZERO}"
        __P(CStr(String.Format(CultureInfo.InvariantCulture, fmt, 50) & "|" & String.Format(CultureInfo.InvariantCulture, fmt, -50) & "|" & String.Format(CultureInfo.InvariantCulture, fmt, 0)))
        __Check("+50|-50|ZERO")
    End Sub
End Module
