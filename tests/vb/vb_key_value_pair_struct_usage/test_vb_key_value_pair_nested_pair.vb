' vybe-test: vb/vb_key_value_pair_struct_usage/test_vb_key_value_pair_nested_pair
...
Module Program
    Sub Main()
        ...
        __P(CStr(outer.Key & "->" & outer.Value.Key & "->" & outer.Value.Value))
        __Check("Outer->Inner->42")
    End Sub
End Module
