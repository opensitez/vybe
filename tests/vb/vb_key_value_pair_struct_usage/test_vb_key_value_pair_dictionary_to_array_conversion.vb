' vybe-test: vb/vb_key_value_pair_struct_usage/test_vb_key_value_pair_dictionary_to_array_conversion
...
Module Program
    Sub Main()
        ...
        __Check(CStr(arr(0).Key & "=" & arr(0).Value & "|" & arr(1).Key & "=" & arr(1).Value), "X=10|Y=20")
    End Sub
End Module
