' vybe-test: vb/vb_generic_static_member_per_type/test_vb_generic_shared_field_inheritance_base_class
...
Module Program
    Sub Main()
        ...
        __P(CStr(DerivedInt.BaseTag & "|" & DerivedString.BaseTag))
        __Check("IntDerived|StringDerived")
    End Sub
End Module
