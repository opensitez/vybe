' vybe-test: vb/vb_generic_static_member_per_type/test_vb_generic_shared_field_lock_object_isolation
...
Module Program
    Sub Main()
        ...
        __Check(CStr(Object.ReferenceEquals(lockInt, lockStr)), "False")
    End Sub
End Module
