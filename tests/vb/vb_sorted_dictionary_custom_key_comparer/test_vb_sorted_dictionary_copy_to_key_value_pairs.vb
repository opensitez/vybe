' vybe-test: vb/vb_sorted_dictionary_custom_key_comparer/test_vb_sorted_dictionary_copy_to_key_value_pairs
...
Module Program
    Sub Main()
        ...
        dict.CopyTo(arr, 0)
        __Check(CStr(arr(0).Key & "=" & arr(0).Value), "1=One")
        __Check(CStr(arr(1).Key & "=" & arr(1).Value), "2=Two")
    End Sub
End Module
