' vybe-test: vb/vb_directcast_anonymous_type/directcast_anonymous_type
' origin: languages/vb/tests/vb/test_vb_directcast_anonymous_type.rs
...
Module M
    Sub Main()
        ...
        __Check(CStr(c.Name), "Test") ' Late bound
    End Sub
End Module
