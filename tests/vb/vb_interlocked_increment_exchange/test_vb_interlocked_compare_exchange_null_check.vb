' vybe-test: vb/vb_interlocked_increment_exchange/test_vb_interlocked_compare_exchange_null_check
...
Module Program
    Sub Main()
        ...
        __P(CStr((oldVal Is Nothing) & "|" & target))
        __Check("True|Initialized")
    End Sub
End Module
