' vybe-test: vb/vb_interlocked_increment_exchange/test_vb_interlocked_compare_exchange_no_match
...
Module Program
    Sub Main()
        ...
        __P(CStr("Old: " & oldVal & " | Current: " & target))
        __Check("Old: 50 | Current: 50")
    End Sub
End Module
