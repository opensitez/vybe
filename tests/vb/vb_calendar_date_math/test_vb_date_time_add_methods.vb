...
Module Program
    Sub Main()
        ...
        __P(CStr(dt.AddDays(1).ToString("yyyy-MM-dd")))
        __P(CStr(dt.AddMonths(1).ToString("yyyy-MM-dd")))
        __P(CStr(dt.AddYears(1).ToString("yyyy-MM-dd")))
        __P(CStr(DateTime.IsLeapYear(2024)))
        __Check("2024-02-29
2024-03-28
2025-02-28
True")
