' vybe-test: vb/vb_regex_matches_named_groups/test_vb_regex_timeout_cancellation
...
Module Program
    Sub Main()
        ...
        Catch ex As RegexMatchTimeoutException
            __P(CStr("RegexMatchTimeoutException Caught"))
        End Try
        __Check("RegexMatchTimeoutException Caught")
    End Sub
End Module
