...
Module M
    ' VB.NET has no `IsMissing`: an Optional parameter MUST carry a default
    ' value, and an omitted argument arrives as that default.
    Function CheckMissing(Optional ByVal arg As Object = Nothing) As Boolean
        Return arg Is Nothing
    End Function

    Sub Main()
        __P(CStr(CheckMissing()))
        __P(CStr(CheckMissing("here")))
        __Check("True" & vbLf & "False")
    End Sub
End Module
