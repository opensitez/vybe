...
Module M
    Sub Main()
        ...
        __P(CStr(Uri.TryCreate("https://example.com", UriKind.Absolute, absolute)))
        __P(CStr(Uri.TryCreate("bad uri !", UriKind.Absolute, relative)))
        __P(CStr(absolute IsNot Nothing))
        __P(CStr(relative Is Nothing))
        __Check("True
False
True
True")
