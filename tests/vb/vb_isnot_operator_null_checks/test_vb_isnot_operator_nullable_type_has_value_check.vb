' vybe-test: vb/vb_isnot_operator_null_checks/test_vb_isnot_operator_nullable_type_has_value_check
...
Module Program
    Sub Main()
        ...
        __Check(CStr((n1 IsNot Nothing) & "|" & (n2 IsNot Nothing)), "True|False")
    End Sub
End Module
