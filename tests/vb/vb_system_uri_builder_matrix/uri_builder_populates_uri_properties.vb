...
Module M
    Sub Main()
        ...
        __P(CStr(builder.Uri.Scheme))
        __P(CStr(builder.Uri.Host))
        __P(CStr(builder.Uri.Port))
        __P(CStr(builder.Uri.AbsolutePath))
        __P(CStr(builder.Uri.Query))
        __P(CStr(builder.Uri.Fragment))
        __Check("https
example.com
443
/api/v1
