' vybe-test: vb/vb_spec_datetime_conversions/datetime_spec_cdate_parses_datetime_string
...
Module M
    Sub Main()
        __P(CStr(CStr(CDate("5/14/2024 3:45:59 PM"))))
        ...
        ' codepoint.
        __Check("5/14/2024 3:45:59" & ChrW(&H202F) & "PM")
    End Sub
End Module
