' vybe-test: vb/vb_spec_datetime_conversions/datetime_spec_timevalue_parses_short_time_string
...
Module M
    Sub Main()
        __P(CStr(CStr(TimeValue("3:45 PM"))))
