// vybe-test: pascal/pascal_dynamic_array_multidimensional_ops/test_dynarray_2d_element_read_write
...
begin
  ...
  m[0, 0] := 1; m[0, 1] := 2;
  m[1, 0] := 3; m[1, 1] := 4;
  __p(__vs(m[0, 0].ToString + ',' + m[0, 1].ToString));
  __p(__vs(m[1, 0].ToString + ',' + m[1, 1].ToString));
__vybeCheck('1,2' + #10 + '3,4');
end.
