// vybe-test: pascal/pascal_dynamic_array_multidimensional_ops/test_dynarray_2d_procedure_var_param
...
begin
  InitIdentity(mat, 3);
  __p(__vs(mat[0, 0].ToString + ',' + mat[1, 1].ToString + ',' + mat[2, 2].ToString));
  __p(__vs(mat[0, 1]));
__vybeCheck('1,1,1' + #10 + '0');
end.
