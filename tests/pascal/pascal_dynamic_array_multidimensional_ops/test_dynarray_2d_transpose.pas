// vybe-test: pascal/pascal_dynamic_array_multidimensional_ops/test_dynarray_2d_transpose
...
begin
  ...
  t := Transpose(m);
  __p(__vs(Length(t).ToString + 'x' + Length(t[0]).ToString));
  __p(__vs(t[2, 0])); // m[0, 2] = 3
__vybeCheck('3x2' + #10 + '3');
end.
