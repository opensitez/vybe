// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_in_constructor
...
begin
  try
    ...
    on E: Exception do __p(__vs('CtorCaught:' + E.Message));
  end;
__vybeCheck('CtorCaught:CodeTooSmall');
end.
