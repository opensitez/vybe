// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_restoring_asserterrorproc
// origin: languages/pascal/tests/pascal/test_pascal_assertion_handling_assert.rs
program Test;
{$mode delphi}
...
begin
  ...
  try
    ...
    on E: EAssertionFailed do __p(__vs('StandardHandler:' + E.Message));
  end;
__vybeCheck('DummyHandler:Msg1' + #10 + 'StandardHandler:Msg2');
end.
