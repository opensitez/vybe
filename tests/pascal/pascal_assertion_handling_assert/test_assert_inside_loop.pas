// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_inside_loop
...
begin
  ...
  begin
    try
      ...
      __p(__vs('ElementOK:' + arr[i].ToString));
    except
      on E: Exception do __p(__vs('CaughtAtIndex:' + i.ToString));
    end;
  end;
__vybeCheck('ElementOK:2' + #10 + 'ElementOK:4' + #10 + 'CaughtAtIndex:2');
end.
