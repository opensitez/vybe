// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_assertions_on_directive
...
begin
  try
    ...
    on E: EAssertionFailed do __p(__vs('AssertionsOnTriggered'));
  end;
__vybeCheck('AssertionsOnTriggered');
end.
