// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_condition_false_raises_eassertionfailed
...
begin
  try
    ...
    on E: EAssertionFailed do __p(__vs('AssertFailedCaught'));
  end;
__vybeCheck('AssertFailedCaught');
end.
