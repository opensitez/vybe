// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_in_class_method
...
begin
  ...
  try
    acc.Deposit(100);
    __p(__vs('Deposit100OK'));
    acc.Deposit(-50);
  except
    on E: Exception do __p(__vs('Caught:' + E.Message));
  end;
  acc.Free;
__vybeCheck('Deposit100OK' + #10 + 'Caught:DepositMustBePositive');
end.
