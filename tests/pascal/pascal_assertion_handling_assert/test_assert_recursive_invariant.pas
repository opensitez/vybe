// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_recursive_invariant
...
begin
  try
    __p(__vs(Factorial(4)));
    Factorial(-2);
  except
    on E: Exception do __p(__vs(E.Message));
  end;
__vybeCheck('24' + #10 + 'FactorialNegativeInput');
end.
