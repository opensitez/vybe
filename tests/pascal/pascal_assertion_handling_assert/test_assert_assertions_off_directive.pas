// vybe-test: pascal/pascal_assertion_handling_assert/test_assert_assertions_off_directive
...
begin
  Assert(10 < 5);
  __p(__vs('AssertionsOffIgnoredFailure'));
__vybeCheck('AssertionsOffIgnoredFailure');
end.
