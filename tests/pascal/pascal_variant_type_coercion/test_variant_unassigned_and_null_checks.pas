// vybe-test: pascal/pascal_variant_type_coercion/test_variant_unassigned_and_null_checks
// origin: languages/pascal/tests/pascal/test_pascal_variant_type_coercion.rs
program Test;
{$mode delphi}
uses SysUtils;
...
var v: Variant;
begin
  __p(__vs(VarIsEmpty(v)));
  v := Null;
  __p(__vs(VarIsNull(v)));
  __p(__vs(VarIsEmpty(v)));
