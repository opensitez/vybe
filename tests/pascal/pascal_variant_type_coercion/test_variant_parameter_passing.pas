// vybe-test: pascal/pascal_variant_type_coercion/test_variant_parameter_passing
...
begin
  __p(__vs(FormatVariant(123)));
  __p(__vs(FormatVariant('ABC')));
__vybeCheck('Val=123' + #10 + 'Val=ABC');
end.
