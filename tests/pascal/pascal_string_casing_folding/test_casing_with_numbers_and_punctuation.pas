// vybe-test: pascal/pascal_string_casing_folding/test_casing_with_numbers_and_punctuation
...
begin
  __p(__vs(UpperCase('123-abc_DEF!')));
  __p(__vs(LowerCase('123-abc_DEF!')));
__vybeCheck('123-ABC_DEF!' + #10 + '123-abc_def!');
end.
