// vybe-test: pascal/pascal_string_casing_folding/test_ansiuppercase_and_ansilowercase
...
uses SysUtils;
begin
  __p(__vs(AnsiUpperCase('object pascal')));
  __p(__vs(AnsiLowerCase('OBJECT PASCAL')));
__vybeCheck('OBJECT PASCAL' + #10 + 'object pascal');
end.
