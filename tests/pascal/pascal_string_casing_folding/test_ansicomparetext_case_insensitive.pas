// vybe-test: pascal/pascal_string_casing_folding/test_ansicomparetext_case_insensitive
...
uses SysUtils;
begin
  __p(__vs(AnsiCompareText('abc', 'ABC') = 0));
  __p(__vs(AnsiCompareText('abc', 'DEF') < 0));
