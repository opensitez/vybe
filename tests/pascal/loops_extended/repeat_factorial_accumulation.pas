// vybe-test: pascal/loops_extended/repeat_factorial_accumulation
...
end; var i,f:Integer; begin i:=1; f:=1; repeat f:=f*i; Inc(i); until i>5; __p(__vs(f)); __vybeCheck('120');
end.
