// vybe-test: pascal/loops_extended/repeat_continue_in_middle
...
end; var n:Integer; begin n:=0; repeat Inc(n); if n=2 then Continue; __p(__vs(n)); until n>=4; __vybeCheck('1' + #10 + '3' + #10 + '4');
end.
