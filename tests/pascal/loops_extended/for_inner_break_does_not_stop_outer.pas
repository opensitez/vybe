// vybe-test: pascal/loops_extended/for_inner_break_does_not_stop_outer
...
end; var i,j,hits:Integer; begin hits:=0; for i:=1 to 2 do begin for j:=1 to 3 do begin Inc(hits); if j=1 then Break; end; end; __p(__vs(hits)); __vybeCheck('2');
end.
