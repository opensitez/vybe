// vybe-test: pascal/loops_extended/nested_repeat_inner_break_outer
...
end; var i,j:Integer; begin i:=0; repeat Inc(i); j:=0; repeat Inc(j); if j=2 then Break; until false; until i=2; __p(__vs(i)); __p(__vs(j)); __vybeCheck('2' + #10 + '2');
end.
