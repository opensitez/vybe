// vybe-test: pascal/loops_extended/for_step_simulated_with_while_positive
...
end; var i,start,stop,step:Integer; begin start:=2; stop:=10; step:=2; i:=start; while i<=stop do begin __p(__vs(i)); i:=i+step; end; __vybeCheck('2' + #10 + '4' + #10 + '6' + #10 + '8' + #10 + '10');
end.
