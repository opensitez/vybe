// vybe-test: pascal/loops_extended/for_enum_members_iteration
...
end; type TColor=(Red,Green,Blue); var c:TColor; begin for c:=Red to Blue do __p(__vs(Ord(c))); __vybeCheck('0' + #10 + '1' + #10 + '2');
end.
