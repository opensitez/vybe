// vybe-test: pascal/loops_extended/while_manual_step_by_three_down
...
end; var i:Integer; begin i:=9; while i>=0 do begin __p(__vs(i)); i:=i-3; end; __vybeCheck('9' + #10 + '6' + #10 + '3' + #10 + '0');
end.
