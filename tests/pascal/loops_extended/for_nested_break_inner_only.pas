// vybe-test: pascal/loops_extended/for_nested_break_inner_only
...
end; var i,j:Integer; begin for i:=1 to 3 do begin for j:=1 to 3 do begin if j=2 then Break; __p(__vs(IntToStr(i)+'-'+IntToStr(j))); end; end; __vybeCheck('1-1' + #10 + '2-1' + #10 + '3-1');
end.
