// vybe-test: pascal/loops_extended/for_break_on_match
...
end; var i:Integer; begin for i:=1 to 10 do begin if i=4 then Break; __p(__vs(i)); end; __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
