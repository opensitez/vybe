// vybe-test: pascal/loops_extended/while_continue_skip_even
...
end; var i:Integer; begin i:=0; while i<5 do begin Inc(i); if i mod 2=0 then Continue; __p(__vs(i)); end; __vybeCheck('1' + #10 + '3' + #10 + '5');
end.
