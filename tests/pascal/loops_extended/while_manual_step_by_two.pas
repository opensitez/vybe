// vybe-test: pascal/loops_extended/while_manual_step_by_two
...
end; var i:Integer; begin i:=0; while i<=6 do begin __p(__vs(i)); i:=i+2; end; __vybeCheck('0' + #10 + '2' + #10 + '4' + #10 + '6');
end.
