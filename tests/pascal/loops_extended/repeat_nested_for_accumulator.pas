// vybe-test: pascal/loops_extended/repeat_nested_for_accumulator
...
end; var outer,inner,sum:Integer; begin sum:=0; outer:=0; repeat Inc(outer); inner:=0; for inner:=1 to outer do sum:=sum+1; until outer=3; __p(__vs(sum)); __vybeCheck('6');
end.
