// vybe-test: pascal/loops_extended/nested_while_triangular_number
...
end; var i,j,sum:Integer; begin sum:=0; i:=1; while i<=4 do begin j:=1; while j<=i do begin sum:=sum+1; Inc(j); end; Inc(i); end; __p(__vs(sum)); __vybeCheck('10');
end.
