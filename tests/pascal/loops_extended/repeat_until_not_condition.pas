// vybe-test: pascal/loops_extended/repeat_until_not_condition
...
end; var running:Boolean; begin running:=true; repeat __p(__vs('tick')); running:=false; until not running; __vybeCheck('tick');
end.
