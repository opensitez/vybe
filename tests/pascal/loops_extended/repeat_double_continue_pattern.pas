// vybe-test: pascal/loops_extended/repeat_double_continue_pattern
...
end; var n,outc:Integer; begin n:=0; outc:=0; repeat Inc(n); if n mod 2=0 then Continue; if n>5 then Break; Inc(outc); until false; __p(__vs(outc)); __vybeCheck('3');
end.
