// vybe-test: pascal/loops_extended/repeat_until_with_and_condition
...
end; var x,y:Integer; begin x:=0; y:=0; repeat Inc(x); Inc(y); until (x>=2) and (y>=2); __p(__vs(x)); __vybeCheck('2');
end.
