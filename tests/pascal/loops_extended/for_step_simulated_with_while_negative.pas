// vybe-test: pascal/loops_extended/for_step_simulated_with_while_negative
// origin: languages/pascal/tests/pascal/test_loops_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var i,start,stop,step:Integer; begin start:=10; stop:=2; step:=-2; i:=start; while i>=stop do begin __p(__vs(i)); i:=i+step; end; __vybeCheck('10' + #10 + '8' + #10 + '6' + #10 + '4' + #10 + '2');
end.
