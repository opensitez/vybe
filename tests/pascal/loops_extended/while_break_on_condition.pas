// vybe-test: pascal/loops_extended/while_break_on_condition
...
end; var n:Integer; begin n:=0; while true do begin Inc(n); if n=3 then Break; __p(__vs(n)); end; __vybeCheck('1' + #10 + '2');
end.
