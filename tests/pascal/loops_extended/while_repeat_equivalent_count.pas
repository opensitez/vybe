// vybe-test: pascal/loops_extended/while_repeat_equivalent_count
...
end; var a,b:Integer; begin a:=0; while a<3 do begin Inc(a); end; b:=0; repeat Inc(b); until b>=3; __p(__vs(a)); __p(__vs(b)); __vybeCheck('3' + #10 + '3');
end.
