// vybe-test: pascal/loops_extended/repeat_until_with_or_condition
...
end; var a,b:Integer; begin a:=0; b:=10; repeat Inc(a); until (a>=3) or (b<0); __p(__vs(a)); __vybeCheck('3');
end.
