// vybe-test: pascal/loops_extended/for_continue_skip_multiples_of_three
...
end; var i:Integer; begin for i:=1 to 6 do begin if i mod 3=0 then Continue; __p(__vs(i)); end; __vybeCheck('1' + #10 + '2' + #10 + '4' + #10 + '5');
end.
