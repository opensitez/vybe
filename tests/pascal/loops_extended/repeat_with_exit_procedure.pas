// vybe-test: pascal/loops_extended/repeat_with_exit_procedure
...
end; procedure Scan; var n:Integer; begin n:=0; repeat Inc(n); if n=2 then Exit; __p(__vs('loop')); until false; end; begin Scan; __p(__vs('out')); __vybeCheck('loop' + #10 + 'out');
end.
