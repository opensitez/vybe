// vybe-test: pascal/loops_extended/repeat_until_false_first_iteration_runs
...
end; var n:Integer; begin n:=0; repeat __p(__vs('body')); Inc(n); until n>0; __vybeCheck('body');
end.
