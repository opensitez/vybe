// vybe-test: pascal/loops_extended/repeat_until_sum_reaches_target
...
end; var n,s:Integer; begin n:=0; s:=0; repeat Inc(n); s:=s+n; until s>=10; __p(__vs(s)); __vybeCheck('10');
end.
