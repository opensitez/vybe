// vybe-test: pascal/loops_extended/nested_for_row_column_matrix
...
end; var r,c:Integer; begin for r:=1 to 2 do for c:=1 to 2 do __p(__vs(IntToStr(r)+','+IntToStr(c))); __vybeCheck('1,1' + #10 + '1,2' + #10 + '2,1' + #10 + '2,2');
end.
