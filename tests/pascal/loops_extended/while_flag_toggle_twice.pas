// vybe-test: pascal/loops_extended/while_flag_toggle_twice
...
end; var n:Integer; on:Boolean; begin n:=0; on:=true; while on do begin Inc(n); if n=2 then on:=false; __p(__vs(n)); end; __vybeCheck('1' + #10 + '2');
end.
