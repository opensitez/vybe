// vybe-test: pascal/pointers_memory/ptrmem_new_record_39
...
end; type TR=record V:Integer; end; var p:^TR; begin New(p); p^.V:=49; __p(__vs(p^.V)); Dispose(p); __vybeCheck('49');
end.
