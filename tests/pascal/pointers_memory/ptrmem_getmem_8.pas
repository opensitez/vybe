// vybe-test: pascal/pointers_memory/ptrmem_getmem_8
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=16; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('16');
end.
