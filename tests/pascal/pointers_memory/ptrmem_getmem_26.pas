// vybe-test: pascal/pointers_memory/ptrmem_getmem_26
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=52; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('52');
end.
