// vybe-test: pascal/pointers_memory/ptrmem_getmem_38
// origin: languages/pascal/tests/pascal/test_pointers_memory.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=76; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('76');
end.
