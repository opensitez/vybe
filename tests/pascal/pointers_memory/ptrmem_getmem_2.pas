// vybe-test: pascal/pointers_memory/ptrmem_getmem_2
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=4; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('4');
end.
