// vybe-test: pascal/pointers_memory/ptrmem_getmem_32
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=64; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('64');
end.
