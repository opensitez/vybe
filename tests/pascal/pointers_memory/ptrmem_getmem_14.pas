// vybe-test: pascal/pointers_memory/ptrmem_getmem_14
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=28; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('28');
end.
