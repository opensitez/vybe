// vybe-test: pascal/pointers_memory/ptrmem_getmem_20
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=40; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('40');
end.
