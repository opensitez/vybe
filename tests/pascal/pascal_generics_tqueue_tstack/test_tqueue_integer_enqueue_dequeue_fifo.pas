// vybe-test: pascal/pascal_generics_tqueue_tstack/test_tqueue_integer_enqueue_dequeue_fifo
// origin: languages/pascal/tests/pascal/test_pascal_generics_tqueue_tstack.rs
program Test;
{$mode delphi}
