// vybe-test: pascal/pascal_class_rtti_typeinfo/test_class_reference_type_metaclass
...
procedure TAnimal.Speak; begin __p(__vs('Animal')); end;
procedure TDog.Speak; begin __p(__vs('Woof')); end;
