// vybe-test: pascal/scope_visibility/procedure_param_shadows_global
...
end; var v:Integer; procedure P(v:Integer); begin __p(__vs(v)); end; begin v:=1; P(9); __vybeCheck('9');
end.
