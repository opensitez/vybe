// vybe-test: pascal/scope_visibility/outer_var_mutated_by_nested_proc
...
end; var total:Integer; procedure Acc(n:Integer); begin total:=total+n; end; begin total:=0; Acc(3); Acc(4); __p(__vs(total)); __vybeCheck('7');
end.
