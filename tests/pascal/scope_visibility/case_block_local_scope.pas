// vybe-test: pascal/scope_visibility/case_block_local_scope
...
end; var n:Integer; begin n:=2; case n of 1: __p(__vs('one')); 2: begin var t:Integer; t:=20; __p(__vs(t)); end; end; __vybeCheck('20');
end.
