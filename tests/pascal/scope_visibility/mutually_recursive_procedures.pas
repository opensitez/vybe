// vybe-test: pascal/scope_visibility/mutually_recursive_procedures
// origin: languages/pascal/tests/pascal/test_scope_visibility.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; procedure Even(n:Integer); forward; procedure Odd(n:Integer); begin if n=0 then __p(__vs('odd0')) else Even(n-1); end; procedure Even(n:Integer); begin if n=0 then __p(__vs('even0')) else Odd(n-1); end; begin Even(2); __vybeCheck('even0');
end.
