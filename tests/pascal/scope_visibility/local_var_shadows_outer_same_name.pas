// vybe-test: pascal/scope_visibility/local_var_shadows_outer_same_name
...
end; var x:Integer; procedure P; var x:Integer; begin x:=2; __p(__vs(x)); end; begin x:=1; P; __p(__vs(x)); __vybeCheck('2' + #10 + '1');
end.
