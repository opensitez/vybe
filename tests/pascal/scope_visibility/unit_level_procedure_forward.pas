// vybe-test: pascal/scope_visibility/unit_level_procedure_forward
...
end; procedure B; forward; procedure A; begin B; end; procedure B; begin __p(__vs('b')); end; begin A; __vybeCheck('b');
end.
