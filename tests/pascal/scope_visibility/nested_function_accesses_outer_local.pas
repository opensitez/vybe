// vybe-test: pascal/scope_visibility/nested_function_accesses_outer_local
...
end; function Outer:Integer; var base:Integer; function Inner:Integer; begin Result:=base+1; end; begin base:=10; Result:=Inner; end; begin __p(__vs(Outer)); __vybeCheck('11');
end.
