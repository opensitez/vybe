// vybe-test: pascal/scope_visibility/class_field_vs_local_name
...
end; type TBox=class public V:Integer; procedure Show; end; procedure TBox.Show; var V:Integer; begin V:=5; __p(__vs(Self.V)); end; var b:TBox; begin b:=TBox.Create; b.V:=9; b.Show; b.Free; __vybeCheck('9');
end.
