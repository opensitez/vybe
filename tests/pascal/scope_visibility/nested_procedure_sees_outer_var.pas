// vybe-test: pascal/scope_visibility/nested_procedure_sees_outer_var
...
end; var n:Integer; procedure Outer; procedure Inner; begin n:=n+1; end; begin Inner; end; begin n:=0; Outer; __p(__vs(n)); __vybeCheck('1');
end.
