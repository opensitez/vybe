// vybe-test: pascal/scope_visibility/function_result_before_assign
...
end; function F:Integer; begin Result:=0; Result:=Result+4; end; begin __p(__vs(F)); __vybeCheck('4');
end.
