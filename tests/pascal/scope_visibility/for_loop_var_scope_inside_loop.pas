// vybe-test: pascal/scope_visibility/for_loop_var_scope_inside_loop
...
end; var i:Integer; begin i:=99; for i:=1 to 2 do __p(__vs(i)); __p(__vs(i)); __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
