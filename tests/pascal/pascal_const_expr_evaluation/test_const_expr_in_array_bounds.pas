// vybe-test: pascal/pascal_const_expr_evaluation/test_const_expr_in_array_bounds
// origin: languages/pascal/tests/pascal/test_pascal_const_expr_evaluation.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  arr[MinIndex] := 10;
  arr[MaxIndex] := 50;
  __p(__vs(arr[MinIndex]));
  __p(__vs(arr[MaxIndex]));
