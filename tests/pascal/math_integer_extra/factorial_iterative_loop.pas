// vybe-test: pascal/math_integer_extra/factorial_iterative_loop
...
end; function Fact(n:Integer):Integer; var i:Integer; begin Result:=1; for i:=2 to n do Result:=Result*i; end; begin __p(__vs(Fact(5))); __vybeCheck('120');
end.
