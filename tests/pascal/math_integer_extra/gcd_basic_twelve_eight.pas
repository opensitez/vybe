// vybe-test: pascal/math_integer_extra/gcd_basic_twelve_eight
...
end; function Gcd(a,b:Integer):Integer; begin if b=0 then Result:=a else Result:=Gcd(b,a mod b); end; begin __p(__vs(Gcd(12,8))); __vybeCheck('4');
end.
