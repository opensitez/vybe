// vybe-test: pascal/math_integer_extra/sum_factorials_one_to_four
...
end; function Fact(n:Integer):Integer; begin if n<=1 then Result:=1 else Result:=n*Fact(n-1); end; var i,s:Integer; begin s:=0; for i:=1 to 4 do s:=s+Fact(i); __p(__vs(s)); __vybeCheck('33');
end.
