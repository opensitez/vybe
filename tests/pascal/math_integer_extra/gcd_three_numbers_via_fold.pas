// vybe-test: pascal/math_integer_extra/gcd_three_numbers_via_fold
...
end; function Gcd(a,b:Integer):Integer; begin if b=0 then Result:=a else Result:=Gcd(b,a mod b); end; begin __p(__vs(Gcd(Gcd(24,36),60))); __vybeCheck('12');
end.
