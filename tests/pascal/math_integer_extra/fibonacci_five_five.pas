// vybe-test: pascal/math_integer_extra/fibonacci_five_five
...
end; function Fib(n:Integer):Integer; begin if n<=0 then Result:=0 else if n=1 then Result:=1 else Result:=Fib(n-1)+Fib(n-2); end; begin __p(__vs(Fib(5))); __vybeCheck('5');
end.
