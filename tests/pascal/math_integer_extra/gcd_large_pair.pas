// vybe-test: pascal/math_integer_extra/gcd_large_pair
...
end; function Gcd(a,b:Integer):Integer; begin if b=0 then Result:=a else Result:=Gcd(b,a mod b); end; begin __p(__vs(Gcd(270,192))); __vybeCheck('6');
end.
