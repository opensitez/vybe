// vybe-test: pascal/math_integer_extra/gcd_iterative_style
...
end; function Gcd(a,b:Integer):Integer; begin while b<>0 do begin Result:=a mod b; a:=b; b:=Result; end; Result:=a; end; begin __p(__vs(Gcd(48,18))); __vybeCheck('6');
end.
