// vybe-test: pascal/math_integer_extra/sum_gcd_pairs_list
...
end; function Gcd(a,b:Integer):Integer; begin if b=0 then Result:=a else Result:=Gcd(b,a mod b); end; begin __p(__vs(Gcd(14,21)+Gcd(8,12))); __vybeCheck('11');
end.
