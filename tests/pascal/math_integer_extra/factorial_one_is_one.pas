// vybe-test: pascal/math_integer_extra/factorial_one_is_one
...
end; function Fact(n:Integer):Integer; begin if n<=1 then Result:=1 else Result:=n*Fact(n-1); end; begin __p(__vs(Fact(1))); __vybeCheck('1');
end.
