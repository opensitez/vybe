// vybe-test: pascal/math_integer_extra/gcd_coprime_seven_fifteen
...
end; function Gcd(a,b:Integer):Integer; begin if b=0 then Result:=a else Result:=Gcd(b,a mod b); end; begin __p(__vs(Gcd(7,15))); __vybeCheck('1');
end.
