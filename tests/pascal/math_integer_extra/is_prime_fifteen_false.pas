// vybe-test: pascal/math_integer_extra/is_prime_fifteen_false
...
end; function IsPrime(n:Integer):Boolean; var i:Integer; begin Result:=n>1; if Result then for i:=2 to n-1 do if (n mod i)=0 then Result:=false; end; begin __p(__vs(IsPrime(15))); __vybeCheck('False');
end.
