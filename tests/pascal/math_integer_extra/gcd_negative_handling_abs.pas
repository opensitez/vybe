// vybe-test: pascal/math_integer_extra/gcd_negative_handling_abs
...
end; function Gcd(a,b:Integer):Integer; begin a:=Abs(a); b:=Abs(b); if b=0 then Result:=a else Result:=Gcd(b,a mod b); end; begin __p(__vs(Gcd(-12,8))); __vybeCheck('4');
end.
