// vybe-test: pascal/math_integer_extra/lcm_small_multiples
...
end; function Gcd(a,b:Integer):Integer; begin if b=0 then Result:=a else Result:=Gcd(b,a mod b); end; function Lcm(a,b:Integer):Integer; begin Result:=(a div Gcd(a,b))*b; end; begin __p(__vs(Lcm(3,4))); __vybeCheck('12');
end.
