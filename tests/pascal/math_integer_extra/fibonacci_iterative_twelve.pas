// vybe-test: pascal/math_integer_extra/fibonacci_iterative_twelve
...
end; function Fib(n:Integer):Integer; var a,b,i,t:Integer; begin if n<=0 then Result:=0 else begin a:=0; b:=1; for i:=2 to n do begin t:=a+b; a:=b; b:=t; end; Result:=b; end; end; begin __p(__vs(Fib(12))); __vybeCheck('144');
end.
