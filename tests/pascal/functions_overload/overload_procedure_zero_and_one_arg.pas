// vybe-test: pascal/functions_overload/overload_procedure_zero_and_one_arg
...
end; procedure Ping; overload; begin __p(__vs('p')); end; procedure Ping(n:Integer); overload; begin __p(__vs(n)); end; begin Ping; Ping(9); __vybeCheck('p' + #10 + '9');
end.
