// vybe-test: pascal/functions_overload/default_with_arithmetic_body
...
end; function Pow2(n:Integer; e:Integer=2):Integer; var i:Integer; begin Result:=1; for i:=1 to e do Result:=Result*n; end; begin __p(__vs(Pow2(3))); __p(__vs(Pow2(2,3))); __vybeCheck('9' + #10 + '8');
end.
