// vybe-test: pascal/functions_overload/default_procedure_optional_message
...
end; procedure Log(msg:string='done'); begin __p(__vs(msg)); end; begin Log; Log('go'); __vybeCheck('done' + #10 + 'go');
end.
