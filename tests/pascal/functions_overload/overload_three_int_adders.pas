// vybe-test: pascal/functions_overload/overload_three_int_adders
...
end; function F(n:Integer):Integer; overload; begin Result:=n+1; end; function F(n:Integer;m:Integer):Integer; overload; begin Result:=n+m; end; function F(n,m,k:Integer):Integer; overload; begin Result:=n+m+k; end; begin __p(__vs(F(5))); __p(__vs(F(2,3))); __p(__vs(F(1,2,3))); __vybeCheck('6' + #10 + '5' + #10 + '6');
end.
