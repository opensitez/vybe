// vybe-test: pascal/functions_overload/default_nested_call_uses_inner_default
...
end; function IncBy(n:Integer; d:Integer=5):Integer; begin Result:=n+d; end; begin __p(__vs(IncBy(IncBy(1)))); __vybeCheck('11');
end.
