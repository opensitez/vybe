// vybe-test: pascal/functions_overload/default_all_three_middle_specified
...
end; function F(a,b:Integer=1; c:Integer=2):Integer; begin Result:=a+b+c; end; begin __p(__vs(F(10,20))); __vybeCheck('32');
end.
