// vybe-test: pascal/functions_overload/overload_case_insensitive_tag
...
end; function Kind(c:Char):Integer; overload; begin Result:=Ord(c); end; function Kind(s:string):Integer; overload; begin Result:=Length(s); end; begin __p(__vs(Kind('A'))); __p(__vs(Kind('ab'))); __vybeCheck('65' + #10 + '2');
end.
