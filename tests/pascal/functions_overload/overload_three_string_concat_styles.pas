// vybe-test: pascal/functions_overload/overload_three_string_concat_styles
...
end; function Join(a,b:string):string; overload; begin Result:=a+b; end; function Join(a,b,c:string):string; overload; begin Result:=a+b+c; end; begin __p(__vs(Join('a','b'))); __p(__vs(Join('x','y','z'))); __vybeCheck('ab' + #10 + 'xyz');
end.
