// vybe-test: pascal/functions_overload/default_mixed_types_int_and_string
...
end; function LabelOf(n:Integer; lbl:string='n'):string; begin Result:=lbl+IntToStr(n); end; begin __p(__vs(LabelOf(4))); __p(__vs(LabelOf(4,'v'))); __vybeCheck('n4' + #10 + 'v4');
end.
