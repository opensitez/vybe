// vybe-test: pascal/functions_overload/overload_and_default_combined
...
end; function F(n:Integer):Integer; overload; begin Result:=n; end; function F(n:Integer; k:Integer=2):Integer; overload; begin Result:=n*k; end; begin __p(__vs(F(5))); __p(__vs(F(5,3))); __vybeCheck('5' + #10 + '15');
end.
