// vybe-test: pascal/functions_overload/default_explicit_zero_overrides
...
end; function Scale(n:Integer; k:Integer=2):Integer; begin Result:=n*k; end; begin __p(__vs(Scale(7,0))); __vybeCheck('0');
end.
