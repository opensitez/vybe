// vybe-test: pascal/functions_overload/default_negative_literal
...
end; function Shift(n:Integer; d:Integer=-1):Integer; begin Result:=n+d; end; begin __p(__vs(Shift(5))); __vybeCheck('4');
end.
