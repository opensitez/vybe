// vybe-test: pascal/functions_overload/overload_string_and_integer_write
...
end; procedure P(s:string); overload; begin __p(__vs(s)); end; procedure P(n:Integer); overload; begin __p(__vs(n)); end; begin P('hi'); P(42); __vybeCheck('hi' + #10 + '42');
end.
