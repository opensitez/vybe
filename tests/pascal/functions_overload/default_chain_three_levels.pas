// vybe-test: pascal/functions_overload/default_chain_three_levels
...
end; function A(n:Integer=1):Integer; begin Result:=n; end; function B(n:Integer=2):Integer; begin Result:=n; end; begin __p(__vs(A(B))); __vybeCheck('2');
end.
