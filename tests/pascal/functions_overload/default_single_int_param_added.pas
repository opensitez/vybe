// vybe-test: pascal/functions_overload/default_single_int_param_added
...
end; function Add(n:Integer; d:Integer=3):Integer; begin Result:=n+d; end; begin __p(__vs(Add(10))); __p(__vs(Add(10,7))); __vybeCheck('13' + #10 + '17');
end.
