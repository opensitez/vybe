// vybe-test: pascal/functions_overload/overload_two_procedures_by_name_count
...
end; procedure Emit; overload; begin __p(__vs('0')); end; procedure Emit(c:Char); overload; begin __p(__vs(c)); end; procedure Emit(s:string); overload; begin __p(__vs(s)); end; begin Emit; Emit('x'); Emit('ok'); __vybeCheck('0' + #10 + 'x' + #10 + 'ok');
end.
