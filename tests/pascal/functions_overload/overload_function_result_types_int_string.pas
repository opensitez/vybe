// vybe-test: pascal/functions_overload/overload_function_result_types_int_string
...
end; function Desc(n:Integer):Integer; overload; begin Result:=n; end; function Desc(s:string):string; overload; begin Result:=s; end; begin __p(__vs(Desc(7))); __p(__vs(Desc('z'))); __vybeCheck('7' + #10 + 'z');
end.
