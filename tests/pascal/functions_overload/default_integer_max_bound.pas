// vybe-test: pascal/functions_overload/default_integer_max_bound
...
end; function Cap(n:Integer; m:Integer=100):Integer; begin if n>m then Result:=m else Result:=n; end; begin __p(__vs(Cap(150))); __p(__vs(Cap(80,50))); __vybeCheck('100' + #10 + '50');
end.
