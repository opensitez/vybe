// vybe-test: pascal/functions_overload/default_char_pad_fill
...
end; function Pad(c:Char; n:Integer=3):string; var i:Integer; begin Result:=''; for i:=1 to n do Result:=Result+c; end; begin __p(__vs(Pad('-'))); __p(__vs(Pad('*',2))); __vybeCheck('---' + #10 + '**');
end.
