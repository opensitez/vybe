// vybe-test: pascal/functions_overload/overload_plus_default_on_one_variant
...
end; function Val(n:Integer; bias:Integer=0):Integer; overload; begin Result:=n+bias; end; function Val(s:string):Integer; overload; begin Result:=Length(s); end; begin __p(__vs(Val(3))); __p(__vs(Val('abc'))); __vybeCheck('3' + #10 + '3');
end.
