// vybe-test: pascal/functions_overload/default_triple_int_only_first_passed
...
end; function Sum3(a:Integer; b:Integer=1; c:Integer=2):Integer; begin Result:=a+b+c; end; begin __p(__vs(Sum3(10))); __vybeCheck('13');
end.
