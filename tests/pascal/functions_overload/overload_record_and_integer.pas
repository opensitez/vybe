// vybe-test: pascal/functions_overload/overload_record_and_integer
...
end; type TPt=record X,Y:Integer; end; function Area(p:TPt):Integer; overload; begin Result:=p.X*p.Y; end; function Area(w,h:Integer):Integer; overload; begin Result:=w*h; end; var p:TPt; begin p.X:=3; p.Y:=4; __p(__vs(Area(p))); __p(__vs(Area(2,5))); __vybeCheck('12' + #10 + '10');
end.
