// vybe-test: pascal/functions_overload/overload_nested_integer_calls
...
end; function Id(n:Integer):Integer; overload; begin Result:=n; end; function Id(a,b:Integer):Integer; overload; begin Result:=a+b; end; begin __p(__vs(Id(Id(2),Id(3)))); __vybeCheck('5');
end.
