// vybe-test: pascal/functions_overload/default_two_strings_second_default
...
end; function Pair(a:string; b:string='b'):string; begin Result:=a+b; end; begin __p(__vs(Pair('a'))); __p(__vs(Pair('x','y'))); __vybeCheck('ab' + #10 + 'xy');
end.
