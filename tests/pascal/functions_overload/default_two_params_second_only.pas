// vybe-test: pascal/functions_overload/default_two_params_second_only
...
end; function Mul(a:Integer; b:Integer=2; c:Integer=10):Integer; begin Result:=a*b+c; end; begin __p(__vs(Mul(5))); __p(__vs(Mul(5,3))); __vybeCheck('20' + #10 + '25');
end.
