// vybe-test: pascal/functions_overload/overload_real_vs_integer_double
...
end; function Twice(v:Integer):Integer; overload; begin Result:=v*2; end; function Twice(v:Real):Real; overload; begin Result:=v*2.0; end; begin __p(__vs(Twice(3))); __p(__vs(Trunc(Twice(2.5)))); __vybeCheck('6' + #10 + '5');
end.
