// vybe-test: pascal/functions_overload/default_real_multiplier
...
end; function ScaleR(v:Real; k:Real=2.5):Real; begin Result:=v*k; end; begin __p(__vs(Trunc(ScaleR(4.0)))); __vybeCheck('10');
end.
