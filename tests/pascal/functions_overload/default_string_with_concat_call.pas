// vybe-test: pascal/functions_overload/default_string_with_concat_call
...
end; function Wrap(s:string; open:string='['; close:string=']'):string; begin Result:=open+s+close; end; begin __p(__vs(Wrap('a'))); __p(__vs(Wrap('b','(',' )'))); __vybeCheck('[a]' + #10 + '(b )');
end.
