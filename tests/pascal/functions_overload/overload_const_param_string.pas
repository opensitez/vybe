// vybe-test: pascal/functions_overload/overload_const_param_string
...
end; function Len(const s:string):Integer; overload; begin Result:=Length(s); end; function Len(c:Char):Integer; overload; begin Result:=1; end; begin __p(__vs(Len('abc'))); __p(__vs(Len('z'))); __vybeCheck('3' + #10 + '1');
end.
