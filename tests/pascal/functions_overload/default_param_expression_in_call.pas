// vybe-test: pascal/functions_overload/default_param_expression_in_call
...
end; function Offset(n:Integer; d:Integer=1):Integer; begin Result:=n+d; end; var x:Integer; begin x:=4; __p(__vs(Offset(x,x))); __vybeCheck('8');
end.
