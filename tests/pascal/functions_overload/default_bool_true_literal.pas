// vybe-test: pascal/functions_overload/default_bool_true_literal
...
end; function Flag(on:Boolean=true):string; begin if on then Result:='y' else Result:='n'; end; begin __p(__vs(Flag)); __p(__vs(Flag(false))); __vybeCheck('y' + #10 + 'n');
end.
