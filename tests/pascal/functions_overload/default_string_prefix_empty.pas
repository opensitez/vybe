// vybe-test: pascal/functions_overload/default_string_prefix_empty
...
end; function Tag(s:string; pfx:string='>'):string; begin Result:=pfx+s; end; begin __p(__vs(Tag('x'))); __p(__vs(Tag('y','!'))); __vybeCheck('>x' + #10 + '!y');
end.
