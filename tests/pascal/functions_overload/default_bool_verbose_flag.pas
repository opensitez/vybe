// vybe-test: pascal/functions_overload/default_bool_verbose_flag
...
end; procedure Show(n:Integer; loud:Boolean=false); begin if loud then __p(__vs('L'+IntToStr(n))) else __p(__vs(IntToStr(n))); end; begin Show(1); Show(2,true); __vybeCheck('1' + #10 + 'L2');
end.
