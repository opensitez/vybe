// vybe-test: pascal/functions_overload/overload_enum_ord_helper
...
end; type TS=(One,Two,Three); function N(v:TS):Integer; overload; begin Result:=Ord(v); end; function N(i:Integer):Integer; overload; begin Result:=i*10; end; begin __p(__vs(N(Two))); __p(__vs(N(2))); __vybeCheck('1' + #10 + '20');
end.
