// vybe-test: pascal/functions_overload/overload_char_vs_string_first
...
end; function Head(c:Char):string; overload; begin Result:=c; end; function Head(s:string):string; overload; begin Result:=Copy(s,1,1); end; begin __p(__vs(Head('z'))); __p(__vs(Head('abc'))); __vybeCheck('z' + #10 + 'a');
end.
