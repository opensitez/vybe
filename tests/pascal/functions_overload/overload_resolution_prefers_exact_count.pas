// vybe-test: pascal/functions_overload/overload_resolution_prefers_exact_count
...
end; function G(x:Integer):Integer; overload; begin Result:=x; end; function G(x,y:Integer):Integer; overload; begin Result:=x+y; end; begin __p(__vs(G(4))); __p(__vs(G(2,5))); __vybeCheck('4' + #10 + '7');
end.
