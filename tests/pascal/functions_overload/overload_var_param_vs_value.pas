// vybe-test: pascal/functions_overload/overload_var_param_vs_value
...
end; procedure Bump(var n:Integer); overload; begin Inc(n); end; procedure Bump(n:Integer); overload; begin __p(__vs(n+1)); end; var x:Integer; begin x:=1; Bump(x); __p(__vs(x)); Bump(4); __vybeCheck('2' + #10 + '5');
end.
