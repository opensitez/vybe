// vybe-test: pascal/functions_overload/overload_array_fixed_vs_open
// origin: languages/pascal/tests/pascal/test_functions_overload.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function Sum(const a:array of Integer):Integer; overload; var i:Integer; begin Result:=0; for i:=0 to High(a) do Result:=Result+a[i]; end; function Sum(a:array[1..2] of Integer):Integer; begin Result:=a[1]+a[2]; end; var b:array[1..2] of Integer; begin b[1]:=4; b[2]:=6; __p(__vs(Sum(b))); __vybeCheck('10');
end.
