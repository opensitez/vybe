// vybe-test: pascal/pascal_nested_exception_handling/test_nested_try_except_in_constructor
...
begin
  try
    ...
    on E: Exception do
    begin
      __p(__vs('ParentCtorHandled:' + E.Message));
      Sub := nil;
    end;
  end;
end;
...
begin
  ...
  __p(__vs(p.Sub = nil));
  p.Free;
__vybeCheck('ParentCtorHandled:SubCtorErr' + #10 + 'True');
end.
