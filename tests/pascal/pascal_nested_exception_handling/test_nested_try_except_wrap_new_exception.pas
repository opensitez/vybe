// vybe-test: pascal/pascal_nested_exception_handling/test_nested_try_except_wrap_new_exception
...
begin
  try
    ...
    on E: EInvalidArgument do __p(__vs('OuterCaughtWrapped:' + E.Message));
  end;
__vybeCheck('OuterCaughtWrapped:Wrapped:DivisionByZero');
end.
