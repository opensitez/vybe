// vybe-test: pascal/pascal_nested_exception_handling/test_nested_exception_in_property_getter
...
begin
  ...
  try
    try
      ...
      on E: Exception do __p(__vs('CaughtGetter:' + E.Message));
    end;
  finally
    t.Free;
  end;
__vybeCheck('CaughtGetter:GetterError');
end.
