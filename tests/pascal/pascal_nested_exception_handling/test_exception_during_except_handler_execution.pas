// vybe-test: pascal/pascal_nested_exception_handling/test_exception_during_except_handler_execution
...
begin
  try
    try
      ...
      on E: Exception do
      begin
        __p(__vs('FirstCaught:' + E.Message));
        raise Exception.Create('SecondErrFromExcept');
      end;
    end;
  except
    on E: Exception do __p(__vs('OuterCaughtSecond:' + E.Message));
  end;
__vybeCheck('FirstCaught:FirstErr' + #10 + 'OuterCaughtSecond:SecondErrFromExcept');
end.
