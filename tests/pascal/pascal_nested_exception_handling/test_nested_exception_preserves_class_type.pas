// vybe-test: pascal/pascal_nested_exception_handling/test_nested_exception_preserves_class_type
...
begin
  try
    ...
    on E: Exception do __p(__vs(E.ClassName + ':' + E.Message));
  end;
__vybeCheck('ERangeError:OutOfRange');
end.
