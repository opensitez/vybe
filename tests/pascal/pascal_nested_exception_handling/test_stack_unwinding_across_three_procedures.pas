// vybe-test: pascal/pascal_nested_exception_handling/test_stack_unwinding_across_three_procedures
...
begin
  try
    ...
    on E: Exception do __p(__vs('UnwoundToTop:' + E.Message));
  end;
__vybeCheck('UnwoundToTop:DeepFailure');
end.
