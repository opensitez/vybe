// vybe-test: pascal/pascal_nested_exception_handling/test_selective_inner_catch_unmatched_bubbles_up
...
begin
  try
    try
      ...
      on E: EDivByZero do __p(__vs('InnerDivZeroNotTriggered'));
    end;
  except
    on E: EAccessViolation do __p(__vs('OuterCaughtAV:' + E.Message));
  end;
__vybeCheck('OuterCaughtAV:AVError');
end.
