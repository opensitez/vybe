// vybe-test: pascal/pascal_nested_exception_handling/test_three_level_nested_try_except
  ...
  try
    try
      try
        ...
        on E: EDivByZero do __p(__vs('Level3Handled'));
      end;
    except
      on E: EArgumentException do __p(__vs('Level2Handled'));
    end;
  except
    on E: Exception do __p(__vs('Level1Handled:' + E.Message));
  end;
__vybeCheck('Level1Handled:Level3Err');
end.
