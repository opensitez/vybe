// vybe-test: pascal/pascal_nested_exception_handling/test_nested_try_except_in_loop
  ...
  begin
    try
      try
        ...
        on E: EDivByZero do __p(__vs('InnerCaughtDivZero'));
      end;
    except
      on E: Exception do __p(__vs('OuterCaughtErr:' + E.Message));
    end;
  end;
__vybeCheck('OuterCaughtErr:Err1' + #10 + 'InnerCaughtDivZero');
end.
