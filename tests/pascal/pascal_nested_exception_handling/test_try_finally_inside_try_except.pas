// vybe-test: pascal/pascal_nested_exception_handling/test_try_finally_inside_try_except
...
begin
  try
    try
      ...
      __p(__vs('CleanupExecuted'));
    end;
  except
    on E: Exception do __p(__vs('HandlerExecuted:' + E.Message));
  end;
__vybeCheck('CleanupExecuted' + #10 + 'HandlerExecuted:WorkError');
end.
