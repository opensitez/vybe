// vybe-test: pascal/pascal_nested_exception_handling/test_recursive_unwinding_with_finally
...
begin
  try
    ...
    __p(__vs('UnwindingDepth:' + depth.ToString));
  end;
end;
begin
  try
...
__vybeCheck('UnwindingDepth:3' + #10 + 'UnwindingDepth:2' + #10 + 'UnwindingDepth:1' + #10 + 'TopCaught:Depth3Err');
end.
