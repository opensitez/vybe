// vybe-test: pascal/pascal_nested_exception_handling/test_nested_finally_with_reraised_exception
...
begin
  try
    ...
    on E: Exception do __p(__vs('CaughtAtTop:' + E.Message));
  end;
__vybeCheck('Fin1' + #10 + 'Fin2' + #10 + 'CaughtAtTop:DeepErr');
end.
