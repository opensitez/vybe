// vybe-test: pascal/pascal_nested_exception_handling/test_nested_exception_with_array_processing
...
begin
  ...
  begin
    try
      ...
      __p(__vs('Val:' + arr[i].ToString));
    except
      on E: EDivByZero do __p(__vs('SkippedZeroAtIndex:' + i.ToString));
    end;
  end;
end;
begin
  ProcessArray([10, 0, 30]);
__vybeCheck('Val:10' + #10 + 'SkippedZeroAtIndex:1' + #10 + 'Val:30');
end.
