// vybe-test: pascal/pascal_nested_exception_handling/test_nested_try_except_reraise_to_outer
...
__vybeCheck('InnerLog:OriginalError' + #10 + 'OuterCaught:OriginalError');
end.
