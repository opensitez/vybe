// vybe-test: pascal/pascal_nested_exception_handling/test_exception_in_finally_block
...
begin
  try
    ...
    on E: Exception do __p(__vs('OuterCaughtFinallyErr:' + E.Message));
  end;
__vybeCheck('InTryBlock' + #10 + 'OuterCaughtFinallyErr:FinallyFailed');
end.
