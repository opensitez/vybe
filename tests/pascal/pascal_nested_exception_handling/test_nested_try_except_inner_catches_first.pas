// vybe-test: pascal/pascal_nested_exception_handling/test_nested_try_except_inner_catches_first
...
begin
  try
    try
      ...
      on E: Exception do __p(__vs('InnerCaught:' + E.Message));
    end;
  except
    on E: Exception do __p(__vs('OuterCaught:' + E.Message));
  end;
__vybeCheck('InnerCaught:InnerError');
end.
