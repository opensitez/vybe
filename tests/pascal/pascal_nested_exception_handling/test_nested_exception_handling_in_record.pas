// vybe-test: pascal/pascal_nested_exception_handling/test_nested_exception_handling_in_record
...
begin
  try
    ...
    on E: Exception do __p(__vs('RecHandled:' + E.Message));
  end;
end;
var r: TRec;
begin
  r.Run;
__vybeCheck('RecHandled:RecRunErr');
end.
