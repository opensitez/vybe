// vybe-test: pascal/classes_polymorphism/override_changes_virtual_behavior_only
...
var c: TChild;
begin c := TChild.Create; __p(__vs(c.A)); __p(__vs(c.B)); c.Free; __vybeCheck('10' + #10 + '2');
end.
