// vybe-test: pascal/classes_polymorphism/virtual_counter_increments_on_each_call
// origin: languages/pascal/tests/pascal/test_classes_polymorphism.rs
program T;
{$mode delphi}
uses SysUtils;
...
var f: TBase;
begin f := TFast.Create; __p(__vs(f.Tick)); __p(__vs(f.Tick)); f.Free; __vybeCheck('2' + #10 + '4');
end.
