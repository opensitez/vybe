// vybe-test: pascal/pascal_bitset_bitarray_ops/test_rotate_right_32bit
// origin: languages/pascal/tests/pascal/test_pascal_bitset_bitarray_ops.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(HexStr(RotateRight($00000003, 1), 8)));
__vybeCheck('80000001');
end.
