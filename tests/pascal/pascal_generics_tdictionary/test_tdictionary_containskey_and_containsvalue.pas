// vybe-test: pascal/pascal_generics_tdictionary/test_tdictionary_containskey_and_containsvalue
// origin: languages/pascal/tests/pascal/test_pascal_generics_tdictionary.rs
program Test;
{$mode delphi}
...
begin
  ...
  __p(__vs(dict.ContainsKey(200)));
  __p(__vs(dict.ContainsKey(500)));
  __p(__vs(dict.ContainsValue('OK')));
  dict.Free;
