// vybe-test: pascal/pascal_enum_scoped_attributes/test_enum_comparison_operators
// origin: languages/pascal/tests/pascal/test_pascal_enum_scoped_attributes.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(Novice < Expert));
  __p(__vs(Master > Intermediate));
  __p(__vs(Novice = Novice));
  __p(__vs(Novice <> Expert));
__vybeCheck('True' + #10 + 'True' + #10 + 'True' + #10 + 'True');
end.
