// vybe-test: pascal/string_search_extra/pos_multichar_second_occurrence_manual
...
end; var s:string; p1,p2:Integer; begin s:='xyxy'; p1:=Pos('xy',s); p2:=Pos('xy',Copy(s,p1+1,Length(s))); __p(__vs(p1)); __p(__vs(p2)); __vybeCheck('1' + #10 + '2');
end.
