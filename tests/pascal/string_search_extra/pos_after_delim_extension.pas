// vybe-test: pascal/string_search_extra/pos_after_delim_extension
...
end; var s:string; d,p:Integer; begin s:='file.txt'; d:=LastDelimiter('.',s); p:=Pos('.',s); __p(__vs(Copy(s,d+1,3))); __vybeCheck('txt');
end.
