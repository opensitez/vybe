// vybe-test: pascal/string_search_extra/lastdelimiter_extract_filename
...
end; var p:Integer; s:string; begin s:='path/to/name'; p:=LastDelimiter('/',s); __p(__vs(Copy(s,p+1,Length(s)))); __vybeCheck('name');
end.
