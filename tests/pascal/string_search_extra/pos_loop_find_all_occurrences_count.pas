// vybe-test: pascal/string_search_extra/pos_loop_find_all_occurrences_count
// origin: languages/pascal/tests/pascal/test_string_search_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var s:string; i,p,c:Integer; begin s:='abab'; c:=0; i:=1; repeat p:=Pos('a',Copy(s,i,Length(s))); if p>0 then begin Inc(c); i:=i+p; end; until p=0; __p(__vs(c)); __vybeCheck('2');
end.
