// vybe-test: pascal/string_search_extra/pos_drives_slice_extraction
...
end; var s,t:string; p:Integer; begin s:='id=42'; p:=Pos('=',s); t:=Copy(s,p+1,Length(s)); __p(__vs(t)); __vybeCheck('42');
end.
