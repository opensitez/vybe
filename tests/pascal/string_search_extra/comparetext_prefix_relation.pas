// vybe-test: pascal/string_search_extra/comparetext_prefix_relation
...
end; var r:Integer; begin r:=CompareText('test','testing'); if r<0 then __p(__vs('shorter')) else __p(__vs('other')); __vybeCheck('shorter');
end.
