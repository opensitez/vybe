// vybe-test: pascal/string_search_extra/comparetext_numbers_as_strings
...
end; var r:Integer; begin r:=CompareText('10','2'); if r<0 then __p(__vs('less')) else __p(__vs('geq')); __vybeCheck('less');
end.
