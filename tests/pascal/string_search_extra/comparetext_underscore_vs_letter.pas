// vybe-test: pascal/string_search_extra/comparetext_underscore_vs_letter
...
end; var r:Integer; begin r:=CompareText('_a','a'); if r<0 then __p(__vs('u')) else __p(__vs('v')); __vybeCheck('u');
end.
