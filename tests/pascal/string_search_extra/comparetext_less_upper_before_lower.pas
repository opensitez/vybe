// vybe-test: pascal/string_search_extra/comparetext_less_upper_before_lower
...
end; var r:Integer; begin r:=CompareText('apple','Banana'); if r<0 then __p(__vs('less')) else __p(__vs('geq')); __vybeCheck('less');
end.
