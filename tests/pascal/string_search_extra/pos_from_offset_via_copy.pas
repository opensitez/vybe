// vybe-test: pascal/string_search_extra/pos_from_offset_via_copy
...
end; var s:string; p:Integer; begin s:='banana'; p:=Pos('na',Copy(s,3,Length(s))); __p(__vs(p)); __vybeCheck('1');
end.
