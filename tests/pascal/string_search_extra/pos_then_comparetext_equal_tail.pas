// vybe-test: pascal/string_search_extra/pos_then_comparetext_equal_tail
...
end; var s,t:string; p:Integer; begin s:='pre-TAIL'; p:=Pos('TAIL',s); t:=Copy(s,p,4); if CompareText(t,'tail')=0 then __p(__vs('match')); __vybeCheck('match');
end.
