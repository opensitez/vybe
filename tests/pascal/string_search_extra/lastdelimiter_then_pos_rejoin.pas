// vybe-test: pascal/string_search_extra/lastdelimiter_then_pos_rejoin
...
end; var s:string; d,p:Integer; begin s:='a.b.c'; d:=LastDelimiter('.',s); p:=Pos('.',s); __p(__vs(d-p)); __vybeCheck('2');
end.
