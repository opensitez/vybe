// vybe-test: pascal/string_search_extra/comparetext_greater_longer_prefix
...
end; var r:Integer; begin r:=CompareText('zzz','zz'); if r>0 then __p(__vs('gt')) else __p(__vs('le')); __vybeCheck('gt');
end.
