// vybe-test: pascal/string_search_extra/comparetext_same_length_diff_char
...
end; var r:Integer; begin r:=CompareText('cat','car'); if r>0 then __p(__vs('t>r')) else __p(__vs('other')); __vybeCheck('t>r');
end.
