// vybe-test: pascal/string_search_extra/comparetext_sort_three_words
...
end; function Before(const a,b:string):Boolean; begin Result:=CompareText(a,b)<0; end; begin if Before('ant','Bee') then __p(__vs('ok')); __vybeCheck('ok');
end.
