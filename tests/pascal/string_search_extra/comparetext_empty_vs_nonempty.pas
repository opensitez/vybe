// vybe-test: pascal/string_search_extra/comparetext_empty_vs_nonempty
...
end; var r:Integer; begin r:=CompareText('','a'); if r<0 then __p(__vs('less')) else __p(__vs('geq')); __vybeCheck('less');
end.
