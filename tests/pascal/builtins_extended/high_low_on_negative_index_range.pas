// vybe-test: pascal/builtins_extended/high_low_on_negative_index_range
...
end; var a: array[-2..2] of Integer; begin __p(__vs(Low(a))); __p(__vs(High(a))); __vybeCheck('-2' + #10 + '2');
end.
