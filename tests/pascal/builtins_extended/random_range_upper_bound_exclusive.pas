// vybe-test: pascal/builtins_extended/random_range_upper_bound_exclusive
...
end; var n: Integer; begin Randomize; n := Random(3); __p(__vs((n >= 0) and (n < 3))); __vybeCheck('True');
end.
