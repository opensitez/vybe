// vybe-test: pascal/builtins_extended/dec_in_while_loop_countdown
...
end; var n: Integer; begin n := 3; while n > 0 do begin __p(__vs(n)); Dec(n); end; __vybeCheck('3' + #10 + '2' + #10 + '1');
end.
