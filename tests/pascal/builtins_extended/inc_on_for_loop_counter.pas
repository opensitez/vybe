// vybe-test: pascal/builtins_extended/inc_on_for_loop_counter
// origin: languages/pascal/tests/pascal/test_builtins_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var i, sum: Integer; begin sum := 0; for i := 1 to 3 do begin Inc(sum, i); end; __p(__vs(sum)); __vybeCheck('6');
end.
