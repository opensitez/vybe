// vybe-test: pascal/pascal_tstringlist_properties/test_tstringlist_ownsobjects_automatic_freeing
...
destructor TItemObj.Destroy; begin __p(__vs('FreedObj:' + Name)); inherited Destroy; end;
