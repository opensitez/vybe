// vybe-test: pascal/closures_extended/nested_capture_with_param_override_logic
...
begin
  base := 5;
  __p(__vs(Resolve(false, 99)));
  __p(__vs(Resolve(true, 99)));
end;
begin Outer(0); __vybeCheck('5' + #10 + '99');
end.
