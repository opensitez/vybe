// vybe-test: pascal/classes_extended/destructor_virtual_chain_calls_inherited
...
destructor TBase.Destroy; begin __p(__vs('base')); inherited Destroy; end;
destructor TChild.Destroy; begin __p(__vs('child')); inherited Destroy; end;
var o: TChild;
begin
  o := TChild.Create;
  o.Free;
