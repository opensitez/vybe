// vybe-test: pascal/pascal_class_helpers/test_class_helper_static_class_method
// origin: languages/pascal/tests/pascal/test_pascal_class_helpers.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs('HelperStaticMethod'));
end;
begin
  TBase.Announce;
__vybeCheck('HelperStaticMethod');
end.
