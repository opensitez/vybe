// vybe-test: pascal/type_aliases_extra/alias_multiline_type_block
...
end; type TInt=Integer; type TPair=record A,B:TInt; end; var p:TPair; begin p.A:=2; p.B:=3; __p(__vs(p.A+p.B)); __vybeCheck('5');
end.
