// vybe-test: pascal/type_aliases_extra/alias_dynamic_array
...
end; type TE=Integer; var a:array of TE; begin SetLength(a,2); a[0]:=1; a[1]:=2; __p(__vs(a[1])); __vybeCheck('2');
end.
