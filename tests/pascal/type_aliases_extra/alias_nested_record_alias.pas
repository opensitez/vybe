// vybe-test: pascal/type_aliases_extra/alias_nested_record_alias
...
end; type TInner=record V:Integer; end; type TOuter=record Inner:TInner; end; var o:TOuter; begin o.Inner.V:=3; __p(__vs(o.Inner.V)); __vybeCheck('3');
end.
