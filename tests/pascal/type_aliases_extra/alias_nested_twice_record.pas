// vybe-test: pascal/type_aliases_extra/alias_nested_twice_record
...
end; type TA=Integer; type TB=record A:TA; end; type TC=record B:TB; end; var c:TC; begin c.B.A:=8; __p(__vs(c.B.A)); __vybeCheck('8');
end.
