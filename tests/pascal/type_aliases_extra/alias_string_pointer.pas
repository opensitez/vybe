// vybe-test: pascal/type_aliases_extra/alias_string_pointer
...
end; type TStr=string; type PStr=^TStr; var s:TStr; p:PStr; begin s:='hi'; p:=@s; __p(__vs(p^)); __vybeCheck('hi');
end.
