// vybe-test: pascal/type_aliases_extra/alias_two_d_array
...
end; type TCell=Integer; type TGrid=array[0..1,0..1] of TCell; var g:TGrid; begin g[0,1]:=9; __p(__vs(g[0,1])); __vybeCheck('9');
end.
