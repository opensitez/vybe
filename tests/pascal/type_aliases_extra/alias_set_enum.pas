// vybe-test: pascal/type_aliases_extra/alias_set_enum
...
end; type TC=(R,G,B); type TS=set of TC; var s:TS; begin s:=[R,B]; if G in s then __p(__vs('g')) else __p(__vs('no')); __vybeCheck('no');
end.
