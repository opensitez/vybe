// vybe-test: pascal/type_aliases_extra/alias_nested_string_alias
...
end; type S=string; type SS=S; type SSS=SS; var t:SSS; begin t:='deep'; __p(__vs(t)); __vybeCheck('deep');
end.
