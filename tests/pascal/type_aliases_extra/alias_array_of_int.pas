// vybe-test: pascal/type_aliases_extra/alias_array_of_int
...
end; type TInt=Integer; type TArr=array[0..2] of TInt; var a:TArr; begin a[1]:=5; __p(__vs(a[1])); __vybeCheck('5');
end.
