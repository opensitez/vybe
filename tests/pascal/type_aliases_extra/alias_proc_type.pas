// vybe-test: pascal/type_aliases_extra/alias_proc_type
// origin: languages/pascal/tests/pascal/test_type_aliases_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TInt=Integer; type TFn=function(x:TInt):TInt; function DoubleIt(n:TInt):TInt; begin Result:=n*2; end; var f:TFn; begin f:=@DoubleIt; __p(__vs(f(6))); __vybeCheck('12');
end.
