// vybe-test: pascal/type_aliases_extra/alias_record_field_alias
...
end; type TScore=Integer; type TPlayer=record Score:TScore; end; var p:TPlayer; begin p.Score:=100; __p(__vs(p.Score)); __vybeCheck('100');
end.
