// vybe-test: pascal/type_aliases_extra/alias_double_pointer
...
end; type TInt=Integer; type PInt=^TInt; var n:TInt; p:PInt; begin n:=99; p:=@n; __p(__vs(p^)); __vybeCheck('99');
end.
