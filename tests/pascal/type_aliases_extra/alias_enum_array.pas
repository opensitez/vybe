// vybe-test: pascal/type_aliases_extra/alias_enum_array
...
end; type T=(X,Y,Z); type TArr=array[T] of string; var a:TArr; begin a[Y]:='mid'; __p(__vs(a[Y])); __vybeCheck('mid');
end.
