// vybe-test: pascal/type_aliases_extra/alias_set_of_alias
...
end; type TD=1..3; type TSet=set of TD; var s:TSet; begin s:=[1,3]; if 2 in s then __p(__vs('in')) else __p(__vs('out')); __vybeCheck('out');
end.
