// vybe-test: pascal/type_aliases_extra/alias_pointer_to_alias
...
end; type TNum=Integer; type PNum=^TNum; var n:TNum; p:PNum; begin n:=7; p:=@n; __p(__vs(p^)); __vybeCheck('7');
end.
