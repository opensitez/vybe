// vybe-test: pascal/type_aliases_extra/alias_currency_style
...
end; type TCents=Integer; type TDollars=Real; var c:TCents; d:TDollars; begin c:=250; d:=c/100; __p(__vs(d)); __vybeCheck('2.5');
end.
