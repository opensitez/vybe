// vybe-test: pascal/type_aliases_extra/alias_record_array_field
...
end; type TItem=Integer; type TBag=record Items:array[0..1] of TItem; end; var b:TBag; begin b.Items[1]:=4; __p(__vs(b.Items[1])); __vybeCheck('4');
end.
