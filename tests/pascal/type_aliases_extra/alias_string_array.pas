// vybe-test: pascal/type_aliases_extra/alias_string_array
...
end; type TLine=string; type TLines=array[1..2] of TLine; var L:TLines; begin L[1]:='a'; L[2]:='b'; __p(__vs(L[1])); __p(__vs(L[2])); __vybeCheck('a' + #10 + 'b');
end.
