// vybe-test: pascal/type_aliases_extra/alias_nested_id_in_record
...
end; type TId=Integer; type TRec=record Id:TId; end; var r:TRec; begin r.Id:=42; __p(__vs(r.Id)); __vybeCheck('42');
end.
