// vybe-test: pascal/type_aliases_extra/alias_pointer_chain
...
end; type TI=Integer; type PI=^TI; type PPI=^PI; var n:TI; p:PI; pp:PPI; begin n:=5; p:=@n; pp:=@p; __p(__vs(pp^^)); __vybeCheck('5');
end.
