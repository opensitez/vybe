// vybe-test: pascal/pascal_utf8string_rawbyte_string/test_utf8string_function_return
// origin: languages/pascal/tests/pascal/test_pascal_utf8string_rawbyte_string.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(GetUTF8Text));
__vybeCheck('FunctionUTF8Return');
end.
