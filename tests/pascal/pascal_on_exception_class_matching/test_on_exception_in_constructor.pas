// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_in_constructor
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('MatchedCtorErr:' + E.Message));
  end;
__vybeCheck('MatchedCtorErr:RangeCtor');
end.
