// vybe-test: pascal/pascal_on_exception_class_matching/test_subclass_matches_ancestor_handler
...
begin
  try
    ...
    on E: ECustomBase do __p(__vs('MatchedAncestor:' + E.ClassName));
  end;
__vybeCheck('MatchedAncestor:ECustomChild');
end.
