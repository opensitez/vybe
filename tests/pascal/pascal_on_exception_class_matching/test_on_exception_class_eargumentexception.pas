// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_class_eargumentexception
...
begin
  try
    ...
    on E: EArgumentException do __p(__vs('MatchedArgErr:' + E.Message));
  end;
__vybeCheck('MatchedArgErr:BadParam');
end.
