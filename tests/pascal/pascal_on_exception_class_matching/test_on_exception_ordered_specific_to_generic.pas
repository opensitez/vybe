// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_ordered_specific_to_generic
...
begin
  try
    ...
    on E: ESpecific do __p(__vs('SpecificHandlerMatched'));
    on E: Exception do __p(__vs('GenericHandlerMatched'));
  end;
__vybeCheck('SpecificHandlerMatched');
end.
