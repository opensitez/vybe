// vybe-test: pascal/pascal_on_exception_class_matching/test_first_matching_on_block_wins
...
begin
  try
    ...
    on E: EBase do __p(__vs('BaseHandlerFirst'));
    on E: ESub do __p(__vs('SubHandlerSecond'));
  end;
__vybeCheck('BaseHandlerFirst');
end.
