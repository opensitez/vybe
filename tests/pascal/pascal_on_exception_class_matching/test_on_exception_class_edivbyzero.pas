// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_class_edivbyzero
...
begin
  ...
  try
    ...
    on E: EDivByZero do __p(__vs('MatchedDivByZero'));
  end;
__vybeCheck('MatchedDivByZero');
end.
