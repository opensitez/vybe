// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_in_virtual_method_override
...
begin
  ...
  try
    ...
    on E: EInvalidOp do __p(__vs('MatchedVirtualOverride:' + E.Message));
  end;
  w.Free;
__vybeCheck('MatchedVirtualOverride:SubOpFail');
end.
