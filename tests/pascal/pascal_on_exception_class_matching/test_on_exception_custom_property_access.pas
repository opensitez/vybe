// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_custom_property_access
...
begin
  try
    ...
    on E: ECustomProp do __p(__vs(E.CustomID.ToString + '-' + E.Message));
  end;
__vybeCheck('888-PropMsg');
end.
