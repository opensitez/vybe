// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_reraise_from_handler
// origin: languages/pascal/tests/pascal/test_pascal_on_exception_class_matching.rs
program Test;
{$mode delphi}
...
begin
  try
    try
      ...
      on E: EDivByZero do
      begin
        __p(__vs('InnerMatched:' + E.ClassName));
        raise;
      end;
    end;
  except
    on E: EDivByZero do __p(__vs('OuterMatched:' + E.ClassName));
  end;
__vybeCheck('InnerMatched:EDivByZero' + #10 + 'OuterMatched:EDivByZero');
end.
