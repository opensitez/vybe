// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_in_record_method
...
begin
  try
    ...
    on E: EConvertError do __p(__vs('MatchedRecordErr:' + E.Message));
  end;
__vybeCheck('MatchedRecordErr:RecConvertFail');
end.
