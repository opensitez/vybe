// vybe-test: pascal/pascal_on_exception_class_matching/test_multi_level_inheritance_matching
...
begin
  try
    ...
    on E: ELevel1 do __p(__vs('CaughtAtL1:' + E.ClassName));
  end;
__vybeCheck('CaughtAtL1:ELevel3');
end.
