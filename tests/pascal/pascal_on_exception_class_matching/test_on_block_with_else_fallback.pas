// vybe-test: pascal/pascal_on_exception_class_matching/test_on_block_with_else_fallback
...
begin
  try
    ...
    on E: EDivByZero do __p(__vs('DivZero'));
    on E: EConvertError do __p(__vs('ConvertErr'));
  else
    __p(__vs('ElseFallbackHandled'));
  end;
__vybeCheck('ElseFallbackHandled');
end.
