// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_variable_scope_isolation
...
begin
  try
    ...
    on E: Exception do __p(__vs('Scope1:' + E.Message));
  end;

  try
    raise Exception.Create('Err2');
  except
    on E: Exception do __p(__vs('Scope2:' + E.Message));
  end;
end;
begin
  TestScope;
__vybeCheck('Scope1:Err1' + #10 + 'Scope2:Err2');
end.
