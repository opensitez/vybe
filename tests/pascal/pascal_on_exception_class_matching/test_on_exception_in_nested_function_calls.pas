// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_in_nested_function_calls
...
begin
  try
    ...
    on E: EConvertError do __p(__vs('TopMatchedF3:' + E.Message));
  end;
__vybeCheck('TopMatchedF3:F3Convert');
end.
