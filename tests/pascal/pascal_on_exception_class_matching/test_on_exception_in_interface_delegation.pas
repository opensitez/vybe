// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_in_interface_delegation
...
begin
  ...
  try
    ...
    on E: EOverflow do __p(__vs('MatchedInterfaceDelegation:' + E.ClassName));
  end;
__vybeCheck('MatchedInterfaceDelegation:EOverflow');
end.
