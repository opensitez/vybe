// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_catch_all_base_class
...
begin
  try
    ...
    on E: Exception do __p(__vs('CatchAllBase:' + E.ClassName));
  end;
__vybeCheck('CatchAllBase:EUnusualError');
end.
