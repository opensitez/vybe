// vybe-test: pascal/pascal_on_exception_class_matching/test_omitting_variable_in_on_clause
...
begin
  try
    ...
    on EDivByZero do __p(__vs('DivByZeroCaughtWithoutVar'));
  end;
__vybeCheck('DivByZeroCaughtWithoutVar');
end.
