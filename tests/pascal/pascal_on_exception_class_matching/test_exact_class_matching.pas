// vybe-test: pascal/pascal_on_exception_class_matching/test_exact_class_matching
...
begin
  try
    ...
    on E: EConvertError do __p(__vs('MatchedExact:' + E.ClassName));
    on E: Exception do __p(__vs('MatchedBase'));
  end;
__vybeCheck('MatchedExact:EConvertError');
end.
