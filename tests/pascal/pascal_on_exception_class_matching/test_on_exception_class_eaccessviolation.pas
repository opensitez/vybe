// vybe-test: pascal/pascal_on_exception_class_matching/test_on_exception_class_eaccessviolation
...
begin
  ...
  try
    ...
    on E: EAccessViolation do __p(__vs('MatchedAV'));
    on E: Exception do __p(__vs('MatchedGen'));
  end;
__vybeCheck('MatchedAV');
end.
