// vybe-test: pascal/pascal_custom_variants_varutils/test_variant_varcast_exception
...
begin
  ...
  try
    ...
    on E: EVariantError do __p(__vs('VariantCastFailed'));
  end;
__vybeCheck('VariantCastFailed');
end.
