// vybe-test: pascal/pascal_custom_variants_varutils/test_variant_vartypetoasstring
// origin: languages/pascal/tests/pascal/test_pascal_custom_variants_varutils.rs
program Test;
{$mode delphi}
...
uses Variants;
begin
  __p(__vs(VarTypeToAsString(varInteger)));
  __p(__vs(VarTypeToAsString(varString)));
__vybeCheck('Integer' + #10 + 'String');
end.
