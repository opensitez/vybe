// vybe-test: pascal/pascal_custom_variants_varutils/test_variant_vartostr_vartostrdef
...
begin
  ...
  __p(__vs(VarToStr(v)));
  v := Null;
  __p(__vs(VarToStrDef(v, 'DefaultNullText')));
__vybeCheck('777' + #10 + 'DefaultNullText');
end.
