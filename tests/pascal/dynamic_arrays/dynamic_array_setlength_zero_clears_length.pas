// vybe-test: pascal/dynamic_arrays/dynamic_array_setlength_zero_clears_length
...
end; var a: array of Integer; begin a := [1, 2, 3]; SetLength(a, 0); __p(__vs(Length(a))); __p(__vs(High(a))); __vybeCheck('0' + #10 + '-1');
end.
