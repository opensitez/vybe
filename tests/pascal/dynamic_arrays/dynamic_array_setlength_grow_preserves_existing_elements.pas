// vybe-test: pascal/dynamic_arrays/dynamic_array_setlength_grow_preserves_existing_elements
...
end; var a: array of Integer; begin SetLength(a, 2); a[0] := 11; a[1] := 22; SetLength(a, 4); __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('11' + #10 + '22');
end.
