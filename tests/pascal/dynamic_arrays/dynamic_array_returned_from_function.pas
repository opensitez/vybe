// vybe-test: pascal/dynamic_arrays/dynamic_array_returned_from_function
...
end; function Make: array of Integer; begin SetLength(Result, 3); Result[0] := 1; Result[1] := 2; Result[2] := 3; end; var a: array of Integer; begin a := Make; __p(__vs(a[2])); __vybeCheck('3');
end.
