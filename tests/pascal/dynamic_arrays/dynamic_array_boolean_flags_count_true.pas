// vybe-test: pascal/dynamic_arrays/dynamic_array_boolean_flags_count_true
...
end; var flags: array of Boolean; i, c: Integer; begin flags := [true, false, true]; c := 0; for i := 0 to High(flags) do if flags[i] then c := c + 1; __p(__vs(c)); __vybeCheck('2');
end.
