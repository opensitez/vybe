// vybe-test: pascal/dynamic_arrays/dynamic_array_nested_row_storage
...
end; var row1, row2: array of Integer; begin row1 := [1, 2]; row2 := [3, 4, 5]; __p(__vs(Length(row1))); __p(__vs(row2[2])); __vybeCheck('2' + #10 + '5');
end.
