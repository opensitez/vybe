// vybe-test: pascal/dynamic_arrays/dynamic_array_append_via_setlength_and_assign
...
end; var a: array of Integer; begin SetLength(a, 1); a[0] := 100; SetLength(a, 2); a[1] := 200; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('100' + #10 + '200');
end.
