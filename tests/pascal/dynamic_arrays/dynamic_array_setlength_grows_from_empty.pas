// vybe-test: pascal/dynamic_arrays/dynamic_array_setlength_grows_from_empty
...
end; var a: array of Integer; begin SetLength(a, 4); __p(__vs(Length(a))); __p(__vs(High(a))); __p(__vs(Low(a))); __vybeCheck('4' + #10 + '3' + #10 + '0');
end.
