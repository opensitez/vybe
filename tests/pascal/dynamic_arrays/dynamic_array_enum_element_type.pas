// vybe-test: pascal/dynamic_arrays/dynamic_array_enum_element_type
...
end; type TColor = (Red, Green, Blue); var colors: array of TColor; begin colors := [Red, Blue]; __p(__vs(Ord(colors[1]))); __vybeCheck('2');
end.
