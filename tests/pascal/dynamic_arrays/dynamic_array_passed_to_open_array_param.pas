// vybe-test: pascal/dynamic_arrays/dynamic_array_passed_to_open_array_param
...
end; function Sum(const a: array of Integer): Integer; var i: Integer; begin Result := 0; for i := Low(a) to High(a) do Result := Result + a[i]; end; var data: array of Integer; begin data := [10, 20, 30]; __p(__vs(Sum(data))); __vybeCheck('60');
end.
