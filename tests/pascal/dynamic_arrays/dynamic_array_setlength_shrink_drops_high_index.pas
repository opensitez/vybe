// vybe-test: pascal/dynamic_arrays/dynamic_array_setlength_shrink_drops_high_index
...
end; var a: array of Integer; begin SetLength(a, 5); a[4] := 99; SetLength(a, 2); __p(__vs(Length(a))); __p(__vs(High(a))); __vybeCheck('2' + #10 + '1');
end.
