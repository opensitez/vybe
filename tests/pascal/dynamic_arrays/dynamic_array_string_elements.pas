// vybe-test: pascal/dynamic_arrays/dynamic_array_string_elements
...
end; var names: array of String; begin names := ['ann', 'bob']; __p(__vs(names[1])); __p(__vs(Length(names))); __vybeCheck('bob' + #10 + '2');
end.
