// vybe-test: pascal/dynamic_arrays/dynamic_array_real_values_sum
...
end; var vals: array of Double; s: Double; begin vals := [1.5, 2.5, 3.0]; s := vals[0] + vals[1] + vals[2]; __p(__vs(Round(s))); __vybeCheck('7');
end.
