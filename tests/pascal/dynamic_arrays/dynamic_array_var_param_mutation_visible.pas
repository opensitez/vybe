// vybe-test: pascal/dynamic_arrays/dynamic_array_var_param_mutation_visible
// origin: languages/pascal/tests/pascal/test_dynamic_arrays.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; procedure DoubleAll(var a: array of Integer); var i: Integer; begin for i := Low(a) to High(a) do a[i] := a[i] * 2; end; var data: array of Integer; begin data := [3, 4]; DoubleAll(data); __p(__vs(data[0])); __p(__vs(data[1])); __vybeCheck('6' + #10 + '8');
end.
