// vybe-test: pascal/dynamic_arrays/dynamic_array_in_record_field
...
end; type TB = record Items: array of Integer; end; var b: TB; begin SetLength(b.Items, 2); b.Items[0] := 5; b.Items[1] := 6; __p(__vs(b.Items[1])); __vybeCheck('6');
end.
