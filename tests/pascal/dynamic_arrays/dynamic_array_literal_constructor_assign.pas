// vybe-test: pascal/dynamic_arrays/dynamic_array_literal_constructor_assign
...
end; var a: array of Integer; begin a := [7, 8, 9]; __p(__vs(a[0])); __p(__vs(a[2])); __p(__vs(Length(a))); __vybeCheck('7' + #10 + '9' + #10 + '3');
end.
