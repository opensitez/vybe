// vybe-test: pascal/exceptions/raise_in_procedure
...
begin
  try
    ...
    on E: Exception do __p(__vs('Error: ' + E.Message));
  end;
__vybeCheck('valid: 5' + #10 + 'Error: negative');
end.
