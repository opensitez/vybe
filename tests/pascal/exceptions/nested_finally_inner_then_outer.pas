// vybe-test: pascal/exceptions/nested_finally_inner_then_outer
...
begin
  try
    try
      ...
      __p(__vs('inner-finally'));
    end;
  finally
    __p(__vs('outer-finally'));
  end;
__vybeCheck('inner-try' + #10 + 'inner-finally' + #10 + 'outer-finally');
end.
