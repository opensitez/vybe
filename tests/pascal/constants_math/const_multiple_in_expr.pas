// vybe-test: pascal/constants_math/const_multiple_in_expr
// origin: languages/pascal/tests/pascal/test_constants_math.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; const A=1; const B=2; const C=3; const S=A+B+C; begin __p(__vs(S)); __vybeCheck('6');
end.
