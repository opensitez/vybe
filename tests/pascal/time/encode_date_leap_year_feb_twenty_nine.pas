// vybe-test: pascal/time/encode_date_leap_year_feb_twenty_nine
// origin: languages/pascal/tests/pascal/test_time.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  __p(__vs(FormatDateTime('yyyy-mm-dd', d)));
__vybeCheck('2000-02-29');
end.
