// vybe-test: pascal/generics_extended/generic_dictionary_simple_pair_list
...
end; type TEntry<K,V>=record Key:K; Value:V; end; var e:TEntry<String,Integer>; begin e.Key:='age'; e.Value:=33; __p(__vs(e.Key)); __p(__vs(e.Value)); __vybeCheck('age' + #10 + '33');
end.
