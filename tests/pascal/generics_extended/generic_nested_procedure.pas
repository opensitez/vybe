// vybe-test: pascal/generics_extended/generic_nested_procedure
...
end; procedure Run<T>(v:T); begin __p(__vs(v)); end; begin Run<String>('go'); Run<Integer>(42); __vybeCheck('go' + #10 + '42');
end.
