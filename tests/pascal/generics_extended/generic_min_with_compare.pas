// vybe-test: pascal/generics_extended/generic_min_with_compare
...
end; function Min<T>(a,b:T):T; begin if a<b then Result:=a else Result:=b; end; begin __p(__vs(Min<Integer>(8,3))); __p(__vs(Min<String>('beta','alpha'))); __vybeCheck('3' + #10 + 'alpha');
end.
