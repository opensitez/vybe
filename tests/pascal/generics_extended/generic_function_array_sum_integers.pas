// vybe-test: pascal/generics_extended/generic_function_array_sum_integers
...
end; function Sum(const a:array of Integer):Integer; var i:Integer; begin Result:=0; for i:=Low(a) to High(a) do Result:=Result+a[i]; end; begin __p(__vs(Sum([1,2,3]))); __vybeCheck('6');
end.
