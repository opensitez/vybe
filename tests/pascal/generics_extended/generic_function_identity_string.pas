// vybe-test: pascal/generics_extended/generic_function_identity_string
...
end; function Id<T>(v:T):T; begin Result:=v; end; begin __p(__vs(Id<String>('ok'))); __vybeCheck('ok');
end.
