// vybe-test: pascal/generics_extended/generic_array_wrapper_first
...
end; type TArrayBox<T>=record Items:array[0..1] of T; end; var b:TArrayBox<String>; begin b.Items[0]:='first'; b.Items[1]:='second'; __p(__vs(b.Items[0])); __vybeCheck('first');
end.
