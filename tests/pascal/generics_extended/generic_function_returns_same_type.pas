// vybe-test: pascal/generics_extended/generic_function_returns_same_type
...
end; function Double<T>(v:T):T; begin Result:=v; end; begin __p(__vs(Double<Integer>(21))); __vybeCheck('21');
end.
