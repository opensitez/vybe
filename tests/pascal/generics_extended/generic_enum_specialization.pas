// vybe-test: pascal/generics_extended/generic_enum_specialization
...
end; type TD=(A,B); type TEnumBox<T>=record V:T; end; var e:TEnumBox<TD>; begin e.V:=B; __p(__vs(Ord(e.V))); __vybeCheck('1');
end.
