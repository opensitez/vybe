// vybe-test: pascal/generics_extended/generic_record_default_ctor_style
...
end; type TCell<T>=record Value:T; Initialized:Boolean; end; var c:TCell<Double>; begin c.Value:=2.5; c.Initialized:=true; if c.Initialized then __p(__vs(Round(c.Value))); __vybeCheck('3');
end.
