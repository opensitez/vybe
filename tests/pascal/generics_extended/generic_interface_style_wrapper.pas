// vybe-test: pascal/generics_extended/generic_interface_style_wrapper
...
end; type IHolder<T>=interface function Get:T; end; THolder<T>=class(TInterfacedObject,IHolder<T>) private F:T; public constructor Create(v:T); function Get:T; end; constructor THolder<T>.Create(v:T); begin F:=v; end; function THolder<T>.Get:T; begin Result:=F; end; var h:IHolder<String>; begin h:=THolder<String>.Create('data'); __p(__vs(h.Get)); __vybeCheck('data');
end.
