// vybe-test: pascal/generics_extended/generic_procedure_swap_two_vars
...
end; procedure Swap<T>(var a,b:T); var t:T; begin t:=a; a:=b; b:=t; end; var x,y:Integer; begin x:=3; y:=9; Swap<Integer>(x,y); __p(__vs(x)); __p(__vs(y)); __vybeCheck('9' + #10 + '3');
end.
