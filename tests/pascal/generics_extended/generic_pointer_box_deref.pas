// vybe-test: pascal/generics_extended/generic_pointer_box_deref
...
end; type TPtrBox<T>=record P:^T; end; var n:Integer; b:TPtrBox<Integer>; begin n:=12; b.P:=@n; __p(__vs(b.P^)); __vybeCheck('12');
end.
