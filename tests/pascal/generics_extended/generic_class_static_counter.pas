// vybe-test: pascal/generics_extended/generic_class_static_counter
...
end; type TCounted=class public class var Total:Integer; constructor Create; end; class var TCounted.Total:Integer; constructor TCounted.Create; begin Inc(Total); end; begin TCounted.Total:=0; TCounted.Create; TCounted.Create; __p(__vs(TCounted.Total)); __vybeCheck('2');
end.
