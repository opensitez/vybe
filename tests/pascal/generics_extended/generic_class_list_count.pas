// vybe-test: pascal/generics_extended/generic_class_list_count
...
end; type TList<T>=class private FCount:Integer; public constructor Create; function Count:Integer; procedure Add; end; constructor TList<T>.Create; begin FCount:=0; end; function TList<T>.Count:Integer; begin Result:=FCount; end; procedure TList<T>.Add; begin Inc(FCount); end; var L:TList<Integer>; begin L:=TList<Integer>.Create; L.Add; L.Add; __p(__vs(L.Count)); L.Free; __vybeCheck('2');
end.
