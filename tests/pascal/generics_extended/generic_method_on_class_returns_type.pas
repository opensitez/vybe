// vybe-test: pascal/generics_extended/generic_method_on_class_returns_type
...
end; type TFactory<T>=class public class function Make(v:T):T; end; class function TFactory<Integer>.Make(v:Integer):Integer; begin Result:=v+1; end; begin __p(__vs(TFactory<Integer>.Make(6))); __vybeCheck('7');
end.
