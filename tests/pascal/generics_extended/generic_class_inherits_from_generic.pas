// vybe-test: pascal/generics_extended/generic_class_inherits_from_generic
...
end; type TBase<T>=class public Value:T; end; type TDerived=class(TBase<Integer>) public function Double:Integer; end; function TDerived.Double:Integer; begin Result:=Value*2; end; var d:TDerived; begin d:=TDerived.Create; d.Value:=11; __p(__vs(d.Double)); d.Free; __vybeCheck('22');
end.
