// vybe-test: pascal/generics_extended/generic_record_copy_value_semantics
...
end; type TWrap<T>=record V:T; end; var a,b:TWrap<Integer>; begin a.V:=5; b:=a; b.V:=9; __p(__vs(a.V)); __p(__vs(b.V)); __vybeCheck('5' + #10 + '9');
end.
