// vybe-test: pascal/generics_extended/generic_default_value_via_explicit_branch
...
end; function ZeroInt:Integer; begin Result:=0; end; begin __p(__vs(ZeroInt)); __vybeCheck('0');
end.
