// vybe-test: pascal/generics_extended/generic_record_pair_swap_fields
...
end; type TPair<T>=record A,B:T; end; var p:TPair<Integer>; t:Integer; begin p.A:=1; p.B:=2; t:=p.A; p.A:=p.B; p.B:=t; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('2' + #10 + '1');
end.
