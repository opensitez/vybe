// vybe-test: pascal/generics_extended/generic_nested_specialization
...
end; type TBox<T>=class public Value:T; constructor Create(v:T); end; constructor TBox<T>.Create(v:T); begin Value:=v; end; var outer:TBox<TBox<Integer>>; begin outer:=TBox<TBox<Integer>>.Create(TBox<Integer>.Create(5)); __p(__vs(outer.Value.Value)); outer.Value.Free; outer.Free; __vybeCheck('5');
end.
