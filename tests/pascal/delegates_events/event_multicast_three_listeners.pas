// vybe-test: pascal/delegates_events/event_multicast_three_listeners
...
end; type TEv=procedure; procedure All(a,b,c:TEv); begin a; b; c; end; begin All(procedure begin __p(__vs('1')); end, procedure begin __p(__vs('2')); end, procedure begin __p(__vs('3')); end); __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
