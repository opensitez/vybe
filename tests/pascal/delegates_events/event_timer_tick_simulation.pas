// vybe-test: pascal/delegates_events/event_timer_tick_simulation
...
end; type TTimer=class FTicks:Integer; FOnTick:procedure; procedure Run(n:Integer); var i:Integer; begin for i:=1 to n do if Assigned(FOnTick) then FOnTick; end; end; var t:TTimer; begin t:=TTimer.Create; t.FOnTick:=procedure begin Inc(t.FTicks); end; t.Run(3); __p(__vs(t.FTicks)); __vybeCheck('3');
end.
