// vybe-test: pascal/delegates_events/event_method_pointer_virtual_dispatch
...
end; type TBase=class procedure Go; virtual; end; TChild=class(TBase) procedure Go; override; end; procedure TBase.Go; begin __p(__vs('base')); end; procedure TChild.Go; begin __p(__vs('child')); end; var b:TBase; p:procedure of object; begin b:=TChild.Create; p:=b.Go; p; __vybeCheck('child');
end.
