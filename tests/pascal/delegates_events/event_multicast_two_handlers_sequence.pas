// vybe-test: pascal/delegates_events/event_multicast_two_handlers_sequence
...
end; type TEv=procedure; procedure RunBoth(a,b:TEv); begin a; b; end; begin RunBoth(procedure begin __p(__vs('1')); end, procedure begin __p(__vs('2')); end); __vybeCheck('1' + #10 + '2');
end.
