// vybe-test: pascal/delegates_events/event_method_pointer_inherited_method
...
end; type TBase=class procedure Run; virtual; end; TChild=class(TBase); procedure TBase.Run; begin __p(__vs('run')); end; var c:TChild; p:procedure of object; begin c:=TChild.Create; p:=c.Run; p; __vybeCheck('run');
end.
