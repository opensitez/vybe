// vybe-test: pascal/delegates_events/event_multicast_count_handlers
...
end; type TEv=procedure; function CountCalls(const hs:array of TEv):Integer; var i,c:Integer; begin c:=0; for i:=Low(hs) to High(hs) do begin hs[i]; Inc(c); end; Result:=c; end; begin __p(__vs(CountCalls([procedure begin end, procedure begin end]))); __vybeCheck('2');
end.
