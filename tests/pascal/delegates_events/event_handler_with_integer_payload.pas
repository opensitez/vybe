// vybe-test: pascal/delegates_events/event_handler_with_integer_payload
...
end; type TIntEvent=procedure(v:Integer); var e:TIntEvent; begin e:=procedure(v:Integer) begin __p(__vs(v)); end; e(42); __vybeCheck('42');
end.
