// vybe-test: pascal/delegates_events/event_pass_method_pointer_to_helper
...
end; type TWorker=class procedure Do; end; procedure TWorker.Do; begin __p(__vs('do')); end; procedure Invoke(p:procedure of object); begin p; end; var w:TWorker; begin w:=TWorker.Create; Invoke(w.Do); __vybeCheck('do');
end.
