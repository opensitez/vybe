// vybe-test: pascal/delegates_events/event_handler_reassign_changes_behavior
...
end; type TEv=procedure; var e:TEv; begin e:=procedure begin __p(__vs('a')); end; e; e:=procedure begin __p(__vs('b')); end; e; __vybeCheck('a' + #10 + 'b');
end.
