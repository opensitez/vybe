// vybe-test: pascal/delegates_events/event_handler_with_two_integer_args
...
end; type TPairEv=procedure(a,b:Integer); var e:TPairEv; begin e:=procedure(a,b:Integer) begin __p(__vs(a+b)); end; e(3,4); __vybeCheck('7');
end.
