// vybe-test: pascal/delegates_events/event_notify_list_simulated_with_counter
...
end; type TBus=class FHits:Integer; procedure Emit; end; procedure TBus.Emit; begin Inc(FHits); end; var b:TBus; p:procedure of object; begin b:=TBus.Create; p:=b.Emit; p; p; __p(__vs(b.FHits)); __vybeCheck('2');
end.
