// vybe-test: pascal/delegates_events/event_chained_two_anonymous_calls
...
end; procedure Chain(a,b:procedure); begin a; b; end; begin Chain(procedure begin __p(__vs('x')); end, procedure begin __p(__vs('y')); end); __vybeCheck('x' + #10 + 'y');
end.
