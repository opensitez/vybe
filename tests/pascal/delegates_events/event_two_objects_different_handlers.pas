// vybe-test: pascal/delegates_events/event_two_objects_different_handlers
...
end; type TA=class procedure A; end; TB=class procedure B; end; procedure TA.A; begin __p(__vs('A')); end; procedure TB.B; begin __p(__vs('B')); end; var a:TA; b:TB; pa,pb:procedure of object; begin a:=TA.Create; b:=TB.Create; pa:=a.A; pb:=b.B; pa; pb; __vybeCheck('A' + #10 + 'B');
end.
