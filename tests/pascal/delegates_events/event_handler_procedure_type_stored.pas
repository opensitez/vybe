// vybe-test: pascal/delegates_events/event_handler_procedure_type_stored
...
end; type TNotify=procedure(Sender: TObject); var h:TNotify; begin h:=procedure(Sender: TObject) begin __p(__vs('fired')); end; h(nil); __vybeCheck('fired');
end.
