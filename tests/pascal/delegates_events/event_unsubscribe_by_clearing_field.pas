// vybe-test: pascal/delegates_events/event_unsubscribe_by_clearing_field
...
end; type TSrc=class FOn:procedure; procedure Fire; end; procedure TSrc.Fire; begin if Assigned(FOn) then FOn; end; var s:TSrc; begin s:=TSrc.Create; s.FOn:=procedure begin __p(__vs('once')); end; s.Fire; s.FOn:=nil; s.Fire; __vybeCheck('once');
end.
