// vybe-test: pascal/delegates_events/event_multicast_via_array_of_procedures
...
end; type TEv=procedure; procedure FireAll(const hs:array of TEv); var i:Integer; begin for i:=Low(hs) to High(hs) do hs[i]; end; begin FireAll([procedure begin __p(__vs('a')); end, procedure begin __p(__vs('b')); end]); __vybeCheck('a' + #10 + 'b');
end.
