// vybe-test: pascal/delegates_events/event_handler_string_argument
...
end; type TStrEv=procedure(const s:string); var e:TStrEv; begin e:=procedure(const s:string) begin __p(__vs(s)); end; e('evt'); __vybeCheck('evt');
end.
