// vybe-test: pascal/delegates_events/event_handler_capture_outer_counter
...
end; var hits:Integer; p:procedure; begin hits:=0; p:=procedure begin Inc(hits); end; p; p; __p(__vs(hits)); __vybeCheck('2');
end.
