// vybe-test: pascal/delegates_events/event_method_pointer_returns_via_side_effect
...
end; type TAcc=class FSum:Integer; procedure Add(n:Integer); end; procedure TAcc.Add(n:Integer); begin FSum:=FSum+n; end; var a:TAcc; p:procedure of object; begin a:=TAcc.Create; p:=procedure begin a.Add(5); end; p; __p(__vs(a.FSum)); __vybeCheck('5');
end.
