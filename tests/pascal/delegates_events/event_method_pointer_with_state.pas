// vybe-test: pascal/delegates_events/event_method_pointer_with_state
...
end; type TCounter=class FCount:Integer; procedure Inc; end; procedure TCounter.Inc; begin FCount:=FCount+1; end; var c:TCounter; p:procedure of object; begin c:=TCounter.Create; p:=c.Inc; p; p; __p(__vs(c.FCount)); __vybeCheck('2');
end.
