// vybe-test: pascal/delegates_events/event_anonymous_with_local_string_capture
...
end; procedure ShowMsg(const m:string); var p:procedure; begin p:=procedure begin __p(__vs(m)); end; p; end; begin ShowMsg('hello'); __vybeCheck('hello');
end.
