// vybe-test: pascal/delegates_events/event_method_pointer_on_object
...
end; type TObj=class procedure Click; end; procedure TObj.Click; begin __p(__vs('click')); end; var o:TObj; p:procedure of object; begin o:=TObj.Create; p:=o.Click; p; __vybeCheck('click');
end.
