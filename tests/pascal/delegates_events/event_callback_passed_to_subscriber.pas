// vybe-test: pascal/delegates_events/event_callback_passed_to_subscriber
...
end; type TSub=class procedure Subscribe(cb:procedure); end; procedure TSub.Subscribe(cb:procedure); begin cb; end; var s:TSub; begin s:=TSub.Create; s.Subscribe(procedure begin __p(__vs('sub')); end); __vybeCheck('sub');
end.
