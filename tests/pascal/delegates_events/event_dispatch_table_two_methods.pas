// vybe-test: pascal/delegates_events/event_dispatch_table_two_methods
...
end; type THandler=class procedure A; procedure B; end; procedure THandler.A; begin __p(__vs('A')); end; procedure THandler.B; begin __p(__vs('B')); end; var h:THandler; p:procedure of object; begin h:=THandler.Create; p:=h.A; p; p:=h.B; p; __vybeCheck('A' + #10 + 'B');
end.
