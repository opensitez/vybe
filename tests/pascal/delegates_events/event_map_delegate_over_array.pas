// vybe-test: pascal/delegates_events/event_map_delegate_over_array
...
end; procedure Each(fn:procedure(i:Integer)); var k:Integer; begin for k:=1 to 3 do fn(k); end; begin Each(procedure(i:Integer) begin __p(__vs(i)); end); __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
