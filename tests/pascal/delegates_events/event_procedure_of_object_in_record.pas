// vybe-test: pascal/delegates_events/event_procedure_of_object_in_record
...
end; type TObj=class procedure Ping; end; procedure TObj.Ping; begin __p(__vs('ping')); end; type TSlot=record H:procedure of object; end; var o:TObj; s:TSlot; begin o:=TObj.Create; s.H:=o.Ping; s.H; __vybeCheck('ping');
end.
