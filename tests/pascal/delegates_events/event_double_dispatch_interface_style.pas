// vybe-test: pascal/delegates_events/event_double_dispatch_interface_style
...
end; type IClick=interface procedure Click; end; TBtn=class(TInterfacedObject,IClick) procedure Click; end; procedure TBtn.Click; begin __p(__vs('btn')); end; procedure Bind(c:IClick); begin c.Click; end; var b:IClick; begin b:=TBtn.Create; Bind(b); __vybeCheck('btn');
end.
