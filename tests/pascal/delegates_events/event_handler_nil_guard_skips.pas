// vybe-test: pascal/delegates_events/event_handler_nil_guard_skips
...
end; type TEv=procedure; procedure SafeCall(e:TEv); begin if Assigned(e) then e; end; begin SafeCall(nil); __p(__vs('ok')); __vybeCheck('ok');
end.
