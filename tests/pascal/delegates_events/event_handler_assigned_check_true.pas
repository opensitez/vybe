// vybe-test: pascal/delegates_events/event_handler_assigned_check_true
...
end; type TEv=procedure; var e:TEv; begin e:=procedure begin __p(__vs('yes')); end; if Assigned(e) then e; __vybeCheck('yes');
end.
