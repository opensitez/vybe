// vybe-test: pascal/delegates_events/event_delegate_stored_in_class_field
...
end; type THost=class F:procedure; procedure Run; end; procedure THost.Run; begin if Assigned(F) then F; end; var h:THost; begin h:=THost.Create; h.F:=procedure begin __p(__vs('go')); end; h.Run; __vybeCheck('go');
end.
