// vybe-test: pascal/delegates_events/event_click_counter_on_object
...
end; type TBtn=class FClicks:Integer; procedure Click; end; procedure TBtn.Click; begin Inc(FClicks); end; var b:TBtn; h:procedure of object; begin b:=TBtn.Create; h:=b.Click; h; h; __p(__vs(b.FClicks)); __vybeCheck('2');
end.
