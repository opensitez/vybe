// vybe-test: pascal/delegates_events/event_method_pointer_free_after_call_safe
...
end; type TObj=class procedure Done; end; procedure TObj.Done; begin __p(__vs('done')); end; var o:TObj; p:procedure of object; begin o:=TObj.Create; p:=o.Done; p; o.Free; __p(__vs('ok')); __vybeCheck('done' + #10 + 'ok');
end.
