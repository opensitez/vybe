// vybe-test: pascal/enums_sets_extended/set_intersection_result_is_subset_of_both
...
end; type TF=(A,B,C); var s1,s2,i: set of TF; begin s1:=[A,B]; s2:=[B,C]; i:=s1*s2; __p(__vs(i<=s1)); __p(__vs(i<=s2)); __vybeCheck('True' + #10 + 'True');
end.
