// vybe-test: pascal/enums_sets_extended/for_in_empty_enum_array_zero_iterations
...
end; type TF=(A,B); var f:TF; n:Integer; begin n:=0; for f in [] do Inc(n); __p(__vs(n)); __vybeCheck('0');
end.
