// vybe-test: pascal/enums_sets_extended/for_in_over_subset_enum_values
...
end; type TC=(R,G,B); var c:TC; s:String; begin s:=''; for c in [R,B] do s:=s+'x'; __p(__vs(Length(s))); __vybeCheck('2');
end.
