// vybe-test: pascal/enums_sets_extended/enum_pred_from_last_to_middle
...
end; type TE=(Alpha,Beta,Gamma); var e:TE; begin e:=Gamma; e:=Pred(e); __p(__vs(Ord(e))); __vybeCheck('1');
end.
