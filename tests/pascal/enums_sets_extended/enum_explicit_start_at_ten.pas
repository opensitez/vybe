// vybe-test: pascal/enums_sets_extended/enum_explicit_start_at_ten
...
end; type TErr=(None=0, Minor=10, Major=20); var e:TErr; begin e:=Minor; __p(__vs(Ord(e))); __vybeCheck('10');
end.
