// vybe-test: pascal/enums_sets_extended/for_in_enum_accumulate_ord_sum
...
end; type TN=(N0,N1,N2); var n:TN; sum:Integer; begin sum:=0; for n in [N0,N1,N2] do sum:=sum+Ord(n); __p(__vs(sum)); __vybeCheck('3');
end.
