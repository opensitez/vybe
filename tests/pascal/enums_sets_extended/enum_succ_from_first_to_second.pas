// vybe-test: pascal/enums_sets_extended/enum_succ_from_first_to_second
...
end; type TE=(Alpha,Beta,Gamma); var e:TE; begin e:=Alpha; e:=Succ(e); __p(__vs(Ord(e))); __vybeCheck('1');
end.
