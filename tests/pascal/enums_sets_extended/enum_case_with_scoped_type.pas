// vybe-test: pascal/enums_sets_extended/enum_case_with_scoped_type
...
end; type TS=(Off,On); var s:TS; begin s:=On; case s of Off:__p(__vs('0')); On:__p(__vs('1')); end; __vybeCheck('1');
end.
