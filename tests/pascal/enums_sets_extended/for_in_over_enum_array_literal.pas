// vybe-test: pascal/enums_sets_extended/for_in_over_enum_array_literal
...
end; type TDay=(Mon,Tue,Wed); var d:TDay; n:Integer; begin n:=0; for d in [Mon,Tue,Wed] do Inc(n); __p(__vs(n)); __vybeCheck('3');
end.
