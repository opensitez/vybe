// vybe-test: pascal/enums_sets_extended/set_symmetric_difference_xor
...
end; type TF=(A,B); var s1,s2,s: set of TF; begin s1:=[A]; s2:=[B]; s:=s1><s2; __p(__vs(A in s)); __p(__vs(B in s)); __vybeCheck('True' + #10 + 'True');
end.
