// vybe-test: pascal/enums_sets_extended/set_difference_removes_member
...
end; type TF=(A,B,C); var s1,s2,s: set of TF; begin s1:=[A,B,C]; s2:=[B]; s:=s1-s2; __p(__vs(A in s)); __p(__vs(B in s)); __vybeCheck('True' + #10 + 'False');
end.
