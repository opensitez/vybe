// vybe-test: pascal/enums_sets_extended/scoped_enum_return_from_function
...
end; type TDir=(North,East,South,West); function DefaultDir:TDir; begin Result:=North; end; begin __p(__vs(Ord(DefaultDir))); __vybeCheck('0');
end.
