// vybe-test: pascal/enums_sets_extended/set_superset_strict_false_when_equal
...
end; type TF=(A); TFSet=set of TF; var s: TFSet; begin s:=[A]; __p(__vs((s>=s) and (s<>s))); __vybeCheck('False');
end.
