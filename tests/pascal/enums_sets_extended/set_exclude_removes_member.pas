// vybe-test: pascal/enums_sets_extended/set_exclude_removes_member
...
end; type TF=(X,Y); var s: set of TF; begin s:=[X,Y]; Exclude(s,X); __p(__vs(X in s)); __p(__vs(Y in s)); __vybeCheck('False' + #10 + 'True');
end.
