// vybe-test: pascal/enums_sets_extended/enum_record_array_of_values
...
end; type TC=(Cold,Warm,Hot); var temps:array[0..2] of TC; begin temps[0]:=Cold; temps[2]:=Hot; __p(__vs(Ord(temps[2]))); __vybeCheck('2');
end.
