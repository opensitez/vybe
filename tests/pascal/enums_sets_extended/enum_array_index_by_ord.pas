// vybe-test: pascal/enums_sets_extended/enum_array_index_by_ord
...
end; type TC=(Red,Green,Blue); var names:array[TC] of String; begin names[Red]:='r'; names[Blue]:='b'; __p(__vs(names[Blue])); __vybeCheck('b');
end.
