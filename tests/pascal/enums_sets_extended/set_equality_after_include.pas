// vybe-test: pascal/enums_sets_extended/set_equality_after_include
...
end; type TF=(A,B); var s1,s2: set of TF; begin s1:=[A]; s2:=[A]; Include(s2,B); __p(__vs(s1=s2)); __vybeCheck('False');
end.
