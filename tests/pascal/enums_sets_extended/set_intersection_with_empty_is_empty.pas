// vybe-test: pascal/enums_sets_extended/set_intersection_with_empty_is_empty
...
end; type TF=(A,B); var s,e,i: set of TF; begin s:=[A,B]; i:=s*e; __p(__vs(Length(i))); __vybeCheck('0');
end.
