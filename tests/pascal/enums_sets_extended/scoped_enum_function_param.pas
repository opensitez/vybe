// vybe-test: pascal/enums_sets_extended/scoped_enum_function_param
...
end; type TMode=(Safe,Fast); function Tag(m:TMode):Integer; begin Result:=Ord(m); end; begin __p(__vs(Tag(Fast))); __vybeCheck('1');
end.
