// vybe-test: pascal/enums_sets_extended/scoped_enum_in_variant_record_tag
...
end; type TK=(IntK,StrK); type TV=record case TK of IntK:(I:Integer); StrK:(S:String); end; var v:TV; begin v.I:=7; __p(__vs(v.I)); __vybeCheck('7');
end.
