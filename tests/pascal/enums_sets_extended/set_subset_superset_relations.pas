// vybe-test: pascal/enums_sets_extended/set_subset_superset_relations
...
end; type TF=(A,B,C); var small,big: set of TF; begin small:=[A]; big:=[A,B]; __p(__vs(small<=big)); __p(__vs(big>=small)); __vybeCheck('true' + #10 + 'true');
end.
