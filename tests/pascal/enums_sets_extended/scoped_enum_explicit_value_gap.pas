// vybe-test: pascal/enums_sets_extended/scoped_enum_explicit_value_gap
...
end; type TCode=(Ok=0, Warn=5, Fail=10); var c:TCode; begin c:=Fail; __p(__vs(Ord(c))); __vybeCheck('10');
end.
