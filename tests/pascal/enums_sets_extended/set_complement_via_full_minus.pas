// vybe-test: pascal/enums_sets_extended/set_complement_via_full_minus
// origin: languages/pascal/tests/pascal/test_enums_sets_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TF=(A,B,C); var full,part,rest: set of TF; begin full:=[A,B,C]; part:=[B]; rest:=full-part; __p(__vs(A in rest)); __p(__vs(C in rest)); __vybeCheck('True' + #10 + 'True');
end.
