// vybe-test: pascal/enums_sets_extended/set_union_two_enum_members
...
end; type TF=(A,B,C); var s1,s2,s: set of TF; begin s1:=[A]; s2:=[B]; s:=s1+s2; __p(__vs(Ord(A in s))); __p(__vs(Ord(B in s))); __vybeCheck('1' + #10 + '1');
end.
