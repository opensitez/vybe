// vybe-test: pascal/enums_sets_extended/set_intersection_overlapping_members
...
end; type TF=(A,B,C); var s1,s2,s: set of TF; begin s1:=[A,B]; s2:=[B,C]; s:=s1*s2; __p(__vs(B in s)); __p(__vs(A in s)); __vybeCheck('true' + #10 + 'false');
end.
