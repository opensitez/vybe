// vybe-test: pascal/enums_sets_extended/enum_for_in_breaks_on_count
...
end; type TN=(N1,N2,N3,N4); var n:TN; c:Integer; begin c:=0; for n in [N1,N2,N3] do Inc(c); __p(__vs(c)); __vybeCheck('3');
end.
