// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_in_record_methods
...
procedure TFormatter.Format(v: Integer); begin __p(__vs('RecInt:' + v.ToString)); end;
procedure TFormatter.Format(const s: String); begin __p(__vs('RecStr:' + s)); end;

var f: TFormatter;
begin
  f.Format(99);
  f.Format('Text');
__vybeCheck('RecInt:99' + #10 + 'RecStr:Text');
end.
