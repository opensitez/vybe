// vybe-test: pascal/pascal_procedure_overloading_default_args/test_default_parameter_multiple
...
begin
  __p(__vs(w.ToString + 'x' + h.ToString + '-' + color));
end;
begin
  SetBox;
  SetBox(50);
  SetBox(50, 75, 'Blue');
__vybeCheck('100x200-Red' + #10 + '50x200-Red' + #10 + '50x75-Blue');
end.
