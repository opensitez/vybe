// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_by_parameter_type
...
begin __p(__vs('Int:' + v.ToString)); end;

procedure PrintVal(v: Double); overload;
begin __p(__vs('Float:' + FloatToStr(v))); end;

procedure PrintVal(const v: String); overload;
begin __p(__vs('Str:' + v)); end;

begin
  PrintVal(42);
  PrintVal(3.14);
  PrintVal('Hello');
__vybeCheck('Int:42' + #10 + 'Float:3.14' + #10 + 'Str:Hello');
end.
