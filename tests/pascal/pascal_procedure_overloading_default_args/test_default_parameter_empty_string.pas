// vybe-test: pascal/pascal_procedure_overloading_default_args/test_default_parameter_empty_string
...
begin
  if tag = '' then __p(__vs(msg))
  else __p(__vs('[' + tag + '] ' + msg));
end;
begin
  LogTag('PlainMsg');
  LogTag('TaggedMsg', 'INFO');
__vybeCheck('PlainMsg' + #10 + '[INFO] TaggedMsg');
end.
