// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_resolution_widening_conversion
...
begin __p(__vs('Int64:' + v.ToString)); end;

procedure Run(v: Double); overload;
begin __p(__vs('Double:' + FloatToStr(v))); end;

var b: Byte;
begin
  b := 10;
  Run(b); // Prefers Int64 widening over Double
__vybeCheck('Int64:10');
end.
