// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_interface_methods
...
procedure TOverloadedImpl.DoIt(x: Integer); begin __p(__vs('IntfInt:' + x.ToString)); end;
procedure TOverloadedImpl.DoIt(const s: String); begin __p(__vs('IntfStr:' + s)); end;
...
begin
  ...
  intf.DoIt(42);
  intf.DoIt('Data');
__vybeCheck('IntfInt:42' + #10 + 'IntfStr:Data');
end.
