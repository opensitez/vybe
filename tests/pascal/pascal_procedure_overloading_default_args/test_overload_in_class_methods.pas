// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_in_class_methods
...
begin
  ...
  __p(__vs(calc.Compute(5, 5)));
  __p(__vs(calc.Compute(2.5, 4.0)));
  calc.Free;
__vybeCheck('10' + #10 + '10');
end.
