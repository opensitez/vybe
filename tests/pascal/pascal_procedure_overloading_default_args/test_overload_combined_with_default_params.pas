// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_combined_with_default_params
...
begin __p(__vs('IntProc:' + x.ToString + '-' + msg)); end;

procedure Process(x: Double; msg: String = 'DefaultFloat'); overload;
begin __p(__vs('FloatProc:' + FloatToStr(x) + '-' + msg)); end;

begin
  Process(10);
  Process(2.5);
__vybeCheck('IntProc:10-DefaultInt' + #10 + 'FloatProc:2.5-DefaultFloat');
end.
