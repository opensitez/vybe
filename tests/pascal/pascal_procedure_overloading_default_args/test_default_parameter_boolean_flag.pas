// vybe-test: pascal/pascal_procedure_overloading_default_args/test_default_parameter_boolean_flag
...
begin
  if uppercase then __p(__vs(UpperCase(text)))
  else __p(__vs(text));
end;
begin
  Render('Pascal');
  Render('Pascal', True);
__vybeCheck('Pascal' + #10 + 'PASCAL');
end.
