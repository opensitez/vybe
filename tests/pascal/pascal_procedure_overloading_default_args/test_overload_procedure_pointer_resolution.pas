// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_procedure_pointer_resolution
...
procedure Target(x: Integer); overload; begin __p(__vs('ProcInt:' + x.ToString)); end;
procedure Target(s: String); overload; begin __p(__vs('ProcStr:' + s)); end;
