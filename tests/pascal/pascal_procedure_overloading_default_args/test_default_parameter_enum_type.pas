// vybe-test: pascal/pascal_procedure_overloading_default_args/test_default_parameter_enum_type
...
begin
  __p(__vs(msg + ':' + Ord(lvl).ToString));
end;
begin
  Log('Message1');
  Log('Message2', lvlHigh);
__vybeCheck('Message1:1' + #10 + 'Message2:2');
end.
