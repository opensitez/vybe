// vybe-test: pascal/pascal_procedure_overloading_default_args/test_overload_virtual_method_override
// origin: languages/pascal/tests/pascal/test_pascal_procedure_overloading_default_args.rs
program Test;
{$mode delphi}
uses SysUtils;
...
procedure TBase.Show(x: Integer); begin __p(__vs('BaseInt:' + x.ToString)); end;
procedure TSub.Show(x: Integer); begin __p(__vs('SubInt:' + x.ToString)); end;
procedure TSub.Show(const s: String); begin __p(__vs('SubStr:' + s)); end;
...
begin
  ...
  obj.Show('Text');
  obj.Free;
__vybeCheck('SubInt:10' + #10 + 'SubStr:Text');
end.
