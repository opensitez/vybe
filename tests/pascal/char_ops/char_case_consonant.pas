// vybe-test: pascal/char_ops/char_case_consonant
// origin: languages/pascal/tests/pascal/test_char_ops.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  c := 'b';
  case c of
    'a','e','i','o','u': __p(__vs('vowel'));
    else __p(__vs('consonant'));
  end;
__vybeCheck('consonant');
end.
