// vybe-test: pascal/pascal_set_algebra_operations/test_set_record_field_storage
// origin: languages/pascal/tests/pascal/test_pascal_set_algebra_operations.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  __p(__vs(fp.FileName));
  __p(__vs(ReadAcc in fp.Access));
  __p(__vs(ExecAcc in fp.Access));
__vybeCheck('data.bin' + #10 + 'True' + #10 + 'False');
end.
