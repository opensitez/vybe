// vybe-test: pascal/variables/const_expression_used_in_array_bounds
// origin: languages/pascal/tests/pascal/test_variables.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; const N = 3; var a: array[1..N] of Integer; begin a[2] := 5; __p(__vs(a[2])); __vybeCheck('5');
end.
