// vybe-test: pascal/pascal_random_number_generators/test_random_gaussian_approximation
// origin: languages/pascal/tests/pascal/test_pascal_random_number_generators.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  RandSeed := 444;
  __p(__vs((ApproxGaussian >= 0.0) and (ApproxGaussian <= 1.0)));
__vybeCheck('True');
end.
