// vybe-test: pascal/int_overflow_style/shl_10
// origin: languages/pascal/tests/pascal/test_int_overflow_style.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var n:Integer; begin n:=1; __p(__vs(n shl 10)); __vybeCheck('1024');
end.
