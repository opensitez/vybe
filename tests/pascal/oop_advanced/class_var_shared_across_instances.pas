// vybe-test: pascal/oop_advanced/class_var_shared_across_instances
...
var a,b:TCounted; begin TCounted.N:=0; a:=TCounted.Create; b:=TCounted.Create; __p(__vs(TCounted.N)); a.Free; b.Free; __vybeCheck('2');
end.
