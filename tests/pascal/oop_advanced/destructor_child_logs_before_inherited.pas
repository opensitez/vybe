// vybe-test: pascal/oop_advanced/destructor_child_logs_before_inherited
...
var c:TChild; begin TBase.Log:=''; c:=TChild.Create; c.Free; __p(__vs(TBase.Log)); __vybeCheck('CB');
end.
