// vybe-test: pascal/oop_advanced/class_destructor_pattern_on_free
...
var r:TRes; begin TRes.Freed:=false; r:=TRes.Create; r.Free; __p(__vs(TRes.Freed)); __vybeCheck('True');
end.
