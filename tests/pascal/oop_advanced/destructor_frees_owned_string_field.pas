// vybe-test: pascal/oop_advanced/destructor_frees_owned_string_field
...
var m:TMsg; begin m:=TMsg.Create('bye'); __p(__vs(m.FText)); m.Free; __p(__vs('ok')); __vybeCheck('bye' + #10 + 'ok');
end.
