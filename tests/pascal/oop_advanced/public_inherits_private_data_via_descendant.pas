// vybe-test: pascal/oop_advanced/public_inherits_private_data_via_descendant
...
var c:TChild; begin c:=TChild.Create; c.Bump; __p(__vs(c.GetV)); c.Free; __vybeCheck('1');
end.
