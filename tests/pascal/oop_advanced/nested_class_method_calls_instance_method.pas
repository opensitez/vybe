// vybe-test: pascal/oop_advanced/nested_class_method_calls_instance_method
...
var p:TPair; begin p:=TPair.Create; p.FA:=2; p.FB:=3; __p(__vs(p.Total)); p.Free; __vybeCheck('5');
end.
