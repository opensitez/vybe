// vybe-test: pascal/oop_advanced/destructor_inherited_called_explicitly
...
var c:TChild; begin TBase.Seq:=''; c:=TChild.Create; c.Free; __p(__vs(TBase.Seq)); __vybeCheck('CB');
end.
