// vybe-test: pascal/oop_advanced/visibility_public_method_on_private_object_fields
...
var h:THidden; begin h:=THidden.Create; h.SetX(4); __p(__vs(h.GetX)); h.Free; __vybeCheck('4');
end.
