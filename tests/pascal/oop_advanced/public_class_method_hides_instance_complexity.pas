// vybe-test: pascal/oop_advanced/public_class_method_hides_instance_complexity
...
var f:TFactory; begin f:=TFactory.Build(99); __p(__vs(f.FV)); f.Free; __vybeCheck('99');
end.
