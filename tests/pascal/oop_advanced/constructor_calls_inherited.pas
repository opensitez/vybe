// vybe-test: pascal/oop_advanced/constructor_calls_inherited
...
constructor TBase.Create; begin __p(__vs('base')); end;
constructor TChild.Create; begin inherited; __p(__vs('child')); end;
var c:TChild; begin c:=TChild.Create; c.Free; __vybeCheck('base' + #10 + 'child');
end.
