// vybe-test: pascal/pascal_custom_mem_manager/test_custom_mem_manager_register_expected_memory_leak
// origin: languages/pascal/tests/pascal/test_pascal_custom_mem_manager.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  __p(__vs('LeakTrackerInitialized'));
  SetMemoryManager(OldMM);
__vybeCheck('LeakTrackerInitialized');
end.
