// vybe-test: pascal/scoped_enumerations/scoped_enum_for_in_array_of_enums
...
end; type TDay = (Mon, Tue, Wed); var d: TDay; n: Integer; begin n := 0; for d in [Mon, Wed] do n := n + 1; __p(__vs(n)); __vybeCheck('2');
end.
