// vybe-test: pascal/scoped_enumerations/scoped_enum_succ_pred_walk
...
end; type T = (A, B, C); var v: T; begin v := A; v := Succ(v); __p(__vs(Ord(v))); v := Pred(Succ(v)); __p(__vs(Ord(v))); __vybeCheck('1' + #10 + '0');
end.
