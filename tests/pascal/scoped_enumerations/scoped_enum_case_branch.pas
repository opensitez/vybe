// vybe-test: pascal/scoped_enumerations/scoped_enum_case_branch
...
end; type TLevel = (Low, Mid, High); var l: TLevel; begin l := Mid; case l of Low: __p(__vs('L')); Mid: __p(__vs('M')); High: __p(__vs('H')); end; __vybeCheck('M');
end.
