// vybe-test: pascal/scoped_enumerations/scoped_enum_explicit_values
...
end; type TCode = (Ok = 0, Warn = 10, Err = 20); var c: TCode; begin c := Warn; __p(__vs(Ord(c))); __vybeCheck('10');
end.
