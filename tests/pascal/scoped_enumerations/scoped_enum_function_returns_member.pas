// vybe-test: pascal/scoped_enumerations/scoped_enum_function_returns_member
...
end; type TMode = (Read, Write); function DefaultMode: TMode; begin Result := Read; end; begin __p(__vs(Ord(DefaultMode))); __vybeCheck('0');
end.
