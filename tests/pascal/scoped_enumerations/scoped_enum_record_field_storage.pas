// vybe-test: pascal/scoped_enumerations/scoped_enum_record_field_storage
// origin: languages/pascal/tests/pascal/test_scoped_enumerations.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TKind = (Cat, Dog); type TPet = record Kind: TKind; Name: String; end; var p: TPet; begin p.Kind := Dog; p.Name := 'Rex'; __p(__vs(p.Name)); __p(__vs(Ord(p.Kind))); __vybeCheck('Rex' + #10 + '1');
end.
