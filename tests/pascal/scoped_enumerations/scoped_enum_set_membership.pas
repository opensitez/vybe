// vybe-test: pascal/scoped_enumerations/scoped_enum_set_membership
...
end; type TFlag = (A, B, C); var chosen: set of TFlag; begin chosen := [B, C]; if B in chosen then __p(__vs('has B')); __vybeCheck('has B');
end.
