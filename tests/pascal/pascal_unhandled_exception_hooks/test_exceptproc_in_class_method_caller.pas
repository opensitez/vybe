// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_in_class_method_caller
...
begin
  __p(__vs('MethodHook:' + Exception(ExceptObj).Message));
end;
...
begin
  ...
  w := TWorker.Create;
  w.Fail;
__vybeCheck('MethodHook:MethodFailed');
end.
