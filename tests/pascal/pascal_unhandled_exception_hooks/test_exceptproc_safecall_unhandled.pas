// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_safecall_unhandled
...
begin
  __p(__vs('SafecallHook:' + Exception(ExceptObj).Message));
end;
...
begin
  ...
  DoSafe;
__vybeCheck('SafecallHook:SafecallUnhandled');
end.
