// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_with_array_processing
...
begin
  __p(__vs('ArrayHook:' + Exception(ExceptObj).Message));
end;
...
begin
  ...
  Process([1, 2, 3]);
__vybeCheck('ArrayHook:ArrProcessingErr');
end.
