// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_reraised_exception
...
begin
  __p(__vs('ReraiseHook:' + Exception(ExceptObj).Message));
end;
begin
...
__vybeCheck('ReraiseHook:ReraisedUnhandled');
end.
