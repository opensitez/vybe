// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_in_record_method_caller
...
begin
  __p(__vs('RecHook:' + Exception(ExceptObj).Message));
end;
