// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_hook_registration
...
begin
  __p(__vs('HookCaught:' + Exception(ExceptObj).Message));
end;
...
begin
  ...
  ExceptProc := oldProc;
__vybeCheck('HookCaught:UnhandledError');
end.
