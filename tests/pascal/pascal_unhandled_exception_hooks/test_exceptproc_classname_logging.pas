// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_classname_logging
...
begin
  __p(__vs('HookClass:' + ExceptObj.ClassName));
end;
begin
  ExceptProc := LogExceptClass;
  raise EInvalidArgument.Create('BadArg');
__vybeCheck('HookClass:EInvalidArgument');
end.
