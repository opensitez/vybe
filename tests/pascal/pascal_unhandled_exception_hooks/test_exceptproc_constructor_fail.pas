// vybe-test: pascal/pascal_unhandled_exception_hooks/test_exceptproc_constructor_fail
...
begin
  __p(__vs('CtorHook:' + Exception(ExceptObj).Message));
end;
...
begin
  ExceptProc := CtorHook;
  obj := TBadCtor.Create;
__vybeCheck('CtorHook:CtorFailed');
end.
