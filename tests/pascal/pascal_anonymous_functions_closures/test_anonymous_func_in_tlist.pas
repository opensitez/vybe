// vybe-test: pascal/pascal_anonymous_functions_closures/test_anonymous_func_in_tlist
...
begin
  ...
  list.Add(procedure begin __p(__vs('Task1')); end);
  list.Add(procedure begin __p(__vs('Task2')); end);

  for task in list do task();

  list.Free;
__vybeCheck('Task1' + #10 + 'Task2');
end.
