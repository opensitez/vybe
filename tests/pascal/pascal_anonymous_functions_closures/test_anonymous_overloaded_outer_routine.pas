// vybe-test: pascal/pascal_anonymous_functions_closures/test_anonymous_overloaded_outer_routine
// origin: languages/pascal/tests/pascal/test_pascal_anonymous_functions_closures.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  Exec(procedure(v: Integer) begin __p(__vs('Int:' + v.ToString)); end);
  Exec(procedure(v: String) begin __p(__vs('Str:' + v)); end);
__vybeCheck('Int:42' + #10 + 'Str:FortyTwo');
end.
