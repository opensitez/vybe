// vybe-test: pascal/pascal_anonymous_functions_closures/test_anonymous_exception_handling_inside_body
...
begin
  ...
  begin
    try
      ...
      on E: Exception do __p(__vs('AnonCaught:' + E.Message));
    end;
  end;
  runner();
__vybeCheck('AnonCaught:AnonError');
end.
