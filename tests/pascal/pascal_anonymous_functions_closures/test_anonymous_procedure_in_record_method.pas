// vybe-test: pascal/pascal_anonymous_functions_closures/test_anonymous_procedure_in_record_method
...
var r: TRunnerRec;
begin
  r.Run(procedure begin __p(__vs('RunnerRecAnonExecuted')); end);
__vybeCheck('RunnerRecAnonExecuted');
end.
