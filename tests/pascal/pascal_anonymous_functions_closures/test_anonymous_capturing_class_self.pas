// vybe-test: pascal/pascal_anonymous_functions_closures/test_anonymous_capturing_class_self
...
begin
  Result := procedure
  begin
    __p(__vs('CapturedSelfVal:' + FVal.ToString));
  end;
end;
...
begin
  ...
  runner();
  obj.Free;
__vybeCheck('CapturedSelfVal:99');
end.
