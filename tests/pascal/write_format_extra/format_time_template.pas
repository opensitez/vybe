// vybe-test: pascal/write_format_extra/format_time_template
...
end; var t:TDateTime; begin t:=EncodeTime(9,5,7,0); __p(__vs(FormatDateTime('hh:nn',t))); __vybeCheck('09:05');
end.
