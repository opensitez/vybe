// vybe-test: pascal/write_format_extra/format_date_template
// origin: languages/pascal/tests/pascal/test_write_format_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var d:TDateTime; begin d:=EncodeDate(2021,6,15); __p(__vs(FormatDateTime('yyyy-mm-dd',d))); __vybeCheck('2021-06-15');
end.
