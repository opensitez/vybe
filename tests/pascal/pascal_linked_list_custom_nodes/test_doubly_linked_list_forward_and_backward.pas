// vybe-test: pascal/pascal_linked_list_custom_nodes/test_doubly_linked_list_forward_and_backward
...
begin
  ...
  __p(__vs(n1^.Val));
  __p(__vs(n1^.Next^.Val));
  __p(__vs(n2^.Prev^.Val));

  Dispose(n1); Dispose(n2);
__vybeCheck('1' + #10 + '2' + #10 + '1');
end.
