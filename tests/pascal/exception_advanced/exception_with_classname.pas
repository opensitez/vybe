// vybe-test: pascal/exception_advanced/exception_with_classname
...
begin
  try
    ...
    on E: EValidationError do
      __p(__vs('Validation: ' + E.Message));
    on E: Exception do
      __p(__vs('Generic: ' + E.Message));
  end;
__vybeCheck('Validation: invalid input');
end.
