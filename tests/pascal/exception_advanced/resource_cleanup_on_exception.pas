// vybe-test: pascal/exception_advanced/resource_cleanup_on_exception
...
begin
  ...
  try
    ...
    on E: Exception do
      __p(__vs('handled: ' + E.Message));
  end;
  if acquired then
    __p(__vs('cleanup needed: ' + BoolToStr(acquired, True)));
__vybeCheck('acquired' + #10 + 'handled: fail' + #10 + 'cleanup needed: True');
end.
