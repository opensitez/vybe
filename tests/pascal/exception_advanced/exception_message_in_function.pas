// vybe-test: pascal/exception_advanced/exception_message_in_function
...
begin
  try
    __p(__vs(SafeDivide(10, 2)));
    __p(__vs(SafeDivide(5, 0)));
  except
    on E: Exception do
      __p(__vs('Error: ' + E.Message));
  end;
__vybeCheck('5' + #10 + 'Error: division by zero');
end.
