// vybe-test: pascal/exception_advanced/reraise_caught_by_outer
...
begin
  try
    try
      ...
      on E: Exception do
      begin
        __p(__vs('inner caught: ' + E.Message));
        raise;
      end;
    end;
  except
    on E: Exception do
      __p(__vs('outer caught: ' + E.Message));
  end;
__vybeCheck('inner caught: inner error' + #10 + 'outer caught: inner error');
end.
