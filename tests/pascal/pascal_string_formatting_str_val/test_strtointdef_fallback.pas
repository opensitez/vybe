// vybe-test: pascal/pascal_string_formatting_str_val/test_strtointdef_fallback
...
uses SysUtils;
begin
  __p(__vs(StrToIntDef('500', -1)));
  __p(__vs(StrToIntDef('invalid', -1)));
__vybeCheck('500' + #10 + '-1');
end.
