// vybe-test: pascal/pascal_string_formatting_str_val/test_strtofloatdef_fallback
// origin: languages/pascal/tests/pascal/test_pascal_string_formatting_str_val.rs
program Test;
{$mode delphi}
...
uses SysUtils;
begin
  __p(__vs(StrToFloatDef('12.5', 0.0)));
  __p(__vs(StrToFloatDef('bad', -1.0)));
__vybeCheck('12.5' + #10 + '-1');
end.
