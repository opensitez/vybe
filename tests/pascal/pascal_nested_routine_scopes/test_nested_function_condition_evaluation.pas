// vybe-test: pascal/pascal_nested_routine_scopes/test_nested_function_condition_evaluation
// origin: languages/pascal/tests/pascal/test_pascal_nested_routine_scopes.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(FilterData(75)));
  __p(__vs(FilterData(25)));
