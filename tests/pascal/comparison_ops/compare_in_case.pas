// vybe-test: pascal/comparison_ops/compare_in_case
// origin: languages/pascal/tests/pascal/test_comparison_ops.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var n:Integer; begin n:=4; case n of 1..3:__p(__vs('low')); 4..6:__p(__vs('mid')); else __p(__vs('hi')); end; __vybeCheck('mid');
end.
