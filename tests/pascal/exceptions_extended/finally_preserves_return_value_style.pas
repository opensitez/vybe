// vybe-test: pascal/exceptions_extended/finally_preserves_return_value_style
...
end; function F:Integer; begin Result:=0; try Result:=5; finally Result:=Result+1; end; end; begin __p(__vs(F)); __vybeCheck('6');
end.
