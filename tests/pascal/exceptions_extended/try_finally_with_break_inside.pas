// vybe-test: pascal/exceptions_extended/try_finally_with_break_inside
...
end; var i:Integer; begin for i:=1 to 3 do try if i=2 then break; finally __p(__vs('f')); end; __vybeCheck('f' + #10 + 'f');
end.
