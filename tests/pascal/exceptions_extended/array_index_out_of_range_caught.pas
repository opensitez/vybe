// vybe-test: pascal/exceptions_extended/array_index_out_of_range_caught
...
end; var a:array[1..2] of Integer; i:Integer; begin a[1]:=1; a[2]:=2; try i:=a[9]; except __p(__vs('bounds')); end; __vybeCheck('bounds');
end.
