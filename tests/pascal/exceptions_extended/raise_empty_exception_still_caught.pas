// vybe-test: pascal/exceptions_extended/raise_empty_exception_still_caught
...
end; begin try raise Exception.Create(''); except on E:Exception do if E.Message='' then __p(__vs('empty')); end; __vybeCheck('empty');
end.
