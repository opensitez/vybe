// vybe-test: pascal/exceptions_extended/exception_in_constructor_cleanup
// origin: languages/pascal/tests/pascal/test_exceptions_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TFail=class constructor Create; end; constructor TFail.Create; begin inherited; raise Exception.Create('ctor'); end; begin try TFail.Create; except __p(__vs('ctor-fail')); end; __vybeCheck('ctor-fail');
end.
