// vybe-test: pascal/exceptions_extended/try_except_continue_loop
...
end; var i,n:Integer; begin n:=0; for i:=1 to 3 do begin try if i=2 then raise Exception.Create('skip'); n:=n+1; except end; end; __p(__vs(n)); __vybeCheck('2');
end.
