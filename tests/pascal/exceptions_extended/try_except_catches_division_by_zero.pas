// vybe-test: pascal/exceptions_extended/try_except_catches_division_by_zero
...
end; var x:Integer; begin x:=1; try x:=x div 0; except __p(__vs('caught')); end; __vybeCheck('caught');
end.
