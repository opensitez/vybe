// vybe-test: pascal/exceptions_extended/except_on_specific_type_only
...
end; begin try raise ERangeError.Create('range'); except on E:ERangeError do __p(__vs('range')); on E:Exception do __p(__vs('other')); end; __vybeCheck('range');
end.
