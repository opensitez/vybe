// vybe-test: pascal/exceptions_extended/except_outer_catches_inner_reraise
...
end; begin try try raise Exception.Create('x'); except raise Exception.Create('y'); end; except on E:Exception do __p(__vs(E.Message)); end; __vybeCheck('y');
end.
