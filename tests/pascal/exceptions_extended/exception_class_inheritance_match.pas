// vybe-test: pascal/exceptions_extended/exception_class_inheritance_match
...
end; begin try raise EDivByZero.Create('div'); except on E:EDivByZero do __p(__vs('div0')); end; __vybeCheck('div0');
end.
