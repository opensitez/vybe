// vybe-test: pascal/exceptions_extended/re_raise_after_log
...
end; var n:Integer; begin n:=0; try try raise Exception.Create('e'); except Inc(n); raise; end; except Inc(n); end; __p(__vs(n)); __vybeCheck('2');
end.
