// vybe-test: pascal/exceptions_extended/nested_try_blocks_inner_catch
...
end; begin try try raise Exception.Create('inner'); except __p(__vs('inner')); end; except __p(__vs('outer')); end; __vybeCheck('inner');
end.
