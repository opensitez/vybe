// vybe-test: pascal/exceptions_extended/nested_finally_order
...
end; begin try try __p(__vs('a')); finally __p(__vs('b')); end; finally __p(__vs('c')); end; __vybeCheck('a' + #10 + 'b' + #10 + 'c');
end.
