// vybe-test: pascal/exceptions_extended/try_finally_runs_after_except
...
end; begin try try raise Exception.Create('e'); except __p(__vs('ex')); end; finally __p(__vs('fin')); end; __vybeCheck('ex' + #10 + 'fin');
end.
