// vybe-test: pascal/exceptions_extended/finally_counter_increments
...
end; var c:Integer; begin c:=0; try try raise Exception.Create('e'); except end; finally Inc(c); end; __p(__vs(c)); __vybeCheck('1');
end.
