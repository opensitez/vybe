// vybe-test: pascal/exceptions_extended/raise_explicit_exception_message
...
end; begin try raise Exception.Create('boom'); except on E:Exception do __p(__vs(E.Message)); end; __vybeCheck('boom');
end.
