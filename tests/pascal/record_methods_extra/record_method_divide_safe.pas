// vybe-test: pascal/record_methods_extra/record_method_divide_safe
...
end; type TFrac=record Num,Den:Integer; function Value:Integer; end; function TFrac.Value:Integer; begin if Den=0 then Result:=0 else Result:=Num div Den; end; var f:TFrac; begin f.Num:=9; f.Den:=3; __p(__vs(f.Value)); __vybeCheck('3');
end.
