// vybe-test: pascal/record_methods_extra/record_method_char_to_ord
...
end; type TCh=record C:Char; function Code:Integer; end; function TCh.Code:Integer; begin Result:=Ord(C); end; var c:TCh; begin c.C:='A'; __p(__vs(c.Code)); __vybeCheck('65');
end.
