// vybe-test: pascal/record_methods_extra/record_method_count_bits_simple
...
end; type TBits=record Mask:Integer; function Pop:Integer; end; function TBits.Pop:Integer; var c,m:Integer; begin c:=0; m:=Mask; while m>0 do begin if (m mod 2)=1 then Inc(c); m:=m div 2; end; Result:=c; end; var b:TBits; begin b.Mask:=5; __p(__vs(b.Pop)); __vybeCheck('2');
end.
