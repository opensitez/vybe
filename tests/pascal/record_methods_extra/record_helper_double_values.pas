// vybe-test: pascal/record_methods_extra/record_helper_double_values
...
end; type TPair=record A,B:Integer; end; TPairHelper=record helper for TPair procedure Double; end; procedure TPairHelper.Double; begin A:=A*2; B:=B*2; end; var p:TPair; begin p.A:=2; p.B:=3; p.Double; __p(__vs(p.A+p.B)); __vybeCheck('10');
end.
