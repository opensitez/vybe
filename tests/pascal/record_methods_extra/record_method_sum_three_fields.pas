// vybe-test: pascal/record_methods_extra/record_method_sum_three_fields
...
end; type TTrip=record A,B,C:Integer; function Sum:Integer; end; function TTrip.Sum:Integer; begin Result:=A+B+C; end; var t:TTrip; begin t.A:=1; t.B:=2; t.C:=3; __p(__vs(t.Sum)); __vybeCheck('6');
end.
