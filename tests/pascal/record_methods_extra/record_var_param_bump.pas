// vybe-test: pascal/record_methods_extra/record_var_param_bump
...
end; type TPt=record X:Integer; end; procedure Bump(var p:TPt); begin Inc(p.X); end; var p:TPt; begin p.X:=4; Bump(p); __p(__vs(p.X)); __vybeCheck('5');
end.
