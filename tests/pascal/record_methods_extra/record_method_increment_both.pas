// vybe-test: pascal/record_methods_extra/record_method_increment_both
...
end; type TPair=record A,B:Integer; procedure IncBoth; end; procedure TPair.IncBoth; begin Inc(A); Inc(B); end; var p:TPair; begin p.A:=1; p.B:=2; p.IncBoth; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('2' + #10 + '3');
end.
