// vybe-test: pascal/record_methods_extra/record_function_max_component
...
end; type TRng=record Lo,Hi:Integer; function Span:Integer; end; function TRng.Span:Integer; begin Result:=Hi-Lo; end; var r:TRng; begin r.Lo:=3; r.Hi:=10; __p(__vs(r.Span)); __vybeCheck('7');
end.
