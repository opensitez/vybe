// vybe-test: pascal/record_methods_extra/record_helper_distance_squared
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt function LenSq:Integer; end; function TPtHelper.LenSq:Integer; begin Result:=X*X+Y*Y; end; var p:TPt; begin p.X:=3; p.Y:=4; __p(__vs(p.LenSq)); __vybeCheck('25');
end.
