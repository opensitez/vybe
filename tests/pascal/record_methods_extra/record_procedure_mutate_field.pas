// vybe-test: pascal/record_methods_extra/record_procedure_mutate_field
...
end; type TAcc=record N:Integer; procedure IncN; end; procedure TAcc.IncN; begin Inc(N); end; var a:TAcc; begin a.N:=0; a.IncN; a.IncN; __p(__vs(a.N)); __vybeCheck('2');
end.
