// vybe-test: pascal/record_methods_extra/record_helper_magnitude_manhattan
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt function Manh:Integer; end; function TPtHelper.Manh:Integer; begin Result:=Abs(X)+Abs(Y); end; var p:TPt; begin p.X:=-2; p.Y:=3; __p(__vs(p.Manh)); __vybeCheck('5');
end.
