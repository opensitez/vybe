// vybe-test: pascal/record_methods_extra/record_helper_compare_x
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt function SameX(const o:TPt):Boolean; end; function TPtHelper.SameX(const o:TPt):Boolean; begin Result:=X=o.X; end; var a,b:TPt; begin a.X:=1; a.Y:=2; b.X:=1; b.Y:=9; __p(__vs(a.SameX(b))); __vybeCheck('True');
end.
