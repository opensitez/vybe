// vybe-test: pascal/record_methods_extra/record_function_midpoint
...
end; type TRng=record Lo,Hi:Integer; function Mid:Integer; end; function TRng.Mid:Integer; begin Result:=(Lo+Hi) div 2; end; var r:TRng; begin r.Lo:=2; r.Hi:=8; __p(__vs(r.Mid)); __vybeCheck('5');
end.
