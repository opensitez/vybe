// vybe-test: pascal/record_methods_extra/record_method_min_field
...
end; type TPair=record A,B:Integer; function MinF:Integer; end; function TPair.MinF:Integer; begin if A<B then Result:=A else Result:=B; end; var p:TPair; begin p.A:=7; p.B:=3; __p(__vs(p.MinF)); __vybeCheck('3');
end.
