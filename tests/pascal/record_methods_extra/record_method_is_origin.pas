// vybe-test: pascal/record_methods_extra/record_method_is_origin
...
end; type TPt=record X,Y:Integer; function IsZero:Boolean; end; function TPt.IsZero:Boolean; begin Result:=(X=0) and (Y=0); end; var p:TPt; begin p.X:=0; p.Y:=0; __p(__vs(p.IsZero)); __vybeCheck('True');
end.
