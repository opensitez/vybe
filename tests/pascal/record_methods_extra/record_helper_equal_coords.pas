// vybe-test: pascal/record_methods_extra/record_helper_equal_coords
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt function Equal(const o:TPt):Boolean; end; function TPtHelper.Equal(const o:TPt):Boolean; begin Result:=(X=o.X) and (Y=o.Y); end; var a,b:TPt; begin a.X:=1; a.Y:=2; b:=a; __p(__vs(a.Equal(b))); __vybeCheck('True');
end.
