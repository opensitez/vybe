// vybe-test: pascal/record_methods_extra/record_method_concat_names
...
end; type TFull=record First,Last:string; function Full:string; end; function TFull.Full:string; begin Result:=First+' '+Last; end; var f:TFull; begin f.First:='Ann'; f.Last:='Lee'; __p(__vs(f.Full)); __vybeCheck('Ann Lee');
end.
