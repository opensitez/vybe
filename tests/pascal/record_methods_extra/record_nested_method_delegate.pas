// vybe-test: pascal/record_methods_extra/record_nested_method_delegate
// origin: languages/pascal/tests/pascal/test_record_methods_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TInner=record V:Integer; function Get:Integer; end; function TInner.Get:Integer; begin Result:=V; end; type TOuter=record Inner:TInner; function Total:Integer; end; function TOuter.Total:Integer; begin Result:=Inner.Get; end; var o:TOuter; begin o.Inner.V:=11; __p(__vs(o.Total)); __vybeCheck('11');
end.
