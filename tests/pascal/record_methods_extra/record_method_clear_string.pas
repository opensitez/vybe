// vybe-test: pascal/record_methods_extra/record_method_clear_string
...
end; type TBuf=record S:string; procedure Clear; end; procedure TBuf.Clear; begin S:=''; end; var b:TBuf; begin b.S:='x'; b.Clear; __p(__vs(Length(b.S))); __vybeCheck('0');
end.
