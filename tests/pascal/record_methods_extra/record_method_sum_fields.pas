// vybe-test: pascal/record_methods_extra/record_method_sum_fields
...
end; type TPair=record A,B:Integer; function Sum:Integer; end; function TPair.Sum:Integer; begin Result:=A+B; end; var p:TPair; begin p.A:=6; p.B:=7; __p(__vs(p.Sum)); __vybeCheck('13');
end.
