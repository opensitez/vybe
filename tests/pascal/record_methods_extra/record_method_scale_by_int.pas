// vybe-test: pascal/record_methods_extra/record_method_scale_by_int
...
end; type TVec=record X,Y:Integer; procedure Scale(k:Integer); end; procedure TVec.Scale(k:Integer); begin X:=X*k; Y:=Y*k; end; var v:TVec; begin v.X:=2; v.Y:=3; v.Scale(4); __p(__vs(v.X)); __p(__vs(v.Y)); __vybeCheck('8' + #10 + '12');
end.
