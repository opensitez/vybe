// vybe-test: pascal/record_methods_extra/record_method_char_field_upper
...
end; type TCh=record C:Char; function Upper:Char; end; function TCh.Upper:Char; begin Result:=UpCase(C); end; var c:TCh; begin c.C:='m'; __p(__vs(c.Upper)); __vybeCheck('M');
end.
