// vybe-test: pascal/record_methods_extra/record_method_reset_fields
...
end; type TReset=record A,B:Integer; procedure Clear; end; procedure TReset.Clear; begin A:=0; B:=0; end; var r:TReset; begin r.A:=5; r.B:=6; r.Clear; __p(__vs(r.A+r.B)); __vybeCheck('0');
end.
