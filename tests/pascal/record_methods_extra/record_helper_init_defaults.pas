// vybe-test: pascal/record_methods_extra/record_helper_init_defaults
...
end; type TCfg=record A,B:Integer; end; TCfgHelper=record helper for TCfg procedure Init; end; procedure TCfgHelper.Init; begin A:=1; B:=2; end; var c:TCfg; begin c.Init; __p(__vs(c.A+c.B)); __vybeCheck('3');
end.
