// vybe-test: pascal/record_methods_extra/record_function_add_points
...
end; type TPt=record X,Y:Integer; end; function Add(a,b:TPt):TPt; begin Result.X:=a.X+b.X; Result.Y:=a.Y+b.Y; end; var u,v,w:TPt; begin u.X:=1; u.Y:=2; v.X:=3; v.Y:=4; w:=Add(u,v); __p(__vs(w.X)); __p(__vs(w.Y)); __vybeCheck('4' + #10 + '6');
end.
