// vybe-test: pascal/record_methods_extra/record_method_compare_y
...
end; type TPt=record X,Y:Integer; function YGreater(const o:TPt):Boolean; end; function TPt.YGreater(const o:TPt):Boolean; begin Result:=Y>o.Y; end; var a,b:TPt; begin a.Y:=5; b.Y:=2; __p(__vs(a.YGreater(b))); __vybeCheck('True');
end.
