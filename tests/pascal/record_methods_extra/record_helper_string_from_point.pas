// vybe-test: pascal/record_methods_extra/record_helper_string_from_point
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt function AsText:string; end; function TPtHelper.AsText:string; begin Result:=IntToStr(X)+','+IntToStr(Y); end; var p:TPt; begin p.X:=2; p.Y:=5; __p(__vs(p.AsText)); __vybeCheck('2,5');
end.
