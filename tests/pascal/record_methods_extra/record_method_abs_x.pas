// vybe-test: pascal/record_methods_extra/record_method_abs_x
...
end; type TPt=record X:Integer; function AbsX:Integer; end; function TPt.AbsX:Integer; begin if X<0 then Result:=-X else Result:=X; end; var p:TPt; begin p.X:=-8; __p(__vs(p.AbsX)); __vybeCheck('8');
end.
