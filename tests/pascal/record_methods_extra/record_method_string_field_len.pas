// vybe-test: pascal/record_methods_extra/record_method_string_field_len
...
end; type TName=record S:string; function Len:Integer; end; function TName.Len:Integer; begin Result:=Length(S); end; var n:TName; begin n.S:='abc'; __p(__vs(n.Len)); __vybeCheck('3');
end.
