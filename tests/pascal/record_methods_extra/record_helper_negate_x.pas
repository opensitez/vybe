// vybe-test: pascal/record_methods_extra/record_helper_negate_x
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt procedure NegX; end; procedure TPtHelper.NegX; begin X:=-X; end; var p:TPt; begin p.X:=4; p.NegX; __p(__vs(p.X)); __vybeCheck('-4');
end.
