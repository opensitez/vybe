// vybe-test: pascal/record_methods_extra/record_helper_has_zero
...
end; type TPair=record A,B:Integer; end; TPairHelper=record helper for TPair function HasZero:Boolean; end; function TPairHelper.HasZero:Boolean; begin Result:=(A=0) or (B=0); end; var p:TPair; begin p.A:=0; p.B:=3; __p(__vs(p.HasZero)); __vybeCheck('True');
end.
