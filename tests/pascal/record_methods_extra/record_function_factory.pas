// vybe-test: pascal/record_methods_extra/record_function_factory
...
end; type TPt=record X,Y:Integer; end; function MakePt(x,y:Integer):TPt; begin Result.X:=x; Result.Y:=y; end; var p:TPt; begin p:=MakePt(2,3); __p(__vs(p.X+p.Y)); __vybeCheck('5');
end.
