// vybe-test: pascal/record_methods_extra/record_method_product
...
end; type TRect=record W,H:Integer; function Area:Integer; end; function TRect.Area:Integer; begin Result:=W*H; end; var r:TRect; begin r.W:=5; r.H:=8; __p(__vs(r.Area)); __vybeCheck('40');
end.
