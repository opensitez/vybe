// vybe-test: pascal/record_methods_extra/record_nested_clear_inner
...
end; type TInner=record V:Integer; procedure Zero; end; procedure TInner.Zero; begin V:=0; end; type TWrap=record Inner:TInner; procedure Reset; end; procedure TWrap.Reset; begin Inner.Zero; end; var w:TWrap; begin w.Inner.V:=9; w.Reset; __p(__vs(w.Inner.V)); __vybeCheck('0');
end.
