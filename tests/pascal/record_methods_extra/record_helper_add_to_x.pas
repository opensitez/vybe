// vybe-test: pascal/record_methods_extra/record_helper_add_to_x
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt procedure AddX(d:Integer); end; procedure TPtHelper.AddX(d:Integer); begin X:=X+d; end; var p:TPt; begin p.X:=1; p.AddX(4); __p(__vs(p.X)); __vybeCheck('5');
end.
