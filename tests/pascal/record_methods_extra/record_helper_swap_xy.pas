// vybe-test: pascal/record_methods_extra/record_helper_swap_xy
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt procedure Swap; end; procedure TPtHelper.Swap; var t:Integer; begin t:=X; X:=Y; Y:=t; end; var p:TPt; begin p.X:=1; p.Y:=9; p.Swap; __p(__vs(p.X)); __p(__vs(p.Y)); __vybeCheck('9' + #10 + '1');
end.
