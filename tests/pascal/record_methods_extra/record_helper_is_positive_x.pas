// vybe-test: pascal/record_methods_extra/record_helper_is_positive_x
...
end; type TPt=record X,Y:Integer; end; TPtHelper=record helper for TPt function XPos:Boolean; end; function TPtHelper.XPos:Boolean; begin Result:=X>0; end; var p:TPt; begin p.X:=3; __p(__vs(p.XPos)); __vybeCheck('True');
end.
