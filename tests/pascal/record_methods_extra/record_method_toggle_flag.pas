// vybe-test: pascal/record_methods_extra/record_method_toggle_flag
...
end; type TFlag=record On:Boolean; procedure Flip; end; procedure TFlag.Flip; begin On:=not On; end; var f:TFlag; begin f.On:=false; f.Flip; __p(__vs(f.On)); __vybeCheck('True');
end.
