// vybe-test: pascal/record_methods_extra/record_method_average_two_fields
...
end; type TPair=record A,B:Integer; function Avg:Integer; end; function TPair.Avg:Integer; begin Result:=(A+B) div 2; end; var p:TPair; begin p.A:=4; p.B:=8; __p(__vs(p.Avg)); __vybeCheck('6');
end.
