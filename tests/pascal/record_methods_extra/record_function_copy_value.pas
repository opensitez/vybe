// vybe-test: pascal/record_methods_extra/record_function_copy_value
...
end; type TVal=record N:Integer; end; function Dup(v:TVal):TVal; begin Result:=v; Result.N:=Result.N+1; end; var a,b:TVal; begin a.N:=5; b:=Dup(a); __p(__vs(b.N)); __vybeCheck('6');
end.
