// vybe-test: pascal/record_methods_extra/record_method_set_string
...
end; type TMsg=record Text:string; procedure SetText(const s:string); end; procedure TMsg.SetText(const s:string); begin Text:=s; end; var m:TMsg; begin m.SetText('hi'); __p(__vs(m.Text)); __vybeCheck('hi');
end.
