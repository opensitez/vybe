// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_inside_loop_iteration
  ...
  begin
    try
      try
        ...
        __p(__vs('LoopOK:' + i.ToString));
      except
        on E: Exception do
        begin
          __p(__vs('LoopIntercept:' + i.ToString));
          raise;
        end;
      end;
    except
      on E: Exception do __p(__vs('LoopOuterCaught:' + i.ToString));
    end;
  end;
__vybeCheck('LoopOK:1' + #10 + 'LoopIntercept:2' + #10 + 'LoopOuterCaught:2');
end.
