// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_conditional
...
begin
  try
    Process(False);
    __p(__vs('ContinuedWhenNoReraise'));
    Process(True);
  except
    on E: Exception do __p(__vs('CaughtTopAfterReraise'));
  end;
__vybeCheck('CaughtInProc' + #10 + 'ContinuedWhenNoReraise' + #10 + 'CaughtInProc' + #10 + 'CaughtTopAfterReraise');
end.
