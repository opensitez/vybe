// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_interface_method_implementation
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('IntfCallerCaught:' + E.Message));
  end;
__vybeCheck('IntfLogged' + #10 + 'IntfCallerCaught:IntfWorkErr');
end.
