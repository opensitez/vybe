// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_custom_exception_with_extra_fields
...
begin
  try
    try
      ...
      on E: ECustomData do
      begin
        __p(__vs('InnerTag:' + E.Tag.ToString));
        raise;
      end;
    end;
  except
    on E: ECustomData do __p(__vs('OuterTag:' + E.Tag.ToString));
  end;
__vybeCheck('InnerTag:999' + #10 + 'OuterTag:999');
end.
