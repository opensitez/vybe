// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_after_resource_cleanup
...
begin
  ...
  try
    try
      ...
      __p(__vs('CleaningUpResource'));
      sl.Free;
      sl := nil;
      raise;
    end;
  except
    on E: Exception do __p(__vs('OuterCaughtResourceCleaned:' + E.Message));
  end;
__vybeCheck('CleaningUpResource' + #10 + 'OuterCaughtResourceCleaned:FailWithResource');
end.
