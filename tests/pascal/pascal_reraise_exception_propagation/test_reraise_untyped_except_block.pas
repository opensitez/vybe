// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_untyped_except_block
...
begin
  try
    try
      ...
      __p(__vs('UntypedIntercepted'));
      raise;
    end;
  except
    on E: Exception do __p(__vs('OuterCaught:' + E.Message));
  end;
__vybeCheck('UntypedIntercepted' + #10 + 'OuterCaught:UntypedReraise');
end.
