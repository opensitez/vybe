// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_updates_global_error_count
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('ErrorCount:' + errorCount.ToString));
  end;
__vybeCheck('ErrorCount:1');
end.
