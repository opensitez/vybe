// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_preserves_exact_subclass_type
...
begin
  try
    try
      ...
      on E: Exception do
      begin
        __p(__vs('BaseIntercept:' + E.ClassName));
        raise;
      end;
    end;
  except
    on E: ECustomChild do __p(__vs('OuterChildCaught:' + E.ClassName));
  end;
__vybeCheck('BaseIntercept:ECustomChild' + #10 + 'OuterChildCaught:ECustomChild');
end.
