// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_multiple_chained_levels
// origin: languages/pascal/tests/pascal/test_pascal_reraise_exception_propagation.rs
program Test;
{$mode delphi}
...
procedure P2;
begin
  try P1; except __p(__vs('P2Reraising')); raise; end;
end;
procedure P3;
begin
  try P2; except __p(__vs('P3Reraising')); raise; end;
end;
begin
  try
    P3;
  except
    on E: Exception do __p(__vs('MainCaught:' + E.Message));
  end;
__vybeCheck('P2Reraising' + #10 + 'P3Reraising' + #10 + 'MainCaught:ChainedErr');
end.
