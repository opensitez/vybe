// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_preserves_error_code_in_sys_exception
...
begin
  try
    try
      ...
      on E: EDivByZero do
      begin
        __p(__vs('InnerDivByZero'));
        raise;
      end;
    end;
  except
    on E: EDivByZero do __p(__vs('OuterDivByZeroConfirmed'));
  end;
__vybeCheck('InnerDivByZero' + #10 + 'OuterDivByZeroConfirmed');
end.
