// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_nested_procedure_call
...
begin
  try
    ...
    on E: Exception do
    begin
      __p(__vs('LoggerLogged:' + E.Message));
      raise;
    end;
  end;
end;
begin
  try
    ...
    on E: Exception do __p(__vs('TopHandler:' + E.Message));
  end;
__vybeCheck('LoggerLogged:DeepError' + #10 + 'TopHandler:DeepError');
end.
