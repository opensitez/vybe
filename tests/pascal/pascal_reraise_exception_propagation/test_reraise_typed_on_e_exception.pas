// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_typed_on_e_exception
...
begin
  try
    try
      ...
      begin
        __p(__vs('TypedIntercepted:' + E.Message));
        raise;
      end;
    end;
  except
    on E: EInvalidArgument do __p(__vs('OuterTypedCaught:' + E.ClassName));
  end;
__vybeCheck('TypedIntercepted:BadArg' + #10 + 'OuterTypedCaught:EInvalidArgument');
end.
