// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_class_helper
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('CallerHelperCaught:' + E.Message));
  end;
__vybeCheck('HelperLogged' + #10 + 'CallerHelperCaught:HelperErr');
end.
