// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_class_method
...
begin
  try
    ...
    on E: Exception do
    begin
      __p(__vs('MethodLogged:' + E.Message));
      raise;
    end;
  end;
end;
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('CallerCaught:' + E.Message));
  end;
  w.Free;
__vybeCheck('MethodLogged:TaskFailed' + #10 + 'CallerCaught:TaskFailed');
end.
