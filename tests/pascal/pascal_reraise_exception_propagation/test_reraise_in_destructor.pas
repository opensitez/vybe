// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_destructor
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('FreeCaught:' + E.Message));
  end;
__vybeCheck('DtorLogging' + #10 + 'FreeCaught:DtorErr');
end.
