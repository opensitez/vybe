// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_record_method
...
begin
  try
    ...
    on E: Exception do __p(__vs('OuterRecCaught:' + E.Message));
  end;
__vybeCheck('RecLogged:RecErr' + #10 + 'OuterRecCaught:RecErr');
end.
