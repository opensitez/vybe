// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_function_return
...
begin
  try
    ...
    on E: Exception do __p(__vs('FuncCallerCaught:' + E.Message));
  end;
__vybeCheck('FuncLogged' + #10 + 'FuncCallerCaught:FuncValErr');
end.
