// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_in_constructor
...
begin
  try
    ...
    on E: Exception do __p(__vs('CallerCtorCaught:' + E.Message));
  end;
__vybeCheck('ParentCtorLogging' + #10 + 'CallerCtorCaught:ChildCtorErr');
end.
