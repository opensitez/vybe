// vybe-test: pascal/pascal_reraise_exception_propagation/test_reraise_with_finally_block_cleanup
  ...
  try
    try
      try
        ...
        __p(__vs('ExceptBlock'));
        raise;
      end;
    finally
      __p(__vs('FinallyBlock'));
    end;
  except
    on E: Exception do __p(__vs('OuterBlock:' + E.Message));
  end;
__vybeCheck('ExceptBlock' + #10 + 'FinallyBlock' + #10 + 'OuterBlock:WithFinally');
end.
