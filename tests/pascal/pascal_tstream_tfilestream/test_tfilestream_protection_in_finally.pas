// vybe-test: pascal/pascal_tstream_tfilestream/test_tfilestream_protection_in_finally
...
begin
  ...
  try
    __p(__vs('StreamActive'));
  finally
    fs.Free;
    __p(__vs('StreamFreedInFinally'));
  end;
__vybeCheck('StreamActive' + #10 + 'StreamFreedInFinally');
end.
