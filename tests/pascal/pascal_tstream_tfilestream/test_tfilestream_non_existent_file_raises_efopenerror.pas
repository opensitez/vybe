// vybe-test: pascal/pascal_tstream_tfilestream/test_tfilestream_non_existent_file_raises_efopenerror
...
begin
  try
    ...
    on E: EFOpenError do __p(__vs('FOpenErrorCaught'));
  end;
__vybeCheck('FOpenErrorCaught');
end.
