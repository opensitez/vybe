// vybe-test: pascal/pascal_class_visibility_specifiers/test_private_method_called_by_public_method
...
procedure TPipeline.Step1; begin __p(__vs('Step1')); end;
procedure TPipeline.Step2; begin __p(__vs('Step2')); end;
