// vybe-test: pascal/pascal_class_visibility_specifiers/test_protected_method_with_default_parameters
...
procedure TBaseWorker.Work(intensity: Integer); begin __p(__vs('BaseWork:' + intensity.ToString)); end;
procedure TBaseWorker.Execute; begin Work; end;
procedure TFastWorker.Work(intensity: Integer); begin __p(__vs('FastWork:' + intensity.ToString)); end;
var w: TBaseWorker;
begin
  w := TFastWorker.Create;
  w.Execute;
  w.Free;
__vybeCheck('FastWork:1');
end.
