// vybe-test: pascal/pascal_class_visibility_specifiers/test_protected_method_accessed_by_subclass
...
procedure TBaseProcessor.InternalProcess; begin __p(__vs('BaseInternal')); end;
procedure TCustomProcessor.InternalProcess; begin __p(__vs('CustomInternal')); end;
