// vybe-test: pascal/pascal_class_visibility_specifiers/test_protected_virtual_method_override_access
...
procedure TBaseApp.PrintName; begin __p(__vs(GetName)); end;
