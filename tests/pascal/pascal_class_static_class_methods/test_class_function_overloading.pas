// vybe-test: pascal/pascal_class_static_class_methods/test_class_function_overloading
...
begin
  __p(__vs(TParser.Parse(42)));
  __p(__vs(TParser.Parse('hello')));
__vybeCheck('INT:42' + #10 + 'STR:hello');
end.
