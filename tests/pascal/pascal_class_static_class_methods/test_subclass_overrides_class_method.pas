// vybe-test: pascal/pascal_class_static_class_methods/test_subclass_overrides_class_method
// origin: languages/pascal/tests/pascal/test_pascal_class_static_class_methods.rs
program Test;
{$mode delphi}
uses SysUtils;
...
class procedure TBaseClass.Announce; begin __p(__vs('BaseClass')); end;
class procedure TSubClass.Announce; begin __p(__vs('SubClass')); end;
begin
  TBaseClass.Announce;
  TSubClass.Announce;
__vybeCheck('BaseClass' + #10 + 'SubClass');
end.
