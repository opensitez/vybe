// vybe-test: pascal/pascal_class_static_class_methods/test_class_function_real_precision_computation
...
begin
  __p(__vs(TGeometry.CircleArea(2.0)));
__vybeCheck('12.56636');
end.
