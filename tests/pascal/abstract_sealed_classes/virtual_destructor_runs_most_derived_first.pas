// vybe-test: pascal/abstract_sealed_classes/virtual_destructor_runs_most_derived_first
// origin: languages/pascal/tests/pascal/test_abstract_sealed_classes.rs
program T;
{$mode delphi}
uses SysUtils;
...
destructor TBase.Destroy; begin __p(__vs('base')); inherited; end;
destructor TChild.Destroy; begin __p(__vs('child')); inherited; end;
var c: TChild;
begin
  c := TChild.Create;
  c.Free;
__vybeCheck('child' + #10 + 'base');
end.
