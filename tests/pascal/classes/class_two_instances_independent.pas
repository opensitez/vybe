// vybe-test: pascal/classes/class_two_instances_independent
// origin: languages/pascal/tests/pascal/test_classes.rs
program T;
{$mode delphi}
uses SysUtils;
...
var a, b: TBox;
begin a := TBox.Create(10); b := TBox.Create(20); __p(__vs(a.GetVal())); __p(__vs(b.GetVal())); __vybeCheck('10' + #10 + '20');
end.
