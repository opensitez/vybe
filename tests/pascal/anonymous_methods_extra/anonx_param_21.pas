// vybe-test: pascal/anonymous_methods_extra/anonx_param_21
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x+21; end; __p(__vs(f(21))); __vybeCheck('42');
end.
