// vybe-test: pascal/anonymous_methods_extra/anonx_func_26
...
end; var f:function:Integer; begin f:=function:Integer begin Result:=26; end; __p(__vs(f())); __vybeCheck('26');
end.
