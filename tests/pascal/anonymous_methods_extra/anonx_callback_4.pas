// vybe-test: pascal/anonymous_methods_extra/anonx_callback_4
...
end; procedure Run(p:procedure); begin p; end; begin Run(procedure begin __p(__vs('cb4')); end); __vybeCheck('cb4');
end.
