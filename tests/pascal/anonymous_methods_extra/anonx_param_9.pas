// vybe-test: pascal/anonymous_methods_extra/anonx_param_9
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x+9; end; __p(__vs(f(9))); __vybeCheck('18');
end.
