// vybe-test: pascal/anonymous_methods_extra/anonx_func_38
...
end; var f:function:Integer; begin f:=function:Integer begin Result:=38; end; __p(__vs(f())); __vybeCheck('38');
end.
