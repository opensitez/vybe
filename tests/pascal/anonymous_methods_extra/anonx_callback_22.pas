// vybe-test: pascal/anonymous_methods_extra/anonx_callback_22
...
end; procedure Run(p:procedure); begin p; end; begin Run(procedure begin __p(__vs('cb22')); end); __vybeCheck('cb22');
end.
