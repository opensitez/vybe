// vybe-test: pascal/anonymous_methods_extra/anonx_param_33
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x+33; end; __p(__vs(f(33))); __vybeCheck('66');
end.
