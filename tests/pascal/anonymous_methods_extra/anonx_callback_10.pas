// vybe-test: pascal/anonymous_methods_extra/anonx_callback_10
...
end; procedure Run(p:procedure); begin p; end; begin Run(procedure begin __p(__vs('cb10')); end); __vybeCheck('cb10');
end.
