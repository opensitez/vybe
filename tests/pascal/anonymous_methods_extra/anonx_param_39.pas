// vybe-test: pascal/anonymous_methods_extra/anonx_param_39
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x+39; end; __p(__vs(f(39))); __vybeCheck('78');
end.
