// vybe-test: pascal/anonymous_methods_extra/anonx_callback_16
...
end; procedure Run(p:procedure); begin p; end; begin Run(procedure begin __p(__vs('cb16')); end); __vybeCheck('cb16');
end.
