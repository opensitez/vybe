// vybe-test: pascal/anonymous_methods_extra/anonx_callback_34
...
end; procedure Run(p:procedure); begin p; end; begin Run(procedure begin __p(__vs('cb34')); end); __vybeCheck('cb34');
end.
