// vybe-test: pascal/anonymous_methods_extra/anonx_func_14
...
end; var f:function:Integer; begin f:=function:Integer begin Result:=14; end; __p(__vs(f())); __vybeCheck('14');
end.
