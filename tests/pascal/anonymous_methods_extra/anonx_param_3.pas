// vybe-test: pascal/anonymous_methods_extra/anonx_param_3
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x+3; end; __p(__vs(f(3))); __vybeCheck('6');
end.
