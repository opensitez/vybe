// vybe-test: pascal/anonymous_methods_extra/anonx_func_32
...
end; var f:function:Integer; begin f:=function:Integer begin Result:=32; end; __p(__vs(f())); __vybeCheck('32');
end.
