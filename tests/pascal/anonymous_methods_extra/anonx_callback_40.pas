// vybe-test: pascal/anonymous_methods_extra/anonx_callback_40
...
end; procedure Run(p:procedure); begin p; end; begin Run(procedure begin __p(__vs('cb40')); end); __vybeCheck('cb40');
end.
