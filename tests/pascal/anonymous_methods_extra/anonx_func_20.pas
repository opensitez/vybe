// vybe-test: pascal/anonymous_methods_extra/anonx_func_20
...
end; var f:function:Integer; begin f:=function:Integer begin Result:=20; end; __p(__vs(f())); __vybeCheck('20');
end.
