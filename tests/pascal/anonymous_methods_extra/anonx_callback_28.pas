// vybe-test: pascal/anonymous_methods_extra/anonx_callback_28
...
end; procedure Run(p:procedure); begin p; end; begin Run(procedure begin __p(__vs('cb28')); end); __vybeCheck('cb28');
end.
