// vybe-test: pascal/type_convert/format_with_conversion
// origin: languages/pascal/tests/pascal/test_type_convert.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  n := 42;
  __p(__vs(Format('Hex: %s', [IntToHex(n, 4)])));
__vybeCheck('Hex: 002A');
end.
