// vybe-test: pascal/string_extra/extract_first_word
// origin: languages/pascal/tests/pascal/test_string_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(FirstWord('hello world')));
  __p(__vs(FirstWord('single')));
__vybeCheck('hello' + #10 + 'single');
end.
