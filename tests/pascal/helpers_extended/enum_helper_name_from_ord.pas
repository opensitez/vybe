// vybe-test: pascal/helpers_extended/enum_helper_name_from_ord
...
end; type TD=(A,B,C); TDHelper=record helper for TD function AsInt:Integer; end; function TDHelper.AsInt:Integer; begin Result:=Ord(Self); end; var d:TD; begin d:=B; __p(__vs(d.AsInt)); __vybeCheck('1');
end.
