// vybe-test: pascal/helpers_extended/record_helper_adds_method_to_record
...
end; type TPoint=record X,Y:Integer; end; TPointHelper=record helper for TPoint function Sum:Integer; end; function TPointHelper.Sum:Integer; begin Result:=X+Y; end; var p:TPoint; begin p.X:=2; p.Y:=3; __p(__vs(p.Sum)); __vybeCheck('5');
end.
