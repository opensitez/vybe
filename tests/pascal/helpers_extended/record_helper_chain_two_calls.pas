// vybe-test: pascal/helpers_extended/record_helper_chain_two_calls
// origin: languages/pascal/tests/pascal/test_helpers_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TR=record V:Integer; end; TRHelper=record helper for TR function IncV:TR; function DoubleV:TR; end; function TRHelper.IncV:TR; begin Result:=Self; Result.V:=V+1; end; function TRHelper.DoubleV:TR; begin Result:=Self; Result.V:=V*2; end; var r:TR; begin r.V:=3; r:=r.IncV.DoubleV; __p(__vs(r.V)); __vybeCheck('8');
end.
