// vybe-test: pascal/helpers_extended/class_helper_on_custom_class
...
end; type TBox=class public Value:Integer; end; TBoxHelper=class helper for TBox procedure Print; end; procedure TBoxHelper.Print; begin __p(__vs(Value)); end; var b:TBox; begin b:=TBox.Create; b.Value:=77; b.Print; b.Free; __vybeCheck('77');
end.
