// vybe-test: pascal/helpers_extended/set_helper_contains_all_bits
...
end; type TSetHelper=record helper for set of Byte function Count:Integer; end; function TSetHelper.Count:Integer; var b:Byte; begin Result:=0; for b in Self do Inc(Result); end; var s:set of Byte; begin s:=[1,2,3]; __p(__vs(s.Count)); __vybeCheck('3');
end.
