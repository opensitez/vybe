// vybe-test: pascal/helpers_extended/double_helper_abs_value
...
end; type TDoubleHelper=record helper for Double function AbsVal:Double; end; function TDoubleHelper.AbsVal:Double; begin if Self<0 then Result:=-Self else Result:=Self; end; var d:Double; begin d:=-2.5; __p(__vs(d.AbsVal)); __vybeCheck('2.5');
end.
