// vybe-test: pascal/helpers_extended/integer_helper_clamp_range
...
end; type TIntHelper=record helper for Integer function Clamp(lo,hi:Integer):Integer; end; function TIntHelper.Clamp(lo,hi:Integer):Integer; begin if Self<lo then Result:=lo else if Self>hi then Result:=hi else Result:=Self; end; var n:Integer; begin n:=15; __p(__vs(n.Clamp(0,10))); __vybeCheck('10');
end.
