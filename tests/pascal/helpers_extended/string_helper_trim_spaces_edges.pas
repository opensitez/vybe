// vybe-test: pascal/helpers_extended/string_helper_trim_spaces_edges
...
end; type TStrHelper=record helper for String function Trimmed:string; end; function TStrHelper.Trimmed:string; begin Result:=Trim(Self); end; var s:string; begin s:='  hi  '; __p(__vs(s.Trimmed)); __vybeCheck('hi');
end.
