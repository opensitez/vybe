// vybe-test: pascal/pascal_xml_document_parsing/test_xmldocument_attribute_count_and_query
...
begin
  ...
  __p(__vs(node.AttributeNodes.Count));
  __p(__vs(node.Attributes['k1']));
  __p(__vs(node.Attributes['k2']));
__vybeCheck('2' + #10 + 'v1' + #10 + 'v2');
end.
