// vybe-test: pascal/pascal_xml_document_parsing/test_xmldocument_childnodes_count_and_iteration
// origin: languages/pascal/tests/pascal/test_pascal_xml_document_parsing.rs
program Test;
{$mode delphi}
...
begin
  ...
  __p(__vs(doc.DocumentElement.ChildNodes.Count));
  for i := 0 to doc.DocumentElement.ChildNodes.Count - 1 do
    __p(__vs(doc.DocumentElement.ChildNodes[i].NodeName));
__vybeCheck('2' + #10 + 'item1' + #10 + 'item2');
end.
