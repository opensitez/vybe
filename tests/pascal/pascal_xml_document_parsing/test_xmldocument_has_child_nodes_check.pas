// vybe-test: pascal/pascal_xml_document_parsing/test_xmldocument_has_child_nodes_check
...
begin
  ...
  __p(__vs(doc.DocumentElement.HasChildNodes));
  __p(__vs(doc.DocumentElement.ChildNodes['child'].HasChildNodes));
