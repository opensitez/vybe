// vybe-test: pascal/pascal_xml_document_parsing/test_xmldocument_clone_node
...
begin
  ...
  __p(__vs(clonedNode.Text));
  __p(__vs(clonedNode.Attributes['id']));
__vybeCheck('Original' + #10 + '1');
end.
