// vybe-test: pascal/collections_maps/record_dictionary_two_keys
...
end; type TDict=record K1,K2:Integer; end; var d:TDict; begin d.K1:=10; d.K2:=20; __p(__vs(d.K1+d.K2)); __vybeCheck('30');
end.
