// vybe-test: pascal/collections_maps/sorted_insert_position_linear
...
end; function PosFor(const a:array of Integer; v:Integer):Integer; var i:Integer; begin Result:=High(a)+1; for i:=Low(a) to High(a) do if a[i]>v then begin Result:=i; Exit; end; end; begin __p(__vs(PosFor([1,3,5],4))); __vybeCheck('2');
end.
