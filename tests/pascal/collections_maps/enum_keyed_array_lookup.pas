// vybe-test: pascal/collections_maps/enum_keyed_array_lookup
...
end; type TK=(A,B,C); var m:array[TK] of Integer; k:TK; begin m[A]:=1; m[B]:=2; m[C]:=3; for k:=A to C do __p(__vs(m[k])); __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
