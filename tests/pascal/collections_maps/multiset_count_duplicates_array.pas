// vybe-test: pascal/collections_maps/multiset_count_duplicates_array
...
end; var a:array of Integer; i,c:Integer; begin a:=[1,1,2]; c:=0; for i:=0 to High(a) do if a[i]=1 then Inc(c); __p(__vs(c)); __vybeCheck('2');
end.
