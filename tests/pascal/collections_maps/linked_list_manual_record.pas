// vybe-test: pascal/collections_maps/linked_list_manual_record
...
end; type TNode=record V:Integer; Next:Integer; end; var nodes:array[0..1] of TNode; begin nodes[0].V:=1; nodes[0].Next:=1; nodes[1].V:=2; nodes[1].Next:=-1; __p(__vs(nodes[0].V)); __p(__vs(nodes[nodes[0].Next].V)); __vybeCheck('1' + #10 + '2');
end.
