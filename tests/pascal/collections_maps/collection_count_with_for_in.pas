// vybe-test: pascal/collections_maps/collection_count_with_for_in
...
end; var a:array of Integer; x,c:Integer; begin a:=[4,5,6]; c:=0; for x in a do Inc(c); __p(__vs(c)); __vybeCheck('3');
end.
