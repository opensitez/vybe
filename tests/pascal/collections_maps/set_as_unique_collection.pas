// vybe-test: pascal/collections_maps/set_as_unique_collection
...
end; var seen:set of Integer; n:Integer; c:Integer; begin seen:=[1,2,3]; c:=0; for n in seen do Inc(c); __p(__vs(c)); __vybeCheck('3');
end.
