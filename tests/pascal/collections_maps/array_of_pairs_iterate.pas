// vybe-test: pascal/collections_maps/array_of_pairs_iterate
...
end; type TPair=record K:string; V:Integer; end; var p:array[0..1] of TPair; i:Integer; s:Integer; begin p[0].K:='x'; p[0].V:=1; p[1].K:='y'; p[1].V:=2; s:=0; for i:=0 to 1 do s:=s+p[i].V; __p(__vs(s)); __vybeCheck('3');
end.
