// vybe-test: pascal/collections_maps/generic_key_value_box
...
end; type TKV<K,V>=record Key:K; Value:V; end; var e:TKV<string,Integer>; begin e.Key:='id'; e.Value:=42; __p(__vs(e.Value)); __vybeCheck('42');
end.
