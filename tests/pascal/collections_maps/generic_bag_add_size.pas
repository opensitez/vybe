// vybe-test: pascal/collections_maps/generic_bag_add_size
// origin: languages/pascal/tests/pascal/test_collections_maps.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TBag<T>=class private F:array of T; public procedure Add(v:T); function Size:Integer; end; procedure TBag<T>.Add(v:T); var n:Integer; begin n:=Length(F); SetLength(F,n+1); F[n]:=v; end; function TBag<T>.Size:Integer; begin Result:=Length(F); end; var b:TBag<Integer>; begin b:=TBag<Integer>.Create; b.Add(1); b.Add(2); __p(__vs(b.Size)); b.Free; __vybeCheck('2');
end.
