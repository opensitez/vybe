// vybe-test: pascal/collections_maps/map_update_existing_key
...
end; type TEntry=record Key:string; Value:Integer; end; var items:array[0..0] of TEntry; procedure Put(k:string; v:Integer); begin items[0].Key:=k; items[0].Value:=v; end; begin Put('x',1); Put('x',9); __p(__vs(items[0].Value)); __vybeCheck('9');
end.
