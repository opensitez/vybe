// vybe-test: pascal/collections_maps/collection_filter_to_new_array
...
end; var src,dst:array of Integer; i,n:Integer; begin src:=[1,2,3,4]; n:=0; for i:=0 to High(src) do if src[i] mod 2=0 then begin SetLength(dst,n+1); dst[n]:=src[i]; Inc(n); end; __p(__vs(dst[0])); __p(__vs(dst[1])); __vybeCheck('2' + #10 + '4');
end.
