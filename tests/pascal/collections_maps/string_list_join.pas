// vybe-test: pascal/collections_maps/string_list_join
...
end; var parts:array of string; i:Integer; s:string; begin parts:=['a','b','c']; s:=''; for i:=0 to High(parts) do s:=s+parts[i]; __p(__vs(s)); __vybeCheck('abc');
end.
