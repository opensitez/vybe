// vybe-test: pascal/collections_maps/dynamic_array_as_list_append
...
end; var a:array of Integer; begin SetLength(a,1); a[0]:=1; SetLength(a,2); a[1]:=2; __p(__vs(a[0]+a[1])); __vybeCheck('3');
end.
