// vybe-test: pascal/pascal_thread_synchronization_primitives/test_thread_queue_asynchronous_dispatch
...
begin
  ...
  t.WaitFor;
  t.Free;
__vybeCheck('QueuedWorkCompleted');
end.
