// vybe-test: pascal/pascal_thread_synchronization_primitives/test_thread_tcriticalsection_enter_leave
// origin: languages/pascal/tests/pascal/test_pascal_thread_synchronization_primitives.rs
program Test;
{$mode delphi}
...
begin
  ...
  cs.Enter;
  try
    __p(__vs('CriticalSectionEntered'));
  finally
    cs.Leave;
  end;
  cs.Free;
__vybeCheck('CriticalSectionEntered');
end.
