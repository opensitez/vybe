// vybe-test: pascal/pascal_comparer_equality_comparer/test_float_comparer_with_tolerance
...
begin
  ...
  __p(__vs(cmp.Compare(1.0001, 1.0002) = 0));
  __p(__vs(cmp.Compare(1.0, 2.0) < 0));
