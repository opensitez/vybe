// vybe-test: pascal/pascal_comparer_equality_comparer/test_gethashcode_integer_default
// origin: languages/pascal/tests/pascal/test_pascal_comparer_equality_comparer.rs
program Test;
{$mode delphi}
...
begin
  ...
  __p(__vs(eq.GetHashCode(100) = eq.GetHashCode(100)));
  __p(__vs(eq.GetHashCode(100) <> eq.GetHashCode(200)));
