// vybe-test: pascal/pascal_comparer_equality_comparer/test_tcomparer_default_integer_compare
...
begin
  ...
  __p(__vs(cmp.Compare(10, 20) < 0));
  __p(__vs(cmp.Compare(20, 10) > 0));
  __p(__vs(cmp.Compare(15, 15) = 0));
