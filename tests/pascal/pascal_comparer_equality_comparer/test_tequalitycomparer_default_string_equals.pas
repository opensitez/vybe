// vybe-test: pascal/pascal_comparer_equality_comparer/test_tequalitycomparer_default_string_equals
...
begin
  ...
  __p(__vs(eq.Equals('hello', 'hello')));
  __p(__vs(eq.Equals('hello', 'world')));
