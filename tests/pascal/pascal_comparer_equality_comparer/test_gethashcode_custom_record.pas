// vybe-test: pascal/pascal_comparer_equality_comparer/test_gethashcode_custom_record
...
begin
  ...
  pt1.X := 10; pt1.Y := 20;
  pt2.X := 10; pt2.Y := 20;
  __p(__vs(eq.Equals(pt1, pt2)));
  __p(__vs(eq.GetHashCode(pt1) = eq.GetHashCode(pt2)));
