// vybe-test: pascal/operators/chained_range_check_with_and
// origin: languages/pascal/tests/pascal/test_operators.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var n: Integer; begin n := 5; __p(__vs((n > 1) and (n < 10))); __vybeCheck('true');
end.
