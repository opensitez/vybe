// vybe-test: pascal/bool_logic_extra/for_with_bool_break
// origin: languages/pascal/tests/pascal/test_bool_logic_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var i:Integer; done:Boolean; begin done:=false; for i:=1 to 5 do if not done then begin if i=3 then done:=true else __p(__vs(i)); end; __vybeCheck('1' + #10 + '2');
end.
