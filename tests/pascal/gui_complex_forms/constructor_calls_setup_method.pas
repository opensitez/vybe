// vybe-test: pascal/gui_complex_forms/constructor_calls_setup_method
// origin: languages/pascal/tests/pascal/gui_complex_forms.rs
program Test;
{$mode delphi}
uses SysUtils;
...
var f: TForm1;
begin f := TForm1.Create; __p(__vs(f.GetTitle)); __p(__vs(f.FW)); __vybeCheck('Default' + #10 + '800');
end.
