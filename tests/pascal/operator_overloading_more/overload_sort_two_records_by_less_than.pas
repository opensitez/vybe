// vybe-test: pascal/operator_overloading_more/overload_sort_two_records_by_less_than
// origin: languages/pascal/tests/pascal/test_operator_overloading_more.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  a.N := 30; b.N := 12;
  if b < a then __p(__vs(b.N)) else __p(__vs(a.N));
  if a > b then __p(__vs(a.N)) else __p(__vs(b.N));
__vybeCheck('12' + #10 + '30');
end.
