// vybe-test: pascal/real_numeric_extra/currency_trunc_sum_11
// origin: languages/pascal/tests/pascal/test_real_numeric_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var a,b:Currency; begin a:=11.10; b:=11.20; __p(__vs(Trunc(a+b))); __vybeCheck('22');
end.
