// vybe-test: pascal/control_flow_extra/nested_if_blocks_multiple_statements
...
end; var x:Integer; begin x:=2; if x>1 then begin if x<5 then begin __p(__vs('a')); __p(__vs('b')); end; end; __vybeCheck('a' + #10 + 'b');
end.
