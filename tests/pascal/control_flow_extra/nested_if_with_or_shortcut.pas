// vybe-test: pascal/control_flow_extra/nested_if_with_or_shortcut
...
end; var x:Integer; begin x:=0; if x=0 then if (x=1) or (x=0) then __p(__vs('zero')); __vybeCheck('zero');
end.
