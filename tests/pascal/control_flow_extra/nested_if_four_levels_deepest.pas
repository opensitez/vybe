// vybe-test: pascal/control_flow_extra/nested_if_four_levels_deepest
...
end; var v:Integer; begin v:=4; if v>0 then if v>1 then if v>2 then if v>3 then __p(__vs('4')) else __p(__vs('3')); __vybeCheck('4');
end.
