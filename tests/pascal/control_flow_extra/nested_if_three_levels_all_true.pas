// vybe-test: pascal/control_flow_extra/nested_if_three_levels_all_true
// origin: languages/pascal/tests/pascal/test_control_flow_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var x:Integer; begin x:=9; if x>0 then if x>5 then if x>8 then __p(__vs('deep')) else __p(__vs('mid')) else __p(__vs('shallow')); __vybeCheck('deep');
end.
