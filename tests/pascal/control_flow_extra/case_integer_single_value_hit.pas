// vybe-test: pascal/control_flow_extra/case_integer_single_value_hit
...
end; var n:Integer; begin n:=4; case n of 2: __p(__vs('two')); 4: __p(__vs('four')); else __p(__vs('other')); end; __vybeCheck('four');
end.
