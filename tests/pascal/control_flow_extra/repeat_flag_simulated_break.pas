// vybe-test: pascal/control_flow_extra/repeat_flag_simulated_break
...
end; var i,st:Integer; begin i:=0; st:=0; repeat Inc(i); if i=3 then st:=1; until st=1; __p(__vs(i)); __vybeCheck('3');
end.
