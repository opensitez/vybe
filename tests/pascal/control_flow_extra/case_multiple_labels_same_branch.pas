// vybe-test: pascal/control_flow_extra/case_multiple_labels_same_branch
...
end; var n:Integer; begin n:=3; case n of 1,3,5: __p(__vs('odd')); 2,4,6: __p(__vs('even')); end; __vybeCheck('odd');
end.
