// vybe-test: pascal/control_flow_extra/case_inside_if_true_guard
...
end; var n:Integer; begin n:=2; if n>0 then case n of 1: __p(__vs('one')); 2: __p(__vs('two')); end; __vybeCheck('two');
end.
