// vybe-test: pascal/control_flow_extra/repeat_until_outer_wraps_if
...
end; var n:Integer; begin n:=0; repeat Inc(n); if n=3 then __p(__vs('hit')); until n>=3; __vybeCheck('hit');
end.
