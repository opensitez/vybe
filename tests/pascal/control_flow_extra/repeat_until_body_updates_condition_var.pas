// vybe-test: pascal/control_flow_extra/repeat_until_body_updates_condition_var
...
end; var a,b:Integer; begin a:=1; b:=10; repeat b:=b-a; until b<=0; __p(__vs(b)); __vybeCheck('0');
end.
