// vybe-test: pascal/control_flow_extra/repeat_until_xor_two_flags
...
end; var a,b:Integer; begin a:=0; b:=1; repeat Inc(a); until (a>2) xor (b=0); __p(__vs(a)); __vybeCheck('3');
end.
