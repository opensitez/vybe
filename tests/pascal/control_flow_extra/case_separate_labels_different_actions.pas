// vybe-test: pascal/control_flow_extra/case_separate_labels_different_actions
...
end; var n:Integer; begin n:=2; case n of 1: __p(__vs('one')); 2: __p(__vs('two')); 3: __p(__vs('three')); end; __vybeCheck('two');
end.
