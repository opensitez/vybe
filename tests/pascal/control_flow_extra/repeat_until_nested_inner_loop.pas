// vybe-test: pascal/control_flow_extra/repeat_until_nested_inner_loop
...
end; var i,j,s:Integer; begin s:=0; i:=0; repeat Inc(i); j:=0; repeat Inc(j); s:=s+1; until j=2; until i=2; __p(__vs(s)); __vybeCheck('4');
end.
