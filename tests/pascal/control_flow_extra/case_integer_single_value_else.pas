// vybe-test: pascal/control_flow_extra/case_integer_single_value_else
...
end; var n:Integer; begin n:=99; case n of 1: __p(__vs('one')); 2: __p(__vs('two')); else __p(__vs('else')); end; __vybeCheck('else');
end.
