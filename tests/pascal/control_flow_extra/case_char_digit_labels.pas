// vybe-test: pascal/control_flow_extra/case_char_digit_labels
...
end; var c:Char; begin c:='5'; case c of '0','1','2','3','4': __p(__vs('low')); '5','6','7','8','9': __p(__vs('five-plus')); end; __vybeCheck('five-plus');
end.
