// vybe-test: pascal/control_flow_extra/repeat_until_with_begin_block_sum
...
end; var n,s:Integer; begin n:=0; s:=0; repeat begin Inc(n); s:=s+n; end; until n=4; __p(__vs(s)); __vybeCheck('10');
end.
