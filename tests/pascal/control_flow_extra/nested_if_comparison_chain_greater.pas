// vybe-test: pascal/control_flow_extra/nested_if_comparison_chain_greater
...
end; var n:Integer; begin n:=50; if n>10 then if n>20 then if n>30 then __p(__vs('high')); __vybeCheck('high');
end.
