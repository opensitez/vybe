// vybe-test: pascal/control_flow_extra/case_inside_repeat_loop
...
end; var i:Integer; begin i:=0; repeat Inc(i); case i of 1: __p(__vs('a')); 2: __p(__vs('b')); end; until i=2; __vybeCheck('a' + #10 + 'b');
end.
