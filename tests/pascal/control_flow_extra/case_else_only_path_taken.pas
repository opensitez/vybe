// vybe-test: pascal/control_flow_extra/case_else_only_path_taken
...
end; var n:Integer; begin n:=100; case n of 1: __p(__vs('one')); else __p(__vs('fallback')); end; __vybeCheck('fallback');
end.
