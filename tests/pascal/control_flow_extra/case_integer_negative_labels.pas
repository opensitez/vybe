// vybe-test: pascal/control_flow_extra/case_integer_negative_labels
...
end; var n:Integer; begin n:=-3; case n of -1: __p(__vs('a')); -3: __p(__vs('b')); else __p(__vs('c')); end; __vybeCheck('b');
end.
