// vybe-test: pascal/control_flow_extra/repeat_until_sum_exceeds_threshold
...
end; var k,s:Integer; begin k:=0; s:=0; repeat Inc(k); s:=s+k; until s>20; __p(__vs(k)); __vybeCheck('6');
end.
