// vybe-test: pascal/control_flow_extra/case_char_no_match_falls_else
...
end; var c:Char; begin c:='q'; case c of 'a': __p(__vs('a')); 'b': __p(__vs('b')); else __p(__vs('other')); end; __vybeCheck('other');
end.
