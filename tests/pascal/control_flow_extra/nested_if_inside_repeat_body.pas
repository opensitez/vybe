// vybe-test: pascal/control_flow_extra/nested_if_inside_repeat_body
...
end; var i:Integer; begin i:=0; repeat Inc(i); if i=2 then __p(__vs('two')); until i=3; __vybeCheck('two');
end.
