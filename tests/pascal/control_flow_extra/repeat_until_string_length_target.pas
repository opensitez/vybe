// vybe-test: pascal/control_flow_extra/repeat_until_string_length_target
...
end; var s:string; begin s:=''; repeat s:=s+'*'; until Length(s)=6; __p(__vs(Length(s))); __vybeCheck('6');
end.
