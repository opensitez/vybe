// vybe-test: pascal/control_flow_extra/nested_if_outer_false_skips_inner
...
end; var x:Integer; begin x:=-1; if x>0 then if x>5 then __p(__vs('a')) else __p(__vs('b')) else __p(__vs('c')); __vybeCheck('c');
end.
