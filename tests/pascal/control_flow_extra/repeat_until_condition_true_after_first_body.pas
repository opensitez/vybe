// vybe-test: pascal/control_flow_extra/repeat_until_condition_true_after_first_body
...
end; var done:Boolean; begin done:=false; repeat done:=true; until done; __p(__vs('ok')); __vybeCheck('ok');
end.
