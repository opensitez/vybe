// vybe-test: pascal/control_flow_extra/nested_if_middle_branch_false
...
end; var x:Integer; begin x:=3; if x>0 then if x>5 then __p(__vs('a')) else __p(__vs('b')) else __p(__vs('c')); __vybeCheck('b');
end.
