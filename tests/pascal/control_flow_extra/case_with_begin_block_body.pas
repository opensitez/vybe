// vybe-test: pascal/control_flow_extra/case_with_begin_block_body
...
end; var n:Integer; begin n:=1; case n of 1: begin __p(__vs('a')); __p(__vs('b')); end; end; __vybeCheck('a' + #10 + 'b');
end.
