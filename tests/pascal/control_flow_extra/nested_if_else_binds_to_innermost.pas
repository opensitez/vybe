// vybe-test: pascal/control_flow_extra/nested_if_else_binds_to_innermost
...
end; var n:Integer; begin n:=2; if n>0 then if n=1 then __p(__vs('one')) else __p(__vs('not-one')); __vybeCheck('not-one');
end.
