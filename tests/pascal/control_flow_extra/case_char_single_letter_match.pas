// vybe-test: pascal/control_flow_extra/case_char_single_letter_match
...
end; var c:Char; begin c:='k'; case c of 'a': __p(__vs('a')); 'k': __p(__vs('k')); else __p(__vs('z')); end; __vybeCheck('k');
end.
