// vybe-test: pascal/control_flow_extra/nested_if_with_and_condition
...
end; var a,b:Integer; begin a:=3; b:=4; if a>0 then if (a<5) and (b>3) then __p(__vs('yes')); __vybeCheck('yes');
end.
