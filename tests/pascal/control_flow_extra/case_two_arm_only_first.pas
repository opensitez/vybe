// vybe-test: pascal/control_flow_extra/case_two_arm_only_first
...
end; var n:Integer; begin n:=1; case n of 1: __p(__vs('first')); 2: __p(__vs('second')); end; __vybeCheck('first');
end.
