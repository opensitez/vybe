// vybe-test: pascal/edge_cases/scope_local_shadows_global
// origin: languages/pascal/tests/pascal/test_edge_cases.rs
program T;
{$mode delphi}
uses SysUtils;
...
procedure Test; var x: Integer; begin x := 99; __p(__vs(x)); end;
begin x := 1; Test; __p(__vs(x)); __vybeCheck('99' + #10 + '1');
end.
