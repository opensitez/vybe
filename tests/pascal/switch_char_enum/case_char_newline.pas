// vybe-test: pascal/switch_char_enum/case_char_newline
...
end; var c:Char; begin c:=#10; case c of #10:__p(__vs('nl')); #13:__p(__vs('cr')); else __p(__vs('x')); end; __vybeCheck('nl');
end.
