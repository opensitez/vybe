// vybe-test: pascal/switch_char_enum/case_enum_nested_in_if
...
end; type TMode=(Read,Write,Append); var m:TMode; begin m:=Write; if m=Write then case m of Read:__p(__vs('r')); Write:__p(__vs('w')); Append:__p(__vs('a')); end; __vybeCheck('w');
end.
