// vybe-test: pascal/switch_char_enum/case_enum_last_member
...
end; type T=(Alpha,Beta,Gamma); var x:T; begin x:=Gamma; case x of Alpha:__p(__vs(0)); Beta:__p(__vs(1)); Gamma:__p(__vs(Ord(x))); end; __vybeCheck('2');
end.
