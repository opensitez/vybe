// vybe-test: pascal/switch_char_enum/case_enum_in_for_dispatch
...
end; type T=(On,Off); var s:T; begin s:=On; case s of On:__p(__vs('1')); Off:__p(__vs('0')); end; s:=Off; case s of On:__p(__vs('1')); Off:__p(__vs('0')); end; __vybeCheck('1' + #10 + '0');
end.
