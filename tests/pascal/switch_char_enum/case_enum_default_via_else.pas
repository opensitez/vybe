// vybe-test: pascal/switch_char_enum/case_enum_default_via_else
...
end; type TOp=(Add,Sub,Mul,Div); var o:TOp; begin o:=Div; case o of Add:__p(__vs('+')); Sub:__p(__vs('-')); else __p(__vs('other')); end; __vybeCheck('other');
end.
