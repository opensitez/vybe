// vybe-test: pascal/switch_char_enum/case_enum_first_ordinal
...
end; type T=(Alpha,Beta,Gamma); var x:T; begin x:=Alpha; case x of Alpha:__p(__vs(Ord(x))); Beta:__p(__vs(1)); Gamma:__p(__vs(2)); end; __vybeCheck('0');
end.
