// vybe-test: pascal/switch_char_enum/case_enum_scoped_style
...
end; type TStatus=(Idle,Running,Done); var s:TStatus; begin s:=Running; case s of Idle:__p(__vs('i')); Running:__p(__vs('run')); Done:__p(__vs('d')); end; __vybeCheck('run');
end.
