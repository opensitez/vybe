// vybe-test: pascal/switch_char_enum/case_char_comma_list
...
end; var c:Char; begin c:='x'; case c of 'a','e','i','o','u': __p(__vs('vowel')); else __p(__vs('cons')); end; __vybeCheck('cons');
end.
