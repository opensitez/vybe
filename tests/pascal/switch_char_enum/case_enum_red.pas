// vybe-test: pascal/switch_char_enum/case_enum_red
...
end; type TColor=(Red,Green,Blue); var c:TColor; begin c:=Red; case c of Red:__p(__vs('r')); Green:__p(__vs('g')); Blue:__p(__vs('b')); end; __vybeCheck('r');
end.
