// vybe-test: pascal/switch_char_enum/case_enum_pair_group_a
...
end; type T=(A,B,C,D); var v:T; begin v:=B; case v of A,B:__p(__vs('ab')); C,D:__p(__vs('cd')); end; __vybeCheck('ab');
end.
