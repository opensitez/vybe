// vybe-test: pascal/switch_char_enum/case_char_with_else
...
end; var c:Char; begin c:='q'; case c of 'a'..'d':__p(__vs('ad')); 'e'..'h':__p(__vs('eh')); else __p(__vs('rest')); end; __vybeCheck('rest');
end.
