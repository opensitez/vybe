// vybe-test: pascal/switch_char_enum/case_char_single_a
...
end; var c:Char; begin c:='a'; case c of 'a': __p(__vs('alpha')); 'b': __p(__vs('beta')); else __p(__vs('?')); end; __vybeCheck('alpha');
end.
