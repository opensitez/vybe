// vybe-test: pascal/switch_char_enum/case_enum_comma_list
...
end; type TDay=(Mon,Tue,Wed,Thu,Fri,Sat,Sun); var d:TDay; begin d:=Fri; case d of Mon,Tue,Wed,Thu,Fri:__p(__vs('weekday')); Sat,Sun:__p(__vs('weekend')); end; __vybeCheck('weekday');
end.
