// vybe-test: pascal/switch_char_enum/case_char_gap_value
...
end; var c:Char; begin c:='3'; case c of '0'..'2','4'..'6','8'..'9':__p(__vs('grp')); else __p(__vs('gap')); end; __vybeCheck('gap');
end.
