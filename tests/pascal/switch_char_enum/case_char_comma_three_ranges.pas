// vybe-test: pascal/switch_char_enum/case_char_comma_three_ranges
...
end; var c:Char; begin c:='2'; case c of '0'..'2','4'..'6','8'..'9':__p(__vs('grp')); else __p(__vs('gap')); end; __vybeCheck('grp');
end.
