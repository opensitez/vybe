// vybe-test: pascal/switch_char_enum/case_enum_three_way
...
end; type TSize=(Small,Medium,Large); var s:TSize; begin s:=Large; case s of Small:__p(__vs('s')); Medium:__p(__vs('m')); Large:__p(__vs('l')); end; __vybeCheck('l');
end.
