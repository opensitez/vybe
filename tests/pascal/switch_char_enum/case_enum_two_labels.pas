// vybe-test: pascal/switch_char_enum/case_enum_two_labels
// origin: languages/pascal/tests/pascal/test_switch_char_enum.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TSuit=(Clubs,Diamonds,Hearts,Spades); var s:TSuit; begin s:=Hearts; case s of Clubs,Diamonds:__p(__vs('red0')); Hearts,Spades:__p(__vs('black0')); end; __vybeCheck('black0');
end.
