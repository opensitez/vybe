// vybe-test: pascal/switch_char_enum/case_char_vowel_e
...
end; var c:Char; begin c:='e'; case c of 'a','e','i','o','u': __p(__vs('vowel')); else __p(__vs('cons')); end; __vybeCheck('vowel');
end.
