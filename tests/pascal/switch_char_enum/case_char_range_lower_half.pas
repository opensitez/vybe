// vybe-test: pascal/switch_char_enum/case_char_range_lower_half
...
end; var c:Char; begin c:='f'; case c of 'a'..'m': __p(__vs('first')); 'n'..'z': __p(__vs('second')); end; __vybeCheck('first');
end.
