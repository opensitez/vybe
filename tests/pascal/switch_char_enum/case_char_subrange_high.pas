// vybe-test: pascal/switch_char_enum/case_char_subrange_high
...
end; type TDigit='0'..'9'; var d:TDigit; begin d:='8'; case d of '0'..'4':__p(__vs('low')); '5'..'9':__p(__vs('high')); end; __vybeCheck('high');
end.
