// vybe-test: pascal/switch_char_enum/case_char_mixed_list_range
...
end; var c:Char; begin c:='b'; case c of 'a','c'..'e':__p(__vs('hit')); else __p(__vs('miss')); end; __vybeCheck('hit');
end.
