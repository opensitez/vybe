// vybe-test: pascal/switch_char_enum/case_enum_ordinal_based
...
end; type TLevel=(Low,Med,High); var l:TLevel; begin l:=Med; case l of Low:__p(__vs('1')); Med:__p(__vs('2')); High:__p(__vs('3')); end; __vybeCheck('2');
end.
