// vybe-test: pascal/switch_char_enum/case_enum_else_branch
...
end; type TDir=(N,E,S,W); var d:TDir; begin d:=W; case d of N:__p(__vs('n')); E:__p(__vs('e')); else __p(__vs('other')); end; __vybeCheck('other');
end.
