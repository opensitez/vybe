// vybe-test: pascal/pascal_conditional_compilation_directives/test_cond_boolean_or_expression
...
begin
  ...
  __p(__vs('AtLeastOneFlagActive'));
  {$ENDIF}
__vybeCheck('AtLeastOneFlagActive');
end.
