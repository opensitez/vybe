// vybe-test: pascal/pascal_conditional_compilation_directives/test_cond_hints_warnings_directives
// origin: languages/pascal/tests/pascal/test_pascal_conditional_compilation_directives.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs('DirectivesProcessed'));
__vybeCheck('DirectivesProcessed');
end.
