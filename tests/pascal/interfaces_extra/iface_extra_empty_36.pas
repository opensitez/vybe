// vybe-test: pascal/interfaces_extra/iface_extra_empty_36
...
end; type IEmpty=interface end; TObj=class(TInterfacedObject,IEmpty) public Tag:Integer; end; var o:TObj; begin o:=TObj.Create; o.Tag:=36; __p(__vs(o.Tag)); __vybeCheck('36');
end.
