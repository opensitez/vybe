// vybe-test: pascal/interfaces_extra/iface_extra_dual_21
...
end; type IA=interface procedure A; end; IB=interface procedure B; end; TBoth=class(TInterfacedObject,IA,IB) procedure A; procedure B; end; procedure TBoth.A; begin __p(__vs('A21')); end; procedure TBoth.B; begin __p(__vs('B21')); end; var a:IA; b:IB; begin a:=TBoth.Create; b:=TBoth(a); a.A; b.B; __vybeCheck('A21' + #10 + 'B21');
end.
