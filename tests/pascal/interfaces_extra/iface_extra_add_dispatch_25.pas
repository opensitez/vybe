// vybe-test: pascal/interfaces_extra/iface_extra_add_dispatch_25
...
end; type ICalc=interface function Add(a,b:Integer):Integer; end; TImpl=class(TInterfacedObject,ICalc) function Add(a,b:Integer):Integer; end; function TImpl.Add(a,b:Integer):Integer; begin Result:=a+b+25; end; var c:ICalc; begin c:=TImpl.Create; __p(__vs(c.Add(25,1))); __vybeCheck('51');
end.
