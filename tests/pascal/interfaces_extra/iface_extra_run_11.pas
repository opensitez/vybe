// vybe-test: pascal/interfaces_extra/iface_extra_run_11
...
end; type IRun=interface procedure Run(v:Integer); end; TRunner=class(TInterfacedObject,IRun) procedure Run(v:Integer); end; procedure TRunner.Run(v:Integer); begin __p(__vs(v+11)); end; var r:IRun; begin r:=TRunner.Create; r.Run(11); __vybeCheck('22');
end.
