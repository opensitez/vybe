// vybe-test: pascal/interfaces_extra/iface_extra_run_17
...
end; type IRun=interface procedure Run(v:Integer); end; TRunner=class(TInterfacedObject,IRun) procedure Run(v:Integer); end; procedure TRunner.Run(v:Integer); begin __p(__vs(v+17)); end; var r:IRun; begin r:=TRunner.Create; r.Run(17); __vybeCheck('34');
end.
