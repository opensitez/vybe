// vybe-test: pascal/interfaces_extra/iface_extra_factory_28
...
end; type IVal=interface function Get:Integer; end; TBox=class(TInterfacedObject,IVal) private F:Integer; public constructor Create(v:Integer); function Get:Integer; end; constructor TBox.Create(v:Integer); begin F:=v; end; function TBox.Get:Integer; begin Result:=F; end; function Make(v:Integer):IVal; begin Result:=TBox.Create(v); end; var iv:IVal; begin iv:=Make(140); __p(__vs(iv.Get)); __vybeCheck('140');
end.
