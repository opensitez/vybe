// vybe-test: pascal/interfaces_extra/iface_extra_dual_9
...
end; type IA=interface procedure A; end; IB=interface procedure B; end; TBoth=class(TInterfacedObject,IA,IB) procedure A; procedure B; end; procedure TBoth.A; begin __p(__vs('A9')); end; procedure TBoth.B; begin __p(__vs('B9')); end; var a:IA; b:IB; begin a:=TBoth.Create; b:=TBoth(a); a.A; b.B; __vybeCheck('A9' + #10 + 'B9');
end.
