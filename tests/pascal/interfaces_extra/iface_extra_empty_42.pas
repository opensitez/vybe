// vybe-test: pascal/interfaces_extra/iface_extra_empty_42
...
end; type IEmpty=interface end; TObj=class(TInterfacedObject,IEmpty) public Tag:Integer; end; var o:TObj; begin o:=TObj.Create; o.Tag:=42; __p(__vs(o.Tag)); __vybeCheck('42');
end.
