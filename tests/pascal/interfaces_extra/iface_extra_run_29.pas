// vybe-test: pascal/interfaces_extra/iface_extra_run_29
...
end; type IRun=interface procedure Run(v:Integer); end; TRunner=class(TInterfacedObject,IRun) procedure Run(v:Integer); end; procedure TRunner.Run(v:Integer); begin __p(__vs(v+29)); end; var r:IRun; begin r:=TRunner.Create; r.Run(29); __vybeCheck('58');
end.
