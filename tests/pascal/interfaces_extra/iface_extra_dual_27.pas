// vybe-test: pascal/interfaces_extra/iface_extra_dual_27
// origin: languages/pascal/tests/pascal/test_interfaces_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type IA=interface procedure A; end; IB=interface procedure B; end; TBoth=class(TInterfacedObject,IA,IB) procedure A; procedure B; end; procedure TBoth.A; begin __p(__vs('A27')); end; procedure TBoth.B; begin __p(__vs('B27')); end; var a:IA; b:IB; begin a:=TBoth.Create; b:=TBoth(a); a.A; b.B; __vybeCheck('A27' + #10 + 'B27');
end.
