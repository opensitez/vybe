// vybe-test: pascal/programs5/test_programs5_word_count
...
begin
  __p(__vs(WordCount('hello world')));
  __p(__vs(WordCount('one two three four')));
  __p(__vs(WordCount('  leading spaces')));
__vybeCheck('2' + #10 + '4' + #10 + '2');
end.
