// vybe-test: pascal/programs5/test_programs5_luhn_check
// origin: languages/pascal/tests/pascal/test_programs5.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  if LuhnCheck('4532015112830366') then __p(__vs('valid')) else __p(__vs('invalid'));
  if LuhnCheck('1234567890123456') then __p(__vs('valid')) else __p(__vs('invalid'));
__vybeCheck('valid' + #10 + 'invalid');
end.
