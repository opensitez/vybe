// vybe-test: pascal/pascal_ttextreader_ttextwriter/test_tstreamwriter_protection_finally
// origin: languages/pascal/tests/pascal/test_pascal_ttextreader_ttextwriter.rs
program Test;
{$mode delphi}
...
begin
  ...
  try
    ...
    w.Free;
    ms.Free;
    __p(__vs('StreamWriterFreedInFinally'));
  end;
__vybeCheck('StreamWriterFreedInFinally');
end.
