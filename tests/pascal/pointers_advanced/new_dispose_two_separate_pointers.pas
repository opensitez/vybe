// vybe-test: pascal/pointers_advanced/new_dispose_two_separate_pointers
...
end; var p,q:^Integer; begin New(p); New(q); p^:=1; q^:=2; __p(__vs(p^+q^)); Dispose(p); Dispose(q); __vybeCheck('3');
end.
