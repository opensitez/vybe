// vybe-test: pascal/pointers_advanced/address_of_for_loop_index_var
...
end; var i:Integer; p:^Integer; begin for i:=1 to 1 do begin p:=@i; __p(__vs(p^)); end; __vybeCheck('1');
end.
