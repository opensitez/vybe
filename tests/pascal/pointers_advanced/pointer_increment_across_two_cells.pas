// vybe-test: pascal/pointers_advanced/pointer_increment_across_two_cells
...
end; var a:array[0..1] of Integer; p:^Integer; begin a[0]:=10; a[1]:=20; p:=@a[0]; Inc(p); __p(__vs(p^)); __vybeCheck('20');
end.
