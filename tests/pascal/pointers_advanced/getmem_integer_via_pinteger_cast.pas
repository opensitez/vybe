// vybe-test: pascal/pointers_advanced/getmem_integer_via_pinteger_cast
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=123; __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('123');
end.
