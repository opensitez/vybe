// vybe-test: pascal/pointers_advanced/new_dispose_in_loop_three_times
...
end; var p:^Integer; i,sum:Integer; begin sum:=0; for i:=1 to 3 do begin New(p); p^:=i; sum:=sum+p^; Dispose(p); end; __p(__vs(sum)); __vybeCheck('6');
end.
