// vybe-test: pascal/pointers_advanced/pointer_param_updates_caller_int
...
end; procedure SetTen(p:^Integer); begin p^:=10; end; var x:Integer; begin x:=0; SetTen(@x); __p(__vs(x)); __vybeCheck('10');
end.
