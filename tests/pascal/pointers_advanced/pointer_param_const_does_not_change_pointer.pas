// vybe-test: pascal/pointers_advanced/pointer_param_const_does_not_change_pointer
...
end; procedure Show(p:^Integer); begin __p(__vs(p^)); end; var x:Integer; begin x:=44; Show(@x); __vybeCheck('44');
end.
