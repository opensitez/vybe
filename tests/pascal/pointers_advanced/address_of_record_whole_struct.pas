// vybe-test: pascal/pointers_advanced/address_of_record_whole_struct
...
end; type TR=record A,B:Integer; end; var r:TR; p:^TR; begin r.A:=2; r.B:=3; p:=@r; __p(__vs(p^.A+p^.B)); __vybeCheck('5');
end.
