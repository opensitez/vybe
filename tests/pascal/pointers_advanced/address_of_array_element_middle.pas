// vybe-test: pascal/pointers_advanced/address_of_array_element_middle
...
end; var a:array[0..2] of Integer; p:^Integer; begin a[1]:=42; p:=@a[1]; __p(__vs(p^)); __vybeCheck('42');
end.
