// vybe-test: pascal/pointers_advanced/typed_pointer_to_record_field_via_at
...
end; type TPt=record X,Y:Integer; end; var pt:TPt; px:^Integer; begin pt.Y:=6; px:=@pt.Y; px^:=8; __p(__vs(pt.Y)); __vybeCheck('8');
end.
