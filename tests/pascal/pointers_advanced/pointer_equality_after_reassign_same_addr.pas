// vybe-test: pascal/pointers_advanced/pointer_equality_after_reassign_same_addr
...
end; var x:Integer; p,q:^Integer; begin x:=0; p:=@x; q:=@x; __p(__vs(p=q)); __vybeCheck('true');
end.
