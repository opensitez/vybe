// vybe-test: pascal/pointers_advanced/new_dispose_record_on_heap
...
end; type TR=record V:Integer; end; var p:^TR; begin New(p); p^.V:=99; __p(__vs(p^.V)); Dispose(p); __vybeCheck('99');
end.
