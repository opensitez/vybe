// vybe-test: pascal/pointers_advanced/pointer_passed_through_nested_call
...
end; function Id(p:^Integer):^Integer; begin Result:=p; end; var x:Integer; p:^Integer; begin x:=8; p:=Id(@x); __p(__vs(p^)); __vybeCheck('8');
end.
