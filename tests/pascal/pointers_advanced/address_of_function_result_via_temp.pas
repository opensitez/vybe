// vybe-test: pascal/pointers_advanced/address_of_function_result_via_temp
...
end; function Make:Integer; begin Result:=11; end; var n:Integer; p:^Integer; begin n:=Make; p:=@n; __p(__vs(p^)); __vybeCheck('11');
end.
