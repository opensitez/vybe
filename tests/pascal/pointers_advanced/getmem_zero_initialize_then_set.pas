// vybe-test: pascal/pointers_advanced/getmem_zero_initialize_then_set
...
end; var p:Pointer; begin GetMem(p,SizeOf(Integer)); PInteger(p)^:=0; Inc(PInteger(p)^); __p(__vs(PInteger(p)^)); FreeMem(p); __vybeCheck('1');
end.
