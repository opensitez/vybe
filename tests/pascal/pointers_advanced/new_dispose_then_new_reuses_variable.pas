// vybe-test: pascal/pointers_advanced/new_dispose_then_new_reuses_variable
...
end; var p:^Integer; begin New(p); p^:=1; Dispose(p); New(p); p^:=2; __p(__vs(p^)); Dispose(p); __vybeCheck('2');
end.
