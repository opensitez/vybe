// vybe-test: pascal/pointers_advanced/pointer_to_nested_record_field
// origin: languages/pascal/tests/pascal/test_pointers_advanced.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TInner=record V:Integer; end; TOuter=record N:TInner; end; var o:TOuter; p:^Integer; begin o.N.V:=4; p:=@o.N.V; p^:=5; __p(__vs(o.N.V)); __vybeCheck('5');
end.
