// vybe-test: pascal/pointers_advanced/typed_pointer_in_record_field
...
end; type TWrap=record P:^Integer; end; var x:Integer; w:TWrap; begin x:=9; w.P:=@x; __p(__vs(w.P^)); __vybeCheck('9');
end.
