// vybe-test: pascal/pointers_advanced/function_returns_pointer_to_static
...
end; var G:Integer; function AddrG:^Integer; begin Result:=@G; end; var p:^Integer; begin G:=5; p:=AddrG; p^:=6; __p(__vs(G)); __vybeCheck('6');
end.
