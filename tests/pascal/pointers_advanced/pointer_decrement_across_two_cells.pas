// vybe-test: pascal/pointers_advanced/pointer_decrement_across_two_cells
...
end; var a:array[0..1] of Integer; p:^Integer; begin a[0]:=7; a[1]:=9; p:=@a[1]; Dec(p); __p(__vs(p^)); __vybeCheck('7');
end.
