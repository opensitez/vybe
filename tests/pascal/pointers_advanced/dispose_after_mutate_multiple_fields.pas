// vybe-test: pascal/pointers_advanced/dispose_after_mutate_multiple_fields
...
end; type TR=record A,B:Integer; end; var p:^TR; begin New(p); p^.A:=1; p^.B:=2; __p(__vs(p^.A+p^.B)); Dispose(p); __p(__vs('done')); __vybeCheck('3' + #10 + 'done');
end.
