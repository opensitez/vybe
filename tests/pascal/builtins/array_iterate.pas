// vybe-test: pascal/builtins/array_iterate
// origin: languages/pascal/tests/pascal/test_builtins.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var a: array of Integer; var i: Integer; begin a := [5, 10, 15]; for i := 0 to High(a) do __p(__vs(a[i])); __vybeCheck('5' + #10 + '10' + #10 + '15');
end.
