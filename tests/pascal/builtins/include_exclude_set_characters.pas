// vybe-test: pascal/builtins/include_exclude_set_characters
...
end; var s: set of Char; begin s := ['a']; Include(s, 'b'); Exclude(s, 'a'); if 'b' in s then __p(__vs('b')); __vybeCheck('b');
end.
