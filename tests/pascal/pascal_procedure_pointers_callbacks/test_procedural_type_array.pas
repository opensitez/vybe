// vybe-test: pascal/pascal_procedure_pointers_callbacks/test_procedural_type_array
// origin: languages/pascal/tests/pascal/test_pascal_procedure_pointers_callbacks.rs
program Test;
{$mode delphi}
uses SysUtils;
...
procedure Step1; begin __p(__vs('Step1')); end;
procedure Step2; begin __p(__vs('Step2')); end;
procedure Step3; begin __p(__vs('Step3')); end;
...
begin
  ...
  for i := 1 to 3 do
    steps[i]();
__vybeCheck('Step1' + #10 + 'Step2' + #10 + 'Step3');
end.
