// vybe-test: pascal/pascal_procedure_pointers_callbacks/test_assigned_check_on_procedure_pointer
...
procedure Dummy; begin __p(__vs('Dummy')); end;
var p: TSimpleProc;
begin
  p := nil;
  __p(__vs(Assigned(p)));
  ...
  __p(__vs(Assigned(p)));
  p();
__vybeCheck('False' + #10 + 'True' + #10 + 'Dummy');
end.
