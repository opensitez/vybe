// vybe-test: pascal/type_system_extended/set_union_two_enums
...
end; type TD = (A, B, C); var s1, s2, s3: set of TD; begin s1 := [A]; s2 := [B, C]; s3 := s1 + s2; if A in s3 then __p(__vs('has')); __vybeCheck('has');
end.
