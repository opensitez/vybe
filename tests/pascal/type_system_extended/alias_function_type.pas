// vybe-test: pascal/type_system_extended/alias_function_type
...
end; type TFunc = function(x: Integer): Integer; function Sq(x: Integer): Integer; begin Result := x * x; end; var f: TFunc; begin f := @Sq; __p(__vs(f(6))); __vybeCheck('36');
end.
