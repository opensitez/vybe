// vybe-test: pascal/type_system_extended/subrange_array_index_type
...
end; type TIdx = 1..3; var a: array[TIdx] of Integer; i: TIdx; begin for i := 1 to 3 do a[i] := i; __p(__vs(a[2])); __vybeCheck('2');
end.
