// vybe-test: pascal/type_system_extended/set_of_subrange_type
...
end; type TD = 1..3; var s: set of TD; x: TD; begin s := [1, 3]; x := 2; if x in s then __p(__vs('in')) else __p(__vs('out')); __vybeCheck('out');
end.
