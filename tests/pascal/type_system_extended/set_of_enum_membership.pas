// vybe-test: pascal/type_system_extended/set_of_enum_membership
...
end; type TC = (Red, Green, Blue); var s: set of TC; c: TC; begin s := [Red, Blue]; c := Blue; if c in s then __p(__vs('yes')); __vybeCheck('yes');
end.
