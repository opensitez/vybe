// vybe-test: pascal/type_system_extended/alias_record_type_name
...
end; type TPoint = record X, Y: Integer; end; type TLocation = TPoint; var p: TLocation; begin p.X := 4; p.Y := 5; __p(__vs(p.X + p.Y)); __vybeCheck('9');
end.
