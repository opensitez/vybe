// vybe-test: pascal/type_system_extended/alias_nested_type_reference
...
end; type TId = Integer; type TUser = record Id: TId; end; var u: TUser; begin u.Id := 42; __p(__vs(u.Id)); __vybeCheck('42');
end.
