// vybe-test: pascal/type_system_extended/type_alias_array_of_integer
...
end; type TIntArray = array[0..2] of Integer; var a: TIntArray; begin a[1] := 9; __p(__vs(a[1])); __vybeCheck('9');
end.
