// vybe-test: pascal/type_system_extended/alias_procedure_type
...
end; type TProc = procedure; procedure P; begin __p(__vs('run')); end; var fp: TProc; begin fp := @P; fp(); __vybeCheck('run');
end.
