// vybe-test: pascal/type_system_extended/ordinal_low_high_on_static_array
...
end; var a: array[2..5] of Integer; begin __p(__vs(Low(a))); __p(__vs(High(a))); __vybeCheck('2' + #10 + '5');
end.
