// vybe-test: pascal/pascal_safecall_calling_convention/test_safecall_div_by_zero_exception
...
begin
  ...
  try
    ...
    on E: EDivByZero do __p(__vs('CaughtSafecallDivByZero'));
  end;
__vybeCheck('CaughtSafecallDivByZero');
end.
