// vybe-test: pascal/pascal_safecall_calling_convention/test_safecall_multiple_methods_in_interface
// origin: languages/pascal/tests/pascal/test_pascal_safecall_calling_convention.rs
program Test;
{$mode delphi}
uses SysUtils;
...
procedure TSafeMultiImpl.Step1; begin __p(__vs('Step1Executed')); end;
procedure TSafeMultiImpl.Step2; begin __p(__vs('Step2Executed')); end;
var obj: ISafeMulti;
begin
  obj := TSafeMultiImpl.Create;
  obj.Step1;
  obj.Step2;
__vybeCheck('Step1Executed' + #10 + 'Step2Executed');
end.
