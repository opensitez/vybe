// vybe-test: pascal/pascal_safecall_calling_convention/test_safecall_default_parameter
...
__vybeCheck('EXEC:DefaultPrefix' + #10 + 'EXEC:CustomPrefix');
end.
