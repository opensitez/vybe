// vybe-test: pascal/pascal_safecall_calling_convention/test_safecall_standalone_procedure_declaration
...
begin
  __p(__vs('StandaloneSafecall:' + msg));
end;
begin
  StandaloneSafeProc('Hello');
__vybeCheck('StandaloneSafecall:Hello');
end.
