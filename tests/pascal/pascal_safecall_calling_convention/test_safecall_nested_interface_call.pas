// vybe-test: pascal/pascal_safecall_calling_convention/test_safecall_nested_interface_call
...
procedure TSafeCoreImpl.RunCore; begin __p(__vs('NestedSafeCoreRun')); end;

var core: ISafeCore;
begin
  core := TSafeCoreImpl.Create;
  core.RunCore;
__vybeCheck('NestedSafeCoreRun');
end.
