// vybe-test: pascal/pascal_safecall_calling_convention/test_safecall_in_subclass_virtual_override
...
procedure TBaseSafe.DoWork; begin __p(__vs('BaseSafe')); end;
procedure TSubSafe.DoWork; begin __p(__vs('SubSafe')); end;
