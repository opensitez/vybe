// vybe-test: pascal/pascal_safecall_calling_convention/test_safecall_exception_marshaling_to_caller
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('CallerCaughtSafecall:' + E.Message));
  end;
__vybeCheck('CallerCaughtSafecall:SafecallErrorOccurred');
end.
