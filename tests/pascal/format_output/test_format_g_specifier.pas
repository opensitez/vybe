// vybe-test: pascal/format_output/test_format_g_specifier
...
begin
  __p(__vs(Format('%g', [1000000.0])));
  __p(__vs(Format('%g', [0.0001])));
  __p(__vs(Format('%g', [3.14])));
__vybeCheck('1e+06' + #10 + '0.0001' + #10 + '3.14');
end.
