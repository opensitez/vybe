// vybe-test: pascal/format_output/test_format_combined_table
...
begin
  ...
  for i := 0 to 1 do
    __p(__vs(Format('%-8s %3d  %.1f%%', [rows[i].Name, rows[i].Score, rows[i].Pct])));
__vybeCheck('Alice     95  95.0%' + #10 + 'Bob       72  72.0%');
end.
