// vybe-test: pascal/format_output/test_format_integer_zero_padded
...
begin
  for i := 1 to 5 do
    __p(__vs(Format('item_%03d', [i])));
__vybeCheck('item_001' + #10 + 'item_002' + #10 + 'item_003' + #10 + 'item_004' + #10 + 'item_005');
end.
