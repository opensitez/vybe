// vybe-test: pascal/generics_advanced/generic_vector_dot_two_integers
...
end; type TVec<T>=record X,Y:T; end; function Dot(a,b:TVec<Integer>):Integer; begin Result:=a.X*b.X+a.Y*b.Y; end; var u,v:TVec<Integer>; begin u.X:=1; u.Y:=2; v.X:=3; v.Y:=4; __p(__vs(Dot(u,v))); __vybeCheck('11');
end.
