// vybe-test: pascal/generics_advanced/generic_nested_box_in_box
...
end; type TBox<T>=class public Value:T; constructor Create(v:T); end; constructor TBox<T>.Create(v:T); begin Value:=v; end; var outer:TBox<TBox<String>>; begin outer:=TBox<TBox<String>>.Create(TBox<String>.Create('ok')); __p(__vs(outer.Value.Value)); outer.Value.Free; outer.Free; __vybeCheck('ok');
end.
