// vybe-test: pascal/generics_advanced/generic_record_clone_field_copy
...
end; type TClone<T>=record Data:T; end; var a,b:TClone<Integer>; begin a.Data:=5; b:=a; b.Data:=8; __p(__vs(a.Data)); __p(__vs(b.Data)); __vybeCheck('5' + #10 + '8');
end.
