// vybe-test: pascal/generics_advanced/generic_class_inherits_generic_field
...
end; type TBase<T>=class public Value:T; end; TChild=class(TBase<Integer>) end; var c:TChild; begin c:=TChild.Create; c.Value:=11; __p(__vs(c.Value)); c.Free; __vybeCheck('11');
end.
