// vybe-test: pascal/generics_advanced/generic_class_method_returns_generic
...
end; type TFactory<T>=class public class function Make(v:T):T; end; class function TFactory<T>.Make(v:T):T; begin Result:=v; end; begin __p(__vs(TFactory<Integer>.Make(77))); __vybeCheck('77');
end.
