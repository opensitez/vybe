// vybe-test: pascal/generics_advanced/generic_predicate_filter_count
...
end; function CountPos(const a:array of Integer):Integer; var i:Integer; begin Result:=0; for i:=Low(a) to High(a) do if a[i]>0 then Inc(Result); end; begin __p(__vs(CountPos([1,-2,3]))); __vybeCheck('2');
end.
