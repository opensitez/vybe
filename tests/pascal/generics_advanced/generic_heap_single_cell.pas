// vybe-test: pascal/generics_advanced/generic_heap_single_cell
...
end; type TCell<T>=class public V:T; constructor Create(v:T); end; constructor TCell<T>.Create(v:T); begin V:=v; end; var c:TCell<String>; begin c:=TCell<String>.Create('cell'); __p(__vs(c.V)); c.Free; __vybeCheck('cell');
end.
