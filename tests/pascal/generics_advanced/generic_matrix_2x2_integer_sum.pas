// vybe-test: pascal/generics_advanced/generic_matrix_2x2_integer_sum
...
end; type TMat<T>=record Cells:array[0..1,0..1] of T; end; var m:TMat<Integer>; begin m.Cells[0,0]:=1; m.Cells[0,1]:=2; m.Cells[1,0]:=3; m.Cells[1,1]:=4; __p(__vs(m.Cells[1,1])); __vybeCheck('4');
end.
