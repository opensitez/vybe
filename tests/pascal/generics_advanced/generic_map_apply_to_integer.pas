// vybe-test: pascal/generics_advanced/generic_map_apply_to_integer
...
end; function Double<T>(v:T):T; begin Result:=v; end; function DoubleInt(n:Integer):Integer; begin Result:=n*2; end; begin __p(__vs(DoubleInt(6))); __vybeCheck('12');
end.
