// vybe-test: pascal/generics_advanced/generic_optional_set_value
...
end; type TOpt<T>=class public Has:Boolean; Value:T; procedure Set(v:T); end; procedure TOpt<T>.Set(v:T); begin Has:=true; Value:=v; end; var o:TOpt<Integer>; begin o:=TOpt<Integer>.Create; o.Set(4); __p(__vs(o.Value)); o.Free; __vybeCheck('4');
end.
