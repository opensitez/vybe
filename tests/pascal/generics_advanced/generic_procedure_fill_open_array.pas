// vybe-test: pascal/generics_advanced/generic_procedure_fill_open_array
...
end; procedure Fill<T>(var a:array of T; v:T); var i:Integer; begin for i:=Low(a) to High(a) do a[i]:=v; end; var a:array of Integer; begin SetLength(a,3); Fill<Integer>(a,7); __p(__vs(a[2])); __vybeCheck('7');
end.
