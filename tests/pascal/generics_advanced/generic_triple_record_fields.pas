// vybe-test: pascal/generics_advanced/generic_triple_record_fields
...
end; type TTrip<T>=record A,B,C:T; end; var t:TTrip<Integer>; begin t.A:=1; t.B:=2; t.C:=3; __p(__vs(t.A+t.B+t.C)); __vybeCheck('6');
end.
