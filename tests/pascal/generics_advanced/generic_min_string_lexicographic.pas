// vybe-test: pascal/generics_advanced/generic_min_string_lexicographic
...
end; function Smaller<T>(a,b:T):T; begin if a<b then Result:=a else Result:=b; end; begin __p(__vs(Smaller<String>('delta','alpha'))); __vybeCheck('alpha');
end.
