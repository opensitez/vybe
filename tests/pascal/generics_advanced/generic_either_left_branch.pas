// vybe-test: pascal/generics_advanced/generic_either_left_branch
...
end; type TEither<L,R>=record IsLeft:Boolean; Left:L; Right:R; end; var e:TEither<Integer,String>; begin e.IsLeft:=true; e.Left:=9; __p(__vs(e.Left)); __vybeCheck('9');
end.
