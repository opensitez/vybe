// vybe-test: pascal/generics_advanced/generic_list_push_count_strings
...
end; type TList<T>=class private FN:Integer; public constructor Create; procedure Add; function Count:Integer; end; constructor TList<T>.Create; begin FN:=0; end; procedure TList<T>.Add; begin Inc(FN); end; function TList<T>.Count:Integer; begin Result:=FN; end; var L:TList<String>; begin L:=TList<String>.Create; L.Add; L.Add; L.Add; __p(__vs(L.Count)); L.Free; __vybeCheck('3');
end.
