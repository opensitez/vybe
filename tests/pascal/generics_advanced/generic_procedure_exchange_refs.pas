// vybe-test: pascal/generics_advanced/generic_procedure_exchange_refs
...
end; procedure Exchange<T>(var a,b:T); var t:T; begin t:=a; a:=b; b:=t; end; var x,y:String; begin x:='1'; y:='2'; Exchange<String>(x,y); __p(__vs(x+y)); __vybeCheck('21');
end.
