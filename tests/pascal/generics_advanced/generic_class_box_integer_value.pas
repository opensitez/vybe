// vybe-test: pascal/generics_advanced/generic_class_box_integer_value
...
end; type TBox<T>=class public Value:T; constructor Create(v:T); end; constructor TBox<T>.Create(v:T); begin Value:=v; end; var b:TBox<Integer>; begin b:=TBox<Integer>.Create(12); __p(__vs(b.Value)); b.Free; __vybeCheck('12');
end.
