// vybe-test: pascal/generics_advanced/generic_key_value_string_int
...
end; type TKVP<K,V>=record Key:K; Value:V; end; var m:TKVP<String,Integer>; begin m.Key:='age'; m.Value:=30; __p(__vs(m.Value)); __vybeCheck('30');
end.
