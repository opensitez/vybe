// vybe-test: pascal/generics_advanced/generic_function_last_index_open_array
...
end; function Last<T>(const a:array of T):T; begin Result:=a[High(a)]; end; var a:array of String; begin a:=['a','b','c']; __p(__vs(Last<String>(a))); __vybeCheck('c');
end.
