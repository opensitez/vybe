// vybe-test: pascal/generics_advanced/generic_sum_open_array_integers
...
end; function Sum<T>(const a:array of Integer):Integer; var i:Integer; begin Result:=0; for i:=Low(a) to High(a) do Result:=Result+a[i]; end; var a:array of Integer; begin a:=[1,2,3]; __p(__vs(Sum<Integer>(a))); __vybeCheck('6');
end.
