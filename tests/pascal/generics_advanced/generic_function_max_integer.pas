// vybe-test: pascal/generics_advanced/generic_function_max_integer
...
end; function Bigger<T>(a,b:T):T; begin if a>b then Result:=a else Result:=b; end; begin __p(__vs(Bigger<Integer>(4,9))); __vybeCheck('9');
end.
