// vybe-test: pascal/generics_advanced/generic_function_first_of_open_array
...
end; function First<T>(const a:array of T):T; begin Result:=a[0]; end; var nums:array of Integer; begin nums:=[8,9]; __p(__vs(First<Integer>(nums))); __vybeCheck('8');
end.
