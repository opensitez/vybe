// vybe-test: pascal/generics_advanced/generic_record_default_initialize_integers
...
end; type TR<T>=record A,B:T; end; var r:TR<Integer>; begin r.A:=3; r.B:=4; __p(__vs(r.A*r.B)); __vybeCheck('12');
end.
