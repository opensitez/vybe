// vybe-test: pascal/generics_advanced/generic_open_array_param_length
...
end; function Len<T>(const a:array of T):Integer; begin Result:=Length(a); end; var a:array of Integer; begin a:=[1,2,3,4]; __p(__vs(Len<Integer>(a))); __vybeCheck('4');
end.
