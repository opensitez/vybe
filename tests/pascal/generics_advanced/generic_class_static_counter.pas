// vybe-test: pascal/generics_advanced/generic_class_static_counter
...
end; type TCounted<T>=class public class var N:Integer; class procedure Bump; end; class var TCounted<Integer>.N:Integer; class procedure TCounted<T>.Bump; begin Inc(N); end; begin TCounted<Integer>.N:=0; TCounted<Integer>.Bump; TCounted<Integer>.Bump; __p(__vs(TCounted<Integer>.N)); __vybeCheck('2');
end.
