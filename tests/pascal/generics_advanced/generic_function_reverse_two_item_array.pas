// vybe-test: pascal/generics_advanced/generic_function_reverse_two_item_array
...
end; procedure Reverse<T>(var a:array of T); var t:T; begin t:=a[0]; a[0]:=a[1]; a[1]:=t; end; var a:array of String; begin a:=['first','second']; Reverse<String>(a); __p(__vs(a[0])); __vybeCheck('second');
end.
