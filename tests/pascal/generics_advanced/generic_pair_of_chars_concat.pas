// vybe-test: pascal/generics_advanced/generic_pair_of_chars_concat
...
end; type TPair<T>=record A,B:T; end; var p:TPair<Char>; begin p.A:='Q'; p.B:='Z'; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('Q' + #10 + 'Z');
end.
