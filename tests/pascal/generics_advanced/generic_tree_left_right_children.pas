// vybe-test: pascal/generics_advanced/generic_tree_left_right_children
...
end; type TNode<T>=record Left,Right:T; end; var n:TNode<Integer>; begin n.Left:=2; n.Right:=3; __p(__vs(n.Left+n.Right)); __vybeCheck('5');
end.
