// vybe-test: pascal/generics_advanced/generic_record_pair_of_strings
...
end; type TPair<T>=record First, Second:T; end; var p:TPair<String>; begin p.First:='a'; p.Second:='b'; __p(__vs(p.First+p.Second)); __vybeCheck('ab');
end.
