// vybe-test: pascal/generics_advanced/generic_array_wrapper_length_two
...
end; type TW<T>=record Items:array[0..1] of T; end; var w:TW<Double>; begin w.Items[0]:=1.5; w.Items[1]:=2.5; __p(__vs(Round(w.Items[0]+w.Items[1]))); __vybeCheck('4');
end.
