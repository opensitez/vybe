// vybe-test: pascal/boolean_patterns/logical_implication
...
begin
  __p(__vs(Implies(True, True)));
  __p(__vs(Implies(True, False)));
  __p(__vs(Implies(False, True)));
  __p(__vs(Implies(False, False)));
