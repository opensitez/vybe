// vybe-test: pascal/boolean_patterns/boolean_or_of_conditions
// origin: languages/pascal/tests/pascal/test_boolean_patterns.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(IsBoundary(0, 10)));
  __p(__vs(IsBoundary(9, 10)));
  __p(__vs(IsBoundary(5, 10)));
