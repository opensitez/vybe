// vybe-test: pascal/pascal_math_unit_trig_hyperbolic/test_math_arcsinh_arccosh_arctanh
...
uses Math;
begin
  __p(__vs(ArcSinh(0.0) = 0.0));
  __p(__vs(ArcCosh(1.0) = 0.0));
  __p(__vs(ArcTanh(0.0) = 0.0));
