// vybe-test: pascal/pascal_math_unit_trig_hyperbolic/test_math_arcsin_arccos_arctan2
// origin: languages/pascal/tests/pascal/test_pascal_math_unit_trig_hyperbolic.rs
program Test;
{$mode delphi}
...
uses Math;
begin
  __p(__vs(ArcSin(0.0) = 0.0));
  __p(__vs(ArcCos(1.0) = 0.0));
  __p(__vs(ArcTan2(1.0, 1.0) > 0.78));
