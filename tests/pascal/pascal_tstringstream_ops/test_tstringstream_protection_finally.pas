// vybe-test: pascal/pascal_tstringstream_ops/test_tstringstream_protection_finally
// origin: languages/pascal/tests/pascal/test_pascal_tstringstream_ops.rs
program Test;
{$mode delphi}
...
begin
  ...
  try
    __p(__vs(ss.DataString));
  finally
    ss.Free;
    __p(__vs('StringStreamFreed'));
  end;
__vybeCheck('ProtectedStreamText' + #10 + 'StringStreamFreed');
end.
