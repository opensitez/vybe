// vybe-test: pascal/pascal_tbinaryreader_tbinarywriter/test_tbinarywriter_heterogeneous_pipeline
// origin: languages/pascal/tests/pascal/test_pascal_tbinaryreader_tbinarywriter.rs
program Test;
{$mode delphi}
...
begin
  ...
  __p(__vs(r.ReadInt32));
  __p(__vs(r.ReadString));
  __p(__vs(r.ReadBoolean));
  __p(__vs(r.ReadDouble));
  r.Free; ms.Free;
__vybeCheck('101' + #10 + 'ItemName' + #10 + 'True' + #10 + '19.99');
end.
