// vybe-test: pascal/pascal_tbinaryreader_tbinarywriter/test_tbinarywriter_protection_finally
...
begin
  ...
  try
    ...
    w.Free;
    ms.Free;
    __p(__vs('BinaryWriterFreedInFinally'));
  end;
__vybeCheck('BinaryWriterFreedInFinally');
end.
