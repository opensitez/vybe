// vybe-test: pascal/pascal_tbinaryreader_tbinarywriter/test_tbinarywriter_array_of_bytes_write
...
begin
  ...
  __p(__vs(readBytes[0]));
  __p(__vs(readBytes[1]));
  r.Free; ms.Free;
__vybeCheck('55' + #10 + '66');
end.
