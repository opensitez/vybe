// vybe-test: pascal/pascal_tbinaryreader_tbinarywriter/test_tbinarywriter_write_byte_word_cardinal
...
begin
  ...
  __p(__vs(r.ReadByte));
  __p(__vs(r.ReadUInt16));
  __p(__vs(r.ReadUInt32));
  r.Free; ms.Free;
__vybeCheck('255' + #10 + '65535' + #10 + '4294967295');
end.
