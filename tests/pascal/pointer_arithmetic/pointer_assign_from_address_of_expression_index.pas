// vybe-test: pascal/pointer_arithmetic/pointer_assign_from_address_of_expression_index
...
end; var a: array[1..4] of Integer; p: ^Integer; i: Integer; begin for i:=1 to 4 do a[i]:=i*10; p:=@a[3]; __p(__vs(p^)); __vybeCheck('30');
end.
