// vybe-test: pascal/pointer_arithmetic/pointer_boolean_array_walk_finds_true
...
end; var f: array[0..2] of Boolean; p: ^Boolean; begin f[0]:=false; f[1]:=true; f[2]:=false; p:=@f[0]; Inc(p); if p^ then __p(__vs('hit')); __vybeCheck('hit');
end.
