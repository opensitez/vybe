// vybe-test: pascal/pointer_arithmetic/pointer_to_boolean_toggles_value
...
end; var f: Boolean; p: ^Boolean; begin f:=false; p:=@f; p^:=true; if f then __p(__vs('on')); __vybeCheck('on');
end.
