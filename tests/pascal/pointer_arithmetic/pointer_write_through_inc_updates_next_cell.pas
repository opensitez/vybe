// vybe-test: pascal/pointer_arithmetic/pointer_write_through_inc_updates_next_cell
...
end; var a: array[0..1] of Integer; p: ^Integer; begin a[0]:=0; a[1]:=0; p:=@a[0]; p^:=5; Inc(p); p^:=9; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('5' + #10 + '9');
end.
