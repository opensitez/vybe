// vybe-test: pascal/pointer_arithmetic/pointer_starts_at_middle_element
...
end; var a: array[1..5] of Integer; p: ^Integer; begin a[3]:=99; p:=@a[3]; __p(__vs(p^)); __vybeCheck('99');
end.
