// vybe-test: pascal/pointer_arithmetic/pointer_dec_after_inc_returns_original
...
end; var x: Integer; p: ^Integer; begin x:=8; p:=@x; Inc(p); Dec(p); __p(__vs(p^)); __vybeCheck('8');
end.
