// vybe-test: pascal/pointer_arithmetic/pointer_loop_accumulates_via_inc
...
end; var a: array[0..4] of Integer; p: ^Integer; i, s: Integer; begin for i:=0 to 4 do a[i]:=i+1; p:=@a[0]; s:=0; for i:=0 to 4 do begin s:=s+p^; Inc(p); end; __p(__vs(s)); __vybeCheck('15');
end.
