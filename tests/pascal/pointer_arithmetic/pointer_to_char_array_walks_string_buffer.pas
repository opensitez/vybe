// vybe-test: pascal/pointer_arithmetic/pointer_to_char_array_walks_string_buffer
...
end; var buf: array[0..2] of Char; p: ^Char; begin buf[0]:='a'; buf[1]:='b'; buf[2]:='c'; p:=@buf[0]; __p(__vs(p^)); Inc(p); __p(__vs(p^)); __vybeCheck('a' + #10 + 'b');
end.
