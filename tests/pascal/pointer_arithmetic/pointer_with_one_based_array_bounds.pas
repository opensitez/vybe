// vybe-test: pascal/pointer_arithmetic/pointer_with_one_based_array_bounds
...
end; var a: array[1..3] of Integer; p: ^Integer; begin a[2]:=44; p:=@a[2]; __p(__vs(p^)); __vybeCheck('44');
end.
