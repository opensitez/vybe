// vybe-test: pascal/pointer_arithmetic/pointer_subtract_same_array_yields_index_distance
...
end; var a: array[0..5] of Integer; p, q: ^Integer; d: Integer; begin p:=@a[1]; q:=@a[4]; d:=q-p; __p(__vs(d)); __vybeCheck('3');
end.
