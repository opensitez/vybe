// vybe-test: pascal/pointer_arithmetic/pointer_swap_cells_using_temp
...
end; var a,b: Integer; pa,pb: ^Integer; t: Integer; begin a:=1; b:=9; pa:=@a; pb:=@b; t:=pa^; pa^:=pb^; pb^:=t; __p(__vs(a)); __p(__vs(b)); __vybeCheck('9' + #10 + '1');
end.
