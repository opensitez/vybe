// vybe-test: pascal/pointer_arithmetic/pointer_compare_same_element_address
...
end; var x: Integer; p, q: ^Integer; begin x:=7; p:=@x; q:=@x; if p=q then __p(__vs('same')); __vybeCheck('same');
end.
