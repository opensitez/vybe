// vybe-test: pascal/pointer_arithmetic/pointer_compare_different_fields_not_equal
...
end; type TR=record A,B:Integer; end; var r:TR; p,q:^Integer; begin r.A:=1; r.B:=2; p:=@r.A; q:=@r.B; if p<>q then __p(__vs('diff')); __vybeCheck('diff');
end.
