// vybe-test: pascal/pointer_arithmetic/pointer_passed_to_procedure_by_ref_walk
...
end; procedure Bump(var p: ^Integer); begin Inc(p); end; var a: array[0..1] of Integer; p: ^Integer; begin a[0]:=1; a[1]:=2; p:=@a[0]; Bump(p); __p(__vs(p^)); __vybeCheck('2');
end.
