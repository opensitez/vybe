// vybe-test: pascal/pointer_arithmetic/pointer_walk_counts_zero_cells
...
end; var a: array[0..4] of Integer; p: ^Integer; i, c: Integer; begin for i:=0 to 4 do a[i]:=0; p:=@a[0]; c:=0; for i:=0 to 4 do begin if p^=0 then c:=c+1; Inc(p); end; __p(__vs(c)); __vybeCheck('5');
end.
