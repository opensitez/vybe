// vybe-test: pascal/pointer_arithmetic/pointer_parameter_reads_through_deref
...
end; function ReadPtr(p: ^Integer): Integer; begin Result:=p^; end; var x: Integer; begin x:=18; __p(__vs(ReadPtr(@x))); __vybeCheck('18');
end.
