// vybe-test: pascal/pointer_arithmetic/pointer_to_real_updates_through_deref
...
end; var x: Double; p: ^Double; begin x:=1.5; p:=@x; p^:=2.5; __p(__vs(Round(p^*10))); __vybeCheck('25');
end.
