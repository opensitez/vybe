// vybe-test: pascal/pointer_arithmetic/pointer_record_array_element_address
...
end; type TR=record V:Integer; end; var items: array[0..1] of TR; p: ^Integer; begin items[1].V:=77; p:=@items[1].V; __p(__vs(p^)); __vybeCheck('77');
end.
