// vybe-test: pascal/pointer_arithmetic/pointer_inc_twice_skips_one_element
...
end; var a: array[0..3] of Integer; p: ^Integer; begin a[0]:=10; a[2]:=30; p:=@a[0]; Inc(p); Inc(p); __p(__vs(p^)); __vybeCheck('30');
end.
