// vybe-test: pascal/pointer_arithmetic/pointer_offset_from_first_to_third_element
...
end; var a: array[0..4] of Integer; first, third: ^Integer; begin a[0]:=10; a[2]:=30; first:=@a[0]; third:=@a[2]; __p(__vs(first^)); __p(__vs(third^)); __vybeCheck('10' + #10 + '30');
end.
