// vybe-test: pascal/pointer_arithmetic/pointer_to_static_array_first_and_last
...
end; var a: array[0..4] of Integer; first, last: ^Integer; begin a[0]:=2; a[4]:=8; first:=@a[0]; last:=@a[4]; __p(__vs(last-first)); __vybeCheck('4');
end.
