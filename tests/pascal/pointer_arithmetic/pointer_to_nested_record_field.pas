// vybe-test: pascal/pointer_arithmetic/pointer_to_nested_record_field
...
end; type TInner=record V:Integer; end; type TOuter=record Inner:TInner; end; var o:TOuter; p:^Integer; begin o.Inner.V:=12; p:=@o.Inner.V; __p(__vs(p^)); __vybeCheck('12');
end.
