// vybe-test: pascal/pointer_arithmetic/pointer_returned_from_function_points_to_static
...
end; var g: Integer; function AddrGlobal: ^Integer; begin Result:=@g; end; var p: ^Integer; begin g:=55; p:=AddrGlobal; __p(__vs(p^)); __vybeCheck('55');
end.
