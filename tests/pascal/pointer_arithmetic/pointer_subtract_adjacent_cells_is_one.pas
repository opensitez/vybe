// vybe-test: pascal/pointer_arithmetic/pointer_subtract_adjacent_cells_is_one
...
end; var a: array[0..2] of Integer; p, q: ^Integer; begin p:=@a[0]; q:=@a[1]; __p(__vs(q-p)); __vybeCheck('1');
end.
