// vybe-test: pascal/pascal_variant_arrays_vararray/test_vararray_2d_create_and_access
...
begin
  ...
  v[0, 0] := 1; v[0, 1] := 2;
  v[1, 0] := 3; v[1, 1] := 4;
  __p(__vs(v[0, 0].ToString + ',' + v[0, 1].ToString));
  __p(__vs(v[1, 0].ToString + ',' + v[1, 1].ToString));
  VarClear(v);
