// vybe-test: pascal/pascal_variant_arrays_vararray/test_vararray_out_of_bounds_exception
...
begin
  ...
  try
    ...
    on E: EVariantArrayBoundsError do __p(__vs('ArrayBoundsErrorCaught'));
  end;
  VarClear(v);
__vybeCheck('ArrayBoundsErrorCaught');
end.
