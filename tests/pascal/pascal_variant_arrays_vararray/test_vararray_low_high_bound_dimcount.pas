// vybe-test: pascal/pascal_variant_arrays_vararray/test_vararray_low_high_bound_dimcount
// origin: languages/pascal/tests/pascal/test_pascal_variant_arrays_vararray.rs
program Test;
{$mode delphi}
...
begin
  ...
  __p(__vs(VarArrayDimCount(v)));
  __p(__vs(VarArrayLowBound(v, 1)));
  __p(__vs(VarArrayHighBound(v, 1)));
  VarClear(v);
__vybeCheck('1' + #10 + '1' + #10 + '5');
end.
