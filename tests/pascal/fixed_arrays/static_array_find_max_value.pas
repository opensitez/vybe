// vybe-test: pascal/fixed_arrays/static_array_find_max_value
...
end; var a: array[1..4] of Integer; i,m: Integer; begin a[1]:=3; a[2]:=9; a[3]:=1; a[4]:=7; m:=a[1]; for i:=2 to 4 do if a[i]>m then m:=a[i]; __p(__vs(m)); __vybeCheck('9');
end.
