// vybe-test: pascal/fixed_arrays/static_array_count_matching
...
end; var a: array[1..5] of Integer; i,c: Integer; begin a[1]:=2; a[2]:=2; a[3]:=5; a[4]:=2; a[5]:=1; c:=0; for i:=1 to 5 do if a[i]=2 then c:=c+1; __p(__vs(c)); __vybeCheck('3');
end.
