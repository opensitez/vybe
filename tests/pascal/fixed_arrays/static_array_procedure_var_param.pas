// vybe-test: pascal/fixed_arrays/static_array_procedure_var_param
...
end; procedure DoubleAll(var a: array[0..1] of Integer); begin a[0]:=a[0]*2; a[1]:=a[1]*2; end; var v: array[0..1] of Integer; begin v[0]:=3; v[1]:=4; DoubleAll(v); __p(__vs(v[0]+v[1])); __vybeCheck('14');
end.
