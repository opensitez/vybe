// vybe-test: pascal/fixed_arrays/static_array_single_element_bounds
...
end; var a: array[7..7] of Integer; begin a[7]:=42; __p(__vs(Low(a))); __p(__vs(High(a))); __p(__vs(a[7])); __vybeCheck('7' + #10 + '7' + #10 + '42');
end.
