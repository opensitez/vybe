// vybe-test: pascal/fixed_arrays/static_array_reverse_in_place
...
end; var a: array[1..3] of Integer; i,t: Integer; begin a[1]:=1; a[2]:=2; a[3]:=3; for i:=1 to 1 do begin t:=a[i]; a[i]:=a[4-i]; a[4-i]:=t; end; __p(__vs(a[2])); __vybeCheck('2');
end.
