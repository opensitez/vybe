// vybe-test: pascal/fixed_arrays/static_array_char_elements_join
...
end; var a: array[1..3] of Char; s: string; begin a[1]:='a'; a[2]:='b'; a[3]:='c'; s:=a[1]+a[2]+a[3]; __p(__vs(s)); __vybeCheck('abc');
end.
