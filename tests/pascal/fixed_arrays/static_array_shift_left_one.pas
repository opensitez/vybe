// vybe-test: pascal/fixed_arrays/static_array_shift_left_one
...
end; var a: array[0..2] of Integer; i: Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; for i:=0 to 1 do a[i]:=a[i+1]; a[2]:=0; __p(__vs(a[0])); __p(__vs(a[2])); __vybeCheck('2' + #10 + '0');
end.
