// vybe-test: pascal/fixed_arrays/static_array_partial_fill_then_read
...
end; var a: array[1..4] of Integer; i: Integer; begin for i:=1 to 4 do a[i]:=i*i; __p(__vs(a[3])); __vybeCheck('9');
end.
