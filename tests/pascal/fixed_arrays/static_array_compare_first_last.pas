// vybe-test: pascal/fixed_arrays/static_array_compare_first_last
...
end; var a: array[1..3] of Integer; begin a[1]:=5; a[3]:=5; if a[1]=a[3] then __p(__vs('eq')); __vybeCheck('eq');
end.
