// vybe-test: pascal/fixed_arrays/static_array_multiply_accumulate
...
end; var a: array[1..3] of Integer; i,p: Integer; begin a[1]:=2; a[2]:=3; a[3]:=4; p:=1; for i:=1 to 3 do p:=p*a[i]; __p(__vs(p)); __vybeCheck('24');
end.
