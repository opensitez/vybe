// vybe-test: pascal/fixed_arrays/static_array_copy_loop
...
end; var src,dst: array[0..1] of Integer; i: Integer; begin src[0]:=4; src[1]:=5; for i:=0 to 1 do dst[i]:=src[i]; __p(__vs(dst[0]+dst[1])); __vybeCheck('9');
end.
