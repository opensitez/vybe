// vybe-test: pascal/fixed_arrays/static_array_real_sum_loop
...
end; var a: array[1..3] of Double; i: Integer; s: Double; begin a[1]:=1.0; a[2]:=2.0; a[3]:=3.0; s:=0; for i:=1 to 3 do s:=s+a[i]; __p(__vs(Round(s))); __vybeCheck('6');
end.
