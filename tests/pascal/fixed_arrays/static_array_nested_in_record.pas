// vybe-test: pascal/fixed_arrays/static_array_nested_in_record
...
end; type TB=record Items: array[0..1] of Integer; end; var b: TB; begin b.Items[0]:=6; b.Items[1]:=7; __p(__vs(b.Items[0]+b.Items[1])); __vybeCheck('13');
end.
