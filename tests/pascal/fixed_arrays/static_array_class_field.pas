// vybe-test: pascal/fixed_arrays/static_array_class_field
...
end; type TBox=class public Data: array[1..2] of Integer; end; var b: TBox; begin b:=TBox.Create; b.Data[1]:=11; b.Data[2]:=22; __p(__vs(b.Data[1]+b.Data[2])); b.Free; __vybeCheck('33');
end.
