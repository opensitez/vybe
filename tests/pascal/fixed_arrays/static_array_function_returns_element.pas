// vybe-test: pascal/fixed_arrays/static_array_function_returns_element
// origin: languages/pascal/tests/pascal/test_fixed_arrays.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function Pick(a: array[1..3] of Integer; idx: Integer): Integer; begin Result:=a[idx]; end; var v: array[1..3] of Integer; begin v[1]:=10; v[2]:=20; v[3]:=30; __p(__vs(Pick(v,2))); __vybeCheck('20');
end.
