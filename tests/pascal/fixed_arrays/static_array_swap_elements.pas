// vybe-test: pascal/fixed_arrays/static_array_swap_elements
...
end; var a: array[1..2] of Integer; t: Integer; begin a[1]:=1; a[2]:=9; t:=a[1]; a[1]:=a[2]; a[2]:=t; __p(__vs(a[1])); __p(__vs(a[2])); __vybeCheck('9' + #10 + '1');
end.
