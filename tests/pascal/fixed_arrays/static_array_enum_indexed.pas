// vybe-test: pascal/fixed_arrays/static_array_enum_indexed
...
end; type TD=(A,B,C); var arr: array[TD] of Integer; begin arr[A]:=1; arr[C]:=3; __p(__vs(arr[A]+arr[C])); __vybeCheck('4');
end.
