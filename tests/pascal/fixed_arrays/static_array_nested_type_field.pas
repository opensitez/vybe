// vybe-test: pascal/fixed_arrays/static_array_nested_type_field
...
end; type TR=record V:Integer; end; var a: array[1..2] of TR; begin a[1].V:=3; a[2].V:=4; __p(__vs(a[1].V+a[2].V)); __vybeCheck('7');
end.
