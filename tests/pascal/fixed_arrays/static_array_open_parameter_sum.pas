// vybe-test: pascal/fixed_arrays/static_array_open_parameter_sum
...
end; function Sum3(a: array[0..2] of Integer): Integer; begin Result:=a[0]+a[1]+a[2]; end; var v: array[0..2] of Integer; begin v[0]:=1; v[1]:=2; v[2]:=3; __p(__vs(Sum3(v))); __vybeCheck('6');
end.
