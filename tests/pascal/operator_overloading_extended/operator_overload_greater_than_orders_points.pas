// vybe-test: pascal/operator_overloading_extended/operator_overload_greater_than_orders_points
// origin: languages/pascal/tests/pascal/test_operator_overloading_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  p.X := 5; q.X := 2;
  if p > q then __p(__vs('gt')) else __p(__vs('le'));
__vybeCheck('gt');
end.
