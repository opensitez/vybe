// vybe-test: pascal/pascal_format_specifiers_advanced/test_fmt_invalid_specifier_raises_econverterror
...
begin
  try
    ...
    on E: EConvertError do __p(__vs('FormatErrorCaught'));
  end;
__vybeCheck('FormatErrorCaught');
end.
