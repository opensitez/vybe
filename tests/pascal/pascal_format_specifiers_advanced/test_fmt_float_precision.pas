// vybe-test: pascal/pascal_format_specifiers_advanced/test_fmt_float_precision
...
uses SysUtils;
begin
  __p(__vs(Format('%.2f', [3.14159])));
  __p(__vs(Format('%.4f', [3.14159])));
__vybeCheck('3.14' + #10 + '3.1416');
end.
