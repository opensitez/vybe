// vybe-test: pascal/pascal_format_specifiers_advanced/test_fmt_left_right_alignment
...
uses SysUtils;
begin
  __p(__vs('[' + Format('%-10s', ['Left']) + ']'));
  __p(__vs('[' + Format('%10s', ['Right']) + ']'));
__vybeCheck('[Left      ]' + #10 + '[     Right]');
end.
