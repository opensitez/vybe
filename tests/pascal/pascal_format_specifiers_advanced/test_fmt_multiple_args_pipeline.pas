// vybe-test: pascal/pascal_format_specifiers_advanced/test_fmt_multiple_args_pipeline
...
uses SysUtils;
begin
  __p(__vs(Format('ID:%04d Name:%-8s Active:%s', [7, 'Alice', 'TRUE'])));
__vybeCheck('ID:0007 Name:Alice    Active:TRUE');
end.
