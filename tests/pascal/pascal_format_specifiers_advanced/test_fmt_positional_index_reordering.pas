// vybe-test: pascal/pascal_format_specifiers_advanced/test_fmt_positional_index_reordering
// origin: languages/pascal/tests/pascal/test_pascal_format_specifiers_advanced.rs
program Test;
{$mode delphi}
...
uses SysUtils;
begin
  __p(__vs(Format('%1:s %0:s', ['Second', 'First'])));
  __p(__vs(Format('%0:d + %0:d = %1:d', [5, 10])));
__vybeCheck('First Second' + #10 + '5 + 5 = 10');
end.
