// vybe-test: pascal/goto_extended/goto_while_replacement_count_down
...
end; label again; var n:Integer; begin n:=3; again: __p(__vs(n)); Dec(n); if n>0 then goto again; __vybeCheck('3' + #10 + '2' + #10 + '1');
end.
