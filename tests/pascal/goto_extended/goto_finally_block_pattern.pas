// vybe-test: pascal/goto_extended/goto_finally_block_pattern
...
end; label cleanup; var ok:Boolean; begin ok:=false; if not ok then goto cleanup; __p(__vs('work')); cleanup: __p(__vs('cleanup')); __vybeCheck('cleanup');
end.
