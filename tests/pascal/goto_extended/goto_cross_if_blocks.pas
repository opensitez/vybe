// vybe-test: pascal/goto_extended/goto_cross_if_blocks
...
end; label target; var a:Integer; begin a:=0; if a=0 then begin goto target; end; __p(__vs('skip')); target: __p(__vs('tgt')); __vybeCheck('tgt');
end.
