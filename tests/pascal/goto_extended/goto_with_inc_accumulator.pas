// vybe-test: pascal/goto_extended/goto_with_inc_accumulator
...
end; label again; var sum,i:Integer; begin sum:=0; i:=0; again: Inc(i); sum:=sum+i; if i<4 then goto again; __p(__vs(sum)); __vybeCheck('10');
end.
