// vybe-test: pascal/goto_extended/goto_three_level_nested_escape
...
end; label escape; var depth:Integer; begin depth:=3; if depth=3 then if depth>0 then goto escape; __p(__vs('no')); escape: __p(__vs('out')); __vybeCheck('out');
end.
