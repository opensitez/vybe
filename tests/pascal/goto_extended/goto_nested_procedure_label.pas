// vybe-test: pascal/goto_extended/goto_nested_procedure_label
...
end; label done; procedure Inner; label leave; begin goto leave; __p(__vs('skip')); leave: __p(__vs('inner')); end; begin Inner; goto done; __p(__vs('skip2')); done: __p(__vs('outer')); __vybeCheck('inner' + #10 + 'outer');
end.
