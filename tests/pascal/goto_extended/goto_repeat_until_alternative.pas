// vybe-test: pascal/goto_extended/goto_repeat_until_alternative
...
end; label check; var n:Integer; begin n:=0; check: __p(__vs(n)); Inc(n); if n<=2 then goto check; __vybeCheck('0' + #10 + '1' + #10 + '2');
end.
