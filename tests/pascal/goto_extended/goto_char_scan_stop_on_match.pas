// vybe-test: pascal/goto_extended/goto_char_scan_stop_on_match
...
end; label found; var i:Integer; s:string; c:Char; begin s:='abc'; for i:=1 to Length(s) do begin c:=s[i]; if c='b' then goto found; end; found: __p(__vs(c)); __vybeCheck('b');
end.
