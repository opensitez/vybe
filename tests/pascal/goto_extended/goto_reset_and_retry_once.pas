// vybe-test: pascal/goto_extended/goto_reset_and_retry_once
...
end; label retry, giveup; var tries:Integer; begin tries:=0; retry: Inc(tries); if tries=1 then goto retry; if tries>2 then goto giveup; __p(__vs(tries)); giveup: __p(__vs('done')); __vybeCheck('2' + #10 + 'done');
end.
