// vybe-test: pascal/goto_extended/goto_compare_integers_branch
...
end; label gt,le; var a,b:Integer; begin a:=5; b:=3; if a>b then goto gt else goto le; gt: __p(__vs('gt')); goto endprog; le: __p(__vs('le')); endprog: __vybeCheck('gt');
end.
