// vybe-test: pascal/goto_extended/goto_forward_over_multiple_statements
...
end; label finish; begin __p(__vs('start')); goto finish; __p(__vs('skip1')); __p(__vs('skip2')); finish: __p(__vs('done')); __vybeCheck('start' + #10 + 'done');
end.
