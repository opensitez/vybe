// vybe-test: pascal/goto_extended/goto_for_loop_escape
...
end; label bail; var i:Integer; begin for i:=1 to 10 do begin if i=4 then goto bail; __p(__vs(i)); end; bail: __p(__vs('stop')); __vybeCheck('1' + #10 + '2' + #10 + '3' + #10 + 'stop');
end.
