// vybe-test: pascal/goto_extended/goto_while_true_break_pattern
...
end; label break_loop; var n:Integer; begin n:=0; while true do begin Inc(n); if n=2 then goto break_loop; __p(__vs(n)); end; break_loop: __p(__vs('brk')); __vybeCheck('1' + #10 + 'brk');
end.
