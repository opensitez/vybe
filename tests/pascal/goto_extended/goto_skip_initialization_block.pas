// vybe-test: pascal/goto_extended/goto_skip_initialization_block
...
end; label run; var ready:Boolean; begin ready:=false; if not ready then goto run; __p(__vs('init')); run: __p(__vs('run')); __vybeCheck('run');
end.
