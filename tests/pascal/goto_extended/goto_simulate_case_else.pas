// vybe-test: pascal/goto_extended/goto_simulate_case_else
...
end; label L1,L2,Lelse,done; var n:Integer; begin n:=9; if n=1 then goto L1 else if n=2 then goto L2 else goto Lelse; L1: __p(__vs('1')); goto done; L2: __p(__vs('2')); goto done; Lelse: __p(__vs('else')); done: __vybeCheck('else');
end.
