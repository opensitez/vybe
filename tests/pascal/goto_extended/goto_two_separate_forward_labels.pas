// vybe-test: pascal/goto_extended/goto_two_separate_forward_labels
...
end; label A,B; begin goto A; B: __p(__vs('B')); goto endprog; A: __p(__vs('A')); goto B; endprog: __vybeCheck('A' + #10 + 'B');
end.
