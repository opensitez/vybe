// vybe-test: pascal/goto_extended/goto_continue_loop_simulation
...
end; label loop_top, loop_cont; var i:Integer; begin i:=0; loop_top: Inc(i); if i=2 then goto loop_cont; __p(__vs(i)); loop_cont: if i<3 then goto loop_top; __vybeCheck('1' + #10 + '3');
end.
