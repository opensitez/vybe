// vybe-test: pascal/goto_extended/goto_accumulate_until_threshold
...
end; label add_more; var sum,v:Integer; begin sum:=0; v:=1; add_more: sum:=sum+v; Inc(v); if sum<10 then goto add_more; __p(__vs(sum)); __vybeCheck('10');
end.
