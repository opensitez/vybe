// vybe-test: pascal/goto_extended/goto_string_compare_branch
...
end; label match, nomatch; var s:string; begin s:='ok'; if s='ok' then goto match else goto nomatch; match: __p(__vs('match')); goto done; nomatch: __p(__vs('no')); done: __vybeCheck('match');
end.
