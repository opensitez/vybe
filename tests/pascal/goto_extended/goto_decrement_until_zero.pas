// vybe-test: pascal/goto_extended/goto_decrement_until_zero
...
end; label top; var n:Integer; begin n:=2; top: __p(__vs(n)); Dec(n); if n>=0 then goto top; __vybeCheck('2' + #10 + '1' + #10 + '0');
end.
