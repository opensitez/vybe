// vybe-test: pascal/goto_extended/goto_skip_after_success_flag
...
end; label fail, ok; var success:Boolean; begin success:=true; if success then goto ok; fail: __p(__vs('fail')); goto endprog; ok: __p(__vs('ok')); endprog: __vybeCheck('ok');
end.
