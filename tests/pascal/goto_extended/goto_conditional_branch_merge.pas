// vybe-test: pascal/goto_extended/goto_conditional_branch_merge
...
end; label merge; var x:Integer; begin x:=1; if x=1 then goto merge; __p(__vs('no')); merge: __p(__vs('yes')); __vybeCheck('yes');
end.
