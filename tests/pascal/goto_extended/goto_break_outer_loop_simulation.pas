// vybe-test: pascal/goto_extended/goto_break_outer_loop_simulation
...
end; label break_outer; var i,j:Integer; begin for i:=1 to 3 do begin for j:=1 to 3 do begin if (i=2) and (j=2) then goto break_outer; end; end; break_outer: __p(__vs('broken')); __vybeCheck('broken');
end.
