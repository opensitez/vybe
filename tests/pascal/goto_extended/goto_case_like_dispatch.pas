// vybe-test: pascal/goto_extended/goto_case_like_dispatch
...
end; label L1,L2,L3,done; var n:Integer; begin n:=2; if n=1 then goto L1 else if n=2 then goto L2 else goto L3; L1: __p(__vs('one')); goto done; L2: __p(__vs('two')); goto done; L3: __p(__vs('three')); done: __vybeCheck('two');
end.
