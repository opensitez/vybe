// vybe-test: pascal/goto_extended/goto_backward_label_loop_count
...
end; label top; var n:Integer; begin n:=0; top: Inc(n); if n<3 then goto top; __p(__vs(n)); __vybeCheck('3');
end.
