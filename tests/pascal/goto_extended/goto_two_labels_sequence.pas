// vybe-test: pascal/goto_extended/goto_two_labels_sequence
...
end; label L1, L2; begin __p(__vs('a')); goto L1; L2: __p(__vs('c')); goto done; L1: __p(__vs('b')); goto L2; done: __vybeCheck('a' + #10 + 'b' + #10 + 'c');
end.
