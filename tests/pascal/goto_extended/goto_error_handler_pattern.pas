// vybe-test: pascal/goto_extended/goto_error_handler_pattern
...
end; label err, ok; var code:Integer; begin code:=-1; if code<0 then goto err; __p(__vs('ok')); goto ok; err: __p(__vs('err')); ok: __p(__vs('end')); __vybeCheck('err' + #10 + 'end');
end.
