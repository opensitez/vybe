// vybe-test: pascal/goto_extended/goto_repeat_body_once_then_jump
...
end; label once; begin __p(__vs('body')); goto once; once: __p(__vs('once')); __vybeCheck('body' + #10 + 'once');
end.
