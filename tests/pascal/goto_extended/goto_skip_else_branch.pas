// vybe-test: pascal/goto_extended/goto_skip_else_branch
...
end; label past; var n:Integer; begin n:=5; if n>0 then goto past; __p(__vs('neg')); past: __p(__vs('past')); __vybeCheck('past');
end.
