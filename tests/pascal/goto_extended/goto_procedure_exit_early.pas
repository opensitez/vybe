// vybe-test: pascal/goto_extended/goto_procedure_exit_early
...
end; label ret; procedure P(n:Integer); begin if n=0 then goto ret; __p(__vs(n)); ret: end; begin P(0); P(2); __vybeCheck('2');
end.
