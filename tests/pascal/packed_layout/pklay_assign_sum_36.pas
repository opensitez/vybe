// vybe-test: pascal/packed_layout/pklay_assign_sum_36
...
end; type TP=packed record Lo,Hi:Byte; end; var a,b:TP; begin a.Lo:=36; a.Hi:=38; b:=a; __p(__vs(b.Lo+b.Hi)); __vybeCheck('74');
end.
