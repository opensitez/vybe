// vybe-test: pascal/packed_layout/pklay_char_byte_33
...
end; type TP=packed record Ch:Char; B:Byte; end; var p:TP; begin p.Ch:='H'; p.B:=33; __p(__vs(p.Ch)); __vybeCheck('H');
end.
