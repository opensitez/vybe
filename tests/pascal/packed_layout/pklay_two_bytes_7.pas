// vybe-test: pascal/packed_layout/pklay_two_bytes_7
...
end; type TP=packed record A,B:Byte; end; var p:TP; begin p.A:=7; p.B:=8; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('7' + #10 + '8');
end.
