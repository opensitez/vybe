// vybe-test: pascal/packed_layout/pklay_assign_sum_18
...
end; type TP=packed record Lo,Hi:Byte; end; var a,b:TP; begin a.Lo:=18; a.Hi:=20; b:=a; __p(__vs(b.Lo+b.Hi)); __vybeCheck('38');
end.
