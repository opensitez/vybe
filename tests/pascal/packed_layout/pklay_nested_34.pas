// vybe-test: pascal/packed_layout/pklay_nested_34
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; Tag:Byte; end; var o:TOuter; begin o.Inner.B:=34; o.Tag:=39; __p(__vs(o.Inner.B)); __p(__vs(o.Tag)); __vybeCheck('34' + #10 + '39');
end.
