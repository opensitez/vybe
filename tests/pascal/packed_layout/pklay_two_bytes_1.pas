// vybe-test: pascal/packed_layout/pklay_two_bytes_1
...
end; type TP=packed record A,B:Byte; end; var p:TP; begin p.A:=1; p.B:=2; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('1' + #10 + '2');
end.
