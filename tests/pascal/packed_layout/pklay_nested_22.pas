// vybe-test: pascal/packed_layout/pklay_nested_22
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; Tag:Byte; end; var o:TOuter; begin o.Inner.B:=22; o.Tag:=27; __p(__vs(o.Inner.B)); __p(__vs(o.Tag)); __vybeCheck('22' + #10 + '27');
end.
