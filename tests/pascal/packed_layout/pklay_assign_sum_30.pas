// vybe-test: pascal/packed_layout/pklay_assign_sum_30
...
end; type TP=packed record Lo,Hi:Byte; end; var a,b:TP; begin a.Lo:=30; a.Hi:=32; b:=a; __p(__vs(b.Lo+b.Hi)); __vybeCheck('62');
end.
