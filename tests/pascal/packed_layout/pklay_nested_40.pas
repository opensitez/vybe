// vybe-test: pascal/packed_layout/pklay_nested_40
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; Tag:Byte; end; var o:TOuter; begin o.Inner.B:=40; o.Tag:=45; __p(__vs(o.Inner.B)); __p(__vs(o.Tag)); __vybeCheck('40' + #10 + '45');
end.
