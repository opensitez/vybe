// vybe-test: pascal/packed_layout/pklay_two_bytes_13
...
end; type TP=packed record A,B:Byte; end; var p:TP; begin p.A:=13; p.B:=14; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('13' + #10 + '14');
end.
