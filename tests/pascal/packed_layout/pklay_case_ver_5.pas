// vybe-test: pascal/packed_layout/pklay_case_ver_5
...
end; type TP=packed record Ver:Byte; end; var p:TP; begin p.Ver:=3; case p.Ver of 1:__p(__vs('v1_5')); 2:__p(__vs('v2_5')); 3:__p(__vs('v3_5')); else __p(__vs('?')); end; __vybeCheck('v3_5');
end.
