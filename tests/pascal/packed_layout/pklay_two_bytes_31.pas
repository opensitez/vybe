// vybe-test: pascal/packed_layout/pklay_two_bytes_31
...
end; type TP=packed record A,B:Byte; end; var p:TP; begin p.A:=31; p.B:=32; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('31' + #10 + '32');
end.
