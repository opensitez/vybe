// vybe-test: pascal/packed_layout/pklay_nested_16
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; Tag:Byte; end; var o:TOuter; begin o.Inner.B:=16; o.Tag:=21; __p(__vs(o.Inner.B)); __p(__vs(o.Tag)); __vybeCheck('16' + #10 + '21');
end.
