// vybe-test: pascal/packed_layout/pklay_bool_byte_14
...
end; type TP=packed record Flag:Boolean; Code:Byte; end; var p:TP; begin p.Flag:=true; p.Code:=14; if p.Flag then __p(__vs(p.Code)); __vybeCheck('14');
end.
