// vybe-test: pascal/packed_layout/pklay_char_byte_15
...
end; type TP=packed record Ch:Char; B:Byte; end; var p:TP; begin p.Ch:='P'; p.B:=15; __p(__vs(p.Ch)); __vybeCheck('P');
end.
