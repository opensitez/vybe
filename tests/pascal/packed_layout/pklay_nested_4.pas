// vybe-test: pascal/packed_layout/pklay_nested_4
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; Tag:Byte; end; var o:TOuter; begin o.Inner.B:=4; o.Tag:=9; __p(__vs(o.Inner.B)); __p(__vs(o.Tag)); __vybeCheck('4' + #10 + '9');
end.
