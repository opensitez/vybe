// vybe-test: pascal/packed_layout/pklay_two_bytes_19
...
end; type TP=packed record A,B:Byte; end; var p:TP; begin p.A:=19; p.B:=20; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('19' + #10 + '20');
end.
