// vybe-test: pascal/packed_layout/pklay_char_byte_21
...
end; type TP=packed record Ch:Char; B:Byte; end; var p:TP; begin p.Ch:='V'; p.B:=21; __p(__vs(p.Ch)); __vybeCheck('V');
end.
