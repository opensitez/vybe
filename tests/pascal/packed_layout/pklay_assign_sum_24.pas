// vybe-test: pascal/packed_layout/pklay_assign_sum_24
...
end; type TP=packed record Lo,Hi:Byte; end; var a,b:TP; begin a.Lo:=24; a.Hi:=26; b:=a; __p(__vs(b.Lo+b.Hi)); __vybeCheck('50');
end.
