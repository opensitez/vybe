// vybe-test: pascal/packed_layout/pklay_char_byte_39
...
end; type TP=packed record Ch:Char; B:Byte; end; var p:TP; begin p.Ch:='N'; p.B:=39; __p(__vs(p.Ch)); __vybeCheck('N');
end.
