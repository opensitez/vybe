// vybe-test: pascal/packed_layout/pklay_nested_28
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; Tag:Byte; end; var o:TOuter; begin o.Inner.B:=28; o.Tag:=33; __p(__vs(o.Inner.B)); __p(__vs(o.Tag)); __vybeCheck('28' + #10 + '33');
end.
