// vybe-test: pascal/packed_layout/pklay_two_bytes_37
...
end; type TP=packed record A,B:Byte; end; var p:TP; begin p.A:=37; p.B:=38; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('37' + #10 + '38');
end.
