// vybe-test: pascal/packed_layout/pklay_assign_sum_12
...
end; type TP=packed record Lo,Hi:Byte; end; var a,b:TP; begin a.Lo:=12; a.Hi:=14; b:=a; __p(__vs(b.Lo+b.Hi)); __vybeCheck('26');
end.
