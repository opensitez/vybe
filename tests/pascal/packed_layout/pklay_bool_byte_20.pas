// vybe-test: pascal/packed_layout/pklay_bool_byte_20
...
end; type TP=packed record Flag:Boolean; Code:Byte; end; var p:TP; begin p.Flag:=true; p.Code:=20; if p.Flag then __p(__vs(p.Code)); __vybeCheck('20');
end.
