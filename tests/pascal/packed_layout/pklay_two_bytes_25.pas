// vybe-test: pascal/packed_layout/pklay_two_bytes_25
...
end; type TP=packed record A,B:Byte; end; var p:TP; begin p.A:=25; p.B:=26; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('25' + #10 + '26');
end.
