// vybe-test: pascal/packed_layout/pklay_assign_sum_6
...
end; type TP=packed record Lo,Hi:Byte; end; var a,b:TP; begin a.Lo:=6; a.Hi:=8; b:=a; __p(__vs(b.Lo+b.Hi)); __vybeCheck('14');
end.
