// vybe-test: pascal/packed_layout/pklay_char_byte_27
...
end; type TP=packed record Ch:Char; B:Byte; end; var p:TP; begin p.Ch:='B'; p.B:=27; __p(__vs(p.Ch)); __vybeCheck('B');
end.
