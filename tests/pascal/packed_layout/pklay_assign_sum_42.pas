// vybe-test: pascal/packed_layout/pklay_assign_sum_42
...
end; type TP=packed record Lo,Hi:Byte; end; var a,b:TP; begin a.Lo:=42; a.Hi:=44; b:=a; __p(__vs(b.Lo+b.Hi)); __vybeCheck('86');
end.
