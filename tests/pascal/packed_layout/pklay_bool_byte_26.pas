// vybe-test: pascal/packed_layout/pklay_bool_byte_26
...
end; type TP=packed record Flag:Boolean; Code:Byte; end; var p:TP; begin p.Flag:=true; p.Code:=26; if p.Flag then __p(__vs(p.Code)); __vybeCheck('26');
end.
