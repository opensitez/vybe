// vybe-test: pascal/packed_layout/pklay_nested_10
// origin: languages/pascal/tests/pascal/test_packed_layout.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; Tag:Byte; end; var o:TOuter; begin o.Inner.B:=10; o.Tag:=15; __p(__vs(o.Inner.B)); __p(__vs(o.Tag)); __vybeCheck('10' + #10 + '15');
end.
