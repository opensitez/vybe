// vybe-test: pascal/time_calendar/calendar_age_days
...
end; var birth,today:TDateTime; begin birth:=EncodeDate(2000,1,1); today:=EncodeDate(2000,1,31); __p(__vs(DaysBetween(today,birth))); __vybeCheck('30');
end.
