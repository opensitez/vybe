// vybe-test: pascal/time_calendar/decode_time_parts
...
end; var t:TDateTime; h,m,s,ms:Word; begin t:=EncodeTime(23,59,58,0); DecodeTime(t,h,m,s,ms); __p(__vs(h)); __p(__vs(m)); __p(__vs(s)); __vybeCheck('23' + #10 + '59' + #10 + '58');
end.
