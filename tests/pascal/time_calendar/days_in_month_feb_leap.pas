// vybe-test: pascal/time_calendar/days_in_month_feb_leap
...
end; var a,b:TDateTime; begin a:=EncodeDate(2020,2,1); b:=IncMonth(a,1); __p(__vs(DaysBetween(b,a))); __vybeCheck('29');
end.
