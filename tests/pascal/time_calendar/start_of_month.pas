// vybe-test: pascal/time_calendar/start_of_month
...
end; var d,s:TDateTime; begin d:=EncodeDate(2020,6,15); s:=EncodeDate(YearOf(d),MonthOf(d),1); __p(__vs(DayOf(s))); __vybeCheck('1');
end.
