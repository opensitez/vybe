// vybe-test: pascal/time_calendar/days_in_month_apr
...
end; var a,b:TDateTime; begin a:=EncodeDate(2020,4,1); b:=IncMonth(a,1); __p(__vs(DaysBetween(b,a))); __vybeCheck('30');
end.
