// vybe-test: pascal/time_calendar/days_between_dates
...
end; var a,b:TDateTime; begin a:=EncodeDate(2020,1,1); b:=EncodeDate(2020,1,11); __p(__vs(DaysBetween(b,a))); __vybeCheck('10');
end.
