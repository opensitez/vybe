// vybe-test: pascal/time_calendar/inc_month_forward
...
end; var d:TDateTime; begin d:=EncodeDate(2020,1,31); d:=IncMonth(d,1); __p(__vs(FormatDateTime("yyyy-mm",d))); __vybeCheck('2020-02');
end.
