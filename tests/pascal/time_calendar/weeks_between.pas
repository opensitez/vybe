// vybe-test: pascal/time_calendar/weeks_between
...
end; var a,b:TDateTime; begin a:=EncodeDate(2020,1,1); b:=EncodeDate(2020,1,15); __p(__vs(DaysBetween(b,a) div 7)); __vybeCheck('2');
end.
