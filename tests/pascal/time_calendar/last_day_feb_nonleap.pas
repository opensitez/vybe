// vybe-test: pascal/time_calendar/last_day_feb_nonleap
...
end; var a,b:TDateTime; begin a:=EncodeDate(2019,2,1); b:=IncMonth(a,1); __p(__vs(DaysBetween(b,a))); __vybeCheck('28');
end.
