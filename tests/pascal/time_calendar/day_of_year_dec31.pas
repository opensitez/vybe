// vybe-test: pascal/time_calendar/day_of_year_dec31
...
end; var d:TDateTime; begin d:=EncodeDate(2020,12,31); __p(__vs(DaysBetween(EncodeDate(2020,1,1),d)+1)); __vybeCheck('366');
end.
