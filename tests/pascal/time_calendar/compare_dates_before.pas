// vybe-test: pascal/time_calendar/compare_dates_before
...
end; var early,late:TDateTime; begin early:=EncodeDate(2020,1,1); late:=EncodeDate(2020,12,31); __p(__vs(CompareDate(early,late))); __vybeCheck('-1');
end.
