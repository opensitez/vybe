// vybe-test: pascal/time_calendar/decode_date_parts
...
end; var d:TDateTime; y,m,day:Word; begin d:=EncodeDate(1999,12,31); DecodeDate(d,y,m,day); __p(__vs(y)); __p(__vs(m)); __p(__vs(day)); __vybeCheck('1999' + #10 + '12' + #10 + '31');
end.
