// vybe-test: pascal/time_calendar/day_of_year_jan1
...
end; var d:TDateTime; begin d:=EncodeDate(2020,1,1); __p(__vs(DaysBetween(EncodeDate(2020,1,1),d)+1)); __vybeCheck('1');
end.
