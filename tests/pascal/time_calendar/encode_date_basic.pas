// vybe-test: pascal/time_calendar/encode_date_basic
...
end; var d:TDateTime; begin d:=EncodeDate(2020,1,2); __p(__vs(FormatDateTime("yyyy-mm-dd",d))); __vybeCheck('2020-01-02');
end.
