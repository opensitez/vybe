// vybe-test: pascal/time_calendar/compare_dates_equal
...
end; var a,b:TDateTime; begin a:=EncodeDate(2020,5,5); b:=EncodeDate(2020,5,5); __p(__vs(CompareDate(a,b))); __vybeCheck('0');
end.
