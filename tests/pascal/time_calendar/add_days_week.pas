// vybe-test: pascal/time_calendar/add_days_week
...
end; var d:TDateTime; begin d:=EncodeDate(2020,1,1); d:=IncDay(d,7); __p(__vs(FormatDateTime("yyyy-mm-dd",d))); __vybeCheck('2020-01-08');
end.
