// vybe-test: pascal/time_calendar/end_of_month_june
...
end; var d,e:TDateTime; begin d:=EncodeDate(2020,6,15); e:=IncDay(IncMonth(EncodeDate(YearOf(d),MonthOf(d),1),1),-1); __p(__vs(DayOf(e))); __vybeCheck('30');
end.
