// vybe-test: pascal/math_builtins_extended/clamp_via_min_max
...
end; function Clamp(v,lo,hi:Integer):Integer; begin Result:=Max(lo,Min(v,hi)); end; begin __p(__vs(Clamp(15,0,10))); __vybeCheck('10');
end.
