// vybe-test: pascal/math_builtins_extended/sign_zero_branch
...
end; function Sign(n:Integer):Integer; begin if n>0 then Result:=1 else if n<0 then Result:=-1 else Result:=0; end; begin __p(__vs(Sign(0))); __vybeCheck('0');
end.
