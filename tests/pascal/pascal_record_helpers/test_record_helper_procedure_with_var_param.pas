// vybe-test: pascal/pascal_record_helpers/test_record_helper_procedure_with_var_param
// origin: languages/pascal/tests/pascal/test_pascal_record_helpers.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  a := 10; b := 20;
  a.SwapWith(b);
  __p(__vs(a.ToString + ',' + b.ToString));
__vybeCheck('20,10');
end.
