// vybe-test: pascal/pascal_environment_command_line_args/test_env_custom_cmdline_parse_helper
...
begin
  __p(__vs(ParseIntArg('', 100)));
  __p(__vs(ParseIntArg('250', 100)));
__vybeCheck('100' + #10 + '250');
end.
