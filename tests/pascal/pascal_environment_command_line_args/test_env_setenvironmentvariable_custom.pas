// vybe-test: pascal/pascal_environment_command_line_args/test_env_setenvironmentvariable_custom
...
begin
  ...
  __p(__vs(GetEnvironmentVariable('TEST_ENV_VAR')));
__vybeCheck('PascalVal');
end.
