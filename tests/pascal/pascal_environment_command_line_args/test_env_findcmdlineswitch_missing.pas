// vybe-test: pascal/pascal_environment_command_line_args/test_env_findcmdlineswitch_missing
// origin: languages/pascal/tests/pascal/test_pascal_environment_command_line_args.rs
program Test;
{$mode delphi}
...
var value: String;
begin
  __p(__vs(FindCmdLineSwitch('missing_flag')));
  __p(__vs(FindCmdLineSwitch('missing_switch', value)));
__vybeCheck('False' + #10 + 'False');
end.
