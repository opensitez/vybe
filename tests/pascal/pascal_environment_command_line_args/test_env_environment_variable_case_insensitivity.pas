// vybe-test: pascal/pascal_environment_command_line_args/test_env_environment_variable_case_insensitivity
...
begin
  ...
  __p(__vs(GetEnvironmentVariable('casing_var')));
__vybeCheck('CaseTest');
end.
