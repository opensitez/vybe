// vybe-test: pascal/pascal_environment_command_line_args/test_env_getenvironmentvariable_nonexistent
...
uses SysUtils;
begin
  __p(__vs(Length(GetEnvironmentVariable('NON_EXISTENT_VAR_XYZ_99')) = 0));
__vybeCheck('True');
end.
