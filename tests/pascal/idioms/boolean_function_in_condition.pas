// vybe-test: pascal/idioms/boolean_function_in_condition
...
begin
  if InRange(5, 1, 10) then __p(__vs('in range'));
  if not InRange(15, 1, 10) then __p(__vs('out of range'));
__vybeCheck('in range' + #10 + 'out of range');
end.
