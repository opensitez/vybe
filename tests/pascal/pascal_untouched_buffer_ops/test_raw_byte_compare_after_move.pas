// vybe-test: pascal/pascal_untouched_buffer_ops/test_raw_byte_compare_after_move
// origin: languages/pascal/tests/pascal/test_pascal_untouched_buffer_ops.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  __p(__vs(SameBytes(x, y, SizeOf(Integer))));
__vybeCheck('True');
end.
