// vybe-test: pascal/pascal_json_reader_writer/test_jsonobject_nested_object
...
begin
  ...
  __p(__vs((root.Values['address'] as TJSONObject).Values['city'].Value));
  root.Free;
__vybeCheck('Metropolis');
end.
