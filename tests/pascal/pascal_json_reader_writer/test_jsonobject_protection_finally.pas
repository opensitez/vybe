// vybe-test: pascal/pascal_json_reader_writer/test_jsonobject_protection_finally
...
begin
  ...
  try
    ...
    __p(__vs('JSONCreated'));
  finally
    json.Free;
    __p(__vs('JSONFreedInFinally'));
  end;
__vybeCheck('JSONCreated' + #10 + 'JSONFreedInFinally');
end.
