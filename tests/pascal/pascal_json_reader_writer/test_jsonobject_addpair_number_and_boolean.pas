// vybe-test: pascal/pascal_json_reader_writer/test_jsonobject_addpair_number_and_boolean
...
begin
  ...
  __p(__vs(json.Values['id'].Value));
  __p(__vs(json.Values['active'].Value));
  json.Free;
__vybeCheck('101' + #10 + 'true');
end.
