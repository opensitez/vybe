// vybe-test: pascal/pascal_json_reader_writer/test_jsonarray_nested_objects
...
begin
  ...
  __p(__vs((arr.Items[0] as TJSONObject).Values['id'].Value));
  __p(__vs((arr.Items[1] as TJSONObject).Values['id'].Value));
  arr.Free;
__vybeCheck('1' + #10 + '2');
end.
