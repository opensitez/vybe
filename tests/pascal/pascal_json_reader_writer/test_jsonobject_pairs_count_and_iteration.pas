// vybe-test: pascal/pascal_json_reader_writer/test_jsonobject_pairs_count_and_iteration
...
begin
  ...
  __p(__vs(json.Count));
  for pair in json do
    __p(__vs(pair.JsonString.Value + '=' + pair.JsonValue.Value));
  json.Free;
__vybeCheck('2' + #10 + 'a=1' + #10 + 'b=2');
end.
