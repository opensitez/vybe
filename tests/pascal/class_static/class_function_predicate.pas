// vybe-test: pascal/class_static/class_function_predicate
// origin: languages/pascal/tests/pascal/test_class_static.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(TValidator.IsEmail('user@example.com')));
  __p(__vs(TValidator.IsEmail('notanemail')));
  __p(__vs(TValidator.IsPositive(5)));
  __p(__vs(TValidator.IsPositive(-1)));
__vybeCheck('True' + #10 + 'False' + #10 + 'True' + #10 + 'False');
end.
