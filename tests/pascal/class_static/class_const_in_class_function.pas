// vybe-test: pascal/class_static/class_const_in_class_function
...
begin
  __p(__vs(TLimits.IsValidCount(50)));
  __p(__vs(TLimits.IsValidCount(0)));
  __p(__vs(TLimits.IsValidCount(101)));
