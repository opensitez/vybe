// vybe-test: pascal/conditions_switch/case_enum_with_else_via_integer_tag
...
end; type TC=(Red,Green,Blue); var n:Integer; begin n:=9; case TC(n) of Red:__p(__vs('r')); Green:__p(__vs('g')); Blue:__p(__vs('b')); else __p(__vs('?')); end; __vybeCheck('?');
end.
