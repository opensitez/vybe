// vybe-test: pascal/conditions_switch/case_in_loop_dispatch
...
end; var i:Integer; begin for i:=1 to 3 do case i of 1:__p(__vs('a')); 2:__p(__vs('b')); 3:__p(__vs('c')); end; __vybeCheck('a' + #10 + 'b' + #10 + 'c');
end.
