// vybe-test: pascal/conditions_switch/case_statement_sets_variable
...
end; var n,code:Integer; begin n:=3; code:=0; case n of 1:code:=10; 2:code:=20; 3:code:=30; end; __p(__vs(code)); __vybeCheck('30');
end.
