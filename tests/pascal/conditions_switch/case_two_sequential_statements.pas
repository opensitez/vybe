// vybe-test: pascal/conditions_switch/case_two_sequential_statements
...
end; var n:Integer; begin n:=2; case n of 1:__p(__vs('one')); end; case n of 2:__p(__vs('two')); end; __vybeCheck('two');
end.
