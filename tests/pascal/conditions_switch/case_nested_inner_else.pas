// vybe-test: pascal/conditions_switch/case_nested_inner_else
...
end; var a,b:Integer; begin a:=1; b:=9; case a of 1:case b of 2:__p(__vs('two')); else __p(__vs('inner')); end; else __p(__vs('outer')); end; __vybeCheck('inner');
end.
