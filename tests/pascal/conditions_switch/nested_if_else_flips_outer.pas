// vybe-test: pascal/conditions_switch/nested_if_else_flips_outer
...
end; var x,y:Integer; begin x:=0; y:=1; if x=1 then __p(__vs('a')) else if y=1 then __p(__vs('b')) else __p(__vs('c')); __vybeCheck('b');
end.
