// vybe-test: pascal/conditions_switch/case_on_string_first_char
...
end; var s:string; c:Char; begin s:='test'; c:=s[1]; case c of 't':__p(__vs('t')); else __p(__vs('?')); end; __vybeCheck('t');
end.
