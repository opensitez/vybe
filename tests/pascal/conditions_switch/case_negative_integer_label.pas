// vybe-test: pascal/conditions_switch/case_negative_integer_label
...
end; var n:Integer; begin n:=-1; case n of -1:__p(__vs('neg')); 0:__p(__vs('zero')); else __p(__vs('other')); end; __vybeCheck('neg');
end.
