// vybe-test: pascal/conditions_switch/case_in_function_with_else
...
end; function Label(n:Integer):string; begin case n of 0:Result:='zero'; 1:Result:='one'; else Result:='many'; end; end; begin __p(__vs(Label(1))); __p(__vs(Label(8))); __vybeCheck('one' + #10 + 'many');
end.
