// vybe-test: pascal/conditions_switch/if_nested_three_deep
...
end; var a,b,c:Integer; begin a:=1; b:=1; c:=0; if a=1 then if b=1 then if c=0 then __p(__vs('deep')); __vybeCheck('deep');
end.
