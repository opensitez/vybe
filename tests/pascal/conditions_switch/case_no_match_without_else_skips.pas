// vybe-test: pascal/conditions_switch/case_no_match_without_else_skips
...
end; var n:Integer; begin n:=5; case n of 1,2,3:__p(__vs('hit')); end; __p(__vs('after')); __vybeCheck('after');
end.
