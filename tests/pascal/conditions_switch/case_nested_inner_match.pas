// vybe-test: pascal/conditions_switch/case_nested_inner_match
...
end; var a,b:Integer; begin a:=1; b:=2; case a of 1:case b of 2:__p(__vs('ok')); else __p(__vs('no')); end; else __p(__vs('skip')); end; __vybeCheck('ok');
end.
