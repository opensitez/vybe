// vybe-test: pascal/conditions_switch/if_elseif_first_true_short
...
end; var n:Integer; begin n:=1; if n=1 then __p(__vs('first')) else if n=2 then __p(__vs('second')) else __p(__vs('third')); __vybeCheck('first');
end.
