// vybe-test: pascal/conditions_switch/if_elseif_on_char_range
...
end; var c:Char; begin c:='M'; if c<'N' then __p(__vs('before')) else if c='N' then __p(__vs('n')) else __p(__vs('after')); __vybeCheck('before');
end.
