// vybe-test: pascal/conditions_switch/if_nested_case_mixed
...
end; var n:Integer; begin n:=2; if n>0 then case n of 1:__p(__vs('one')); 2:__p(__vs('two')); end else __p(__vs('neg')); __vybeCheck('two');
end.
