// vybe-test: pascal/conditions_switch/if_elseif_else_final_else
...
end; var x:Integer; begin x:=9; if x=1 then __p(__vs('one')) else if x=2 then __p(__vs('two')) else __p(__vs('other')); __vybeCheck('other');
end.
