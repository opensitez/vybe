// vybe-test: pascal/conditions_switch/case_enum_value
...
end; type TS=(Low,High); var s:TS; begin s:=High; case s of Low:__p(__vs('l')); High:__p(__vs('h')); end; __vybeCheck('h');
end.
