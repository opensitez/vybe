// vybe-test: pascal/conditions_switch/case_assign_string_result
...
end; var n:Integer; s:string; begin n:=5; case n of 5:s:='five'; else s:='?'; end; __p(__vs(s)); __vybeCheck('five');
end.
