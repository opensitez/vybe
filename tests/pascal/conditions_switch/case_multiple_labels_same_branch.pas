// vybe-test: pascal/conditions_switch/case_multiple_labels_same_branch
...
end; var d:Integer; begin d:=2; case d of 1,2,3:__p(__vs('small')); 4,5:__p(__vs('big')); end; __vybeCheck('small');
end.
