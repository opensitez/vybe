// vybe-test: pascal/conditions_switch/case_boolean_as_integer_zero_one
...
end; var b:Boolean; begin b:=true; case Ord(b) of 0:__p(__vs('f')); 1:__p(__vs('t')); end; __vybeCheck('t');
end.
