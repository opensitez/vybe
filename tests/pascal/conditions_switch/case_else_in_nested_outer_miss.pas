// vybe-test: pascal/conditions_switch/case_else_in_nested_outer_miss
...
end; var a,b:Integer; begin a:=9; b:=1; case a of 1:case b of 1:__p(__vs('in')); end; else __p(__vs('out')); end; __vybeCheck('out');
end.
