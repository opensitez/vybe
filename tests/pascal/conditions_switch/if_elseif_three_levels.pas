// vybe-test: pascal/conditions_switch/if_elseif_three_levels
...
end; var s:string; begin s:='B'; if s='A' then __p(__vs('alpha')) else if s='B' then __p(__vs('beta')) else if s='C' then __p(__vs('gamma')) else __p(__vs('?')); __vybeCheck('beta');
end.
