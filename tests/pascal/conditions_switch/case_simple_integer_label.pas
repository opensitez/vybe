// vybe-test: pascal/conditions_switch/case_simple_integer_label
...
end; var n:Integer; begin n:=2; case n of 1:__p(__vs('a')); 2:__p(__vs('b')); 3:__p(__vs('c')); end; __vybeCheck('b');
end.
