// vybe-test: pascal/conditions_switch/if_elseif_else_middle_branch
...
end; var x:Integer; begin x:=2; if x=1 then __p(__vs('one')) else if x=2 then __p(__vs('two')) else __p(__vs('other')); __vybeCheck('two');
end.
