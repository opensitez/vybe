// vybe-test: pascal/dynamic_arrays_extended/copy_empty_when_count_zero
...
end; var src,dst:array of Integer; begin src:=[1,2,3]; dst:=Copy(src,2,0); __p(__vs(Length(dst))); __vybeCheck('0');
end.
