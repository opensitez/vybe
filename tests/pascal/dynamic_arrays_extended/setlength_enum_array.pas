// vybe-test: pascal/dynamic_arrays_extended/setlength_enum_array
...
end; type TC=(Red,Green); var a:array of TC; begin SetLength(a,2); a[1]:=Green; __p(__vs(Ord(a[1]))); __vybeCheck('1');
end.
