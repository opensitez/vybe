// vybe-test: pascal/dynamic_arrays_extended/setlength_triple_growth_chain
...
end; var a:array of Integer; begin SetLength(a,1); SetLength(a,2); SetLength(a,3); __p(__vs(Length(a))); __vybeCheck('3');
end.
