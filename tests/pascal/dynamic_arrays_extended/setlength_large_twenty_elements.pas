// vybe-test: pascal/dynamic_arrays_extended/setlength_large_twenty_elements
...
end; var a:array of Integer; begin SetLength(a,20); a[19]:=42; __p(__vs(a[19])); __vybeCheck('42');
end.
