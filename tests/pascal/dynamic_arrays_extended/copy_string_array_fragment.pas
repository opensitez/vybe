// vybe-test: pascal/dynamic_arrays_extended/copy_string_array_fragment
...
end; var src,dst:array of String; begin src:=['a','b','c']; dst:=Copy(src,2,2); __p(__vs(dst[1])); __vybeCheck('c');
end.
