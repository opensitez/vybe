// vybe-test: pascal/dynamic_arrays_extended/dynamic_array_reverse_in_place
...
end; var a:array of Integer; t:Integer; begin a:=[1,2,3]; t:=a[0]; a[0]:=a[2]; a[2]:=t; __p(__vs(a[0])); __p(__vs(a[2])); __vybeCheck('3' + #10 + '1');
end.
