// vybe-test: pascal/dynamic_arrays_extended/setlength_append_slot_pattern
...
end; var a:array of Integer; n:Integer; begin a:=[1,2]; n:=Length(a); SetLength(a,n+1); a[n]:=3; __p(__vs(a[2])); __vybeCheck('3');
end.
