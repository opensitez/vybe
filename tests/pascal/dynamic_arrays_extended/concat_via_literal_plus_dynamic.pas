// vybe-test: pascal/dynamic_arrays_extended/concat_via_literal_plus_dynamic
...
end; var a,b:array of Integer; begin a:=[1]; b:=[2,3]; a:=a+b; __p(__vs(Length(a))); __p(__vs(a[2])); __vybeCheck('3' + #10 + '3');
end.
