// vybe-test: pascal/dynamic_arrays_extended/function_returns_copy_of_input
...
end; function Clone(const a:array of Integer):array of Integer; begin Result:=Copy(a,1,Length(a)); end; var x,y:array of Integer; begin x:=[8,9]; y:=Clone(x); __p(__vs(y[1])); __vybeCheck('9');
end.
