// vybe-test: pascal/dynamic_arrays_extended/dynamic_array_nested_setlength_rows
...
end; var r1,r2:array of Integer; begin SetLength(r1,2); SetLength(r2,3); r2[2]:=5; __p(__vs(r2[2])); __vybeCheck('5');
end.
