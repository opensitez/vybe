// vybe-test: pascal/dynamic_arrays_extended/setlength_shrink_keeps_low_indices
...
end; var a:array of Integer; begin SetLength(a,4); a[0]:=1; a[1]:=2; SetLength(a,2); __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('1' + #10 + '2');
end.
