// vybe-test: pascal/dynamic_arrays_extended/dynamic_array_param_high_bound
...
end; function LastIdx(const a:array of Integer):Integer; begin Result:=High(a); end; var d:array of Integer; begin d:=[0,0,0]; __p(__vs(LastIdx(d))); __vybeCheck('2');
end.
