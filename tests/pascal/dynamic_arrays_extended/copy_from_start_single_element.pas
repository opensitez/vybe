// vybe-test: pascal/dynamic_arrays_extended/copy_from_start_single_element
...
end; var src,dst:array of Integer; begin src:=[5,6,7]; dst:=Copy(src,1,1); __p(__vs(dst[0])); __vybeCheck('5');
end.
