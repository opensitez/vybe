// vybe-test: pascal/dynamic_arrays_extended/concat_three_small_arrays_manual
...
end; var a,b,c,d:array of Integer; begin a:=[1]; b:=[2]; c:=[3]; d:=a+b+c; __p(__vs(d[2])); __vybeCheck('3');
end.
