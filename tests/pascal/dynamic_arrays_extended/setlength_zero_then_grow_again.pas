// vybe-test: pascal/dynamic_arrays_extended/setlength_zero_then_grow_again
...
end; var a:array of Integer; begin a:=[1]; SetLength(a,0); SetLength(a,1); a[0]:=5; __p(__vs(a[0])); __vybeCheck('5');
end.
