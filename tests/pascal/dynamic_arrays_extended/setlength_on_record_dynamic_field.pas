// vybe-test: pascal/dynamic_arrays_extended/setlength_on_record_dynamic_field
...
end; type TB=record Items:array of Integer; end; var b:TB; begin SetLength(b.Items,2); b.Items[1]:=12; __p(__vs(b.Items[1])); __vybeCheck('12');
end.
