// vybe-test: pascal/dynamic_arrays_extended/setlength_string_array_two_items
...
end; var a:array of String; begin SetLength(a,2); a[0]:='foo'; a[1]:='bar'; __p(__vs(a[1])); __vybeCheck('bar');
end.
