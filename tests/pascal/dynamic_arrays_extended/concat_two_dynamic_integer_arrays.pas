// vybe-test: pascal/dynamic_arrays_extended/concat_two_dynamic_integer_arrays
...
end; var a,b,c:array of Integer; begin a:=[1,2]; b:=[3]; SetLength(c,Length(a)+Length(b)); c[0]:=a[0]; c[1]:=a[1]; c[2]:=b[0]; __p(__vs(c[2])); __vybeCheck('3');
end.
