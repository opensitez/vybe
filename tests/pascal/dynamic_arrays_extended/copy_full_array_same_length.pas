// vybe-test: pascal/dynamic_arrays_extended/copy_full_array_same_length
...
end; var src,dst:array of Integer; begin src:=[4,5]; dst:=Copy(src,1,2); __p(__vs(dst[1])); __vybeCheck('5');
end.
