// vybe-test: pascal/dynamic_arrays_extended/concat_empty_with_nonempty
...
end; var a,b:array of Integer; begin SetLength(a,0); b:=[7]; a:=a+b; __p(__vs(a[0])); __vybeCheck('7');
end.
