// vybe-test: pascal/dynamic_arrays_extended/setlength_char_dynamic_array
...
end; var a:array of Char; begin SetLength(a,3); a[0]:='a'; a[1]:='b'; a[2]:='c'; __p(__vs(a[1])); __vybeCheck('b');
end.
