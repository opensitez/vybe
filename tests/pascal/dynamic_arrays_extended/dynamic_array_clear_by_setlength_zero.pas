// vybe-test: pascal/dynamic_arrays_extended/dynamic_array_clear_by_setlength_zero
...
end; var a:array of Integer; begin a:=[1,2,3]; SetLength(a,0); __p(__vs(Length(a))); __vybeCheck('0');
end.
