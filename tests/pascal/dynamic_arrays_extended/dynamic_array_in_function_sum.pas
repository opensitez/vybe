// vybe-test: pascal/dynamic_arrays_extended/dynamic_array_in_function_sum
// origin: languages/pascal/tests/pascal/test_dynamic_arrays_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function Total(const a:array of Integer):Integer; var i:Integer; begin Result:=0; for i:=Low(a) to High(a) do Result:=Result+a[i]; end; var d:array of Integer; begin d:=[1,2,3]; __p(__vs(Total(d))); __vybeCheck('6');
end.
