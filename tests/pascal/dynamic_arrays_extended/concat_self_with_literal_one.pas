// vybe-test: pascal/dynamic_arrays_extended/concat_self_with_literal_one
...
end; var a:array of Integer; begin a:=[1]; a:=a+[2]; __p(__vs(Length(a))); __p(__vs(a[1])); __vybeCheck('2' + #10 + '2');
end.
