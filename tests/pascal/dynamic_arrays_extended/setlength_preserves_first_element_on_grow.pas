// vybe-test: pascal/dynamic_arrays_extended/setlength_preserves_first_element_on_grow
...
end; var a:array of Integer; begin SetLength(a,1); a[0]:=77; SetLength(a,3); __p(__vs(a[0])); __vybeCheck('77');
end.
