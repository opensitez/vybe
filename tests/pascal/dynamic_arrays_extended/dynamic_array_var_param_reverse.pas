// vybe-test: pascal/dynamic_arrays_extended/dynamic_array_var_param_reverse
...
end; procedure Rev(var a:array of Integer); var t:Integer; begin t:=a[0]; a[0]:=a[1]; a[1]:=t; end; var d:array of Integer; begin d:=[3,4]; Rev(d); __p(__vs(d[0])); __vybeCheck('4');
end.
