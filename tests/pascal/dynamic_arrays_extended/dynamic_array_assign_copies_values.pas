// vybe-test: pascal/dynamic_arrays_extended/dynamic_array_assign_copies_values
...
end; var a,b:array of Integer; begin a:=[1,2]; b:=a; b[0]:=9; __p(__vs(a[0])); __p(__vs(b[0])); __vybeCheck('1' + #10 + '9');
end.
