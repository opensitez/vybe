// vybe-test: pascal/dynamic_arrays_extended/setlength_real_array_fill
...
end; var a:array of Double; i:Integer; begin SetLength(a,3); for i:=0 to 2 do a[i]:=1.0; __p(__vs(Round(a[2]))); __vybeCheck('1');
end.
