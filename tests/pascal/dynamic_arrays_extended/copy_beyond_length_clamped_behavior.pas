// vybe-test: pascal/dynamic_arrays_extended/copy_beyond_length_clamped_behavior
...
end; var src,dst:array of Integer; begin src:=[1,2]; dst:=Copy(src,2,5); __p(__vs(Length(dst))); __vybeCheck('1');
end.
