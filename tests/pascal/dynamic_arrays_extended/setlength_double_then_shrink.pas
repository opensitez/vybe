// vybe-test: pascal/dynamic_arrays_extended/setlength_double_then_shrink
...
end; var a:array of Integer; begin SetLength(a,4); SetLength(a,2); __p(__vs(Length(a))); __vybeCheck('2');
end.
