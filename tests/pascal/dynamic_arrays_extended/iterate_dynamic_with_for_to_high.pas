// vybe-test: pascal/dynamic_arrays_extended/iterate_dynamic_with_for_to_high
...
end; var a:array of Integer; i:Integer; begin a:=[2,4,6]; for i:=0 to High(a) do __p(__vs(a[i])); __vybeCheck('2' + #10 + '4' + #10 + '6');
end.
