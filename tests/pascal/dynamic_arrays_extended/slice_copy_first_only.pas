// vybe-test: pascal/dynamic_arrays_extended/slice_copy_first_only
...
end; var src,dst:array of Integer; begin src:=[9,8,7]; dst:=Copy(src,1,1); __p(__vs(dst[0])); __vybeCheck('9');
end.
