// vybe-test: pascal/dynamic_arrays_extended/copy_dynamic_slice_middle_two
...
end; var src,dst:array of Integer; begin src:=[10,20,30,40]; dst:=Copy(src,2,2); __p(__vs(dst[0])); __p(__vs(dst[1])); __vybeCheck('20' + #10 + '30');
end.
