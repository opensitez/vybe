// vybe-test: pascal/class_inheritance/protected_member_visible_in_descendant
...
end; type TBase=class strict protected F:Integer; public function Get:Integer; end; TChild=class(TBase) procedure Set(v:Integer); end; function TBase.Get:Integer; begin Result:=F; end; procedure TChild.Set(v:Integer); begin F:=v; end; var c:TChild; begin c:=TChild.Create; c.Set(6); __p(__vs(c.Get)); c.Free; __vybeCheck('6');
end.
