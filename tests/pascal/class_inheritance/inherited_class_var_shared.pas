// vybe-test: pascal/class_inheritance/inherited_class_var_shared
...
end; type TBase=class public class var Hits:Integer; end; TChild=class(TBase); class var TBase.Hits:Integer; begin TBase.Hits:=0; Inc(TChild.Hits); __p(__vs(TBase.Hits)); __vybeCheck('1');
end.
