// vybe-test: pascal/class_inheritance/class_cast_as_child
...
end; type TBase=class public V:Integer; end; TChild=class(TBase); var b:TBase; c:TChild; begin b:=TChild.Create; b.V:=9; c:=TChild(b); __p(__vs(c.V)); c.Free; __vybeCheck('9');
end.
