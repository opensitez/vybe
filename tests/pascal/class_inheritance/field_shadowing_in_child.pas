// vybe-test: pascal/class_inheritance/field_shadowing_in_child
...
end; type TBase=class public X:Integer; end; TChild=class(TBase) public Y:Integer; end; var c:TChild; begin c:=TChild.Create; c.X:=1; c.Y:=2; __p(__vs(c.X+c.Y)); c.Free; __vybeCheck('3');
end.
