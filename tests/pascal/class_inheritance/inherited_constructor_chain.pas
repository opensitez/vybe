// vybe-test: pascal/class_inheritance/inherited_constructor_chain
...
end; type TBase=class public Value:Integer; constructor Create(v:Integer); end; TChild=class(TBase) constructor Create(v:Integer); end; constructor TBase.Create(v:Integer); begin Value:=v; end; constructor TChild.Create(v:Integer); begin inherited Create(v+1); end; var c:TChild; begin c:=TChild.Create(4); __p(__vs(c.Value)); c.Free; __vybeCheck('5');
end.
