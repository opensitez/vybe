// vybe-test: pascal/class_inheritance/sibling_classes_do_not_share_overrides
// origin: languages/pascal/tests/pascal/test_class_inheritance.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TBase=class public function N:Integer; virtual; end; TA=class(TBase) function N:Integer; override; end; TB=class(TBase) function N:Integer; override; end; function TBase.N:Integer; begin Result:=0; end; function TA.N:Integer; begin Result:=1; end; function TB.N:Integer; begin Result:=2; end; var a:TA; b:TB; begin a:=TA.Create; b:=TB.Create; __p(__vs(a.N)); __p(__vs(b.N)); a.Free; b.Free; __vybeCheck('1' + #10 + '2');
end.
