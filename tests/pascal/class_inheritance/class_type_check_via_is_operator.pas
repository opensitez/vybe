// vybe-test: pascal/class_inheritance/class_type_check_via_is_operator
...
end; type TBase=class end; TChild=class(TBase); var b:TBase; begin b:=TChild.Create; if b is TChild then __p(__vs('yes')); b.Free; __vybeCheck('yes');
end.
