// vybe-test: pascal/class_inheritance/base_reference_virtual_dispatch
...
end; type TBase=class public function Id:Integer; virtual; end; TChild=class(TBase) function Id:Integer; override; end; function TBase.Id:Integer; begin Result:=1; end; function TChild.Id:Integer; begin Result:=2; end; var b:TBase; begin b:=TChild.Create; __p(__vs(b.Id)); b.Free; __vybeCheck('2');
end.
