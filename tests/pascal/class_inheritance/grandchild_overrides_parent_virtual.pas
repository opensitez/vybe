// vybe-test: pascal/class_inheritance/grandchild_overrides_parent_virtual
...
end; type TA=class public function F:Integer; virtual; end; TB=class(TA) end; TC=class(TB) function F:Integer; override; end; function TA.F:Integer; begin Result:=1; end; function TC.F:Integer; begin Result:=3; end; var o:TA; begin o:=TC.Create; __p(__vs(o.F)); o.Free; __vybeCheck('3');
end.
