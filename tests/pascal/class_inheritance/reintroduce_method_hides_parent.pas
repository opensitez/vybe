// vybe-test: pascal/class_inheritance/reintroduce_method_hides_parent
...
end; type TBase=class public function Name:string; virtual; end; TChild=class(TBase) function Name:string; reintroduce; end; function TBase.Name:string; begin Result:='base'; end; function TChild.Name:string; begin Result:='child'; end; var c:TChild; begin c:=TChild.Create; __p(__vs(c.Name)); c.Free; __vybeCheck('child');
end.
