// vybe-test: pascal/class_inheritance/inherited_property_reader
...
end; type TBase=class private F:Integer; public property N:Integer read F write F; end; TChild=class(TBase); var c:TChild; begin c:=TChild.Create; c.N:=12; __p(__vs(c.N)); c.Free; __vybeCheck('12');
end.
