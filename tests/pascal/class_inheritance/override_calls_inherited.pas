// vybe-test: pascal/class_inheritance/override_calls_inherited
...
end; type TBase=class public function Twice(n:Integer):Integer; virtual; end; TChild=class(TBase) function Twice(n:Integer):Integer; override; end; function TBase.Twice(n:Integer):Integer; begin Result:=n*2; end; function TChild.Twice(n:Integer):Integer; begin Result:=inherited Twice(n)+1; end; var c:TChild; begin c:=TChild.Create; __p(__vs(c.Twice(3))); c.Free; __vybeCheck('7');
end.
