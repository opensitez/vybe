// vybe-test: pascal/class_inheritance/parent_method_not_overridden_keeps_base_behavior
...
end; type TBase=class public function Val:Integer; virtual; end; TChild=class(TBase) function Other:Integer; end; function TBase.Val:Integer; begin Result:=10; end; function TChild.Other:Integer; begin Result:=20; end; var c:TChild; begin c:=TChild.Create; __p(__vs(c.Val)); c.Free; __vybeCheck('10');
end.
