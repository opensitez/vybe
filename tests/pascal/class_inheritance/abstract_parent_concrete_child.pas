// vybe-test: pascal/class_inheritance/abstract_parent_concrete_child
...
end; type TBase=class abstract public function Run:Integer; virtual; abstract; end; TChild=class(TBase) function Run:Integer; override; end; function TChild.Run:Integer; begin Result:=5; end; var b:TBase; begin b:=TChild.Create; __p(__vs(b.Run)); b.Free; __vybeCheck('5');
end.
