// vybe-test: pascal/class_inheritance/inherited_field_visible_in_child
...
end; type TBase=class public Value:Integer; end; TChild=class(TBase); var c:TChild; begin c:=TChild.Create; c.Value:=8; __p(__vs(c.Value)); c.Free; __vybeCheck('8');
end.
