// vybe-test: pascal/class_inheritance/deep_inheritance_three_levels
...
end; type TA=class public function L:Integer; virtual; end; TB=class(TA) function L:Integer; override; end; TC=class(TB) function L:Integer; override; end; function TA.L:Integer; begin Result:=1; end; function TB.L:Integer; begin Result:=2; end; function TC.L:Integer; begin Result:=3; end; var o:TA; begin o:=TC.Create; __p(__vs(o.L)); o.Free; __vybeCheck('3');
end.
