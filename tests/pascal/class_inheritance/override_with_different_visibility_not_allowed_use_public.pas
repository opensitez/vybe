// vybe-test: pascal/class_inheritance/override_with_different_visibility_not_allowed_use_public
...
end; type TBase=class public procedure Ping; virtual; end; TChild=class(TBase) public procedure Ping; override; end; procedure TBase.Ping; begin __p(__vs('base')); end; procedure TChild.Ping; begin __p(__vs('child')); end; var b:TBase; begin b:=TChild.Create; b.Ping; b.Free; __vybeCheck('child');
end.
