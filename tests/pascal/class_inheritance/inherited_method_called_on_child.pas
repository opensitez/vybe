// vybe-test: pascal/class_inheritance/inherited_method_called_on_child
...
end; type TBase=class public function Tag:string; virtual; end; TChild=class(TBase) function Tag:string; override; end; function TBase.Tag:string; begin Result:='base'; end; function TChild.Tag:string; begin Result:='child'; end; var c:TChild; begin c:=TChild.Create; __p(__vs(c.Tag)); c.Free; __vybeCheck('child');
end.
