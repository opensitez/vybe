// vybe-test: pascal/class_inheritance/interface_inheritance_on_classes
...
end; type ICore=interface function Core:Integer; end; TBase=class(TInterfacedObject,ICore) function Core:Integer; virtual; end; TChild=class(TBase) function Core:Integer; override; end; function TBase.Core:Integer; begin Result:=1; end; function TChild.Core:Integer; begin Result:=2; end; var i:ICore; begin i:=TChild.Create; __p(__vs(i.Core)); __vybeCheck('2');
end.
