// vybe-test: pascal/pascal_date_time_sysutils/test_datetime_isleapyear
// origin: languages/pascal/tests/pascal/test_pascal_date_time_sysutils.rs
program Test;
{$mode delphi}
...
uses SysUtils;
begin
  __p(__vs(IsLeapYear(2024)));
  __p(__vs(IsLeapYear(2025)));
  __p(__vs(IsLeapYear(2000)));
  __p(__vs(IsLeapYear(1900)));
