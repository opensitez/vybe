// vybe-test: pascal/pascal_date_time_sysutils/test_datetime_encode_decode_time
...
begin
  ...
  __p(__vs(h.ToString + ':' + m.ToString + ':' + s.ToString + '.' + ms.ToString));
__vybeCheck('14:30:45.500');
end.
