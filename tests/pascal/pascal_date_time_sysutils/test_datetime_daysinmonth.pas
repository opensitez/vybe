// vybe-test: pascal/pascal_date_time_sysutils/test_datetime_daysinmonth
...
uses DateUtils;
begin
  __p(__vs(DaysInMonth(EncodeDate(2024, 2, 1)))); // Leap year
  __p(__vs(DaysInMonth(EncodeDate(2025, 2, 1)))); // Non-leap
__vybeCheck('29' + #10 + '28');
end.
