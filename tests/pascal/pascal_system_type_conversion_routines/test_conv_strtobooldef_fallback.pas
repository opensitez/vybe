// vybe-test: pascal/pascal_system_type_conversion_routines/test_conv_strtobooldef_fallback
...
uses SysUtils;
begin
  __p(__vs(StrToBoolDef('True', False)));
  __p(__vs(StrToBoolDef('Invalid', False)));
