// vybe-test: pascal/pascal_system_type_conversion_routines/test_conv_strtofloatdef_fallback
...
uses SysUtils;
begin
  __p(__vs(StrToFloatDef('3.14', 0.0) = 3.14));
  __p(__vs(StrToFloatDef('NotAFloat', 0.0) = 0.0));
