// vybe-test: pascal/pascal_system_type_conversion_routines/test_conv_inttohex
// origin: languages/pascal/tests/pascal/test_pascal_system_type_conversion_routines.rs
program Test;
{$mode delphi}
...
uses SysUtils;
begin
  __p(__vs(IntToHex(255, 2)));
  __p(__vs(IntToHex(255, 4)));
  __p(__vs(IntToHex(4096, 4)));
__vybeCheck('FF' + #10 + '00FF' + #10 + '1000');
end.
