// vybe-test: pascal/pascal_system_type_conversion_routines/test_conv_strtocurrdef
...
uses SysUtils;
begin
  __p(__vs(StrToCurrDef('49.99', 0.0) = 49.99));
  __p(__vs(StrToCurrDef('invalid', 0.0) = 0.0));
