// vybe-test: pascal/type_system/succ_advances_enum_value
// origin: languages/pascal/tests/pascal/test_type_system.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TColor = (Red, Green, Blue); var c: TColor; begin c := Red; c := Succ(c); __p(__vs(Ord(c))); __vybeCheck('1');
end.
