// vybe-test: pascal/control_flow/for_downto_skips_when_start_below_end
...
end; var i: Integer; begin for i := 1 downto 4 do __p(__vs(i)); __p(__vs('skip')); __vybeCheck('skip');
end.
