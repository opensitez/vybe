// vybe-test: pascal/control_flow/if_nested
// origin: languages/pascal/tests/pascal/test_control_flow.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var x: Integer; begin x := 10;
      if x > 5 then if x > 8 then __p(__vs('big')) else __p(__vs('med')) else __p(__vs('small')); __vybeCheck('big');
end.
