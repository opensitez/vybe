// vybe-test: pascal/pascal_unicodestring_widestring/test_widestring_to_unicodestring_conversion
// origin: languages/pascal/tests/pascal/test_pascal_unicodestring_widestring.rs
program Test;
{$mode delphi}
uses SysUtils;
