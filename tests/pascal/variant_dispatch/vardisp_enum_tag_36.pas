// vybe-test: pascal/variant_dispatch/vardisp_enum_tag_36
...
end; type TK=(One,Two,Three); type TV=record case Kind:TK of One:(N:Integer); Two:(T:string); Three:(C:Integer); end; var v:TV; begin v.Kind:=Three; v.C:=136; __p(__vs(v.C)); __vybeCheck('136');
end.
