// vybe-test: pascal/variant_dispatch/vardisp_enum_tag_30
...
end; type TK=(One,Two,Three); type TV=record case Kind:TK of One:(N:Integer); Two:(T:string); Three:(C:Integer); end; var v:TV; begin v.Kind:=Three; v.C:=130; __p(__vs(v.C)); __vybeCheck('130');
end.
