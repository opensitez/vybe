// vybe-test: pascal/variant_dispatch/vardisp_case_tag_23
...
end; type TV=record case K:Integer of 0:(A:Integer); 1:(B:Integer); 2:(C:Integer); end; procedure Show(const v:TV); begin case v.K of 0:__p(__vs(v.A)); 1:__p(__vs(v.B)); 2:__p(__vs(v.C)); end; end; var x:TV; begin x.K:=2; x.C:=161; Show(x); __vybeCheck('161');
end.
