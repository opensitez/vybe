// vybe-test: pascal/variant_dispatch/vardisp_rec_int_arm_21
...
end; type TV=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TV; begin v.K:=0; v.I:=21; __p(__vs(v.I)); __vybeCheck('21');
end.
