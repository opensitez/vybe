// vybe-test: pascal/variant_dispatch/vardisp_rec_int_arm_3
...
end; type TV=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TV; begin v.K:=0; v.I:=3; __p(__vs(v.I)); __vybeCheck('3');
end.
