// vybe-test: pascal/variant_dispatch/vardisp_rec_str_arm_16
...
end; type TV=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TV; begin v.K:=1; v.S:='arm16'; __p(__vs(v.S)); __vybeCheck('arm16');
end.
