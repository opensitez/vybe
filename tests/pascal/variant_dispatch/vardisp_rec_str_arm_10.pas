// vybe-test: pascal/variant_dispatch/vardisp_rec_str_arm_10
...
end; type TV=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TV; begin v.K:=1; v.S:='arm10'; __p(__vs(v.S)); __vybeCheck('arm10');
end.
