// vybe-test: pascal/math_trig_extra/sin_squared_plus_cos_squared_various
// origin: languages/pascal/tests/pascal/test_math_trig_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var t:Real; begin t:=1.1; __p(__vs(Trunc((Sin(t)*Sin(t)+Cos(t)*Cos(t))*1000))); __vybeCheck('1000');
end.
