// vybe-test: pascal/gui_constructor_patterns/inherited_constructor_calls_parent
// origin: languages/pascal/tests/pascal/gui_constructor_patterns.rs
program Test;
{$mode delphi}
uses SysUtils;
...
var d: TDerived;
begin d := TDerived.Create; __p(__vs(d.FVal)); __vybeCheck('42');
end.
