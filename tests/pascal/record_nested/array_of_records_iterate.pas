// vybe-test: pascal/record_nested/array_of_records_iterate
// origin: languages/pascal/tests/pascal/test_record_nested.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  for i := 1 to 3 do
    __p(__vs(students[i].Name + ': ' + IntToStr(students[i].Score)));
__vybeCheck('Alice: 95' + #10 + 'Bob: 80' + #10 + 'Carol: 88');
end.
