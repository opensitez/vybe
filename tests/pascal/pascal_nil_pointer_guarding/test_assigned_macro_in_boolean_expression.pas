// vybe-test: pascal/pascal_nil_pointer_guarding/test_assigned_macro_in_boolean_expression
...
begin
  ...
  x := 10;
  p2 := @x;
  __p(__vs(Assigned(p1) or Assigned(p2)));
  __p(__vs(Assigned(p1) and Assigned(p2)));
