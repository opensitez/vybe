// vybe-test: pascal/pascal_nil_pointer_guarding/test_short_circuit_eval_prevents_nil_crash
// origin: languages/pascal/tests/pascal/test_pascal_nil_pointer_guarding.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  p := nil;
  if (p <> nil) and (p^ = 100) then __p(__vs('Unreachable'))
  else __p(__vs('ShortCircuitSafe'));
__vybeCheck('ShortCircuitSafe');
end.
