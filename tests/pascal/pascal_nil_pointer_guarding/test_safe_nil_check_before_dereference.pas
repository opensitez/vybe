// vybe-test: pascal/pascal_nil_pointer_guarding/test_safe_nil_check_before_dereference
...
begin
  p := nil;
  if p <> nil then __p(__vs(p^))
  else __p(__vs('NilGuarded'));
__vybeCheck('NilGuarded');
end.
