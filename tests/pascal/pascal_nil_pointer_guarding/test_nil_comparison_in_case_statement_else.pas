// vybe-test: pascal/pascal_nil_pointer_guarding/test_nil_comparison_in_case_statement_else
...
begin
  p := nil;
  if p = nil then __p(__vs('BranchNil'))
  else __p(__vs('BranchAssigned'));
__vybeCheck('BranchNil');
end.
