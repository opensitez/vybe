// vybe-test: pascal/programs/prog_fizzbuzz
// origin: languages/pascal/tests/pascal/test_programs.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; __vybeCheck('1' + #10 + '2' + #10 + 'Fizz' + #10 + '4' + #10 + 'Buzz' + #10 + 'Fizz' + #10 + '7' + #10 + '8' + #10 + 'Fizz' + #10 + 'Buzz' + #10 + '11' + #10 + 'Fizz' + #10 + '13' + #10 + '14' + #10 + 'FizzBuzz');
end.
