// vybe-test: pascal/lambdas_anonymous/anonymous_function_real_arithmetic
...
end; var f:function(a,b:Double):Double; begin f:=function(a,b:Double):Double begin Result:=a+b; end; __p(__vs(Round(f(1.2,2.3)))); __vybeCheck('4');
end.
