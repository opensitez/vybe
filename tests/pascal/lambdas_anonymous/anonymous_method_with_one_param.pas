// vybe-test: pascal/lambdas_anonymous/anonymous_method_with_one_param
...
end; var f:function(n:Integer):Integer; begin f:=function(n:Integer):Integer begin Result:=n*n; end; __p(__vs(f(6))); __vybeCheck('36');
end.
