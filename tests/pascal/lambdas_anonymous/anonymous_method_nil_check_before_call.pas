// vybe-test: pascal/lambdas_anonymous/anonymous_method_nil_check_before_call
...
end; var p:procedure; begin if Assigned(p) then p else __p(__vs('nil')); __vybeCheck('nil');
end.
