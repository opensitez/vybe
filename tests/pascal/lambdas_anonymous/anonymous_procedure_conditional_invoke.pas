// vybe-test: pascal/lambdas_anonymous/anonymous_procedure_conditional_invoke
...
end; var p:procedure; ok:Boolean; begin ok:=true; p:=procedure begin __p(__vs('yes')); end; if ok then p; __vybeCheck('yes');
end.
