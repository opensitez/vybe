// vybe-test: pascal/lambdas_anonymous/anonymous_function_string_concat
...
end; var f:function(s:string):string; begin f:=function(s:string):string begin Result:=s+'!'; end; __p(__vs(f('go'))); __vybeCheck('go!');
end.
