// vybe-test: pascal/lambdas_anonymous/anonymous_method_in_class_field
...
end; type TBox=class public Fn:procedure; end; var b:TBox; begin b:=TBox.Create; b.Fn:=procedure begin __p(__vs('inbox')); end; b.Fn; b.Free; __vybeCheck('inbox');
end.
