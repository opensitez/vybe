// vybe-test: pascal/lambdas_anonymous/anonymous_procedure_twice_invocation
...
end; var p:procedure; begin p:=procedure begin __p(__vs('x')); end; p; p; __vybeCheck('x' + #10 + 'x');
end.
