// vybe-test: pascal/lambdas_anonymous/anonymous_procedure_assigned_to_variable
...
end; var a,b:procedure; begin a:=procedure begin __p(__vs('a')); end; b:=a; b; __vybeCheck('a');
end.
