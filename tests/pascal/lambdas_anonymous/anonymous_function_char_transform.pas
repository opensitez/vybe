// vybe-test: pascal/lambdas_anonymous/anonymous_function_char_transform
...
end; var f:function(c:Char):Char; begin f:=function(c:Char):Char begin Result:=UpCase(c); end; __p(__vs(f('z'))); __vybeCheck('Z');
end.
