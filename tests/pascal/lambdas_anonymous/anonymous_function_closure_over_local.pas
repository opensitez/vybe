// vybe-test: pascal/lambdas_anonymous/anonymous_function_closure_over_local
...
end; function MakeAdder(k:Integer):function(n:Integer):Integer; begin Result:=function(n:Integer):Integer begin Result:=n+k; end; end; var f:function(n:Integer):Integer; begin f:=MakeAdder(3); __p(__vs(f(4))); __vybeCheck('7');
end.
