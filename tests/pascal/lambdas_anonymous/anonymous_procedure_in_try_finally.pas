// vybe-test: pascal/lambdas_anonymous/anonymous_procedure_in_try_finally
...
end; var p:procedure; begin p:=procedure begin __p(__vs('run')); end; try p; finally __p(__vs('done')); end; __vybeCheck('run' + #10 + 'done');
end.
