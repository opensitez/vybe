// vybe-test: pascal/lambdas_anonymous/anonymous_function_compose_two
...
end; function Compose(f,g:function(n:Integer):Integer):function(n:Integer):Integer; begin Result:=function(n:Integer):Integer begin Result:=f(g(n)); end; end; var h:function(n:Integer):Integer; begin h:=Compose(function(n:Integer):Integer begin Result:=n+1; end, function(n:Integer):Integer begin Result:=n*2; end); __p(__vs(h(3))); __vybeCheck('7');
end.
