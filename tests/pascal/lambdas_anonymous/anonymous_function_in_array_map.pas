// vybe-test: pascal/lambdas_anonymous/anonymous_function_in_array_map
...
end; procedure Map(const a:array of Integer; fn:function(n:Integer):Integer); var i:Integer; begin for i:=Low(a) to High(a) do __p(__vs(fn(a[i]))); end; begin Map([1,2,3], function(n:Integer):Integer begin Result:=n+10; end); __vybeCheck('11' + #10 + '12' + #10 + '13');
end.
