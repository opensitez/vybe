// vybe-test: pascal/lambdas_anonymous/anonymous_method_stored_in_record
...
end; type TWrap=record Fn:function:Integer; end; var w:TWrap; begin w.Fn:=function:Integer begin Result:=5; end; __p(__vs(w.Fn())); __vybeCheck('5');
end.
