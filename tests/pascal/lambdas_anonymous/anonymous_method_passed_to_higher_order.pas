// vybe-test: pascal/lambdas_anonymous/anonymous_method_passed_to_higher_order
...
end; procedure Twice(fn:procedure); begin fn; fn; end; begin Twice(procedure begin __p(__vs('t')); end); __vybeCheck('t' + #10 + 't');
end.
