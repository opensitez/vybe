// vybe-test: pascal/lambdas_anonymous/anonymous_function_returns_value
...
end; var f:function:Integer; begin f:=function:Integer begin Result:=99; end; __p(__vs(f())); __vybeCheck('99');
end.
