// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_remove_frees_object
...
destructor TItem.Destroy; begin __p(__vs('RemovedAndFreed')); inherited Destroy; end;
...
begin
  ...
  __p(__vs(list.Count));
  list.Free;
__vybeCheck('RemovedAndFreed' + #10 + '0');
end.
