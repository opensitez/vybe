// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_delete_frees_owned_object
...
destructor TWidget.Destroy; begin __p(__vs('WidgetDestroyed:' + Tag)); inherited Destroy; end;
...
begin
  ...
  list.Delete(0);
  __p(__vs('AfterDelete'));
  list.Free;
__vybeCheck('WidgetDestroyed:W1' + #10 + 'AfterDelete' + #10 + 'WidgetDestroyed:W2');
end.
