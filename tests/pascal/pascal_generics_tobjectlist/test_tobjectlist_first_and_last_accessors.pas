// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_first_and_last_accessors
...
begin
  ...
  __p(__vs(list.First.Name));
  __p(__vs(list.Last.Name));
  list.Free;
__vybeCheck('FirstEl' + #10 + 'LastEl');
end.
