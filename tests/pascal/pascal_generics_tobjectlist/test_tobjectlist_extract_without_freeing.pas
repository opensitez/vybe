// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_extract_without_freeing
...
destructor TItem.Destroy; begin __p(__vs('ItemFreed:' + Code.ToString)); inherited Destroy; end;
...
begin
  ...
  __p(__vs(list.Count));
  __p(__vs(extracted.Code));
  list.Free;
  extracted.Free;
__vybeCheck('0' + #10 + '100' + #10 + 'ItemFreed:100');
end.
