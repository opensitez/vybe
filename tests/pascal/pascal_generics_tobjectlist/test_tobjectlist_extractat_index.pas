// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_extractat_index
...
destructor TItem.Destroy; begin __p(__vs('ItemFreed:' + Val.ToString)); inherited Destroy; end;
...
begin
  ...
  __p(__vs(extracted.Val));
  __p(__vs(list.Count));
  extracted.Free;
  list.Free;
__vybeCheck('10' + #10 + '1' + #10 + 'ItemFreed:10' + #10 + 'ItemFreed:20');
end.
