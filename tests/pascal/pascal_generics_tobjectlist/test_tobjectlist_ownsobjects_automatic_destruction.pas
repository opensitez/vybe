// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_ownsobjects_automatic_destruction
...
destructor TSampleItem.Destroy; begin __p(__vs('FreedItem:' + ID.ToString)); inherited Destroy; end;
...
begin
  ...
  list.Free;
__vybeCheck('FreedItem:1' + #10 + 'FreedItem:2');
end.
