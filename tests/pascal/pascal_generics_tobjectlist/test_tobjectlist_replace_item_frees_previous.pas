// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_replace_item_frees_previous
...
destructor TData.Destroy; begin __p(__vs('ReplacedFreed:' + LabelStr)); inherited Destroy; end;
...
begin
  ...
  __p(__vs(list[0].LabelStr));
  list.Free;
__vybeCheck('ReplacedFreed:Old' + #10 + 'New' + #10 + 'ReplacedFreed:New');
end.
