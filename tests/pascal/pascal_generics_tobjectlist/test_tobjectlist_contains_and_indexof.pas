// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_contains_and_indexof
...
begin
  ...
  list.Add(o1);
  __p(__vs(list.Contains(o1)));
  __p(__vs(list.Contains(o2)));
  __p(__vs(list.IndexOf(o1)));
  list.Free;
  o2.Free;
__vybeCheck('True' + #10 + 'False' + #10 + '0');
end.
