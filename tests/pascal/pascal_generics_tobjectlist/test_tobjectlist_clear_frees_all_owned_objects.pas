// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_clear_frees_all_owned_objects
...
destructor TNode.Destroy; begin __p(__vs('NodeCleared')); inherited Destroy; end;
...
begin
  ...
  __p(__vs(list.Count));
  list.Free;
__vybeCheck('NodeCleared' + #10 + 'NodeCleared' + #10 + '0');
end.
