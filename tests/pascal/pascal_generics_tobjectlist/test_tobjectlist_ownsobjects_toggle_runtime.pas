// vybe-test: pascal/pascal_generics_tobjectlist/test_tobjectlist_ownsobjects_toggle_runtime
...
destructor TItem.Destroy; begin __p(__vs('ToggledFreed')); inherited Destroy; end;
