// vybe-test: pascal/array_algorithms/two_array_dot_product
...
end; function Dot(const u,v:array of Integer):Integer; var i:Integer; begin Result:=0; for i:=0 to High(u) do Result:=Result+u[i]*v[i]; end; var a,b:array[0..2] of Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; b[0]:=4; b[1]:=5; b[2]:=6; __p(__vs(Dot(a,b))); __vybeCheck('32');
end.
