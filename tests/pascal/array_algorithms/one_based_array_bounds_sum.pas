// vybe-test: pascal/array_algorithms/one_based_array_bounds_sum
...
end; var a:array[1..4] of Integer; i,s:Integer; begin for i:=1 to 4 do a[i]:=i; s:=0; for i:=Low(a) to High(a) do s:=s+a[i]; __p(__vs(s)); __vybeCheck('10');
end.
