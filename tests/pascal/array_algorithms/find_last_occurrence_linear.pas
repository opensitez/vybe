// vybe-test: pascal/array_algorithms/find_last_occurrence_linear
...
end; function Last(const a:array of Integer; v:Integer):Integer; var i:Integer; begin Result:=-1; for i:=0 to High(a) do if a[i]=v then Result:=i; end; var arr:array[0..4] of Integer; begin arr[0]:=1; arr[1]:=2; arr[2]:=2; arr[3]:=2; arr[4]:=3; __p(__vs(Last(arr,2))); __vybeCheck('3');
end.
