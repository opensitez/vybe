// vybe-test: pascal/array_algorithms/array_rotate_right_one
...
end; var a:array[0..3] of Integer; t:Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; a[3]:=4; t:=a[3]; a[3]:=a[2]; a[2]:=a[1]; a[1]:=a[0]; a[0]:=t; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('4' + #10 + '1');
end.
