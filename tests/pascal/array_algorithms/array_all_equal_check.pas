// vybe-test: pascal/array_algorithms/array_all_equal_check
...
end; function AllEq(const a:array of Integer; v:Integer):Boolean; var i:Integer; begin Result:=true; for i:=0 to High(a) do if a[i]<>v then Result:=false; end; var arr:array[0..2] of Integer; begin arr[0]:=5; arr[1]:=5; arr[2]:=5; __p(__vs(AllEq(arr,5))); __vybeCheck('True');
end.
