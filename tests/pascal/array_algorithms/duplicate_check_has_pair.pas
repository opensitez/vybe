// vybe-test: pascal/array_algorithms/duplicate_check_has_pair
...
end; function HasDup(const a:array of Integer):Boolean; var i,j:Integer; begin Result:=false; for i:=0 to High(a) do for j:=i+1 to High(a) do if a[i]=a[j] then Result:=true; end; var arr:array[0..3] of Integer; begin arr[0]:=1; arr[1]:=2; arr[2]:=2; arr[3]:=3; __p(__vs(HasDup(arr))); __vybeCheck('True');
end.
