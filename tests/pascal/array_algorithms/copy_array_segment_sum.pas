// vybe-test: pascal/array_algorithms/copy_array_segment_sum
...
end; var src:array[1..5] of Integer; i,s:Integer; begin for i:=1 to 5 do src[i]:=i; s:=0; for i:=2 to 4 do s:=s+src[i]; __p(__vs(s)); __vybeCheck('9');
end.
