// vybe-test: pascal/array_algorithms/linear_search_found_middle
...
end; function Find(const a:array of Integer; v:Integer):Integer; var i:Integer; begin Result:=-1; for i:=0 to High(a) do if a[i]=v then Result:=i; end; var arr:array[0..4] of Integer; begin arr[0]:=3; arr[1]:=7; arr[2]:=9; arr[3]:=2; arr[4]:=5; __p(__vs(Find(arr,9))); __vybeCheck('2');
end.
