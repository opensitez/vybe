// vybe-test: pascal/array_algorithms/count_occurrences_value
...
end; function Count(const a:array of Integer; v:Integer):Integer; var i:Integer; begin Result:=0; for i:=0 to High(a) do if a[i]=v then Inc(Result); end; var arr:array[0..4] of Integer; begin arr[0]:=2; arr[1]:=2; arr[2]:=3; arr[3]:=2; arr[4]:=1; __p(__vs(Count(arr,2))); __vybeCheck('3');
end.
