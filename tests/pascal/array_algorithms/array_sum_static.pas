// vybe-test: pascal/array_algorithms/array_sum_static
...
end; function Sum(const a:array of Integer):Integer; var i:Integer; begin Result:=0; for i:=0 to High(a) do Result:=Result+a[i]; end; var arr:array[0..3] of Integer; begin arr[0]:=1; arr[1]:=2; arr[2]:=3; arr[3]:=4; __p(__vs(Sum(arr))); __vybeCheck('10');
end.
