// vybe-test: pascal/array_algorithms/array_index_of_min
...
end; function IdxMin(const a:array of Integer):Integer; var i,m:Integer; begin m:=0; for i:=1 to High(a) do if a[i]<a[m] then m:=i; Result:=m; end; var arr:array[0..3] of Integer; begin arr[0]:=5; arr[1]:=2; arr[2]:=8; arr[3]:=1; __p(__vs(IdxMin(arr))); __vybeCheck('3');
end.
