// vybe-test: pascal/array_algorithms/array_is_sorted_ascending
...
end; function Sorted(const a:array of Integer):Boolean; var i:Integer; begin Result:=true; for i:=0 to High(a)-1 do if a[i]>a[i+1] then Result:=false; end; var arr:array[0..3] of Integer; begin arr[0]:=1; arr[1]:=2; arr[2]:=2; arr[3]:=4; __p(__vs(Sorted(arr))); __vybeCheck('True');
end.
