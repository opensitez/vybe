// vybe-test: pascal/array_algorithms/find_first_greater_than
...
end; function FirstGT(const a:array of Integer; v:Integer):Integer; var i:Integer; begin Result:=-1; for i:=0 to High(a) do if a[i]>v then begin Result:=i; Break; end; end; var arr:array[0..3] of Integer; begin arr[0]:=1; arr[1]:=3; arr[2]:=3; arr[3]:=6; __p(__vs(FirstGT(arr,3))); __vybeCheck('3');
end.
