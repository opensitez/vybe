// vybe-test: pascal/array_algorithms/fill_array_with_constant
...
end; procedure Fill(var a:array of Integer; v:Integer); var i:Integer; begin for i:=0 to High(a) do a[i]:=v; end; var arr:array[0..2] of Integer; begin Fill(arr,7); __p(__vs(arr[1])); __vybeCheck('7');
end.
