// vybe-test: pascal/array_algorithms/static_array_init_literal_sum
...
end; var a:array[0..2] of Integer = (2,4,6); s,i:Integer; begin s:=0; for i:=0 to 2 do s:=s+a[i]; __p(__vs(s)); __vybeCheck('12');
end.
