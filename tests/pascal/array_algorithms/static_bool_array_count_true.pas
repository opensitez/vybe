// vybe-test: pascal/array_algorithms/static_bool_array_count_true
...
end; var a:array[0..3] of Boolean; i,c:Integer; begin a[0]:=true; a[1]:=false; a[2]:=true; a[3]:=true; c:=0; for i:=0 to 3 do if a[i] then Inc(c); __p(__vs(c)); __vybeCheck('3');
end.
