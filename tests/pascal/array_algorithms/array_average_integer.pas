// vybe-test: pascal/array_algorithms/array_average_integer
...
end; function Avg(const a:array of Integer):Integer; var i,s:Integer; begin s:=0; for i:=0 to High(a) do s:=s+a[i]; Result:=s div (High(a)+1); end; var arr:array[0..3] of Integer; begin arr[0]:=2; arr[1]:=4; arr[2]:=6; arr[3]:=8; __p(__vs(Avg(arr))); __vybeCheck('5');
end.
