// vybe-test: pascal/array_algorithms/linear_search_not_found
...
end; function Find(const a:array of Integer; v:Integer):Integer; var i:Integer; begin Result:=-1; for i:=0 to High(a) do if a[i]=v then Result:=i; end; var arr:array[0..2] of Integer; begin arr[0]:=1; arr[1]:=2; arr[2]:=3; __p(__vs(Find(arr,4))); __vybeCheck('-1');
end.
