// vybe-test: pascal/array_algorithms/partition_pivot_count_less
...
end; var a:array[0..4] of Integer; i,p,c:Integer; begin a[0]:=5; a[1]:=2; a[2]:=8; a[3]:=1; a[4]:=6; p:=5; c:=0; for i:=0 to 4 do if a[i]<p then Inc(c); __p(__vs(c)); __vybeCheck('2');
end.
