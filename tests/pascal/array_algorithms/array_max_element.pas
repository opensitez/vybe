// vybe-test: pascal/array_algorithms/array_max_element
...
end; function MaxVal(const a:array of Integer):Integer; var i:Integer; begin Result:=a[0]; for i:=1 to High(a) do if a[i]>Result then Result:=a[i]; end; var arr:array[0..2] of Integer; begin arr[0]:=2; arr[1]:=9; arr[2]:=5; __p(__vs(MaxVal(arr))); __vybeCheck('9');
end.
