// vybe-test: pascal/array_algorithms/shift_left_array_manual
...
end; var a:array[0..3] of Integer; i:Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; a[3]:=4; for i:=0 to 2 do a[i]:=a[i+1]; a[3]:=0; __p(__vs(a[0])); __p(__vs(a[3])); __vybeCheck('2' + #10 + '0');
end.
