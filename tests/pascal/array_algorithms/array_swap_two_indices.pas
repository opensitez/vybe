// vybe-test: pascal/array_algorithms/array_swap_two_indices
...
end; var a:array[0..2] of Integer; t:Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; t:=a[0]; a[0]:=a[2]; a[2]:=t; __p(__vs(a[0])); __p(__vs(a[2])); __vybeCheck('3' + #10 + '1');
end.
