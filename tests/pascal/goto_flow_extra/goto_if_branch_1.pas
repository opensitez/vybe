// vybe-test: pascal/goto_flow_extra/goto_if_branch_1
...
end; label L; var x:Integer; begin x:=1; if x mod 2=0 then goto L; __p(__vs(1)); goto endL; L: __p(__vs(2)); endL: __vybeCheck('1');
end.
