// vybe-test: pascal/goto_flow_extra/goto_if_branch_13
...
end; label L; var x:Integer; begin x:=13; if x mod 2=0 then goto L; __p(__vs(1)); goto endL; L: __p(__vs(2)); endL: __vybeCheck('1');
end.
