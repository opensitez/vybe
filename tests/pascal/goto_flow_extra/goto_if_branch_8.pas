// vybe-test: pascal/goto_flow_extra/goto_if_branch_8
...
end; label L; var x:Integer; begin x:=8; if x mod 2=0 then goto L; __p(__vs(1)); goto endL; L: __p(__vs(2)); endL: __vybeCheck('2');
end.
