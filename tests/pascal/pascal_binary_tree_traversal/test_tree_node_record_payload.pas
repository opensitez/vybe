// vybe-test: pascal/pascal_binary_tree_traversal/test_tree_node_record_payload
...
begin
  ...
  __p(__vs(n^.Payload.Name));
  __p(__vs(n^.Payload.Val));
  Dispose(n);
__vybeCheck('RootPayload' + #10 + '777');
end.
