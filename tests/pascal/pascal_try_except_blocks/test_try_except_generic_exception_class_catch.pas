// vybe-test: pascal/pascal_try_except_blocks/test_try_except_generic_exception_class_catch
...
begin
  try
    ...
    on E: Exception do __p(__vs('BaseExceptionCaught:' + E.ClassName));
  end;
__vybeCheck('BaseExceptionCaught:EInvalidArgument');
end.
