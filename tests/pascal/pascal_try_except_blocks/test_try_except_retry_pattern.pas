// vybe-test: pascal/pascal_try_except_blocks/test_try_except_retry_pattern
// origin: languages/pascal/tests/pascal/test_pascal_try_except_blocks.rs
program Test;
{$mode delphi}
...
begin
  ...
  begin
    ...
    try
      ...
      __p(__vs('SuccessOnAttempt:' + attempts.ToString));
      Break;
    except
      on E: Exception do __p(__vs('RetryingAttempt:' + attempts.ToString));
    end;
  end;
__vybeCheck('RetryingAttempt:1' + #10 + 'RetryingAttempt:2' + #10 + 'SuccessOnAttempt:3');
end.
