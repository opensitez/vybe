// vybe-test: pascal/pascal_try_except_blocks/test_try_except_formatting_string_error
...
begin
  try
    ...
    on E: EConvertError do __p(__vs('ConvertErrCaught'));
  end;
__vybeCheck('ConvertErrCaught');
end.
