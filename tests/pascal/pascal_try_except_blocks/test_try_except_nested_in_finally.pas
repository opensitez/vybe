// vybe-test: pascal/pascal_try_except_blocks/test_try_except_nested_in_finally
...
begin
  try
    try
      ...
      on E: Exception do __p(__vs('InnerHandled:' + E.Message));
    end;
  finally
    __p(__vs('OuterFinallyExecuted'));
  end;
__vybeCheck('InnerHandled:InnerError' + #10 + 'OuterFinallyExecuted');
end.
