// vybe-test: pascal/pascal_try_except_blocks/test_try_except_inside_loop
...
begin
  ...
  begin
    try
      ...
      __p(__vs('OK:' + i.ToString));
    except
      on E: Exception do __p(__vs('Handled:' + i.ToString));
    end;
  end;
__vybeCheck('OK:1' + #10 + 'Handled:2' + #10 + 'OK:3');
end.
