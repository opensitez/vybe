// vybe-test: pascal/pascal_try_except_blocks/test_try_except_multiple_on_clauses
...
begin
  try
    ...
    on E: EArgumentException do __p(__vs('ArgErr:' + E.Message));
    on E: EInvalidOp do __p(__vs('OpErr:' + E.Message));
  end;
end;
begin
  CauseError(1);
  CauseError(2);
__vybeCheck('ArgErr:BadArg' + #10 + 'OpErr:BadOp');
end.
