// vybe-test: pascal/pascal_operator_overloading_records/test_operator_logical_and_or_not
...
begin
  ...
  __p(__vs(HexStr(rAnd.Bits, 2)));
  __p(__vs(HexStr(rOr.Bits, 2)));
__vybeCheck('03' + #10 + '3F');
end.
