// vybe-test: pascal/pascal_operator_overloading_records/test_operator_negative_positive
...
begin
  ...
  n := -v;
  p := +v;
  __p(__vs(n.X.ToString + ',' + n.Y.ToString));
  __p(__vs(p.X.ToString + ',' + p.Y.ToString));
__vybeCheck('-10,20' + #10 + '10,-20');
end.
