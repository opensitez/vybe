// vybe-test: pascal/pascal_operator_overloading_records/test_operator_add_subtract_record
// origin: languages/pascal/tests/pascal/test_pascal_operator_overloading_records.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  resAdd := p1 + p2;
  resSub := p1 - p2;
  __p(__vs(resAdd.X.ToString + ',' + resAdd.Y.ToString));
  __p(__vs(resSub.X.ToString + ',' + resSub.Y.ToString));
__vybeCheck('13,25' + #10 + '7,15');
end.
