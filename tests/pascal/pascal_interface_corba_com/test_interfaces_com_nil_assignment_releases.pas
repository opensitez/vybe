// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_com_nil_assignment_releases
...
destructor TData.Destroy; begin __p(__vs('DataReleasedOnNil')); inherited Destroy; end;
...
begin
  ...
  d := nil;
  __p(__vs('AfterNil'));
__vybeCheck('DataReleasedOnNil' + #10 + 'AfterNil');
end.
