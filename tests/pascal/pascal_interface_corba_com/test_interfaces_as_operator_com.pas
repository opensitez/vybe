// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_as_operator_com
...
procedure TFooBar.Foo; begin __p(__vs('FooCall')); end;
procedure TFooBar.Bar; begin __p(__vs('BarCall')); end;
