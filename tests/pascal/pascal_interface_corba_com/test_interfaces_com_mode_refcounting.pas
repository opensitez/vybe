// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_com_mode_refcounting
...
procedure TComImpl.DoComWork; begin __p(__vs('ComWorkExecuted')); end;

var w: IComWork;
begin
  w := TComImpl.Create;
  w.DoComWork;
__vybeCheck('ComWorkExecuted');
end.
