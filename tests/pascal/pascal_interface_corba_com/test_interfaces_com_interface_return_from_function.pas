// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_com_interface_return_from_function
...
begin
  __p(__vs(CreateItem.Name));
__vybeCheck('ItemReturnedFromFunc');
end.
