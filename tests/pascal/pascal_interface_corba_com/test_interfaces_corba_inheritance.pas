// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_corba_inheritance
...
procedure TSubImpl.BaseProc; begin __p(__vs('BaseCorbaExecuted')); end;
procedure TSubImpl.SubProc; begin __p(__vs('SubCorbaExecuted')); end;
...
begin
  ...
  obj.Free;
__vybeCheck('BaseCorbaExecuted' + #10 + 'SubCorbaExecuted');
end.
