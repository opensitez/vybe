// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_corba_manual_lifetime
...
destructor TCorbaItem.Destroy; begin __p(__vs('CorbaObjectDestroyedManually')); inherited Destroy; end;

var itemObj: TCorbaItem; itemIntf: ICorbaItem;
begin
  itemObj := TCorbaItem.Create;
  itemIntf := itemObj;
  __p(__vs(itemIntf.GetVal));
  itemObj.Free;
__vybeCheck('500' + #10 + 'CorbaObjectDestroyedManually');
end.
