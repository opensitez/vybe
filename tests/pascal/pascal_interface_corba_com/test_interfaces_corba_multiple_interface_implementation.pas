// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_corba_multiple_interface_implementation
...
procedure TCorbaDual.DoA; begin __p(__vs('CorbaA')); end;
procedure TCorbaDual.DoB; begin __p(__vs('CorbaB')); end;
