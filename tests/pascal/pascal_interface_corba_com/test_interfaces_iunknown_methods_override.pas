// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_iunknown_methods_override
// origin: languages/pascal/tests/pascal/test_pascal_interface_corba_com.rs
program Test;
{$mode delphi}
uses SysUtils;
...
function TCustomUnk._AddRef: Integer; begin Inc(FRefCount); __p(__vs('AddRef:' + FRefCount.ToString)); Result := FRefCount; end;
function TCustomUnk._Release: Integer; begin Dec(FRefCount); __p(__vs('Release:' + FRefCount.ToString)); Result := FRefCount; end;

var unk: IUnknown;
begin
  unk := TCustomUnk.Create;
__vybeCheck('AddRef:1' + #10 + 'Release:0');
end.
