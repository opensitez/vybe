// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_supports_query_com
...
procedure TTargetImpl.Action; begin __p(__vs('ActionSupported')); end;
