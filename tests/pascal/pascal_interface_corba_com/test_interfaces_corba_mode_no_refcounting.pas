// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_corba_mode_no_refcounting
...
procedure TCorbaImpl.DoCorbaWork; begin __p(__vs('CorbaWorkExecuted')); end;
