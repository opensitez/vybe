// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_com_weak_ref_avoidance
...
procedure TSimple.Run; begin __p(__vs('RunSimple')); end;
...
begin
  TestScope;
  __p(__vs('ScopeEnded'));
__vybeCheck('RunSimple' + #10 + 'ScopeEnded');
end.
