// vybe-test: pascal/pascal_interface_corba_com/test_interfaces_com_procedure_parameter_passing
...
procedure TWorkerImpl.Work; begin __p(__vs('WorkParameterDone')); end;
