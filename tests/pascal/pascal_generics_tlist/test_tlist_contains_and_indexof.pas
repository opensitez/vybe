// vybe-test: pascal/pascal_generics_tlist/test_tlist_contains_and_indexof
...
begin
  ...
  __p(__vs(list.Contains('Banana')));
  __p(__vs(list.IndexOf('Cherry')));
  __p(__vs(list.IndexOf('Orange')));
  list.Free;
__vybeCheck('True' + #10 + '2' + #10 + '-1');
end.
