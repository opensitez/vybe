// vybe-test: pascal/records_advanced/nested_record_string_field_upper
...
end; type TInner=record Name:string; end; type TOuter=record Inner:TInner; end; var o:TOuter; begin o.Inner.Name:='vybe'; __p(__vs(AnsiUpperCase(o.Inner.Name))); __vybeCheck('VYBE');
end.
