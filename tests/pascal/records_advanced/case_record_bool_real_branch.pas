// vybe-test: pascal/records_advanced/case_record_bool_real_branch
...
end; type TVal=record case IsInt:Boolean of true:(I:Integer); false:(R:Double); end; var v:TVal; begin v.IsInt:=false; v.R:=3.5; __p(__vs(Round(v.R))); __vybeCheck('4');
end.
