// vybe-test: pascal/records_advanced/record_real_field_round
...
end; type TMeas=record V:Double; end; var m:TMeas; begin m.V:=2.6; __p(__vs(Round(m.V))); __vybeCheck('3');
end.
