// vybe-test: pascal/records_advanced/record_array_of_records
...
end; type TItem=record V:Integer; end; var a:array[0..1] of TItem; begin a[0].V:=1; a[1].V:=2; __p(__vs(a[1].V)); __vybeCheck('2');
end.
