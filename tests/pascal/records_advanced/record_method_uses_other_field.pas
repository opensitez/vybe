// vybe-test: pascal/records_advanced/record_method_uses_other_field
...
end; type TRect=record W,H:Integer; function Area:Integer; end; function TRect.Area:Integer; begin Result:=W*H; end; var r:TRect; begin r.W:=5; r.H:=6; __p(__vs(r.Area)); __vybeCheck('30');
end.
