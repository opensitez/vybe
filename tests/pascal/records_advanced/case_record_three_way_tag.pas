// vybe-test: pascal/records_advanced/case_record_three_way_tag
...
end; type TShape=record case Tag:Integer of 0:(W,H:Integer); 1:(R:Integer); 2:(Side:Integer); end; var s:TShape; begin s.Tag:=2; s.Side:=6; __p(__vs(s.Side)); __vybeCheck('6');
end.
