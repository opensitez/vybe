// vybe-test: pascal/records_advanced/record_variant_part_with_string_and_int
...
end; type TCell=record case Active:Boolean of false:(I:Integer); true:(S:string); end; var c:TCell; begin c.Active:=true; c.S:='text'; __p(__vs(c.S)); __vybeCheck('text');
end.
