// vybe-test: pascal/records_advanced/case_record_tag_preserved_after_field_write
...
end; type TVal=record case K:Integer of 1:(A:Integer); 2:(B:Integer); end; var v:TVal; begin v.K:=1; v.A:=5; __p(__vs(v.K)); __vybeCheck('1');
end.
