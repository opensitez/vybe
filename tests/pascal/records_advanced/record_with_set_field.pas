// vybe-test: pascal/records_advanced/record_with_set_field
...
end; type TDay=(Mon,Tue,Wed); type TDays=set of TDay; type TSched=record Open:TDays; end; var s:TSched; begin s.Open:=[Mon,Wed]; __p(__vs(Ord(Mon) in s.Open)); __p(__vs(Ord(Tue) in s.Open)); __vybeCheck('True' + #10 + 'False');
end.
