// vybe-test: pascal/records_advanced/record_procedure_param_field_update
...
end; type TPt=record X:Integer; end; procedure Bump(var p:TPt); begin p.X:=p.X+1; end; var p:TPt; begin p.X:=4; Bump(p); __p(__vs(p.X)); __vybeCheck('5');
end.
