// vybe-test: pascal/records_advanced/case_record_with_fixed_prefix_field
...
end; type TMsg=record Id:Integer; case Kind:Integer of 1:(Text:string); 2:(Code:Integer); end; var m:TMsg; begin m.Id:=9; m.Kind:=2; m.Code:=404; __p(__vs(m.Code)); __vybeCheck('404');
end.
