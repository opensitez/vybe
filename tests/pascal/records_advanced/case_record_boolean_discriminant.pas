// vybe-test: pascal/records_advanced/case_record_boolean_discriminant
...
end; type TNum=record case IsReal:Boolean of false:(N:Integer); true:(R:Double); end; var x:TNum; begin x.IsReal:=false; x.N:=7; __p(__vs(x.N)); __vybeCheck('7');
end.
