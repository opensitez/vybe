// vybe-test: pascal/records_advanced/nested_record_reset_inner_only
...
end; type TInner=record V:Integer; end; type TOuter=record Tag:Integer; Inner:TInner; end; var o:TOuter; begin o.Tag:=1; o.Inner.V:=9; o.Inner.V:=0; __p(__vs(o.Tag)); __p(__vs(o.Inner.V)); __vybeCheck('1' + #10 + '0');
end.
