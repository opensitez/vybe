// vybe-test: pascal/records_advanced/case_record_char_discriminant
...
end; type TTok=record case Kind:Char of 'I':(N:Integer); 'S':(T:string); end; var t:TTok; begin t.Kind:='I'; t.N:=11; __p(__vs(t.N)); __vybeCheck('11');
end.
