// vybe-test: pascal/records_advanced/case_record_dispatch_procedure
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; procedure Show(const v:TVal); begin if v.K=0 then __p(__vs(v.I)) else __p(__vs(v.S)); end; var v:TVal; begin v.K:=0; v.I:=88; Show(v); __vybeCheck('88');
end.
