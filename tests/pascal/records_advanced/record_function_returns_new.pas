// vybe-test: pascal/records_advanced/record_function_returns_new
...
end; type TPt=record X,Y:Integer; end; function Make(x,y:Integer):TPt; begin Result.X:=x; Result.Y:=y; end; var p:TPt; begin p:=Make(2,3); __p(__vs(p.X+p.Y)); __vybeCheck('5');
end.
