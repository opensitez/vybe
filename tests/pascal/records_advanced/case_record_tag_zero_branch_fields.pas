// vybe-test: pascal/records_advanced/case_record_tag_zero_branch_fields
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TVal; begin v.K:=0; v.I:=42; __p(__vs(v.I)); __vybeCheck('42');
end.
