// vybe-test: pascal/records_advanced/record_two_methods_chain
...
end; type TAcc=record N:Integer; procedure Inc1; function Get:Integer; end; procedure TAcc.Inc1; begin N:=N+1; end; function TAcc.Get:Integer; begin Result:=N; end; var a:TAcc; begin a.N:=0; a.Inc1; a.Inc1; __p(__vs(a.Get)); __vybeCheck('2');
end.
