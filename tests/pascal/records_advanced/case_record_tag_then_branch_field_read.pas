// vybe-test: pascal/records_advanced/case_record_tag_then_branch_field_read
...
end; type TE=record case K:Integer of 1:(A:Integer); 2:(B:Integer); end; var e:TE; begin e.K:=2; e.B:=31; __p(__vs(e.B)); __vybeCheck('31');
end.
