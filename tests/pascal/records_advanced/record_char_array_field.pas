// vybe-test: pascal/records_advanced/record_char_array_field
...
end; type TBuf=record Ch:array[0..1] of Char; end; var b:TBuf; begin b.Ch[0]:='X'; b.Ch[1]:='Y'; __p(__vs(b.Ch[0])); __p(__vs(b.Ch[1])); __vybeCheck('X' + #10 + 'Y');
end.
