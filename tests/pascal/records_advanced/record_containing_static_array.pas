// vybe-test: pascal/records_advanced/record_containing_static_array
...
end; type TBuf=record Data:array[0..2] of Integer; end; var b:TBuf; begin b.Data[2]:=8; __p(__vs(b.Data[2])); __vybeCheck('8');
end.
