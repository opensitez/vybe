// vybe-test: pascal/records_advanced/case_record_switch_on_tag
...
end; type TShape=record case Tag:Integer of 0:(R:Integer); 1:(W,H:Integer); end; var s:TShape; begin s.Tag:=1; s.W:=3; s.H:=4; if s.Tag=1 then __p(__vs(s.W*s.H)) else __p(__vs(0)); __vybeCheck('12');
end.
