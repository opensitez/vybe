// vybe-test: pascal/records_advanced/nested_record_three_deep
...
end; type TL3=record V:Integer; end; type TL2=record L3:TL3; end; type TL1=record L2:TL2; end; var r:TL1; begin r.L2.L3.V:=21; __p(__vs(r.L2.L3.V)); __vybeCheck('21');
end.
