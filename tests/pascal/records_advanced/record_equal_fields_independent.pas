// vybe-test: pascal/records_advanced/record_equal_fields_independent
...
end; type TPt=record X,Y:Integer; end; var a,b:TPt; begin a.X:=1; a.Y:=2; b:=a; b.X:=9; __p(__vs(a.X)); __p(__vs(b.X)); __vybeCheck('1' + #10 + '9');
end.
