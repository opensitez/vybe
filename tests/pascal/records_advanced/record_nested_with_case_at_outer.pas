// vybe-test: pascal/records_advanced/record_nested_with_case_at_outer
...
end; type TInner=record V:Integer; end; type TOuter=record case Tag:Integer of 0:(I:Integer); 1:(Inner:TInner); end; var o:TOuter; begin o.Tag:=1; o.Inner.V:=13; __p(__vs(o.Inner.V)); __vybeCheck('13');
end.
