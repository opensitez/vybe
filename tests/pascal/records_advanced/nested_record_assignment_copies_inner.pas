// vybe-test: pascal/records_advanced/nested_record_assignment_copies_inner
...
end; type TInner=record N:Integer; end; type TOuter=record A,B:TInner; end; var o:TOuter; begin o.A.N:=3; o.B:=o.A; o.B.N:=9; __p(__vs(o.A.N)); __vybeCheck('3');
end.
