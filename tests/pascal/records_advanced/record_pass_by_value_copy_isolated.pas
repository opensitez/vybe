// vybe-test: pascal/records_advanced/record_pass_by_value_copy_isolated
...
end; type TBox=record V:Integer; end; function Double(b:TBox):TBox; begin b.V:=b.V*2; Result:=b; end; var x:TBox; begin x.V:=5; x:=Double(x); __p(__vs(x.V)); __vybeCheck('10');
end.
