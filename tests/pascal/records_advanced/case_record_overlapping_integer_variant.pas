// vybe-test: pascal/records_advanced/case_record_overlapping_integer_variant
...
end; type TNum=record case T:Integer of 0,1:(Lo,Hi:Byte); 2:(Value:Integer); end; var n:TNum; begin n.T:=2; n.Value:=1000; __p(__vs(n.Value)); __vybeCheck('1000');
end.
