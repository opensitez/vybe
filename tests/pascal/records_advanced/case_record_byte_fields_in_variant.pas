// vybe-test: pascal/records_advanced/case_record_byte_fields_in_variant
...
end; type TBytes=record case Mode:Integer of 0:(A,B,C:Byte); 1:(WordVal:Integer); end; var b:TBytes; begin b.Mode:=0; b.A:=1; b.B:=2; b.C:=3; __p(__vs(b.A+b.B+b.C)); __vybeCheck('6');
end.
