// vybe-test: pascal/records_advanced/record_in_array_initialized_in_loop
...
end; type TCell=record V:Integer; end; var a:array[0..2] of TCell; i:Integer; begin for i:=0 to 2 do a[i].V:=i*i; __p(__vs(a[2].V)); __vybeCheck('4');
end.
