// vybe-test: pascal/records_advanced/nested_record_sum_via_method
// origin: languages/pascal/tests/pascal/test_records_advanced.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TInner=record V:Integer; function Get:Integer; end; function TInner.Get:Integer; begin Result:=V; end; type TOuter=record Inner:TInner; function Total:Integer; end; function TOuter.Total:Integer; begin Result:=Inner.Get; end; var o:TOuter; begin o.Inner.V:=6; __p(__vs(o.Total)); __vybeCheck('6');
end.
