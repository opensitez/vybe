// vybe-test: pascal/records_advanced/nested_record_in_case_variant
...
end; type TInner=record V:Integer; end; type TWrap=record case K:Integer of 0:(I:Integer); 1:(Inner:TInner); end; var w:TWrap; begin w.K:=1; w.Inner.V:=77; __p(__vs(w.Inner.V)); __vybeCheck('77');
end.
