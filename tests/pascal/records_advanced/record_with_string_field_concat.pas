// vybe-test: pascal/records_advanced/record_with_string_field_concat
...
end; type TName=record First,Last:string; end; var n:TName; begin n.First:='Ann'; n.Last:='Lee'; __p(__vs(n.First+' '+n.Last)); __vybeCheck('Ann Lee');
end.
