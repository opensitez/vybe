// vybe-test: pascal/records_advanced/case_record_tag_one_string_branch
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TVal; begin v.K:=1; v.S:='hi'; __p(__vs(v.S)); __vybeCheck('hi');
end.
