// vybe-test: pascal/records_advanced/nested_record_two_levels
...
end; type TInner=record V:Integer; end; type TOuter=record Inner:TInner; end; var o:TOuter; begin o.Inner.V:=55; __p(__vs(o.Inner.V)); __vybeCheck('55');
end.
