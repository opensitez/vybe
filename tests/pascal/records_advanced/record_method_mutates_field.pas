// vybe-test: pascal/records_advanced/record_method_mutates_field
...
end; type TAcc=record N:Integer; procedure IncN; end; procedure TAcc.IncN; begin N:=N+1; end; var a:TAcc; begin a.N:=1; a.IncN; __p(__vs(a.N)); __vybeCheck('2');
end.
