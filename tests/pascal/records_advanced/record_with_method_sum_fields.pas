// vybe-test: pascal/records_advanced/record_with_method_sum_fields
...
end; type TPair=record A,B:Integer; function Sum:Integer; end; function TPair.Sum:Integer; begin Result:=A+B; end; var p:TPair; begin p.A:=4; p.B:=5; __p(__vs(p.Sum)); __vybeCheck('9');
end.
