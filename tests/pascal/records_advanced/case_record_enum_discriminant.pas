// vybe-test: pascal/records_advanced/case_record_enum_discriminant
...
end; type TKind=(IntK,StrK); type TBox=record case Kind:TKind of IntK:(V:Integer); StrK:(T:string); end; var b:TBox; begin b.Kind:=StrK; b.T:='ok'; __p(__vs(b.T)); __vybeCheck('ok');
end.
