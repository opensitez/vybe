// vybe-test: pascal/records_advanced/case_record_four_tags
...
end; type TOp=record case Code:Integer of 0:(Add:Integer); 1:(Sub:Integer); 2:(Mul:Integer); 3:(DivValue:Integer); end; var o:TOp; begin o.Code:=3; o.DivValue:=2; __p(__vs(o.DivValue)); __vybeCheck('2');
end.
