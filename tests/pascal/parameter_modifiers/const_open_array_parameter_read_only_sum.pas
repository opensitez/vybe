// vybe-test: pascal/parameter_modifiers/const_open_array_parameter_read_only_sum
...
end; function Total(const a: array of Integer): Integer; var i: Integer; begin Result := 0; for i := Low(a) to High(a) do Result := Result + a[i]; end; begin __p(__vs(Total([2, 4, 6]))); __vybeCheck('12');
end.
