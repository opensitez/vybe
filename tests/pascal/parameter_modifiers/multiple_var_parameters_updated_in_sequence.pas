// vybe-test: pascal/parameter_modifiers/multiple_var_parameters_updated_in_sequence
...
end; procedure Fill(var a, b, c: Integer); begin a := 1; b := 2; c := 3; end; var x, y, z: Integer; begin Fill(x, y, z); __p(__vs(x)); __p(__vs(y)); __p(__vs(z)); __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
