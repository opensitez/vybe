// vybe-test: pascal/parameter_modifiers/out_string_parameter_returns_concatenated_value
...
end; procedure Build(out s: String); begin s := 'built'; end; var msg: String; begin Build(msg); __p(__vs(msg)); __vybeCheck('built');
end.
