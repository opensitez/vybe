// vybe-test: pascal/parameter_modifiers/var_parameter_swaps_two_variables
...
end; procedure Swap(var a, b: Integer); var t: Integer; begin t := a; a := b; b := t; end; var x, y: Integer; begin x := 1; y := 9; Swap(x, y); __p(__vs(x)); __p(__vs(y)); __vybeCheck('9' + #10 + '1');
end.
