// vybe-test: pascal/parameter_modifiers/var_record_parameter_mutates_field
...
end; type TR = record N: Integer; end; procedure Bump(var r: TR); begin r.N := r.N + 1; end; var rec: TR; begin rec.N := 8; Bump(rec); __p(__vs(rec.N)); __vybeCheck('9');
end.
