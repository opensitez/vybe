// vybe-test: pascal/parameter_modifiers/out_parameter_uninitialized_on_entry
...
end; procedure MakePair(out lo, hi: Integer); begin lo := 10; hi := 20; end; var a, b: Integer; begin MakePair(a, b); __p(__vs(a + b)); __vybeCheck('30');
end.
