// vybe-test: pascal/parameter_modifiers/out_parameter_assigns_before_return
...
end; procedure Split(out a, b: Integer); begin a := 3; b := 4; end; var x, y: Integer; begin Split(x, y); __p(__vs(x)); __p(__vs(y)); __vybeCheck('3' + #10 + '4');
end.
