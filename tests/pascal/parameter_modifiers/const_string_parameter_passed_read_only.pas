// vybe-test: pascal/parameter_modifiers/const_string_parameter_passed_read_only
...
end; function Len(const s: String): Integer; begin Result := Length(s); end; begin __p(__vs(Len('abcd'))); __vybeCheck('4');
end.
