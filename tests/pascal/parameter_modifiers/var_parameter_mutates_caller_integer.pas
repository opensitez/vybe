// vybe-test: pascal/parameter_modifiers/var_parameter_mutates_caller_integer
...
end; procedure IncTwice(var n: Integer); begin n := n + 2; end; var x: Integer; begin x := 5; IncTwice(x); __p(__vs(x)); __vybeCheck('7');
end.
