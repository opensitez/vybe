// vybe-test: pascal/parameter_modifiers/const_parameter_cannot_be_assigned_in_procedure
...
end; function Twice(const n: Integer): Integer; begin Result := n * 2; end; begin __p(__vs(Twice(6))); __vybeCheck('12');
end.
