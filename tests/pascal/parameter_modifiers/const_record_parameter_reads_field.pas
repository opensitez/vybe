// vybe-test: pascal/parameter_modifiers/const_record_parameter_reads_field
...
end; type TR = record Name: String; end; function LabelOf(const r: TR): String; begin Result := '[' + r.Name + ']'; end; var rec: TR; begin rec.Name := 'x'; __p(__vs(LabelOf(rec))); __vybeCheck('[x]');
end.
