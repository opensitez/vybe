// vybe-test: pascal/loops_nested/inner_for_shadow_print
...
end; var o,j:Integer; begin for o:=1 to 2 do begin for j:=5 to 6 do __p(__vs(j)); __p(__vs('o')); end; __vybeCheck('5' + #10 + '6' + #10 + 'o' + #10 + '5' + #10 + '6' + #10 + 'o');
end.
