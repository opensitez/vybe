// vybe-test: pascal/loops_nested/break_outer_after_row_limit
...
end; var i,j:Integer; begin for i:=1 to 4 do begin for j:=1 to 3 do __p(__vs(i*10+j)); if i=2 then Break; end; __vybeCheck('11' + #10 + '12' + #10 + '13' + #10 + '21' + #10 + '22' + #10 + '23');
end.
