// vybe-test: pascal/loops_nested/search_break_on_product
...
end; var i,j,found:Integer; begin found:=0; for i:=1 to 5 do if found=0 then for j:=1 to 5 do if (i*j=15) and (found=0) then begin found:=1; __p(__vs(i)); __p(__vs(j)); Break; end; __vybeCheck('3' + #10 + '5');
end.
