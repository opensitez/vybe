// vybe-test: pascal/loops_nested/deep_sum_mod_three_count
...
end; var a,b,c,s:Integer; begin s:=0; for a:=1 to 3 do for b:=1 to 3 do for c:=1 to 3 do if (a+b+c) mod 3=0 then Inc(s); __p(__vs(s)); __vybeCheck('9');
end.
