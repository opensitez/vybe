// vybe-test: pascal/loops_nested/outer_flag_after_inner_scan
...
end; var i,j,hit:Integer; begin hit:=0; for i:=1 to 5 do begin if hit=0 then for j:=1 to 5 do if i+j=7 then hit:=i; end; __p(__vs(hit)); __vybeCheck('2');
end.
