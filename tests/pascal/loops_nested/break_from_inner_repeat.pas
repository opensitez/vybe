// vybe-test: pascal/loops_nested/break_from_inner_repeat
...
end; var i,j:Integer; begin i:=0; repeat Inc(i); j:=0; repeat Inc(j); if j=2 then Break; until false; until i=3; __p(__vs(i)); __p(__vs(j)); __vybeCheck('3' + #10 + '2');
end.
