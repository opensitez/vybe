// vybe-test: pascal/loops_nested/nested_repeat_power_of_two
...
end; var a,b,p:Integer; begin a:=0; p:=1; repeat Inc(a); b:=0; repeat Inc(b); p:=p*2; until b=3; until a=2; __p(__vs(p)); __vybeCheck('64');
end.
