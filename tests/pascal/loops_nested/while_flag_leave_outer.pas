// vybe-test: pascal/loops_nested/while_flag_leave_outer
...
end; var i,j:Integer; leave:Boolean; begin leave:=false; i:=0; while (i<5) and not leave do begin Inc(i); j:=0; while j<5 do begin Inc(j); if (i=3) and (j=2) then leave:=true; end; end; __p(__vs(i)); __vybeCheck('3');
end.
