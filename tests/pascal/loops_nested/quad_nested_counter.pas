// vybe-test: pascal/loops_nested/quad_nested_counter
...
end; var a,b,c,d,s:Integer; begin s:=0; for a:=0 to 1 do for b:=0 to 1 do for c:=0 to 1 do for d:=0 to 1 do Inc(s); __p(__vs(s)); __vybeCheck('16');
end.
