// vybe-test: pascal/loops_nested/diagonal_only_nested
...
end; var r,c:Integer; begin for r:=1 to 3 do for c:=1 to 3 do if r=c then __p(__vs(r)); __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
