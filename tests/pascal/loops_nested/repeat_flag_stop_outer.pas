// vybe-test: pascal/loops_nested/repeat_flag_stop_outer
...
end; var i,j:Integer; stop:Boolean; begin stop:=false; i:=0; repeat Inc(i); j:=0; repeat Inc(j); if (i=2) and (j=2) then stop:=true; until stop or (j>=3); until stop; __p(__vs(i)); __p(__vs(j)); __vybeCheck('2' + #10 + '2');
end.
