// vybe-test: pascal/loops_nested/triple_for_coord_strings
...
end; var x,y,z:Integer; begin for x:=1 to 2 do for y:=1 to 2 do for z:=1 to 2 do __p(__vs(IntToStr(x)+'-'+IntToStr(y)+'-'+IntToStr(z))); __vybeCheck('1-1-1' + #10 + '1-1-2' + #10 + '1-2-1' + #10 + '1-2-2' + #10 + '2-1-1' + #10 + '2-1-2' + #10 + '2-2-1' + #10 + '2-2-2');
end.
