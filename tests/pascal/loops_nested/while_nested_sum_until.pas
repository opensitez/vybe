// vybe-test: pascal/loops_nested/while_nested_sum_until
...
end; var i,j,s:Integer; begin s:=0; i:=0; while i<3 do begin Inc(i); j:=0; while j<i do begin Inc(j); s:=s+1; end; end; __p(__vs(s)); __vybeCheck('6');
end.
