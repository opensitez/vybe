// vybe-test: pascal/loops_nested/for_downto_inside_for_to
...
end; var i,j:Integer; begin for i:=1 to 2 do for j:=2 downto 1 do __p(__vs(i*10+j)); __vybeCheck('12' + #10 + '11' + #10 + '22' + #10 + '21');
end.
