// vybe-test: pascal/loops_nested/repeat_until_outer_inner
...
end; var x,y:Integer; begin x:=0; repeat Inc(x); y:=0; repeat Inc(y); until y=2; until x=2; __p(__vs(x)); __p(__vs(y)); __vybeCheck('2' + #10 + '2');
end.
