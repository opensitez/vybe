// vybe-test: pascal/loops_nested/triple_for_cell_count
...
end; var i,j,k,c:Integer; begin c:=0; for i:=1 to 2 do for j:=1 to 2 do for k:=1 to 2 do Inc(c); __p(__vs(c)); __vybeCheck('8');
end.
