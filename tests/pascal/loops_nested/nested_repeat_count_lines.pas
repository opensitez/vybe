// vybe-test: pascal/loops_nested/nested_repeat_count_lines
...
end; var i,j,n:Integer; begin n:=0; i:=0; repeat Inc(i); j:=0; repeat Inc(j); Inc(n); until j=2; until i=2; __p(__vs(n)); __vybeCheck('6');
end.
