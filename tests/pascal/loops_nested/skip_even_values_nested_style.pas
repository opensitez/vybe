// vybe-test: pascal/loops_nested/skip_even_values_nested_style
...
end; var i:Integer; begin for i:=1 to 6 do if i mod 2<>0 then __p(__vs(i)); __vybeCheck('1' + #10 + '3' + #10 + '5');
end.
