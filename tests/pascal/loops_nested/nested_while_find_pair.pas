// vybe-test: pascal/loops_nested/nested_while_find_pair
...
end; var a,b:Integer; found:Boolean; begin found:=false; a:=1; while (a<=3) and not found do begin b:=1; while b<=3 do begin if a*a+b*b=10 then begin __p(__vs(a)); __p(__vs(b)); found:=true; Break; end; Inc(b); end; Inc(a); end; __vybeCheck('1' + #10 + '3');
end.
