// vybe-test: pascal/loops_nested/triple_while_countdown_print
// origin: languages/pascal/tests/pascal/test_loops_nested.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var a,b,c:Integer; begin a:=2; while a>0 do begin b:=2; while b>0 do begin c:=2; while c>0 do begin __p(__vs(a*100+b*10+c)); Dec(c); end; Dec(b); end; Dec(a); end; __vybeCheck('222' + #10 + '221' + #10 + '212' + #10 + '211' + #10 + '122' + #10 + '121' + #10 + '112' + #10 + '111');
end.
