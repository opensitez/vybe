// vybe-test: pascal/loops_nested/grid_skip_center
...
end; var r,c:Integer; begin for r:=1 to 3 do for c:=1 to 3 do if not ((r=2) and (c=2)) then __p(__vs(r*10+c)); __vybeCheck('11' + #10 + '12' + #10 + '13' + #10 + '21' + #10 + '23' + #10 + '31' + #10 + '32' + #10 + '33');
end.
