// vybe-test: pascal/loops_nested/nested_loop_max_value
...
end; var i,j,m:Integer; begin m:=0; for i:=1 to 3 do for j:=1 to 3 do if i*j>m then m:=i*j; __p(__vs(m)); __vybeCheck('9');
end.
