// vybe-test: pascal/loops_nested/triple_downto_values
...
end; var i,j,k:Integer; begin for i:=2 downto 1 do for j:=2 downto 1 do for k:=2 downto 1 do __p(__vs(i*100+j*10+k)); __vybeCheck('222' + #10 + '221' + #10 + '212' + #10 + '211' + #10 + '122' + #10 + '121' + #10 + '112' + #10 + '111');
end.
