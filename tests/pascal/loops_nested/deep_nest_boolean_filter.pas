// vybe-test: pascal/loops_nested/deep_nest_boolean_filter
...
end; var x,y,z,n:Integer; begin n:=0; for x:=0 to 1 do for y:=0 to 1 do for z:=0 to 1 do if (x+y+z)>=2 then Inc(n); __p(__vs(n)); __vybeCheck('4');
end.
