// vybe-test: pascal/loops_nested/five_level_count
...
end; var a,b,c,d,e,n:Integer; begin n:=0; for a:=0 to 1 do for b:=0 to 1 do for c:=0 to 1 do for d:=0 to 1 do for e:=0 to 1 do Inc(n); __p(__vs(n)); __vybeCheck('32');
end.
