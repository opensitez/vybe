// vybe-test: pascal/loops_nested/clock_nested_tick_count
...
end; var h,m,s,c:Integer; begin c:=0; for h:=0 to 1 do for m:=0 to 1 do for s:=0 to 1 do Inc(c); __p(__vs(c)); __vybeCheck('8');
end.
