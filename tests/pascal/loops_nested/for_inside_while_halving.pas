// vybe-test: pascal/loops_nested/for_inside_while_halving
...
end; var n,i:Integer; begin n:=8; while n>0 do begin for i:=1 to 2 do __p(__vs(n)); n:=n div 2; end; __vybeCheck('8' + #10 + '8' + #10 + '4' + #10 + '4' + #10 + '2' + #10 + '2' + #10 + '1' + #10 + '1');
end.
