// vybe-test: pascal/loops_nested/simulate_labeled_continue_skip
...
end; var i,j,s:Integer; begin s:=0; for i:=1 to 3 do for j:=1 to 3 do begin if j=2 then begin end else s:=s+1; end; __p(__vs(s)); __vybeCheck('6');
end.
