// vybe-test: pascal/loops_nested/for_repeat_write_rows
...
end; var i,j:Integer; begin for i:=1 to 2 do begin j:=0; repeat Inc(j); __p(__vs(i*10+j)); until j=2; end; __vybeCheck('11' + #10 + '12' + #10 + '21' + #10 + '22');
end.
