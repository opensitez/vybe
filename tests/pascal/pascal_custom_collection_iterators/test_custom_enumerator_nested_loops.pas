// vybe-test: pascal/pascal_custom_collection_iterators/test_custom_enumerator_nested_loops
...
begin
  ...
  for i in r1 do
    for j in r2 do
      __p(__vs(i.ToString + ':' + j.ToString));
__vybeCheck('1:10' + #10 + '1:11' + #10 + '2:10' + #10 + '2:11');
end.
