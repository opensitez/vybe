// vybe-test: pascal/property_accessors/propacc_direct_25
...
end; type T=class private F:Integer; public property Val:Integer read F write F; end; var o:T; begin o:=T.Create; o.Val:=25; __p(__vs(o.Val)); o.Free; __vybeCheck('25');
end.
