// vybe-test: pascal/property_accessors/propacc_two_props_10
...
end; type T=class private FX,FY:Integer; public property X:Integer read FX write FX; property Y:Integer read FY write FY; end; var o:T; begin o:=T.Create; o.X:=10; o.Y:=11; __p(__vs(o.X+o.Y)); o.Free; __vybeCheck('21');
end.
