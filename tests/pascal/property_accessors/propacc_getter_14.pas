// vybe-test: pascal/property_accessors/propacc_getter_14
...
end; type T=class private F:Integer; function GetV:Integer; public property Val:Integer read GetV; end; function T.GetV:Integer; begin Result:=F+14; end; var o:T; begin o:=T.Create; o.F:=14; __p(__vs(o.Val)); o.Free; __vybeCheck('28');
end.
