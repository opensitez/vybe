// vybe-test: pascal/property_accessors/propacc_two_props_28
...
end; type T=class private FX,FY:Integer; public property X:Integer read FX write FX; property Y:Integer read FY write FY; end; var o:T; begin o:=T.Create; o.X:=28; o.Y:=29; __p(__vs(o.X+o.Y)); o.Free; __vybeCheck('57');
end.
