// vybe-test: pascal/property_accessors/propacc_getter_38
...
end; type T=class private F:Integer; function GetV:Integer; public property Val:Integer read GetV; end; function T.GetV:Integer; begin Result:=F+38; end; var o:T; begin o:=T.Create; o.F:=38; __p(__vs(o.Val)); o.Free; __vybeCheck('76');
end.
