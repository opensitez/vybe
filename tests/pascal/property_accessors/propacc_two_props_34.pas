// vybe-test: pascal/property_accessors/propacc_two_props_34
...
end; type T=class private FX,FY:Integer; public property X:Integer read FX write FX; property Y:Integer read FY write FY; end; var o:T; begin o:=T.Create; o.X:=34; o.Y:=35; __p(__vs(o.X+o.Y)); o.Free; __vybeCheck('69');
end.
