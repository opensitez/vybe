// vybe-test: pascal/pascal_interface_reference_counting/test_interface_with_enum_parameter
...
procedure TRobot.Move(dir: TDirection); begin __p(__vs('Dir:' + Ord(dir).ToString)); end;
var m: IMover;
begin
  m := TRobot.Create;
  m.Move(dDown);
