// vybe-test: pascal/pascal_interface_reference_counting/test_interface_ref_count_shared_ownership
...
procedure TSharedObj.Show; begin __p(__vs('SharedShow')); end;
destructor TSharedObj.Destroy; begin __p(__vs('SharedDestroyed')); inherited Destroy; end;
var ref1, ref2: IShared;
begin
  ref1 := TSharedObj.Create;
  ref2 := ref1;
  ref1 := nil;
  __p(__vs('Ref1Cleared'));
  ref2.Show;
  ref2 := nil;
  __p(__vs('Ref2Cleared'));
__vybeCheck('Ref1Cleared' + #10 + 'SharedShow' + #10 + 'SharedDestroyed' + #10 + 'Ref2Cleared');
end.
