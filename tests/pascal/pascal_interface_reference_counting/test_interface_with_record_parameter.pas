// vybe-test: pascal/pascal_interface_reference_counting/test_interface_with_record_parameter
...
procedure TConsumerImpl.Consume(d: TData); begin __p(__vs(d.Code)); end;
