// vybe-test: pascal/pascal_interface_reference_counting/test_interface_array_polymorphism
...
procedure TTaskA.Execute; begin __p(__vs('TaskA')); end;
procedure TTaskB.Execute; begin __p(__vs('TaskB')); end;
