// vybe-test: pascal/pascal_interface_reference_counting/test_interface_auto_reference_counting_cleanup
...
procedure TTrackerObj.Ping; begin __p(__vs('Pinged')); end;
destructor TTrackerObj.Destroy; begin __p(__vs('AutoDestroyed')); inherited Destroy; end;
procedure RunScope;
var t: ITracker;
begin
...
begin
  RunScope;
__vybeCheck('Pinged' + #10 + 'AutoDestroyed');
end.
