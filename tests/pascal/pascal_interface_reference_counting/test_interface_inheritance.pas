// vybe-test: pascal/pascal_interface_reference_counting/test_interface_inheritance
...
procedure TChainImpl.Step1; begin __p(__vs('Step1')); end;
procedure TChainImpl.Step2; begin __p(__vs('Step2')); end;
var sub: ISubIntf;
begin
