// vybe-test: pascal/pascal_interface_reference_counting/test_interface_function_return_value
...
procedure TWorkerImpl.DoWork; begin __p(__vs('WorkDone')); end;
