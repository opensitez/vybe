// vybe-test: pascal/pascal_interface_reference_counting/test_interface_with_default_parameter
...
procedure TNotifierImpl.Notify(msg: String); begin __p(__vs(msg)); end;
var n: INotifier;
begin
  n := TNotifierImpl.Create;
  n.Notify;
  n.Notify('CustomNotification');
__vybeCheck('DefaultNotification' + #10 + 'CustomNotification');
end.
