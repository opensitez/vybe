// vybe-test: pascal/pascal_interface_reference_counting/test_interface_reassigned_to_nil
...
procedure TCleanObj.Action; begin __p(__vs('Active')); end;
destructor TCleanObj.Destroy; begin __p(__vs('DestroyedOnNil')); inherited Destroy; end;
var intf: ICleanable;
begin
  ...
  intf := nil;
  __p(__vs('AfterNil'));
__vybeCheck('Active' + #10 + 'DestroyedOnNil' + #10 + 'AfterNil');
end.
