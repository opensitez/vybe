// vybe-test: pascal/pascal_interface_reference_counting/test_interface_factory_registry_dispatch
...
procedure TStartCommand.Execute; begin __p(__vs('StartedCommand')); end;
