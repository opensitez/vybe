// vybe-test: pascal/pascal_tmemorystream_ops/test_tmemorystream_protection_finally
// origin: languages/pascal/tests/pascal/test_pascal_tmemorystream_ops.rs
program Test;
{$mode delphi}
...
begin
  ...
  try
    ms.SetSize(100);
    __p(__vs('MemoryStreamActive'));
  finally
    ms.Free;
    __p(__vs('MemoryStreamFreed'));
  end;
__vybeCheck('MemoryStreamActive' + #10 + 'MemoryStreamFreed');
end.
