// vybe-test: pascal/generic_containers/generic_max_function
// origin: languages/pascal/tests/pascal/test_generic_containers.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(GenMax<Integer>(3, 7)));
  __p(__vs(GenMax<Integer>(10, 5)));
__vybeCheck('7' + #10 + '10');
end.
