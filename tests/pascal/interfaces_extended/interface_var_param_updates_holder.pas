// vybe-test: pascal/interfaces_extended/interface_var_param_updates_holder
...
end; type ISet=interface procedure Set(v:Integer); end; TSet=class(TInterfacedObject,ISet) private F:Integer; public procedure Set(v:Integer); function Get:Integer; end; procedure TSet.Set(v:Integer); begin F:=v; end; function TSet.Get:Integer; begin Result:=F; end; procedure Apply(s:ISet); begin s.Set(99); end; var o:TSet; begin o:=TSet.Create; Apply(o); __p(__vs(o.Get)); __vybeCheck('99');
end.
