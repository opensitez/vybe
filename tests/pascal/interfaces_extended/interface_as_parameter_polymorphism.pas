// vybe-test: pascal/interfaces_extended/interface_as_parameter_polymorphism
...
end; type IShow=interface procedure Show; end; TA=class(TInterfacedObject,IShow) procedure Show; end; TB=class(TInterfacedObject,IShow) procedure Show; end; procedure TA.Show; begin __p(__vs('A')); end; procedure TB.Show; begin __p(__vs('B')); end; procedure Call(s:IShow); begin s.Show; end; var a:IShow; begin a:=TA.Create; Call(a); a:=TB.Create; Call(a); __vybeCheck('A' + #10 + 'B');
end.
