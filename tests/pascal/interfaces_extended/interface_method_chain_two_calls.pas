// vybe-test: pascal/interfaces_extended/interface_method_chain_two_calls
...
end; type IInc=interface function Inc(v:Integer):Integer; end; TInc=class(TInterfacedObject,IInc) function Inc(v:Integer):Integer; end; function TInc.Inc(v:Integer):Integer; begin Result:=v+1; end; var i:IInc; begin i:=TInc.Create; __p(__vs(i.Inc(i.Inc(1)))); __vybeCheck('3');
end.
