// vybe-test: pascal/interfaces_extended/interface_optional_absent_branch
...
end; type IMaybe=interface function Has:Boolean; end; procedure Use(m:IMaybe); begin if m=nil then __p(__vs('none')) else __p(__vs('some')); end; begin Use(nil); __vybeCheck('none');
end.
