// vybe-test: pascal/interfaces_extended/interface_stored_in_record_field
...
end; type ITag=interface function Tag:Integer; end; TTag=class(TInterfacedObject,ITag) private F:Integer; public constructor Create(t:Integer); function Tag:Integer; end; constructor TTag.Create(t:Integer); begin F:=t; end; function TTag.Tag:Integer; begin Result:=F; end; type TWrap=record H:ITag; end; var w:TWrap; begin w.H:=TTag.Create(7); __p(__vs(w.H.Tag)); __vybeCheck('7');
end.
