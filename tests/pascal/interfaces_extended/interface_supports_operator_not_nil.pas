// vybe-test: pascal/interfaces_extended/interface_supports_operator_not_nil
...
end; type IRun=interface procedure Run; end; TRunner=class(TInterfacedObject,IRun) procedure Run; end; procedure TRunner.Run; begin __p(__vs('run')); end; var r:IRun; begin r:=TRunner.Create; if r<>nil then r.Run; __vybeCheck('run');
end.
