// vybe-test: pascal/interfaces_extended/interface_guid_style_name_only
...
end; type IWorker=interface ['{11111111-1111-1111-1111-111111111111}'] function Work:Integer; end; TWorker=class(TInterfacedObject,IWorker) function Work:Integer; end; function TWorker.Work:Integer; begin Result:=42; end; var w:IWorker; begin w:=TWorker.Create; __p(__vs(w.Work)); __vybeCheck('42');
end.
