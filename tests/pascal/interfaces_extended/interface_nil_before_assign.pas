// vybe-test: pascal/interfaces_extended/interface_nil_before_assign
...
end; type IEmpty=interface end; var i:IEmpty; begin if i=nil then __p(__vs('nil')); __vybeCheck('nil');
end.
