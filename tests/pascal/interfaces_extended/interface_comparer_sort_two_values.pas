// vybe-test: pascal/interfaces_extended/interface_comparer_sort_two_values
...
end; type ICompare=interface function Less(a,b:Integer):Boolean; end; TAsc=class(TInterfacedObject,ICompare) function Less(a,b:Integer):Boolean; end; function TAsc.Less(a,b:Integer):Boolean; begin Result:=a<b; end; function Min(c:ICompare;a,b:Integer):Integer; begin if c.Less(a,b) then Result:=a else Result:=b; end; var c:ICompare; begin c:=TAsc.Create; __p(__vs(Min(c,8,3))); __vybeCheck('3');
end.
