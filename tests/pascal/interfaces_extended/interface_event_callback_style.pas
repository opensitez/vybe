// vybe-test: pascal/interfaces_extended/interface_event_callback_style
...
end; type IClick=interface procedure Click; end; TButton=class(TInterfacedObject,IClick) procedure Click; end; procedure TButton.Click; begin __p(__vs('clicked')); end; procedure Wire(evt:IClick); begin evt.Click; end; var b:IClick; begin b:=TButton.Create; Wire(b); __vybeCheck('clicked');
end.
