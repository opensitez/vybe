// vybe-test: pascal/interfaces_extended/two_interfaces_on_one_class
...
end; type IAdd=interface function Add(a,b:Integer):Integer; end; IMul=interface function Mul(a,b:Integer):Integer; end; TCalc=class(TInterfacedObject,IAdd,IMul) function Add(a,b:Integer):Integer; function Mul(a,b:Integer):Integer; end; function TCalc.Add(a,b:Integer):Integer; begin Result:=a+b; end; function TCalc.Mul(a,b:Integer):Integer; begin Result:=a*b; end; var add:IAdd; mul:IMul; begin add:=TCalc.Create; mul:=TCalc(add); __p(__vs(add.Add(2,3))); __p(__vs(mul.Mul(2,3))); __vybeCheck('5' + #10 + '6');
end.
