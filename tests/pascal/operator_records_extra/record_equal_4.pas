// vybe-test: pascal/operator_records_extra/record_equal_4
...
end; type TR=record V:Integer; class operator Equal(a,b:TR):Boolean; end; class operator TR.Equal(a,b:TR):Boolean; begin Result:=a.V=b.V; end; var a,b:TR; begin a.V:=4; b.V:=4; if a=b then __p(__vs(1)) else __p(__vs(0)); __vybeCheck('1');
end.
