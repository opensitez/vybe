// vybe-test: pascal/operator_records_extra/record_add_9
...
end; type TR=record V:Integer; class operator Add(a,b:TR):TR; end; class operator TR.Add(a,b:TR):TR; begin Result.V:=a.V+b.V; end; var a,b,c:TR; begin a.V:=9; b.V:=10; c:=a+b; __p(__vs(c.V)); __vybeCheck('19');
end.
