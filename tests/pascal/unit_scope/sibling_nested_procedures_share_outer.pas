// vybe-test: pascal/unit_scope/sibling_nested_procedures_share_outer
...
end; procedure P; var s: Integer; procedure Add1; begin s:=s+1; end; procedure Add2; begin s:=s+2; end; begin s:=0; Add1; Add2; __p(__vs(s)); end; begin P; __vybeCheck('3');
end.
