// vybe-test: pascal/unit_scope/forward_mutual_procedure_a_calls_b
...
end; procedure A; forward; procedure B; forward; procedure A; begin __p(__vs('A')); B; end; procedure B; begin __p(__vs('B')); end; begin A; __vybeCheck('A' + #10 + 'B');
end.
