// vybe-test: pascal/unit_scope/procedure_local_var_not_visible_outside
...
end; var x: Integer; procedure P; var y: Integer; begin y:=5; x:=y; end; begin x:=0; P; __p(__vs(x)); __vybeCheck('5');
end.
