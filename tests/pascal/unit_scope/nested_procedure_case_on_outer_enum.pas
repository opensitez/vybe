// vybe-test: pascal/unit_scope/nested_procedure_case_on_outer_enum
...
end; type TM=(A,B); procedure P; var m: TM; procedure Show; begin case m of A: __p(__vs('A')); B: __p(__vs('B')); end; end; begin m:=B; Show; end; begin P; __vybeCheck('B');
end.
