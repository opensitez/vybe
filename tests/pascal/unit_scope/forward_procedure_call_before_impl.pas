// vybe-test: pascal/unit_scope/forward_procedure_call_before_impl
...
end; procedure Alpha; forward; procedure Beta; begin __p(__vs('beta')); end; procedure Alpha; begin Beta; end; begin Alpha; __vybeCheck('beta');
end.
