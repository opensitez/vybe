// vybe-test: pascal/unit_scope/local_record_scope_in_procedure
...
end; type TG=record V:Integer; end; var g:TG; procedure P; var r:TG; begin r.V:=8; g:=r; end; begin g.V:=0; P; __p(__vs(g.V)); __vybeCheck('8');
end.
