// vybe-test: pascal/unit_scope/triple_nested_procedure_chain
...
end; procedure A; procedure B; procedure C; begin __p(__vs('deep')); end; begin C; end; begin B; end; begin A; __vybeCheck('deep');
end.
