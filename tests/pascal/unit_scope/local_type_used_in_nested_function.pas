// vybe-test: pascal/unit_scope/local_type_used_in_nested_function
...
end; procedure P; type TPair=record A,B:Integer; end; function Make: TPair; begin Result.A:=1; Result.B:=2; end; begin __p(__vs(Make.B)); end; begin P; __vybeCheck('2');
end.
