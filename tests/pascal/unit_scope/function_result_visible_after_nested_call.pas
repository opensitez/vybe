// vybe-test: pascal/unit_scope/function_result_visible_after_nested_call
...
end; function Calc: Integer; function Helper: Integer; begin Result:=4; end; begin Result:=Helper*3; end; begin __p(__vs(Calc)); __vybeCheck('12');
end.
