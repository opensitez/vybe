// vybe-test: pascal/unit_scope/nested_procedure_iterates_outer_array
...
end; procedure P; var a: array[0..2] of Integer; procedure Sum(var s: Integer); var i: Integer; begin s:=0; for i:=0 to 2 do s:=s+a[i]; end; var t: Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; Sum(t); __p(__vs(t)); end; begin P; __vybeCheck('6');
end.
