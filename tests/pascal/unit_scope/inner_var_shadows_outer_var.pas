// vybe-test: pascal/unit_scope/inner_var_shadows_outer_var
...
end; var x: Integer; procedure P; var x: Integer; begin x:=100; __p(__vs(x)); end; begin x:=1; P; __p(__vs(x)); __vybeCheck('100' + #10 + '1');
end.
