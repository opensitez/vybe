// vybe-test: pascal/unit_scope/local_const_visible_in_nested_procedure
...
end; procedure P; const K=7; procedure Q; begin __p(__vs(K)); end; begin Q; end; begin P; __vybeCheck('7');
end.
