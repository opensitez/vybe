// vybe-test: pascal/unit_scope/local_enum_in_procedure_scope
...
end; procedure P; type TS=(On,Off); var s:TS; begin s:=On; if s=On then __p(__vs('on')); end; begin P; __vybeCheck('on');
end.
