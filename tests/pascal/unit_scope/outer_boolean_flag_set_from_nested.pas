// vybe-test: pascal/unit_scope/outer_boolean_flag_set_from_nested
...
end; procedure P; var ok: Boolean; procedure SetOk; begin ok:=true; end; begin ok:=false; SetOk; if ok then __p(__vs('yes')); end; begin P; __vybeCheck('yes');
end.
