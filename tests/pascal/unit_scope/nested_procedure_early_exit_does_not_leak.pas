// vybe-test: pascal/unit_scope/nested_procedure_early_exit_does_not_leak
...
end; procedure P; var n: Integer; procedure Q; begin n:=3; Exit; n:=9; end; begin n:=0; Q; __p(__vs(n)); end; begin P; __vybeCheck('3');
end.
