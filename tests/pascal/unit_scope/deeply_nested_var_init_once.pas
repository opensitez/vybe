// vybe-test: pascal/unit_scope/deeply_nested_var_init_once
...
end; procedure L1; var n: Integer; procedure L2; procedure L3; begin n:=5; end; begin L3; __p(__vs(n)); end; begin n:=0; L2; end; begin L1; __vybeCheck('5');
end.
