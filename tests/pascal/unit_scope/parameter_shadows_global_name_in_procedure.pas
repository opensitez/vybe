// vybe-test: pascal/unit_scope/parameter_shadows_global_name_in_procedure
...
end; var n: Integer; procedure Show(n: Integer); begin __p(__vs(n)); end; begin n:=1; Show(9); __p(__vs(n)); __vybeCheck('9' + #10 + '1');
end.
