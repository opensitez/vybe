// vybe-test: pascal/unit_scope/nested_function_returns_to_outer_assign
...
end; procedure P; var v: Integer; function Inner: Integer; begin Result:=21; end; begin v:=Inner; __p(__vs(v)); end; begin P; __vybeCheck('21');
end.
