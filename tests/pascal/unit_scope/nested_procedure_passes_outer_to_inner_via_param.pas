// vybe-test: pascal/unit_scope/nested_procedure_passes_outer_to_inner_via_param
...
end; procedure Outer(v: Integer); procedure Inner(x: Integer); begin __p(__vs(x)); end; begin Inner(v); end; begin Outer(6); __vybeCheck('6');
end.
