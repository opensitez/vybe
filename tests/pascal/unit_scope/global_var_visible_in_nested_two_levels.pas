// vybe-test: pascal/unit_scope/global_var_visible_in_nested_two_levels
...
end; var g: Integer; procedure A; procedure B; begin g:=42; end; begin B; end; begin g:=0; A; __p(__vs(g)); __vybeCheck('42');
end.
