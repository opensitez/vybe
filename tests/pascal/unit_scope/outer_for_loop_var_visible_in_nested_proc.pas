// vybe-test: pascal/unit_scope/outer_for_loop_var_visible_in_nested_proc
...
end; procedure P; var i, s: Integer; procedure Acc; begin s:=s+i; end; begin s:=0; for i:=1 to 3 do Acc; __p(__vs(s)); end; begin P; __vybeCheck('6');
end.
