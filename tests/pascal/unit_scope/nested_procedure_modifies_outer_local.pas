// vybe-test: pascal/unit_scope/nested_procedure_modifies_outer_local
...
end; procedure Outer; var x: Integer; procedure Inner; begin x:=x+1; end; begin x:=1; Inner; __p(__vs(x)); end; begin Outer; __vybeCheck('2');
end.
