// vybe-test: pascal/unit_scope/nested_procedure_recursive_on_counter
...
end; procedure P; var n: Integer; procedure Rec; begin if n<3 then begin n:=n+1; Rec; end; end; begin n:=0; Rec; __p(__vs(n)); end; begin P; __vybeCheck('3');
end.
