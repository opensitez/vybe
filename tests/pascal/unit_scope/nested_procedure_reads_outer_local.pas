// vybe-test: pascal/unit_scope/nested_procedure_reads_outer_local
...
end; procedure Outer; var x: Integer; procedure Inner; begin __p(__vs(x)); end; begin x:=9; Inner; end; begin Outer; __vybeCheck('9');
end.
