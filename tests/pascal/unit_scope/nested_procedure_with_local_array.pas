// vybe-test: pascal/unit_scope/nested_procedure_with_local_array
...
end; procedure P; var a: array[0..1] of Integer; procedure Fill; begin a[0]:=1; a[1]:=2; end; begin Fill; __p(__vs(a[1])); end; begin P; __vybeCheck('2');
end.
