// vybe-test: pascal/unit_scope/nested_class_method_sees_unit_level_var
...
end; var total: Integer; type T=class procedure Bump; end; class procedure T.Bump; begin total:=total+1; end; begin total:=0; T.Bump; T.Bump; __p(__vs(total)); __vybeCheck('2');
end.
