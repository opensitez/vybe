// vybe-test: pascal/unit_procedures_extra/forward_proc_14
...
end; procedure Alpha; forward; procedure Beta; begin __p(__vs(14)); end; procedure Alpha; begin Beta; end; begin Alpha; __vybeCheck('14');
end.
