// vybe-test: pascal/unit_procedures_extra/forward_proc_11
...
end; procedure Alpha; forward; procedure Beta; begin __p(__vs(11)); end; procedure Alpha; begin Beta; end; begin Alpha; __vybeCheck('11');
end.
