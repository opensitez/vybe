// vybe-test: pascal/unit_procedures_extra/forward_proc_3
...
end; procedure Alpha; forward; procedure Beta; begin __p(__vs(3)); end; procedure Alpha; begin Beta; end; begin Alpha; __vybeCheck('3');
end.
