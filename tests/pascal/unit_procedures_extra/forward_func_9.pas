// vybe-test: pascal/unit_procedures_extra/forward_func_9
...
end; function DoubleIt(n:Integer):Integer; forward; function TripleIt(n:Integer):Integer; begin Result:=DoubleIt(n)+n; end; function DoubleIt(n:Integer):Integer; begin Result:=n*2; end; begin __p(__vs(TripleIt(9))); __vybeCheck('27');
end.
