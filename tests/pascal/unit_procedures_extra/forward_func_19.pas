// vybe-test: pascal/unit_procedures_extra/forward_func_19
// origin: languages/pascal/tests/pascal/test_unit_procedures_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function DoubleIt(n:Integer):Integer; forward; function TripleIt(n:Integer):Integer; begin Result:=DoubleIt(n)+n; end; function DoubleIt(n:Integer):Integer; begin Result:=n*2; end; begin __p(__vs(TripleIt(19))); __vybeCheck('57');
end.
