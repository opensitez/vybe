// vybe-test: pascal/unit_procedures_extra/forward_proc_17
...
end; procedure Alpha; forward; procedure Beta; begin __p(__vs(17)); end; procedure Alpha; begin Beta; end; begin Alpha; __vybeCheck('17');
end.
