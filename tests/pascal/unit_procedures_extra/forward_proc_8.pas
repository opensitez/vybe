// vybe-test: pascal/unit_procedures_extra/forward_proc_8
...
end; procedure Alpha; forward; procedure Beta; begin __p(__vs(8)); end; procedure Alpha; begin Beta; end; begin Alpha; __vybeCheck('8');
end.
