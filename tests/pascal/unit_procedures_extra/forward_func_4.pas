// vybe-test: pascal/unit_procedures_extra/forward_func_4
...
end; function DoubleIt(n:Integer):Integer; forward; function TripleIt(n:Integer):Integer; begin Result:=DoubleIt(n)+n; end; function DoubleIt(n:Integer):Integer; begin Result:=n*2; end; begin __p(__vs(TripleIt(4))); __vybeCheck('12');
end.
