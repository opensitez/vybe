// vybe-test: pascal/multidim_arrays/matrix_var_param_mutation
...
end; procedure Bump(var m: array[1..1,1..1] of Integer); begin m[1,1]:=m[1,1]+1; end; var a: array[1..1,1..1] of Integer; begin a[1,1]:=4; Bump(a); __p(__vs(a[1,1])); __vybeCheck('5');
end.
