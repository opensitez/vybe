// vybe-test: pascal/multidim_arrays/matrix_2d_diagonal_sum
...
end; var m: array[1..3,1..3] of Integer; i,s: Integer; begin for i:=1 to 3 do m[i,i]:=i; s:=0; for i:=1 to 3 do s:=s+m[i,i]; __p(__vs(s)); __vybeCheck('6');
end.
