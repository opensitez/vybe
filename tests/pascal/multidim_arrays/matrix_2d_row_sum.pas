// vybe-test: pascal/multidim_arrays/matrix_2d_row_sum
...
end; var m: array[1..2,1..2] of Integer; r,c,s: Integer; begin m[1,1]:=1; m[1,2]:=2; m[2,1]:=3; m[2,2]:=4; s:=0; for r:=1 to 2 do for c:=1 to 2 do s:=s+m[r,c]; __p(__vs(s)); __vybeCheck('10');
end.
