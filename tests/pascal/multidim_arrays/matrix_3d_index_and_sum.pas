// vybe-test: pascal/multidim_arrays/matrix_3d_index_and_sum
...
end; var a: array[0..1,0..1,0..1] of Integer; x,y,z,s: Integer; begin for x:=0 to 1 do for y:=0 to 1 do for z:=0 to 1 do a[x,y,z]:=1; s:=0; for x:=0 to 1 do for y:=0 to 1 do for z:=0 to 1 do s:=s+a[x,y,z]; __p(__vs(s)); __vybeCheck('8');
end.
