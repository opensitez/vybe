// vybe-test: pascal/multidim_arrays/matrix_char_grid_print_row
...
end; var g: array[1..2,1..2] of Char; c: Integer; begin g[1,1]:='a'; g[1,2]:='b'; for c:=1 to 2 do __pw(__vs(g[1,c])); WriteLn; __vybeCheck('ab');
end.
