// vybe-test: pascal/multidim_arrays/matrix_swap_two_cells
...
end; var m: array[1..1,1..2] of Integer; t: Integer; begin m[1,1]:=1; m[1,2]:=9; t:=m[1,1]; m[1,1]:=m[1,2]; m[1,2]:=t; __p(__vs(m[1,1])); __vybeCheck('9');
end.
