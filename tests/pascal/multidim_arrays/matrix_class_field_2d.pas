// vybe-test: pascal/multidim_arrays/matrix_class_field_2d
...
end; type TBoard=class public Cells: array[0..1,0..1] of Integer; end; var b: TBoard; begin b:=TBoard.Create; b.Cells[0,1]:=11; b.Cells[1,0]:=22; __p(__vs(b.Cells[0,1]+b.Cells[1,0])); b.Free; __vybeCheck('33');
end.
