// vybe-test: pascal/multidim_arrays/matrix_function_returns_row_sum
// origin: languages/pascal/tests/pascal/test_multidim_arrays.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function RowSum(const m: array[1..2,1..2] of Integer; r: Integer): Integer; var c: Integer; begin Result:=0; for c:=1 to 2 do Result:=Result+m[r,c]; end; var m: array[1..2,1..2] of Integer; begin m[1,1]:=2; m[1,2]:=3; __p(__vs(RowSum(m,1))); __vybeCheck('5');
end.
