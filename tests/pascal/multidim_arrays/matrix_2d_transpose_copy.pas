// vybe-test: pascal/multidim_arrays/matrix_2d_transpose_copy
...
end; var a,t: array[1..2,1..2] of Integer; r,c: Integer; begin a[1,2]:=9; for r:=1 to 2 do for c:=1 to 2 do t[c,r]:=a[r,c]; __p(__vs(t[2,1])); __vybeCheck('9');
end.
