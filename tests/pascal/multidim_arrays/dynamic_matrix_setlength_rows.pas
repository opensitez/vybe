// vybe-test: pascal/multidim_arrays/dynamic_matrix_setlength_rows
...
end; var m: array of array of Integer; begin SetLength(m,2); SetLength(m[0],2); SetLength(m[1],2); m[0][0]:=1; m[1][1]:=2; __p(__vs(m[0][0]+m[1][1])); __vybeCheck('3');
end.
