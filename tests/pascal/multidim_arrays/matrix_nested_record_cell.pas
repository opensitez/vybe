// vybe-test: pascal/multidim_arrays/matrix_nested_record_cell
...
end; type TC=record V:Integer; end; var g: array[1..2,1..2] of TC; begin g[1,1].V:=5; g[2,2].V:=6; __p(__vs(g[1,1].V+g[2,2].V)); __vybeCheck('11');
end.
