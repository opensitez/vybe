// vybe-test: pascal/multidim_arrays/matrix_open_array_param_rows
...
end; function Cell(const m: array of array of Integer; r,c: Integer): Integer; begin Result:=m[r][c]; end; var m: array[0..1] of array[0..1] of Integer; begin m[0][0]:=3; m[1][1]:=4; __p(__vs(Cell(m,1,1))); __vybeCheck('4');
end.
