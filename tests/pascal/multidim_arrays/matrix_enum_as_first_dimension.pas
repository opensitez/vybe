// vybe-test: pascal/multidim_arrays/matrix_enum_as_first_dimension
...
end; type TR=(R1,R2); var m: array[TR,1..2] of Integer; d: TR; begin m[R1,1]:=7; m[R2,2]:=8; __p(__vs(m[R1,1]+m[R2,2])); __vybeCheck('15');
end.
