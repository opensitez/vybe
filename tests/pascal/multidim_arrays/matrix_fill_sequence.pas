// vybe-test: pascal/multidim_arrays/matrix_fill_sequence
...
end; var m: array[1..2,1..3] of Integer; r,c,v: Integer; begin v:=0; for r:=1 to 2 do for c:=1 to 3 do begin Inc(v); m[r,c]:=v; end; __p(__vs(m[2,3])); __vybeCheck('6');
end.
