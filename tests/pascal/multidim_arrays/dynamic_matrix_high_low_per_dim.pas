// vybe-test: pascal/multidim_arrays/dynamic_matrix_high_low_per_dim
...
end; var m: array of array of Integer; begin SetLength(m,2); SetLength(m[0],3); __p(__vs(High(m))); __p(__vs(High(m[0]))); __vybeCheck('1' + #10 + '2');
end.
