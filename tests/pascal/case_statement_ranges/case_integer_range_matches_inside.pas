// vybe-test: pascal/case_statement_ranges/case_integer_range_matches_inside
...
end; var n: Integer; begin n := 3; case n of 1..5: __p(__vs('band')); else __p(__vs('other')); end; __vybeCheck('band');
end.
