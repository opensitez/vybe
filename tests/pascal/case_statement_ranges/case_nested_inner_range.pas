// vybe-test: pascal/case_statement_ranges/case_nested_inner_range
...
end; var a, b: Integer; begin a := 1; b := 4; case a of 1: case b of 2..5: __p(__vs('inner')); else __p(__vs('outer')); end; else __p(__vs('skip')); end; __vybeCheck('inner');
end.
