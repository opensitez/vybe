// vybe-test: pascal/case_statement_ranges/case_negative_integer_range
...
end; var n: Integer; begin n := -2; case n of -5..-1: __p(__vs('neg')); else __p(__vs('other')); end; __vybeCheck('neg');
end.
