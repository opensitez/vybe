// vybe-test: pascal/case_statement_ranges/case_function_result_from_range_branch
// origin: languages/pascal/tests/pascal/test_case_statement_ranges.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function Sign(n: Integer): string; begin case n of -5..-1: Result := 'neg'; 0: Result := 'zero'; 1..5: Result := 'pos'; else Result := 'unknown'; end; end; begin __p(__vs(Sign(-3))); __p(__vs(Sign(0))); __p(__vs(Sign(4))); __vybeCheck('neg' + #10 + 'zero' + #10 + 'pos');
end.
