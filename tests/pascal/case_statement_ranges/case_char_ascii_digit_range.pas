// vybe-test: pascal/case_statement_ranges/case_char_ascii_digit_range
...
end; var c: Char; begin c := '7'; case c of '0'..'9': __p(__vs('digit')); else __p(__vs('other')); end; __vybeCheck('digit');
end.
