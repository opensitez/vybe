// vybe-test: pascal/case_statement_ranges/case_enum_subset_weekend
...
end; type TDay = (Mon, Tue, Wed, Thu, Fri, Sat, Sun); var d: TDay; begin d := Sun; case d of Sat, Sun: __p(__vs('weekend')); else __p(__vs('weekday')); end; __vybeCheck('weekend');
end.
