// vybe-test: pascal/case_statement_ranges/case_enum_members_as_labels
...
end; type TColor = (Red, Green, Blue); var c: TColor; begin c := Green; case c of Red: __p(__vs('r')); Green: __p(__vs('g')); Blue: __p(__vs('b')); end; __vybeCheck('g');
end.
