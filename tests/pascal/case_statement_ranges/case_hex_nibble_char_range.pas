// vybe-test: pascal/case_statement_ranges/case_hex_nibble_char_range
...
end; var c: Char; v: Integer; begin c := 'C'; case c of '0'..'9': v := Ord(c) - Ord('0'); 'A'..'F': v := 10 + Ord(c) - Ord('A'); else v := -1; end; __p(__vs(v)); __vybeCheck('12');
end.
