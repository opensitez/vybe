// vybe-test: pascal/case_statement_ranges/case_char_range_lowercase
...
end; var c: Char; begin c := 'm'; case c of 'a'..'m': __p(__vs('first')); 'n'..'z': __p(__vs('second')); end; __vybeCheck('first');
end.
