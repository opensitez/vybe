// vybe-test: pascal/case_statement_ranges/case_comma_separated_single_values
...
end; var d: Integer; begin d := 6; case d of 1, 3, 5, 7: __p(__vs('odd')); 2, 4, 6, 8: __p(__vs('even')); end; __vybeCheck('even');
end.
