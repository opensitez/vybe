// vybe-test: pascal/case_statement_ranges/case_comma_separated_disjoint_ranges
...
end; var n: Integer; begin n := 10; case n of 1..3, 8..12: __p(__vs('hit')); else __p(__vs('miss')); end; __vybeCheck('hit');
end.
