// vybe-test: pascal/pascal_file_system_directory_ops/test_filesystem_changefileext
...
uses SysUtils;
begin
  __p(__vs(ChangeFileExt('main.pas', '.exe')));
  __p(__vs(ChangeFileExt('data.tar.gz', '.zip')));
__vybeCheck('main.exe' + #10 + 'data.tar.zip');
end.
