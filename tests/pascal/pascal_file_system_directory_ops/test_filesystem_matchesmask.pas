// vybe-test: pascal/pascal_file_system_directory_ops/test_filesystem_matchesmask
...
uses Masks;
begin
  __p(__vs(MatchesMask('document.pdf', '*.pdf')));
  __p(__vs(MatchesMask('document.txt', '*.pdf')));
