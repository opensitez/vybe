// vybe-test: pascal/pascal_file_system_directory_ops/test_filesystem_extractfilepath_filename_ext
...
begin
  ...
  __p(__vs(ExtractFileName(p)));
  __p(__vs(ExtractFileExt(p)));
  __p(__vs(ExtractFileDir(p)));
__vybeCheck('compiler.pas' + #10 + '.pas' + #10 + '/usr/local/bin');
end.
