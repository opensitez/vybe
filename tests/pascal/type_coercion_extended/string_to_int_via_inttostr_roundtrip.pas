// vybe-test: pascal/type_coercion_extended/string_to_int_via_inttostr_roundtrip
...
end; var n: Integer; s: string; begin n:=808; s:=IntToStr(n); __p(__vs(StrToInt(s))); __vybeCheck('808');
end.
