// vybe-test: pascal/type_coercion_extended/val_procedure_integer_part
// origin: languages/pascal/tests/pascal/test_type_coercion_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var s: string; v: Integer; code: Integer; begin s:='  42abc'; Val(s,v,code); __p(__vs(v)); __p(__vs(code)); __vybeCheck('42' + #10 + '3');
end.
