// vybe-test: pascal/type_coercion_extended/val_procedure_invalid_prefix
...
end; var s: string; v: Integer; code: Integer; begin s:='x9'; Val(s,v,code); __p(__vs(code)); __vybeCheck('1');
end.
