// vybe-test: pascal/programs_extended/fizzbuzz_with_case
// origin: languages/pascal/tests/pascal/test_programs_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  for i := 1 to 15 do
  begin
    if (i mod 15 = 0) then __p(__vs('FizzBuzz'))
    else if (i mod 3 = 0) then __p(__vs('Fizz'))
    else if (i mod 5 = 0) then __p(__vs('Buzz'))
    else __p(__vs(i));
  end;
__vybeCheck('1' + #10 + '2' + #10 + 'Fizz' + #10 + '4' + #10 + 'Buzz' + #10 + 'Fizz' + #10 + '7' + #10 + '8' + #10 + 'Fizz' + #10 + 'Buzz' + #10 + '11' + #10 + 'Fizz' + #10 + '13' + #10 + '14' + #10 + 'FizzBuzz');
end.
