// vybe-test: pascal/programs_extended/palindrome_check
...
begin
  if IsPalindrome('racecar') then __p(__vs('yes')) else __p(__vs('no'));
  if IsPalindrome('hello') then __p(__vs('yes')) else __p(__vs('no'));
__vybeCheck('yes' + #10 + 'no');
end.
