// vybe-test: pascal/numeric_types/int64_comparison
// origin: languages/pascal/tests/pascal/test_numeric_types.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  a := 1000000;
  b := 2000000;
  if a < b then __p(__vs('less')) else __p(__vs('not less'));
__vybeCheck('less');
end.
