// vybe-test: pascal/pascal_dynamic_memory_allocation/test_dynamic_array_in_record_field
...
begin
  ...
  __p(__vs(ds.Title));
  __p(__vs(ds.Values[0] + ds.Values[1]));
__vybeCheck('SensorReadings' + #10 + '37.5');
end.
