// vybe-test: pascal/pascal_interface_property_accessors/test_interface_property_guid_access
...
begin
  g := TGuidImpl.Create;
  __p(__vs(GUIDToString(g.Guid)));
__vybeCheck('{11111111-1111-1111-1111-111111111111}');
end.
