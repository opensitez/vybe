// vybe-test: pascal/pascal_interface_property_accessors/test_interface_property_interface_type
...
procedure TChildImpl.Action; begin __p(__vs('ChildActionExecuted')); end;
...
begin
  ...
  p.Child.Action;
__vybeCheck('ChildActionExecuted');
end.
