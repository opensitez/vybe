// vybe-test: pascal/dynamic_string_array/dstrarr_join_8
...
end; var a:array of string; i:Integer; s:string; begin a:=['x8','y8']; s:=''; for i:=0 to High(a) do s:=s+a[i]; __p(__vs(s)); __vybeCheck('x8y8');
end.
