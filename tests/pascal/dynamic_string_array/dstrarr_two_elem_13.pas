// vybe-test: pascal/dynamic_string_array/dstrarr_two_elem_13
...
end; var a:array of string; begin SetLength(a,2); a[0]:='a13'; a[1]:='b13'; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('a13' + #10 + 'b13');
end.
