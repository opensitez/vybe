// vybe-test: pascal/dynamic_string_array/dstrarr_two_elem_1
...
end; var a:array of string; begin SetLength(a,2); a[0]:='a1'; a[1]:='b1'; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('a1' + #10 + 'b1');
end.
