// vybe-test: pascal/dynamic_string_array/dstrarr_two_elem_7
...
end; var a:array of string; begin SetLength(a,2); a[0]:='a7'; a[1]:='b7'; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('a7' + #10 + 'b7');
end.
