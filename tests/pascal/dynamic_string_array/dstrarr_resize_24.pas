// vybe-test: pascal/dynamic_string_array/dstrarr_resize_24
...
end; var a:array of string; begin SetLength(a,0); SetLength(a,5); a[0]:='z24'; __p(__vs(a[0])); __vybeCheck('z24');
end.
