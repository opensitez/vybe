// vybe-test: pascal/dynamic_string_array/dstrarr_join_20
...
end; var a:array of string; i:Integer; s:string; begin a:=['x20','y20']; s:=''; for i:=0 to High(a) do s:=s+a[i]; __p(__vs(s)); __vybeCheck('x20y20');
end.
