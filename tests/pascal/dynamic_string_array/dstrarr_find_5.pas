// vybe-test: pascal/dynamic_string_array/dstrarr_find_5
...
end; var a:array of string; i,c:Integer; begin a:=['a','b5','c']; c:=0; for i:=0 to High(a) do if a[i]='b5' then Inc(c); __p(__vs(c)); __vybeCheck('1');
end.
