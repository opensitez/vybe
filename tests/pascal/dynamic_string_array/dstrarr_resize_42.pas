// vybe-test: pascal/dynamic_string_array/dstrarr_resize_42
...
end; var a:array of string; begin SetLength(a,0); SetLength(a,3); a[0]:='z42'; __p(__vs(a[0])); __vybeCheck('z42');
end.
