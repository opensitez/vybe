// vybe-test: pascal/dynamic_string_array/dstrarr_two_elem_31
...
end; var a:array of string; begin SetLength(a,2); a[0]:='a31'; a[1]:='b31'; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('a31' + #10 + 'b31');
end.
