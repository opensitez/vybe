// vybe-test: pascal/dynamic_string_array/dstrarr_find_17
...
end; var a:array of string; i,c:Integer; begin a:=['a','b17','c']; c:=0; for i:=0 to High(a) do if a[i]='b17' then Inc(c); __p(__vs(c)); __vybeCheck('1');
end.
