// vybe-test: pascal/dynamic_string_array/dstrarr_find_41
// origin: languages/pascal/tests/pascal/test_dynamic_string_array.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var a:array of string; i,c:Integer; begin a:=['a','b41','c']; c:=0; for i:=0 to High(a) do if a[i]='b41' then Inc(c); __p(__vs(c)); __vybeCheck('1');
end.
