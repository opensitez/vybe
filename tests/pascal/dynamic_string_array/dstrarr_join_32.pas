// vybe-test: pascal/dynamic_string_array/dstrarr_join_32
...
end; var a:array of string; i:Integer; s:string; begin a:=['x32','y32']; s:=''; for i:=0 to High(a) do s:=s+a[i]; __p(__vs(s)); __vybeCheck('x32y32');
end.
