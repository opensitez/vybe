// vybe-test: pascal/dynamic_string_array/dstrarr_resize_30
...
end; var a:array of string; begin SetLength(a,0); SetLength(a,1); a[0]:='z30'; __p(__vs(a[0])); __vybeCheck('z30');
end.
