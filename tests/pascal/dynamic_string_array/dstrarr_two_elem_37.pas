// vybe-test: pascal/dynamic_string_array/dstrarr_two_elem_37
...
end; var a:array of string; begin SetLength(a,2); a[0]:='a37'; a[1]:='b37'; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('a37' + #10 + 'b37');
end.
