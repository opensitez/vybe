// vybe-test: pascal/dynamic_string_array/dstrarr_resize_36
...
end; var a:array of string; begin SetLength(a,0); SetLength(a,2); a[0]:='z36'; __p(__vs(a[0])); __vybeCheck('z36');
end.
