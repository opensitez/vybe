// vybe-test: pascal/dynamic_string_array/dstrarr_two_elem_25
...
end; var a:array of string; begin SetLength(a,2); a[0]:='a25'; a[1]:='b25'; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('a25' + #10 + 'b25');
end.
