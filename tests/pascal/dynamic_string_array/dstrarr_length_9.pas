// vybe-test: pascal/dynamic_string_array/dstrarr_length_9
...
end; var a:array of string; begin SetLength(a,1); a[0]:='only9'; __p(__vs(Length(a))); __p(__vs(a[0])); __vybeCheck('1' + #10 + 'only9');
end.
