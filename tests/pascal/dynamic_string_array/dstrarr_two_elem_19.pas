// vybe-test: pascal/dynamic_string_array/dstrarr_two_elem_19
...
end; var a:array of string; begin SetLength(a,2); a[0]:='a19'; a[1]:='b19'; __p(__vs(a[0])); __p(__vs(a[1])); __vybeCheck('a19' + #10 + 'b19');
end.
