// vybe-test: pascal/dynamic_string_array/dstrarr_resize_18
...
end; var a:array of string; begin SetLength(a,0); SetLength(a,4); a[0]:='z18'; __p(__vs(a[0])); __vybeCheck('z18');
end.
