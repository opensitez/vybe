// vybe-test: pascal/dynamic_string_array/dstrarr_join_38
...
end; var a:array of string; i:Integer; s:string; begin a:=['x38','y38']; s:=''; for i:=0 to High(a) do s:=s+a[i]; __p(__vs(s)); __vybeCheck('x38y38');
end.
