// vybe-test: pascal/dynamic_string_array/dstrarr_join_26
...
end; var a:array of string; i:Integer; s:string; begin a:=['x26','y26']; s:=''; for i:=0 to High(a) do s:=s+a[i]; __p(__vs(s)); __vybeCheck('x26y26');
end.
