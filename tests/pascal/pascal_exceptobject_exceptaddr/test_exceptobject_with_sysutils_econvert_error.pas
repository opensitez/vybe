// vybe-test: pascal/pascal_exceptobject_exceptaddr/test_exceptobject_with_sysutils_econvert_error
...
begin
  try
    ...
    __p(__vs(ExceptObject.ClassName));
  end;
__vybeCheck('EConvertError');
end.
