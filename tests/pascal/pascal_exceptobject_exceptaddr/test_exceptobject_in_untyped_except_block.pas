// vybe-test: pascal/pascal_exceptobject_exceptaddr/test_exceptobject_in_untyped_except_block
...
begin
  try
    ...
    __p(__vs(ExceptObject.ClassName + ':' + Exception(ExceptObject).Message));
  end;
__vybeCheck('EDivByZero:UntypedDivZero');
end.
