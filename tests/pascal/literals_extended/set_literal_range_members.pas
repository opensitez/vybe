// vybe-test: pascal/literals_extended/set_literal_range_members
// origin: languages/pascal/tests/pascal/test_literals_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var s:set of Integer; n:Integer; c:Integer; begin s:=[1..3]; c:=0; for n in s do Inc(c); __p(__vs(c)); __vybeCheck('3');
end.
