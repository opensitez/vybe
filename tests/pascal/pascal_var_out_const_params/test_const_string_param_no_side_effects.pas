// vybe-test: pascal/pascal_var_out_const_params/test_const_string_param_no_side_effects
// origin: languages/pascal/tests/pascal/test_pascal_var_out_const_params.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  original := 'ABC';
  __p(__vs(RepeatTwice(original)));
  __p(__vs(original));
__vybeCheck('ABCABC' + #10 + 'ABC');
end.
