// vybe-test: pascal/pascal_structure_packing_alignment/test_packed_record_boolean_fields
// origin: languages/pascal/tests/pascal/test_pascal_structure_packing_alignment.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  __p(__vs(SizeOf(TPackedFlags)));
  __p(__vs(pf.F1));
  __p(__vs(pf.F2));
  __p(__vs(pf.F3));
__vybeCheck('3' + #10 + 'True' + #10 + 'False' + #10 + 'True');
end.
