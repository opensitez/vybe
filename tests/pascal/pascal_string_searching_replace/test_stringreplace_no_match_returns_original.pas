// vybe-test: pascal/pascal_string_searching_replace/test_stringreplace_no_match_returns_original
// origin: languages/pascal/tests/pascal/test_pascal_string_searching_replace.rs
program Test;
{$mode delphi}
...
uses SysUtils;
begin
  __p(__vs(StringReplace('UnchangedText', 'Missing', 'Replacement', [rfReplaceAll])));
__vybeCheck('UnchangedText');
end.
