// vybe-test: pascal/pascal_string_searching_replace/test_replacetext_case_insensitive
...
uses StrUtils;
begin
  __p(__vs(ReplaceText('Test test TEST', 'test', 'Pass')));
__vybeCheck('Pass Pass Pass');
end.
