// vybe-test: pascal/class_methods_extra/class_procedure_log_line
...
end; type TLog=class class procedure Line(const s:string); end; class procedure TLog.Line(const s:string); begin __p(__vs('L:'+s)); end; begin TLog.Line('ok'); __vybeCheck('L:ok');
end.
