// vybe-test: pascal/class_methods_extra/class_var_string_buffer_append
...
end; type TBuf=class class var S:string; class procedure Add(const t:string); end; class var TBuf.S:string; class procedure TBuf.Add(const t:string); begin S:=S+t; end; begin TBuf.S:=''; TBuf.Add('a'); TBuf.Add('b'); __p(__vs(TBuf.S)); __vybeCheck('ab');
end.
