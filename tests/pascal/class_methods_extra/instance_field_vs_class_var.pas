// vybe-test: pascal/class_methods_extra/instance_field_vs_class_var
...
end; type TMix=class class var Shared:Integer; Local:Integer; end; class var TMix.Shared:Integer; var a,b:TMix; begin TMix.Shared:=0; a:=TMix.Create; b:=TMix.Create; a.Local:=1; b.Local:=2; Inc(TMix.Shared); __p(__vs(a.Local)); __p(__vs(TMix.Shared)); __vybeCheck('1' + #10 + '1');
end.
