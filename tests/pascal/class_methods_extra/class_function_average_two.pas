// vybe-test: pascal/class_methods_extra/class_function_average_two
...
end; type TAvg=class class function Mean(a,b:Integer):Integer; end; class function TAvg.Mean(a,b:Integer):Integer; begin Result:=(a+b) div 2; end; begin __p(__vs(TAvg.Mean(5,9))); __vybeCheck('7');
end.
