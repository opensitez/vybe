// vybe-test: pascal/class_methods_extra/two_instances_share_class_var
...
end; type TGlobal=class class var Hits:Integer; procedure Ping; end; class var TGlobal.Hits:Integer; procedure TGlobal.Ping; begin Inc(Hits); end; var a,b:TGlobal; begin TGlobal.Hits:=0; a:=TGlobal.Create; b:=TGlobal.Create; a.Ping; b.Ping; __p(__vs(TGlobal.Hits)); __vybeCheck('2');
end.
