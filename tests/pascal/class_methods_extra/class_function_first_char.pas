// vybe-test: pascal/class_methods_extra/class_function_first_char
...
end; type THead=class class function First(const s:string):Char; end; class function THead.First(const s:string):Char; begin Result:=s[1]; end; begin __p(__vs(THead.First('zoo'))); __vybeCheck('z');
end.
