// vybe-test: pascal/class_methods_extra/class_procedure_print_twice
...
end; type TOut=class class procedure Twice(const s:string); end; class procedure TOut.Twice(const s:string); begin __p(__vs(s)); __p(__vs(s)); end; begin TOut.Twice('x'); __vybeCheck('x' + #10 + 'x');
end.
