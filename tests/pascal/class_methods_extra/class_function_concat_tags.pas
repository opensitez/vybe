// vybe-test: pascal/class_methods_extra/class_function_concat_tags
...
end; type TTag=class class function Join(a,b:string):string; end; class function TTag.Join(a,b:string):string; begin Result:='<'+a+'/'+b+'>'; end; begin __p(__vs(TTag.Join('a','b'))); __vybeCheck('<a/b>');
end.
