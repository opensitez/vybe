// vybe-test: pascal/class_methods_extra/class_function_negate_int
...
end; type TNeg=class class function Flip(n:Integer):Integer; end; class function TNeg.Flip(n:Integer):Integer; begin Result:=-n; end; begin __p(__vs(TNeg.Flip(11))); __vybeCheck('-11');
end.
