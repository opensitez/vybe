// vybe-test: pascal/class_methods_extra/class_function_modulo
...
end; type TMod=class class function Rem(a,b:Integer):Integer; end; class function TMod.Rem(a,b:Integer):Integer; begin Result:=a mod b; end; begin __p(__vs(TMod.Rem(10,3))); __vybeCheck('1');
end.
