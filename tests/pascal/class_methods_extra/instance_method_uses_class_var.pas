// vybe-test: pascal/class_methods_extra/instance_method_uses_class_var
...
end; type TApp=class class var Seq:Integer; procedure Next; end; class var TApp.Seq:Integer; procedure TApp.Next; begin Inc(Seq); __p(__vs(Seq)); end; var a:TApp; begin TApp.Seq:=0; a:=TApp.Create; a.Next; a.Next; __vybeCheck('1' + #10 + '2');
end.
