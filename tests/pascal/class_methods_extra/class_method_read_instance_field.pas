// vybe-test: pascal/class_methods_extra/class_method_read_instance_field
...
end; type TBox=class W,H:Integer; function Area:Integer; end; function TBox.Area:Integer; begin Result:=W*H; end; var b:TBox; begin b:=TBox.Create; b.W:=4; b.H:=5; __p(__vs(b.Area)); __vybeCheck('20');
end.
