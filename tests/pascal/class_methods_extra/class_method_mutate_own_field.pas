// vybe-test: pascal/class_methods_extra/class_method_mutate_own_field
...
end; type TInc=class N:Integer; procedure Bump; end; procedure TInc.Bump; begin Inc(N); end; var x:TInc; begin x:=TInc.Create; x.N:=10; x.Bump; __p(__vs(x.N)); __vybeCheck('11');
end.
