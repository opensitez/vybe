// vybe-test: pascal/class_methods_extra/class_const_used_in_method
...
end; type TLimits=class public const Max=10; class function Cap(n:Integer):Integer; end; class function TLimits.Cap(n:Integer):Integer; begin if n>Max then Result:=Max else Result:=n; end; begin __p(__vs(TLimits.Cap(15))); __vybeCheck('10');
end.
