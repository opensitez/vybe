// vybe-test: pascal/class_methods_extra/class_function_sum_three
...
end; type TAdd=class class function Sum(a,b,c:Integer):Integer; end; class function TAdd.Sum(a,b,c:Integer):Integer; begin Result:=a+b+c; end; begin __p(__vs(TAdd.Sum(1,2,3))); __vybeCheck('6');
end.
