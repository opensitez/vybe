// vybe-test: pascal/class_methods_extra/class_var_accumulate_from_method
...
end; type TSum=class class var Total:Integer; procedure Add(v:Integer); end; class var TSum.Total:Integer; procedure TSum.Add(v:Integer); begin Total:=Total+v; end; var s:TSum; begin TSum.Total:=0; s:=TSum.Create; s.Add(3); s.Add(4); __p(__vs(TSum.Total)); __vybeCheck('7');
end.
