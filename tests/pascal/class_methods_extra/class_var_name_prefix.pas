// vybe-test: pascal/class_methods_extra/class_var_name_prefix
...
end; type TId=class class var Next:Integer; class function Gen:string; end; class var TId.Next:Integer; class function TId.Gen:string; begin Result:='id'+IntToStr(Next); Inc(Next); end; begin TId.Next:=1; __p(__vs(TId.Gen)); __p(__vs(TId.Gen)); __vybeCheck('id1' + #10 + 'id2');
end.
