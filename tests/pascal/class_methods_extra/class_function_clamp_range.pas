// vybe-test: pascal/class_methods_extra/class_function_clamp_range
...
end; type TClamp=class class function InRange(v,lo,hi:Integer):Integer; end; class function TClamp.InRange(v,lo,hi:Integer):Integer; begin if v<lo then Result:=lo else if v>hi then Result:=hi else Result:=v; end; begin __p(__vs(TClamp.InRange(15,0,10))); __vybeCheck('10');
end.
