// vybe-test: pascal/class_methods_extra/class_var_max_tracking
...
end; type TMax=class class var Best:Integer; class procedure Consider(v:Integer); end; class var TMax.Best:Integer; class procedure TMax.Consider(v:Integer); begin if v>Best then Best:=v; end; begin TMax.Best:=0; TMax.Consider(3); TMax.Consider(7); TMax.Consider(5); __p(__vs(TMax.Best)); __vybeCheck('7');
end.
