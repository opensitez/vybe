// vybe-test: pascal/class_methods_extra/class_function_min_pair
...
end; type TUtil=class class function Min(a,b:Integer):Integer; end; class function TUtil.Min(a,b:Integer):Integer; begin if a<b then Result:=a else Result:=b; end; begin __p(__vs(TUtil.Min(7,3))); __vybeCheck('3');
end.
