// vybe-test: pascal/class_methods_extra/class_function_factorial_static
...
end; type TMath=class class function Fact(n:Integer):Integer; end; class function TMath.Fact(n:Integer):Integer; begin if n<=1 then Result:=1 else Result:=n*Fact(n-1); end; begin __p(__vs(TMath.Fact(5))); __vybeCheck('120');
end.
