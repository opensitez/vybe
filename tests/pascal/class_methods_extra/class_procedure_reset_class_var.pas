// vybe-test: pascal/class_methods_extra/class_procedure_reset_class_var
...
end; type TStore=class class var V:Integer; class procedure Reset; end; class var TStore.V:Integer; class procedure TStore.Reset; begin V:=0; end; begin TStore.V:=9; TStore.Reset; __p(__vs(TStore.V)); __vybeCheck('0');
end.
