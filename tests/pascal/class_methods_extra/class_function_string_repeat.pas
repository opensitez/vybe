// vybe-test: pascal/class_methods_extra/class_function_string_repeat
...
end; type TStr=class class function Dup(s:string; n:Integer):string; end; class function TStr.Dup(s:string; n:Integer):string; var i:Integer; begin Result:=''; for i:=1 to n do Result:=Result+s; end; begin __p(__vs(TStr.Dup('o',3))); __vybeCheck('ooo');
end.
