// vybe-test: pascal/class_methods_extra/class_var_decrement_procedure
...
end; type TDec=class class var N:Integer; class procedure Step; end; class var TDec.N:Integer; class procedure TDec.Step; begin Dec(N); end; begin TDec.N:=5; TDec.Step; TDec.Step; __p(__vs(TDec.N)); __vybeCheck('3');
end.
