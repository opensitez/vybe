// vybe-test: pascal/class_methods_extra/class_function_gcd_style
...
end; type TGcd=class class function G(a,b:Integer):Integer; end; class function TGcd.G(a,b:Integer):Integer; begin if b=0 then Result:=a else Result:=G(b,a mod b); end; begin __p(__vs(TGcd.G(48,18))); __vybeCheck('6');
end.
