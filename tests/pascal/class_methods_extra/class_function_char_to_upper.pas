// vybe-test: pascal/class_methods_extra/class_function_char_to_upper
...
end; type TCharUtil=class class function Up(c:Char):Char; end; class function TCharUtil.Up(c:Char):Char; begin Result:=UpCase(c); end; begin __p(__vs(TCharUtil.Up('g'))); __vybeCheck('G');
end.
