// vybe-test: pascal/class_methods_extra/class_method_chain_on_instance
...
end; type TAcc=class Value:Integer; procedure Add(n:Integer); function Get:Integer; end; procedure TAcc.Add(n:Integer); begin Value:=Value+n; end; function TAcc.Get:Integer; begin Result:=Value; end; var a:TAcc; begin a:=TAcc.Create; a.Value:=1; a.Add(2); __p(__vs(a.Get)); __vybeCheck('3');
end.
