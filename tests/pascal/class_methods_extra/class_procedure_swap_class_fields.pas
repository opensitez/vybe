// vybe-test: pascal/class_methods_extra/class_procedure_swap_class_fields
// origin: languages/pascal/tests/pascal/test_class_methods_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TPair=class class var A,B:Integer; class procedure Swap; end; class var TPair.A:Integer; class var TPair.B:Integer; class procedure TPair.Swap; var t:Integer; begin t:=A; A:=B; B:=t; end; begin TPair.A:=1; TPair.B:=2; TPair.Swap; __p(__vs(TPair.A)); __p(__vs(TPair.B)); __vybeCheck('2' + #10 + '1');
end.
