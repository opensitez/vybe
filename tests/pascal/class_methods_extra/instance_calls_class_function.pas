// vybe-test: pascal/class_methods_extra/instance_calls_class_function
...
end; type TWrap=class function Double(n:Integer):Integer; end; function TWrap.Double(n:Integer):Integer; begin Result:=n*2; end; var w:TWrap; begin w:=TWrap.Create; __p(__vs(w.Double(6))); __vybeCheck('12');
end.
