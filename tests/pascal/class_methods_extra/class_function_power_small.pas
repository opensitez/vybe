// vybe-test: pascal/class_methods_extra/class_function_power_small
...
end; type TPow=class class function P(n,e:Integer):Integer; end; class function TPow.P(n,e:Integer):Integer; var i:Integer; begin Result:=1; for i:=1 to e do Result:=Result*n; end; begin __p(__vs(TPow.P(2,4))); __vybeCheck('16');
end.
