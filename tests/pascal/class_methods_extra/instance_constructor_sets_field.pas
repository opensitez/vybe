// vybe-test: pascal/class_methods_extra/instance_constructor_sets_field
...
end; type TItem=class constructor Create(v:Integer); Value:Integer; end; constructor TItem.Create(v:Integer); begin Value:=v; end; var i:TItem; begin i:=TItem.Create(42); __p(__vs(i.Value)); __vybeCheck('42');
end.
