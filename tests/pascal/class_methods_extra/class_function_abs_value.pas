// vybe-test: pascal/class_methods_extra/class_function_abs_value
...
end; type TAbs=class class function Val(n:Integer):Integer; end; class function TAbs.Val(n:Integer):Integer; begin if n<0 then Result:=-n else Result:=n; end; begin __p(__vs(TAbs.Val(-9))); __vybeCheck('9');
end.
