// vybe-test: pascal/class_methods_extra/class_var_initialized_nonzero
...
end; type TSeed=class class var Base:Integer; end; class var TSeed.Base:Integer; begin TSeed.Base:=100; __p(__vs(TSeed.Base)); __vybeCheck('100');
end.
