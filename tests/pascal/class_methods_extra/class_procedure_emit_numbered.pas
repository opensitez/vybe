// vybe-test: pascal/class_methods_extra/class_procedure_emit_numbered
...
end; type TSeq=class class var I:Integer; class procedure Tick; end; class var TSeq.I:Integer; class procedure TSeq.Tick; begin Inc(I); __p(__vs(I)); end; begin TSeq.I:=0; TSeq.Tick; TSeq.Tick; __vybeCheck('1' + #10 + '2');
end.
