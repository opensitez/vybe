// vybe-test: pascal/class_methods_extra/class_function_length_of_string
...
end; type TLen=class class function OfStr(const s:string):Integer; end; class function TLen.OfStr(const s:string):Integer; begin Result:=Length(s); end; begin __p(__vs(TLen.OfStr('abcd'))); __vybeCheck('4');
end.
