// vybe-test: pascal/class_methods_extra/class_var_set_from_static_method
...
end; type TCfg=class class var Port:Integer; class procedure SetPort(p:Integer); end; class var TCfg.Port:Integer; class procedure TCfg.SetPort(p:Integer); begin Port:=p; end; begin TCfg.SetPort(8080); __p(__vs(TCfg.Port)); __vybeCheck('8080');
end.
