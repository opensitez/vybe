// vybe-test: pascal/class_methods_extra/class_var_shared_counter_increment
...
end; type TCounter=class class var N:Integer; class procedure IncN; end; class var TCounter.N:Integer; class procedure TCounter.IncN; begin Inc(N); end; begin TCounter.N:=0; TCounter.IncN; TCounter.IncN; __p(__vs(TCounter.N)); __vybeCheck('2');
end.
