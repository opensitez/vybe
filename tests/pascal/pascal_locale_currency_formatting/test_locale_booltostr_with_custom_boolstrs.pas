// vybe-test: pascal/pascal_locale_currency_formatting/test_locale_booltostr_with_custom_boolstrs
...
begin
  ...
  __p(__vs(BoolToStr(True, True)));
  __p(__vs(BoolToStr(False, True)));
