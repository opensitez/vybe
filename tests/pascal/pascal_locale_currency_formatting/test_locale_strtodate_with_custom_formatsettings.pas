// vybe-test: pascal/pascal_locale_currency_formatting/test_locale_strtodate_with_custom_formatsettings
// origin: languages/pascal/tests/pascal/test_pascal_locale_currency_formatting.rs
program Test;
{$mode delphi}
...
begin
  ...
  DecodeDate(dt, y, m, d);
  __p(__vs(y.ToString + '-' + m.ToString + '-' + d.ToString));
__vybeCheck('2026-12-25');
end.
