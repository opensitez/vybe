// vybe-test: pascal/pascal_locale_currency_formatting/test_locale_formatfloat_scientific_notation
...
uses SysUtils;
begin
  __p(__vs(FormatFloat('0.00E+00', 1234.56)));
__vybeCheck('1.23E+03');
end.
