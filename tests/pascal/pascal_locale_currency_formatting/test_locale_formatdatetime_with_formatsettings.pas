// vybe-test: pascal/pascal_locale_currency_formatting/test_locale_formatdatetime_with_formatsettings
...
begin
  ...
  __p(__vs(FormatDateTime('yyyy/mm/dd', dt, fs)));
__vybeCheck('2026/11/30');
end.
