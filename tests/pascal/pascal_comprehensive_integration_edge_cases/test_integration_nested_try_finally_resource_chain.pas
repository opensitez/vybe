// vybe-test: pascal/pascal_comprehensive_integration_edge_cases/test_integration_nested_try_finally_resource_chain
...
begin
  ProcessPipeline;
__vybeCheck('MS1Created' + #10 + 'MS2Created' + #10 + 'MS2Freed' + #10 + 'MS1Freed');
end.
