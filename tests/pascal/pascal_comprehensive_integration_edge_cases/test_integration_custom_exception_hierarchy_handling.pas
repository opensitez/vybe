// vybe-test: pascal/pascal_comprehensive_integration_edge_cases/test_integration_custom_exception_hierarchy_handling
...
begin
  try
    ...
    on E: EValError do __p(__vs('ValError:' + E.Field + '=' + E.Message));
    on E: EAppError do __p(__vs('AppError'));
  end;
__vybeCheck('ValError:Age=CannotBeNegative');
end.
