// vybe-test: pascal/pascal_comprehensive_integration_edge_cases/test_integration_binary_reader_writer_record_stream
...
begin
  ...
  r.Free; ms.Free;
__vybeCheck('100' + #10 + 'StreamPayload' + #10 + 'True');
end.
