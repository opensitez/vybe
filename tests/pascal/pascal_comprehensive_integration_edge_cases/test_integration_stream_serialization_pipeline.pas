// vybe-test: pascal/pascal_comprehensive_integration_edge_cases/test_integration_stream_serialization_pipeline
...
begin
  ...
  try
    ...
    __p(__vs(a2.ID.ToString + ':' + CurrToStr(a2.Balance)));
  finally
    ms.Free;
  end;
__vybeCheck('101:1500.75');
end.
