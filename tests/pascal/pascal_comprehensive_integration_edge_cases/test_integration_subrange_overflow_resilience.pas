// vybe-test: pascal/pascal_comprehensive_integration_edge_cases/test_integration_subrange_overflow_resilience
...
begin
  try
    BoundsCheck;
    __p(__vs('BoundsCheckOK'));
  except
    on E: ERangeError do __p(__vs('Failed'));
  end;
__vybeCheck('10' + #10 + 'BoundsCheckOK');
end.
