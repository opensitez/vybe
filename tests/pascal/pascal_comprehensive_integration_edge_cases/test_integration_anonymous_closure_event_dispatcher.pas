// vybe-test: pascal/pascal_comprehensive_integration_edge_cases/test_integration_anonymous_closure_event_dispatcher
...
begin
  ...
  bus.Subscribe(procedure(const msg: String) begin __p(__vs('Sub1:' + msg)); end);
  bus.Subscribe(procedure(const msg: String) begin __p(__vs('Sub2:' + msg)); end);

  bus.Publish('Broadcast');

  bus.Free;
__vybeCheck('Sub1:Broadcast' + #10 + 'Sub2:Broadcast');
end.
