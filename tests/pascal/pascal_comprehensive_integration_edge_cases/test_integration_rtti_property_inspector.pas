// vybe-test: pascal/pascal_comprehensive_integration_edge_cases/test_integration_rtti_property_inspector
...
begin
  ...
  for prop in t.GetProperties do
    __p(__vs(prop.Name + '=' + prop.GetValue(p).ToString));

  ctx.Free; p.Free;
__vybeCheck('Name=Alice' + #10 + 'Age=30');
end.
