// vybe-test: pascal/packed_records/packed_record_used_in_case_on_byte_field
...
end; type THdr = packed record Ver: Byte; end; var h: THdr; begin h.Ver := 2; case h.Ver of 1: __p(__vs('v1')); 2: __p(__vs('v2')); else __p(__vs('other')); end; __vybeCheck('v2');
end.
