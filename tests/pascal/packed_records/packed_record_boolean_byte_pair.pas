// vybe-test: pascal/packed_records/packed_record_boolean_byte_pair
...
end; type TFlags = packed record On: Boolean; Id: Byte; end; var f: TFlags; begin f.On := true; f.Id := 5; if f.On then __p(__vs(f.Id)); __vybeCheck('5');
end.
