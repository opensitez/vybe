// vybe-test: pascal/packed_records/packed_record_mixed_byte_char_fields
...
end; type TMix = packed record Code: Byte; Ch: Char; end; var m: TMix; begin m.Code := 65; m.Ch := 'Z'; __p(__vs(m.Ch)); __vybeCheck('Z');
end.
