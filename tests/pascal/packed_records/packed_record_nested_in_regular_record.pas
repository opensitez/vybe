// vybe-test: pascal/packed_records/packed_record_nested_in_regular_record
// origin: languages/pascal/tests/pascal/test_packed_records.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TInner = packed record B: Byte; end; type TOuter = record Inner: TInner; Tag: Integer; end; var o: TOuter; begin o.Inner.B := 7; o.Tag := 1; __p(__vs(o.Inner.B)); __vybeCheck('7');
end.
