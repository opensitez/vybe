// vybe-test: pascal/packed_records/packed_record_two_bytes_size
...
end; type TPacked = packed record A: Byte; B: Byte; end; var p: TPacked; begin p.A := 1; p.B := 2; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('1' + #10 + '2');
end.
