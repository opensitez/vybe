// vybe-test: pascal/packed_records/packed_record_assign_copy
...
end; type TP = packed record Lo, Hi: Byte; end; var a, b: TP; begin a.Lo := 3; a.Hi := 9; b := a; __p(__vs(b.Hi)); __vybeCheck('9');
end.
