// vybe-test: pascal/pascal_bitwise_shift_rotations/test_bit_rolbyte_rorbyte
...
begin
  __p(__vs(HexStr(RolByte($80, 1), 2))); // $80 rol 1 -> $01
  __p(__vs(HexStr(RorByte($01, 1), 2))); // $01 ror 1 -> $80
__vybeCheck('01' + #10 + '80');
end.
