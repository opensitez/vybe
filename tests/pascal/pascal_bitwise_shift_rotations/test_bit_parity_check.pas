// vybe-test: pascal/pascal_bitwise_shift_rotations/test_bit_parity_check
...
begin
  __p(__vs(IsEvenParity($03))); // 00000011 -> 2 ones -> Even
  __p(__vs(IsEvenParity($07))); // 00000111 -> 3 ones -> Odd
