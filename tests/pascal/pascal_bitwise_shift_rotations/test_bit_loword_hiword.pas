// vybe-test: pascal/pascal_bitwise_shift_rotations/test_bit_loword_hiword
...
begin
  card := $12345678;
  __p(__vs(HexStr(LoWord(card), 4)));
  __p(__vs(HexStr(HiWord(card), 4)));
__vybeCheck('5678' + #10 + '1234');
end.
