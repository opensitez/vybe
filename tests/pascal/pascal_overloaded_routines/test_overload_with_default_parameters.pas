// vybe-test: pascal/pascal_overloaded_routines/test_overload_with_default_parameters
...
begin
  __p(__vs('EXEC_INT:' + (a + b).ToString));
end;
...
begin
  Exec(10);
  Exec('test');
__vybeCheck('EXEC_INT:10' + #10 + 'EXEC_STR:test');
end.
