// vybe-test: pascal/pascal_overloaded_routines/test_overload_four_arguments
...
begin
  __p(__vs('2_ARGS:' + (a + b).ToString));
end;
procedure Config(a, b, c, d: Integer); overload;
begin
  __p(__vs('4_ARGS:' + (a + b + c + d).ToString));
end;
begin
  Config(1, 2);
  Config(1, 2, 3, 4);
__vybeCheck('2_ARGS:3' + #10 + '4_ARGS:10');
end.
