// vybe-test: pascal/pascal_overloaded_routines/test_overload_three_types
// origin: languages/pascal/tests/pascal/test_pascal_overloaded_routines.rs
program Test;
{$mode delphi}
uses SysUtils;
...
procedure Handle(i: Integer); overload; begin __p(__vs('INT')); end;
procedure Handle(r: Real); overload; begin __p(__vs('REAL')); end;
procedure Handle(s: String); overload; begin __p(__vs('STR')); end;
begin
  Handle(5);
  Handle(5.5);
  Handle('five');
__vybeCheck('INT' + #10 + 'REAL' + #10 + 'STR');
end.
