// vybe-test: pascal/pascal_overloaded_routines/test_overload_inherited_class_methods
...
begin
  __p(__vs('BASE_INT:' + i.ToString));
end;
procedure TDerived.Show(s: String);
begin
  __p(__vs('DERIVED_STR:' + s));
end;
var d: TDerived;
begin
  d := TDerived.Create;
  ...
  d.Show(42);
  d.Free;
__vybeCheck('DERIVED_STR:hello' + #10 + 'BASE_INT:42');
end.
