// vybe-test: pascal/pascal_overloaded_routines/test_overload_constructors
...
begin
  ...
  __p(__vs(p1.Name + ':' + p1.Age.ToString));
  __p(__vs(p2.Name + ':' + p2.Age.ToString));
  p1.Free; p2.Free;
__vybeCheck('Alice:0' + #10 + 'Bob:30');
end.
