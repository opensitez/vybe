// vybe-test: pascal/pascal_overloaded_routines/test_overload_class_methods
...
begin
  __p(__vs('ERR[' + code.ToString + ']: ' + msg));
end;
var logger: TLogger;
begin
  ...
  logger.Free;
__vybeCheck('LOG: Info message' + #10 + 'ERR[404]: Not Found');
end.
