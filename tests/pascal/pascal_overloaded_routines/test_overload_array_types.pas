// vybe-test: pascal/pascal_overloaded_routines/test_overload_array_types
...
begin
  __p(__vs('INT_ARR:' + a[1].ToString));
end;
procedure Dump(a: TStrArr); overload;
begin
  __p(__vs('STR_ARR:' + a[1]));
end;
...
begin
  ...
  Dump(ia);
  Dump(sa);
__vybeCheck('INT_ARR:10' + #10 + 'STR_ARR:first');
end.
