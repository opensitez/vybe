// vybe-test: pascal/pascal_overloaded_routines/test_overload_in_nested_routines
...
procedure Parent;
  ...
  begin
    __p(__vs('NESTED_INT:' + n.ToString));
  end;
  procedure Action(s: String); overload;
  begin
    __p(__vs('NESTED_STR:' + s));
  end;
begin
  Action(99);
  Action('nested');
...
begin
  Parent;
__vybeCheck('NESTED_INT:99' + #10 + 'NESTED_STR:nested');
end.
