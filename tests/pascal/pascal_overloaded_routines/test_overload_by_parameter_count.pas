// vybe-test: pascal/pascal_overloaded_routines/test_overload_by_parameter_count
...
begin
  __p(__vs('One: ' + a.ToString));
end;
procedure Display(a, b: Integer); overload;
begin
  __p(__vs('Two: ' + a.ToString + ', ' + b.ToString));
end;
begin
  Display(10);
  Display(10, 20);
__vybeCheck('One: 10' + #10 + 'Two: 10, 20');
end.
