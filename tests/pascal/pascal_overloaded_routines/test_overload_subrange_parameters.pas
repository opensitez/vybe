// vybe-test: pascal/pascal_overloaded_routines/test_overload_subrange_parameters
...
begin
  __p(__vs('SUB1:' + s.ToString));
end;
procedure TestSub(s: TSub2); overload;
begin
  __p(__vs('SUB2:' + s.ToString));
end;
...
begin
  ...
  TestSub(v1);
  TestSub(v2);
__vybeCheck('SUB1:5' + #10 + 'SUB2:150');
end.
