// vybe-test: pascal/pascal_default_parameter_values/test_default_param_boolean_flag
...
begin
  if verbose then __p(__vs('[VERBOSE] ' + msg))
  else __p(__vs('[INFO] ' + msg));
end;
begin
  LogMsg('System started');
  LogMsg('Debug details', True);
__vybeCheck('[INFO] System started' + #10 + '[VERBOSE] Debug details');
end.
