// vybe-test: pascal/pascal_default_parameter_values/test_default_param_mixed_explicit_and_defaults
...
begin
  __p(__vs(ComputeTax(100.0)));
  __p(__vs(ComputeTax(100.0, 0.10)));
  __p(__vs(ComputeTax(100.0, 0.10, 5.0)));
__vybeCheck('115' + #10 + '115' + #10 + '115');
end.
