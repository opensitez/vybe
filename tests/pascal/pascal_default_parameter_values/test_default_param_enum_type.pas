// vybe-test: pascal/pascal_default_parameter_values/test_default_param_enum_type
...
begin
  __p(__vs(FormatAlign('Title')));
  __p(__vs(FormatAlign('Body', alLeft)));
__vybeCheck('1:Title' + #10 + '0:Body');
end.
