// vybe-test: pascal/pascal_default_parameter_values/test_default_param_with_const_modifier
...
begin
  __p(__vs(AppendSuffix('document')));
  __p(__vs(AppendSuffix('image', '.png')));
__vybeCheck('document.txt' + #10 + 'image.png');
end.
