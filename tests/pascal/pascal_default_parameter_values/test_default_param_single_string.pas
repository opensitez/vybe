// vybe-test: pascal/pascal_default_parameter_values/test_default_param_single_string
...
begin
  __p(__vs(Greet('Alice')));
  __p(__vs(Greet('Bob', 'Welcome')));
__vybeCheck('Hello Alice' + #10 + 'Welcome Bob');
end.
