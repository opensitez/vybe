// vybe-test: pascal/pascal_default_parameter_values/test_default_param_class_static_method
...
begin
  __p(__vs(TMathUtils.Multiply(10)));
  __p(__vs(TMathUtils.Multiply(10, 5)));
__vybeCheck('20' + #10 + '50');
end.
