// vybe-test: pascal/pascal_default_parameter_values/test_default_param_negative_integer
...
begin
  __p(__vs(AdjustScore(100)));
  __p(__vs(AdjustScore(100, -10)));
__vybeCheck('95' + #10 + '90');
end.
