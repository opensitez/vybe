// vybe-test: pascal/pascal_default_parameter_values/test_default_param_floating_point
...
begin
  __p(__vs(MultiplyFactor(10.0)));
  __p(__vs(MultiplyFactor(10.0, 2.0)));
__vybeCheck('15' + #10 + '20');
end.
