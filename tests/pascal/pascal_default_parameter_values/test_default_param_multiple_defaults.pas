// vybe-test: pascal/pascal_default_parameter_values/test_default_param_multiple_defaults
// origin: languages/pascal/tests/pascal/test_pascal_default_parameter_values.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(CalcBoxVolume));
  __p(__vs(CalcBoxVolume(5)));
  __p(__vs(CalcBoxVolume(5, 4)));
  __p(__vs(CalcBoxVolume(5, 4, 3)));
__vybeCheck('1' + #10 + '5' + #10 + '20' + #10 + '60');
end.
