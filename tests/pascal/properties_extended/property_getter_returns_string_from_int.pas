// vybe-test: pascal/properties_extended/property_getter_returns_string_from_int
...
end; type TNum=class private FN:Integer; function GetHex:string; public property N:Integer read FN write FN; property Hex:string read GetHex; end; function TNum.GetHex:string; begin Result:=IntToHex(FN,2); end; var n:TNum; begin n:=TNum.Create; n.N:=255; __p(__vs(n.Hex)); __vybeCheck('FF');
end.
