// vybe-test: pascal/properties_extended/property_nested_class_access
...
end; type TInner=class public property V:Integer read FV write FV; FV:Integer; end; TOuter=class public Inner:TInner; constructor Create; end; constructor TOuter.Create; begin Inner:=TInner.Create; end; var o:TOuter; begin o:=TOuter.Create; o.Inner.V:=12; __p(__vs(o.Inner.V)); __vybeCheck('12');
end.
