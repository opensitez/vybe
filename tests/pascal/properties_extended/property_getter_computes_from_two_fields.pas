// vybe-test: pascal/properties_extended/property_getter_computes_from_two_fields
...
end; type TRect=class private FW,FH:Integer; function GetArea:Integer; public property Width:Integer read FW write FW; property Height:Integer read FH write FH; property Area:Integer read GetArea; end; function TRect.GetArea:Integer; begin Result:=FW*FH; end; var r:TRect; begin r:=TRect.Create; r.Width:=4; r.Height:=5; __p(__vs(r.Area)); __vybeCheck('20');
end.
