// vybe-test: pascal/properties_extended/property_inherited_simple_field
...
end; type TBase=class protected F:Integer; public property N:Integer read F write F; end; TChild=class(TBase); var c:TChild; begin c:=TChild.Create; c.N:=18; __p(__vs(c.N)); __vybeCheck('18');
end.
