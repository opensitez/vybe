// vybe-test: pascal/properties_extended/property_getter_lazy_init
...
end; type TLazy=class private FReady:Boolean; FVal:Integer; function GetVal:Integer; public property Val:Integer read GetVal; end; function TLazy.GetVal:Integer; begin if not FReady then begin FVal:=99; FReady:=true; end; Result:=FVal; end; var L:TLazy; begin L:=TLazy.Create; __p(__vs(L.Val)); __vybeCheck('99');
end.
