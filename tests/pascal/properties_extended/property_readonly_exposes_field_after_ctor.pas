// vybe-test: pascal/properties_extended/property_readonly_exposes_field_after_ctor
...
end; type TToken=class private FKind:Integer; public constructor Create(k:Integer); property Kind:Integer read FKind; end; constructor TToken.Create(k:Integer); begin FKind:=k; end; var t:TToken; begin t:=TToken.Create(7); __p(__vs(t.Kind)); __vybeCheck('7');
end.
