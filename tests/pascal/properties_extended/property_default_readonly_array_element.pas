// vybe-test: pascal/properties_extended/property_default_readonly_array_element
...
end; type TView=class private F:array[0..1] of Integer; function GetV(i:Integer):Integer; public property V[i:Integer]:Integer read GetV; default; end; function TView.GetV(i:Integer):Integer; begin Result:=F[i]; end; var v:TView; begin v:=TView.Create; v.F[1]:=33; __p(__vs(v[1])); __vybeCheck('33');
end.
