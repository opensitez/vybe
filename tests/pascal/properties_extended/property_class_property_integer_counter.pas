// vybe-test: pascal/properties_extended/property_class_property_integer_counter
...
end; type TGen=class strict private class var FSerial:Integer; class function Next:Integer; public class property Serial:Integer read Next; end; class function TGen.Next:Integer; begin Inc(FSerial); Result:=FSerial; end; begin __p(__vs(TGen.Serial)); __p(__vs(TGen.Serial)); __vybeCheck('1' + #10 + '2');
end.
