// vybe-test: pascal/properties_extended/property_chained_assignment_via_write
...
end; type TPair=class private FA,FB:Integer; public property A:Integer read FA write FA; property B:Integer read FB write FB; end; var p:TPair; begin p:=TPair.Create; p.A:=3; p.B:=p.A+2; __p(__vs(p.B)); __vybeCheck('5');
end.
