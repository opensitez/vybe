// vybe-test: pascal/properties_extended/property_inherited_indexed_in_child
...
end; type TBase=class private F:array[0..1] of Integer; protected function GetItem(i:Integer):Integer; procedure SetItem(i:Integer; v:Integer); public property Data[i:Integer]:Integer read GetItem write SetItem; end; TChild=class(TBase); function TBase.GetItem(i:Integer):Integer; begin Result:=F[i]; end; procedure TBase.SetItem(i:Integer; v:Integer); begin F[i]:=v; end; var c:TChild; begin c:=TChild.Create; c.Data[0]:=11; __p(__vs(c.Data[0])); __vybeCheck('11');
end.
