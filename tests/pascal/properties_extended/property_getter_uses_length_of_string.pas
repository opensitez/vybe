// vybe-test: pascal/properties_extended/property_getter_uses_length_of_string
...
end; type TS=class private FS:string; function GetLen:Integer; public property Text:string read FS write FS; property Len:Integer read GetLen; end; function TS.GetLen:Integer; begin Result:=Length(FS); end; var s:TS; begin s:=TS.Create; s.Text:='four'; __p(__vs(s.Len)); __vybeCheck('4');
end.
