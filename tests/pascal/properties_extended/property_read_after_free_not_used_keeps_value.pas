// vybe-test: pascal/properties_extended/property_read_after_free_not_used_keeps_value
...
end; type TBox=class public property Val:Integer read FVal write FVal; FVal:Integer; end; var b:TBox; begin b:=TBox.Create; b.Val:=7; __p(__vs(b.Val)); b.Free; __vybeCheck('7');
end.
