// vybe-test: pascal/properties_extended/property_multiple_in_same_class_independent
...
end; type TPoint=class private FX,FY:Integer; public property X:Integer read FX write FX; property Y:Integer read FY write FY; end; var p:TPoint; begin p:=TPoint.Create; p.X:=2; p.Y:=3; __p(__vs(p.X+p.Y)); __vybeCheck('5');
end.
