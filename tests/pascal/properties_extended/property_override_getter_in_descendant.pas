// vybe-test: pascal/properties_extended/property_override_getter_in_descendant
...
end; type TBase=class private F:Integer; protected function GetMsg:string; virtual; public property Msg:string read GetMsg; end; TChild=class(TBase) function GetMsg:string; override; end; function TBase.GetMsg:string; begin Result:='base'; end; function TChild.GetMsg:string; begin Result:='child'; end; var c:TChild; begin c:=TChild.Create; __p(__vs(c.Msg)); __vybeCheck('child');
end.
