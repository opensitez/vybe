// vybe-test: pascal/properties_extended/property_indexed_negative_offset_in_getter
...
end; type TOffset=class private F:array[1..3] of Integer; function GetAt(i:Integer):Integer; public property At[i:Integer]:Integer read GetAt; end; function TOffset.GetAt(i:Integer):Integer; begin Result:=F[i+1]; end; var o:TOffset; begin o:=TOffset.Create; o.F[2]:=99; __p(__vs(o.At[1])); __vybeCheck('99');
end.
