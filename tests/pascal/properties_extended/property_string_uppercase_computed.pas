// vybe-test: pascal/properties_extended/property_string_uppercase_computed
...
end; type TLabel=class private FText:string; function GetUpper:string; public property Text:string read FText write FText; property Upper:string read GetUpper; end; function TLabel.GetUpper:string; begin Result:=UpperCase(FText); end; var L:TLabel; begin L:=TLabel.Create; L.Text:='hi'; __p(__vs(L.Upper)); __vybeCheck('HI');
end.
