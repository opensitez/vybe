// vybe-test: pascal/properties_extended/property_interface_style_on_class
...
end; type IReadable=interface function ReadVal:Integer; end; TCell=class(TInterfacedObject,IReadable) private F:Integer; public property Val:Integer read F write F; function ReadVal:Integer; begin Result:=Val; end; end; var c:IReadable; begin c:=TCell.Create; TCell(c).Val:=6; __p(__vs(c.ReadVal)); __vybeCheck('6');
end.
