// vybe-test: pascal/properties_extended/property_implemented_in_descendant_only
...
end; type TBase=class public function Tag:string; virtual; abstract; end; TChild=class(TBase) function Tag:string; override; end; function TChild.Tag:string; begin Result:='child'; end; var c:TChild; begin c:=TChild.Create; __p(__vs(c.Tag)); __vybeCheck('child');
end.
