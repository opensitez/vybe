// vybe-test: pascal/bitwise_integer/xor_on_integer_variables_is_bitwise
// origin: languages/pascal/tests/pascal/test_bitwise_integer.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var a, b: Integer; begin a := 12; b := 10; __p(__vs(a xor b)); __vybeCheck('6');
end.
