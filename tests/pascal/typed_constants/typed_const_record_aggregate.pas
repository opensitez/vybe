// vybe-test: pascal/typed_constants/typed_const_record_aggregate
// origin: languages/pascal/tests/pascal/test_typed_constants.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TR = record X, Y: Integer; end; const Origin: TR = (X: 0; Y: 0); var r: TR; begin r := Origin; __p(__vs(r.X)); __p(__vs(r.Y)); __vybeCheck('0' + #10 + '0');
end.
