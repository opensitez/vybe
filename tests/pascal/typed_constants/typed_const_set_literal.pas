// vybe-test: pascal/typed_constants/typed_const_set_literal
...
end; type TD = (One, Two, Three); const S: set of TD = [One, Three]; var x: TD; begin x := Two; if not (x in S) then __p(__vs('missing')); __vybeCheck('missing');
end.
