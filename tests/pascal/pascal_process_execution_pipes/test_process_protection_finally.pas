// vybe-test: pascal/pascal_process_execution_pipes/test_process_protection_finally
// origin: languages/pascal/tests/pascal/test_pascal_process_execution_pipes.rs
program Test;
{$mode delphi}
...
begin
  ...
  try
    __p(__vs('ProcessCreated'));
  finally
    proc.Free;
    __p(__vs('ProcessFreedInFinally'));
  end;
__vybeCheck('ProcessCreated' + #10 + 'ProcessFreedInFinally');
end.
