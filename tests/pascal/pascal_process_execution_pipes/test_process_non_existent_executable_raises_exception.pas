// vybe-test: pascal/pascal_process_execution_pipes/test_process_non_existent_executable_raises_exception
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('ExecFailedException'));
  end;
  proc.Free;
__vybeCheck('ExecFailedException');
end.
