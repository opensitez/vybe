// vybe-test: pascal/pascal_enum_set_type_conversions/test_enum_succ_pred_custom_ordinals
...
begin
  __p(__vs(GetEnumName(TypeInfo(TMode), Ord(Succ(mAlpha)))));
  __p(__vs(GetEnumName(TypeInfo(TMode), Ord(Pred(mGamma)))));
__vybeCheck('mBeta' + #10 + 'mBeta');
end.
