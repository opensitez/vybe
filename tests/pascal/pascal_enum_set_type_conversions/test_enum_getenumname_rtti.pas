// vybe-test: pascal/pascal_enum_set_type_conversions/test_enum_getenumname_rtti
// origin: languages/pascal/tests/pascal/test_pascal_enum_set_type_conversions.rs
program Test;
{$mode delphi}
...
begin
  __p(__vs(GetEnumName(TypeInfo(TColor), Ord(cRed))));
  __p(__vs(GetEnumName(TypeInfo(TColor), Ord(cGreen))));
  __p(__vs(GetEnumName(TypeInfo(TColor), Ord(cBlue))));
__vybeCheck('cRed' + #10 + 'cGreen' + #10 + 'cBlue');
end.
