// vybe-test: pascal/pascal_enum_set_type_conversions/test_enum_invalid_string_getenumvalue_returns_minus_one
...
begin
  __p(__vs(GetEnumValue(TypeInfo(TColor), 'cNonExistent')));
__vybeCheck('-1');
end.
