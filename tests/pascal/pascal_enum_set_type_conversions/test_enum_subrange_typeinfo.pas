// vybe-test: pascal/pascal_enum_set_type_conversions/test_enum_subrange_typeinfo
...
begin
  __p(__vs(GetEnumName(TypeInfo(TColor), Ord(Low(TSubColor)))));
  __p(__vs(GetEnumName(TypeInfo(TColor), Ord(High(TSubColor)))));
__vybeCheck('cGreen' + #10 + 'cBlue');
end.
