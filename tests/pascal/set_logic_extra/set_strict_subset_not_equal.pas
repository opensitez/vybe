// vybe-test: pascal/set_logic_extra/set_strict_subset_not_equal
...
end; type TD=(A,B,C); var a,b:set of TD; begin a:=[A]; b:=[A,B]; __p(__vs(Ord((a<=b) and not (a=b)))); __vybeCheck('1');
end.
