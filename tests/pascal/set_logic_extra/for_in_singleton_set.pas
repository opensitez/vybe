// vybe-test: pascal/set_logic_extra/for_in_singleton_set
...
end; type TD=(A,B,C); var s:set of TD; c:TD; v:Char; begin s:=[B]; for c in s do if c=B then v:='y' else v:='n'; __p(__vs(v)); __vybeCheck('y');
end.
