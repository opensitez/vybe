// vybe-test: pascal/set_logic_extra/for_in_char_set_uppercase
...
end; var s:set of Char; c:Char; t:Char; begin s:=['A'..'C']; t:=#0; for c in s do t:=c; __p(__vs(t)); __vybeCheck('C');
end.
