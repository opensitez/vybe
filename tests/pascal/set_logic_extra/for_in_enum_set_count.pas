// vybe-test: pascal/set_logic_extra/for_in_enum_set_count
...
end; type TD=(A,B,C); var s:set of TD; c:TD; n:Integer; begin s:=[A,C]; n:=0; for c in s do Inc(n); __p(__vs(n)); __vybeCheck('2');
end.
