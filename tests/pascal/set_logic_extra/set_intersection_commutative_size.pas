// vybe-test: pascal/set_logic_extra/set_intersection_commutative_size
// origin: languages/pascal/tests/pascal/test_set_logic_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TD=(A,B,C); var s,t,u,v:set of TD; c:TD; ns,nt:Integer; begin s:=[A,B]; t:=[B,C]; u:=s*t; v:=t*s; ns:=0; nt:=0; for c in u do Inc(ns); for c in v do Inc(nt); __p(__vs(ns)); __p(__vs(nt)); __vybeCheck('1' + #10 + '1');
end.
