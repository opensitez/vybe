// vybe-test: pascal/set_logic_extra/set_subset_equal_sets
...
end; type TD=(A,B); var s,t:set of TD; begin s:=[A,B]; t:=[A,B]; __p(__vs(Ord(s<=t))); __p(__vs(Ord(s>=t))); __vybeCheck('1' + #10 + '1');
end.
