// vybe-test: pascal/set_logic_extra/set_union_three_step
...
end; type TD=(A,B,C,D); var a,b,c,u:set of TD; begin a:=[A]; b:=[B]; c:=[C]; u:=a+b; u:=u+c; __p(__vs(Ord(D in u))); __p(__vs(Ord(B in u))); __vybeCheck('0' + #10 + '1');
end.
