// vybe-test: pascal/set_logic_extra/not_in_on_array_negates_membership
...
end; var a: array[0..2] of Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; __p(__vs(Ord(99 in a))); __vybeCheck('0');
end.
