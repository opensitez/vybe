// vybe-test: pascal/set_logic_extra/set_assign_from_literal_brackets
...
end; type TD=(X,Y,Z); var s:set of TD; begin s:=[Y,Z]; __p(__vs(Ord(X in s))); __p(__vs(Ord(Y in s))); __vybeCheck('0' + #10 + '1');
end.
