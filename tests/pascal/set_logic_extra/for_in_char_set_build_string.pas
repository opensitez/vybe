// vybe-test: pascal/set_logic_extra/for_in_char_set_build_string
...
end; var s:set of Char; c:Char; t:string; begin s:=['x','y']; t:=''; for c in s do t:=t+c; __p(__vs(Length(t))); __vybeCheck('2');
end.
