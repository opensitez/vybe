// vybe-test: pascal/set_logic_extra/set_include_loop_build
...
end; type TD=(A,B,C,D); var s:set of TD; i:Integer; begin s:=[]; for i:=0 to 2 do Include(s,TD(i)); __p(__vs(Ord(D in s))); __p(__vs(Ord(C in s))); __vybeCheck('0' + #10 + '1');
end.
