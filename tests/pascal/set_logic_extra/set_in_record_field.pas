// vybe-test: pascal/set_logic_extra/set_in_record_field
...
end; type TD=(A,B); type TBox=record Flags:set of TD; end; var b:TBox; begin b.Flags:=[A]; Include(b.Flags,B); __p(__vs(Ord(B in b.Flags))); __vybeCheck('1');
end.
