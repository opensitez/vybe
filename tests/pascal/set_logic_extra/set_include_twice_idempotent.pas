// vybe-test: pascal/set_logic_extra/set_include_twice_idempotent
...
end; type TD=(A,B); var s:set of TD; n:Integer; begin s:=[]; Include(s,A); Include(s,A); n:=0; if A in s then Inc(n); __p(__vs(n)); __vybeCheck('1');
end.
