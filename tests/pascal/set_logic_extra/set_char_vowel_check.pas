// vybe-test: pascal/set_logic_extra/set_char_vowel_check
...
end; var v:set of Char; begin v:=['a','e','i','o','u']; __p(__vs(Ord('e' in v))); __p(__vs(Ord('z' in v))); __vybeCheck('1' + #10 + '0');
end.
