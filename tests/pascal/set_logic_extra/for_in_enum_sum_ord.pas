// vybe-test: pascal/set_logic_extra/for_in_enum_sum_ord
...
end; type TD=(P,Q,R); var s:set of TD; c:TD; sum:Integer; begin s:=[P,R]; sum:=0; for c in s do sum:=sum+Ord(c); __p(__vs(sum)); __vybeCheck('2');
end.
