// vybe-test: pascal/set_logic_extra/set_union_preserves_no_duplicates
...
end; type TD=(A,B,C); var s,t,u:set of TD; c:TD; n:Integer; begin s:=[A,B]; t:=[B,C]; u:=s+t; n:=0; for c in u do Inc(n); __p(__vs(n)); __vybeCheck('3');
end.
