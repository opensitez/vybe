// vybe-test: pascal/set_logic_extra/for_in_break_count_at_two
...
end; type TD=(A,B,C,D); var s:set of TD; c:TD; n:Integer; begin s:=[A..D]; n:=0; for c in s do begin Inc(n); if n=2 then Break; end; __p(__vs(n)); __vybeCheck('2');
end.
