// vybe-test: pascal/set_logic_extra/set_difference_removes
...
end; type TD=(A,B,C); var s,t,d:set of TD; begin s:=[A,B,C]; t:=[B]; d:=s-t; __p(__vs(Ord(A in d))); __p(__vs(Ord(B in d))); __vybeCheck('1' + #10 + '0');
end.
