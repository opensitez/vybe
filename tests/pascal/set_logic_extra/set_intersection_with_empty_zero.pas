// vybe-test: pascal/set_logic_extra/set_intersection_with_empty_zero
...
end; type TD=(A,B); var s,e,i:set of TD; begin s:=[A,B]; e:=[]; i:=s*e; __p(__vs(Ord(A in i))); __vybeCheck('0');
end.
