// vybe-test: pascal/set_logic_extra/in_on_array_is_value_membership
...
end; var a: array[0..3] of Integer; begin a[0]:=10; a[1]:=20; a[2]:=30; a[3]:=40; __p(__vs(Ord(30 in a))); __p(__vs(Ord(35 in a))); __vybeCheck('1' + #10 + '0');
end.
