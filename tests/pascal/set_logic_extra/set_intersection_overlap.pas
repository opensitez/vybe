// vybe-test: pascal/set_logic_extra/set_intersection_overlap
...
end; type TD=(A,B,C); var s,t,u:set of TD; begin s:=[A,B]; t:=[B,C]; u:=s*t; __p(__vs(Ord(A in u))); __p(__vs(Ord(B in u))); __vybeCheck('0' + #10 + '1');
end.
