// vybe-test: pascal/set_logic_extra/set_full_enum_all_in
...
end; type TD=(A,B,C); var s:set of TD; begin s:=[A..C]; __p(__vs(Ord(A in s))); __p(__vs(Ord(C in s))); __vybeCheck('1' + #10 + '1');
end.
