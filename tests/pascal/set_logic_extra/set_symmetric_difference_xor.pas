// vybe-test: pascal/set_logic_extra/set_symmetric_difference_xor
...
end; type TD=(A,B,C); var s,t,x:set of TD; begin s:=[A,B]; t:=[B,C]; x:=s><t; __p(__vs(Ord(A in x))); __p(__vs(Ord(C in x))); __vybeCheck('1' + #10 + '1');
end.
