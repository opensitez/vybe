// vybe-test: pascal/set_logic_extra/for_in_empty_set_zero_iters
...
end; type TD=(A,B); var s:set of TD; c:TD; n:Integer; begin s:=[]; n:=0; for c in s do Inc(n); __p(__vs(n)); __vybeCheck('0');
end.
