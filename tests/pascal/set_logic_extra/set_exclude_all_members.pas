// vybe-test: pascal/set_logic_extra/set_exclude_all_members
...
end; type TD=(A,B); var s:set of TD; begin s:=[A,B]; Exclude(s,A); Exclude(s,B); __p(__vs(Ord(A in s))); __vybeCheck('0');
end.
