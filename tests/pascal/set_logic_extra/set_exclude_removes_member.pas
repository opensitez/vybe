// vybe-test: pascal/set_logic_extra/set_exclude_removes_member
...
end; type TD=(A,B,C); var s:set of TD; begin s:=[A,B]; Exclude(s,A); __p(__vs(Ord(A in s))); __vybeCheck('0');
end.
