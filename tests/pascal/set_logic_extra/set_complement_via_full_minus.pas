// vybe-test: pascal/set_logic_extra/set_complement_via_full_minus
...
end; type TD=(A,B,C); var full,part,rest:set of TD; begin full:=[A..C]; part:=[B]; rest:=full-part; __p(__vs(Ord(A in rest))); __p(__vs(Ord(B in rest))); __vybeCheck('1' + #10 + '0');
end.
