// vybe-test: pascal/set_logic_extra/set_char_range_letters_count
...
end; var s:set of Char; c:Char; n:Integer; begin s:=['a'..'d']; n:=0; for c in s do Inc(n); __p(__vs(n)); __vybeCheck('4');
end.
