// vybe-test: pascal/set_logic_extra/set_union_combines
...
end; type TD=(A,B,C); var s,t,u:set of TD; begin s:=[A]; t:=[B]; u:=s+t; __p(__vs(Ord(C in u))); __p(__vs(Ord(B in u))); __vybeCheck('0' + #10 + '1');
end.
