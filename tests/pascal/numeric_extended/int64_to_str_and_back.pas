// vybe-test: pascal/numeric_extended/int64_to_str_and_back
...
end; var i:Int64; s:String; begin s:='1234567890123'; i:=StrToInt64(s); __p(__vs(i)); __vybeCheck('1234567890123');
end.
