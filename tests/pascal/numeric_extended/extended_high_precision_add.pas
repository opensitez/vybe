// vybe-test: pascal/numeric_extended/extended_high_precision_add
...
end; var e:Extended; begin e:=1.23456789; e:=e+0.00000001; __p(__vs(e>1.234567)); __vybeCheck('True');
end.
