// vybe-test: pascal/numeric_extended/currency_subtract_tax
// origin: languages/pascal/tests/pascal/test_numeric_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var gross,tax,net:Currency; begin gross:=100.00; tax:=8.25; net:=gross-tax; __p(__vs(net)); __vybeCheck('91.75');
end.
