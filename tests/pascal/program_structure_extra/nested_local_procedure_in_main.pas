// vybe-test: pascal/program_structure_extra/nested_local_procedure_in_main
// origin: languages/pascal/tests/pascal/test_program_structure_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; procedure Outer; procedure Inner; begin __p(__vs('inner')); end; begin Inner; end; begin Outer; __vybeCheck('inner');
end.
