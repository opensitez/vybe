// vybe-test: pascal/program_structure_extra/multi_section_8
...
end; const C=8; type TRec=record N:Integer; end; var r:TRec; begin r.N:=C*2; __p(__vs(r.N)); __vybeCheck('16');
end.
