// vybe-test: pascal/program_structure_extra/label_declaration_section
...
end; label finish; begin __p(__vs('go')); goto finish; __p(__vs('skip')); finish: __p(__vs('done')); __vybeCheck('go' + #10 + 'done');
end.
