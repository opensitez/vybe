// vybe-test: pascal/program_structure_extra/multi_section_2
...
end; const C=2; type TRec=record N:Integer; end; var r:TRec; begin r.N:=C*2; __p(__vs(r.N)); __vybeCheck('4');
end.
