// vybe-test: pascal/program_structure_extra/multi_section_7
...
end; const C=7; type TRec=record N:Integer; end; var r:TRec; begin r.N:=C*2; __p(__vs(r.N)); __vybeCheck('14');
end.
