// vybe-test: pascal/pascal_rtti_custom_attributes/test_rtti_custom_attribute_default_constructor
...
begin
  ...
  __p(__vs(t.GetAttributes[0].ClassName));
  ctx.Free;
__vybeCheck('SerializableAttribute');
end.
