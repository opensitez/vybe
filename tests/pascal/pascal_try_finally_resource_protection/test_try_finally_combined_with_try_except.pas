// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_combined_with_try_except
...
begin
  ...
  try
    ...
    on E: Exception do __p(__vs('Handled:' + E.Message));
  end;
  __p(__vs('ObjFreedStatus:' + objFreed.ToString));
__vybeCheck('Handled:ErrorInTry' + #10 + 'ObjFreedStatus:True');
end.
