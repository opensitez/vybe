// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_stringlist_protection
...
begin
  ...
  try
    ...
    sl.Free;
    __p(__vs('StringListFreed'));
  end;
__vybeCheck('ProtectedLine' + #10 + 'StringListFreed');
end.
