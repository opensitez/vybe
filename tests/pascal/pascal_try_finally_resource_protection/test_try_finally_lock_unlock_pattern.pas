// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_lock_unlock_pattern
...
procedure TLock.Lock; begin Locked := True; __p(__vs('Locked')); end;
procedure TLock.Unlock; begin Locked := False; __p(__vs('Unlocked')); end;

var l: TLock;
begin
  l.Lock;
  try
    __p(__vs('CriticalSectionCode'));
  finally
    l.Unlock;
  end;
__vybeCheck('Locked' + #10 + 'CriticalSectionCode' + #10 + 'Unlocked');
end.
