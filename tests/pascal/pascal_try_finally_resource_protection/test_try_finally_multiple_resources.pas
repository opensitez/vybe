// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_multiple_resources
// origin: languages/pascal/tests/pascal/test_pascal_try_finally_resource_protection.rs
program Test;
{$mode delphi}
uses SysUtils;
...
destructor TResA.Destroy; begin __p(__vs('ResAFreed')); inherited Destroy; end;
destructor TResB.Destroy; begin __p(__vs('ResBFreed')); inherited Destroy; end;
...
__vybeCheck('UsingBothResources' + #10 + 'ResBFreed' + #10 + 'ResAFreed');
end.
