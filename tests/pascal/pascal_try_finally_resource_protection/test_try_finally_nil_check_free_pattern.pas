// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_nil_check_free_pattern
...
begin
  obj := nil;
  try
    __p(__vs('NoAllocationMade'));
  finally
    obj.Free;
    __p(__vs('NilFreeHandled'));
  end;
__vybeCheck('NoAllocationMade' + #10 + 'NilFreeHandled');
end.
