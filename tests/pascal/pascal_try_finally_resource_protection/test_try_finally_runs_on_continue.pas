// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_runs_on_continue
...
begin
  ...
  begin
    try
      ...
      __p(__vs('Iter:' + i.ToString));
    finally
      __p(__vs('FinallyIter:' + i.ToString));
    end;
  end;
__vybeCheck('FinallyIter:1' + #10 + 'Iter:2' + #10 + 'FinallyIter:2');
end.
