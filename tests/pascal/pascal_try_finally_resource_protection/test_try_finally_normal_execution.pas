// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_normal_execution
...
begin
  try
    __p(__vs('ProtectedWork'));
  finally
    __p(__vs('ResourceFreed'));
  end;
__vybeCheck('ProtectedWork' + #10 + 'ResourceFreed');
end.
