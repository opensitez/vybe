// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_execution_on_exception
...
begin
  try
    try
      ...
      __p(__vs('FinallyRunsOnException'));
    end;
  except
    on E: Exception do __p(__vs('Caught:' + E.Message));
  end;
__vybeCheck('FinallyRunsOnException' + #10 + 'Caught:FailInWork');
end.
