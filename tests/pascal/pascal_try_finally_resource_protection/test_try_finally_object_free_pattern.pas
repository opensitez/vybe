// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_object_free_pattern
...
destructor TResObj.Destroy; begin __p(__vs('ObjectFreedInFinally')); inherited Destroy; end;

var obj: TResObj;
begin
  obj := TResObj.Create;
  try
    __p(__vs('UsingObject'));
  finally
    obj.Free;
  end;
__vybeCheck('UsingObject' + #10 + 'ObjectFreedInFinally');
end.
