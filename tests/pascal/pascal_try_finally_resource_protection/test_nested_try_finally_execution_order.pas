// vybe-test: pascal/pascal_try_finally_resource_protection/test_nested_try_finally_execution_order
...
begin
  try
    try
      ...
      __p(__vs('InnerFinally'));
    end;
  finally
    __p(__vs('OuterFinally'));
  end;
__vybeCheck('InnerWork' + #10 + 'InnerFinally' + #10 + 'OuterFinally');
end.
