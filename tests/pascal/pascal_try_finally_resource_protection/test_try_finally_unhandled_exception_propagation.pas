// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_unhandled_exception_propagation
...
begin
  try
    ...
    on E: Exception do __p(__vs('TopCaught:' + E.Message));
  end;
__vybeCheck('SubFinallyExecuted' + #10 + 'TopCaught:UncaughtInSub');
end.
