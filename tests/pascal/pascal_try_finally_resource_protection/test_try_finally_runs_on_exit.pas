// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_runs_on_exit
...
begin
  try
    __p(__vs('BeforeExit'));
    Exit;
    __p(__vs('Unreachable'));
  finally
    __p(__vs('FinallyRunsOnExit'));
  end;
end;
begin
  RunProc;
__vybeCheck('BeforeExit' + #10 + 'FinallyRunsOnExit');
end.
