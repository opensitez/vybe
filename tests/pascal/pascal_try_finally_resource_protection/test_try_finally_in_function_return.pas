// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_in_function_return
...
begin
  try
    ...
    __p(__vs('FinallyInFunction'));
  end;
end;
begin
  __p(__vs(ComputeValue));
__vybeCheck('FinallyInFunction' + #10 + '42');
end.
