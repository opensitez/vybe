// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_in_record_method
...
begin
  try
    __p(__vs('RecExecuteStart'));
  finally
    __p(__vs('RecExecuteFinally'));
  end;
end;
var w: TWorkerRec;
begin
  w.Execute;
__vybeCheck('RecExecuteStart' + #10 + 'RecExecuteFinally');
end.
