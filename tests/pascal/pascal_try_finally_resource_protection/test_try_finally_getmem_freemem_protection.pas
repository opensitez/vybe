// vybe-test: pascal/pascal_try_finally_resource_protection/test_try_finally_getmem_freemem_protection
...
begin
  GetMem(p, 100);
  try
    __p(__vs('BufferAllocated'));
  finally
    FreeMem(p);
    __p(__vs('BufferFreed'));
  end;
__vybeCheck('BufferAllocated' + #10 + 'BufferFreed');
end.
