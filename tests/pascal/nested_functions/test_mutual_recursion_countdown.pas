// vybe-test: pascal/nested_functions/test_mutual_recursion_countdown
...
begin
  EvenStep(4);
__vybeCheck('even:4' + #10 + 'odd:3' + #10 + 'even:2' + #10 + 'odd:1');
end.
