// vybe-test: pascal/class_rtti/test_is_dispatch_conditional
// origin: languages/pascal/tests/pascal/test_class_rtti.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  if a is TDog then __p(__vs('Good dog!'))
  else if a is TCat then __p(__vs('Nice cat!'))
  else __p(__vs('Hi animal!'));
end;
...
begin
  ...
  Greet(c);
  Greet(a);
__vybeCheck('Good dog!' + #10 + 'Nice cat!' + #10 + 'Hi animal!');
end.
