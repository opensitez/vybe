// vybe-test: pascal/class_rtti/test_class_reference_variable
...
begin
  __p(__vs(TBase.TypeName));
  __p(__vs(TDerivedA.TypeName));
  __p(__vs(TDerivedB.TypeName));
__vybeCheck('Base' + #10 + 'DerivedA' + #10 + 'DerivedB');
end.
