// vybe-test: pascal/char_unicode_extra/char_range_ascii_printable_slice
...
end; var s:set of Char; c:Char; n:Integer; begin s:=['!'..'~']; n:=0; for c in s do Inc(n); __p(__vs(Ord(n>90))); __vybeCheck('1');
end.
