// vybe-test: pascal/char_unicode_extra/upcase_char_array_cell
...
end; var a:array[1..2] of Char; begin a[1]:='g'; a[2]:='h'; __p(__vs(UpCase(a[1]))); __p(__vs(UpCase(a[2]))); __vybeCheck('G' + #10 + 'H');
end.
