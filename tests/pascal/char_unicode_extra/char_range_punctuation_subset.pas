// vybe-test: pascal/char_unicode_extra/char_range_punctuation_subset
...
end; var p:set of Char; begin p:=['.'..'/']; __p(__vs(Ord('.' in p))); __p(__vs(Ord('0' in p))); __vybeCheck('1' + #10 + '0');
end.
