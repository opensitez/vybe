// vybe-test: pascal/char_unicode_extra/char_in_range_letters_loop_count
...
end; var s:set of Char; c:Char; n:Integer; begin s:=['a'..'c']; n:=0; for c in s do Inc(n); __p(__vs(n)); __vybeCheck('3');
end.
