// vybe-test: pascal/char_unicode_extra/char_range_vowels_only
...
end; var v:set of Char; begin v:=['a','e','i','o','u']; __p(__vs(Ord('i' in v))); __p(__vs(Ord('b' in v))); __vybeCheck('1' + #10 + '0');
end.
