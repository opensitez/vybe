// vybe-test: pascal/char_unicode_extra/char_range_lowercase_in_set
...
end; var s:set of Char; begin s:=['a'..'z']; __p(__vs(Ord('m' in s))); __p(__vs(Ord('M' in s))); __vybeCheck('1' + #10 + '0');
end.
