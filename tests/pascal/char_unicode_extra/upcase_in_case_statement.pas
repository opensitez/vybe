// vybe-test: pascal/char_unicode_extra/upcase_in_case_statement
...
end; var c:Char; begin c:=UpCase('d'); case c of 'D': __p(__vs('ok')); else __p(__vs('no')); end; __vybeCheck('ok');
end.
