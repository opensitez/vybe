// vybe-test: pascal/char_unicode_extra/char_range_hex_letters
...
end; var h:set of Char; begin h:=['0'..'9','a'..'f']; __p(__vs(Ord('c' in h))); __p(__vs(Ord('g' in h))); __vybeCheck('1' + #10 + '0');
end.
