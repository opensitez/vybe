// vybe-test: pascal/char_unicode_extra/char_range_union_two_ranges
...
end; var s:set of Char; begin s:=['a'..'c']+['x'..'z']; __p(__vs(Ord('b' in s))); __p(__vs(Ord('y' in s))); __vybeCheck('1' + #10 + '1');
end.
