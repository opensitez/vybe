// vybe-test: pascal/char_unicode_extra/char_range_control_chars_low
...
end; var s:set of Char; begin s:=['#0'..'#31']; __p(__vs(Ord(#9 in s))); __p(__vs(Ord('A' in s))); __vybeCheck('1' + #10 + '0');
end.
