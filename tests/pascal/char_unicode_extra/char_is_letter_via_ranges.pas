// vybe-test: pascal/char_unicode_extra/char_is_letter_via_ranges
// origin: languages/pascal/tests/pascal/test_char_unicode_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var letters:set of Char; c:Char; begin letters:=['A'..'Z']+['a'..'z']; c:='J'; __p(__vs(Ord(c in letters))); c:='5'; __p(__vs(Ord(c in letters))); __vybeCheck('1' + #10 + '0');
end.
