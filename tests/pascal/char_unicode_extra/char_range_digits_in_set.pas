// vybe-test: pascal/char_unicode_extra/char_range_digits_in_set
...
end; var s:set of Char; begin s:=['0'..'9']; __p(__vs(Ord('4' in s))); __p(__vs(Ord('a' in s))); __vybeCheck('1' + #10 + '0');
end.
