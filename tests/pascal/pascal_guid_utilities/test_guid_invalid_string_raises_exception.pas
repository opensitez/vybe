// vybe-test: pascal/pascal_guid_utilities/test_guid_invalid_string_raises_exception
// origin: languages/pascal/tests/pascal/test_pascal_guid_utilities.rs
program Test;
{$mode delphi}
...
begin
  try
    ...
    on E: EConvertError do __p(__vs('InvalidGuidErrorCaught'));
  end;
__vybeCheck('InvalidGuidErrorCaught');
end.
