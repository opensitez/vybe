// vybe-test: pascal/pascal_guid_utilities/test_guid_to_string_conversion_in_log
...
begin
  __p(__vs('LOG_GUID:' + GUIDToString(g)));
end;
begin
  LogGuid(StringToGUID('{99999999-9999-9999-9999-999999999999}'));
__vybeCheck('LOG_GUID:{99999999-9999-9999-9999-999999999999}');
end.
