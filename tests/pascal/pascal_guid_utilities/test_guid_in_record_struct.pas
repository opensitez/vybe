// vybe-test: pascal/pascal_guid_utilities/test_guid_in_record_struct
...
begin
  ...
  __p(__vs(GUIDToString(meta.ID) + ':' + meta.Name));
__vybeCheck('{00000000-0000-0000-0000-000000000001}:Component1');
end.
