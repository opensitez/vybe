// vybe-test: pascal/string_manipulation/replace_then_length_check
// origin: languages/pascal/tests/pascal/test_string_manipulation.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var s:String; begin s:=StringReplace('aaaa','a','b',[rfReplaceAll]); __p(__vs(Length(s))); __vybeCheck('4');
end.
