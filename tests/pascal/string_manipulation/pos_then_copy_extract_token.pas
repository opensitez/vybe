// vybe-test: pascal/string_manipulation/pos_then_copy_extract_token
...
end; var p:Integer; begin p:=Pos('@','user@host'); __p(__vs(Copy('user@host',1,p-1))); __vybeCheck('user');
end.
