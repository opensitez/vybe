// vybe-test: pascal/pascal_ansistring_refcounting/test_ansistring_concatenation_allocates_new_buffer
// origin: languages/pascal/tests/pascal/test_pascal_ansistring_refcounting.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  s3 := s1 + s2;
  __p(__vs(s3));
  __p(__vs(StringRefCount(s3)));
__vybeCheck('Hello World' + #10 + '1');
end.
