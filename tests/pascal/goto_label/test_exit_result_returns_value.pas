// vybe-test: pascal/goto_label/test_exit_result_returns_value
// origin: languages/pascal/tests/pascal/test_goto_label.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(Clamp(5, 0, 10)));
  __p(__vs(Clamp(-5, 0, 10)));
  __p(__vs(Clamp(15, 0, 10)));
__vybeCheck('5' + #10 + '0' + #10 + '10');
end.
