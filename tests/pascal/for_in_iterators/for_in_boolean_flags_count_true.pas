// vybe-test: pascal/for_in_iterators/for_in_boolean_flags_count_true
...
end; var b: Boolean; c: Integer; begin c:=0; for b in [true,false,true] do if b then c:=c+1; __p(__vs(c)); __vybeCheck('2');
end.
