// vybe-test: pascal/for_in_iterators/for_in_real_dynamic_array
...
end; var r: Double; s: Double; begin s:=0; for r in [1.5, 2.5] do s:=s+r; __p(__vs(Round(s))); __vybeCheck('4');
end.
