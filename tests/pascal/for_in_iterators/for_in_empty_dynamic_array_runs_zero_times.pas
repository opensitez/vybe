// vybe-test: pascal/for_in_iterators/for_in_empty_dynamic_array_runs_zero_times
...
end; var a: array of Integer; x, n: Integer; begin a:=[]; n:=0; for x in a do n:=n+1; __p(__vs(n)); __vybeCheck('0');
end.
