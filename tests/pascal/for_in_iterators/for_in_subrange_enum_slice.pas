// vybe-test: pascal/for_in_iterators/for_in_subrange_enum_slice
...
end; type TColor=(Red,Green,Blue,Yellow); var c: TColor; n: Integer; begin n:=0; for c in [Green,Blue] do n:=n+1; __p(__vs(n)); __vybeCheck('2');
end.
