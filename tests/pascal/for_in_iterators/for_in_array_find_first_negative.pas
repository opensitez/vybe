// vybe-test: pascal/for_in_iterators/for_in_array_find_first_negative
...
end; var x, hit: Integer; begin hit:=0; for x in [3,5,-1,9] do if x<0 then begin hit:=x; break; end; __p(__vs(hit)); __vybeCheck('-1');
end.
