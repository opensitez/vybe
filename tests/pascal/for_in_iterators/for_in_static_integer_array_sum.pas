// vybe-test: pascal/for_in_iterators/for_in_static_integer_array_sum
...
end; var a: array[0..3] of Integer; x, s: Integer; begin a[0]:=1; a[1]:=2; a[2]:=3; a[3]:=4; s:=0; for x in a do s:=s+x; __p(__vs(s)); __vybeCheck('10');
end.
