// vybe-test: pascal/for_in_iterators/for_in_array_continue_skip_evens
...
end; var x, s: Integer; begin s:=0; for x in [1,2,3,4] do begin if x mod 2=0 then continue; s:=s+x; end; __p(__vs(s)); __vybeCheck('4');
end.
