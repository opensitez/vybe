// vybe-test: pascal/for_in_iterators/for_in_enum_weekdays_count
...
end; type TDay=(Mon,Tue,Wed,Thu,Fri); var d: TDay; n: Integer; begin n:=0; for d in [Mon,Tue,Wed,Thu,Fri] do n:=n+1; __p(__vs(n)); __vybeCheck('5');
end.
