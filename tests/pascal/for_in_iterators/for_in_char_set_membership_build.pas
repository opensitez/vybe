// vybe-test: pascal/for_in_iterators/for_in_char_set_membership_build
...
end; var c: Char; s: set of Char; begin s:=[]; for c in 'abc' do Include(s,c); if 'b' in s then __p(__vs('ok')); __vybeCheck('ok');
end.
