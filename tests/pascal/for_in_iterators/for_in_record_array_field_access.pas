// vybe-test: pascal/for_in_iterators/for_in_record_array_field_access
// origin: languages/pascal/tests/pascal/test_for_in_iterators.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TR=record V:Integer; end; var items: array[0..1] of TR; it: TR; s: Integer; begin items[0].V:=2; items[1].V:=3; s:=0; for it in items do s:=s+it.V; __p(__vs(s)); __vybeCheck('5');
end.
