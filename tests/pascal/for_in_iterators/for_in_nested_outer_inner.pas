// vybe-test: pascal/for_in_iterators/for_in_nested_outer_inner
...
end; var i,j,c: Integer; begin c:=0; for i in [1,2] do for j in [1,2] do c:=c+1; __p(__vs(c)); __vybeCheck('4');
end.
