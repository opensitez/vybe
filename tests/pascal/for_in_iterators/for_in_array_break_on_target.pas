// vybe-test: pascal/for_in_iterators/for_in_array_break_on_target
...
end; var x: Integer; begin for x in [1,2,3,4,5] do begin if x=3 then break; __p(__vs(x)); end; __vybeCheck('1' + #10 + '2');
end.
