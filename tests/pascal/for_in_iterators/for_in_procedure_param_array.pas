// vybe-test: pascal/for_in_iterators/for_in_procedure_param_array
...
end; procedure ShowAll(a: array of Integer); var x: Integer; begin for x in a do __p(__vs(x)); end; begin ShowAll([7,8]); __vybeCheck('7' + #10 + '8');
end.
