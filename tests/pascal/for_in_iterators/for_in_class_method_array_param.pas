// vybe-test: pascal/for_in_iterators/for_in_class_method_array_param
...
end; type TBox=class class procedure Sum(a: array of Integer); var x,s: Integer; begin s:=0; for x in a do s:=s+x; __p(__vs(s)); end; end; begin TBox.Sum([4,5,6]); __vybeCheck('15');
end.
