// vybe-test: pascal/for_in_iterators/for_in_integer_set_literal_sum
...
end; var x, t: Integer; begin t:=0; for x in [100,200] do t:=t div 100; __p(__vs(t)); __vybeCheck('2');
end.
