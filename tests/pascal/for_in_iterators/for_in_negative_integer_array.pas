// vybe-test: pascal/for_in_iterators/for_in_negative_integer_array
...
end; var x, m: Integer; begin m:=0; for x in [-3,-1,2] do if x>m then m:=x; __p(__vs(m)); __vybeCheck('2');
end.
