// vybe-test: pascal/for_in_iterators/for_in_string_with_spaces_trim_check
...
end; var c: Char; hasSpace: Boolean; begin hasSpace:=false; for c in 'a b' do if c=' ' then hasSpace:=true; if hasSpace then __p(__vs('space')); __vybeCheck('space');
end.
