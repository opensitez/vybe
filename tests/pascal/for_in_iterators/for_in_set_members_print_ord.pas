// vybe-test: pascal/for_in_iterators/for_in_set_members_print_ord
...
end; type TD=(One,Two,Three); var d: TD; begin for d in [One,Three] do __p(__vs(Ord(d))); __vybeCheck('0' + #10 + '2');
end.
