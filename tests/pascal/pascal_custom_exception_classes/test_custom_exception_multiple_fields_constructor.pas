// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_multiple_fields_constructor
...
begin
  try
    ...
    on E: EMultiFieldErr do __p(__vs(E.Message + '@' + E.Line.ToString + ':' + E.Col.ToString));
  end;
__vybeCheck('SyntaxError@12:45');
end.
