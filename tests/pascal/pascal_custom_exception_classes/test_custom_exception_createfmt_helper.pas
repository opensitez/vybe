// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_createfmt_helper
...
begin
  try
    ...
    on E: EFormattedErr do __p(__vs(E.Message));
  end;
__vybeCheck('Invalid value 99 for field Age');
end.
