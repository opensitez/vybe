// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_with_string_property
...
begin
  try
    ...
    on E: EDetailErr do __p(__vs(E.Message + ' -> ' + E.Detail));
  end;
__vybeCheck('Summary -> DetailedStackInformation');
end.
