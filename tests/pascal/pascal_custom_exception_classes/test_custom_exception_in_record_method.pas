// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_in_record_method
...
begin
  try
    ...
    on E: ERecordErr do __p(__vs(E.Message));
  end;
__vybeCheck('RecordValidationFailed');
end.
