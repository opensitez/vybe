// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_in_generic_method
...
begin
  try
    ...
    on E: EGenericErr do __p(__vs(E.Message));
  end;
__vybeCheck('GenericValueNull');
end.
