// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_subclass_matching_priority
...
begin
  try
    ...
    on E: ESubErr do __p(__vs('MatchedSubClass'));
    on E: EBaseErr do __p(__vs('MatchedBaseClass'));
  end;
__vybeCheck('MatchedSubClass');
end.
