// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_array_instantiation
...
begin
  ...
  __p(__vs(errs[0].Message));
  __p(__vs(errs[1].Message));
  errs[0].Free; errs[1].Free;
__vybeCheck('Err0' + #10 + 'Err1');
end.
