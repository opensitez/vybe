// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_inheritance_polymorphism
...
begin
  try
    ...
    on E: EBaseAppErr do __p(__vs('CaughtBase:' + E.ClassName));
  end;
__vybeCheck('CaughtBase:ETimeoutErr');
end.
