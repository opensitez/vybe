// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_subclassing_econvert_error
...
begin
  try
    ...
    on E: EConvertError do __p(__vs('CaughtAsConvertError:' + E.Message));
  end;
__vybeCheck('CaughtAsConvertError:ParseIntegerFailed');
end.
