// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_inheritsfrom_query
...
begin
  ...
  __p(__vs(e.InheritsFrom(ECoreErr)));
  __p(__vs(e.InheritsFrom(Exception)));
  e.Free;
