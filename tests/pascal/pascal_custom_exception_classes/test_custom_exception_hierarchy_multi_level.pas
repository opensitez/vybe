// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_hierarchy_multi_level
...
begin
  try
    ...
    on E: ELevel2 do __p(__vs('CaughtAtL2:' + E.ClassName));
  end;
__vybeCheck('CaughtAtL2:ELevel3');
end.
