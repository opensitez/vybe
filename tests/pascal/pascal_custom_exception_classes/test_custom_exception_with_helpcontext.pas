// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_with_helpcontext
...
begin
  try
    ...
    on E: EHelpErr do __p(__vs(E.Message + '-' + E.HelpContext.ToString));
  end;
__vybeCheck('ContextualHelpError-1001');
end.
