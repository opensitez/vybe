// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_with_error_code_field
...
begin
  try
    ...
    on E: ECodeException do __p(__vs(E.ErrorCode.ToString + '-' + E.Message));
  end;
__vybeCheck('404-Page Not Found');
end.
