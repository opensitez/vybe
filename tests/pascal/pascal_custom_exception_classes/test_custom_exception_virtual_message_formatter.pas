// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_virtual_message_formatter
...
begin
  ...
  __p(__vs(e.GetFormattedMessage));
  e.Free;
__vybeCheck('Sub:TestMessage');
end.
