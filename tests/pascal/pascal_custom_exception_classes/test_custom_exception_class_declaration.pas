// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_class_declaration
...
begin
  try
    ...
    on E: ECustomAppError do __p(__vs(E.ClassName + ':' + E.Message));
  end;
__vybeCheck('ECustomAppError:AppErrorOccurred');
end.
