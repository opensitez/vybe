// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_wrapping_payload_record
...
begin
  ...
  try
    ...
    on E: EPayloadErr do __p(__vs(E.Payload.ModuleName + ':' + E.Payload.Severity.ToString));
  end;
__vybeCheck('AuthModule:5');
end.
