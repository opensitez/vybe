// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_reraising_custom_type
...
begin
  try
    try
      ...
      begin
        __p(__vs('InnerLog:' + E.Message));
        raise;
      end;
    end;
  except
    on E: ECustomReraise do __p(__vs('OuterLog:' + E.Message));
  end;
__vybeCheck('InnerLog:ReraisedCustom' + #10 + 'OuterLog:ReraisedCustom');
end.
