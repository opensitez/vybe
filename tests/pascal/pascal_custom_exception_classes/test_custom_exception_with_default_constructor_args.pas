// vybe-test: pascal/pascal_custom_exception_classes/test_custom_exception_with_default_constructor_args
...
begin
  try
    ...
    on E: EDefaultErr do __p(__vs(E.Message));
  end;
__vybeCheck('DefaultErrorMessage');
end.
