// vybe-test: pascal/pascal_high_precision_floating_point/test_fp_comparevalue_float
// origin: languages/pascal/tests/pascal/test_pascal_high_precision_floating_point.rs
program Test;
{$mode delphi}
...
uses Math;
begin
  __p(__vs(CompareValue(10.5, 20.5)));
  __p(__vs(CompareValue(20.5, 10.5)));
  __p(__vs(CompareValue(10.5, 10.5)));
__vybeCheck('-1' + #10 + '1' + #10 + '0');
end.
