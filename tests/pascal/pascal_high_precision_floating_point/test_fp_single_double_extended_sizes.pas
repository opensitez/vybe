// vybe-test: pascal/pascal_high_precision_floating_point/test_fp_single_double_extended_sizes
...
begin
  __p(__vs(SizeOf(Single) = 4));
  __p(__vs(SizeOf(Double) = 8));
  __p(__vs(SizeOf(Extended) >= 8));
