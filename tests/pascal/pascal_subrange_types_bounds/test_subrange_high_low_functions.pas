// vybe-test: pascal/pascal_subrange_types_bounds/test_subrange_high_low_functions
// origin: languages/pascal/tests/pascal/test_pascal_subrange_types_bounds.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  __p(__vs(Low(TScore)));
  __p(__vs(High(TScore)));
__vybeCheck('0' + #10 + '100');
end.
