// vybe-test: pascal/modern_pascal/forward_declaration
// origin: languages/pascal/tests/pascal/test_modern_pascal.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  if n > 0 then begin __p(__vs('A' + IntToStr(n))); B(n - 1); end;
end;

procedure B(n: Integer);
begin
  if n > 0 then begin __p(__vs('B' + IntToStr(n))); A(n - 1); end;
end;

begin
  A(3);
__vybeCheck('A3' + #10 + 'B2' + #10 + 'A1');
end.
