// vybe-test: pascal/data_adt/multiset_add_count
// origin: languages/pascal/tests/pascal/test_data_adt.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  ms.Add('cherry');
  ms.Add('apple');
  __p(__vs(ms.CountOf('apple')));
  __p(__vs(ms.CountOf('banana')));
  __p(__vs(ms.CountOf('grape')));
  ms.Free;
__vybeCheck('3' + #10 + '1' + #10 + '0');
end.
