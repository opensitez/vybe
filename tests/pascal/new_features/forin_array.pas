// vybe-test: pascal/new_features/forin_array
// origin: languages/pascal/tests/pascal/test_new_features.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var item: Integer; begin
      for item in [10, 20, 30] do __p(__vs(item)); __vybeCheck('10' + #10 + '20' + #10 + '30');
end.
