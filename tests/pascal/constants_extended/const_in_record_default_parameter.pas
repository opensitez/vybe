// vybe-test: pascal/constants_extended/const_in_record_default_parameter
...
end; const DEFAULT_N = 5; procedure Show(n: Integer); begin __p(__vs(n)); end; begin Show(DEFAULT_N); __vybeCheck('5');
end.
