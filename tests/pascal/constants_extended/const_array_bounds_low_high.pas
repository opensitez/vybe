// vybe-test: pascal/constants_extended/const_array_bounds_low_high
...
end; const A: array[5..7] of Integer = (1, 2, 3); begin __p(__vs(Low(A))); __p(__vs(High(A))); __vybeCheck('5' + #10 + '7');
end.
