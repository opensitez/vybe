// vybe-test: pascal/constants_extended/const_array_index_from_const
...
end; const IDX = 1; const A: array[0..2] of Integer = (10, 20, 30); begin __p(__vs(A[IDX])); __vybeCheck('20');
end.
