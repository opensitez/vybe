// vybe-test: pascal/constants_extended/resourcestring_style_error_template
...
end; const SErrPrefix = 'Error: '; const SErrCode = 'E001'; const SFull = SErrPrefix + SErrCode; begin __p(__vs(SFull)); __vybeCheck('Error: E001');
end.
