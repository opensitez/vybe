// vybe-test: pascal/constants_extended/const_boolean_or_expression
...
end; const F = False; const T1 = True; const R = F or T1; begin if R then __p(__vs('ok')); __vybeCheck('ok');
end.
