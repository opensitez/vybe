// vybe-test: pascal/constants_extended/resourcestring_style_plural_label
...
end; const SItemSingular = 'item'; const SItemPlural = 'items'; const UsePlural = True; begin if UsePlural then __p(__vs(SItemPlural)) else __p(__vs(SItemSingular)); __vybeCheck('items');
end.
