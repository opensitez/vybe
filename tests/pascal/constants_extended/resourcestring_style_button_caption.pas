// vybe-test: pascal/constants_extended/resourcestring_style_button_caption
...
end; const SCaptionOk = 'OK'; const SCaptionCancel = 'Cancel'; begin __p(__vs(SCaptionOk)); __p(__vs(SCaptionCancel)); __vybeCheck('OK' + #10 + 'Cancel');
end.
