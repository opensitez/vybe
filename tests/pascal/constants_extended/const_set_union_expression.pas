// vybe-test: pascal/constants_extended/const_set_union_expression
...
end; type TD = (A, B, C); const S1 = [A]; const S2 = [B, C]; const S = S1 + S2; var x: TD; begin x := B; if x in S then __p(__vs('in')) else __p(__vs('out')); __vybeCheck('in');
end.
