// vybe-test: pascal/constants_extended/const_resource_lookup_table_entry
// origin: languages/pascal/tests/pascal/test_constants_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; const Keys: array[0..2] of string = ('red', 'green', 'blue'); const Vals: array[0..2] of Integer = (1, 2, 3); var i: Integer; begin for i := 0 to 2 do if Keys[i] = 'green' then __p(__vs(Vals[i])); __vybeCheck('2');
end.
