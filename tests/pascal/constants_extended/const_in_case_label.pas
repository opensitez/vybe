// vybe-test: pascal/constants_extended/const_in_case_label
...
end; const CODE = 2; var x: Integer; begin x := CODE; case x of 1: __p(__vs('one')); 2: __p(__vs('two')); else __p(__vs('other')); end; __vybeCheck('two');
end.
