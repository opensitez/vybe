// vybe-test: pascal/constants_extended/const_used_in_for_bound
...
end; const LAST = 3; var i, s: Integer; begin s := 0; for i := 1 to LAST do s := s + i; __p(__vs(s)); __vybeCheck('6');
end.
