// vybe-test: pascal/constants_extended/const_record_nested_field_init
...
end; type TInner = record V: Integer; end; type TOuter = record Inner: TInner; end; const O: TOuter = (Inner: (V: 9)); begin __p(__vs(O.Inner.V)); __vybeCheck('9');
end.
