// vybe-test: pascal/constants_extended/resourcestring_style_const_string
...
end; const SMsgNotFound = 'Record not found'; begin __p(__vs(SMsgNotFound)); __vybeCheck('Record not found');
end.
