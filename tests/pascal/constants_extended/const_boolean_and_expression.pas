// vybe-test: pascal/constants_extended/const_boolean_and_expression
...
end; const T1 = True; const T2 = True; const R = T1 and T2; begin if R then __p(__vs('ok')); __vybeCheck('ok');
end.
