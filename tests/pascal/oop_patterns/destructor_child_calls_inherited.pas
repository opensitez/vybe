// vybe-test: pascal/oop_patterns/destructor_child_calls_inherited
// origin: languages/pascal/tests/pascal/test_oop_patterns.rs
program T;
{$mode delphi}
uses SysUtils;
...
constructor TBase.Create; begin __p(__vs('base create')); end;
destructor TBase.Destroy; begin __p(__vs('base destroy')); inherited Destroy; end;
constructor TChild.Create; begin inherited Create; __p(__vs('child create')); end;
destructor TChild.Destroy; begin __p(__vs('child destroy')); inherited Destroy; end;

var c: TChild;
begin
  c := TChild.Create;
  c.Free;
__vybeCheck('base create' + #10 + 'child create' + #10 + 'child destroy' + #10 + 'base destroy');
end.
