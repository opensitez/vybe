// vybe-test: pascal/pascal_class_constructors_destructors/test_constructor_instantiates_multiple_fields
...
begin
  ...
  __p(__vs(comp.A.Name));
  __p(__vs(comp.B.Code));
  comp.Free;
__vybeCheck('CompA' + #10 + '777');
end.
