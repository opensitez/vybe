// vybe-test: pascal/pascal_class_constructors_destructors/test_inherited_constructor_chaining
...
begin
  __p(__vs('ParentCreated'));
end;
constructor TChild.Create;
begin
  inherited Create;
  __p(__vs('ChildCreated'));
end;
var c: TChild;
begin
  c := TChild.Create;
  c.Free;
__vybeCheck('ParentCreated' + #10 + 'ChildCreated');
end.
