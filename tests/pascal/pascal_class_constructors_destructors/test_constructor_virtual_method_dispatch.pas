// vybe-test: pascal/pascal_class_constructors_destructors/test_constructor_virtual_method_dispatch
// origin: languages/pascal/tests/pascal/test_pascal_class_constructors_destructors.rs
program Test;
{$mode delphi}
uses SysUtils;
...
procedure TBase.Init; begin __p(__vs('BaseInit')); end;
procedure TSub.Init; begin __p(__vs('SubInit')); end;
