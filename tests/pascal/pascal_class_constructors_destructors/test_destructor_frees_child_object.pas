// vybe-test: pascal/pascal_class_constructors_destructors/test_destructor_frees_child_object
...
begin
  m := TMainObj.Create;
  m.Free;
__vybeCheck('SubDestroyed' + #10 + 'MainDestroyed');
end.
