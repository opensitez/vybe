// vybe-test: pascal/pascal_class_constructors_destructors/test_constructor_with_record_parameter
...
begin
  ...
  n := TNode.Create(rec);
  __p(__vs(n.Conf.Code));
  __p(__vs(n.Conf.Name));
  n.Free;
__vybeCheck('200' + #10 + 'OK');
end.
