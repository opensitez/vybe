// vybe-test: pascal/pascal_class_constructors_destructors/test_destructor_virtual_dispatch
...
begin
  __p(__vs('BaseDestroy'));
  inherited Destroy;
end;
destructor TDerived.Destroy;
begin
  __p(__vs('DerivedDestroy'));
  inherited Destroy;
end;
var b: TBase;
begin
  b := TDerived.Create;
  b.Free;
__vybeCheck('DerivedDestroy' + #10 + 'BaseDestroy');
end.
