// vybe-test: pascal/oop_visibility_extra/strict_private_ctor_4
...
end; type TB=class strict private F:Integer; public constructor Create(v:Integer); function Get:Integer; end; constructor TB.Create(v:Integer); begin F:=v; end; function TB.Get:Integer; begin Result:=F; end; var o:TB; begin o:=TB.Create(4); __p(__vs(o.Get)); o.Free; __vybeCheck('4');
end.
