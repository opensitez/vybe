// vybe-test: pascal/oop_visibility_extra/public_field_5
...
end; type TB=class public F:Integer; end; var o:TB; begin o:=TB.Create; o.F:=5; __p(__vs(o.F)); o.Free; __vybeCheck('5');
end.
