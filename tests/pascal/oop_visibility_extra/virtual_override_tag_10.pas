// vybe-test: pascal/oop_visibility_extra/virtual_override_tag_10
...
end; type TB=class public function Tag:Integer; virtual; end; TC=class(TB) function Tag:Integer; override; end; function TB.Tag:Integer; begin Result:=10; end; function TC.Tag:Integer; begin Result:=20; end; var o:TB; begin o:=TC.Create; __p(__vs(o.Tag)); o.Free; __vybeCheck('20');
end.
