// vybe-test: pascal/oop_visibility_extra/public_field_7
...
end; type TB=class public F:Integer; end; var o:TB; begin o:=TB.Create; o.F:=7; __p(__vs(o.F)); o.Free; __vybeCheck('7');
end.
