// vybe-test: pascal/oop_visibility_extra/virtual_override_tag_1
...
end; type TB=class public function Tag:Integer; virtual; end; TC=class(TB) function Tag:Integer; override; end; function TB.Tag:Integer; begin Result:=1; end; function TC.Tag:Integer; begin Result:=2; end; var o:TB; begin o:=TC.Create; __p(__vs(o.Tag)); o.Free; __vybeCheck('2');
end.
