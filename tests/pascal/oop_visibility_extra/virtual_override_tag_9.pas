// vybe-test: pascal/oop_visibility_extra/virtual_override_tag_9
...
end; type TB=class public function Tag:Integer; virtual; end; TC=class(TB) function Tag:Integer; override; end; function TB.Tag:Integer; begin Result:=9; end; function TC.Tag:Integer; begin Result:=18; end; var o:TB; begin o:=TC.Create; __p(__vs(o.Tag)); o.Free; __vybeCheck('18');
end.
