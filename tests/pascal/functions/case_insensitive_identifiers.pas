// vybe-test: pascal/functions/case_insensitive_identifiers
...
end; var Counter: Integer; function Double(N: Integer): Integer; begin Double := n * 2; end; begin Counter := 5; __p(__vs(counter)); __p(__vs(double(Counter))); __vybeCheck('5' + #10 + '10');
end.
