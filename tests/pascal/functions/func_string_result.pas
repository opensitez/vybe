// vybe-test: pascal/functions/func_string_result
...
end; function Greet(name: String): String; begin Result := 'Hello ' + name; end; begin __p(__vs(Greet('World'))); __vybeCheck('Hello World');
end.
