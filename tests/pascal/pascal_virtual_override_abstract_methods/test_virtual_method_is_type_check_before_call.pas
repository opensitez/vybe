// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_virtual_method_is_type_check_before_call
...
procedure TBase.Action; begin __p(__vs('Base')); end;
procedure TSub.Action; begin __p(__vs('Sub')); end;
var b: TBase;
begin
  b := TSub.Create;
  if b is TSub then
