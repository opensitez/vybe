// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_virtual_function_with_string_parameter
...
begin
  ...
  __p(__vs(f.FormatText('hello pascal')));
  f.Free;
__vybeCheck('HELLO PASCAL');
end.
