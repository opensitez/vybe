// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_polymorphic_array_dispatch
...
procedure TBaseWidget.Render; begin __p(__vs('Widget')); end;
procedure TButton.Render; begin __p(__vs('Button')); end;
procedure TLabel.Render; begin __p(__vs('Label')); end;
