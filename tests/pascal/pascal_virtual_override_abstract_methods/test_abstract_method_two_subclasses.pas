// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_abstract_method_two_subclasses
...
begin
  ...
  __p(__vs(c1.Exec(10, 5)));
  __p(__vs(c2.Exec(10, 5)));
  c1.Free; c2.Free;
__vybeCheck('15' + #10 + '50');
end.
