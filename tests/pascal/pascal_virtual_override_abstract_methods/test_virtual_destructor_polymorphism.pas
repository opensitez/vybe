// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_virtual_destructor_polymorphism
// origin: languages/pascal/tests/pascal/test_pascal_virtual_override_abstract_methods.rs
program Test;
{$mode delphi}
uses SysUtils;
...
destructor TBaseResource.Destroy; begin __p(__vs('BaseCleaned')); inherited Destroy; end;
destructor TCustomResource.Destroy; begin __p(__vs('CustomCleaned')); inherited Destroy; end;
var res: TBaseResource;
begin
  res := TCustomResource.Create;
  res.Free;
__vybeCheck('CustomCleaned' + #10 + 'BaseCleaned');
end.
