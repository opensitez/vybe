// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_virtual_method_overriding
...
procedure TAnimal.MakeSound; begin __p(__vs('Generic')); end;
procedure TDog.MakeSound; begin __p(__vs('Bark')); end;
var a: TAnimal;
begin
  a := TDog.Create;
  a.MakeSound;
