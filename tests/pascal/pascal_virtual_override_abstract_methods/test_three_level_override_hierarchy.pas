// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_three_level_override_hierarchy
...
procedure TLevel1.Action; begin __p(__vs('L1')); end;
procedure TLevel2.Action; begin __p(__vs('L2')); end;
procedure TLevel3.Action; begin __p(__vs('L3')); end;
var obj: TLevel1;
begin
  obj := TLevel3.Create;
  obj.Action;
