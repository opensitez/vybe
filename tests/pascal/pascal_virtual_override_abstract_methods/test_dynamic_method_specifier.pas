// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_dynamic_method_specifier
...
procedure TDynBase.Exec; begin __p(__vs('DynBase')); end;
procedure TDynSub.Exec; begin __p(__vs('DynSub')); end;
var d: TDynBase;
begin
  d := TDynSub.Create;
  d.Exec;
