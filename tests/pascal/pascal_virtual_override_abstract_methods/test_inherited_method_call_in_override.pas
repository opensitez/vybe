// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_inherited_method_call_in_override
...
procedure TParent.Greet; begin __p(__vs('Hello Parent')); end;
procedure TChild.Greet;
begin
  inherited Greet;
  __p(__vs('Hello Child'));
end;
var c: TChild;
begin
  c := TChild.Create;
  c.Greet;
  c.Free;
__vybeCheck('Hello Parent' + #10 + 'Hello Child');
end.
