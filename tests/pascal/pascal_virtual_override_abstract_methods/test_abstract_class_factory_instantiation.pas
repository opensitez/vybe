// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_abstract_class_factory_instantiation
...
procedure TElectricEngine.Start; begin __p(__vs('SilentStart')); end;
var eng: TEngine;
begin
  eng := CreateEngine;
  eng.Start;
  eng.Free;
__vybeCheck('SilentStart');
end.
