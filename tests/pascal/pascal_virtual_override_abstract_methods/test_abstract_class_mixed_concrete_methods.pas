// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_abstract_class_mixed_concrete_methods
...
procedure TAbstractLogger.LogHeader; begin __p(__vs('=== LOG ===')); end;
procedure TConsoleLogger.LogBody(msg: String); begin __p(__vs(msg)); end;
