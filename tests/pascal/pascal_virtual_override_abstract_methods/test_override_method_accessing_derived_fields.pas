// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_override_method_accessing_derived_fields
...
begin
  ...
  __p(__vs(b.GetDescription));
  b.Free;
__vybeCheck('Book=$15.99');
end.
