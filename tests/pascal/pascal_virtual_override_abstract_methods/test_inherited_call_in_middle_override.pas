// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_inherited_call_in_middle_override
...
procedure TA.Step; begin __p(__vs('A')); end;
procedure TB.Step; begin __p(__vs('B')); inherited Step; end;
procedure TC.Step; begin __p(__vs('C')); inherited Step; end;
var obj: TA;
begin
  obj := TC.Create;
  obj.Step;
  obj.Free;
__vybeCheck('C' + #10 + 'B' + #10 + 'A');
end.
