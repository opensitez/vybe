// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_override_with_const_parameter
...
procedure TPrinter.PrintVal(const s: String); begin __p(__vs(s)); end;
procedure TPrefixPrinter.PrintVal(const s: String); begin __p(__vs('> ' + s)); end;
var p: TPrinter;
begin
