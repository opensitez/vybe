// vybe-test: pascal/pascal_virtual_override_abstract_methods/test_virtual_method_called_by_base_method
...
procedure TFramework.ProcessStep; begin __p(__vs('DefaultStep')); end;
...
procedure TAppFramework.ProcessStep; begin __p(__vs('AppCustomStep')); end;
var app: TFramework;
begin
  app := TAppFramework.Create;
  app.RunFramework;
  app.Free;
__vybeCheck('Start' + #10 + 'AppCustomStep' + #10 + 'End');
end.
