// vybe-test: pascal/strings/string_replace_all_occurrences_flag
// origin: languages/pascal/tests/pascal/test_strings.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; begin __p(__vs(StringReplace('a-b-a', '-', '+', [rfReplaceAll]))); __vybeCheck('a+b+a');
end.
