// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_reassignment_cleans_old
...
destructor TRefObj.Destroy; begin __p(__vs('ReassignedFreed:' + Name)); inherited Destroy; end;
...
begin
  ...
  __p(__vs('ReassignmentDone'));
__vybeCheck('ReassignedFreed:First' + #10 + 'ReassignmentDone' + #10 + 'ReassignedFreed:Second');
end.
