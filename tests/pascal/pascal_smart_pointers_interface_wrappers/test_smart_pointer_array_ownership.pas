// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_array_ownership
...
destructor TItem.Destroy; begin __p(__vs('ItemDestroyed:' + ID.ToString)); inherited Destroy; end;
...
begin
  ProcessItems;
__vybeCheck('ItemDestroyed:1' + #10 + 'ItemDestroyed:2');
end.
