// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_shared_ownership_refcount
...
destructor TSharedResource.Destroy; begin __p(__vs('SharedFreed:' + Name)); inherited Destroy; end;
...
begin
  ...
  ref2 := ref1;
  ref1 := nil;
  __p(__vs('Ref1NilCompleted'));
  __p(__vs(ref2.GetRes.Name));
  ref2 := nil;
  __p(__vs('Ref2NilCompleted'));
__vybeCheck('Ref1NilCompleted' + #10 + 'SharedDoc' + #10 + 'SharedFreed:SharedDoc' + #10 + 'Ref2NilCompleted');
end.
