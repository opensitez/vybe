// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_in_record_field
...
destructor TSubItem.Destroy; begin __p(__vs('SubItemFreed:' + Title)); inherited Destroy; end;
...
begin
  ...
  __p(__vs(rec.SmartField.GetSub.Title));
end;

begin
  RunRecScope;
__vybeCheck('RecFieldItem' + #10 + 'SubItemFreed:RecFieldItem');
end.
