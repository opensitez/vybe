// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_custom_cleanup_closure
...
procedure OnCleanup;
begin
  __p(__vs('CustomCleanupCallbackExecuted'));
end;
...
begin
  TestCustomCleanup;
__vybeCheck('CustomCleanupCallbackExecuted');
end.
