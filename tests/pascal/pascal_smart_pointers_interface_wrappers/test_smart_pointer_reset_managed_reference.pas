// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_reset_managed_reference
...
destructor TResource.Destroy; begin __p(__vs('Freed:' + Tag)); inherited Destroy; end;
...
begin
  ...
  __p(__vs(ptr.Get.Tag));
__vybeCheck('Freed:Old' + #10 + 'New' + #10 + 'Freed:New');
end.
