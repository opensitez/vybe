// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_method_call_on_managed_object
...
procedure TWorker.PerformWork; begin __p(__vs('ManagedWorkExecuted')); end;
...
begin
  ...
  smart.DoWork;
__vybeCheck('ManagedWorkExecuted');
end.
