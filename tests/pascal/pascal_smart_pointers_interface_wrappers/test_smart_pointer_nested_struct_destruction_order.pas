// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_nested_struct_destruction_order
...
destructor TChildObj.Destroy; begin __p(__vs('ChildObjFreed')); inherited Destroy; end;
...
destructor TParentObj.Destroy; begin Child.Free; __p(__vs('ParentObjFreed')); inherited Destroy; end;
...
begin
  RunParentScope;
__vybeCheck('ChildObjFreed' + #10 + 'ParentObjFreed');
end.
