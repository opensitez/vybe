// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_managing_container_instance
...
begin
  ...
  __p(__vs(smart.GetContainer.Text));
__vybeCheck('ContainerText');
end.
