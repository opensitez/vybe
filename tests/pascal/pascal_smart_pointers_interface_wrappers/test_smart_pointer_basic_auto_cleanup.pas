// vybe-test: pascal/pascal_smart_pointers_interface_wrappers/test_smart_pointer_basic_auto_cleanup
...
begin
  __p(__vs('AutoCleanedBySmartPointer'));
  inherited Destroy;
end;
...
begin
  RunScope;
__vybeCheck('AutoCleanedBySmartPointer');
end.
