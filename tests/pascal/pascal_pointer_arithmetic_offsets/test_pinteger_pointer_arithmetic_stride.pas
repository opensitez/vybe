// vybe-test: pascal/pascal_pointer_arithmetic_offsets/test_pinteger_pointer_arithmetic_stride
// origin: languages/pascal/tests/pascal/test_pascal_pointer_arithmetic_offsets.rs
program Test;
{$mode delphi}
uses SysUtils;
