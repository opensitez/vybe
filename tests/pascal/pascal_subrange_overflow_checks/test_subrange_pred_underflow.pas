// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_pred_underflow
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('PredRangeErrorCaught'));
  end;
__vybeCheck('PredRangeErrorCaught');
end.
