// vybe-test: pascal/pascal_subrange_overflow_checks/test_overflow_multiplication_check
// origin: languages/pascal/tests/pascal/test_pascal_subrange_overflow_checks.rs
program Test;
{$mode delphi}
...
begin
  try
    ...
    on E: EIntOverflow do __p(__vs('MulOverflowCaught'));
    on E: ERangeError do __p(__vs('MulOverflowCaughtRange'));
  end;
__vybeCheck('MulOverflowCaught');
end.
