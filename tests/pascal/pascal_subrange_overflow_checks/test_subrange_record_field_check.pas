// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_record_field_check
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('RecordRangeErrorCaught'));
  end;
__vybeCheck('RecordRangeErrorCaught');
end.
