// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_succ_overflow
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('SuccRangeErrorCaught'));
  end;
__vybeCheck('SuccRangeErrorCaught');
end.
