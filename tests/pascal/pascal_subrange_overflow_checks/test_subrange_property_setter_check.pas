// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_property_setter_check
...
begin
  ...
  try
    ...
    on E: ERangeError do __p(__vs('PropertyRangeErrorCaught'));
  end;
  obj.Free;
__vybeCheck('PropertyRangeErrorCaught');
end.
