// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_inc_dec_boundary_check
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('IncRangeErrorCaught'));
  end;
__vybeCheck('IncRangeErrorCaught');
end.
