// vybe-test: pascal/pascal_subrange_overflow_checks/test_integer_overflow_eintoverflow
...
begin
  try
    ...
    on E: EIntOverflow do __p(__vs('IntOverflowCaught'));
    on E: ERangeError do __p(__vs('IntOverflowCaughtRange'));
  end;
__vybeCheck('IntOverflowCaught');
end.
