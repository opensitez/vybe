// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_upper_bound_overflow_erangeerror
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('UpperRangeErrorCaught'));
  end;
__vybeCheck('UpperRangeErrorCaught');
end.
