// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_enum_bounds_check
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('EnumRangeErrorCaught'));
  end;
__vybeCheck('EnumRangeErrorCaught');
end.
