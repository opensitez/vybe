// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_array_indexing_check
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('ArrayIndexErrorCaught'));
  end;
__vybeCheck('ArrayIndexErrorCaught');
end.
