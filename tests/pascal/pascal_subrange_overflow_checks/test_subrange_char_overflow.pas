// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_char_overflow
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('CharRangeErrorCaught'));
  end;
__vybeCheck('CharRangeErrorCaught');
end.
