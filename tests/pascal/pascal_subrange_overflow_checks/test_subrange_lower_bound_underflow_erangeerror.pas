// vybe-test: pascal/pascal_subrange_overflow_checks/test_subrange_lower_bound_underflow_erangeerror
...
begin
  try
    ...
    on E: ERangeError do __p(__vs('LowerRangeErrorCaught'));
  end;
__vybeCheck('LowerRangeErrorCaught');
end.
