// vybe-test: pascal/nested_procedures_extra/nested_three_level_prints_chain
...
end; procedure A; procedure B; procedure C; begin __p(__vs('c')); end; begin C; __p(__vs('b')); end; begin B; __p(__vs('a')); end; begin A; __vybeCheck('c' + #10 + 'b' + #10 + 'a');
end.
