// vybe-test: pascal/nested_procedures_extra/mutual_recursion_countdown_5
...
end; procedure B(n:Integer); forward; procedure A(n:Integer); begin if n>0 then begin __p(__vs(n)); B(n-1); end; end; procedure B(n:Integer); begin if n>0 then A(n-1); end; begin A(5); __vybeCheck('5' + #10 + '3' + #10 + '1');
end.
