// vybe-test: pascal/nested_procedures_extra/nested_proc_reads_outer_const
...
end; procedure Outer; const K=11; procedure Inner; begin __p(__vs(K)); end; begin Inner; end; begin Outer; __vybeCheck('11');
end.
