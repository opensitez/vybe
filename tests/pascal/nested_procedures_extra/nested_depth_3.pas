// vybe-test: pascal/nested_procedures_extra/nested_depth_3
...
end; procedure Outer; procedure I1; begin I2; end; procedure I2; begin __p(__vs(3)); end;  begin I1; end; begin Outer; __vybeCheck('3');
end.
