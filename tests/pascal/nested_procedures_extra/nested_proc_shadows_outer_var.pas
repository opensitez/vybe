// vybe-test: pascal/nested_procedures_extra/nested_proc_shadows_outer_var
...
end; procedure Outer; var x:Integer; procedure Inner; var x:Integer; begin x:=99; __p(__vs(x)); end; begin x:=1; Inner; __p(__vs(x)); end; begin Outer; __vybeCheck('99' + #10 + '1');
end.
