// vybe-test: pascal/nested_procedures_extra/nested_depth_4
...
end; procedure Outer; procedure I1; begin I2; end; procedure I2; begin I3; end; procedure I3; begin __p(__vs(4)); end;  begin I1; end; begin Outer; __vybeCheck('4');
end.
