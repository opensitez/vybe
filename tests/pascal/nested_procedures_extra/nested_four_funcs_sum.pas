// vybe-test: pascal/nested_procedures_extra/nested_four_funcs_sum
...
end; function Outer:Integer; function A:Integer; begin Result:=1; end; function B:Integer; begin Result:=A+2; end; function C:Integer; begin Result:=B+3; end; begin Result:=C; end; begin __p(__vs(Outer)); __vybeCheck('6');
end.
