// vybe-test: pascal/nested_procedures_extra/nested_proc_modifies_outer_local
...
end; procedure Outer; var x:Integer; procedure Inner; begin x:=x+5; end; begin x:=10; Inner; __p(__vs(x)); end; begin Outer; __vybeCheck('15');
end.
