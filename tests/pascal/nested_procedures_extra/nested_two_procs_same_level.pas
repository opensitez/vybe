// vybe-test: pascal/nested_procedures_extra/nested_two_procs_same_level
...
end; procedure Outer; procedure A; begin __p(__vs(1)); end; procedure B; begin __p(__vs(2)); end; begin A; B; end; begin Outer; __vybeCheck('1' + #10 + '2');
end.
