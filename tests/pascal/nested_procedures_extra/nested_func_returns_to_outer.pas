// vybe-test: pascal/nested_procedures_extra/nested_func_returns_to_outer
...
end; function Outer:Integer; function Inner:Integer; begin Result:=42; end; begin Result:=Inner; end; begin __p(__vs(Outer)); __vybeCheck('42');
end.
