// vybe-test: pascal/nested_procedures_extra/nested_func_uses_outer_param
...
end; function Outer(n:Integer):Integer; function Inner:Integer; begin Result:=n*2; end; begin Result:=Inner; end; begin __p(__vs(Outer(6))); __vybeCheck('12');
end.
