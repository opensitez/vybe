// vybe-test: pascal/nested_procedures_extra/nested_proc_called_twice
...
end; procedure Outer; procedure Tick; begin __p(__vs('t')); end; begin Tick; Tick; end; begin Outer; __vybeCheck('t' + #10 + 't');
end.
