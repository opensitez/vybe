// vybe-test: pascal/nested_procedures_extra/mutual_recursion_countdown_11
...
end; procedure B(n:Integer); forward; procedure A(n:Integer); begin if n>0 then begin __p(__vs(n)); B(n-1); end; end; procedure B(n:Integer); begin if n>0 then A(n-1); end; begin A(11); __vybeCheck('11' + #10 + '9' + #10 + '7' + #10 + '5' + #10 + '3' + #10 + '1');
end.
