// vybe-test: pascal/nested_procedures_extra/nested_mutual_local_forward
...
end; procedure Outer; procedure B; forward; procedure A; begin __p(__vs('a')); B; end; procedure B; begin __p(__vs('b')); end; begin A; end; begin Outer; __vybeCheck('a' + #10 + 'b');
end.
