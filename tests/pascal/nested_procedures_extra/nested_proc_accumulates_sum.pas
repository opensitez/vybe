// vybe-test: pascal/nested_procedures_extra/nested_proc_accumulates_sum
...
end; procedure Outer; var total:Integer; procedure Add(n:Integer); begin total:=total+n; end; begin total:=0; Add(3); Add(4); __p(__vs(total)); end; begin Outer; __vybeCheck('7');
end.
