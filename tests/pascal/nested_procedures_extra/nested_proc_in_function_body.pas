// vybe-test: pascal/nested_procedures_extra/nested_proc_in_function_body
...
end; function Compute:Integer; procedure Step; begin __p(__vs(1)); end; begin Step; Result:=7; end; begin __p(__vs(Compute)); __vybeCheck('1' + #10 + '7');
end.
