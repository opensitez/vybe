// vybe-test: pascal/nested_procedures_extra/mutual_recursion_countdown_14
...
end; procedure B(n:Integer); forward; procedure A(n:Integer); begin if n>0 then begin __p(__vs(n)); B(n-1); end; end; procedure B(n:Integer); begin if n>0 then A(n-1); end; begin A(14); __vybeCheck('14' + #10 + '12' + #10 + '10' + #10 + '8' + #10 + '6' + #10 + '4' + #10 + '2');
end.
