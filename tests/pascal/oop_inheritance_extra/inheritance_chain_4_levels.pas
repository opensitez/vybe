// vybe-test: pascal/oop_inheritance_extra/inheritance_chain_4_levels
...
end; type TL1=class public function L:Integer; virtual; end; TL2=class(TL1) function L:Integer; override; end; TL3=class(TL2) function L:Integer; override; end;  function TL1.L:Integer; begin Result:=1; end; function TL2.L:Integer; begin Result:=2; end; function TL3.L:Integer; begin Result:=3; end;  var o:TL1; begin o:=TL3.Create; __p(__vs(o.L)); o.Free; __vybeCheck('3');
end.
