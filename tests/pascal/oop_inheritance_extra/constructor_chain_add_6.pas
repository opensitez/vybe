// vybe-test: pascal/oop_inheritance_extra/constructor_chain_add_6
...
end; type TBase=class public Value:Integer; constructor Create(v:Integer); end; TChild=class(TBase) constructor Create(v:Integer); end; constructor TBase.Create(v:Integer); begin Value:=v; end; constructor TChild.Create(v:Integer); begin inherited Create(v+6); end; var c:TChild; begin c:=TChild.Create(10); __p(__vs(c.Value)); c.Free; __vybeCheck('16');
end.
