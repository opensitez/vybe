// vybe-test: pascal/oop_inheritance_extra/inherited_field_depth_1
...
end; type TBase=class public V:Integer; end; T1=class(TBase);  var o:T1; begin o:=T1.Create; o.V:=3; __p(__vs(o.V)); o.Free; __vybeCheck('3');
end.
