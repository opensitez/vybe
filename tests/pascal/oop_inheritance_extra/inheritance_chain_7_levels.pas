// vybe-test: pascal/oop_inheritance_extra/inheritance_chain_7_levels
// origin: languages/pascal/tests/pascal/test_oop_inheritance_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TL1=class public function L:Integer; virtual; end; TL2=class(TL1) function L:Integer; override; end; TL3=class(TL2) function L:Integer; override; end; TL4=class(TL3) function L:Integer; override; end; TL5=class(TL4) function L:Integer; override; end; TL6=class(TL5) function L:Integer; override; end;  function TL1.L:Integer; begin Result:=1; end; function TL2.L:Integer; begin Result:=2; end; function TL3.L:Integer; begin Result:=3; end; function TL4.L:Integer; begin Result:=4; end; function TL5.L:Integer; begin Result:=5; end; function TL6.L:Integer; begin Result:=6; end;  var o:TL1; begin o:=TL6.Create; __p(__vs(o.L)); o.Free; __vybeCheck('6');
end.
