// vybe-test: pascal/oop_inheritance_extra/inherited_field_depth_8
...
end; type TBase=class public V:Integer; end; T1=class(TBase); T2=class(T1); T3=class(T2); T4=class(T3); T5=class(T4); T6=class(T5); T7=class(T6); T8=class(T7);  var o:T8; begin o:=T8.Create; o.V:=24; __p(__vs(o.V)); o.Free; __vybeCheck('24');
end.
