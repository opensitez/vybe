// vybe-test: pascal/oop_inheritance_extra/inherited_field_depth_9
...
end; type TBase=class public V:Integer; end; T1=class(TBase); T2=class(T1); T3=class(T2); T4=class(T3); T5=class(T4); T6=class(T5); T7=class(T6); T8=class(T7); T9=class(T8);  var o:T9; begin o:=T9.Create; o.V:=27; __p(__vs(o.V)); o.Free; __vybeCheck('27');
end.
