// vybe-test: pascal/oop_inheritance_extra/inherited_field_depth_4
...
end; type TBase=class public V:Integer; end; T1=class(TBase); T2=class(T1); T3=class(T2); T4=class(T3);  var o:T4; begin o:=T4.Create; o.V:=12; __p(__vs(o.V)); o.Free; __vybeCheck('12');
end.
