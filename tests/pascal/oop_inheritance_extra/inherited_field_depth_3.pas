// vybe-test: pascal/oop_inheritance_extra/inherited_field_depth_3
...
end; type TBase=class public V:Integer; end; T1=class(TBase); T2=class(T1); T3=class(T2);  var o:T3; begin o:=T3.Create; o.V:=9; __p(__vs(o.V)); o.Free; __vybeCheck('9');
end.
