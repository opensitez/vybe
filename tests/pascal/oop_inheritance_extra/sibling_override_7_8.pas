// vybe-test: pascal/oop_inheritance_extra/sibling_override_7_8
...
end; type TB=class public function N:Integer; virtual; end; TA=class(TB) function N:Integer; override; end; TC=class(TB) function N:Integer; override; end; function TB.N:Integer; begin Result:=0; end; function TA.N:Integer; begin Result:=7; end; function TC.N:Integer; begin Result:=8; end; var x:TA; y:TC; begin x:=TA.Create; y:=TC.Create; __p(__vs(x.N)); __p(__vs(y.N)); x.Free; y.Free; __vybeCheck('7' + #10 + '8');
end.
