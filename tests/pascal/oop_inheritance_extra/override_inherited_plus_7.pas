// vybe-test: pascal/oop_inheritance_extra/override_inherited_plus_7
...
end; type TB=class public function F:Integer; virtual; end; TC=class(TB) function F:Integer; override; end; function TB.F:Integer; begin Result:=7; end; function TC.F:Integer; begin Result:=inherited F+7; end; var c:TC; begin c:=TC.Create; __p(__vs(c.F)); c.Free; __vybeCheck('14');
end.
