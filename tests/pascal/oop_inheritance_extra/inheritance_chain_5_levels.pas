// vybe-test: pascal/oop_inheritance_extra/inheritance_chain_5_levels
...
end; type TL1=class public function L:Integer; virtual; end; TL2=class(TL1) function L:Integer; override; end; TL3=class(TL2) function L:Integer; override; end; TL4=class(TL3) function L:Integer; override; end;  function TL1.L:Integer; begin Result:=1; end; function TL2.L:Integer; begin Result:=2; end; function TL3.L:Integer; begin Result:=3; end; function TL4.L:Integer; begin Result:=4; end;  var o:TL1; begin o:=TL4.Create; __p(__vs(o.L)); o.Free; __vybeCheck('4');
end.
