// vybe-test: pascal/oop_inheritance_extra/inherited_field_depth_2
...
end; type TBase=class public V:Integer; end; T1=class(TBase); T2=class(T1);  var o:T2; begin o:=T2.Create; o.V:=6; __p(__vs(o.V)); o.Free; __vybeCheck('6');
end.
