// vybe-test: pascal/oop_inheritance_extra/inherited_field_depth_5
...
end; type TBase=class public V:Integer; end; T1=class(TBase); T2=class(T1); T3=class(T2); T4=class(T3); T5=class(T4);  var o:T5; begin o:=T5.Create; o.V:=15; __p(__vs(o.V)); o.Free; __vybeCheck('15');
end.
