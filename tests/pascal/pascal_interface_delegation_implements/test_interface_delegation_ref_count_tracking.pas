// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_ref_count_tracking
// origin: languages/pascal/tests/pascal/test_pascal_interface_delegation_implements.rs
program Test;
{$mode delphi}
uses SysUtils;
...
procedure TCounterImpl.Ping; begin __p(__vs('DelegatedPing')); end;
destructor TCounterImpl.Destroy; begin __p(__vs('DelegateDestroyed')); inherited Destroy; end;
...
begin
  TestLifetime;
__vybeCheck('DelegatedPing' + #10 + 'DelegateDestroyed');
end.
