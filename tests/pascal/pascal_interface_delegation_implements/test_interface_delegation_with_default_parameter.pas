// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_with_default_parameter
...
procedure TDefaultImpl.Run(prefix: String); begin __p(__vs('RUN:' + prefix)); end;
...
begin
  ...
  d.Run;
  d.Run('CUST');
__vybeCheck('RUN:DEF' + #10 + 'RUN:CUST');
end.
