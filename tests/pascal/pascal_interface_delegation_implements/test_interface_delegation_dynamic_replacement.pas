// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_dynamic_replacement
...
procedure TPrinterA.Print; begin __p(__vs('PrinterA')); end;
procedure TPrinterB.Print; begin __p(__vs('PrinterB')); end;
...
begin
  ...
  intf.Print;
__vybeCheck('PrinterA' + #10 + 'PrinterB');
end.
