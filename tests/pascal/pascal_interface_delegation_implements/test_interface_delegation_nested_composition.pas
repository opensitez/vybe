// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_nested_composition
...
procedure TCoreAction.Run; begin __p(__vs('DeepNestedRun')); end;
