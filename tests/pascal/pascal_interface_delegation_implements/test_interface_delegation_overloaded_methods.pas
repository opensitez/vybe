// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_overloaded_methods
...
procedure TOverloadedImpl.Process(i: Integer); begin __p(__vs('INT:' + i.ToString)); end;
procedure TOverloadedImpl.Process(s: String); begin __p(__vs('STR:' + s)); end;
...
begin
  ...
  o.Process(42);
  o.Process('Pascal');
__vybeCheck('INT:42' + #10 + 'STR:Pascal');
end.
