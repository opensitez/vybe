// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_getter_backing
...
procedure TWorkerImpl.Work; begin __p(__vs('WorkingLazy')); end;
