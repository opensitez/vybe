// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_enum_parameter
...
procedure TModeImpl.SetMode(m: TMode); begin __p(__vs('MODE:' + Ord(m).ToString)); end;
