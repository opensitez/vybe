// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_with_record_parameter
...
procedure TRecHandlerImpl.HandleRec(r: TRec); begin __p(__vs('REC:' + r.Val)); end;
...
begin
  ...
  h.HandleRec(data);
__vybeCheck('REC:DelegatedRecordData');
end.
