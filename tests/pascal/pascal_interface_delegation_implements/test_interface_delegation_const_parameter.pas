// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_const_parameter
...
procedure TDisplayImpl.ShowConst(const s: String); begin __p(__vs('CONST:' + s)); end;
...
__vybeCheck('CONST:ImmutableText');
end.
