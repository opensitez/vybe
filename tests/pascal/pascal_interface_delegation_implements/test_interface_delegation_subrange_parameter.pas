// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_subrange_parameter
...
procedure TScoreImpl.RecordScore(s: TScore); begin __p(__vs('SCORE:' + s.ToString)); end;
