// vybe-test: pascal/pascal_interface_delegation_implements/test_interface_delegation_supports_check
...
procedure TAuditImpl.Audit; begin __p(__vs('AuditExecuted')); end;
