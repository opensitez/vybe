// vybe-test: pascal/subrange_extra/subrange_array_index
// origin: languages/pascal/tests/pascal/test_subrange_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TI=1..3; type TA=array[TI] of Integer; var a:TA; i:TI; begin for i:=1 to 3 do a[i]:=i*10; __p(__vs(a[2])); __vybeCheck('20');
end.
