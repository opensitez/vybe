// vybe-test: pascal/subrange_extra/subrange_boolean_from_compare
...
end; type TR=1..10; var x:TR; begin x:=6; if x>5 then __p(__vs('gt')) else __p(__vs('le')); __vybeCheck('gt');
end.
