// vybe-test: pascal/subrange_extra/subrange_case_label
...
end; type TM=1..3; var m:TM; begin m:=2; case m of 1:__p(__vs('a')); 2:__p(__vs('b')); 3:__p(__vs('c')); end; __vybeCheck('b');
end.
