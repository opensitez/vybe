// vybe-test: pascal/subrange_extra/subrange_nested_type
...
end; type TInner=1..2; type TOuter=record V:TInner; end; var o:TOuter; begin o.V:=2; __p(__vs(o.V)); __vybeCheck('2');
end.
