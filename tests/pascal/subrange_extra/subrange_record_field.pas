// vybe-test: pascal/subrange_extra/subrange_record_field
...
end; type TDay=1..31; type TDate=record D:TDay; end; var dt:TDate; begin dt.D:=15; __p(__vs(dt.D)); __vybeCheck('15');
end.
