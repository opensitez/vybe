// vybe-test: pascal/print_format_extended/writeln_nested_call_result
// origin: languages/pascal/tests/pascal/test_print_format_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function Twice(n:Integer):Integer; begin Result:=n*2; end; begin __p(__vs(Twice(6))); __vybeCheck('12');
end.
