// vybe-test: pascal/generic_specializations/generic_function_identity
// origin: languages/pascal/tests/pascal/test_generic_specializations.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin Result := v; end;
begin
  __p(__vs(Id<String>('same')));
  __p(__vs(Id<Integer>(88)));
__vybeCheck('same' + #10 + '88');
end.
