// vybe-test: pascal/exceptions_flow/excflow_nested_14
...
end; begin try try try raise Exception.Create('deep14'); except __p(__vs('L314')); end; except __p(__vs('L2')); end; except __p(__vs('L1')); end; __vybeCheck('L314');
end.
