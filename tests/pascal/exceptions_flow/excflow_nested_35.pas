// vybe-test: pascal/exceptions_flow/excflow_nested_35
...
end; begin try try try raise Exception.Create('deep35'); except __p(__vs('L335')); end; except __p(__vs('L2')); end; except __p(__vs('L1')); end; __vybeCheck('L335');
end.
