// vybe-test: pascal/exceptions_flow/excflow_except_finally_4
...
end; begin try try raise Exception.Create('e4'); except __p(__vs('c4')); end; finally __p(__vs('f4')); end; __vybeCheck('c4' + #10 + 'f4');
end.
