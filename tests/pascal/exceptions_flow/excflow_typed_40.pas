// vybe-test: pascal/exceptions_flow/excflow_typed_40
...
end; begin try raise ERangeError.Create('rng40'); except on E:ERangeError do __p(__vs('range40')); on E:Exception do __p(__vs('other')); end; __vybeCheck('range40');
end.
