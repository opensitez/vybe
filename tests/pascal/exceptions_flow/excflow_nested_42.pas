// vybe-test: pascal/exceptions_flow/excflow_nested_42
...
end; begin try try try raise Exception.Create('deep42'); except __p(__vs('L342')); end; except __p(__vs('L2')); end; except __p(__vs('L1')); end; __vybeCheck('L342');
end.
