// vybe-test: pascal/exceptions_flow/excflow_typed_5
...
end; begin try raise ERangeError.Create('rng5'); except on E:ERangeError do __p(__vs('range5')); on E:Exception do __p(__vs('other')); end; __vybeCheck('range5');
end.
