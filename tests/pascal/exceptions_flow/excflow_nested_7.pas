// vybe-test: pascal/exceptions_flow/excflow_nested_7
...
end; begin try try try raise Exception.Create('deep7'); except __p(__vs('L37')); end; except __p(__vs('L2')); end; except __p(__vs('L1')); end; __vybeCheck('L37');
end.
