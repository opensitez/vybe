// vybe-test: pascal/exceptions_flow/excflow_nested_21
...
end; begin try try try raise Exception.Create('deep21'); except __p(__vs('L321')); end; except __p(__vs('L2')); end; except __p(__vs('L1')); end; __vybeCheck('L321');
end.
