// vybe-test: pascal/exceptions_flow/excflow_nested_28
...
end; begin try try try raise Exception.Create('deep28'); except __p(__vs('L328')); end; except __p(__vs('L2')); end; except __p(__vs('L1')); end; __vybeCheck('L328');
end.
