// vybe-test: pascal/exceptions_flow/excflow_except_finally_11
...
end; begin try try raise Exception.Create('e11'); except __p(__vs('c11')); end; finally __p(__vs('f11')); end; __vybeCheck('c11' + #10 + 'f11');
end.
