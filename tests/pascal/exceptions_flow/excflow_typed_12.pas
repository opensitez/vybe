// vybe-test: pascal/exceptions_flow/excflow_typed_12
...
end; begin try raise ERangeError.Create('rng12'); except on E:ERangeError do __p(__vs('range12')); on E:Exception do __p(__vs('other')); end; __vybeCheck('range12');
end.
