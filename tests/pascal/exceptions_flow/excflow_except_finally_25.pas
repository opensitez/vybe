// vybe-test: pascal/exceptions_flow/excflow_except_finally_25
...
end; begin try try raise Exception.Create('e25'); except __p(__vs('c25')); end; finally __p(__vs('f25')); end; __vybeCheck('c25' + #10 + 'f25');
end.
