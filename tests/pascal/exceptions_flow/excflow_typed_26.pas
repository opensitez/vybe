// vybe-test: pascal/exceptions_flow/excflow_typed_26
...
end; begin try raise ERangeError.Create('rng26'); except on E:ERangeError do __p(__vs('range26')); on E:Exception do __p(__vs('other')); end; __vybeCheck('range26');
end.
