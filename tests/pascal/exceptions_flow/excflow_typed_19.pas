// vybe-test: pascal/exceptions_flow/excflow_typed_19
...
end; begin try raise ERangeError.Create('rng19'); except on E:ERangeError do __p(__vs('range19')); on E:Exception do __p(__vs('other')); end; __vybeCheck('range19');
end.
