// vybe-test: pascal/exceptions_flow/excflow_except_finally_32
...
end; begin try try raise Exception.Create('e32'); except __p(__vs('c32')); end; finally __p(__vs('f32')); end; __vybeCheck('c32' + #10 + 'f32');
end.
