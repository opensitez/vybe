// vybe-test: pascal/exceptions_flow/excflow_except_finally_18
...
end; begin try try raise Exception.Create('e18'); except __p(__vs('c18')); end; finally __p(__vs('f18')); end; __vybeCheck('c18' + #10 + 'f18');
end.
