// vybe-test: pascal/exceptions_flow/excflow_except_finally_39
...
end; begin try try raise Exception.Create('e39'); except __p(__vs('c39')); end; finally __p(__vs('f39')); end; __vybeCheck('c39' + #10 + 'f39');
end.
