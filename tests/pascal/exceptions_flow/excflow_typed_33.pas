// vybe-test: pascal/exceptions_flow/excflow_typed_33
// origin: languages/pascal/tests/pascal/test_exceptions_flow.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; begin try raise ERangeError.Create('rng33'); except on E:ERangeError do __p(__vs('range33')); on E:Exception do __p(__vs('other')); end; __vybeCheck('range33');
end.
