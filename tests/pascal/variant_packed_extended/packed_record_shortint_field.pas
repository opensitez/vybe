// vybe-test: pascal/variant_packed_extended/packed_record_shortint_field
...
end; type TP=packed record V:ShortInt; end; var p:TP; begin p.V:=-5; __p(__vs(p.V)); __vybeCheck('-5');
end.
