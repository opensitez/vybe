// vybe-test: pascal/variant_packed_extended/packed_record_in_array
...
end; type TP=packed record V:Byte; end; var a:array[0..1] of TP; begin a[0].V:=5; a[1].V:=6; __p(__vs(a[1].V)); __vybeCheck('6');
end.
