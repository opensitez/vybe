// vybe-test: pascal/variant_packed_extended/variant_record_boolean_arms_real_and_int
...
end; type TN=record case IsReal:Boolean of false:(I:Integer); true:(R:Double); end; var n:TN; begin n.IsReal:=true; n.R:=2.5; __p(__vs(Round(n.R))); __vybeCheck('3');
end.
