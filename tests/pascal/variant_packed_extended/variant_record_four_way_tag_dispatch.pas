// vybe-test: pascal/variant_packed_extended/variant_record_four_way_tag_dispatch
...
end; type TOp=record case C:Integer of 0:(A:Integer); 1:(B:Integer); 2:(C2:Integer); 3:(D:Integer); end; var o:TOp; begin o.C:=3; o.D:=21; __p(__vs(o.D)); __vybeCheck('21');
end.
