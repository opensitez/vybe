// vybe-test: pascal/variant_packed_extended/packed_record_modify_one_field_keeps_other
...
end; type TP=packed record Lo,Hi:Byte; end; var p:TP; begin p.Lo:=1; p.Hi:=2; p.Lo:=9; __p(__vs(p.Hi)); __vybeCheck('2');
end.
