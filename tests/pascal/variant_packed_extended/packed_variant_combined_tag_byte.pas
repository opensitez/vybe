// vybe-test: pascal/variant_packed_extended/packed_variant_combined_tag_byte
...
end; type TH=packed record case Tag:Byte of 0:(A:Byte); 1:(B:Byte); end; var h:TH; begin h.Tag:=1; h.B:=7; __p(__vs(h.B)); __vybeCheck('7');
end.
