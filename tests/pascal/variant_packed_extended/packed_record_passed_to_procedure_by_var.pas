// vybe-test: pascal/variant_packed_extended/packed_record_passed_to_procedure_by_var
...
end; type TP=packed record V:Byte; end; procedure IncP(var p:TP); begin p.V:=p.V+1; end; var p:TP; begin p.V:=4; IncP(p); __p(__vs(p.V)); __vybeCheck('5');
end.
