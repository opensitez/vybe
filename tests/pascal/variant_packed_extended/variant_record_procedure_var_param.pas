// vybe-test: pascal/variant_packed_extended/variant_record_procedure_var_param
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; procedure SetInt(var v:TVal; n:Integer); begin v.K:=0; v.I:=n; end; var v:TVal; begin SetInt(v,5); __p(__vs(v.I)); __vybeCheck('5');
end.
