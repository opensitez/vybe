// vybe-test: pascal/variant_packed_extended/variant_record_fixed_header_plus_variant
...
end; type TMsg=record Id:Integer; case Kind:Integer of 1:(Text:string); 2:(Code:Integer); end; var m:TMsg; begin m.Id:=1; m.Kind:=1; m.Text:='hi'; __p(__vs(m.Text)); __vybeCheck('hi');
end.
