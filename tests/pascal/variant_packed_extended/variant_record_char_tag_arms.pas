// vybe-test: pascal/variant_packed_extended/variant_record_char_tag_arms
...
end; type TT=record case K:Char of 'N':(I:Integer); 'S':(T:string); end; var v:TT; begin v.K:='N'; v.I:=12; __p(__vs(v.I)); __vybeCheck('12');
end.
