// vybe-test: pascal/variant_packed_extended/variant_record_case_statement_on_tag
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TVal; begin v.K:=0; v.I:=6; case v.K of 0:__p(__vs(v.I)); 1:__p(__vs(0)); end; __vybeCheck('6');
end.
