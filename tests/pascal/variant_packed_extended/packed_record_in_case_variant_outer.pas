// vybe-test: pascal/variant_packed_extended/packed_record_in_case_variant_outer
...
end; type TInner=packed record B:Byte; end; type TOuter=record case Tag:Integer of 0:(I:Integer); 1:(Inner:TInner); end; var o:TOuter; begin o.Tag:=1; o.Inner.B:=8; __p(__vs(o.Inner.B)); __vybeCheck('8');
end.
