// vybe-test: pascal/variant_packed_extended/packed_record_array_copy_element
...
end; type TP=packed record V:Byte; end; var a,b:array[0..0] of TP; begin a[0].V:=3; b[0]:=a[0]; __p(__vs(b[0].V)); __vybeCheck('3');
end.
