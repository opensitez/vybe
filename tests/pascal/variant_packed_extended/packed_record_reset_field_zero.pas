// vybe-test: pascal/variant_packed_extended/packed_record_reset_field_zero
...
end; type TP=packed record V:Byte; end; var p:TP; begin p.V:=9; p.V:=0; __p(__vs(p.V)); __vybeCheck('0');
end.
