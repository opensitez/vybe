// vybe-test: pascal/variant_packed_extended/packed_record_case_on_byte_field
...
end; type TH=packed record Ver:Byte; end; var h:TH; begin h.Ver:=3; case h.Ver of 1:__p(__vs('a')); 2:__p(__vs('b')); 3:__p(__vs('c')); else __p(__vs('?')); end; __vybeCheck('c');
end.
