// vybe-test: pascal/variant_packed_extended/variant_record_enum_two_arms
...
end; type TK=(A,B); type TV=record case Kind:TK of A:(N:Integer); B:(T:string); end; var v:TV; begin v.Kind:=B; v.T:='ok'; __p(__vs(v.T)); __vybeCheck('ok');
end.
