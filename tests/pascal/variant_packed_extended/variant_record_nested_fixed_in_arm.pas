// vybe-test: pascal/variant_packed_extended/variant_record_nested_fixed_in_arm
...
end; type TInner=record V:Integer; end; type TWrap=record case K:Integer of 0:(I:Integer); 1:(Inner:TInner); end; var w:TWrap; begin w.K:=1; w.Inner.V:=44; __p(__vs(w.Inner.V)); __vybeCheck('44');
end.
