// vybe-test: pascal/variant_packed_extended/packed_record_word_byte_mixed
...
end; type TP=packed record Lo:Byte; Hi:Byte; end; var p:TP; begin p.Lo:=1; p.Hi:=2; __p(__vs(p.Lo*10+p.Hi)); __vybeCheck('12');
end.
