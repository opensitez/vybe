// vybe-test: pascal/variant_packed_extended/packed_record_three_bytes_sequential
...
end; type TP=packed record A,B,C:Byte; end; var p:TP; begin p.A:=1; p.B:=2; p.C:=3; __p(__vs(p.A+p.B+p.C)); __vybeCheck('6');
end.
