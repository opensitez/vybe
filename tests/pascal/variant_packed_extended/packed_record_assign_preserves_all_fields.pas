// vybe-test: pascal/variant_packed_extended/packed_record_assign_preserves_all_fields
...
end; type TP=packed record X,Y:Byte; end; var a,b:TP; begin a.X:=7; a.Y:=8; b:=a; __p(__vs(b.X)); __p(__vs(b.Y)); __vybeCheck('7' + #10 + '8');
end.
