// vybe-test: pascal/variant_packed_extended/packed_record_char_and_byte_pair
...
end; type TM=packed record Code:Byte; Ch:Char; end; var m:TM; begin m.Code:=65; m.Ch:='A'; __p(__vs(m.Ch)); __vybeCheck('A');
end.
