// vybe-test: pascal/variant_packed_extended/variant_record_three_arms_dispatch
// origin: languages/pascal/tests/pascal/test_variant_packed_extended.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TOp=record case C:Integer of 0:(A:Integer); 1:(B:Integer); 2:(Cval:Integer); end; procedure Show(const o:TOp); begin case o.C of 0:__p(__vs(o.A)); 1:__p(__vs(o.B)); 2:__p(__vs(o.Cval)); end; end; var x:TOp; begin x.C:=2; x.Cval:=99; Show(x); __vybeCheck('99');
end.
