// vybe-test: pascal/variant_packed_extended/variant_record_multiple_labels_one_arm
...
end; type TV=record case K:Integer of 0,1:(X:Integer); 2:(Y:Integer); end; var v:TV; begin v.K:=1; v.X:=55; __p(__vs(v.X)); __vybeCheck('55');
end.
