// vybe-test: pascal/variant_packed_extended/packed_record_boolean_and_byte
...
end; type TF=packed record Flag:Boolean; Code:Byte; end; var f:TF; begin f.Flag:=true; f.Code:=42; if f.Flag then __p(__vs(f.Code)); __vybeCheck('42');
end.
