// vybe-test: pascal/variant_packed_extended/packed_record_used_in_function_result
...
end; type TP=packed record V:Byte; end; function Make(v:Byte):TP; begin Result.V:=v; end; var p:TP; begin p:=Make(11); __p(__vs(p.V)); __vybeCheck('11');
end.
