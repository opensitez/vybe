// vybe-test: pascal/variant_packed_extended/variant_record_tag_switch_changes_active_field
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TVal; begin v.K:=0; v.I:=10; v.K:=1; v.S:='x'; __p(__vs(v.S)); __vybeCheck('x');
end.
