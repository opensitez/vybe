// vybe-test: pascal/variant_packed_extended/packed_record_loop_accumulate
...
end; type TP=packed record V:Byte; end; var a:array[0..2] of TP; i,s:Integer; begin for i:=0 to 2 do begin a[i].V:=i+1; s:=0; end; for i:=0 to 2 do s:=s+a[i].V; __p(__vs(s)); __vybeCheck('6');
end.
