// vybe-test: pascal/variant_packed_extended/variant_record_two_fixed_before_case
...
end; type TMsg=record Ver,Id:Integer; case Kind:Integer of 1:(Text:string); 2:(Code:Integer); end; var m:TMsg; begin m.Ver:=1; m.Id:=9; m.Kind:=2; m.Code:=500; __p(__vs(m.Code)); __vybeCheck('500');
end.
