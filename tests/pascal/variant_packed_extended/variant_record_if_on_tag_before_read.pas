// vybe-test: pascal/variant_packed_extended/variant_record_if_on_tag_before_read
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TVal; begin v.K:=0; v.I:=8; if v.K=0 then __p(__vs(v.I)) else __p(__vs(0)); __vybeCheck('8');
end.
