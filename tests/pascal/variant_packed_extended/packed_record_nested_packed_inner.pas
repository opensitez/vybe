// vybe-test: pascal/variant_packed_extended/packed_record_nested_packed_inner
...
end; type TInner=packed record B:Byte; end; type TOuter=packed record Inner:TInner; end; var o:TOuter; begin o.Inner.B:=9; __p(__vs(o.Inner.B)); __vybeCheck('9');
end.
