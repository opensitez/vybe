// vybe-test: pascal/variant_packed_extended/packed_record_four_bytes_sum
...
end; type TP=packed record A,B,C,D:Byte; end; var p:TP; begin p.A:=1; p.B:=2; p.C:=3; p.D:=4; __p(__vs(p.A+p.B+p.C+p.D)); __vybeCheck('10');
end.
