// vybe-test: pascal/variant_packed_extended/variant_record_string_arm_length
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TVal; begin v.K:=1; v.S:='abcd'; __p(__vs(Length(v.S))); __vybeCheck('4');
end.
