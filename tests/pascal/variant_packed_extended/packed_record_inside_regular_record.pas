// vybe-test: pascal/variant_packed_extended/packed_record_inside_regular_record
...
end; type TInner=packed record B:Byte; end; type TOuter=record Tag:Integer; Inner:TInner; end; var o:TOuter; begin o.Tag:=1; o.Inner.B:=6; __p(__vs(o.Inner.B)); __vybeCheck('6');
end.
