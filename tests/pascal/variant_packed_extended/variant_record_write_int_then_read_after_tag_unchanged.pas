// vybe-test: pascal/variant_packed_extended/variant_record_write_int_then_read_after_tag_unchanged
...
end; type TVal=record case K:Integer of 1:(A:Integer); 2:(B:Integer); end; var v:TVal; begin v.K:=1; v.A:=77; __p(__vs(v.K)); __vybeCheck('1');
end.
