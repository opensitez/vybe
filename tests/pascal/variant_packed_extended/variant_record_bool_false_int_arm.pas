// vybe-test: pascal/variant_packed_extended/variant_record_bool_false_int_arm
...
end; type TVal=record case B:Boolean of false:(N:Integer); true:(S:string); end; var v:TVal; begin v.B:=false; v.N:=123; __p(__vs(v.N)); __vybeCheck('123');
end.
