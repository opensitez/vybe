// vybe-test: pascal/variant_packed_extended/variant_record_tag_2_byte_fields_sum
...
end; type TPair=record case K:Integer of 0:(A,B:Byte); 1:(V:Integer); end; var p:TPair; begin p.K:=0; p.A:=2; p.B:=3; __p(__vs(p.A+p.B)); __vybeCheck('5');
end.
