// vybe-test: pascal/variant_packed_extended/variant_record_overlapping_bytes_and_word
...
end; type TW=record case T:Integer of 0:(Lo,Hi:Byte); 1:(W:Integer); end; var w:TW; begin w.T:=1; w.W:=258; __p(__vs(w.W)); __vybeCheck('258');
end.
