// vybe-test: pascal/data_records_extra/record_with_method_5
...
end; type TPair=record A,B:Integer; function Sum:Integer; end; function TPair.Sum:Integer; begin Result:=A+B; end; var p:TPair; begin p.A:=5; p.B:=6; __p(__vs(p.Sum)); __vybeCheck('11');
end.
