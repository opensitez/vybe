// vybe-test: pascal/data_records_extra/record_with_method_7
...
end; type TPair=record A,B:Integer; function Sum:Integer; end; function TPair.Sum:Integer; begin Result:=A+B; end; var p:TPair; begin p.A:=7; p.B:=8; __p(__vs(p.Sum)); __vybeCheck('15');
end.
