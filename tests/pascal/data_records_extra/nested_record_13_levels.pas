// vybe-test: pascal/data_records_extra/nested_record_13_levels
...
end; type T1=record V:Integer; end; type T2=record Inner:T1; end; type T3=record Mid:T2; end; var o:T3; begin o.Mid.Inner.V:=13; __p(__vs(o.Mid.Inner.V)); __vybeCheck('13');
end.
