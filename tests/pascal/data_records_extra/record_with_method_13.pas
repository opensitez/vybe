// vybe-test: pascal/data_records_extra/record_with_method_13
// origin: languages/pascal/tests/pascal/test_data_records_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TPair=record A,B:Integer; function Sum:Integer; end; function TPair.Sum:Integer; begin Result:=A+B; end; var p:TPair; begin p.A:=13; p.B:=14; __p(__vs(p.Sum)); __vybeCheck('27');
end.
