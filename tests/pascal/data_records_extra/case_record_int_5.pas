// vybe-test: pascal/data_records_extra/case_record_int_5
...
end; type TVal=record case K:Integer of 0:(I:Integer); 1:(S:string); end; var v:TVal; begin v.K:=0; v.I:=10; __p(__vs(v.I)); __vybeCheck('10');
end.
