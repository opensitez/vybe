// vybe-test: pascal/pascal_shortstring_pascal_length/test_shortstring_array_elements
// origin: languages/pascal/tests/pascal/test_pascal_shortstring_pascal_length.rs
program Test;
{$mode delphi}
uses SysUtils;
...
begin
  ...
  __p(__vs(list[1] + ' & ' + list[2]));
__vybeCheck('ItemOne & ItemTwo');
end.
