// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_interface_queryinterface
...
procedure TMultiImpl.SecondProc; begin __p(__vs('SecondSupported')); end;

var m: IFirst;
begin
  m := TMultiImpl.Create;
  TIntfQuery<IFirst>.CheckSecond(m);
__vybeCheck('SecondSupported');
end.
