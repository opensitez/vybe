// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_constructor_with_param
...
constructor TDerivedItem.Create; begin __p(__vs('DerivedCreated')); end;
