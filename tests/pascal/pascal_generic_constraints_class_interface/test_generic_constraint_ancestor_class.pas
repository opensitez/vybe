// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_ancestor_class
...
procedure TBaseObj.Announce; begin __p(__vs('Base')); end;

type TSubObj = class(TBaseObj)
  public procedure Announce; override;
end;
procedure TSubObj.Announce; begin __p(__vs('Sub')); end;
