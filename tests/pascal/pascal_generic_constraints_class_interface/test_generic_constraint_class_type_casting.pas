// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_class_type_casting
...
procedure TChild.SubMethod; begin __p(__vs('ChildMethod')); end;
