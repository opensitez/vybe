// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_class_method_generic_parameters
...
begin
  __p(__vs(TGenericUtils.CreateAndUse<TTestObj>));
__vybeCheck('TTestObj');
end.
