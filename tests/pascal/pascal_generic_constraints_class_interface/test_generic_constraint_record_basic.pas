// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_record_basic
...
begin
  ...
  __p(__vs(holder.Item.X.ToString + ',' + holder.Item.Y.ToString));
  holder.Free;
__vybeCheck('10,20');
end.
