// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_interface_basic
...
procedure TWorkImpl.DoWork; begin __p(__vs('WorkDoneViaConstrainedGeneric')); end;

var w: IWork;
begin
  w := TWorkImpl.Create;
  TWorkInvoker<IWork>.Run(w);
__vybeCheck('WorkDoneViaConstrainedGeneric');
end.
