// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_multiple_class_interface
...
procedure TLoggableObj.Log; begin __p(__vs('ObjLogged')); end;

var l: TLoggableObj;
begin
  l := TLoggableObj.Create;
  TLoggerContainer<TLoggableObj>.Process(l);
__vybeCheck('ObjLogged');
end.
