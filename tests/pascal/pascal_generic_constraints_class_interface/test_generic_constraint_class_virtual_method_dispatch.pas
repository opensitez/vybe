// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_class_virtual_method_dispatch
...
begin
  ...
  __p(__vs(TAreaCalc<TRectangle>.Compute(rect)));
  rect.Free;
__vybeCheck('20');
end.
