// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_interface_delegation
...
procedure TRunnerImpl.Run; begin __p(__vs('DelegatedRunnerExecuted')); end;
...
begin
  ...
  delegateObj.Execute;
  delegateObj.Free;
__vybeCheck('DelegatedRunnerExecuted');
end.
