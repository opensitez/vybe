// vybe-test: pascal/pascal_generic_constraints_class_interface/test_generic_constraint_constructor
...
constructor TWidget.Create; begin __p(__vs('WidgetCreated')); end;

var w: TWidget;
begin
  w := TFactory<TWidget>.CreateInstance;
  w.Free;
__vybeCheck('WidgetCreated');
end.
