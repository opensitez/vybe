// vybe-test: pascal/generics_collections/gcoll_linked_node_21
...
end; type TNode<T>=class public Value:T; Next:TNode<T>; constructor Create(v:T); end; constructor TNode<T>.Create(v:T); begin Value:=v; Next:=nil; end; var a,b:TNode<Integer>; begin a:=TNode<Integer>.Create(21); b:=TNode<Integer>.Create(42); a.Next:=b; __p(__vs(a.Value)); __p(__vs(a.Next.Value)); a.Free; b.Free; __vybeCheck('21' + #10 + '42');
end.
