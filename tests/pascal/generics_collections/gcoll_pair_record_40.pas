// vybe-test: pascal/generics_collections/gcoll_pair_record_40
...
end; type TPair<T,U>=record A:T; B:U; end; var p:TPair<Integer,string>; begin p.A:=40; p.B:='v40'; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('40' + #10 + 'v40');
end.
