// vybe-test: pascal/generics_collections/gcoll_pair_record_19
...
end; type TPair<T,U>=record A:T; B:U; end; var p:TPair<Integer,string>; begin p.A:=19; p.B:='v19'; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('19' + #10 + 'v19');
end.
