// vybe-test: pascal/generics_collections/gcoll_pair_record_5
...
end; type TPair<T,U>=record A:T; B:U; end; var p:TPair<Integer,string>; begin p.A:=5; p.B:='v5'; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('5' + #10 + 'v5');
end.
