// vybe-test: pascal/generics_collections/gcoll_linked_node_14
// origin: languages/pascal/tests/pascal/test_generics_collections.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; type TNode<T>=class public Value:T; Next:TNode<T>; constructor Create(v:T); end; constructor TNode<T>.Create(v:T); begin Value:=v; Next:=nil; end; var a,b:TNode<Integer>; begin a:=TNode<Integer>.Create(14); b:=TNode<Integer>.Create(28); a.Next:=b; __p(__vs(a.Value)); __p(__vs(a.Next.Value)); a.Free; b.Free; __vybeCheck('14' + #10 + '28');
end.
