// vybe-test: pascal/generics_collections/gcoll_pair_record_12
...
end; type TPair<T,U>=record A:T; B:U; end; var p:TPair<Integer,string>; begin p.A:=12; p.B:='v12'; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('12' + #10 + 'v12');
end.
