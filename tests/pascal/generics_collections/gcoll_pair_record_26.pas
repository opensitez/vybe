// vybe-test: pascal/generics_collections/gcoll_pair_record_26
...
end; type TPair<T,U>=record A:T; B:U; end; var p:TPair<Integer,string>; begin p.A:=26; p.B:='v26'; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('26' + #10 + 'v26');
end.
