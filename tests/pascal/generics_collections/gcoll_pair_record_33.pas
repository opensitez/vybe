// vybe-test: pascal/generics_collections/gcoll_pair_record_33
...
end; type TPair<T,U>=record A:T; B:U; end; var p:TPair<Integer,string>; begin p.A:=33; p.B:='v33'; __p(__vs(p.A)); __p(__vs(p.B)); __vybeCheck('33' + #10 + 'v33');
end.
