// vybe-test: pascal/date_time_extended/inc_hour_advances_clock
...
end; var t:TDateTime; begin t:=EncodeTime(10,0,0,0); t:=IncHour(t,2); __p(__vs(HourOf(t))); __vybeCheck('12');
end.
