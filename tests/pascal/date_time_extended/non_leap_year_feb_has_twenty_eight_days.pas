// vybe-test: pascal/date_time_extended/non_leap_year_feb_has_twenty_eight_days
...
end; var a,b:TDateTime; begin a:=EncodeDate(1900,2,1); b:=IncMonth(a,1); __p(__vs(DaysBetween(b,a))); __vybeCheck('28');
end.
