// vybe-test: pascal/date_time_extended/days_between_two_dates
...
end; var a,b:TDateTime; begin a:=EncodeDate(2000,1,1); b:=EncodeDate(2000,1,11); __p(__vs(Trunc(b-a))); __vybeCheck('10');
end.
