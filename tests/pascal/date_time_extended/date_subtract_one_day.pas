// vybe-test: pascal/date_time_extended/date_subtract_one_day
...
end; var d:TDateTime; begin d:=EncodeDate(2000,1,2); d:=d-1; __p(__vs(FormatDateTime('yyyy-mm-dd', d))); __vybeCheck('2000-01-01');
end.
