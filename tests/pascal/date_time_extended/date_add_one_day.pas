// vybe-test: pascal/date_time_extended/date_add_one_day
...
end; var d:TDateTime; begin d:=EncodeDate(2000,1,1); d:=d+1; __p(__vs(FormatDateTime('yyyy-mm-dd', d))); __vybeCheck('2000-01-02');
end.
