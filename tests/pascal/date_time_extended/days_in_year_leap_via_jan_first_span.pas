// vybe-test: pascal/date_time_extended/days_in_year_leap_via_jan_first_span
...
end; var a,b:TDateTime; begin a:=EncodeDate(2000,1,1); b:=EncodeDate(2001,1,1); __p(__vs(DaysBetween(b,a))); __vybeCheck('366');
end.
