// vybe-test: pascal/date_time_extended/encode_date_jan_first_2000
...
end; var d:TDateTime; begin d:=EncodeDate(2000,1,1); __p(__vs(FormatDateTime('yyyy-mm-dd', d))); __vybeCheck('2000-01-01');
end.
