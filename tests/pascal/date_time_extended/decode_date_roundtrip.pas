// vybe-test: pascal/date_time_extended/decode_date_roundtrip
...
end; var d:TDateTime; y,m,day:Word; begin d:=EncodeDate(2012,7,4); DecodeDate(d,y,m,day); __p(__vs(y)); __p(__vs(m)); __p(__vs(day)); __vybeCheck('2012' + #10 + '7' + #10 + '4');
end.
