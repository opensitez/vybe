// vybe-test: pascal/date_time_extended/first_of_month_via_encode_date
...
end; var d,s:TDateTime; begin d:=EncodeDate(2015,6,15); s:=EncodeDate(YearOf(d),MonthOf(d),1); __p(__vs(DayOf(s))); __vybeCheck('1');
end.
