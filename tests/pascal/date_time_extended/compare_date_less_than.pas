// vybe-test: pascal/date_time_extended/compare_date_less_than
...
end; var a,b:TDateTime; begin a:=EncodeDate(1999,12,31); b:=EncodeDate(2000,1,1); __p(__vs(CompareDate(a,b))); __vybeCheck('-1');
end.
