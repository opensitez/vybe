// vybe-test: pascal/date_time_extended/compare_date_equal
...
end; var a,b:TDateTime; begin a:=EncodeDate(2010,5,5); b:=EncodeDate(2010,5,5); __p(__vs(CompareDate(a,b))); __vybeCheck('0');
end.
