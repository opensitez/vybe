// vybe-test: pascal/date_time_extended/encode_time_midnight
...
end; var t:TDateTime; begin t:=EncodeTime(0,0,0,0); __p(__vs(FormatDateTime('hh:nn:ss', t))); __vybeCheck('00:00:00');
end.
