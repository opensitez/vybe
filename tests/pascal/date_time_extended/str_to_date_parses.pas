// vybe-test: pascal/date_time_extended/str_to_date_parses
...
end; var d:TDateTime; begin d:=StrToDate('3/15/2010'); __p(__vs(YearOf(d))); __p(__vs(MonthOf(d))); __p(__vs(DayOf(d))); __vybeCheck('2010' + #10 + '3' + #10 + '15');
end.
