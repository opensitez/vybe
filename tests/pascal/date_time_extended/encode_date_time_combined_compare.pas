// vybe-test: pascal/date_time_extended/encode_date_time_combined_compare
...
end; var d,t,dt:TDateTime; begin d:=EncodeDate(2000,1,1); t:=EncodeTime(1,2,3,0); dt:=d+t; __p(__vs(FormatDateTime('yyyy-mm-dd', dt))); __p(__vs(FormatDateTime('hh:nn:ss', dt))); __vybeCheck('2000-01-01' + #10 + '01:02:03');
end.
