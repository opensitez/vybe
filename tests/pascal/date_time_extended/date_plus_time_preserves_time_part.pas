// vybe-test: pascal/date_time_extended/date_plus_time_preserves_time_part
...
end; var d,t,dt:TDateTime; begin d:=EncodeDate(2010,1,2); t:=EncodeTime(15,30,45,0); dt:=d+t; __p(__vs(HourOf(dt))); __p(__vs(MinuteOf(dt))); __p(__vs(SecondOf(dt))); __vybeCheck('15' + #10 + '30' + #10 + '45');
end.
