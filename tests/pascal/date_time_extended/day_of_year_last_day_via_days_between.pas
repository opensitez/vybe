// vybe-test: pascal/date_time_extended/day_of_year_last_day_via_days_between
...
end; var start,last:TDateTime; begin start:=EncodeDate(2000,1,1); last:=EncodeDate(2000,12,31); __p(__vs(DaysBetween(last,start)+1)); __vybeCheck('366');
end.
