// vybe-test: pascal/date_time_extended/minutes_between_two_times
...
end; var a,b:TDateTime; begin a:=EncodeTime(10,0,0,0); b:=EncodeTime(10,45,0,0); __p(__vs(Trunc(MinutesBetween(b,a)))); __vybeCheck('45');
end.
