// vybe-test: pascal/date_time_extended/date_plus_time_preserves_date_part
...
end; var d,t,dt:TDateTime; begin d:=EncodeDate(2010,1,2); t:=EncodeTime(15,0,0,0); dt:=d+t; __p(__vs(YearOf(dt))); __p(__vs(MonthOf(dt))); __p(__vs(DayOf(dt))); __vybeCheck('2010' + #10 + '1' + #10 + '2');
end.
