// vybe-test: pascal/date_time_extended/inc_minute_advances_clock
...
end; var t:TDateTime; begin t:=EncodeTime(10,15,0,0); t:=IncMinute(t,30); __p(__vs(MinuteOf(t))); __vybeCheck('45');
end.
