// vybe-test: pascal/date_time_extended/days_in_february_leap_via_month_span
...
end; var a,b:TDateTime; begin a:=EncodeDate(2000,2,1); b:=IncMonth(a,1); __p(__vs(DaysBetween(b,a))); __vybeCheck('29');
end.
