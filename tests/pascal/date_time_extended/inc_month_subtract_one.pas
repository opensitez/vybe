// vybe-test: pascal/date_time_extended/inc_month_subtract_one
...
end; var d:TDateTime; begin d:=EncodeDate(2000,3,15); d:=IncMonth(d,-1); __p(__vs(FormatDateTime('yyyy-mm', d))); __vybeCheck('2000-02');
end.
