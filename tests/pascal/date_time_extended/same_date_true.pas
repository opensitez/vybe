// vybe-test: pascal/date_time_extended/same_date_true
...
end; var a,b:TDateTime; begin a:=EncodeDate(2001,6,15); b:=EncodeDate(2001,6,15); __p(__vs(SameDate(a,b))); __vybeCheck('true');
end.
