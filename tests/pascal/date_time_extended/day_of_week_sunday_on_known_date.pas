// vybe-test: pascal/date_time_extended/day_of_week_sunday_on_known_date
...
end; var d:TDateTime; begin d:=EncodeDate(2000,1,2); __p(__vs(DayOfWeek(d))); __vybeCheck('7');
end.
