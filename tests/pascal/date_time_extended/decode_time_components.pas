// vybe-test: pascal/date_time_extended/decode_time_components
...
end; var t:TDateTime; h,m,s,ms:Word; begin t:=EncodeTime(15,45,30,0); DecodeTime(t,h,m,s,ms); __p(__vs(h)); __p(__vs(m)); __p(__vs(s)); __vybeCheck('15' + #10 + '45' + #10 + '30');
end.
