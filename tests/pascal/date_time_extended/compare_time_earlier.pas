// vybe-test: pascal/date_time_extended/compare_time_earlier
...
end; var a,b:TDateTime; begin a:=EncodeTime(8,0,0,0); b:=EncodeTime(9,0,0,0); __p(__vs(CompareTime(a,b))); __vybeCheck('-1');
end.
