// vybe-test: pascal/date_time_extended/encode_decode_year_boundary
...
end; var d:TDateTime; y,m,day:Word; begin d:=EncodeDate(1999,12,31); d:=d+1; DecodeDate(d,y,m,day); __p(__vs(y)); __p(__vs(m)); __p(__vs(day)); __vybeCheck('2000' + #10 + '1' + #10 + '1');
end.
