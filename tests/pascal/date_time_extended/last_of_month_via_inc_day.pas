// vybe-test: pascal/date_time_extended/last_of_month_via_inc_day
...
end; var d,e:TDateTime; begin d:=EncodeDate(2020,2,1); e:=IncDay(IncMonth(d,1),-1); __p(__vs(DayOf(e))); __vybeCheck('29');
end.
