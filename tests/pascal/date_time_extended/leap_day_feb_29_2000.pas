// vybe-test: pascal/date_time_extended/leap_day_feb_29_2000
...
end; var d:TDateTime; begin d:=EncodeDate(2000,2,29); __p(__vs(FormatDateTime('yyyy-mm-dd', d))); __vybeCheck('2000-02-29');
end.
