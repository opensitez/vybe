// vybe-test: pascal/pascal_sysutils_strutils_functions/test_containstext_case_insensitive
...
uses StrUtils;
begin
  __p(__vs(ContainsText('Hello World', 'WORLD')));
  __p(__vs(ContainsText('Hello World', 'PASCAL')));
