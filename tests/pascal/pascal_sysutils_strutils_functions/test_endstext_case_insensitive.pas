// vybe-test: pascal/pascal_sysutils_strutils_functions/test_endstext_case_insensitive
...
uses StrUtils;
begin
  __p(__vs(EndsText('.TXT', 'document.txt')));
  __p(__vs(EndsText('.PNG', 'document.txt')));
