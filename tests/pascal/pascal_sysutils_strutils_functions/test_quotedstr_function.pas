// vybe-test: pascal/pascal_sysutils_strutils_functions/test_quotedstr_function
...
uses SysUtils;
begin
  __p(__vs(QuotedStr('Pascal')));
  __p(__vs(QuotedStr('It''s OK')));
__vybeCheck('''Pascal''' + #10 + '''It''''s OK''');
end.
