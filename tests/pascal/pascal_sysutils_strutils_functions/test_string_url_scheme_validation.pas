// vybe-test: pascal/pascal_sysutils_strutils_functions/test_string_url_scheme_validation
...
begin
  __p(__vs(IsSecureUrl('HTTPS://EXAMPLE.COM')));
  __p(__vs(IsSecureUrl('http://example.com')));
