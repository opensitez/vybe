// vybe-test: pascal/pascal_sysutils_strutils_functions/test_file_extension_check_with_endstext
// origin: languages/pascal/tests/pascal/test_pascal_sysutils_strutils_functions.rs
program Test;
{$mode delphi}
...
begin
  __p(__vs(IsPascalFile('main.PAS')));
  __p(__vs(IsPascalFile('test.pp')));
  __p(__vs(IsPascalFile('doc.txt')));
__vybeCheck('True' + #10 + 'True' + #10 + 'False');
end.
