// vybe-test: pascal/pascal_sysutils_strutils_functions/test_npos_nth_occurrence
...
uses StrUtils;
begin
  __p(__vs(NPos('a', 'banana', 1)));
  __p(__vs(NPos('a', 'banana', 2)));
  __p(__vs(NPos('a', 'banana', 3)));
__vybeCheck('2' + #10 + '4' + #10 + '6');
end.
