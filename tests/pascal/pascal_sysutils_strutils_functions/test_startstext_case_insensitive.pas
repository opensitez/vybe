// vybe-test: pascal/pascal_sysutils_strutils_functions/test_startstext_case_insensitive
...
uses StrUtils;
begin
  __p(__vs(StartsText('http', 'HTTP://LOCALHOST')));
  __p(__vs(StartsText('ftp', 'HTTP://LOCALHOST')));
