// vybe-test: pascal/strings_advanced/pos_drives_copy_slice
// origin: languages/pascal/tests/pascal/test_strings_advanced.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; var s,p:Integer; t:string; begin s:='name=value'; p:=Pos('=', s); t:=Copy(s, p+1, Length(s)); __p(__vs(t)); __vybeCheck('value');
end.
