// vybe-test: pascal/procedural_types/procedural_type_procedure_with_string_arg
...
end; procedure Echo(p: procedure(s: String)); begin p('hi'); end; begin Echo(procedure(s: String) begin __p(__vs(s)); end); __vybeCheck('hi');
end.
