// vybe-test: pascal/procedural_types/procedural_type_procedure_closure_counter
...
end; var n: Integer; tick: procedure; begin n:=0; tick:=procedure begin n:=n+1; end; tick; tick; __p(__vs(n)); __vybeCheck('2');
end.
