// vybe-test: pascal/procedural_types/procedural_type_nested_call_chain
...
end; function Inc1: function(x: Integer): Integer; begin Result:=function(x: Integer): Integer begin Result:=x+1; end; end; var f: function(x: Integer): Integer; begin f:=Inc1; __p(__vs(f(f(0)))); __vybeCheck('2');
end.
