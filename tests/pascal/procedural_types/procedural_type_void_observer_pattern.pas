// vybe-test: pascal/procedural_types/procedural_type_void_observer_pattern
...
end; var obs: procedure; procedure Notify; begin if Assigned(obs) then obs; end; begin obs:=procedure begin __p(__vs('ping')); end; Notify; __vybeCheck('ping');
end.
