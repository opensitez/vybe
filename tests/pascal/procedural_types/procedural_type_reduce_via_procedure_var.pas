// vybe-test: pascal/procedural_types/procedural_type_reduce_via_procedure_var
...
end; procedure Fold(var acc: Integer; add: procedure(var a: Integer; v: Integer); v: Integer); begin add(acc,v); end; var total: Integer; begin total:=0; Fold(total, procedure(var a: Integer; v: Integer) begin a:=a+v; end, 5); Fold(total, procedure(var a: Integer; v: Integer) begin a:=a+v; end, 7); __p(__vs(total)); __vybeCheck('12');
end.
