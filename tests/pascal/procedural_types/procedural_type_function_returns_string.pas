// vybe-test: pascal/procedural_types/procedural_type_function_returns_string
...
end; var f: function(n: Integer): String; begin f:=function(n: Integer): String begin Result:=IntToStr(n)+'!'; end; __p(__vs(f(7))); __vybeCheck('7!');
end.
