// vybe-test: pascal/procedural_types/procedural_type_reference_parameter_in_callback
...
end; procedure Mutate(var n: Integer; step: procedure(var x: Integer)); begin step(n); end; var v: Integer; begin v:=5; Mutate(v, procedure(var x: Integer) begin x:=x*3; end); __p(__vs(v)); __vybeCheck('15');
end.
