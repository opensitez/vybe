// vybe-test: pascal/procedural_types/procedural_type_reassign_changes_behavior
...
end; var f: function(x: Integer): Integer; begin f:=function(x: Integer): Integer begin Result:=x; end; __p(__vs(f(1))); f:=function(x: Integer): Integer begin Result:=x*10; end; __p(__vs(f(1))); __vybeCheck('1' + #10 + '10');
end.
