// vybe-test: pascal/procedural_types/procedural_type_procedure_variable_invoked
...
end; var p: procedure; begin p:=procedure begin __p(__vs('run')); end; p; __vybeCheck('run');
end.
