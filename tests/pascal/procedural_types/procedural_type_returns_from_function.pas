// vybe-test: pascal/procedural_types/procedural_type_returns_from_function
...
end; function MakeAdder(k: Integer): function(x: Integer): Integer; begin Result:=function(x: Integer): Integer begin Result:=x+k; end; end; var f: function(x: Integer): Integer; begin f:=MakeAdder(10); __p(__vs(f(5))); __vybeCheck('15');
end.
