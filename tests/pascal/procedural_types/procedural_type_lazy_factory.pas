// vybe-test: pascal/procedural_types/procedural_type_lazy_factory
...
end; function Lazy: function(): Integer; begin Result:=function(): Integer begin Result:=99; end; end; var g: function(): Integer; begin g:=Lazy; __p(__vs(g())); __vybeCheck('99');
end.
