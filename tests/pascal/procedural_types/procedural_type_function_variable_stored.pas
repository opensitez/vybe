// vybe-test: pascal/procedural_types/procedural_type_function_variable_stored
...
end; var f: function(x: Integer): Integer; begin f:=function(x: Integer): Integer begin Result:=x+1; end; __p(__vs(f(4))); __vybeCheck('5');
end.
