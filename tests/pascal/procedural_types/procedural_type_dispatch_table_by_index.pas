// vybe-test: pascal/procedural_types/procedural_type_dispatch_table_by_index
...
end; var table: array[0..1] of function(x: Integer): Integer; begin table[0]:=function(x: Integer): Integer begin Result:=x; end; table[1]:=function(x: Integer): Integer begin Result:=x+10; end; __p(__vs(table[1](5))); __vybeCheck('15');
end.
