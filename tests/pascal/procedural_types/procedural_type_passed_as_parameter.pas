// vybe-test: pascal/procedural_types/procedural_type_passed_as_parameter
...
end; procedure Twice(f: function(x: Integer): Integer; n: Integer); begin __p(__vs(f(n))); __p(__vs(f(n))); end; begin Twice(function(x: Integer): Integer begin Result:=x*2; end, 3); __vybeCheck('6' + #10 + '6');
end.
