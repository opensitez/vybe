// vybe-test: pascal/procedural_types/procedural_type_capture_outer_local_in_anonymous
...
end; var base: Integer; f: function(x: Integer): Integer; begin base:=100; f:=function(x: Integer): Integer begin Result:=base+x; end; __p(__vs(f(5))); __vybeCheck('105');
end.
