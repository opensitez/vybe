// vybe-test: pascal/procedural_types/procedural_type_nested_anonymous_in_loop
...
end; var i: Integer; f: function(): Integer; s: Integer; begin s:=0; for i:=1 to 3 do begin f:=function(): Integer begin Result:=i; end; s:=s+f; end; __p(__vs(s)); __vybeCheck('6');
end.
