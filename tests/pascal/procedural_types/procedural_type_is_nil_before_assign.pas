// vybe-test: pascal/procedural_types/procedural_type_is_nil_before_assign
...
end; var p: procedure; begin if not Assigned(p) then __p(__vs('unset')); p:=procedure begin __p(__vs('set')); end; p; __vybeCheck('unset' + #10 + 'set');
end.
