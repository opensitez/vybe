// vybe-test: pascal/procedural_types/procedural_type_boolean_predicate
...
end; var ok: function(n: Integer): Boolean; begin ok:=function(n: Integer): Boolean begin Result:=n mod 2=0; end; if ok(8) then __p(__vs('even')); __vybeCheck('even');
end.
