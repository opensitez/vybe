// vybe-test: pascal/procedural_types/procedural_type_event_handler_two_listeners
...
end; var h1,h2: procedure; procedure Fire; begin h1; h2; end; begin h1:=procedure begin __p(__vs('one')); end; h2:=procedure begin __p(__vs('two')); end; Fire; __vybeCheck('one' + #10 + 'two');
end.
