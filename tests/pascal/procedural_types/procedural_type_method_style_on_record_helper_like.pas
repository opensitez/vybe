// vybe-test: pascal/procedural_types/procedural_type_method_style_on_record_helper_like
...
end; type TFn=function(x: Integer): Integer; function DoubleFn: TFn; begin Result:=function(x: Integer): Integer begin Result:=x*2; end; end; var f: TFn; begin f:=DoubleFn; __p(__vs(f(6))); __vybeCheck('12');
end.
