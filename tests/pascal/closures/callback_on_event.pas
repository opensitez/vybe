// vybe-test: pascal/closures/callback_on_event
// origin: languages/pascal/tests/pascal/test_closures.rs
program T;
{$mode delphi}
uses SysUtils;
...
begin
  btn := TButton.Create;
  btn.FOnClick := procedure(sender: String) begin __p(__vs(sender + ' clicked')); end;
  btn.Click;
__vybeCheck('Button1 clicked');
end.
