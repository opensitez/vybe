// vybe-test: pascal/functions_advanced/result_initialized_then_conditionally_overwritten
...
begin __p(__vs(Classify(6))); __p(__vs(Classify(5))); __vybeCheck('even' + #10 + 'odd');
end.
