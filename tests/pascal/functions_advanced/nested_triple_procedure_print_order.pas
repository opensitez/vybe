// vybe-test: pascal/functions_advanced/nested_triple_procedure_print_order
...
procedure L1;
  procedure L2;
    procedure L3;
    begin __p(__vs(3)); end;
  begin __p(__vs(2)); L3; end;
begin __p(__vs(1)); L2; end;
begin L1; __vybeCheck('1' + #10 + '2' + #10 + '3');
end.
