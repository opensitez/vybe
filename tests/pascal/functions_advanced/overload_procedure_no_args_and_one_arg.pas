// vybe-test: pascal/functions_advanced/overload_procedure_no_args_and_one_arg
...
procedure Ping; begin __p(__vs('ping')); end;
procedure Ping(n: Integer); begin __p(__vs(n)); end;
begin
  Ping;
  Ping(7);
__vybeCheck('ping' + #10 + '7');
end.
