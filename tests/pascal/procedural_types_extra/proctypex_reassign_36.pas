// vybe-test: pascal/procedural_types_extra/proctypex_reassign_36
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x; end; __p(__vs(f(36))); f:=function(x:Integer):Integer begin Result:=x+10; end; __p(__vs(f(36))); __vybeCheck('36' + #10 + '46');
end.
