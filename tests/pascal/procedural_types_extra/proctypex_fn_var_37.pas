// vybe-test: pascal/procedural_types_extra/proctypex_fn_var_37
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x+37; end; __p(__vs(f(1))); __vybeCheck('38');
end.
