// vybe-test: pascal/procedural_types_extra/proctypex_factory_22
// origin: languages/pascal/tests/pascal/test_procedural_types_extra.rs
program T;
{$mode delphi}
uses SysUtils;
...
end; function Make(k:Integer):function(x:Integer):Integer; begin Result:=function(x:Integer):Integer begin Result:=x+k; end; end; var f:function(x:Integer):Integer; begin f:=Make(22); __p(__vs(f(0))); __vybeCheck('22');
end.
