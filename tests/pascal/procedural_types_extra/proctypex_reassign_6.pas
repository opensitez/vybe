// vybe-test: pascal/procedural_types_extra/proctypex_reassign_6
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x; end; __p(__vs(f(6))); f:=function(x:Integer):Integer begin Result:=x+10; end; __p(__vs(f(6))); __vybeCheck('6' + #10 + '16');
end.
