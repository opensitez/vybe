// vybe-test: pascal/procedural_types_extra/proctypex_twice_39
...
end; procedure Twice(f:function(x:Integer):Integer); begin __p(__vs(f(39))); __p(__vs(f(39))); end; begin Twice(function(x:Integer):Integer begin Result:=x*2; end); __vybeCheck('78' + #10 + '78');
end.
