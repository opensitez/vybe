// vybe-test: pascal/procedural_types_extra/proctypex_twice_9
...
end; procedure Twice(f:function(x:Integer):Integer); begin __p(__vs(f(9))); __p(__vs(f(9))); end; begin Twice(function(x:Integer):Integer begin Result:=x*2; end); __vybeCheck('18' + #10 + '18');
end.
