// vybe-test: pascal/procedural_types_extra/proctypex_capture_11
...
end; var base:Integer; f:function(x:Integer):Integer; begin base:=11; f:=function(x:Integer):Integer begin Result:=base+x; end; __p(__vs(f(1))); __vybeCheck('12');
end.
