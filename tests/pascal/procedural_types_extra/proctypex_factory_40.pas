// vybe-test: pascal/procedural_types_extra/proctypex_factory_40
...
end; function Make(k:Integer):function(x:Integer):Integer; begin Result:=function(x:Integer):Integer begin Result:=x+k; end; end; var f:function(x:Integer):Integer; begin f:=Make(40); __p(__vs(f(0))); __vybeCheck('40');
end.
