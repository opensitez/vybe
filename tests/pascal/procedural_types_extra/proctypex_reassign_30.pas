// vybe-test: pascal/procedural_types_extra/proctypex_reassign_30
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x; end; __p(__vs(f(30))); f:=function(x:Integer):Integer begin Result:=x+10; end; __p(__vs(f(30))); __vybeCheck('30' + #10 + '40');
end.
