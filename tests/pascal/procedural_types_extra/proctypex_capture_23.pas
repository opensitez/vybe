// vybe-test: pascal/procedural_types_extra/proctypex_capture_23
...
end; var base:Integer; f:function(x:Integer):Integer; begin base:=23; f:=function(x:Integer):Integer begin Result:=base+x; end; __p(__vs(f(1))); __vybeCheck('24');
end.
