// vybe-test: pascal/procedural_types_extra/proctypex_twice_27
...
end; procedure Twice(f:function(x:Integer):Integer); begin __p(__vs(f(27))); __p(__vs(f(27))); end; begin Twice(function(x:Integer):Integer begin Result:=x*2; end); __vybeCheck('54' + #10 + '54');
end.
