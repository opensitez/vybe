// vybe-test: pascal/procedural_types_extra/proctypex_reassign_18
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x; end; __p(__vs(f(18))); f:=function(x:Integer):Integer begin Result:=x+10; end; __p(__vs(f(18))); __vybeCheck('18' + #10 + '28');
end.
