// vybe-test: pascal/procedural_types_extra/proctypex_capture_35
...
end; var base:Integer; f:function(x:Integer):Integer; begin base:=35; f:=function(x:Integer):Integer begin Result:=base+x; end; __p(__vs(f(1))); __vybeCheck('36');
end.
