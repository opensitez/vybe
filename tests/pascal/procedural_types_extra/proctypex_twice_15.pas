// vybe-test: pascal/procedural_types_extra/proctypex_twice_15
...
end; procedure Twice(f:function(x:Integer):Integer); begin __p(__vs(f(15))); __p(__vs(f(15))); end; begin Twice(function(x:Integer):Integer begin Result:=x*2; end); __vybeCheck('30' + #10 + '30');
end.
