// vybe-test: pascal/procedural_types_extra/proctypex_capture_29
...
end; var base:Integer; f:function(x:Integer):Integer; begin base:=29; f:=function(x:Integer):Integer begin Result:=base+x; end; __p(__vs(f(1))); __vybeCheck('30');
end.
