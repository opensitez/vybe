// vybe-test: pascal/procedural_types_extra/proctypex_twice_33
...
end; procedure Twice(f:function(x:Integer):Integer); begin __p(__vs(f(33))); __p(__vs(f(33))); end; begin Twice(function(x:Integer):Integer begin Result:=x*2; end); __vybeCheck('66' + #10 + '66');
end.
