// vybe-test: pascal/procedural_types_extra/proctypex_reassign_42
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x; end; __p(__vs(f(42))); f:=function(x:Integer):Integer begin Result:=x+10; end; __p(__vs(f(42))); __vybeCheck('42' + #10 + '52');
end.
