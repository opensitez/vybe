// vybe-test: pascal/procedural_types_extra/proctypex_twice_3
...
end; procedure Twice(f:function(x:Integer):Integer); begin __p(__vs(f(3))); __p(__vs(f(3))); end; begin Twice(function(x:Integer):Integer begin Result:=x*2; end); __vybeCheck('6' + #10 + '6');
end.
