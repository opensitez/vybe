// vybe-test: pascal/procedural_types_extra/proctypex_reassign_24
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x; end; __p(__vs(f(24))); f:=function(x:Integer):Integer begin Result:=x+10; end; __p(__vs(f(24))); __vybeCheck('24' + #10 + '34');
end.
