// vybe-test: pascal/procedural_types_extra/proctypex_twice_21
...
end; procedure Twice(f:function(x:Integer):Integer); begin __p(__vs(f(21))); __p(__vs(f(21))); end; begin Twice(function(x:Integer):Integer begin Result:=x*2; end); __vybeCheck('42' + #10 + '42');
end.
