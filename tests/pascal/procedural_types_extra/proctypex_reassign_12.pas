// vybe-test: pascal/procedural_types_extra/proctypex_reassign_12
...
end; var f:function(x:Integer):Integer; begin f:=function(x:Integer):Integer begin Result:=x; end; __p(__vs(f(12))); f:=function(x:Integer):Integer begin Result:=x+10; end; __p(__vs(f(12))); __vybeCheck('12' + #10 + '22');
end.
