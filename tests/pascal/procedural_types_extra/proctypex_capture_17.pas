// vybe-test: pascal/procedural_types_extra/proctypex_capture_17
...
end; var base:Integer; f:function(x:Integer):Integer; begin base:=17; f:=function(x:Integer):Integer begin Result:=base+x; end; __p(__vs(f(1))); __vybeCheck('18');
end.
