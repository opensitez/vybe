// vybe-test: pascal/oop_patterns4/test_oop_proxy_pattern
...
begin
  ...
  proxy.FReal := svc;
  proxy.FCallCount := 0;
  __p(__vs(proxy.Request('ping')));
  __p(__vs(proxy.Request('data')));
  __p(__vs(proxy.FCallCount));
__vybeCheck('response:ping' + #10 + 'response:data' + #10 + '2');
end.
