// vybe-test: pascal/oop_patterns4/test_oop_flyweight_chars
...
begin
  ...
  __p(__vs(pool[0].Render));
  __p(__vs(pool[4].Render));
  __p(__vs(pool[25].Render));
__vybeCheck('char:a' + #10 + 'char:e' + #10 + 'char:z');
end.
