// vybe-test: pascal/oop_patterns4/test_oop_prototype_clone
...
begin
  ...
  cfg2 := cfg1.Clone;
  cfg2.FPort := 9090;
  __p(__vs(cfg1.FHost + ':' + IntToStr(cfg1.FPort)));
  __p(__vs(cfg2.FHost + ':' + IntToStr(cfg2.FPort)));
__vybeCheck('localhost:8080' + #10 + 'localhost:9090');
end.
