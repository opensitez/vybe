// vybe-test: pascal/oop_patterns4/test_oop_abstract_method_two_impls
...
begin
  ...
  rc.FW := 4;
  rc.FH := 6;
  __p(__vs(sq.Describe + '=' + IntToStr(sq.Area)));
  __p(__vs(rc.Describe + '=' + IntToStr(rc.Area)));
__vybeCheck('square(5)=25' + #10 + 'rect(4x6)=24');
end.
