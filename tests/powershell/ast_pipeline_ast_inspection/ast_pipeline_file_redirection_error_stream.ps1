# vybe-test: powershell/ast_pipeline_ast_inspection/ast_pipeline_file_redirection_error_stream
# 2> err.log parses as FileRedirectionAst with FromStream = Error
$code = "Test-Connection localhost 2> errors.log"
