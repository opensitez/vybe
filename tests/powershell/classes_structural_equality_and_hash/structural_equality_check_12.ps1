# vybe-test: powershell/classes_structural_equality_and_hash/structural_equality_check_12
class StructItem_12 {
    [int]$A = 12
    [string]$B = "Tag_12"
    [bool]Equals([object]$other) {
        if ($other -isnot [StructItem_12]) { return $false }
...
$s1 = [StructItem_12]::new()
$s2 = [StructItem_12]::new()
