# vybe-test: powershell/classes_structural_equality_and_hash/structural_equality_check_17
class StructItem_17 {
    [int]$A = 17
    [string]$B = "Tag_17"
    [bool]Equals([object]$other) {
        if ($other -isnot [StructItem_17]) { return $false }
...
$s1 = [StructItem_17]::new()
$s2 = [StructItem_17]::new()
