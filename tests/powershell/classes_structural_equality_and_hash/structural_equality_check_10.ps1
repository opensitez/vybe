# vybe-test: powershell/classes_structural_equality_and_hash/structural_equality_check_10
class StructItem_10 {
    [int]$A = 10
    [string]$B = "Tag_10"
    [bool]Equals([object]$other) {
        if ($other -isnot [StructItem_10]) { return $false }
...
$s1 = [StructItem_10]::new()
$s2 = [StructItem_10]::new()
