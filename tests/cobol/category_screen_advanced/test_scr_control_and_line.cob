*> vybe-test: cobol/category_screen_advanced/test_scr_control_and_line
...
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 V PIC X(4) VALUE SPACES. SCREEN SECTION. 01 S1. 05 LINE 2 COL 2 PIC X(4) TO V. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
