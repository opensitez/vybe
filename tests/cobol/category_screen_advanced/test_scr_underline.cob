*> vybe-test: cobol/category_screen_advanced/test_scr_underline
*> origin: languages/cobol/tests/cobol/test_category_screen_advanced.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. SCREEN SECTION. 01 S1. 05 LINE 1 COL 1 VALUE 'A' UNDERLINE. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
