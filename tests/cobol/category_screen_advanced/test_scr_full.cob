*> vybe-test: cobol/category_screen_advanced/test_scr_full
*> origin: languages/cobol/tests/cobol/test_category_screen_advanced.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 V PIC X. SCREEN SECTION. 01 S1. 05 LINE 1 COL 1 PIC X TO V FULL. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
