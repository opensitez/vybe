*> vybe-test: cobol/category_screen_advanced/test_scr_erase_eos
...
01 WS-VYBE-I PIC 9(4) VALUE 0. SCREEN SECTION. 01 S1. 05 LINE 1 COL 1 VALUE 'A' ERASE EOS. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
