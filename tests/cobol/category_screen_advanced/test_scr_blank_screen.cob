*> vybe-test: cobol/category_screen_advanced/test_scr_blank_screen
*> origin: languages/cobol/tests/cobol/test_category_screen_advanced.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. SCREEN SECTION. 01 S1 BLANK SCREEN. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
