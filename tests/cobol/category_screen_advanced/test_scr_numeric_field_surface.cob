*> vybe-test: cobol/category_screen_advanced/test_scr_numeric_field_surface
...
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 NUM PIC 9(5) VALUE 12. SCREEN SECTION. 01 S1. 05 LINE 1 COL 1 PIC ZZ,ZZ TO NUM PROMPT. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
