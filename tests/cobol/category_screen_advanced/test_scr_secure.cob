*> vybe-test: cobol/category_screen_advanced/test_scr_secure
...
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 V PIC X. SCREEN SECTION. 01 S1. 05 LINE 1 COL 1 PIC X TO V SECURE. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
