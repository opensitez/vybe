*> vybe-test: cobol/category_screen_advanced/test_scr_line_col_identifier
...
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 V PIC X VALUE 'A'. SCREEN SECTION. 01 S1. 05 LINE 1 COL 1 FROM V. PROCEDURE DIVISION. DISPLAY S1.
    ADD 1 TO WS-VYBE-I
