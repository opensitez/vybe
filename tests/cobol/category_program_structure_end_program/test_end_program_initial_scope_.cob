*> vybe-test: cobol/category_program_structure_end_program/test_end_program_initial_scope_infer
*> origin: languages/cobol/tests/cobol/test_category_program_structure_end_program.rs
IDENTIFICATION DIVISION. PROGRAM-ID. MAIN. PROCEDURE DIVISION. CALL 'WORKER'. CALL 'WORKER'. STOP RUN. IDENTIFICATION DIVISION. PROGRAM-ID. WORKER IS INITIAL PROGRAM. DATA DIVISION. WORKING-STORAGE SECTION.
