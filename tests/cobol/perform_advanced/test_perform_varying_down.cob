*> vybe-test: cobol/perform_advanced/test_perform_varying_down
...
PROCEDURE DIVISION.
    ...
    EVALUATE WS-VYBE-I
        WHEN 1
            IF WS-VYBE-L NOT = "00q"
                DISPLAY "FAIL at 1 want [00q] got [" WS-VYBE-L "]"
                MOVE 1 TO RETURN-CODE
                RAISE EXCEPTION EC-PROGRAM
            END-IF
        WHEN 2
            IF WS-VYBE-L NOT = "003"
                DISPLAY "FAIL at 2 want [003] got [" WS-VYBE-L "]"
                MOVE 1 TO RETURN-CODE
                RAISE EXCEPTION EC-PROGRAM
            END-IF
        WHEN 3
            IF WS-VYBE-L NOT = "001"
                DISPLAY "FAIL at 3 want [001] got [" WS-VYBE-L "]"
                MOVE 1 TO RETURN-CODE
                RAISE EXCEPTION EC-PROGRAM
            END-IF
        WHEN OTHER
