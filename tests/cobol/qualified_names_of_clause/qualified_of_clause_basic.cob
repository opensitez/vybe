...
PROCEDURE DIVISION.
    ...
    STRING CODE DELIMITED SIZE OF DELIMITED SIZE GRP-A DELIMITED SIZE INTO WS-VYBE-L
    ...
    MOVE SPACES TO WS-VYBE-L
    STRING CODE DELIMITED SIZE OF DELIMITED SIZE GRP-B DELIMITED SIZE INTO WS-VYBE-L
