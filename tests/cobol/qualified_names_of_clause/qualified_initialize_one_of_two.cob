...
PROCEDURE DIVISION.
    ...
    STRING SCORE DELIMITED SIZE OF DELIMITED SIZE REC-1 DELIMITED SIZE INTO WS-VYBE-L
    ...
    MOVE SPACES TO WS-VYBE-L
    STRING SCORE DELIMITED SIZE OF DELIMITED SIZE REC-2 DELIMITED SIZE INTO WS-VYBE-L
