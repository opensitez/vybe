...
PROCEDURE DIVISION.
    ...
    STRING HEADCOUNT DELIMITED SIZE OF DELIMITED SIZE DEPT-A DELIMITED SIZE INTO WS-VYBE-L
    ...
    MOVE SPACES TO WS-VYBE-L
    STRING HEADCOUNT DELIMITED SIZE OF DELIMITED SIZE DEPT-B DELIMITED SIZE INTO WS-VYBE-L
