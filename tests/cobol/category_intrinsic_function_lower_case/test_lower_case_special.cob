*> vybe-test: cobol/category_intrinsic_function_lower_case/test_lower_case_special
*> origin: languages/cobol/tests/cobol/test_category_intrinsic_function_lower_case.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256). 01 V PIC X(5) VALUE 'H@LL!'. PROCEDURE DIVISION. DISPLAY FUNCTION LOWER-CASE(V).
