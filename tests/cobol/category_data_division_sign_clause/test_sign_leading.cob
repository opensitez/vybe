*> vybe-test: cobol/category_data_division_sign_clause/test_sign_leading
*> origin: languages/cobol/tests/cobol/test_category_data_division_sign_clause.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256). 01 V PIC S9(3) SIGN IS LEADING VALUE -123. PROCEDURE DIVISION. DISPLAY V.
