...
FILE SECTION.
FD RPT-FILE REPORT IS R4.
WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. REPORT SECTION. RD R4. 01 G1 TYPE IS DETAIL. 05 COLUMN 1 PIC X VALUE 'C'. 01 G2 TYPE IS DETAIL. 05 COLUMN 1 PIC X VALUE 'D'. PROCEDURE DIVISION. DECLARATIVES. D4 SECTION. USE BEFORE REPORTING G1. D4-PARA. DISPLAY 'BEFORE'.
    ADD 1 TO WS-VYBE-I
