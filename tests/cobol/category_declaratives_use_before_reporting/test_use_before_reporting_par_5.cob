...
FILE SECTION.
FD RPT-FILE REPORT IS R6.
WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. REPORT SECTION. RD R6. 01 G TYPE IS DETAIL. 05 COLUMN 1 PIC X VALUE 'F'. PROCEDURE DIVISION. DECLARATIVES. D6 SECTION. USE BEFORE REPORTING G. D6-PARA. IF 1 = 1 DISPLAY 'BEF' ELSE DISPLAY 'NO'.
    ADD 1 TO WS-VYBE-I
