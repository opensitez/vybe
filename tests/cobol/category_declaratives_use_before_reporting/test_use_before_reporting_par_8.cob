...
FILE SECTION.
FD RPT-FILE REPORT IS R9.
WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. REPORT SECTION. RD R9. 01 G TYPE IS DETAIL. 05 COLUMN 1 PIC X VALUE 'I'. PROCEDURE DIVISION. DECLARATIVES. D9 SECTION. USE BEFORE REPORTING G. D9-PARA. DISPLAY "OPEN".
    ADD 1 TO WS-VYBE-I
