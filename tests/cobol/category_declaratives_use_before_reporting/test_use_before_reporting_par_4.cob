...
FILE SECTION.
FD RPT-FILE REPORT IS R5.
WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. REPORT SECTION. RD R5. 01 G TYPE IS DETAIL. 05 COLUMN 1 PIC X VALUE 'E'. PROCEDURE DIVISION. DECLARATIVES. D5-START SECTION. USE BEFORE REPORTING G. D5-PARA. DISPLAY 'PRE'.
    ADD 1 TO WS-VYBE-I
