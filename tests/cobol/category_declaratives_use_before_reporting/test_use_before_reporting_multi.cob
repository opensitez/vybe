...
01 WS-VYBE-I PIC 9(4) VALUE 0. REPORT SECTION. RD R1. 01 G1 TYPE IS DETAIL. 01 G2 TYPE IS DETAIL. PROCEDURE DIVISION. DECLARATIVES. S1 SECTION. USE BEFORE REPORTING G1. S1-PARA. DISPLAY 'BEF'.
    ADD 1 TO WS-VYBE-I
