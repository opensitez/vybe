...
IDENTIFICATION DIVISION. PROGRAM-ID. T. ENVIRONMENT DIVISION. DATA DIVISION. REPORT SECTION. RD R3. 01 G TYPE IS DETAIL. 05 COLUMN 1 PIC X VALUE 'B'. PROCEDURE DIVISION. DECLARATIVES. D3 SECTION. USE BEFORE REPORTING R3. D3-PARA. DISPLAY 'X'.
    ADD 1 TO WS-VYBE-I
