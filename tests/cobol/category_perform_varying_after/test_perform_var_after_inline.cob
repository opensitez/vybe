*> vybe-test: cobol/category_perform_varying_after/test_perform_var_after_inline
*> origin: languages/cobol/tests/cobol/test_category_perform_varying_after.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 I PIC 9. 01 J PIC 9. PROCEDURE DIVISION. PERFORM VARYING I FROM 1 BY 1 UNTIL I > 2 AFTER J FROM 1 BY 1 UNTIL J > 2 DISPLAY I J END-PERFORM.
    ADD 1 TO WS-VYBE-I
