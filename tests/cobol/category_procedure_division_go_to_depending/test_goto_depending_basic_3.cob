*> vybe-test: cobol/category_procedure_division_go_to_depending/test_goto_depending_basic_3
*> origin: languages/cobol/tests/cobol/test_category_procedure_division_go_to_depending.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 V PIC 9 VALUE 3. PROCEDURE DIVISION. GO TO P1 P2 P3 DEPENDING ON V. DISPLAY 'ERR'.
    ADD 1 TO WS-VYBE-I
