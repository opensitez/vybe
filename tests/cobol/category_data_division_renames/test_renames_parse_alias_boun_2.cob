*> vybe-test: cobol/category_data_division_renames/test_renames_parse_alias_boundary_end
*> origin: languages/cobol/tests/cobol/test_category_data_division_renames.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 R. 05 A PIC X VALUE 'A'. 05 B PIC X VALUE 'B'. 05 C PIC X VALUE 'C'. 66 ALIAS RENAMES C THRU C. PROCEDURE DIVISION. MOVE 'K' TO ALIAS DISPLAY A DISPLAY B DISPLAY C.
    ADD 1 TO WS-VYBE-I
    ...
    EVALUATE WS-VYBE-I
        ...
        WHEN 3
            IF WS-VYBE-L NOT = "K"
                DISPLAY "FAIL at 3 want [K] got [" WS-VYBE-L "]"
                MOVE 1 TO RETURN-CODE
                RAISE EXCEPTION EC-PROGRAM
            END-IF
        WHEN OTHER
