*> vybe-test: cobol/category_data_division_renames/test_renames_parse_numeric_to_alpha_mix
*> origin: languages/cobol/tests/cobol/test_category_data_division_renames.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256). 01 N. 05 A PIC 99 VALUE 12. 05 B PIC 99 VALUE 34. 66 NUM RENAMES A THRU B. PROCEDURE DIVISION. MOVE 0 TO NUM DISPLAY NUM.
