*> vybe-test: cobol/category_data_division_renames/test_renames_parse_alias_boundary_start
*> origin: languages/cobol/tests/cobol/test_category_data_division_renames.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 R. 05 A PIC X VALUE 'A'. 05 B PIC X VALUE 'B'. 05 C PIC X VALUE 'C'. 66 ALIAS RENAMES A THRU A. PROCEDURE DIVISION. MOVE 'K' TO ALIAS DISPLAY A DISPLAY B DISPLAY C.
    ADD 1 TO WS-VYBE-I
    ...
    EVALUATE WS-VYBE-I
        WHEN 1
            IF WS-VYBE-L NOT = "K"
                DISPLAY "FAIL at 1 want [K] got [" WS-VYBE-L "]"
