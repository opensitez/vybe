...
01 WS-VYBE-L PIC X(256). 01 R. 05 A PIC X VALUE 'A'. 05 B PIC X VALUE ' '. 05 C PIC X VALUE 'C'. 66 ALIAS RENAMES A THRU B. PROCEDURE DIVISION. MOVE 'T' TO B DISPLAY ALIAS.
