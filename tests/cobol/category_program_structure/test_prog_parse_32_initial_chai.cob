*> vybe-test: cobol/category_program_structure/test_prog_parse_32_initial_chain_reused
*> origin: languages/cobol/tests/cobol/test_category_program_structure.rs
IDENTIFICATION DIVISION. PROGRAM-ID. ROOT. PROCEDURE DIVISION. CALL 'COUNTER'. CALL 'COUNTER'. STOP RUN. IDENTIFICATION DIVISION. PROGRAM-ID. COUNTER IS INITIAL PROGRAM. DATA DIVISION. WORKING-STORAGE SECTION.
...
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 C PIC 9 VALUE 0. PROCEDURE DIVISION. ADD 1 TO C. DISPLAY C.
    ...
    EVALUATE WS-VYBE-I
        ...
        WHEN OTHER
            ...
            MOVE 1 TO RETURN-CODE
            RAISE EXCEPTION EC-PROGRAM
    END-EVALUATE. EXIT PROGRAM. END PROGRAM COUNTER.
    IF WS-VYBE-I NOT = 2
