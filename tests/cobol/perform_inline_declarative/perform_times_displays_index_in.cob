*> vybe-test: cobol/perform_inline_declarative/perform_times_displays_index_indirectly
...
PROCEDURE DIVISION.
    ...
    EVALUATE WS-VYBE-I
        ...
        WHEN 2
            IF WS-VYBE-L NOT = "04"
                DISPLAY "FAIL at 2 want [04] got [" WS-VYBE-L "]"
                MOVE 1 TO RETURN-CODE
                RAISE EXCEPTION EC-PROGRAM
            END-IF
        WHEN 3
            IF WS-VYBE-L NOT = "06"
                DISPLAY "FAIL at 3 want [06] got [" WS-VYBE-L "]"
                MOVE 1 TO RETURN-CODE
                RAISE EXCEPTION EC-PROGRAM
            END-IF
        WHEN 4
            IF WS-VYBE-L NOT = "08"
                DISPLAY "FAIL at 4 want [08] got [" WS-VYBE-L "]"
                MOVE 1 TO RETURN-CODE
                RAISE EXCEPTION EC-PROGRAM
            END-IF
        WHEN 5
