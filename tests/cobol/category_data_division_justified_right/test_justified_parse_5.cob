*> vybe-test: cobol/category_data_division_justified_right/test_justified_parse_5
*> origin: languages/cobol/tests/cobol/test_category_data_division_justified_right.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256). 01 V PIC X(6) JUSTIFIED RIGHT. 01 W PIC X(6) JUSTIFIED RIGHT VALUE SPACES. PROCEDURE DIVISION. MOVE 'A' TO W. DISPLAY '[' V ']'.
