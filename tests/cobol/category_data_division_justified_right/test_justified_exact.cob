*> vybe-test: cobol/category_data_division_justified_right/test_justified_exact
*> origin: languages/cobol/tests/cobol/test_category_data_division_justified_right.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256). 01 V PIC X(3) JUSTIFIED RIGHT. PROCEDURE DIVISION. MOVE 'ABC' TO V. DISPLAY '[' V ']'.
