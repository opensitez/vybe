*> vybe-test: cobol/category_perform_until/test_perform_until_exit_perform
*> origin: languages/cobol/tests/cobol/test_category_perform_until.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 I PIC 9 VALUE 1. PROCEDURE DIVISION. PERFORM UNTIL I > 5 DISPLAY I IF I = 3 EXIT PERFORM END-IF ADD 1 TO I END-PERFORM.
    ADD 1 TO WS-VYBE-I
