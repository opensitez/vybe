*> vybe-test: cobol/category_perform_until/test_perform_until_test_after
*> origin: languages/cobol/tests/cobol/test_category_perform_until.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256).
01 WS-VYBE-I PIC 9(4) VALUE 0. 01 I PIC 9 VALUE 4. PROCEDURE DIVISION. PERFORM M-PARA WITH TEST AFTER UNTIL I > 3. DISPLAY 'OK'.
    ADD 1 TO WS-VYBE-I
    ...
    EVALUATE WS-VYBE-I
        ...
        WHEN OTHER
            ...
            MOVE 1 TO RETURN-CODE
            RAISE EXCEPTION EC-PROGRAM
    END-EVALUATE.    IF WS-VYBE-I NOT = 2
        DISPLAY "FAIL: " WS-VYBE-I " line(s), wanted 2"
        MOVE 1 TO RETURN-CODE
        RAISE EXCEPTION EC-PROGRAM
    END-IF.
 STOP RUN. M-PARA. DISPLAY I.
    ADD 1 TO WS-VYBE-I
    MOVE SPACES TO WS-VYBE-L
