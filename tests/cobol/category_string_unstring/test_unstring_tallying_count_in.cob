...
01 WS-VYBE-L PIC X(256).
       ...
       01 TALLY-N PIC 9(2) VALUE 0.
       PROCEDURE DIVISION.
           UNSTRING SRC DELIMITED BY ","
              INTO OUT-1 COUNT IN CNT-1
                   OUT-2 COUNT IN CNT-2
              TALLYING IN TALLY-N.
           DISPLAY CNT-1 " " CNT-2 " " TALLY-N.
    MOVE SPACES TO WS-VYBE-L
    STRING CNT-1 DELIMITED SIZE " " DELIMITED SIZE CNT-2 DELIMITED SIZE " " DELIMITED SIZE TALLY-N DELIMITED SIZE INTO WS-VYBE-L
    IF WS-VYBE-L NOT = "05 14 02"
        DISPLAY "FAIL: want [05 14 02] got [" WS-VYBE-L "]"
