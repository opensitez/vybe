...
IDENTIFICATION DIVISION. PROGRAM-ID. T. PROCEDURE DIVISION. DISPLAY FUNCTION MIN('ZZZ' 'AAA' 'MMM').
    MOVE SPACES TO WS-VYBE-L
    STRING FUNCTION DELIMITED SIZE MIN('ZZZ' DELIMITED SIZE 'AAA' DELIMITED SIZE 'MMM') DELIMITED SIZE INTO WS-VYBE-L
