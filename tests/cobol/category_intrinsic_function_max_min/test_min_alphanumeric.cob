...
IDENTIFICATION DIVISION. PROGRAM-ID. T. PROCEDURE DIVISION. DISPLAY FUNCTION MIN('APPLE' 'ZEBRA' 'BANANA').
    MOVE SPACES TO WS-VYBE-L
    STRING FUNCTION DELIMITED SIZE MIN('APPLE' DELIMITED SIZE 'ZEBRA' DELIMITED SIZE 'BANANA') DELIMITED SIZE INTO WS-VYBE-L
