*> vybe-test: cobol/category_data_division_blank_when_zero/test_bwz_edited
*> origin: languages/cobol/tests/cobol/test_category_data_division_blank_when_zero.rs
IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION.
01 WS-VYBE-L PIC X(256). 01 V PIC ZZZ VALUE 0 BLANK WHEN ZERO. PROCEDURE DIVISION. DISPLAY '[' V ']'.
