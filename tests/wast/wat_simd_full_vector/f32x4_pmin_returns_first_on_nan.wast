;; vybe-test: wast/wat_simd_full_vector/f32x4_pmin_returns_first_on_nan
...
(module
  ...
  v128.const f32x4 8.0 3.0 2.0 nan
  f32x4.pmin
...
(assert_return (invoke "f0") (f32.const 3.0))
(assert_return (invoke "f1") (f32.const 3.0))
(assert_return (invoke "f2") (f32.const nan:canonical))
(assert_return (invoke "f3") (f32.const 5.0))
