-- vybe-test: lua/base_xpcall_handlers/test_xpcall_nested_error
-- origin: languages/lua/tests/lua/test_base_xpcall_handlers.rs

local __w1 = "true"
local __i = 0

local function bad() error("bad") end
...
do local __t = tostring(ok and status == false and val == "handled"); __i = __i + 1
