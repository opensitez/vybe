-- vybe-test: lua/control_if_nested_priority/test_control_if_nested_priority_local_scope_shadow
-- origin: languages/lua/tests/lua/test_control_if_nested_priority.rs

local __w1 = "1"
local __i = 0

local x=1; if true then local x='inner'; do local __t = tostring(x); __i = __i + 1
