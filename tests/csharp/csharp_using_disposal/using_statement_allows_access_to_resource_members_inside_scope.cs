...
using System; class Resource : IDisposable { public string Name => "file"; public void Dispose() { __P(("disposed").ToString()); } } using (var resource = new Resource()) { __P((resource.Name).ToString()); }
__Check("file\ndisposed");
