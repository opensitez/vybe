...
App.Run();
__Check("Done_caller_member_name_multiple_optional_params_only_first_is_caller");
...
class App {
    ...
    public static void Log([System.Runtime.CompilerServices.CallerMemberName] string m = "") {
        __P("Done_caller_member_name_multiple_optional_params_only_first_is_caller");
    }
}
