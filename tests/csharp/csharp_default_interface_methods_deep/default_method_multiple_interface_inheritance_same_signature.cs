...
__P(svc.GetGreeting());
__Check("Hello_default_method_multiple_interface_inheritance_same_signature");

interface IDemoService {
    string GetGreeting() => "Hello_default_method_multiple_interface_inheritance_same_signature";
}
