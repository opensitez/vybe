...
__P(svc.GetGreeting());
__Check("Hello_default_interface_method_called_on_concrete_without_override");

interface IDemoService {
    string GetGreeting() => "Hello_default_interface_method_called_on_concrete_without_override";
}
