...
__P(svc.GetGreeting());
__Check("Hello_default_method_replaced_only_on_one_interface_in_diamond");

interface IDemoService {
    string GetGreeting() => "Hello_default_method_replaced_only_on_one_interface_in_diamond";
}
