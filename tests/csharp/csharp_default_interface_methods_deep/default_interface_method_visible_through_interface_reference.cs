...
__P(svc.GetGreeting());
__Check("Hello_default_interface_method_visible_through_interface_reference");

interface IDemoService {
    string GetGreeting() => "Hello_default_interface_method_visible_through_interface_reference";
}
