...
__P(res);
__Check("Static_static_abstract_interface_with_struct_and_class_implementors");
...
class StaticImpl : IStaticProvider<StaticImpl> {
    public static string GetValue() => "Static_static_abstract_interface_with_struct_and_class_implementors";
}
class GenericHelper {
