...
__P(res);
__Check("Static_static_abstract_static_member_hides_instance_context");
...
class StaticImpl : IStaticProvider<StaticImpl> {
    public static string GetValue() => "Static_static_abstract_static_member_hides_instance_context";
}
class GenericHelper {
