...
__P(res);
__Check("Static_static_abstract_explicit_interface_implementation_style");
...
class StaticImpl : IStaticProvider<StaticImpl> {
    public static string GetValue() => "Static_static_abstract_explicit_interface_implementation_style";
}
class GenericHelper {
