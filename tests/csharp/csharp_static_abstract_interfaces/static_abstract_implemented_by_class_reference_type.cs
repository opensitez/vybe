...
__P(res);
__Check("Static_static_abstract_implemented_by_class_reference_type");
...
class StaticImpl : IStaticProvider<StaticImpl> {
    public static string GetValue() => "Static_static_abstract_implemented_by_class_reference_type";
}
class GenericHelper {
