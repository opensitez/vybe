...
__P(res);
__Check("Static_static_abstract_self_referential_constraint_roundtrip");
...
class StaticImpl : IStaticProvider<StaticImpl> {
    public static string GetValue() => "Static_static_abstract_self_referential_constraint_roundtrip";
}
class GenericHelper {
