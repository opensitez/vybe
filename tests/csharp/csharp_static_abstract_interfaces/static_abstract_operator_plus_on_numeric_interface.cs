...
__P(res);
__Check("Static_static_abstract_operator_plus_on_numeric_interface");
...
class StaticImpl : IStaticProvider<StaticImpl> {
    public static string GetValue() => "Static_static_abstract_operator_plus_on_numeric_interface";
}
class GenericHelper {
