...
__P(res);
__Check("Static_static_abstract_parse_empty_string_throws_or_zero");
...
class StaticImpl : IStaticProvider<StaticImpl> {
    public static string GetValue() => "Static_static_abstract_parse_empty_string_throws_or_zero";
}
class GenericHelper {
