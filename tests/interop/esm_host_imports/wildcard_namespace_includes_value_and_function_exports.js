// vybe-test: interop/esm_host_imports/wildcard_namespace_includes_value_and_function_exports
...
__p(__line(Array.isArray(processNs.argv)));
__p(__line(typeof processNs.cwd === "function"));
__p(__line(typeof processNs.version === "string"));
__p(__line(typeof processNs.env === "object"));
__checkLater("true\ntrue\ntrue\ntrue");
