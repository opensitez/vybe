// vybe-test: interop/esm_host_imports/wasi_filesystem_preopens_actual_surface_namespace_import
...
__p(__line(Array.isArray(directories)));
__p(__line(directories.length > 0));
__p(__line(directories[0][1] === "."));
__checkLater("true\ntrue\ntrue");
