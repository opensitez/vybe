// vybe-test: interop/esm_host_imports/node_process_named_imports_bind_values
...
__p(__line(Array.isArray(argv)));
__p(__line(typeof env === "object"));
__p(__line(typeof versions.node === "string"));
__p(__line(typeof platform === "string"));
__p(__line(typeof arch === "string"));
__p(__line(typeof version === "string"));
__p(__line(typeof pid === "number"));
__p(__line(typeof execPath === "string"));
__checkLater("true\ntrue\ntrue\ntrue\ntrue\ntrue\ntrue\ntrue");
