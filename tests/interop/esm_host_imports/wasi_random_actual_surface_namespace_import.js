// vybe-test: interop/esm_host_imports/wasi_random_actual_surface_namespace_import
...
__p(__line(Array.isArray(bytes)));
__p(__line(bytes.length === 4));
__p(__line(typeof value === "number"));
__checkLater("true\ntrue\ntrue");
