// vybe-test: interop/esm_host_imports/ecma_constants_import_as_values
...
__p(__line(typeof PI === "number"));
__p(__line(PI > 3));
__p(__line(typeof E === "number"));
__p(__line(MAX_SAFE_INTEGER > 1000));
__p(__line(Number.isNaN(NumberNaN)));
__checkLater("true\ntrue\ntrue\ntrue\ntrue");
