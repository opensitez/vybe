<?php
// vybe-test: php/php_intl_transliterator_create_transliterate/test_php_intl_transliterator_latin_to_ascii
...
__vybe_check(ob_get_clean(), "Transliterated: Hello World");
