<?php
// vybe-test: php/php_escapeshellcmd_escapeshellarg_sanitization/test_php_escapeshellarg_escapes_single_quotes_inside
...
__vybe_check(ob_get_clean(), "QUOTES_ESCAPED_OK");
