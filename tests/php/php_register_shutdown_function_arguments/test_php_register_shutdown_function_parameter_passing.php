<?php
// vybe-test: php/php_register_shutdown_function_arguments/test_php_register_shutdown_function_parameter_passing
...
__vybe_check(ob_get_clean(), "Shutdown Registered: YES");
