...
class Greeter {
    public function hello(): string {
        return "php_namespace_alias_conflicts_between_local_and_imported_ok";
    }
}
...
__vybe_check(ob_get_clean(), "php_namespace_alias_conflicts_between_local_and_imported_ok");
