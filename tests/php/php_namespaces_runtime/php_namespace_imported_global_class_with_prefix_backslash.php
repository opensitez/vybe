...
class Greeter {
    public function hello(): string {
        return "php_namespace_imported_global_class_with_prefix_backslash_ok";
    }
}
...
__vybe_check(ob_get_clean(), "php_namespace_imported_global_class_with_prefix_backslash_ok");
