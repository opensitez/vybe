...
echo "test_php84_request_parse_body_non_http_env_returns_empty_pair_ok";

__vybe_check(ob_get_clean(), "test_php84_request_parse_body_non_http_env_returns_empty_pair_ok");
