<?php
// vybe-test: php/php_array_chunk_slice_splice_combine/test_php_array_splice_remove_and_replace
...
__vybe_check(ob_get_clean(), "Input: red,orange,yellow | Removed: green,blue");
