...
fn register_preopens(vm: &mut VM) {
    ...
    vm.register_host_fn(
        ...
        Box::new(|_ctx, _args| {
            ...
            let pair = Value::Object(vybe_runtime::heap::alloc(Object::new_array(pair_elements)));
            Value::Object(vybe_runtime::heap::alloc(Object::new_array(vec![pair])))
        }),
    );
}
...
fn register_types(vm: &mut VM) {
    ...
    vm.register_host_fn(
        ...
        Box::new(|_ctx, args| {
            ...
            Value::Object(vybe_runtime::heap::alloc(flags))
        }),
    );
