...
use vybe_ast::{Argument, BinOp, ExprKind, Expression, Literal, Statement, StmtKind};

use crate::emitter::build::{expr, ident, stmt};
...
pub fn build_math_helper_fn(name: &str, params: &[&str], body: Vec<Statement>) -> Statement {
    use vybe_ast::{Modifiers, Param, PassBy, Visibility};
