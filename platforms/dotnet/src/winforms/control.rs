...
impl ControlType {
    /// Fully-qualified .NET class name for this WinForms/control component.
    pub fn dotnet_class_name(&self) -> &str {
        match self {
            ...
            ControlType::Custom(name) => name.as_str(),
        }
    }

    pub fn dotnet_class_name_for_widget_type_name(type_name: &str) -> &'static str {
