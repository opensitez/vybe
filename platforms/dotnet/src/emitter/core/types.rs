...
const NAMESPACE_CONSTANTS: &[(&str, f64)] = &[
    ...
    ("Byte.MinValue", 0.0),
    ("Byte.MaxValue", 255.0),
    ("System.Byte.MinValue", 0.0),
    ("System.Byte.MaxValue", 255.0),
    ("sbyte.MinValue", -128.0),
    ("sbyte.MaxValue", 127.0),
    ("SByte.MinValue", -128.0),
    ("SByte.MaxValue", 127.0),
    ("System.SByte.MinValue", -128.0),
    ("System.SByte.MaxValue", 127.0),
    ("sbyte.minvalue", -128.0),
    ("sbyte.maxvalue", 127.0),
    ("system.sbyte.minvalue", -128.0),
    ("system.sbyte.maxvalue", 127.0),
    ("uint16.MinValue", 0.0),
    ("uint16.MaxValue", 65_535.0),
    ("UInt16.MinValue", 0.0),
    ("UInt16.MaxValue", 65_535.0),
    ("System.UInt16.MinValue", 0.0),
    ("System.UInt16.MaxValue", 65_535.0),
    ("uint16.minvalue", 0.0),
    ("uint16.maxvalue", 65_535.0),
    ("system.uint16.minvalue", 0.0),
    ("system.uint16.maxvalue", 65_535.0),
    ("uint32.MinValue", 0.0),
    ("uint32.MaxValue", 4_294_967_295.0),
    ("uint.MinValue", 0.0),
    ("uint.MaxValue", 4_294_967_295.0),
    ("UInt32.MinValue", 0.0),
    ("UInt32.MaxValue", 4_294_967_295.0),
    ("System.UInt32.MinValue", 0.0),
    ("System.UInt32.MaxValue", 4_294_967_295.0),
    ("uint32.minvalue", 0.0),
    ("uint32.maxvalue", 4_294_967_295.0),
    ("uint.minvalue", 0.0),
    ("uint.maxvalue", 4_294_967_295.0),
    ...
    ("system.uint32.maxvalue", 4_294_967_295.0),
    ("uint64.MinValue", 0.0),
    ("uint64.MaxValue", 18_446_744_073_709_551_615.0),
    ("UInt64.MinValue", 0.0),
    ("UInt64.MaxValue", 18_446_744_073_709_551_615.0),
    ("System.UInt64.MinValue", 0.0),
    ("System.UInt64.MaxValue", 18_446_744_073_709_551_615.0),
    ("uint64.minvalue", 0.0),
    ("uint64.maxvalue", 18_446_744_073_709_551_615.0),
    ("system.uint64.minvalue", 0.0),
    ("system.uint64.maxvalue", 18_446_744_073_709_551_615.0),
    ...
    ("Half.Epsilon", 0.000000059604645),
    ("half.Epsilon", 0.000000059604645),
    ("System.Half.Epsilon", 0.000000059604645),
    ("system.half.epsilon", 0.000000059604645),
    ("Half.NaN", f64::NAN),
    ("half.NaN", f64::NAN),
    ("System.Half.NaN", f64::NAN),
    ("system.half.nan", f64::NAN),
    ("Half.PositiveInfinity", f64::INFINITY),
    ("half.PositiveInfinity", f64::INFINITY),
    ("System.Half.PositiveInfinity", f64::INFINITY),
    ("system.half.positiveinfinity", f64::INFINITY),
    ("Half.NegativeInfinity", f64::NEG_INFINITY),
    ("half.NegativeInfinity", f64::NEG_INFINITY),
    ("System.Half.NegativeInfinity", f64::NEG_INFINITY),
    ("system.half.negativeinfinity", f64::NEG_INFINITY),
    ("Half.NegativeZero", -0.0),
    ("half.NegativeZero", -0.0),
    ("System.Half.NegativeZero", -0.0),
    ("system.half.negativezero", -0.0),
    ("Half.MaxValue", 65504.0),
    ("half.MaxValue", 65504.0),
    ("System.Half.MaxValue", 65504.0),
    ("system.half.maxvalue", 65504.0),
    ("Half.MinValue", -65504.0),
    ("half.MinValue", -65504.0),
    ("System.Half.MinValue", -65504.0),
    ("system.half.minvalue", -65504.0),
    ("char.MaxValue", 65535.0),
    ("char.MinValue", 0.0),
    ("NumberStyles.HexNumber", 515.0),
    ("numberstyles.hexnumber", 515.0),
    ("System.Globalization.NumberStyles.HexNumber", 515.0),
    ("system.globalization.numberstyles.hexnumber", 515.0),
    ...
    ("httpstatuscode.requestheaderfieldstoolarge", 431.0),
    (
        "System.Net.HttpStatusCode.RequestHeaderFieldsTooLarge",
        431.0,
    ),
    (
        "system.net.httpstatuscode.requestheaderfieldstoolarge",
    ...
    ("httpstatuscode.unavailableforlegalreasons", 451.0),
    (
        "System.Net.HttpStatusCode.UnavailableForLegalReasons",
        451.0,
    ),
    (
        "system.net.httpstatuscode.unavailableforlegalreasons",
    ...
    ("httpstatuscode.networkauthenticationrequired", 511.0),
    (
        "System.Net.HttpStatusCode.NetworkAuthenticationRequired",
        511.0,
    ),
    (
        "system.net.httpstatuscode.networkauthenticationrequired",
    ...
    ("int.maxvalue", 2_147_483_647.0),
    ("int.minvalue", -2_147_483_648.0),
    ("system.int.maxvalue", 2_147_483_647.0),
    ("system.int.minvalue", -2_147_483_648.0),
    ("integer.maxvalue", 2_147_483_647.0),
    ("integer.minvalue", -2_147_483_648.0),
    ("system.integer.maxvalue", 2_147_483_647.0),
    ("system.integer.minvalue", -2_147_483_648.0),
    ("short.maxvalue", 32_767.0),
    ("short.minvalue", -32_768.0),
    ("system.short.maxvalue", 32_767.0),
    ("system.short.minvalue", -32_768.0),
    ("sbyte.maxvalue", 127.0),
    ("sbyte.minvalue", -128.0),
    ("system.sbyte.maxvalue", 127.0),
    ("system.sbyte.minvalue", -128.0),
    ...
    ("system.int16.maxvalue", 32_767.0),
    ("system.int16.minvalue", -32_768.0),
    ("uint16.maxvalue", 65_535.0),
    ("uint16.minvalue", 0.0),
    ("ushort.maxvalue", 65_535.0),
    ("ushort.minvalue", 0.0),
    ("system.uint16.maxvalue", 65_535.0),
    ("system.uint16.minvalue", 0.0),
    ("system.ushort.maxvalue", 65_535.0),
    ("system.ushort.minvalue", 0.0),
    ("int32.maxvalue", 2_147_483_647.0),
    ("int32.minvalue", -2_147_483_648.0),
    ("system.int32.maxvalue", 2_147_483_647.0),
    ("system.int32.minvalue", -2_147_483_648.0),
    ("uint32.maxvalue", 4_294_967_295.0),
    ("uint32.minvalue", 0.0),
    ("uinteger.maxvalue", 4_294_967_295.0),
    ("uinteger.minvalue", 0.0),
    ("system.uint32.maxvalue", 4_294_967_295.0),
    ("system.uint32.minvalue", 0.0),
    ("system.uinteger.maxvalue", 4_294_967_295.0),
    ("system.uinteger.minvalue", 0.0),
    ("byte.maxvalue", 255.0),
    ("byte.minvalue", 0.0),
    ("system.byte.maxvalue", 255.0),
    ("system.byte.minvalue", 0.0),
    ...
    ("double.positiveinfinity", f64::INFINITY),
    ("double.negativeinfinity", f64::NEG_INFINITY),
    ("system.double.maxvalue", f64::MAX),
    ("system.double.minvalue", -f64::MAX),
    ("system.double.nan", f64::NAN),
    ("system.double.positiveinfinity", f64::INFINITY),
    ("system.double.negativeinfinity", f64::NEG_INFINITY),
    ("float.maxvalue", 3.4028235e38),
    ("float.minvalue", -3.4028235e38),
    ("single.maxvalue", 3.4028235e38),
    ("single.minvalue", -3.4028235e38),
    ...
    ("single.positiveinfinity", f64::INFINITY),
    ("single.negativeinfinity", f64::NEG_INFINITY),
    ("system.float.maxvalue", 3.4028235e38),
    ("system.float.minvalue", -3.4028235e38),
    ("system.single.maxvalue", 3.4028235e38),
    ("system.single.minvalue", -3.4028235e38),
    ("system.double.epsilon", 5e-324),
    ("system.float.epsilon", 1.401298464324817e-45),
    ("system.single.epsilon", 1.401298464324817e-45),
    ("system.single.nan", f64::NAN),
    ("system.single.positiveinfinity", f64::INFINITY),
    ("system.single.negativeinfinity", f64::NEG_INFINITY),
    ...
    // one is not.
    //
    // `Decimal` is the exception, and for the opposite reason: a Decimal IS an
    // f64 in this tree, so its limits are no less exact than any other Decimal
    // value the program can hold. Absent, `Decimal.MaxValue > 0D` answered
    // False — which is not "loud", it is wrong.
    ("decimal.maxvalue", 7.922816251426434e28),
    ("decimal.minvalue", -7.922816251426434e28),
    ("Decimal.MaxValue", 7.922816251426434e28),
    ("Decimal.MinValue", -7.922816251426434e28),
    ("decimal.zero", 0.0),
    ("decimal.one", 1.0),
