...
#[test]
fn write_read_roundtrip_string() {
    compile_ok(
        r#"
program test
    character(len=20) :: buf
...
#[test]
fn format_scientific_as_string() {
    compile_ok(
        r#"
program test
    character(len=20) :: s
