...
c!(
    alloc_with_source_scalar_23,
    "program p\ninteger, allocatable :: x\nallocate(x, source=5)\nend program p\n"
);
c!(
    alloc_with_stat_dealloc_24,
    "program p\ninteger, allocatable :: a(:)\ninteger :: st\nallocate(a(2), stat=st)\ndeallocate(a, stat=st)\nend program p\n"
);
c!(
    alloc_nested_comp_25,
    "type :: t\ninteger, allocatable :: a(:)\nend type t\nprogram p\ntype(t), allocatable :: x\nallocate(x)\nallocate(x%a(2))\nend program p\n"
);
c!(
    alloc_default_init_26,
...
c!(
    alloc_mold_scalar_28,
    "program p\ninteger, allocatable :: a,b\nallocate(b)\nallocate(a, mold=b)\nend program p\n"
);
c!(
    alloc_source_char_29,
