...
fn test_tostring_default_offset() {
    assert_eq!(
        run_lua_one(r#"print(tostring(" spaced ") == " spaced ")"#),
        "true"
    );
}
...
fn test_tostring_default_captured() {
    assert_eq!(
        run_lua_one(r#"print(tostring("table") == "table")"#),
        "true"
    );
}
...
fn test_tostring_default_edge_first() {
    assert_eq!(
        run_lua_one(r#"print(tostring("function") == "function")"#),
        "true"
    );
}
...
fn test_tostring_default_edge_last() {
    assert_eq!(
        run_lua_one(r#"print(tostring("alpha") == "alpha")"#),
        "true"
    );
}
...
fn test_tostring_default_unicode_like() {
    assert_eq!(
        run_lua_one(r#"print(tostring("gamma") == "gamma")"#),
        "true"
    );
}
