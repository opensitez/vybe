...
fn test_string_rep_basic_baseline() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 1) == string.rep("x", 1))"#), "true");
}


#[test]
fn test_string_rep_basic_simple() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 2) == string.rep("x", 2))"#), "true");
}


#[test]
fn test_string_rep_basic_trimmed() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 3) == string.rep("x", 3))"#), "true");
}


#[test]
fn test_string_rep_basic_decimal() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 4) == string.rep("x", 4))"#), "true");
}


#[test]
fn test_string_rep_basic_hexed() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 5) == string.rep("x", 5))"#), "true");
}


#[test]
fn test_string_rep_basic_prefixed() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 6) == string.rep("x", 6))"#), "true");
}


#[test]
fn test_string_rep_basic_negative() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 7) == string.rep("x", 7))"#), "true");
}


#[test]
fn test_string_rep_basic_rounded() {
    assert_eq!(run_lua_one(r#"print(string.rep("x", 8) == string.rep("x", 8))"#), "true");
}
