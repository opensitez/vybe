...
fn test_debug_getinfo_tail_trimmed() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "f")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_hexed() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "u")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_negative() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nS")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_rounded() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nSl")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_offset() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nu")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_paired() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nl")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_nested() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "fS")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_metaflow() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "fL")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_guarded() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "fSlu")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_mapped() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nSf")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_captured() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nLu")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_edge_first() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nlf")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_edge_second() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "Slu")
print(type(info) == "table")"#
        ),
        "true"
    );
...
fn test_debug_getinfo_tail_edge_last() {
    assert_eq!(
        run_lua_one(
            r#"local info = debug.getinfo(1, "nSu")
print(type(info) == "table")"#
        ),
        "true"
    );
