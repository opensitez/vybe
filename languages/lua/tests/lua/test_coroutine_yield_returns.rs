...
fn test_coroutine_yield_returns_baseline() {
    assert_eq!(
        run_lua_one(
            r#"local co = coroutine.create(function(x)
  coroutine.yield(x)
  return x + 1, x + 2
end)
local ok1, first = coroutine.resume(co, 1)
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 1 and ok2 and a == 2 and b == 3)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 2 and ok2 and a == 3 and b == 4)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 3 and ok2 and a == 4 and b == 5)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 4 and ok2 and a == 5 and b == 6)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 5 and ok2 and a == 6 and b == 7)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 6 and ok2 and a == 7 and b == 8)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 7 and ok2 and a == 8 and b == 9)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 8 and ok2 and a == 9 and b == 10)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 9 and ok2 and a == 10 and b == 11)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 10 and ok2 and a == 11 and b == 12)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 11 and ok2 and a == 12 and b == 13)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 12 and ok2 and a == 13 and b == 14)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 13 and ok2 and a == 14 and b == 15)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 14 and ok2 and a == 15 and b == 16)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 15 and ok2 and a == 16 and b == 17)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 16 and ok2 and a == 17 and b == 18)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 17 and ok2 and a == 18 and b == 19)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 18 and ok2 and a == 19 and b == 20)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 19 and ok2 and a == 20 and b == 21)"#
        ),
        "true"
    );
}
...
local ok2, a, b = coroutine.resume(co)
print(ok1 and first == 20 and ok2 and a == 21 and b == 22)"#
        ),
        "true"
    );
}
