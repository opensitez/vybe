...
#[test]
fn sub_case_02() {
    compile_ok(&p("01 A PIC 99 VALUE 20.", "    SUBTRACT 5 FROM A."));
}
#[test]
fn sub_case_03() {
    compile_ok(&p(
...
fn sub_case_07() {
    compile_ok(&p(
        "01 A PIC 9 VALUE 7.\n01 B PIC 9 VALUE 1.",
        "    SUBTRACT B FROM A NOT ON SIZE ERROR DISPLAY \"O\" END-SUBTRACT.",
    ));
}
#[test]
fn sub_case_08() {
...
#[test]
fn mul_case_02() {
    compile_ok(&p("01 A PIC 9 VALUE 4.", "    MULTIPLY 2 BY A."));
}
#[test]
fn mul_case_03() {
    compile_ok(&p(
...
fn mul_case_07() {
    compile_ok(&p(
        "01 A PIC 9 VALUE 2.\n01 B PIC 9 VALUE 2.",
        "    MULTIPLY A BY B NOT ON SIZE ERROR DISPLAY \"O\" END-MULTIPLY.",
    ));
}
#[test]
fn mul_case_08() {
...
#[test]
fn div_case_02() {
    compile_ok(&p("01 A PIC 99 VALUE 20.", "    DIVIDE 2 INTO A."));
}
#[test]
fn div_case_03() {
    compile_ok(&p(
...
#[test]
fn cmp_case_01() {
    compile_ok(&p("01 R PIC 999 VALUE 0.", "    COMPUTE R = 1 + 2 + 3."));
}
#[test]
fn cmp_case_02() {
    compile_ok(&p("01 R PIC 999 VALUE 0.", "    COMPUTE R = (2 + 3) * 4."));
}
#[test]
fn cmp_case_03() {
    compile_ok(&p("01 R PIC S999 VALUE 0.", "    COMPUTE R = -5 + 1."));
}
#[test]
fn cmp_case_04() {
    compile_ok(&p("01 R PIC 999 VALUE 0.", "    COMPUTE R = 20 / 4."));
}
#[test]
fn cmp_case_05() {
    compile_ok(&p("01 R PIC 999 VALUE 0.", "    COMPUTE R = 2 * (3 + 4)."));
...
#[test]
fn cmp_case_06() {
    compile_ok(&p("01 R PIC 999 VALUE 0.", "    COMPUTE R = 9 - 7 + 5."));
}
#[test]
fn cmp_case_07() {
    let out = run_prints(&p(
