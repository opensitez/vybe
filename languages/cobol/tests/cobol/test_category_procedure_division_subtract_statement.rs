...
cobol_test!(
    test_subtract_size_error_false_path,
...
cobol_test!(
    test_subtract_size_error_true_path,
...
cobol_test!(
    test_subtract_multiple_from_runtime,
    "IDENTIFICATION DIVISION. PROGRAM-ID. T. DATA DIVISION. WORKING-STORAGE SECTION. 01 V1 PIC 9 VALUE 10. 01 V2 PIC 9 VALUE 1. 01 V3 PIC 9 VALUE 2. 01 V4 PIC 9 VALUE 3. PROCEDURE DIVISION. SUBTRACT V2 V3 FROM V1 V4 DISPLAY V1 DISPLAY V4 STOP RUN.",
    vec!["5", "3"]
);
