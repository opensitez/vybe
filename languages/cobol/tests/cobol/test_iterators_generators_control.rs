...
#[test]
fn iter_search_pattern_compiles() {
    compile_ok(&p(
...
#[test]
fn iter_search_all_pattern_compiles() {
    compile_ok(&p(
...
#[test]
fn iter_table_walk_with_accumulator_compiles() {
    compile_ok(&p(
...
#[test]
fn iter_search_with_at_end_clause_compiles() {
    compile_ok(&p(
...
#[test]
fn iter_nested_table_traversal_compiles() {
    compile_ok(&p(
...
#[test]
fn iter_search_all_numeric_key_compiles() {
    compile_ok(&p(
...
#[test]
fn iter_perform_until_with_table_condition_compiles() {
    compile_ok(&p(
        "01 I PIC 9 VALUE 1.\n01 T PIC 9 OCCURS 3 TIMES.\n01 F PIC 9 VALUE 0.",
...
#[test]
fn iter_varying_by_step_compiles() {
    compile_ok(&p(
