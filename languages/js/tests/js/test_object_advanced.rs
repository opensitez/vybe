...
#[test]
fn object_create_null_no_proto() {
    assert_eq!(
        run_js(
            r#"
...
#[test]
fn define_property_getter_setter() {
    assert_eq!(
        run_js(
            r#"
let obj = { _name: "Alice" };
...
#[test]
fn define_property_non_writable() {
    assert_eq!(
        run_js(
            r#"
let obj = {};
...
#[test]
fn define_property_non_enumerable() {
    assert_eq!(
        run_js(
            r#"
let obj = { a: 1, b: 2 };
...
#[test]
fn object_assign_override_order() {
    assert_eq!(
        run_js(
            r#"
...
#[test]
fn get_own_property_descriptor_value_flags() {
    assert_eq!(
        run_js(
            r#"
let obj = { a: 1 };
...
#[test]
fn object_defineproperties_multiple_fields() {
    assert_eq!(
        run_js(
            r#"
let obj = {};
...
#[test]
fn object_prevent_extensions_blocks_new_properties() {
    assert_eq!(
        run_js(
            r#"
let obj = { a: 1 };
...
#[test]
fn object_getprototypeof_object_create_chain() {
    assert_eq!(
        run_js(
            r#"
let proto = { kind: "base" };
