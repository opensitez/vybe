...
#[test]
fn string_interpolation_method_call() {
    assert_eq!(
        run_csharp(
            r#"
string s = "hello";
...
#[test]
fn string_contains_startswith_endswith() {
    assert_eq!(
        run_csharp(
            r#"
string s = "Hello World";
...
#[test]
fn fully_qualified_system_string_format() {
    assert_eq!(
        run_csharp(
            r#"
...
#[test]
fn string_methods_use_stdlib_not_vybe_string_hosts() {
...
"#,
    ...
    for forbidden in ["isNullOrEmpty", "insert", "remove"] {
        assert!(
            !imports
                .iter()
                .any(|(module, name)| module == "vybe:string" && name == forbidden),
...
#[test]
fn stringbuilder_insert_replace() {
    assert_eq!(
        run_csharp(
            r#"
...
#[test]
fn verbatim_string_with_quotes() {
    assert_eq!(
        run_csharp(
            r#"
