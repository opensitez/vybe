...
#[test]
fn array_initialization_syntax() {
    assert_eq!(
        run_csharp(
            r#"
int[] a = { 1, 2, 3, 4, 5 };
...
#[test]
fn collection_initializer_dict() {
    assert_eq!(
        run_csharp(
            r#"
