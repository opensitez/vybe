...
fn string_toupper() {
    assert_eq!(
        run_csharp_one(r#"Console.WriteLine("hello".ToUpper());"#),
        "HELLO"
    );
}
...
fn string_tolower() {
    assert_eq!(
        run_csharp_one(r#"Console.WriteLine("HELLO".ToLower());"#),
        "hello"
    );
}
...
fn string_trim() {
    assert_eq!(
        run_csharp_one(r#"Console.WriteLine("  hi  ".Trim());"#),
        "hi"
    );
}
...
fn string_contains() {
    assert_eq!(
        run_csharp_one(r#"Console.WriteLine("hello world".Contains("world"));"#),
        "True"
    );
}
...
fn string_replace() {
    assert_eq!(
        run_csharp_one(r#"Console.WriteLine("hello world".Replace("world", "C#"));"#),
        "hello C#"
    );
}
...
fn string_indexof() {
    assert_eq!(
        run_csharp_one(r#"Console.WriteLine("hello world".IndexOf("world"));"#),
        "6"
    );
}
...
fn chained_string_methods() {
    assert_eq!(
        run_csharp_one(r#"Console.WriteLine("  Hello World  ".Trim().ToUpper());"#),
        "HELLO WORLD"
    );
}
