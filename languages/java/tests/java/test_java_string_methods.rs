...
jt!(
    string_contains_true,
    "System.out.println(\"dynamic\".contains(\"nam\"));",
    "true"
);
jt!(
    string_contains_false,
    "System.out.println(\"dynamic\".contains(\"nom\"));",
    "false"
);
jt!(
    string_starts_with,
...
jt!(
    string_replace_char,
    "System.out.println(\"cava\".replace('a','o'));",
    "covo"
);
jt!(
...
jt!(
    string_index_of_substring,
    "System.out.println(\"abracadabra\".indexOf(\"cad\"));",
    "3"
);
jt!(
    string_compare_to_true,
    "System.out.println(\"aa\".compareTo(\"ab\"));",
    "-1"
);
jt!(
    string_compare_to_false,
    "System.out.println(\"ab\".compareTo(\"aa\"));",
    "1"
);
jt!(
    string_compare_to_equal,
    "System.out.println(\"same\".compareTo(\"same\"));",
    "0"
);
jt!(
    string_split_parts,
    "System.out.println(java.util.Arrays.toString(\"a,b,c\".split(\"\\,\"))[1]);",
    "b"
);
jt!(
...
jt!(
    string_region_matches_true,
    "System.out.println(\"abcdef\".regionMatches(1, \"bc\", 0, 2));",
    "true"
);
jt!(
    string_region_matches_false,
    "System.out.println(\"abcdef\".regionMatches(1, \"bd\", 0, 2));",
    "false"
);
jt!(
    string_equals_ignore_case_true,
