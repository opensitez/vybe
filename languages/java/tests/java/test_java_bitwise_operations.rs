...
jt!(unsigned_right_shift_positive, "System.out.println(8 >>> 2);", "2");
jt!(unsigned_right_shift_negative, "System.out.println((-8) >>> 30);", "3");
...
jt!(mixed_bitwise_ops, "int v = 7; int w = (v << 1) & 10; System.out.println(w);", "6");
jt!(bit_mask_and_shift, "int v = 1; v = (v << 4) | 3; v &= 19; System.out.println(v);", "19");
jt!(multiple_shifts, "int v = 1; int r = (v << 8) >> 2; System.out.println(r);", "64");
jt!(sign_bit_check, "int v = Integer.MIN_VALUE; System.out.println((v & Integer.MIN_VALUE) != 0);", "true");
...
jt!(mask_parity, "int v = 13; System.out.println((v & 2) == 0);", "false");
jt!(ternary_with_bitops, "int v = 2; System.out.println((v & 1) == 0 ? 0 : 1);", "0");
jt!(bitwise_addition_flags, "int a = 1; a <<= 2; a |= 1; System.out.println(a);", "5");
jt!(double_shift_back, "int a = 12; a >>= 2; a <<= 2; System.out.println(a);", "8");
