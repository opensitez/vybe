...
jt!(switch_char_a, "char c = 'a'; int v = 0; switch (c) { case 'a': v = 1; break; case 'b': v = 2; break; default: v = 0; } System.out.println(v);", "1");
jt!(switch_char_b, "char c = 'b'; int v = 0; switch (c) { case 'a': v = 1; break; case 'b': v = 2; break; default: v = 0; } System.out.println(v);", "2");
jt!(switch_char_default, "char c = 'z'; int v = 0; switch (c) { case 'a': v = 1; break; case 'b': v = 2; break; default: v = 3; } System.out.println(v);", "3");
jt!(switch_char_numeric_addition, "char c = 'c'; int s = 0; switch (c) { case 'a': s = 1; break; case 'c': s = c; break; default: s = 0; } System.out.println(s - 96);", "3");
...
jt!(switch_upper_lower, "char c = 'F'; String s = \"\"; switch (c) { case 'F': s = \"up\"; break; case 'f': s = \"low\"; break; default: s = \"none\"; } System.out.println(s);", "up");
jt!(switch_pairing, "char c = 'h'; int a = 0; switch (c) { case 'g': a = 1; break; case 'h': a = 2; break; case 'i': a = 3; break; default: a = 4; } System.out.println(a);", "2");
jt!(switch_many, "char c = 'm'; int a = 0; switch (c) { case 'k': a = 1; case 'l': a = 2; case 'm': a = 3; default: a = 4; } System.out.println(a);", "4");
jt!(switch_in_loop_chars, "char[] c = {'a','b','c'}; int s = 0; for (int i = 0; i < c.length; i++) { switch (c[i]) { case 'a': s += 1; break; case 'b': s += 2; break; default: s += 3; } } System.out.println(s);", "6");
jt!(switch_with_escape, "char c = '\\t'; int v = 0; switch (c) { case '\\n': v = 1; break; case '\\t': v = 2; break; default: v = 0; } System.out.println(v);", "2");
jt!(switch_derived_index, "char c = 'd'; int idx = c - 'a'; int v = 0; switch (idx) { case 3: v = 3; break; default: v = 0; } System.out.println(v);", "3");
jt!(switch_char_and_string, "char c = 'b'; String s = \"\"; switch (c) { case 'a': s = \"1\"; break; case 'b': s = \"2\"; break; default: s = \"3\"; } System.out.println(s);", "2");
...
jt!(switch_on_char_array, "char[] c = {'x','y'}; int total = 0; for (int i = 0; i < c.length; i++) { switch (c[i]) { case 'x': total += 1; break; case 'y': total += 2; break; default: total += 3; } } System.out.println(total);", "3");
jt!(switch_char_ternary_mix, "char c = 'a'; String s = \"\"; switch (c) { case 'a': s = \"a\"; break; case 'b': s = \"b\"; break; default: s = \"z\"; } System.out.println(s.equals(\"a\") ? 1 : 0);", "1");
