...
jt!(continue_skips, "int sum = 0; int i = 0; do { i++; if (i == 2) continue; sum += i; } while (i < 4); System.out.println(sum);", "8");
...
jt!(do_while_mutating_condition, "int i = 0; int x = 0; do { x += i; i *= 2; i++; } while (i < 4); System.out.println(x);", "4");
...
jt!(double_stage, "int x = 0; int i = 0; do { x += i; i++; } while (i < 2); do { x += i; i++; } while (i < 4); System.out.println(x);", "6");
jt!(nested_do_while, "int total = 0; int i = 0; do { int j = 0; do { total += j; j++; } while (j < 2); i++; } while (i < 3); System.out.println(total);", "3");
...
jt!(break_nested, "int a = 0; int b = 0; do { a++; if (a == 1) { b++; continue; } if (a == 3) { break; } b += a; } while (a < 5); System.out.println(a + \",\" + b);", "3,3");
...
jt!(modulo_in_body, "int i = 0; int c = 0; do { c += i % 3; i++; } while (i < 5); System.out.println(c);", "4");
