...
jt!(
    parenthesized_add_first,
    "System.out.println((2 + 3) * 4);",
    "20"
);
jt!(
    parenthesized_divide_first,
...
jt!(
    comparison_precedes_bitwise,
    "System.out.println(1 + 2 > 2 ? 10 : 1);",
    "10"
);
jt!(
    and_vs_or_precedence,
    "System.out.println(1 + 2 | 4 & 3);",
    "7"
);
jt!(
    bitwise_and_precedes_or,
    "System.out.println(1 + (2 | 3));",
    "6"
);
jt!(shift_precedence, "System.out.println(1 + 1 << 2);", "4");
jt!(
    shift_with_parentheses,
...
jt!(
    nested_conditional,
    "System.out.println((2 > 1 ? 10 : 20) + 1);",
    "11"
);
jt!(
    equality_chain_left_assoc,
    "System.out.println(1 + 2 == 3);",
    "true"
);
jt!(
