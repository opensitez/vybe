...
jt!(
    int_div_by_var,
    "int a = 1; int b = 2; System.out.println(4 / b + a);",
    "3"
);
jt!(
    division_chain,
    "int a = 10; int b = 2; int c = 3; System.out.println(a / b / c);",
    "1"
);
jt!(
    mod_chain,
...
jt!(
    division_mixed,
    "int a = 10; double b = 4.0; System.out.println(a / b);",
    "2.5"
);
jt!(
    mod_mixed,
...
jt!(
    percentile_like,
    "int[] a = {10,20,30,40}; int s = 0; for (int v : a) { s += v / 10; } System.out.println(s);",
    "10"
);
jt!(
    floor_div_alias,
...
jt!(
    double_div_by_zero,
    "System.out.println(Double.isInfinite(5.0 / 0.0));",
    "true"
);
...
jt!(
    divide_precedence,
    "System.out.println(18 / 3 + 2 * 2);",
    "10"
);
jt!(
    division_precedence_parenthesis,
    "System.out.println(18 / (3 + 2) * 2);",
    "6"
);
jt!(
    cast_division_before,
