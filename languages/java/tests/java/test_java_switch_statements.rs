...
jt!(switch_with_char, "char c='b'; String out=""; switch(c){case 'a':out="A";break;case 'b':out="B";break;default:out="Z";} System.out.println(out);", "B");
jt!(string_switch_match, "String s="two"; String out=""; switch(s){case "one":out="1";break;case "two":out="2";break;default:out="0";} System.out.println(out);", "2");
jt!(string_switch_default, "String s="x"; String out=""; switch(s){case "a":out="A";break;case "b":out="B";break;default:out="D";} System.out.println(out);", "D");
...
jt!(switch_on_modulo, "int x=7; int r=0; switch(x % 3){case 1:r=10;break;case 2:r=20;break;default:r=30;} System.out.println(r);", "20");
...
jt!(switch_with_post_increment, "int x=1; String label; switch(x++){case 1: label="one"; break; default: label="no";} System.out.println(label + "|" + x);", "one|2");
jt!(switch_on_byte, "byte x=1; int y=0; switch(x){case 1:y=4;break;case 2:y=8;break;default:y=0;} System.out.println(y);", "4");
jt!(switch_with_negative, "int x=-1; String out=""; switch(x){case -1:out="neg";break;case 1:out="pos";break;default:out="zero";} System.out.println(out);", "neg");
jt!(switch_string_builder_concat, "String x="ok"; StringBuilder sb = new StringBuilder(); switch(x){case "ok":sb.append("yes");break;default:sb.append("no");} System.out.println(sb.toString());", "yes");
...
jt!(switch_with_returning_value, "int x=4; String out; switch(x){case 1:out="a";break;case 2:out="b";break;case 3:out="c";break;default:out="d";} System.out.println(out);", "d");
