...
jt!(binary_with_underscores, "System.out.println(0b1010_1111);", "175");
...
jt!(long_suffix_literal, "System.out.println(3000000000L);", "3000000000");
jt!(long_literal_addition, "System.out.println(1L + 2L);", "3");
jt!(float_literal, "System.out.println(3.5f);", "3.5");
jt!(float_suffix_and_addition, "System.out.println(1.25f + 1.25f);", "2.5");
jt!(double_scientific, "System.out.println(2.5e2);", "250.0");
jt!(double_negative_scientific, "System.out.println(-1.5e1);", "-15.0");
jt!(decimal_and_fractional, "System.out.println(5.0 + 2.5);", "7.5");
...
jt!(string_escape_backslash_n, "System.out.println(\"x\\ny\");", "x\ny");
jt!(string_unicode_escape, "System.out.println(\"A\\u0042C\");", "ABC");
jt!(string_literal_empty, "System.out.println(\"\".length());", "0");
