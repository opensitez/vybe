...
jm!(catch_runtime_exception, "try { throw new RuntimeException(\"x\"); } catch (Exception e) { System.out.println(e.getClass().getSimpleName()); }", "", "RuntimeException");
jm!(
...
jm!(custom_exception_round_trip, "class MyErr extends RuntimeException { MyErr(String s) { super(s); } } try { throw new MyErr(\"ok\"); } catch (MyErr e) { System.out.println(e.getMessage()); }", "", "ok");
jm!(
...
jm!(rethrow_in_catch, "try { try { throw new IllegalStateException(); } catch (IllegalStateException e) { throw e; } } catch (IllegalStateException e) { System.out.println(\"again\"); }", "", "again");
jm!(
...
jm!(null_pointer_to_string, "try { String s = null; System.out.println(s.length()); } catch (NullPointerException e) { System.out.println(\"np\"); }", "", "np");
jm!(
...
jm!(try_with_checked_exception_method, "try { Checked.raise(); } catch (Exception e) { System.out.println(e.getMessage()); }", "static class Checked { static void raise() throws Exception { throw new Exception(\"x\"); } }", "x");
jm!(
...
jm!(add_suppressed_exception, "try { try { throw new RuntimeException(); } catch (RuntimeException e) { Exception wrapped = new Exception(\"wrapped\"); wrapped.addSuppressed(e); throw wrapped; } } catch (Exception e) { System.out.println(e.getSuppressed().length); }", "", "1");
jm!(message_length_on_throw, "try { throw new RuntimeException(\"boom\"); } catch (RuntimeException e) { System.out.println(e.getMessage().length()); }", "", "4");
jm!(
...
jm!(rethrow_and_catch_outer, "try { try { throw new IllegalArgumentException(); } catch (IllegalArgumentException e) { throw e; } } catch (RuntimeException e) { System.out.println(\"outer\"); }", "", "outer");
jm!(
...
jm!(runtime_exception_rethrow_message, "try { try { throw new RuntimeException(\"first\"); } catch (RuntimeException e) { throw new RuntimeException(e.getMessage() + \"-x\"); } } catch (RuntimeException e) { System.out.println(e.getMessage()); }", "", "first-x");
