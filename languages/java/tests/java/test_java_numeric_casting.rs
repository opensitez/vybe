...
jt!(double_negative_to_int, "System.out.println((int)-7.9);", "-7");
...
jt!(short_to_int, "short s = 120; System.out.println((int)s);", "120");
jt!(char_to_int, "char c = 'A'; System.out.println((int)c);", "65");
...
jt!(cast_math_result, "System.out.println((int)(5.0 / 2.0));", "2");
jt!(cast_after_multiplication, "System.out.println((int)(8 * 1.5));", "12");
jt!(cast_roundtrip, "double d = 12.0; System.out.println((int)d);", "12");
jt!(char_expression_sum, "System.out.println((char)('A' + 1));", "B");
jt!(byte_plus_byte_to_int, "byte a = 10; byte b = 20; System.out.println((int)(a + b));", "30");
jt!(byte_to_short, "byte a = 5; short s = (short)a; System.out.println(s);", "5");
jt!(long_div_to_int, "System.out.println((int)(10L / 3L));", "3");
jt!(double_expression_to_long, "System.out.println((long)(9.9 + 0.1));", "10");
