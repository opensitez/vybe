...
jt!(fallthrough_with_loops, "int total = 0; for (int n = 1; n < 4; n++) { int s = 0; switch (n) { case 1: s += n; case 2: s += n; case 3: s += n; } total += s; } System.out.println(total);", "12");
...
jt!(fallthrough_with_update, "int n = 2; int v = 0; switch (n) { case 1: v += 1; v *= 2; case 2: v += 3; v *= 2; case 3: v += 5; } System.out.println(v);", "16");
jt!(fallthrough_if_guard, "int n = 1; int s = 0; switch (n) { case 1: s += 1; if (s > 0) {} case 2: s += 2; case 3: s += 3; } System.out.println(s);", "6");
jt!(fallthrough_with_method, "int n = 3; int s = 0; switch (n) { case 1: s += \"1\".length(); case 2: s += \"2\".length(); case 3: s += \"3\".length(); } System.out.println(s);", "3");
...
jt!(fallthrough_with_default_then_more, "int n = 10; int s = 0; switch (n) { default: s += 4; case 1: s += 1; case 2: s += 2; } System.out.println(s);", "6");
...
jt!(fallthrough_nested_loops, "int total = 0; for (int n = 1; n <= 3; n++) { int s = 0; switch (n) { case 1: s += 1; case 2: s += 2; default: s += 3; } total += s; } System.out.println(total);", "13");
jt!(fallthrough_condition, "int n = 1; int s = 0; switch (n) { case 1: s += 1; if (n > 0) { s += 10; } case 2: s += 2; default: s += 3; } System.out.println(s);", "16");
jt!(fallthrough_math_ops, "int n = 3; int s = 1; switch (n) { case 1: s += 1; case 2: s *= 2; case 3: s *= 3; default: s += 4; } System.out.println(s);", "10");
