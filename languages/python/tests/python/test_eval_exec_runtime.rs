...
crate::runtime_case!(eval_literal_int, "print(eval('1 + 2'))\n", "3");
crate::runtime_case!(eval_literal_list, "print(eval('[1, 2, 3]'))\n", "[1, 2, 3]");
crate::runtime_case!(eval_with_globals, "print(eval('x + 1', {'x': 5}))\n", "6");
crate::runtime_case!(eval_with_locals, "print(eval('x', {}, {'x': 9}))\n", "9");
crate::runtime_case!(
    exec_assign,
    "ns = {}\nexec('y = 7', ns)\nprint(ns['y'])\n",
    "7"
...
crate::runtime_case!(eval_expr_name, "x = 10\nprint(eval('x'))\n", "10");
crate::runtime_case!(eval_builtin_call, "print(eval('len([1,2,3])'))\n", "3");
crate::runtime_case!(
    exec_function_def,
...
crate::runtime_case!(eval_dict_literal, "print(eval('{\"a\": 1}'))\n", "{'a': 1}");
crate::runtime_case!(eval_bool_ops, "print(eval('True and False'))\n", "False");
crate::runtime_case!(eval_comparison, "print(eval('3 < 5'))\n", "True");
crate::runtime_case!(
    exec_import,
    "ns = {}\nexec('import math', ns)\nprint(ns['math'].sqrt(9))\n",
    "3.0"
);
crate::runtime_case!(eval_lambda, "print(eval('(lambda x: x + 1)(5)'))\n", "6");
crate::runtime_case!(
    compile_ast_mode,
    "c = compile('1+1', '<s>', 'eval', flags=0)\nprint(eval(c))\n",
    "2"
);
crate::runtime_case!(eval_nested, "print(eval('eval(\"1+1\")'))\n", "2");
crate::runtime_case!(
    exec_for_loop,
...
crate::runtime_case!(eval_tuple, "print(eval('(1, 2)'))\n", "(1, 2)");
crate::runtime_case!(eval_set, "print(sorted(eval('{1, 2, 3}')))\n", "[1, 2, 3]");
crate::runtime_case!(
    compile_filename,
    "c = compile('1', 'file.py', 'eval')\nprint(c.co_filename)\n",
    "file.py"
);
crate::runtime_case!(eval_string_concat, "print(eval(\"'a' + 'b'\"))\n", "ab");
crate::runtime_case!(
    exec_raise_caught,
    "ns = {}\ntry:\n exec('raise ValueError(\"e\")', ns)\n print('ok')\nexcept ValueError:\n print('err')\n",
    "err"
);
crate::runtime_case!(eval_none, "print(eval('None'))\n", "None");
crate::runtime_case!(eval_float, "print(eval('3.14'))\n", "3.14");
crate::runtime_case!(
...
crate::runtime_case!(eval_ternary, "print(eval('1 if 2 > 1 else 0'))\n", "1");
crate::runtime_case!(
    exec_try_except,
    "ns = {}\nexec('try:\\n 1/0\\nexcept ZeroDivisionError:\\n err = 1', ns)\nprint(ns['err'])\n",
    "1"
);
crate::runtime_case!(eval_bytes_literal, "print(eval(\"b'hi'\"))\n", "b'hi'");
crate::runtime_case!(
