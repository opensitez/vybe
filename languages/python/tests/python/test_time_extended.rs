...
crate::runtime_case!(
    time_struct_time_index,
    "import time\nt = time.gmtime(0)\nprint(t[0])\n",
    "1970"
);
crate::runtime_case!(
    time_struct_time_slice,
    "import time\nt = time.gmtime(0)\nprint(t[0:2])\n",
    "(1970, 1)"
);
crate::runtime_case!(
...
crate::runtime_case!(
    time_strftime_minute,
    "import time\nprint(time.strftime('%M', time.gmtime(0)))\n",
    "00"
);
crate::runtime_case!(
    time_strftime_second,
...
crate::runtime_case!(
    time_strftime_weeknum,
    "import time\nprint(time.strftime('%U', time.gmtime(0)))\n",
    "00"
);
crate::runtime_case!(
    time_strftime_isocalendar,
    "import time\nt = time.gmtime(0)\nprint(t.tm_yday)\n",
    "1"
);
crate::runtime_case!(
