...
compile_case!(
    bytearray_extend_compile,
    "b = bytearray(b'a')\nb.extend(b'bc')\n"
);
compile_case!(
    bytearray_pop_compile,
    "b = bytearray(b'abc')\nx = b.pop()\n"
);
compile_case!(
    bytearray_remove_compile,
    "b = bytearray([1, 2, 3])\nb.remove(2)\n"
);
compile_case!(
    bytearray_reverse_compile,
    "b = bytearray(b'abc')\nb.reverse()\n"
);
compile_case!(
    bytearray_clear_compile,
    "b = bytearray(b'abc')\nb.clear()\n"
);
compile_case!(
    bytearray_slice_compile,
    "b = bytearray(b'abcdef')\nx = b[1:4]\n"
);
compile_case!(
    bytearray_slice_assign_compile,
    "b = bytearray(b'abc')\nb[1:2] = b'XYZ'\n"
);
