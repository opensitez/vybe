...
ruby_test!(
    test_tan_pi_quarter,
    "puts Math.tan(Math::PI / 4).round(5)",
    "1.0"
);
...
ruby_test!(
    test_atan2_quadrant_1,
    "puts Math.atan2(1, 1) == Math::PI / 4",
    "true"
);
ruby_test!(
    test_asin_domain_error,
    "begin; Math.asin(2); rescue Math::DomainError; puts 'err'; end",
    "err"
);
ruby_test!(
    test_acos_domain_error,
    "begin; Math.acos(2); rescue Math::DomainError; puts 'err'; end",
    "err"
);
