...
ruby_test!(
    test_pow_negative_float,
    "puts (2 ** -1).class.name",
    "Rational"
);
ruby_test!(test_pow_modulo_basic, "puts 2.pow(3, 5)", "3");
ruby_test!(
    test_pow_modulo_zero_error,
    "begin; 2.pow(3, 0); rescue ZeroDivisionError; puts 'err'; end",
    "err"
);
ruby_test!(
...
ruby_test!(
    test_pow_modulo_negative_exponent_not_coprime,
    "begin; 2.pow(-1, 4); rescue ZeroDivisionError; puts 'err'; end",
    "err"
); // no inverse
