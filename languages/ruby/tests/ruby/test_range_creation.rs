...
ruby_test!(
    test_range_creation_inclusive,
    "r = 1..5; puts r.class.name",
    "Range"
);
ruby_test!(
    test_range_creation_exclusive,
    "r = 1...5; puts r.class.name",
    "Range"
);
ruby_test!(
    test_range_creation_endless,
    "r = (1..); puts r.class.name",
    "Range"
);
ruby_test!(
    test_range_creation_beginless,
    "r = (..5); puts r.class.name",
    "Range"
);
ruby_test!(test_range_begin, "puts (1..5).begin", "1");
ruby_test!(test_range_end, "puts (1..5).end", "5");
ruby_test!(
    test_range_exclude_end_inclusive,
    "puts (1..5).exclude_end?",
    "false"
);
ruby_test!(
    test_range_exclude_end_exclusive,
    "puts (1...5).exclude_end?",
    "true"
);
