...
ruby_test!(
    test_floor_negative_ndigits_negative_num,
    "puts -15.floor(-1)",
    "-20"
);
...
ruby_test!(
    test_ceil_negative_ndigits_negative_num,
    "puts -15.ceil(-1)",
    "-10"
);
