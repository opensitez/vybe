...
ruby_test!(
    test_rescue_basic,
    "begin; raise 'err'; rescue; puts 'rescued'; end",
    "rescued"
);
ruby_test!(
    test_rescue_class,
    "begin; raise ArgumentError; rescue ArgumentError; puts 'rescued arg'; end",
    "rescued arg"
);
ruby_test!(
