...
vb_full_spec!(
    delegate_spec_single_line_function_lambda_doubles_input,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_multiline_function_lambda_returns_branch_value,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_sub_lambda_prints_message,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_captures_local_variable,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_updates_captured_variable,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_be_passed_as_argument,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_lambda_can_be_returned_from_function,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_lambda_can_return_another_lambda,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_addressof_module_function_matches_func_delegate,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_addressof_instance_method_matches_func_delegate,
    r#"Class Counter
...
vb_full_spec!(
    delegate_spec_addressof_shared_method_matches_func_delegate,
    r#"Class MathBox
...
vb_full_spec!(
    delegate_spec_action_delegate_can_point_to_sub,
    r#"Module M
    Sub Speak()
...
vb_full_spec!(
    delegate_spec_predicate_delegate_returns_boolean_result,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_func_with_two_parameters_returns_sum,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_func_with_three_parameters_returns_total,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_close_over_parameter_from_factory,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_lambda_inside_loop_can_use_iteration_value,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_capture_reference_type_and_mutate_field,
    r#"Class Box
...
vb_full_spec!(
    delegate_spec_lambda_can_be_stored_in_list_of_actions,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_array_can_store_multiple_functions,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_delegate_invocation_list_runs_multicast_subs,
    r#"Module M
    Sub Main()
...
End Module"#,
    ...
    let action = vm
        .globals
        .get("action")
        .expect("expected module-level action global");
    ...
    let ObjectKind::Array(handlers) = &action_guard.kind else {
        panic!(
            "expected combined action to be an array invocation list, got {:?}",
            action_guard.kind
        );
    };
    assert_eq!(
        handlers.len(),
        2,
        "expected exactly two handlers in the invocation list"
    );
    for handler in handlers {
        ...
        assert!(
            matches!(handler_guard.kind, ObjectKind::Function(_)),
            "expected multicast handler to be a function, got {:?}",
            handler_guard.kind
        );
    }
}
...
End Module"#,
    ...
    assert!(
        output.is_empty(),
        "unexpected output while combining delegates: {output:?}"
    );
}

#[test]
fn delegate_spec_delegate_combine_compiles_without_overflow() {
    let module = vybe_language_vb::parse(r#"Module M
    Sub Main()
        Dim action As Action = Sub() Console.WriteLine("a")
        action = CType([Delegate].Combine(action, CType(Sub() Console.WriteLine("b"), Action)), Action)
    End Sub
...
fn delegate_spec_ctype_sub_lambda_compiles_without_overflow() {
    let module = vybe_language_vb::parse(
        r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_addhandler_with_lambda_receives_event,
    r#"Class Clock
...
vb_full_spec!(
    delegate_spec_removehandler_with_lambda_variable_detaches_listener,
    r#"Class Clock
    Public Event Tick()
...
vb_full_spec!(
    delegate_spec_custom_delegate_type_can_be_invoked,
    r#"Delegate Function Combiner(a As Integer, b As Integer) As Integer
Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_delegate_parameter_can_be_called_twice,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_delegate_return_value_can_flow_into_expression,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_call_private_helper_function,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_lambda_can_reference_me_member_inside_instance_method,
    r#"Class Counter
...
vb_full_spec!(
    delegate_spec_lambda_can_infer_parameter_type_from_delegate,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_multiline_sub_lambda_can_mutate_two_values,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_return_boolean_comparison,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_call_method_with_optional_parameter,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_lambda_can_be_selected_with_if_operator,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_return_string_concatenation,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_bind_to_event_style_signature,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_nested_lambda_can_capture_outer_lambda_variable,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_function_delegate_can_be_passed_through_function,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_action_delegate_can_be_returned_from_factory,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_lambda_can_capture_array_and_index_into_it,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_capture_dictionary_and_read_key,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_short_circuit_with_inline_if,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_delegate_can_target_constructor_via_lambda,
    r#"Class Box
    Public Value As Integer
...
vb_full_spec!(
    delegate_spec_lambda_can_capture_nullable_value,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_return_object_reference,
    r#"Class Box
...
vb_full_spec!(
    delegate_spec_delegate_can_chain_two_transform_functions,
    r#"Module M
...
vb_full_spec!(
    delegate_spec_lambda_can_capture_loop_built_string,
    r#"Module M
    Sub Main()
        Dim text As String = ""
        For i As Integer = 1 To 3
...
vb_full_spec!(
    delegate_spec_delegate_can_invoke_instance_method_after_state_change,
    r#"Class Counter
    Public Value As Integer
...
vb_full_spec!(
    delegate_spec_function_lambda_can_return_array_value,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_action_lambda_can_append_to_list,
    r#"Module M
    Sub Main()
...
vb_full_spec!(
    delegate_spec_lambda_can_project_object_field,
    r#"Class Box
