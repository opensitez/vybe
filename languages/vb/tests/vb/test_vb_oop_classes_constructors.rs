...
#[test]
fn class_object_initializer_no_parens() {
    assert_eq!(
        run_vb(
...
#[test]
fn class_constructor_parameterized() {
    assert_eq!(
        run_vb(
...
#[test]
fn class_constructor_overloads() {
    assert_eq!(
        run_vb(
            "Class C\nPublic V As Integer\nPublic Sub New()\nV = 1\nEnd Sub\nPublic Sub New(val As Integer)\nV = val\nEnd Sub\nEnd Class\nModule M\nSub Main()\nDim c1 As New C(2)\nConsole.WriteLine(c1.V)\nEnd Sub\nEnd Module"
        ),
...
#[test]
fn class_constructor_chaining_myclass() {
    assert_eq!(
        run_vb(
            "Class C\nPublic V As Integer\nPublic Sub New()\nMyClass.New(10)\nEnd Sub\nPublic Sub New(val As Integer)\nV = val\nEnd Sub\nEnd Class\nModule M\nSub Main()\nDim c1 As New C()\nConsole.WriteLine(c1.V)\nEnd Sub\nEnd Module"
        ),
...
#[test]
fn class_constructor_chaining_me() {
    assert_eq!(
        run_vb(
...
#[test]
fn class_field_initializer_runs_first() {
    assert_eq!(
        run_vb(
...
#[test]
fn class_shared_member_instance_access() {
    assert_eq!(
        run_vb(
            "Class C\nPublic Shared V As Integer = 1\nEnd Class\nModule M\nSub Main()\nDim c1 As New C()\nConsole.WriteLine(c1.V)\nEnd Sub\nEnd Module"
        ),
...
} // VB allows accessing Shared members via instance
#[test]
...
#[test]
fn class_generic_instantiation() {
    assert_eq!(
        run_vb(
...
#[test]
fn class_generic_multiple_types() {
    assert_eq!(
        run_vb(
...
#[test]
fn class_shadowing_constructor() {
    assert_eq!(
        run_vb(
