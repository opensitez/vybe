...
#[test]
fn gzencode_gzdecode_roundtrip() {
    compile_ok(
        r#"<?php
...
#[test]
fn gzdeflate_gzinflate_roundtrip() {
    compile_ok(
        r#"<?php
