...
#[test]
fn loose_zero_string_comparison() {
    compile_ok(
        r#"<?php
...
#[test]
fn coercion_string_to_int_arithmetic() {
    compile_ok(
        r#"<?php
$a = "5";
$b = $a + 3;
...
#[test]
fn coercion_concat_converts_to_string() {
    compile_ok(
        r#"<?php
$n = 42;
$f = 3.14;
...
#[test]
fn coercion_without_strict_types() {
    compile_ok(
        r#"<?php
