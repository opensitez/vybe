...
#[test]
fn constructor_promotion_public() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn constructor_promotion_defaults() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn constructor_promotion_mixed() {
    assert_eq!(
        run_prints(
            r#"<?php
class User {
...
#[test]
fn stringable_interface_type_hint() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn invoke_makes_object_callable() {
    assert_eq!(
        run_prints(
            r#"<?php
class Multiplier {
...
#[test]
fn magic_call_intercepts_missing_method() {
    assert_eq!(
        run_prints(
            r#"<?php
class Proxy {
...
#[test]
fn same_instance_triple_equal() {
    assert_eq!(
        run_prints(r#"<?php class A {} $a = new A; $b = $a; echo ($a === $b) ? 'same' : 'diff'; "#),
        vec!["same"]
    );
}
#[test]
fn clone_not_identical() {
    assert_eq!(
        run_prints(
            r#"<?php class A {} $a = new A; $b = clone $a; echo ($a === $b) ? 'same' : 'diff'; "#
        ),
        vec!["diff"]
    );
}
