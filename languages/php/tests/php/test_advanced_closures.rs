...
#[test]
fn closure_as_default_parameter_value() {
    compile_ok(
        r#"<?php
...
#[test]
fn closure_stored_in_object_property_called() {
    compile_ok(
        r#"<?php
class Handler {
...
#[test]
fn closure_modifies_external_array_by_ref() {
    compile_ok(
        r#"<?php
$items = [];
...
#[test]
fn closure_multiple_use_by_ref() {
    compile_ok(
        r#"<?php
$sum = 0;
$count = 0;
...
#[test]
fn closure_returned_from_method_bound_to_object() {
    compile_ok(
        r#"<?php
class Greeter {
...
#[test]
fn array_of_closures_iterate_and_call() {
    compile_ok(
        r#"<?php
$fns = [
    fn(int $x): int => $x + 1,
...
#[test]
fn closure_factory_returns_closure() {
    compile_ok(
        r#"<?php
...
#[test]
fn recursive_closure_via_use_ref() {
    compile_ok(
        r#"<?php
$factorial = null;
...
#[test]
fn closure_complex_usort_comparator() {
    compile_ok(
        r#"<?php
$people = [
    ['name' => 'Zara', 'age' => 25],
...
#[test]
fn closure_in_match_expression_arm() {
    compile_ok(
        r#"<?php
$op = 'double';
$fn = match ($op) {
...
#[test]
fn closure_in_ternary_expression() {
    compile_ok(
        r#"<?php
$flag = true;
...
#[test]
fn static_closure_no_this_binding() {
    compile_ok(
        r#"<?php
class Widget {
...
#[test]
fn closure_bind_to_different_class() {
    compile_ok(
        r#"<?php
...
#[test]
fn closure_stored_as_event_handler() {
    compile_ok(
        r#"<?php
class EventEmitter {
...
#[test]
fn closure_with_typed_parameter() {
    compile_ok(
        r#"<?php
