...
#[test]
fn serialize_object_with_private() {
    compile_ok(
        r#"<?php
class Secret {
...
#[test]
fn serialize_unserialize_magic() {
    assert_eq!(
        run_prints(
            r#"<?php
class DateRange {
...
#[test]
fn serialize_custom_representation() {
    assert_eq!(
        run_prints(
            r#"<?php
class Vector {
