...
#[test]
fn intersection_type_parameter_accepted() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn intersection_type_three_interfaces() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn intersection_return_type_both_methods_callable() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn dnf_type_union_of_intersection_and_class() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn dnf_nullable_intersection_type() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn intersection_requires_both_implementations() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn intersection_type_class_property() {
    compile_ok(
        r#"<?php
...
#[test]
fn instanceof_checks_each_interface_separately() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn dnf_type_used_in_function_dispatch() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn intersection_typed_collection_add_retrieve() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn intersection_type_in_closure_parameter() {
    compile_ok(
        r#"<?php
...
#[test]
fn dnf_type_with_null_coalescing() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn dnf_multiple_intersection_groups_in_union() {
    compile_ok(
        r#"<?php
...
#[test]
fn intersection_interface_static_not_part_of_intersection() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn runtime_interface_check_simulates_intersection() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn abstract_method_with_intersection_parameter() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn interface_method_intersection_return_type() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn dnf_type_enforced_via_instanceof_chain() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn intersection_type_narrower_is_subtype_of_single_interface() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn class_satisfying_intersection_accepted_as_single_type() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn null_standalone_type_in_union() {
    assert_eq!(
        run_prints(
            r#"<?php
