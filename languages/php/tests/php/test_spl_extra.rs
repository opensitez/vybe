...
#[test]
fn spl_dll_push_front_back_pop() {
    compile_ok(
        r#"<?php
...
#[test]
fn spl_priority_queue_priority_order() {
    compile_ok(
        r#"<?php
...
#[test]
fn spl_fixed_array_indexed_access() {
    compile_ok(
        r#"<?php
...
#[test]
fn spl_fixed_array_from_regular_array() {
    compile_ok(
        r#"<?php
...
#[test]
fn spl_object_storage_attach_detach() {
    compile_ok(
        r#"<?php
...
#[test]
fn spl_object_storage_with_data() {
    compile_ok(
        r#"<?php
$store = new SplObjectStorage();
$obj = new stdClass();
...
#[test]
fn spl_dll_rewind_current_next() {
    compile_ok(
        r#"<?php
$dll = new SplDoublyLinkedList();
...
#[test]
fn spl_min_heap_count_after_extractions() {
    compile_ok(
        r#"<?php
$h = new SplMinHeap();
...
#[test]
fn spl_priority_queue_identical_priorities() {
    compile_ok(
        r#"<?php
$pq = new SplPriorityQueue();
$pq->insert('task-a', 5);
...
#[test]
fn spl_object_storage_contains_check() {
    compile_ok(
        r#"<?php
$store = new SplObjectStorage();
