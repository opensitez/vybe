...
#[test]
fn intersection_type_narrows_both_interfaces() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn never_return_type_exit_path() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn nullsafe_null_returns_null_not_error() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn static_abstract_method_in_child() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_with_constructor_assistance() {
    assert_eq!(
        run_prints(
            r#"<?php
trait AutoId {
