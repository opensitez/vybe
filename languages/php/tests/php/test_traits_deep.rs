...
#[test]
fn trait_abstract_template_method() {
    compile_ok(
        r#"<?php
trait Report {
...
#[test]
fn trait_property_multiple_classes() {
    compile_ok(
        r#"<?php
trait HasId {
...
#[test]
fn trait_constant_multiple_uses() {
    compile_ok(
        r#"<?php
trait StatusCodes {
    const OK    = 200;
...
#[test]
fn trait_uses_another_via_class() {
    compile_ok(
        r#"<?php
trait HasTimestamps {
...
#[test]
fn trait_late_binding_in_static() {
    compile_ok(
        r#"<?php
trait Registry {
