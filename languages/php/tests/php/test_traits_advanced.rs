...
#[test]
fn trait_multiple_classes_share() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Timestamped {
...
#[test]
fn trait_abstract_forces_implementation() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Validator {
...
#[test]
fn trait_method_conflicts_resolved() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_method_aliased_private() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_in_abstract_class_used_by_concrete() {
    assert_eq!(
        run_prints(
            r#"<?php
trait EventEmitter {
...
#[test]
fn trait_requires_method_from_using_class() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Printable2 {
