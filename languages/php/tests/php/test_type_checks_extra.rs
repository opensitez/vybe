...
// ── is_countable ─────────────────────────────────────────────────
#[test]
fn is_countable_array_and_string() {
    compile_ok(
        r#"<?php
...
// ── is_resource ──────────────────────────────────────────────────
#[test]
fn is_resource_non_resource_value() {
    compile_ok(
        r#"<?php
$x = 42;
...
#[test]
fn var_export_return_true_assign() {
    compile_ok(
        r#"<?php
...
#[test]
fn get_defined_constants_has_entries() {
    compile_ok(
        r#"<?php
define('MY_CONST', 99);
...
#[test]
fn get_defined_functions_user_key() {
    compile_ok(
        r#"<?php
...
#[test]
fn debug_print_backtrace_compile_ok() {
    compile_ok(
        r#"<?php
function traced() {
    debug_print_backtrace();
...
// ── is_subclass_of ───────────────────────────────────────────────
#[test]
fn is_subclass_of_inheritance_check() {
    compile_ok(
        r#"<?php
class Animal {}
...
// ── is_a ─────────────────────────────────────────────────────────
#[test]
fn is_a_object_and_string_class() {
    compile_ok(
        r#"<?php
class Cat {}
...
#[test]
fn get_defined_vars_local_scope() {
    compile_ok(
        r#"<?php
function checkVars() {
    $x = 10;
