...
#[test]
fn throw_string() {
    compile_ok("void main() { try { throw 'an error'; } catch (e) { print(e); } }");
}
#[test]
fn throw_exception_class() {
    compile_ok("void main() { try { throw Exception('msg'); } catch (e) { } }");
}
#[test]
fn throw_in_function() {
    compile_ok("void fail(String msg) { throw Exception(msg); }");
}

#[test]
fn throw_string_result() {
...
#[test]
fn assert_basic() {
    compile_ok("void main() { assert(1 + 1 == 2); }");
}
#[test]
fn assert_with_message() {
    compile_ok("void main() { assert(true, 'must be true'); }");
}
