...
pub fn open_file(path: &str, mode: irys_parser::ast::stmt::FileOpenMode) -> Result<FileHandle, RuntimeError> {
    let file_path = Path::new(path);
    
    match mode {
        irys_parser::ast::stmt::FileOpenMode::Input => {
        ...
        irys_parser::ast::stmt::FileOpenMode::Output => {
        ...
        irys_parser::ast::stmt::FileOpenMode::Append => {
        ...
        irys_parser::ast::stmt::FileOpenMode::Binary => {
            let file = OpenOptions::new()
                .read(true)
                .write(true)
                .create(true)
        ...
        irys_parser::ast::stmt::FileOpenMode::Random => {
