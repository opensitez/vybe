...
#[test]
fn math_abs() { assert_eq!(run_js_one("console.log(Math.abs(-5))"), "5"); }

#[test]
fn math_floor() { assert_eq!(run_js_one("console.log(Math.floor(3.7))"), "3"); }

#[test]
fn math_ceil() { assert_eq!(run_js_one("console.log(Math.ceil(3.2))"), "4"); }

#[test]
fn math_sqrt() { assert_eq!(run_js_one("console.log(Math.sqrt(16))"), "4"); }

#[test]
fn math_round() { assert_eq!(run_js_one("console.log(Math.round(3.5))"), "4"); }
...
#[test]
fn math_pow() { assert_eq!(run_js_one("console.log(Math.pow(2, 10))"), "1024"); }
...
fn string_split_join() {
    assert_eq!(run_js_one(r#"console.log("a,b,c".split(",").join("-"))"#), "a-b-c");
}
...
#[test]
fn array_reduce() {
    assert_eq!(run_js_one(r#"console.log([1,2,3,4].reduce((a, b) => a + b, 0))"#), "10");
}

#[test]
fn array_find() {
    assert_eq!(run_js_one(r#"console.log([10, 20, 30].find(x => x > 15))"#), "20");
}
...
#[test]
fn array_slice() {
    assert_eq!(run_js_one(r#"console.log([1,2,3,4,5].slice(1,3).join(","))"#), "2,3");
}
