...
pub struct LanguageHooks {
    ...
    pub proxy_delete_property: Option<fn(&mut [Chunk], usize, u32)>,
    pub proxy_apply: Option<fn(&mut [Chunk], usize, u32)>,
    pub proxy_own_keys: Option<fn(&mut [Chunk], usize, u32)>,
    pub proxy_get_own_property_descriptor: Option<fn(&mut [Chunk], usize, u32)>,
    pub proxy_define_property: Option<fn(&mut [Chunk], usize, u32)>,
    pub proxy_get_prototype_of: Option<fn(&mut [Chunk], usize, u32)>,
    pub proxy_set_prototype_of: Option<fn(&mut [Chunk], usize, u32)>,
    pub proxy_is_extensible: Option<fn(&mut [Chunk], usize, u32)>,
