...
pub fn register(vm: &mut VM) {
    ...
    vm.register_host_fn("wasi:http", "get", Box::new(|_vm: &mut VM, args: &[Value]| {
        let url = s(args, 0);
    ...
    vm.register_host_fn("wasi:http", "post", Box::new(|_vm: &mut VM, args: &[Value]| {
        let url = s(args, 0);
        let body = s(args, 1);
    ...
    vm.register_host_fn("wasi:http", "fetch", Box::new(|_vm: &mut VM, args: &[Value]| {
        let url = s(args, 0);
