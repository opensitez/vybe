...
pub fn register(vm: &mut VM) {
    ...
    // p.color.g, p.color.b, p.color.a)` with real numeric args.
    {
        ...
        color_obj.properties.insert("__type".into(), Value::String(Arc::from("Color")));
        for (name, r, g, b) in palette {
            let alpha: u8 = if *name == "Transparent" { 0 } else { 255 };
            let mut c = Object::new();
            c.properties.insert("__type".into(), Value::String(Arc::from("Color")));
            c.properties.insert("name".into(), Value::String(Arc::from(*name)));
            ...
            color_obj.properties.insert(name.to_lowercase(), Value::Object(Arc::new(Mutex::new(c))));
        }
        vm.globals.insert("color".into(), Value::Object(Arc::new(Mutex::new(color_obj))));
    }
    ...
    vm.register_host_fn("vybe:gui", "fontNew", Box::new(|_ctx: &mut HostContext, args: &[Value]| {
        ...
        let mut obj = Object::new();
        obj.properties.insert("__type".into(), Value::String(Arc::from("Font")));
    ...
    vm.register_host_fn("vybe:gui", "color.fromargb", Box::new(|_ctx: &mut HostContext, args: &[Value]| {
        ...
        obj.properties.insert("name".into(), Value::String(Arc::from(format!("#{:02X}{:02X}{:02X}", r, g, b).as_str())));
        Value::Object(Arc::new(Mutex::new(obj)))
    }));
    ...
    vm.register_host_fn("vybe:gui", "graphicsNew", Box::new(|_ctx: &mut HostContext, _args: &[Value]| {
        ...
        obj.properties.insert("__control_name".into(), Value::String(Arc::from("graphics")));
        Value::Object(Arc::new(Mutex::new(obj)))
    }));
    ...
    vm.register_host_fn("vybe:gui", "hatchBrushNew", Box::new(|_ctx: &mut HostContext, args: &[Value]| {
        ...
        let mut obj = Object::new();
        obj.properties.insert("__type".into(), Value::String(Arc::from("HatchBrush")));
    ...
    vm.register_host_fn("vybe:gui", "linearGradientBrushNew", Box::new(|_ctx: &mut HostContext, args: &[Value]| {
        ...
        let mut obj = Object::new();
        obj.properties.insert("__type".into(), Value::String(Arc::from("LinearGradientBrush")));
