...
pub fn register(vm: &mut VM) {
    ...
    vm.register_host_fn("vybe:data", "dataTableNew", Box::new(|args: &[Value]| {
    ...
    // DataSet constructor
    vm.register_host_fn("vybe:data", "dataSetNew", Box::new(|args: &[Value]| {
    ...
    // DataTable.NewRow()
    vm.register_host_fn("vybe:data", "dataTableNewRow", Box::new(|_args: &[Value]| {
        let mut obj = Object::new();
    ...
    vm.register_host_fn("vybe:data", "dataTableAddRow", Box::new(|args: &[Value]| {
