//! # `wasm:js-value` — polymorphic method-dispatch shim
//!
//! The wasm js-builtins proposals publish **separate** import modules per
//! reflector (`wasm:js-array.*`, `wasm:js-string.*`, `wasm:js-map.*`,
...
//!
//! This module registers `wasm:js-value.invokeMethod(receiver, name,
...
// Callers on v8 go through `wasm:js-map.*` directly; Vybe's VM does the
