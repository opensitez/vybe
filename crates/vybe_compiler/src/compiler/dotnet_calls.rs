...
impl Compiler {
    ...
    pub(super) fn try_compile_dotnet_numeric_try_parse(
        &mut self,
        callee: &Expression,
        args: &[Argument],
    ) -> Result<bool, String> {
    ...
    pub(super) fn try_compile_dotnet_delegate_call(
        &mut self,
        callee: &Expression,
        args: &[Argument],
    ) -> Result<bool, String> {
    ...
    pub(super) fn try_compile_dotnet_formatted_tostring(
        &mut self,
        callee: &Expression,
        args: &[Argument],
    ) -> Result<bool, String> {
    ...
    pub(super) fn try_compile_dotnet_zero_arg_tostring(
        &mut self,
        callee: &Expression,
        args: &[Argument],
    ) -> Result<bool, String> {
