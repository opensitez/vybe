...
pub fn emit_tuple(chunks: &mut [Chunk], current: usize, n: u16, line: u32) {
    ...
    crate::compiler::collections::emit_pack_n(chunks, current, n, base, line);
...
pub fn emit_list_string_to_tuple(chunk: &mut Chunk, line: u32) {
    ...
    crate::compiler::strings::emit_str_concat(chunk, line);
    ...
    crate::compiler::ops::emit_dyn_gt(chunk, line);
