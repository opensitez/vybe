...
use crate::compiler::instructions::{core_wasm, host, recipes};
use std::sync::Arc;
...
pub fn build_async_generator_next(imports: &mut Chunk) -> Chunk {
    ...
    let try_patch = crate::compiler::errors::emit_try_start(&mut c, 0);
    ...
    c.emit_op_u16(Op::LOCAL_GET, value_local, 0);
    crate::compiler::functions::emit_await(&mut c, 0);
    c.emit_op_u16(Op::LOCAL_SET, value_local, 0);
    ...
    crate::compiler::errors::emit_try_end(&mut c, 0);
    ...
    crate::compiler::errors::patch_catch(&mut c, try_patch);
