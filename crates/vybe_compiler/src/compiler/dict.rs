...
pub fn emit_method_set(chunks: &mut [Chunk], current: usize, dict_slot: u16, line: u32) {
    ...
    crate::compiler::collections::emit_set(chunks, current, line);
    chunks[current].emit_op(Op::DROP, line);
...
pub fn emit_method_has(chunks: &mut [Chunk], current: usize, line: u32) {
    ...
    crate::compiler::ops::emit_i32_to_bool(&mut chunks[current], line);

    chunks[current].emit_else(line);

    chunks[current].emit_op_u16(Op::LOCAL_GET, keys_slot, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, key_slot, line);
    crate::compiler::collections::emit_contains(chunks, current, line);
...
pub fn emit_method_delete(chunks: &mut [Chunk], current: usize, line: u32) {
    ...
    chunks[current].emit_op_u16(Op::STRUCT_GET, keys_key, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, key_slot, line);
    crate::compiler::collections::emit_index_of(chunks, current, line);
    ...
    chunks[current].emit_op_u16(Op::STRUCT_GET, keys_key, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, idx_slot, line);
    crate::compiler::collections::emit_remove_at(chunks, current, line);
    chunks[current].emit_op(Op::DROP, line);
...
pub fn emit_method_size(chunks: &mut [Chunk], current: usize, line: u32) {
    let keys_key = chunks[current].add_constant(Value::String(Arc::from("__keys")));
    chunks[current].emit_op_u16(Op::STRUCT_GET, keys_key, line);
    crate::compiler::collections::emit_len(chunks, current, line);
}
...
pub fn emit_values_from_local(
    ...
    let state = crate::compiler::loops::emit_for_in_start(chunks, current, keys_slot, idx_slot, line);
    ...
    chunks[current].emit_op_u16(Op::LOCAL_GET, keys_slot, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, idx_slot, line);
    crate::compiler::collections::emit_get(chunks, current, line); // keys[i] → key string
    crate::compiler::collections::emit_get(chunks, current, line); // dict[key] → value
    crate::compiler::collections::emit_push(chunks, current, line);
    chunks[current].emit_op(Op::DROP, line); // result.push(value)
    chunks[current].emit_op(Op::DROP, line);

    crate::compiler::loops::emit_for_in_end(chunks, current, idx_slot, state, line);
...
pub fn emit_items_from_local(
    ...
    chunks[current].emit_op_u16(Op::LOCAL_GET, keys_slot, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, idx_slot, line);
    crate::compiler::collections::emit_get(chunks, current, line); // key = keys[i]
    ...
    crate::compiler::collections::emit_get(chunks, current, line);
    // pair = [key, value]
    crate::compiler::collections::emit_array_pair(chunks, current, line);
    // result.push(pair)
    chunks[current].emit_op_u16(Op::LOCAL_GET, result_slot, line);
    ...
    chunks[current].emit_op_u16(Op::LOCAL_GET, keys_slot, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, idx_slot, line);
    crate::compiler::collections::emit_get(chunks, current, line); // key
    chunks[current].emit_op_u16(Op::LOCAL_GET, dict_slot, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, keys_slot, line);
    chunks[current].emit_op_u16(Op::LOCAL_GET, idx_slot, line);
    crate::compiler::collections::emit_get(chunks, current, line); // key again
    crate::compiler::collections::emit_get(chunks, current, line); // dict[key] = value
    crate::compiler::collections::emit_array_pair(chunks, current, line); // [key, value]
    crate::compiler::collections::emit_push(chunks, current, line);
