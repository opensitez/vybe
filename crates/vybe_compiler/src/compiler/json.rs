...
use crate::compiler::functions::create_function_chunk;
...
fn loop_break_unless_lt(chunk: &mut Chunk, i_slot: u16, n_slot: u16, line: u32) {
    ...
    crate::compiler::ops::emit_dyn_not(chunk, line);
...
fn build_normalize_helper(chunks: &mut Vec<Chunk>, line: u32) -> usize {
    ...
    crate::compiler::ops::emit_dyn_to_bool(&mut h, line);
    h.emit_if(line);
    {
    ...
    crate::compiler::ops::emit_dyn_to_bool(&mut h, line); // i32: hasType
    lget(&mut h, props_slot, line);
    crate::compiler::ops::emit_dyn_to_bool(&mut h, line);
    ...
    h.emit_if(line);
    {
        ...
        h.emit_else(line);
        {
            ...
            crate::compiler::convert::emit_to_string(&mut h, line);
            push_str(&mut h, " is not JSON serializable", line);
            crate::compiler::strings::emit_concat(&mut h, 3, line);
            crate::compiler::errors::emit_exception_new_finalize(&mut h, "TypeError", line);
            crate::compiler::errors::emit_throw(&mut h, line);
        }
        h.emit_end(line);
    }
    h.emit_end(line);
