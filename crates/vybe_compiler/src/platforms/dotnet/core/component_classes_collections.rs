    ...
    vec![
        ...
        DotnetClassExport::new(
            ...
            ClassType::new("ArrayList")
                ...
                .with_method(MethodDef::new("IndexOf", 2, MethodBody::Common("collections.index_of_from".into())))
                .with_method(MethodDef::new("LastIndexOf", 1, MethodBody::Common("collections.last_index_of".into())))
                .with_method(MethodDef::new("LastIndexOf", 2, MethodBody::Common("collections.last_index_of_from".into())))
                ...
                .with_method(MethodDef::new("Reverse", 2, MethodBody::Common("collections.reverse_range".into())))
                .with_method(MethodDef::new("ToArray", 0, MethodBody::Common("collections.clone".into())))
