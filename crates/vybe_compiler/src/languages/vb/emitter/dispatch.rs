...
pub fn dispatch(name: &str, chunks: &mut Vec<Chunk>, current: usize, argc: u8, line: u32) -> bool {
    match name {
        ...
        "vb.year" => {
            crate::emitter::vb::datetime_adapter::emit_vb_year(chunks, current, argc, line)
        }
        "vb.month" => {
            crate::emitter::vb::datetime_adapter::emit_vb_month(chunks, current, argc, line)
        }
        "vb.day" => crate::emitter::vb::datetime_adapter::emit_vb_day(chunks, current, argc, line),
        "vb.hour" => {
            crate::emitter::vb::datetime_adapter::emit_vb_hour(chunks, current, argc, line)
        }
        "vb.minute" => {
            crate::emitter::vb::datetime_adapter::emit_vb_minute(chunks, current, argc, line)
        }
        "vb.second" => {
            crate::emitter::vb::datetime_adapter::emit_vb_second(chunks, current, argc, line)
        }
        "vb.weekday" => {
            crate::emitter::vb::datetime_adapter::emit_vb_weekday(chunks, current, argc, line)
        }
