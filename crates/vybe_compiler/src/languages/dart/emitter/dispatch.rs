...
pub fn dispatch(name: &str, chunks: &mut Vec<Chunk>, current: usize, argc: u8, line: u32) -> bool {
    match name {
        "dart.is_empty" => {
            crate::emitter::dart::string_adapter::emit_dart_is_empty(chunks, current, line)
        }
        "dart.is_not_empty" => {
            crate::emitter::dart::string_adapter::emit_dart_is_not_empty(chunks, current, line)
        }
        "dart.replace_first" => {
            crate::emitter::dart::string_adapter::emit_dart_replace_first(chunks, current, line)
        }
        "dart.list_first" => {
            crate::emitter::dart::string_adapter::emit_dart_list_first(chunks, current, line)
        }
        "dart.list_last" => {
            crate::emitter::dart::string_adapter::emit_dart_list_last(chunks, current, line)
        }
        "dart.length" => {
            crate::emitter::dart::string_adapter::emit_dart_length(chunks, current, line)
        }
        "dart.print" => {
