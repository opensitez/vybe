...
fn extract_stmt(stmt: &Statement, out: &mut Vec<Symbol>) {
    match &stmt.kind {
        ...
        StmtKind::EnumDecl { name, members, .. } => {
            ...
            out.push(Symbol {
                name: name.clone(), kind: SymbolKind::Enum, detail: String::new(),
                line: stmt.span.start_line, end_line: stmt.span.end_line,
                children,
            });
        }
        ...
        StmtKind::Block(stmts) => {
            for s in stmts { extract_stmt(s, out); }
        }
...
pub fn language_keywords(lang: Lang) -> &'static [&'static str] {
    match lang {
        Lang::VB => &["Dim","Public","Private","Protected","Friend","Sub","Function","Class","Module",
            "End","If","Then","Else","ElseIf","For","To","Step","Next","Do","While","Loop",
            "Select","Case","Try","Catch","Finally","Throw","Return","Exit","Imports","Namespace",
            "Inherits","Implements","Interface","Enum","Structure","Property","Get","Set",
            "New","Nothing","True","False","And","Or","Not","Is","IsNot","Mod","Like",
            "String","Integer","Double","Boolean","Object","Date","Byte","Long","Short",
            "Console","WriteLn","ReadLine","MsgBox","MessageBox"],
        Lang::JavaScript => &["var","let","const","function","class","if","else","for","while","do",
            "switch","case","break","continue","return","try","catch","finally","throw",
            "new","this","super","extends","import","export","default","async","await",
            "typeof","instanceof","in","of","delete","void","yield","null","undefined",
            "true","false","console","document","window","Array","Object","String","Number",
            "Math","JSON","Promise","Map","Set","Date","RegExp","Error"],
        Lang::CSharp => &["using","namespace","class","struct","interface","enum","public","private",
            "protected","internal","static","void","int","string","bool","double","float",
            "var","if","else","for","foreach","while","do","switch","case","break","continue",
            "return","try","catch","finally","throw","new","this","base","override","virtual",
            "abstract","sealed","readonly","const","null","true","false","async","await",
            "Console","WriteLine","ReadLine","List","Dictionary","Task"],
        Lang::Python => &["def","class","if","elif","else","for","while","break","continue","return",
            "try","except","finally","raise","with","as","import","from","pass","yield",
            "lambda","global","nonlocal","assert","del","True","False","None","and","or","not",
            "in","is","print","len","range","str","int","float","list","dict","set","tuple",
            "self","__init__","__str__","__repr__","super","type","isinstance","enumerate","zip","map","filter"],
        Lang::Ruby => &["def","end","class","module","if","elsif","else","unless","for","while","until",
            "do","begin","rescue","ensure","raise","return","yield","block_given?","self",
            "true","false","nil","and","or","not","require","include","extend","attr_accessor",
            "attr_reader","attr_writer","puts","print","gets","new","initialize","super"],
        Lang::PHP => &["function","class","interface","trait","extends","implements","public","private",
            "protected","static","abstract","final","const","var","if","else","elseif",
            "for","foreach","while","do","switch","case","break","continue","return",
            "try","catch","finally","throw","new","echo","print","null","true","false",
            "array","string","int","float","bool","self","parent","$this","namespace","use"],
        Lang::Dart => &["class","extends","implements","with","mixin","abstract","enum","typedef",
            "import","export","library","part","if","else","for","while","do","switch","case",
            "break","continue","return","try","catch","finally","throw","rethrow",
            "new","this","super","var","final","const","late","void","int","double","String",
            "bool","List","Map","Set","Future","Stream","async","await","yield",
            "true","false","null","print","dynamic","Function","Type"],
        Lang::Pascal => &["program","unit","uses","begin","end","var","const","type","procedure","function",
            "constructor","destructor","class","record","interface","inherited","override","virtual",
            "if","then","else","for","to","downto","do","while","repeat","until","case","of",
            "try","except","finally","raise","exit","break","continue","with",
            "and","or","not","xor","div","mod","in","is","as",
            "nil","true","false","Result","Self","TObject","Create","Destroy","Free",
            "Integer","String","Boolean","Real","Char","WriteLn","ReadLn","Length","Format"],
        Lang::Cobol => &["IDENTIFICATION","DIVISION","ENVIRONMENT","DATA","PROCEDURE","SECTION",
            "WORKING-STORAGE","LINKAGE","PERFORM","MOVE","ADD","SUBTRACT","MULTIPLY","DIVIDE",
            "COMPUTE","IF","ELSE","END-IF","EVALUATE","WHEN","END-EVALUATE",
            "DISPLAY","ACCEPT","STOP","RUN","CALL","USING","PIC","VALUE"],
        _ => &[],
    }
}
