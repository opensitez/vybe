...
const MAPPINGS: &[(&str, &str)] = &[
    ...
    ("__stdlib_pascal_set_intersection", "__vybe_pascal_set_intersection"),
    ("__stdlib_pascal_set_difference", "__vybe_pascal_set_difference"),
    ...
    ("__stdlib_pascal_str_remove_range", "__vybe_pascal_str_remove_range"),
