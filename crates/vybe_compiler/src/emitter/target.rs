    ...
    pub fn vybe() -> Self {
        Target {
            ...
            available_modules: vec![
                ...
                "ecma:weakmap".into(),
                "ecma:weakset".into(),
                "ecma:arraybuffer".into(),
                "ecma:sharedarraybuffer".into(),
                "ecma:dataview".into(),
                "ecma:fixedarray".into(),
                "ecma:structured-clone".into(),
                "ecma:value".into(),
                "ecma:date".into(),
                "ecma:int8array".into(),
                "ecma:uint8array".into(),
                "ecma:uint8clamped".into(),
                "ecma:int16array".into(),
                "ecma:uint16array".into(),
                "ecma:int32array".into(),
                "ecma:uint32array".into(),
                "ecma:float32array".into(),
                "ecma:float64array".into(),
                "ecma:bigint64array".into(),
                "ecma:biguint64array".into(),
                // ECMA-402 Intl
                "ecma:intl".into(),
                ...
                "wasm:js-string".into(),
                "ecma:regexp".into(),
                "wasi:crypto/hashes".into(),
                "web:crypto".into(),
                "wasi:sql/types".into(),
                "wasi:sql/readwrite".into(),
                "web:dom-parser".into(),
                "wasi:cli/stdin".into(),
