...
pub fn emit_common(name: &str, chunks: &mut Vec<Chunk>, current: usize, argc: u8, line: u32) -> bool {
    match name {
        ...
        // ── COBOL adapters ──
        "cobol.round_away_from_zero" => crate::emitter::cobol::arithmetic::emit_round_away_from_zero(chunks, current, line),
        "cobol.integer_of_date" => crate::emitter::cobol::date::emit_integer_of_date(chunks, current, line),
        "cobol.cancel" => crate::emitter::cobol::control::emit_cancel(chunks, current, argc, line),
        "cobol.release" => crate::emitter::cobol::files::emit_release(chunks, current, argc, line),
        "cobol.return_record" => crate::emitter::cobol::files::emit_return_record(chunks, current, argc, line),
        "cobol.alter" => crate::emitter::cobol::control::emit_alter(chunks, current, argc, line),
        "cobol.sort" => crate::emitter::cobol::files::emit_sort(chunks, current, argc, line),
        "cobol.merge" => crate::emitter::cobol::files::emit_merge(chunks, current, argc, line),
        "cobol.copy" => crate::emitter::cobol::data::emit_copy(chunks, current, argc, line),
        "cobol.validate" => crate::emitter::cobol::data::emit_validate(chunks, current, argc, line),
        "cobol.typedef" => crate::emitter::cobol::data::emit_typedef(chunks, current, argc, line),
        "cobol.move_corresponding" => crate::emitter::cobol::data::emit_move_corresponding(chunks, current, argc, line),
        ...
        "php.pdo_statement_bind_param" => crate::emitter::php::database_adapter::emit_php_pdo_statement_bind_param(chunks, current, argc, line),
        "php.pdo_statement_bind_value" => crate::emitter::php::database_adapter::emit_php_pdo_statement_bind_value(chunks, current, argc, line),
        ...
        "php.mysqli_report" => crate::emitter::php::database_adapter::emit_php_mysqli_report(chunks, current, argc, line),
        "php.mysqli_connect" => crate::emitter::php::database_adapter::emit_php_mysqli_connect(chunks, current, argc, line),
        "php.mysqli_init" => crate::emitter::php::database_adapter::emit_php_mysqli_init(chunks, current, argc, line),
        "php.mysqli_real_connect" => crate::emitter::php::database_adapter::emit_php_mysqli_real_connect(chunks, current, argc, line),
        "php.mysqli_connect_errno" => crate::emitter::php::database_adapter::emit_php_mysqli_connect_errno(chunks, current, argc, line),
        "php.mysqli_connect_error" => crate::emitter::php::database_adapter::emit_php_mysqli_connect_error(chunks, current, argc, line),
        "php.mysqli_error" => crate::emitter::php::database_adapter::emit_php_mysqli_error(chunks, current, argc, line),
        "php.mysqli_query" => crate::emitter::php::database_adapter::emit_php_mysqli_query(chunks, current, argc, line),
        "php.mysqli_prepare" => crate::emitter::php::database_adapter::emit_php_mysqli_prepare(chunks, current, argc, line),
        "php.mysqli_select_db" => crate::emitter::php::database_adapter::emit_php_mysqli_select_db(chunks, current, argc, line),
        "php.mysqli_set_charset" => crate::emitter::php::database_adapter::emit_php_mysqli_set_charset(chunks, current, argc, line),
        "php.mysqli_ping" => crate::emitter::php::database_adapter::emit_php_mysqli_ping(chunks, current, argc, line),
        "php.mysqli_errno" => crate::emitter::php::database_adapter::emit_php_mysqli_errno(chunks, current, argc, line),
        "php.mysqli_affected_rows" => crate::emitter::php::database_adapter::emit_php_mysqli_affected_rows(chunks, current, argc, line),
        "php.mysqli_insert_id" => crate::emitter::php::database_adapter::emit_php_mysqli_insert_id(chunks, current, argc, line),
        "php.mysqli_num_fields" => crate::emitter::php::database_adapter::emit_php_mysqli_num_fields(chunks, current, argc, line),
        "php.mysqli_fetch_field" => crate::emitter::php::database_adapter::emit_php_mysqli_fetch_field(chunks, current, argc, line),
        "php.mysqli_free_result" => crate::emitter::php::database_adapter::emit_php_mysqli_free_result(chunks, current, argc, line),
        "php.mysqli_more_results" => crate::emitter::php::database_adapter::emit_php_mysqli_more_results(chunks, current, argc, line),
        "php.mysqli_next_result" => crate::emitter::php::database_adapter::emit_php_mysqli_next_result(chunks, current, argc, line),
        "php.mysqli_close" => crate::emitter::php::database_adapter::emit_php_mysqli_close(chunks, current, argc, line),
        "php.mysqli_real_escape_string" => crate::emitter::php::database_adapter::emit_php_mysqli_real_escape_string(chunks, current, argc, line),
        "php.mysqli_character_set_name" => crate::emitter::php::database_adapter::emit_php_mysqli_character_set_name(chunks, current, argc, line),
        "php.mysqli_get_client_info" => crate::emitter::php::database_adapter::emit_php_mysqli_get_client_info(chunks, current, argc, line),
        "php.mysqli_get_server_info" => crate::emitter::php::database_adapter::emit_php_mysqli_get_server_info(chunks, current, argc, line),
        "php.mysqli_fetch_array" => crate::emitter::php::database_adapter::emit_php_mysqli_fetch_array(chunks, current, argc, line),
        "php.mysqli_fetch_assoc" => crate::emitter::php::database_adapter::emit_php_mysqli_fetch_assoc(chunks, current, argc, line),
        "php.mysqli_fetch_object" => crate::emitter::php::database_adapter::emit_php_mysqli_fetch_object(chunks, current, argc, line),
        "php.mysqli_num_rows" => crate::emitter::php::database_adapter::emit_php_mysqli_num_rows(chunks, current, argc, line),
        "php.mysqli_fetch_all" => crate::emitter::php::database_adapter::emit_php_mysqli_fetch_all(chunks, current, argc, line),
        ...
        "vb.filedatetime" => crate::emitter::vb::misc_adapter::emit_vb_filedatetime(chunks, current, argc, line),
        ...
        "vb.shell_pid" => crate::emitter::vb::misc_adapter::emit_vb_shell_pid(chunks, current, argc, line),
