...
#[test] fn format_multiple() {
    assert_eq!(run_pascal(r#"program T;
begin
  WriteLn(Format('%s is %d years old', ['Alice', 30]));
end."#), &["Alice is 30 years old"]);
}

#[test] fn format_float() {
    assert_eq!(run_pascal(r#"program T;
begin
...
#[test] fn char_from_string_index() {
    assert_eq!(run_pascal(r#"program T;
var s: String;
begin
  s := 'ABCDE';
...
#[test] fn iterate_chars_in_string() {
    assert_eq!(run_pascal(r#"program T;
var ch: String;
begin
  for ch in 'HELLO' do
