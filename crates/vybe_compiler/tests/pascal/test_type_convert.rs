...
#[test] fn strtobool_false_string() {
    assert_eq!(run_pascal(r#"program T;
begin
...
#[test] fn floattostr_integer_value() {
    assert_eq!(run_pascal(r#"program T;
begin
...
#[test] fn format_with_conversion() {
    assert_eq!(run_pascal(r#"program T;
var n: Integer;
begin
  n := 42;
