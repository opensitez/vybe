...
fn sealed_override_prevents_further_overriding() {
    assert_eq!(
        run_csharp(r#"class A{public virtual string Tag()=>"A";}
...
fn covariant_return_type_narrows_return_of_override() {
    assert_eq!(
        run_csharp(r#"class Base{public virtual object Create()=>new object();}
...
fn multiple_levels_of_base_call_chain() {
    assert_eq!(
        run_csharp(r#"class A{public virtual string Name()=>"A";}
...
fn abstract_class_partial_implementation_forces_concrete_override() {
    assert_eq!(
        run_csharp(r#"abstract class Step{
...
fn object_type_is_common_base_of_all_classes() {
    assert_eq!(
        run_csharp(r#"object x=42; object y="hi"; object z=new int[]{};
