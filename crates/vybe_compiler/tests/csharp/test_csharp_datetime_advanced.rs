...
fn datetime_add_days_correctly_crosses_month_boundary() {
    assert_eq!(
        run_csharp(
            r#"var d=new System.DateTime(2024,1,30).AddDays(3);
...
fn datetime_subtract_yields_timespan() {
    assert_eq!(
        run_csharp(
            r#"var a=new System.DateTime(2024,1,10);
...
fn datetime_day_of_week_is_correct() {
    assert_eq!(
        run_csharp(
            r#"var d=new System.DateTime(2024,1,1);
...
fn timespan_total_minutes_converts_hours_and_minutes() {
    assert_eq!(
        run_csharp(
            r#"var ts=new System.TimeSpan(2,30,0);
