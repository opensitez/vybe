...
fn list_capacity_doubles_on_overflow() {
    assert_eq!(
        run_csharp(
            r#"var list=new System.Collections.Generic.List<int>(4);
...
fn list_trim_excess_reduces_capacity_to_count() {
    assert_eq!(
        run_csharp(
            r#"var list=new System.Collections.Generic.List<int>(100);
...
fn hash_set_union_with_intersects_and_except() {
    assert_eq!(
        run_csharp(
            r#"var a=new System.Collections.Generic.HashSet<int>{1,2,3,4};
...
fn sorted_set_get_view_between_returns_subset() {
    assert_eq!(
        run_csharp(
            r#"var s=new System.Collections.Generic.SortedSet<int>{1,2,3,4,5};
