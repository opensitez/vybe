...
fn immutable_list_add_returns_new_list_old_unchanged() {
    assert_eq!(
        run_csharp(r#"var a=System.Collections.Immutable.ImmutableList<int>.Empty;
...
fn immutable_list_remove_returns_new_list() {
    assert_eq!(
        run_csharp(r#"var list=System.Collections.Immutable.ImmutableList.Create(1,2,3);
...
fn immutable_array_indexer_reads_element() {
    assert_eq!(
        run_csharp(r#"var arr=System.Collections.Immutable.ImmutableArray.Create(10,20,30);
...
fn immutable_dictionary_add_returns_new_dictionary() {
    assert_eq!(
        run_csharp(r#"var d=System.Collections.Immutable.ImmutableDictionary<string,int>.Empty;
