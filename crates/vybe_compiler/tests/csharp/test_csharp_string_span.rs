...
fn readonly_span_char_from_string_slice_reads_substring() {
    assert_eq!(
        run_csharp(r#"string s="hello world";
...
fn span_contains_finds_character_in_range() {
    assert_eq!(
        run_csharp(r#"System.ReadOnlySpan<char> span="hello".AsSpan();
...
fn span_of_int_slice_modifies_original_array() {
    assert_eq!(
        run_csharp(r#"int[] arr={1,2,3,4,5};
...
fn memory_span_property_accesses_underlying_data() {
    assert_eq!(
        run_csharp(r#"System.Memory<int> m=new int[]{7,8,9};
...
fn readonly_span_index_from_end_works() {
    assert_eq!(
        run_csharp(r#"System.ReadOnlySpan<char> s="hello".AsSpan();
