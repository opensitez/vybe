...
fn nested_class_fully_qualified_via_outer_name() {
    assert_eq!(
        run_csharp(r#"class Container{public class Item{public int Value=7;}}
...
fn deeply_nested_class_visible_through_chain() {
    assert_eq!(
        run_csharp(r#"class A{public class B{public class C{public int V=3;}}}
...
fn nested_class_can_implement_interface() {
    assert_eq!(
        run_csharp(r#"interface IValue{int Get();}
