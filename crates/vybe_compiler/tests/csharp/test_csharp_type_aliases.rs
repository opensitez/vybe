...
fn using_alias_creates_shorter_name_for_type() {
    assert_eq!(
        run_csharp(r#"using IntList=System.Collections.Generic.List<int>;
...
fn using_alias_for_fully_qualified_type() {
    assert_eq!(
        run_csharp(r#"using Dict=System.Collections.Generic.Dictionary<string,int>;
...
fn type_alias_works_as_return_type_and_parameter() {
    assert_eq!(
        run_csharp(r#"using NameMap=System.Collections.Generic.Dictionary<string,string>;
