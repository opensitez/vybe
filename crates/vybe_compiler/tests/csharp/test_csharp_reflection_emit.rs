...
fn type_is_assignable_from_derived_class() {
    assert_eq!(
        run_csharp(r#"class A{} class B:A{}
...
fn type_base_type_reflects_inheritance_chain() {
    assert_eq!(
        run_csharp(r#"class A{} class B:A{} class C:B{}
...
fn property_info_get_set_accessor_names() {
    assert_eq!(
        run_csharp(r#"class Model{public int Value{get;set;}}
...
fn method_info_invoke_calls_instance_method() {
    assert_eq!(
        run_csharp(r#"class Adder{public int Add(int a,int b)=>a+b;}
...
fn field_info_get_and_set_value_on_instance() {
    assert_eq!(
        run_csharp(r#"class Box{public int V;}
