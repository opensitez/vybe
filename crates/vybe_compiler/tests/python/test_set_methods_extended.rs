...
crate::runtime_case!(set_add_member, "s = {1}\ns.add(2)\nprint(sorted(s))\n", "[1, 2]");
crate::runtime_case!(
    set_remove_existing,
    "s = {1, 2, 3}\ns.remove(2)\nprint(sorted(s))\n",
    "[1, 3]"
...
crate::compile_case!(set_intersection_update_method, "s = {1, 2}\ns.intersection_update({2, 3})\n");
crate::compile_case!(set_difference_update_method, "s = {1, 2}\ns.difference_update({1})\n");
crate::compile_case!(set_symmetric_difference_update_method, "s = {1}\ns.symmetric_difference_update({1, 2})\n");
