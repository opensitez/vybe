...
crate::runtime_case!(
    print_star_unpack_list,
    "print(*[1, 2, 3])\n",
    "1 2 3"
);
crate::runtime_case!(
    print_star_unpack_tuple,
    "print(*(10, 20))\n",
    "10 20"
);
crate::runtime_case!(
...
crate::compile_case!(print_file_kwarg, "import sys\nprint('x', file=sys.stdout)\n");
crate::compile_case!(
    print_sep_end_together,
    "print(1, 2, sep=':', end=';')\n"
);
