...
crate::runtime_case!(str_split_default, "print('a b c'.split())\n", "['a', 'b', 'c']");
crate::runtime_case!(str_split_maxsplit, "print('a,b,c'.split(',', 1))\n", "['a', 'b,c']");
crate::runtime_case!(str_rsplit, "print('a.b.c'.rsplit('.', 1))\n", "['a.b', 'c']");
crate::runtime_case!(str_splitlines, "print('a\\nb'.splitlines())\n", "['a', 'b']");
crate::runtime_case!(str_partition, "print('key=value'.partition('='))\n", "('key', '=', 'value')");
crate::runtime_case!(str_rpartition, "print('a=b=c'.rpartition('='))\n", "('a=b', '=', 'c')");
...
crate::runtime_case!(str_replace_count, "print('aaa'.replace('a', 'b', 2))\n", "bba");
crate::runtime_case!(str_replace_all, "print('abcabc'.replace('a', 'z'))\n", "zbczbc");
...
crate::runtime_case!(str_startswith_true, "print('hello'.startswith('he'))\n", "True");
crate::runtime_case!(str_startswith_false, "print('hello'.startswith('lo'))\n", "False");
...
crate::runtime_case!(str_format_positional, "print('{}+{}={}'.format(1, 2, 3))\n", "1+2=3");
crate::runtime_case!(str_format_named, "print('{a}-{b}'.format(a=1, b=2))\n", "1-2");
...
crate::runtime_case!(str_removeprefix, "print('foobar'.removeprefix('foo'))\n", "bar");
crate::runtime_case!(str_removesuffix, "print('foobar'.removesuffix('bar'))\n", "foo");
crate::runtime_case!(str_expandtabs, "print('a\\tb'.expandtabs(4))\n", "a   b");
crate::runtime_case!(str_encode_utf8, "print(list('é'.encode('utf-8')))\n", "[195, 169]");
crate::runtime_case!(str_maketrans_translate, "print('abc'.translate(str.maketrans('ab', 'xy')))\n", "xyc");
crate::runtime_case!(str_splitlines_keepends, "print('a\\n'.splitlines(keepends=True))\n", "['a\\n']");
