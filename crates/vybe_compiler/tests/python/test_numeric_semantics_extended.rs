...
crate::compile_case!(decimal_float_precision, "from decimal import Decimal\nDecimal(0.1)\n");
crate::compile_case!(fractions_limit, "from fractions import Fraction\nFraction(1, 3) + Fraction(1, 6)\n");
