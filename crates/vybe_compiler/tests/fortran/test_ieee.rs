...
");
c!(ieee_is_finite_11,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_is_finite(1.0)
end program p
");
c!(ieee_is_normal_12,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_is_normal(1.0)
end program p
");
c!(ieee_value_13,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_value(1.0, ieee_positive_inf)
end program p
");
c!(ieee_support_inf_14,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_support_inf(1.0)
end program p
");
c!(ieee_support_nan_15,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_support_nan(1.0)
end program p
");
c!(ieee_rem_16,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_rem(7.0,3.0)
end program p
");
c!(ieee_rint_17,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_rint(1.6)
end program p
");
c!(ieee_logb_18,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_logb(8.0)
end program p
");
c!(ieee_unordered_19,"program p
use, intrinsic :: ieee_arithmetic
print *, ieee_unordered(1.0, 2.0)
end program p
");
c!(ieee_datatype_20,"program p
use, intrinsic :: ieee_arithmetic
