...
#[test] fn out_of_range_integer_in_range() {
    compile_ok(r#"
program test
...
#[test] fn out_of_range_integer_overflow() {
    compile_ok(r#"
program test
...
#[test] fn out_of_range_real_to_integer() {
    compile_ok(r#"
program test
    real :: x = 3.14
...
#[test] fn out_of_range_real_infinity() {
    compile_ok(r#"
program test
    use ieee_arithmetic
    real :: x
...
#[test] fn out_of_range_real_to_real() {
    compile_ok(r#"
program test
...
#[test] fn out_of_range_with_round() {
    compile_ok(r#"
program test
    real :: x = 127.6
...
#[test] fn random_init_repeatable() {
    compile_ok(r#"
program test
...
#[test] fn random_init_non_repeatable() {
    compile_ok(r#"
program test
...
#[test] fn assumed_rank_with_select_rank() {
    compile_ok(r#"
module ar_mod
    implicit none
contains
...
#[test] fn implicit_none_type_external() {
    compile_ok(r#"
program test
...
#[test] fn is_contiguous_pointer_after_assign() {
    compile_ok(r#"
program test
    real, target :: a(10)
    real, pointer :: p(:)
...
#[test] fn is_contiguous_non_unit_stride() {
    compile_ok(r#"
program test
    real, target :: a(10)
    real, pointer :: p(:)
...
#[test] fn char_implied_type_concat() {
    compile_ok(r#"
program test
...
#[test] fn co_broadcast_single_image() {
    compile_ok(r#"
program test
    integer :: x = 99
...
#[test] fn write_logical_format_extended() {
    compile_ok(r#"
program test
...
#[test] fn event_type_declaration() {
    compile_ok(r#"
program test
    use iso_fortran_env
    type(event_type) :: ev[*]
