...
#[test]
fn write_fmt_logical() {
    compile_ok("program t\n  write(*, '(L5)') .true.\nend program t\n");
}
#[test]
fn write_fmt_multiple() {
    compile_ok(
        "program t\n  integer :: n = 42\n  real :: x = 3.14\n  write(*, '(I5, F8.3)') n, x\nend program t\n",
    );
}
