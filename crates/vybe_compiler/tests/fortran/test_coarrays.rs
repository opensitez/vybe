...
#[test]
fn coarray_array_remote_element() {
    compile_ok(
        r#"
program test
    integer :: a(5)[*]
...
#[test]
fn coarray_derived_type_member() {
    compile_ok(
        r#"
program test
    type :: Shared
