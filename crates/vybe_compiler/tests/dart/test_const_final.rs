...
#[test]
fn final_var() {
    compile_ok("final x = 42;");
}
#[test]
fn final_typed() {
    compile_ok("final int x = 42;");
}
#[test]
fn final_string() {
    compile_ok("final name = 'Dart';");
}
#[test]
fn final_list() {
    compile_ok("final items = [1, 2, 3];");
}
#[test]
fn final_map() {
    compile_ok("final m = {'a': 1};");
}
#[test]
fn final_in_function() {
    compile_ok("void f() { final x = 10; print(x); }");
}

#[test]
fn final_class_field() {
    compile_ok("class Point { final int x; final int y; Point(this.x, this.y); }");
}

#[test]
fn final_class_field_initialized() {
...
#[test]
fn const_int() {
    compile_ok("const x = 42;");
}
#[test]
fn const_string() {
    compile_ok("const greeting = 'Hello';");
}
#[test]
fn const_double() {
    compile_ok("const pi = 3.14159;");
}
#[test]
fn const_bool() {
    compile_ok("const debug = true;");
}
#[test]
fn const_typed_int() {
    compile_ok("const int max = 100;");
}
#[test]
fn const_typed_string() {
    compile_ok("const String prefix = 'ID-';");
}

#[test]
fn const_in_class() {
    compile_ok(
        "class Config { static const int timeout = 30; static const String host = 'localhost'; }",
    );
}

#[test]
fn const_used_in_expr() {
...
#[test]
fn const_list() {
    compile_ok("const items = [1, 2, 3];");
}
#[test]
fn const_map() {
    compile_ok("const m = {'key': 'value'};");
}
...
#[test]
fn late_var() {
    compile_ok("late int x; void main() { x = 42; print(x); }");
}
#[test]
fn late_typed_string() {
    compile_ok("late String name; void main() { name = 'Dart'; }");
}
...
#[test]
fn final_and_const_together() {
    compile_ok("const limit = 100; final result = limit * 2;");
}

#[test]
fn final_late_const_in_class() {
    compile_ok(
        r#"
class Settings {
