...
#[test]
fn variable_variable_assign_then_read() {
    compile_ok(
        r#"<?php
$key = 'color';
$$key = 'blue';
...
#[test]
fn variable_variable_expression() {
    compile_ok(
        r#"<?php
$prefix = 'my';
$suffix = 'Var';
...
#[test]
fn variable_function_conditional() {
    compile_ok(
        r#"<?php
...
#[test]
fn call_user_func_static_method() {
    compile_ok(
        r#"<?php
class MathUtil {
