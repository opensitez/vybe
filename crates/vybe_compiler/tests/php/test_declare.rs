...
#[test] fn strict_types_float_param() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn strict_types_string_param() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn strict_types_bool_param() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn strict_types_union_type() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn strict_types_return_type_enforcement() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn strict_types_class_method() {
    compile_ok(r#"<?php
declare(strict_types=1);
class Money {
...
#[test] fn strict_types_type_error_caught() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn strict_types_with_interface() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn declare_ticks_block_form() {
    compile_ok(r#"<?php
declare(ticks=1) {
    $sum = 0;
...
#[test] fn strict_types_multifile_interaction() {
    compile_ok(r#"<?php
declare(strict_types=1);
...
#[test] fn strict_types_named_args() {
    compile_ok(r#"<?php
declare(strict_types=1);
