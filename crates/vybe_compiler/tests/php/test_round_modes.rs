...
fn round_two_decimal_places() {
    assert_eq!(
        run_prints(r#"<?php echo round(3.14159, 2); "#),
        vec!["3.14"]
    );
}
#[test]
fn round_negative_precision_tens() {
    assert_eq!(
        run_prints(r#"<?php echo round(1234.5, -2); "#),
        vec!["1200"]
    );
}
#[test]
fn round_negative_precision_hundreds() {
    assert_eq!(run_prints(r#"<?php echo round(1550, -3); "#), vec!["2000"]);
}
#[test]
fn round_zero_precision_explicit() {
...
fn round_half_up_mode() {
    assert_eq!(
        run_prints(r#"<?php echo round(2.5, 0, PHP_ROUND_HALF_UP); "#),
        vec!["3"]
    );
}
#[test]
...
#[test]
fn round_half_down_mode() {
    assert_eq!(
        run_prints(r#"<?php echo round(2.5, 0, PHP_ROUND_HALF_DOWN); "#),
        vec!["2"]
    );
}
#[test]
fn round_half_down_negative_mode() {
    assert_eq!(
        run_prints(r#"<?php echo round(-2.5, 0, PHP_ROUND_HALF_DOWN); "#),
        vec!["-2"]
    );
...
fn round_half_even_rounds_to_nearest_even() {
    assert_eq!(
        run_prints(r#"<?php echo round(0.5, 0, PHP_ROUND_HALF_EVEN); "#),
        vec!["0"]
    );
}
#[test]
fn round_half_even_three_point_five() {
    assert_eq!(
        run_prints(r#"<?php echo round(3.5, 0, PHP_ROUND_HALF_EVEN); "#),
        vec!["4"]
    );
}
#[test]
fn round_half_even_two_point_five() {
    assert_eq!(
        run_prints(r#"<?php echo round(2.5, 0, PHP_ROUND_HALF_EVEN); "#),
        vec!["2"]
    );
}
...
#[test]
fn round_half_odd_rounds_to_nearest_odd() {
    assert_eq!(
        run_prints(r#"<?php echo round(0.5, 0, PHP_ROUND_HALF_ODD); "#),
        vec!["1"]
    );
}
#[test]
fn round_half_odd_two_point_five() {
    assert_eq!(
        run_prints(r#"<?php echo round(2.5, 0, PHP_ROUND_HALF_ODD); "#),
        vec!["3"]
    );
}
