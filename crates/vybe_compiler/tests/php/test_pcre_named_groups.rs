...
#[test] fn named_group_basic_match() {
...
#[test] fn named_group_alternate_syntax() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_group_accessible_by_numeric_index_too() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_group_in_replace_backreference() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn preg_match_all_named_groups_collect_all() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn preg_match_all_named_groups_set_order() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn positive_lookahead_matches_without_consuming() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn negative_lookahead_excludes_followed_by() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn positive_lookbehind_matches_preceded_by() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn negative_lookbehind_excludes_preceded_by() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn preg_replace_callback_array_multiple_patterns() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn preg_replace_callback_array_with_captures() {
    assert_eq!(run_prints(r#"<?php
$result = preg_replace_callback_array([
...
#[test] fn preg_replace_callback_array_no_match_unchanged() {
    assert_eq!(run_prints(r#"<?php
$result = preg_replace_callback_array([
    '/xyz/' => fn($m) => 'replaced',
], 'no match here');
...
#[test] fn non_capturing_group_not_in_matches() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn possessive_quantifier_prevents_backtrack() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn multiline_flag_anchors_each_line() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn dotall_flag_dot_matches_newlines() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn extended_mode_ignores_whitespace() {
    assert_eq!(run_prints(r#"<?php
$pattern = '/
    (\d{4})  # year
    -
...
#[test] fn unicode_flag_matches_unicode_word_chars() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn backreference_in_pattern_matches_repeated_word() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_backreference_k_syntax() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn preg_quote_escapes_special_chars() {
    assert_eq!(run_prints(r#"<?php
$pattern = preg_quote('.+*?()', '/');
...
#[test] fn preg_grep_filters_matching_elements() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn preg_grep_inverted_filter() {
    assert_eq!(run_prints(r#"<?php
$nums = ['1', '2a', '3', '4b', '5'];
