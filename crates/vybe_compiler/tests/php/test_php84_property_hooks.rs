...
#[test] fn property_hook_get_returns_computed_value() {
...
#[test] fn property_hook_get_derived_from_other_property() {
    assert_eq!(run_prints(r#"<?php
class Name {
    public string $first = '';
    public string $last = '';
...
#[test] fn property_hook_set_validates_before_storing() {
    assert_eq!(run_prints(r#"<?php
class Age {
    public int $value {
        set(int $v) {
...
#[test] fn property_hook_set_throws_on_invalid_value() {
    assert_eq!(run_prints(r#"<?php
class PositiveInt {
    public int $value {
        set(int $v) {
...
#[test] fn property_hook_get_and_set_together() {
    assert_eq!(run_prints(r#"<?php
class Temperature {
...
#[test] fn virtual_property_computed_from_parts() {
    assert_eq!(run_prints(r#"<?php
class Point {
...
#[test] fn property_hook_get_in_child_overrides_parent() {
    assert_eq!(run_prints(r#"<?php
class Base {
    public string $label {
        get => "base";
...
#[test] fn readonly_property_with_get_hook_accessible() {
    assert_eq!(run_prints(r#"<?php
class Token {
...
#[test] fn property_hook_set_coerces_string_to_int() {
    assert_eq!(run_prints(r#"<?php
class Counter {
    public int $count {
...
#[test] fn property_hook_declared_in_interface() {
    assert_eq!(run_prints(r#"<?php
interface HasName {
...
#[test] fn property_hook_set_normalizes_string() {
    assert_eq!(run_prints(r#"<?php
class Slug {
    public string $value {
        set(string $v) {
...
#[test] fn property_hook_set_short_arrow_syntax() {
    assert_eq!(run_prints(r#"<?php
class Box {
    public int $width {
        set => max(0, $value);
...
#[test] fn property_hook_used_inside_class_method() {
    assert_eq!(run_prints(r#"<?php
class Rectangle {
    public function __construct(
        public float $width,
...
#[test] fn multiple_properties_with_hooks_in_same_class() {
    assert_eq!(run_prints(r#"<?php
class Config {
    public string $host {
...
#[test] fn property_hook_with_constructor_access() {
    assert_eq!(run_prints(r#"<?php
class Email {
...
#[test] fn property_hook_get_formats_money_cents() {
    assert_eq!(run_prints(r#"<?php
class Price {
...
#[test] fn property_hook_get_used_in_another_hook() {
    assert_eq!(run_prints(r#"<?php
class Measure {
...
#[test] fn property_hook_set_triggers_side_effect() {
    assert_eq!(run_prints(r#"<?php
class Observable {
...
#[test] fn property_hook_accessible_from_subclass_instance() {
    assert_eq!(run_prints(r#"<?php
class Base {
...
#[test] fn interface_property_hook_declaration_compiles() {
    compile_ok(r#"<?php
interface Shape {
...
#[test] fn property_hook_uses_static_lookup() {
    assert_eq!(run_prints(r#"<?php
class Registry {
