...
#[test] fn named_capture_groups() { compile_ok(r#"<?php
$date = '2024-06-15';
...
#[test] fn non_capturing_group() { compile_ok(r#"<?php
...
#[test] fn positive_lookahead() { compile_ok(r#"<?php
...
#[test] fn negative_lookahead() { compile_ok(r#"<?php
...
#[test] fn positive_lookbehind() { compile_ok(r#"<?php
...
#[test] fn negative_lookbehind() { compile_ok(r#"<?php
...
#[test] fn non_greedy_quantifier() { compile_ok(r#"<?php
...
#[test] fn possessive_quantifier() { compile_ok(r#"<?php
...
#[test] fn atomic_group() { compile_ok(r#"<?php
...
#[test] fn unicode_mode_flag() { compile_ok(r#"<?php
$str = 'Héllo Wörld';
...
#[test] fn multiline_mode_flag() { compile_ok(r#"<?php
$text = "first line\nsecond line\nthird line";
...
#[test] fn dotall_s_flag() { compile_ok(r#"<?php
$text = "start\nmiddle\nend";
...
#[test] fn extended_x_flag() { compile_ok(r#"<?php
$pattern = '/
    ^           # start
    \d{4}       # year
    -           # separator
...
#[test] fn case_insensitive_with_unicode() { compile_ok(r#"<?php
...
#[test] fn preg_match_all_set_order() { compile_ok(r#"<?php
...
#[test] fn preg_match_all_offset_capture() { compile_ok(r#"<?php
...
#[test] fn preg_replace_backreference() { compile_ok(r#"<?php
...
#[test] fn preg_replace_callback_modify_match() { compile_ok(r#"<?php
...
#[test] fn preg_split_delim_capture() { compile_ok(r#"<?php
...
#[test] fn preg_quote_special_chars() { compile_ok(r#"<?php
