...
#[test]
fn closure_bind_to_static_context() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn closure_bind_to_child_accesses_parent_private() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn static_closure_cannot_bind_this() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn closure_event_handler_pattern() {
    assert_eq!(
        run_prints(
            r#"<?php
class Button {
...
#[test]
fn arrow_fn_captures_outer_scope() {
    assert_eq!(
        run_prints(
            r#"<?php
$multiplier = 3;
...
#[test]
fn closure_captures_value_not_binding() {
    assert_eq!(
        run_prints(
            r#"<?php
$x = 5;
...
#[test]
fn closure_captures_reference_sees_change() {
    assert_eq!(
        run_prints(
            r#"<?php
$x = 5;
