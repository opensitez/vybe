...
#[test]
fn http_build_query_assoc_array() {
    compile_ok(
        r#"<?php
...
#[test]
fn http_build_query_custom_separator() {
    compile_ok(
        r#"<?php
$params = ['a' => 1, 'b' => 2, 'c' => 3];
$qs = http_build_query($params, '', '&amp;');
...
#[test]
fn http_build_query_numeric_array() {
    compile_ok(
        r#"<?php
$params = ['foo', 'bar', 'baz'];
$qs = http_build_query($params);
...
// ── http_response_code ───────────────────────────────────────────
#[test]
fn http_response_code_compile_ok() {
    compile_ok(
        r#"<?php
