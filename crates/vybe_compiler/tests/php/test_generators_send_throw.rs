...
#[test] fn generator_send_receives_value() {
...
#[test] fn generator_send_initial_null() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_send_controls_loop() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_return_value_accessible_via_get_return() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_return_value_is_null_if_no_return() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_return_string_value() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_throw_triggers_exception_inside() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_throw_propagates_if_uncaught() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_finally_runs_on_early_close() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_finally_runs_on_normal_completion() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn yield_from_array_delegation() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn yield_from_generator_delegation() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn yield_from_returns_inner_generator_return() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_yield_key_value_pairs() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_lazy_range_with_step() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_valid_returns_false_after_exhaustion() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_rewind_does_not_reset() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn infinite_generator_take_n_items() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_calculator_protocol() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn iterator_to_array_preserve_keys_true() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn iterator_to_array_preserve_keys_false_reindexes() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_catch_rethrow_pattern() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_multiple_yields_after_send() {
    assert_eq!(run_prints(r#"<?php
