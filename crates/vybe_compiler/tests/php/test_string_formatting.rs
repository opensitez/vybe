...
#[test] fn sprintf_padding_integer() {
    compile_ok(r#"<?php
...
#[test] fn sprintf_padding_string() {
    compile_ok(r#########"<?php
...
#[test] fn sprintf_width_precision_float() {
    compile_ok(r#"<?php
...
#[test] fn number_format_no_decimals() {
    compile_ok(r#"<?php
echo number_format(9999999, 0, '.', ',');
"#);
}

#[test] fn number_format_small_numbers() {
    compile_ok(r#"<?php
...
#[test] fn intl_number_formatter_currency() {
    compile_ok(r#"<?php
...
#[test] fn chunk_split_basic() {
    compile_ok(r#"<?php
echo chunk_split("ABCDEFGH", 2, "-");
"#);
}

#[test] fn chunk_split_base64() {
    compile_ok(r#"<?php
...
#[test] fn sprintf_sql_like_pattern() {
    compile_ok(r#"<?php
...
#[test] fn sprintf_currency_table() {
    compile_ok(r#"<?php
