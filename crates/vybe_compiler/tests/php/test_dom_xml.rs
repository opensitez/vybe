...
#[test] fn dom_get_elements_by_tag() {
    compile_ok(r#"<?php
...
#[test] fn dom_xpath_attribute_predicate() {
    compile_ok(r#"<?php
...
#[test] fn dom_xpath_text_content() {
    compile_ok(r#"<?php
...
#[test] fn dom_xpath_register_namespace() {
    compile_ok(r#"<?php
