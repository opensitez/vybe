...
#[test] fn date_format_current_timestamp() {
    compile_ok(r#"<?php
...
#[test] fn date_with_specific_timestamp() {
    compile_ok(r#"<?php
...
#[test] fn mktime_from_components() {
    compile_ok(r#"<?php
date_default_timezone_set('UTC');
...
#[test] fn strtotime_relative_expressions() {
    compile_ok(r#"<?php
date_default_timezone_set('UTC');
...
#[test] fn time_get_unix_timestamp() {
    compile_ok(r#"<?php
$t = time();
...
#[test] fn checkdate_validates_dates() {
    compile_ok(r#"<?php
...
#[test] fn date_interval_from_date_string() {
    compile_ok(r#"<?php
...
#[test] fn datetime_create_from_format_static() {
    compile_ok(r#"<?php
