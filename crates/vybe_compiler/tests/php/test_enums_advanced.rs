...
#[test] fn enum_method_with_logic() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_implements_interface_method() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_cases_returns_all() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_backed_cases_values() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_in_match_multiple_arms() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_collection_filter() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn backed_enum_from_tryFrom() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_singletons_compared_by_identity() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_different_cases_not_equal() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_as_parameter_type() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_nullable_parameter() {
    assert_eq!(run_prints(r#"<?php
