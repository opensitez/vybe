...
#[test] fn generator_valid_after_all_consumed() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_count_not_applicable() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn yield_from_nested_return() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_finally_on_early_close() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_rewind_restarts() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_yields_objects() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_accumulates_state() {
    assert_eq!(run_prints(r#"<?php
