...
#[test] fn reflection_class_get_methods() {
    assert_eq!(run_prints(r#"<?php
class Sample {
...
#[test] fn reflection_class_get_properties() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn reflection_class_get_parent() {
    assert_eq!(run_prints(r#"<?php
class Animal {}
...
#[test] fn reflection_class_implements_interface() {
    assert_eq!(run_prints(r#"<?php
interface Flyable {}
...
#[test] fn reflection_property_get_value() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn reflection_property_set_value() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn reflection_function_parameters() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn reflection_parameter_info() {
    assert_eq!(run_prints(r#"<?php
