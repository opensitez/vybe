...
#[test] fn spread_merges_two_arrays() {
...
#[test] fn spread_with_leading_element() {
    assert_eq!(run_prints(r#"<?php
$rest = [2, 3, 4];
$full = [1, ...$rest];
echo implode(',', $full);
...
#[test] fn spread_with_trailing_element() {
    assert_eq!(run_prints(r#"<?php
$start = [1, 2, 3];
$full = [...$start, 4];
echo implode(',', $full);
...
#[test] fn spread_string_keyed_arrays_merges_preserving_keys() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spread_string_keys_later_wins() {
    assert_eq!(run_prints(r#"<?php
$a = ['x' => 1, 'y' => 2];
$b = ['y' => 99, 'z' => 3];
$result = [...$a, ...$b];
...
#[test] fn spread_mixed_string_and_int_keys() {
    assert_eq!(run_prints(r#"<?php
$named = ['name' => 'Alice'];
$indexed = [1, 2, 3];
...
#[test] fn spread_in_function_call() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spread_partial_positional_args() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spread_with_named_arg_after() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spread_in_new_constructor_call() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spread_equivalent_to_array_merge_for_indexed() {
    assert_eq!(run_prints(r#"<?php
$a = [1, 2];
$b = [3, 4];
$spread = [...$a, ...$b];
...
#[test] fn spread_reindexes_numeric_keys() {
    assert_eq!(run_prints(r#"<?php
$a = [5 => 'a', 10 => 'b'];
$result = [...$a, 'c'];
...
#[test] fn spread_empty_array_contributes_nothing() {
    assert_eq!(run_prints(r#"<?php
$empty = [];
$arr = [1, ...$empty, 2];
echo implode(',', $arr);
...
#[test] fn spread_inside_array_construction_in_map() {
    assert_eq!(run_prints(r#"<?php
$pairs = [[1, 2], [3, 4], [5, 6]];
...
#[test] fn spread_config_merge_defaults_with_user() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spread_string_keys_array_keys_preserved() {
    assert_eq!(run_prints(r#"<?php
$a = ['x' => 1];
$b = ['y' => 2];
$result = [...$a, ...$b];
...
#[test] fn spread_inside_nested_array_literal() {
    assert_eq!(run_prints(r#"<?php
$inner = [2, 3];
...
#[test] fn spread_with_range_function() {
    assert_eq!(run_prints(r#"<?php
$prefix = ['start'];
...
#[test] fn spread_of_filtered_array_reindexes() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spread_in_return_builds_array() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_args_spread_from_assoc_array() {
    assert_eq!(run_prints(r#"<?php
