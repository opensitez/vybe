...
#[test] fn mb_case_conversion_roundtrip() {
    compile_ok(r#"<?php
...
#[test] fn mb_substr_count_multibyte() {
    compile_ok(r#"<?php
$s = "日本日本日";
...
#[test] fn mb_str_split_multibyte() {
    compile_ok(r#"<?php
...
#[test] fn mb_str_split_chunk_size() {
    compile_ok(r#"<?php
...
#[test] fn mb_detect_encoding_multibyte() {
    compile_ok(r#"<?php
$s = "こんにちは";
...
#[test] fn mb_convert_encoding_basic() {
    compile_ok(r#"<?php
$utf8 = "Hello World";
...
#[test] fn mb_convert_encoding_latin_to_utf8() {
    compile_ok(r#"<?php
...
#[test] fn mb_internal_encoding_get() {
    compile_ok(r#"<?php
...
#[test] fn mb_internal_encoding_set() {
    compile_ok(r#"<?php
...
#[test] fn mb_strlen_with_encoding_param() {
    compile_ok(r#"<?php
$s = "Hello";
...
#[test] fn mb_convert_case_upper() {
    compile_ok(r#"<?php
echo mb_convert_case("hello world", MB_CASE_UPPER);
"#);
}

#[test] fn mb_convert_case_lower() {
    compile_ok(r#"<?php
