...
#[test] fn closure_bind_change_object() {
    compile_ok(r#"<?php
...
#[test] fn closure_bind_static_context() {
    compile_ok(r#"<?php
...
#[test] fn closure_bind_null_object_static() {
    compile_ok(r#"<?php
class Config {
...
#[test] fn closure_bind_to_different_instance() {
    compile_ok(r#"<?php
...
#[test] fn closure_bind_to_fluent() {
    compile_ok(r#"<?php
class Builder {
    private array $parts = [];
...
#[test] fn closure_from_callable_compose() {
    compile_ok(r#"<?php
...
#[test] fn static_closure_in_array_map() {
    compile_ok(r#"<?php
$nums = [1, 2, 3, 4, 5];
...
#[test] fn closure_stored_in_property() {
    compile_ok(r#"<?php
class Handler {
...
#[test] fn closure_returned_from_function() {
    compile_ok(r#"<?php
...
#[test] fn currying_with_closures() {
    compile_ok(r#"<?php
...
#[test] fn closure_call_with_args() {
    compile_ok(r#"<?php
