...
#[test] fn named_arg_array_slice() {
    assert_eq!(run_prints(r#"<?php echo implode(',', array_slice(array: [1,2,3,4,5], offset: 1, length: 3)); "#), vec!["2,3,4"]);
}
#[test] fn named_arg_implode() {
    assert_eq!(run_prints(r#"<?php echo implode(separator: '-', array: ['a','b','c']); "#), vec!["a-b-c"]);
}
#[test] fn named_arg_str_pad() {
    assert_eq!(run_prints(r#"<?php echo str_pad(string: '42', length: 6, pad_string: '0', pad_type: STR_PAD_LEFT); "#), vec!["000042"]);
}
#[test] fn named_arg_substr() {
    assert_eq!(run_prints(r#"<?php echo substr(string: 'Hello World', offset: 6); "#), vec!["World"]);
}
#[test] fn named_arg_str_contains() {
    assert_eq!(run_prints(r#"<?php echo str_contains(haystack: 'Hello World', needle: 'World') ? 'yes' : 'no'; "#), vec!["yes"]);
}

// ── Named arguments out of order ──────────────────────────────

#[test] fn named_arg_out_of_order_user_func() {
...
#[test] fn named_arg_skip_optional() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_arg_before_variadic() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_arg_constructor_out_of_order() {
    assert_eq!(run_prints(r#"<?php
class Point {
...
#[test] fn named_arg_with_default_skipped() {
    assert_eq!(run_prints(r#"<?php
class Config {
...
#[test] fn named_arg_spread_from_assoc() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_arg_in_match_arm_function() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_arg_error_on_duplicate() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_positional_mixed() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_arg_array_map_callback() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn named_arg_static_method() {
    assert_eq!(run_prints(r#"<?php
class Converter {
