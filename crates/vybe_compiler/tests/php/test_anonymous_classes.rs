...
#[test] fn anon_class_extends_parent() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn anon_class_extends_and_overrides() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn anon_class_as_return_value() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn anon_class_captures_outer_scope_via_constructor() {
    assert_eq!(run_prints(r#"<?php
$multiplier = 3;
...
#[test] fn anon_class_instanceof_interface() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn anon_class_chaining_methods() {
    assert_eq!(run_prints(r#"<?php
$b = new class {
    private array $parts = [];
...
#[test] fn anon_class_static_method() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn anon_class_in_array_of_objects() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn anon_class_inner_class_pattern() {
    assert_eq!(run_prints(r#"<?php
class Outer {
...
#[test] fn anon_class_multiple_interfaces() {
    assert_eq!(run_prints(r#"<?php
