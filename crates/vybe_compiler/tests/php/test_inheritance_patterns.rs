...
#[test] fn parent_constructor_called() {
...
#[test] fn constructor_chain_three_levels() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn override_method_calls_parent() {
    assert_eq!(run_prints(r#"<?php
class Logger {
...
#[test] fn override_in_deep_chain() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn instanceof_in_hierarchy() {
    assert_eq!(run_prints(r#"<?php
class Vehicle {}
...
#[test] fn final_method_cannot_override() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn final_class_cannot_extend() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn abstract_method_in_concrete_subclass() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn interface_and_abstract_class() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn protected_property_accessed_in_child() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn private_not_visible_in_child() {
    assert_eq!(run_prints(r#"<?php
