...
#[test]
fn function_exists_user_defined() {
    compile_ok(
        r#"<?php
...
#[test]
fn forward_static_call_array_lsb() {
    compile_ok(
        r#"<?php
class Logger {
    static function log() {
...
#[test]
fn register_shutdown_function_basic() {
    compile_ok(
        r#"<?php
...
#[test]
fn get_defined_functions_lists() {
    compile_ok(
        r#"<?php
function myCustomFn() {}
...
#[test]
fn array_walk_with_key_and_extra() {
    compile_ok(
        r#"<?php
...
#[test]
fn usort_with_static_method_callable() {
    compile_ok(
        r#"<?php
class Sorter {
