...
#[test]
fn magic_line_changes_per_line() {
    compile_ok(
        r#"<?php
$a = __LINE__;
$b = __LINE__;
...
#[test]
fn magic_function_global_scope() {
    compile_ok(
        r#"<?php
...
#[test]
fn magic_class_in_parent_inherited() {
    compile_ok(
        r#"<?php
class Base {
...
#[test]
fn magic_trait_multiple_classes() {
    compile_ok(
        r#"<?php
trait Logging {
...
#[test]
fn magic_namespace_in_function() {
    compile_ok(
        r#"<?php
