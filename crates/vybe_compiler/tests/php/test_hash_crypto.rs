...
#[test] fn hash_hmac_sha256() { compile_ok(r#"<?php
$key = 'secret';
$msg = 'data to sign';
...
#[test] fn hash_algos_list() { compile_ok(r#"<?php
$algos = hash_algos();
...
#[test] fn hash_equals_timing_safe() { compile_ok(r#"<?php
...
#[test] fn md5_file_hash() { compile_ok(r#"<?php
...
#[test] fn sha1_file_hash() { compile_ok(r#"<?php
...
#[test] fn password_hash_bcrypt_algo() { compile_ok(r#"<?php
$hash = password_hash('mypassword', PASSWORD_BCRYPT);
echo is_string($hash) ? 'hashed' : 'fail';
echo str_starts_with($hash, '$2y$') ? ':bcrypt' : ':other';
"#); }

#[test] fn password_hash_argon2i_algo() { compile_ok(r#"<?php
...
#[test] fn password_verify_correct_and_wrong() { compile_ok(r#"<?php
...
#[test] fn password_needs_rehash_check() { compile_ok(r#"<?php
...
#[test] fn password_get_info_structure() { compile_ok(r#"<?php
...
#[test] fn openssl_random_pseudo_bytes_length() { compile_ok(r#"<?php
...
#[test] fn random_bytes_secure() { compile_ok(r#"<?php
$bytes = random_bytes(32);
echo strlen($bytes) === 32 ? 'ok' : 'fail';
echo strlen(bin2hex($bytes)) === 64 ? ':hex ok' : ':hex fail';
"#); }

#[test] fn random_int_range() { compile_ok(r#"<?php
$n = random_int(1, 100);
...
#[test] fn crc32_hash() { compile_ok(r#"<?php
...
#[test] fn base64_roundtrip_binary() { compile_ok(r#"<?php
$raw = random_bytes(24);
