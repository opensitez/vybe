...
#[test] fn yield_from_return_value() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_send_bidirectional() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_first_send_must_be_null() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_key_value_pairs() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_preserves_keys_false() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_throw_caught_inside() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn generator_as_coroutine_state_machine() {
    assert_eq!(run_prints(r#"<?php
