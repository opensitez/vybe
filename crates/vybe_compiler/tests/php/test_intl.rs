...
#[test] fn number_formatter_decimal() {
    compile_ok(r#"<?php
...
#[test] fn number_formatter_currency() {
    compile_ok(r#"<?php
...
#[test] fn number_formatter_currency_eur() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
...
#[test] fn number_formatter_percent() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
...
#[test] fn number_formatter_scientific() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
...
#[test] fn number_formatter_spellout() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
...
#[test] fn number_formatter_parse() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
$fmt = new NumberFormatter('en_US', NumberFormatter::DECIMAL);
...
#[test] fn number_formatter_parse_currency() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
$fmt = new NumberFormatter('en_US', NumberFormatter::CURRENCY);
$currency = '';
...
#[test] fn number_formatter_attributes() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
$fmt = new NumberFormatter('en_US', NumberFormatter::DECIMAL);
...
#[test] fn number_formatter_grouping() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
...
#[test] fn intl_date_formatter_basic() {
    compile_ok(r#"<?php
...
#[test] fn intl_date_formatter_short() {
    compile_ok(r#"<?php
if (!class_exists('IntlDateFormatter')) { echo 'skipped'; return; }
...
#[test] fn intl_date_formatter_pattern() {
    compile_ok(r#"<?php
if (!class_exists('IntlDateFormatter')) { echo 'skipped'; return; }
...
#[test] fn intl_date_formatter_parse() {
    compile_ok(r#"<?php
if (!class_exists('IntlDateFormatter')) { echo 'skipped'; return; }
$fmt = new IntlDateFormatter('en_US', IntlDateFormatter::NONE, IntlDateFormatter::NONE,
    'UTC', IntlDateFormatter::GREGORIAN, 'yyyy-MM-dd');
...
#[test] fn intl_date_formatter_locale_de() {
    compile_ok(r#"<?php
if (!class_exists('IntlDateFormatter')) { echo 'skipped'; return; }
...
#[test] fn collator_basic_compare() {
    compile_ok(r#"<?php
...
#[test] fn collator_sort_locale_de() {
    compile_ok(r#"<?php
if (!class_exists('Collator')) { echo 'skipped'; return; }
...
#[test] fn message_formatter_basic() {
    compile_ok(r#"<?php
...
#[test] fn message_formatter_plural() {
    compile_ok(r#"<?php
if (!class_exists('MessageFormatter')) { echo 'skipped'; return; }
...
#[test] fn message_formatter_static() {
    compile_ok(r#"<?php
if (!class_exists('MessageFormatter')) { echo 'skipped'; return; }
...
#[test] fn message_formatter_date() {
    compile_ok(r#"<?php
if (!class_exists('MessageFormatter')) { echo 'skipped'; return; }
...
#[test] fn locale_get_display_name() {
    compile_ok(r#"<?php
if (!class_exists('Locale')) { echo 'skipped'; return; }
...
#[test] fn intl_char_to_upper_lower() {
    compile_ok(r#"<?php
if (!class_exists('IntlChar')) { echo 'skipped'; return; }
...
#[test] fn format_price_multiple_locales() {
    compile_ok(r#"<?php
if (!class_exists('NumberFormatter')) { echo 'skipped'; return; }
$amount = 1234567.89;
...
#[test] fn sort_names_locale_aware() {
    compile_ok(r#"<?php
if (!class_exists('Collator')) { echo 'skipped'; return; }
