...
#[test]
fn password_verify_tampered_hash() {
    compile_ok(
        r#"<?php
...
#[test]
fn password_needs_rehash_same_algo() {
    compile_ok(
        r#"<?php
...
#[test]
fn password_needs_rehash_higher_cost() {
    compile_ok(
        r#"<?php
$hash = password_hash('pass', PASSWORD_BCRYPT, ['cost' => 10]);
...
#[test]
fn password_needs_rehash_different_algo() {
    compile_ok(
        r#"<?php
