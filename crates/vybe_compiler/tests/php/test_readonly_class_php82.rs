...
#[test] fn readonly_class_all_properties_implicitly_readonly() {
...
#[test] fn readonly_class_property_cannot_be_modified() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_class_can_be_cloned() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_class_extends_works() {
    assert_eq!(run_prints(r#"<?php
readonly class Base {
...
#[test] fn readonly_property_set_once_in_constructor() {
    assert_eq!(run_prints(r#"<?php
class Token {
...
#[test] fn readonly_property_throws_on_second_write() {
    assert_eq!(run_prints(r#"<?php
class Token {
    public readonly string $value;
    public function __construct(string $val) { $this->value = $val; }
...
#[test] fn readonly_property_cannot_unset() {
    assert_eq!(run_prints(r#"<?php
class Cfg {
...
#[test] fn readonly_promoted_property() {
    assert_eq!(run_prints(r#"<?php
class User {
    public function __construct(
...
#[test] fn readonly_property_can_be_typed_nullable() {
    assert_eq!(run_prints(r#"<?php
class Node {
...
#[test] fn readonly_clone_preserves_values() {
    assert_eq!(run_prints(r#"<?php
readonly class Pair {
    public function __construct(
        public int $first,
...
#[test] fn readonly_class_implements_interface() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_property_union_type() {
    assert_eq!(run_prints(r#"<?php
class Ref {
...
#[test] fn readonly_property_in_parent_not_overrideable_in_child() {
    assert_eq!(run_prints(r#"<?php
class Vehicle {
...
#[test] fn readonly_property_without_default_is_uninitialized_until_set() {
    assert_eq!(run_prints(r#"<?php
class Lazy {
...
#[test] fn readonly_class_static_factory_method() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_array_property_set_once() {
    assert_eq!(run_prints(r#"<?php
class Config {
...
#[test] fn readonly_property_with_interface_type() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_class_json_serializable() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_class_as_value_object() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_promoted_nullable_default_null() {
    assert_eq!(run_prints(r#"<?php
class Event {
    public function __construct(
