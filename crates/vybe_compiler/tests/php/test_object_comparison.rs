...
#[test] fn two_separate_objects_not_identical() {
...
#[test] fn same_reference_is_identical() {
    assert_eq!(run_prints(r#"<?php
class A {}
$x = new A(); $y = $x;
echo ($x === $y) ? 'identical' : 'not identical';
...
#[test] fn two_objects_same_class_same_props_are_equal_not_identical() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn two_objects_different_props_not_equal() {
    assert_eq!(run_prints(r#"<?php
class Point { public function __construct(public int $x, public int $y) {} }
$a = new Point(1, 2);
$b = new Point(3, 4);
...
#[test] fn different_class_objects_not_equal_even_with_same_props() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn object_not_equal_to_null() {
    assert_eq!(run_prints(r#"<?php
class A {}
$a = new A();
...
#[test] fn null_not_identical_to_object() {
    assert_eq!(run_prints(r#"<?php
class A {}
$a = new A();
...
#[test] fn cloned_object_equal_but_not_identical() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn modifying_clone_makes_them_unequal() {
    assert_eq!(run_prints(r#"<?php
class Box { public int $v = 5; }
$a = new Box(); $b = clone $a;
$b->v = 99;
...
#[test] fn nullsafe_operator_on_null_returns_null() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn nullsafe_operator_chain_on_non_null() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn array_unique_with_equal_objects_keeps_first() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn in_array_strict_true_for_same_reference() {
    assert_eq!(run_prints(r#"<?php
class A {}
$obj = new A();
$arr = [$obj, new A()];
...
#[test] fn in_array_strict_false_for_equal_but_different_instance() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spl_object_id_different_for_different_instances() {
    assert_eq!(run_prints(r#"<?php
class A {}
$a = new A(); $b = new A();
...
#[test] fn spl_object_id_same_for_same_reference() {
    assert_eq!(run_prints(r#"<?php
class A {}
$a = new A(); $b = $a;
...
#[test] fn spl_object_hash_same_for_same_reference() {
    assert_eq!(run_prints(r#"<?php
class A {}
$a = new A(); $b = $a;
...
#[test] fn spl_object_hash_different_for_clones() {
    assert_eq!(run_prints(r#"<?php
class A {}
$a = new A(); $b = clone $a;
...
#[test] fn get_class_returns_exact_class_name() {
    assert_eq!(run_prints(r#"<?php
class Foo {}
$f = new Foo();
echo get_class($f);
...
#[test] fn get_class_returns_child_class_not_parent() {
    assert_eq!(run_prints(r#"<?php
class Animal {}
...
#[test] fn is_a_equivalent_to_instanceof_for_instance() {
    assert_eq!(run_prints(r#"<?php
class Animal {}
class Dog extends Animal {}
$d = new Dog();
...
#[test] fn is_a_string_with_allow_string_true() {
    assert_eq!(run_prints(r#"<?php
class Base {}
...
#[test] fn object_equality_compares_all_properties() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn spaceship_on_equal_objects_returns_zero() {
    assert_eq!(run_prints(r#"<?php
