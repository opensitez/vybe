...
#[test] fn override_attribute_valid() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn dynamic_class_constant_access() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn array_sum_empty_returns_zero() {
    assert_eq!(run_prints(r#"<?php echo array_sum([]); "#), vec!["0"]);
}
#[test] fn array_product_empty_returns_one() {
    assert_eq!(run_prints(r#"<?php echo array_product([]); "#), vec!["1"]);
}

// ── str_split / mb_str_split ──────────────────────────────────

#[test] fn str_split_default_chars() {
    assert_eq!(run_prints(r#"<?php echo implode(',', str_split('hello')); "#), vec!["h,e,l,l,o"]);
}
#[test] fn str_split_with_length() {
    assert_eq!(run_prints(r#"<?php echo implode('|', str_split('abcdef', 2)); "#), vec!["ab|cd|ef"]);
}
#[test] fn mb_str_split_unicode() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_class_all_props_readonly() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_class_throws_on_mutation() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn readonly_class_cloneable() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn dnf_type_nullable_intersection() {
    assert_eq!(run_prints(r#"<?php
interface A {}
interface B {}
...
#[test] fn fiber_getCurrent_inside_fiber() {
    assert_eq!(run_prints(r#"<?php
