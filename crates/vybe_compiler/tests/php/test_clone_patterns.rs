...
#[test] fn clone_creates_new_object_instance() {
...
#[test] fn clone_shallow_copies_scalar_properties() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn clone_modifying_clone_does_not_affect_original() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn shallow_clone_shares_nested_object_reference() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn clone_magic_method_called_on_clone() {
    assert_eq!(run_prints(r#"<?php
class Counter {
    public int $copies = 0;
...
#[test] fn clone_magic_method_deep_clones_nested_object() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn clone_magic_method_resets_id() {
    assert_eq!(run_prints(r#"<?php
class Entity {
...
#[test] fn clone_child_class_creates_child_instance() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn parent_clone_called_from_child_clone() {
    assert_eq!(run_prints(r#"<?php
class Base {
    public array $tags = [];
...
#[test] fn deep_clone_array_of_objects() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn clone_readonly_property_allowed_in_clone_magic() {
    assert_eq!(run_prints(r#"<?php
class Token {
...
#[test] fn clone_with_modifier_returns_new_value_object() {
    assert_eq!(run_prints(r#"<?php
class Money {
...
#[test] fn clone_copies_private_properties() {
    assert_eq!(run_prints(r#"<?php
class Secret {
    private string $key;
...
#[test] fn clone_with_null_resource_reset_in_magic() {
    assert_eq!(run_prints(r#"<?php
class Connection {
...
#[test] fn builder_clone_immutable_with_pattern() {
    assert_eq!(run_prints(r#"<?php
class Query {
...
#[test] fn cloned_objects_are_equal_but_not_identical() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn chain_of_clones_each_independent() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn static_property_not_cloned_per_instance() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn array_of_cloned_objects_are_independent() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn clone_magic_has_access_to_parent_properties() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn serialize_unserialize_produces_independent_copy() {
    assert_eq!(run_prints(r#"<?php
