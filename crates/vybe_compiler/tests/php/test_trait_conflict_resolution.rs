...
#[test]
fn insteadof_resolves_method_conflict() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn insteadof_picks_second_trait() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn insteadof_multiple_conflicts_resolved() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn as_alias_allows_accessing_excluded_method() {
    assert_eq!(
        run_prints(
            r#"<?php
trait A { public function hello(): string { return "A"; } }
...
#[test]
fn as_changes_method_visibility_to_protected() {
    compile_ok(
        r#"<?php
...
#[test]
fn as_changes_method_visibility_to_private() {
    compile_ok(
        r#"<?php
...
#[test]
fn trait_abstract_method_must_be_implemented() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Validatable {
...
#[test]
fn trait_abstract_method_fails_validation_on_missing_field() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Validatable {
...
#[test]
fn trait_property_accessible_in_class() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_static_property_shared_in_class() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn multiple_traits_no_conflict_compose() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_used_in_abstract_class() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_method_calls_class_method() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Formatter {
...
#[test]
fn class_using_trait_can_still_extend() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_satisfies_interface_requirement() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn multiple_as_aliases_on_same_method() {
    assert_eq!(
        run_prints(
            r#"<?php
...
#[test]
fn trait_static_method_callable_on_class() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Factory {
...
#[test]
fn trait_init_method_called_from_constructor() {
    assert_eq!(
        run_prints(
            r#"<?php
trait Initializable {
...
#[test]
fn trait_same_property_compatible_redeclaration() {
    compile_ok(
        r#"<?php
