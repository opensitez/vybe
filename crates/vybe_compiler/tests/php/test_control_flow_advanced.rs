...
#[test] fn match_as_expression_in_assign() {
    assert_eq!(run_prints(r#"<?php
$status = 2;
...
#[test] fn match_throws_on_no_match() {
    assert_eq!(run_prints(r#"<?php
try { $r = match(99) { 1 => 'one' }; }
catch (\UnhandledMatchError $e) { echo 'unhandled'; }
"#), vec!["unhandled"]);
}
#[test] fn match_with_no_arg_bool_conditions() {
    assert_eq!(run_prints(r#"<?php
$x = 15;
...
#[test] fn switch_return_from_function() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn do_while_executes_once() {
    assert_eq!(run_prints(r#"<?php
$i = 10;
...
#[test] fn null_coalescing_chained_deep() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn for_multiple_init_exprs() {
    assert_eq!(run_prints(r#"<?php
for ($i = 0, $j = 10; $i < $j; $i++, $j--) {}
echo $i . ':' . $j;
"#), vec!["5:5"]);
}
#[test] fn foreach_reference() {
    assert_eq!(run_prints(r#"<?php
$a = [1,2,3,4,5];
foreach ($a as &$v) $v *= 2;
unset($v);
...
#[test] fn recursive_binary_search() {
    assert_eq!(run_prints(r#"<?php
