...
#[test] fn union_type_null_checked() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn return_type_void() {
    assert_eq!(run_prints(r#"<?php
function logMsg(string $msg): void { echo $msg; }
logMsg('test');
"#), vec!["test"]);
}
#[test] fn return_type_self() {
    assert_eq!(run_prints(r#"<?php
class Builder {
    private array $parts = [];
...
#[test] fn covariant_return_in_override() {
    assert_eq!(run_prints(r#"<?php
class Animal {}
...
#[test] fn contravariant_param_in_override() {
    assert_eq!(run_prints(r#"<?php
class AnimalFood {}
...
#[test] fn coerce_string_to_int_without_strict() {
    assert_eq!(run_prints(r#"<?php
function add(int $a, int $b): int { return $a + $b; }
echo add('3', '4');
"#), vec!["7"]);
}
#[test] fn coerce_float_to_int_param() {
    assert_eq!(run_prints(r#"<?php
