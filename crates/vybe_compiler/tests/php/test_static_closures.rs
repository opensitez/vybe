...
#[test] fn static_closure_declared_with_keyword() {
    compile_ok(r#"<?php
$fn = static function() {
    return 42;
};
...
#[test] fn static_closure_returns_value() {
...
#[test] fn static_closure_captures_by_value_via_use() {
    assert_eq!(run_prints(r#"<?php
$factor = 3;
...
#[test] fn static_closure_cannot_mutate_outer_via_value_capture() {
    assert_eq!(run_prints(r#"<?php
$x = 10;
...
#[test] fn static_closure_passed_as_callback_to_array_map() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn static_closure_as_usort_comparator() {
    assert_eq!(run_prints(r#"<?php
$arr = [3, 1, 4, 1, 5];
...
#[test] fn static_arrow_function_basic() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn static_arrow_captures_outer_automatically() {
    assert_eq!(run_prints(r#"<?php
$base = 100;
...
#[test] fn static_arrow_used_in_array_map() {
    assert_eq!(run_prints(r#"<?php
$offset = 10;
...
#[test] fn closure_bind_to_new_object() {
    assert_eq!(run_prints(r#"<?php
class Counter {
    private int $count = 0;
}
...
#[test] fn closure_bind_with_null_scope_static() {
    compile_ok(r#"<?php
...
#[test] fn closure_bindto_instance_method() {
    assert_eq!(run_prints(r#"<?php
class Box {
...
#[test] fn closure_from_callable_named_function() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn closure_from_callable_builtin() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn recursive_closure_via_reference() {
    assert_eq!(run_prints(r#"<?php
$factorial = null;
...
#[test] fn memoize_closure_with_static_cache() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn partial_application_via_closure() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn closure_type_hint_in_parameter() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn callable_type_hint_accepts_closure() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn static_closure_returned_from_method() {
    assert_eq!(run_prints(r#"<?php
class Factory {
...
#[test] fn closure_used_as_default_property_initializer_workaround() {
    assert_eq!(run_prints(r#"<?php
class Pipeline {
