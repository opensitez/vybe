...
#[test] fn filter_validate_ip_v4_only() {
    compile_ok(r#"<?php
...
#[test] fn filter_validate_ip_v6_only() {
    compile_ok(r#"<?php
...
#[test] fn filter_validate_int_basic() {
    compile_ok(r#"<?php
...
#[test] fn filter_validate_int_range() {
    compile_ok(r#"<?php
...
#[test] fn filter_validate_boolean() {
    compile_ok(r#"<?php
$trues  = ['1', 'true', 'on', 'yes'];
...
#[test] fn filter_validate_domain() {
    compile_ok(r#"<?php
...
#[test] fn filter_sanitize_string() {
    compile_ok(r#"<?php
...
#[test] fn filter_sanitize_number_int() {
    compile_ok(r#"<?php
echo filter_var('  42abc-5  ', FILTER_SANITIZE_NUMBER_INT);
"#);
}

#[test] fn filter_sanitize_number_float() {
    compile_ok(r#"<?php
...
#[test] fn filter_var_default_option() {
    compile_ok(r#"<?php
...
#[test] fn filter_var_array_basic() {
    compile_ok(r#"<?php
$data = [
    'age'   => '25',
...
#[test] fn filter_var_array_with_options() {
    compile_ok(r#"<?php
...
#[test] fn filter_default_passthrough() {
    compile_ok(r#"<?php
$raw = "hello <world>";
...
#[test] fn sanitize_and_validate_pipeline() {
    compile_ok(r#"<?php
