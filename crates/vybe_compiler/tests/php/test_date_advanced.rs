...
#[test]
fn date_period_include_start_date() {
    compile_ok(
        r#"<?php
$start = new DateTimeImmutable('2024-01-01');
...
#[test]
fn date_period_get_date_interval() {
    compile_ok(
        r#"<?php
$start = new DateTimeImmutable('2024-01-01');
...
#[test]
fn date_interval_create_from_date_string() {
    compile_ok(
        r#"<?php
...
#[test]
fn datetime_timezone_list_by_region() {
    compile_ok(
        r#"<?php
...
#[test]
fn datetime_timezone_all_identifiers() {
    compile_ok(
        r#"<?php
...
#[test]
fn datetime_timezone_transitions() {
    compile_ok(
        r#"<?php
$tz = new DateTimeZone('America/New_York');
...
#[test]
fn datetime_create_from_interface() {
    compile_ok(
        r#"<?php
