...
#[test] fn file_get_contents_basic() { compile_ok(r#"<?php
$contents = file_get_contents('/etc/hostname');
echo is_string($contents) ? 'string' : 'not string';
"#); }

#[test] fn file_get_contents_with_context() { compile_ok(r#"<?php
...
#[test] fn file_put_contents_basic() { compile_ok(r#"<?php
...
#[test] fn file_read_lines() { compile_ok(r#"<?php
...
#[test] fn is_readable_check() { compile_ok(r#"<?php
$r = is_readable('/etc/hostname');
echo is_bool($r) ? 'bool' : 'not bool';
"#); }

#[test] fn is_writable_check() { compile_ok(r#"<?php
$w = is_writable('/tmp');
...
#[test] fn dirname_basic() { compile_ok(r#"<?php
...
#[test] fn basename_basic() { compile_ok(r#"<?php
echo basename('/var/www/html/index.php');
echo basename('/var/www/html/index.php', '.php');
"#); }

#[test] fn pathinfo_components() { compile_ok(r#"<?php
...
#[test] fn realpath_basic() { compile_ok(r#"<?php
...
#[test] fn glob_pattern() { compile_ok(r#"<?php
$files = glob('/tmp/*.txt');
...
#[test] fn scandir_directory() { compile_ok(r#"<?php
$entries = scandir('/tmp');
...
#[test] fn mkdir_and_rmdir() { compile_ok(r#"<?php
...
#[test] fn unlink_file() { compile_ok(r#"<?php
...
#[test] fn rename_file() { compile_ok(r#"<?php
...
#[test] fn copy_file() { compile_ok(r#"<?php
