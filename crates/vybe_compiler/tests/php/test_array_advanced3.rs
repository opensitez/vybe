...
#[test] fn array_map_preserves_assoc_keys() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn array_keys_values_reindex() {
    assert_eq!(run_prints(r#"<?php
$a = [5=>'a', 2=>'b', 9=>'c'];
$vals = array_values($a);
$keys = array_keys($a);
...
#[test] fn array_key_exists_vs_isset() {
    assert_eq!(run_prints(r#"<?php
$a = ['key' => null];
...
#[test] fn array_merge_reindexes_numeric() {
    assert_eq!(run_prints(r#"<?php
$a = [1=>10, 2=>20];
$b = [1=>30, 2=>40];
...
#[test] fn union_operator_preserves_keys() {
    assert_eq!(run_prints(r#"<?php
$a = [1=>'a', 2=>'b'];
$b = [2=>'x', 3=>'c'];
$result = $a + $b;
...
#[test] fn array_slice_preserve_keys_true() {
    assert_eq!(run_prints(r#"<?php
$a = ['a'=>1,'b'=>2,'c'=>3,'d'=>4];
...
#[test] fn array_slice_preserve_keys_false() {
    assert_eq!(run_prints(r#"<?php
$a = ['a'=>1,'b'=>2,'c'=>3];
...
#[test] fn array_udiff_custom_comparison() {
    assert_eq!(run_prints(r#"<?php
$a = [1,2,3,4,5];
$b = [2,4];
...
#[test] fn array_walk_recursive_deep() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn array_map_nested_transform() {
    assert_eq!(run_prints(r#"<?php
