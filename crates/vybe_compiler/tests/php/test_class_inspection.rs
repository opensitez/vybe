...
// ── interface_exists ──────────────────────────────────────────────
#[test]
fn interface_exists_defined_interface() { compile_ok(r#"<?php
...
// ── trait_exists ──────────────────────────────────────────────────
#[test]
fn trait_exists_defined_trait() { compile_ok(r#"<?php
...
// ── get_class_methods ────────────────────────────────────────────
#[test]
fn get_class_methods_returns_array() { compile_ok(r#"<?php
class Calc {
...
// ── get_class_vars ───────────────────────────────────────────────
#[test]
fn get_class_vars_default_properties() { compile_ok(r#"<?php
class Config {
...
// ── get_object_vars ──────────────────────────────────────────────
#[test]
fn get_object_vars_public_properties() { compile_ok(r#"<?php
class Point {
    public int $x;
    public int $y;
...
// ── get_parent_class ─────────────────────────────────────────────
#[test]
fn get_parent_class_with_inheritance() { compile_ok(r#"<?php
class Base {}
...
// ── get_called_class ─────────────────────────────────────────────
#[test]
fn get_called_class_static_context() { compile_ok(r#"<?php
class ParentClass {
...
#[test]
fn is_subclass_of_string_class_arg() { compile_ok(r#"<?php
class Shape {}
...
// ── class_implements ─────────────────────────────────────────────
#[test]
fn class_implements_interfaces_list() { compile_ok(r#"<?php
...
// ── class_uses ───────────────────────────────────────────────────
#[test]
fn class_uses_trait_list() { compile_ok(r#"<?php
...
// ── class_parents ────────────────────────────────────────────────
#[test]
fn class_parents_hierarchy() { compile_ok(r#"<?php
class A {}
class B extends A {}
class C extends B {}
...
// ── property_exists ──────────────────────────────────────────────
#[test]
fn property_exists_class_and_object() { compile_ok(r#"<?php
class User {
    public string $name;
    protected int $age = 0;
}
...
// ── method_exists ────────────────────────────────────────────────
#[test]
fn method_exists_class_and_object() { compile_ok(r#"<?php
class Greeter {
...
#[test]
fn class_exists_no_autoload() { compile_ok(r#"<?php
...
#[test]
fn get_class_no_arg_from_method() { compile_ok(r#"<?php
class SelfNaming {
