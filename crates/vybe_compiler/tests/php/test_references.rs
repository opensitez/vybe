...
#[test]
fn pass_by_reference_nested_array() {
    compile_ok(
        r#"<?php
...
#[test]
fn pass_by_reference_string_modify() {
    compile_ok(
        r#"<?php
...
#[test]
fn unset_reference_keeps_original() {
    compile_ok(
        r#"<?php
$x = 1;
$y = &$x;
...
#[test]
fn return_by_reference_function() {
    compile_ok(
        r#"<?php
...
#[test]
fn return_by_reference_property() {
    compile_ok(
        r#"<?php
class Config {
    private array $data = [];
...
#[test]
fn closure_reference_accumulator() {
    compile_ok(
        r#"<?php
$total = 0;
...
#[test]
fn global_reference_accumulate() {
    compile_ok(
        r#"<?php
$sum = 0;
...
#[test]
fn static_variable_via_reference() {
    compile_ok(
        r#"<?php
