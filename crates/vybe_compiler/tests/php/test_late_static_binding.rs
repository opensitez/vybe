...
#[test] fn lsb_static_class_returns_called_class() {
...
#[test] fn lsb_self_class_returns_defining_class() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn lsb_new_static_creates_child_instance() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn lsb_new_self_always_creates_base() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn lsb_factory_named_constructor() {
    assert_eq!(run_prints(r#"<?php
class Model {
...
#[test] fn lsb_static_property_per_subclass() {
    assert_eq!(run_prints(r#"<?php
class Counter {
...
#[test] fn lsb_static_in_instance_method() {
    assert_eq!(run_prints(r#"<?php
class Base {
...
#[test] fn lsb_fluent_builder_with_static_return() {
    assert_eq!(run_prints(r#"<?php
class Query {
...
#[test] fn lsb_static_const_resolved_in_child() {
    assert_eq!(run_prints(r#"<?php
class Base {
    const TYPE = 'base';
