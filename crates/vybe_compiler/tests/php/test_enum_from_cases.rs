...
#[test] fn backed_enum_from_valid_int() {
...
#[test] fn backed_enum_from_valid_string() {
    assert_eq!(run_prints(r#"<?php
enum Color: string {
    case Red = 'red';
    case Blue = 'blue';
...
#[test] fn backed_enum_from_throws_on_invalid() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn backed_enum_try_from_returns_case_on_match() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn backed_enum_try_from_returns_null_on_no_match() {
    assert_eq!(run_prints(r#"<?php
enum Priority: int { case Low = 1; case High = 3; }
...
#[test] fn backed_enum_try_from_string_no_match() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn pure_enum_cases_returns_all() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn backed_enum_cases_returns_case_objects() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_cases_preserves_declaration_order() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_implements_interface_with_method() {
    assert_eq!(run_prints(r#"<?php
interface HasLabel {
...
#[test] fn enum_implements_stringable() {
    assert_eq!(run_prints(r#"<?php
interface HasLabel {
    public function label(): string;
}
...
#[test] fn enum_method_access_value() {
    assert_eq!(run_prints(r#"<?php
enum Priority: int {
    case Low = 1;
    case Medium = 5;
...
#[test] fn enum_method_returns_other_case() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_can_have_constants() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_cases_are_identical_singletons() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_different_cases_not_identical() {
    assert_eq!(run_prints(r#"<?php
enum Color { case Red; case Blue; }
...
#[test] fn backed_enum_value_accessible() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn enum_cases_in_array_with_in_array() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn backed_enum_as_type_hint_parameter() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn pure_enum_name_property() {
    assert_eq!(run_prints(r#"<?php
...
#[test] fn backed_enum_name_and_value_distinct() {
    assert_eq!(run_prints(r#"<?php
