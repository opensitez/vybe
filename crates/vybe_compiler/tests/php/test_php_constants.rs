...
#[test] fn php_major_version() {
    compile_ok(r#"<?php
$v = PHP_MAJOR_VERSION;
"#);
}

#[test] fn php_os_family() {
    compile_ok(r#"<?php
$os = PHP_OS_FAMILY;
"#);
}
...
#[test] fn uppercase_true_false_null() {
    compile_ok(r#"<?php
$t = TRUE;
$f = FALSE;
$n = NULL;
...
#[test] fn str_pad_direction_constants() {
    compile_ok(r#"<?php
...
#[test] fn array_filter_use_key_constant() {
    compile_ok(r#"<?php
$arr = ['a' => 1, 'b' => 2, 'c' => 3];
...
#[test] fn array_filter_use_both_constant() {
    compile_ok(r#"<?php
$arr = ['x' => 10, 'y' => 5, 'z' => 20];
...
#[test] fn directory_separator_constant() {
    compile_ok(r#"<?php
...
#[test] fn path_separator_constant() {
    compile_ok(r#"<?php
...
#[test] fn define_scalar_constant() {
    compile_ok(r#"<?php
...
#[test] fn constant_function_by_name() {
    compile_ok(r#"<?php
define('TIMEOUT', 30);
$name = 'TIMEOUT';
echo constant($name);
