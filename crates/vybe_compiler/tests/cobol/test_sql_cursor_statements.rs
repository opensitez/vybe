...
#[test]
fn sql_disconnect_compiles() {
    compile_ok(&p("", "    EXEC SQL COMMIT END-EXEC."));
}
#[test]
fn sql_select_into_compiles() {
    compile_ok(&p(
        "01 N PIC X(50).",
...
#[test]
fn sql_commit_compiles() {
    compile_ok(&p("", "    EXEC SQL COMMIT END-EXEC."));
}
#[test]
fn sql_rollback_compiles() {
    compile_ok(&p("", "    EXEC SQL ROLLBACK END-EXEC."));
}
#[test]
fn sql_declare_cursor_compiles() {
    compile_ok(&p(
        "",
...
#[test]
fn sql_open_cursor_compiles() {
    compile_ok(&p("", "    EXEC SQL OPEN C1 END-EXEC."));
}
#[test]
fn sql_fetch_cursor_compiles() {
    compile_ok(&p(
        "01 I PIC 9(5).",
...
#[test]
fn sql_close_cursor_compiles() {
    compile_ok(&p("", "    EXEC SQL CLOSE C1 END-EXEC."));
}
#[test]
fn sql_cursor_loop_compiles() {
    compile_ok(&p(
...
#[test]
fn sql_multi_statement_compiles() {
    compile_ok(&p(
        "01 I PIC 9(5) VALUE 1.",
...
#[test]
fn sql_transaction_pattern_compiles() {
    compile_ok(&p(
        "01 SQLCODE PIC S9(9) VALUE 0.",
...
#[test]
fn sql_select_two_cols_compiles() {
    compile_ok(&p(
        "01 A PIC X(20).\n01 B PIC 9(5).",
...
#[test]
fn sql_cursor_two_cols_compiles() {
    compile_ok(&p(
        "01 A PIC X(20).\n01 B PIC 9(5).",
