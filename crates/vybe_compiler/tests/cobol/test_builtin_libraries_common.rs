...
#[test]
fn sql_cursor_declare_compiles() {
    compile_ok(&p(
        "",
...
#[test]
fn sql_cursor_open_compiles() {
    compile_ok(&p("", "    EXEC SQL OPEN C1 END-EXEC."));
}
#[test]
fn sql_cursor_fetch_compiles() {
    compile_ok(&p(
        "01 I PIC 9(5).",
...
#[test]
fn json_parse_into_group_compiles() {
    compile_ok(&p(
        "01 J PIC X(100).\n01 R.\n   05 N PIC X(10).",
        "    JSON PARSE J INTO R.",
    ));
