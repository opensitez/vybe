...
vb_case!(
    date_literal_supports_new_years_day,
    r#"
Module M
    Sub Main()
...
vb_case!(
    date_literal_supports_mid_month_value,
    r#"
Module M
    Sub Main()
...
vb_case!(
    date_literal_supports_leap_day,
    r#"
Module M
    Sub Main()
...
vb_case!(
    date_literal_supports_summer_holiday_date,
    r#"
Module M
    Sub Main()
...
vb_case!(
    date_literal_supports_end_of_month_value,
    r#"
Module M
    Sub Main()
...
vb_case!(
    date_literal_supports_end_of_year_value,
    r#"
Module M
    Sub Main()
