...
vb_full_spec!(
    object_model_spec_class_field_round_trips_value,
    r#"Class Person
...
vb_full_spec!(
    object_model_spec_constructor_sets_field_from_argument,
    r#"Class Counter
...
vb_full_spec!(
    object_model_spec_method_reads_instance_field,
    r#"Class Counter
...
vb_full_spec!(
    object_model_spec_method_updates_instance_field,
    r#"Class Counter
    Public Value As Integer
...
vb_full_spec!(
    object_model_spec_overloaded_constructors_choose_parameterized_version,
    r#"Class Box
...
vb_full_spec!(
    object_model_spec_overloaded_methods_dispatch_by_arity,
    r#"Class Printer
...
vb_full_spec!(
    object_model_spec_overloaded_methods_dispatch_by_parameter_type,
    r#"Class Printer
    Public Function Show(value As Integer) As String
        Return "int:" & value
    End Function
...
vb_full_spec!(
    object_model_spec_auto_property_round_trips_value,
    r#"Class Person
...
vb_full_spec!(
    object_model_spec_read_only_property_returns_backing_field,
    r#"Class Bag
...
vb_full_spec!(
    object_model_spec_write_only_property_updates_backing_field,
    r#"Class Bag
...
vb_full_spec!(
    object_model_spec_custom_property_getter_transforms_value,
    r#"Class Person
...
vb_full_spec!(
    object_model_spec_custom_property_setter_transforms_value,
    r#"Class Person
...
vb_full_spec!(
    object_model_spec_default_property_can_index_collection_like_type,
    r#"Class Buffer
...
vb_full_spec!(
    object_model_spec_structure_field_round_trips_value,
    r#"Structure Point
    Public X As Integer
End Structure
Module M
...
vb_full_spec!(
    object_model_spec_structure_method_reads_state,
    r#"Structure Point
    Public X As Integer
...
vb_full_spec!(
    object_model_spec_structure_passed_by_value_keeps_original,
    r#"Structure Point
    Public X As Integer
End Structure
Module M
...
vb_full_spec!(
    object_model_spec_structure_passed_byref_can_mutate_original,
    r#"Structure Point
    Public X As Integer
End Structure
Module M
...
vb_full_spec!(
    object_model_spec_enum_values_compare_equal_to_named_member,
    r#"Enum Color
    Red = 1
    Blue = 2
End Enum
...
vb_full_spec!(
    object_model_spec_enum_underlying_value_prints_numeric_representation,
    r#"Enum Color
    Red = 4
End Enum
Module M
...
vb_full_spec!(
    object_model_spec_interface_method_dispatch_uses_implementation,
...
vb_full_spec!(
    object_model_spec_interface_reference_can_call_method,
    r#"Interface IGreeter
    Function Greet() As String
End Interface
Class Greeter
...
vb_full_spec!(
    object_model_spec_mustinherit_base_can_be_used_through_derived_type,
    r#"MustInherit Class Shape
...
vb_full_spec!(
    object_model_spec_overridable_method_can_be_overridden,
    r#"Class BasePrinter
...
vb_full_spec!(
    object_model_spec_mustoverride_method_is_implemented_by_derived_class,
    r#"MustInherit Class Shape
...
vb_full_spec!(
    object_model_spec_mybase_calls_base_implementation,
    r#"Class BasePrinter
    Public Overridable Function Speak() As String
        Return "base"
    End Function
...
vb_full_spec!(
    object_model_spec_me_reference_returns_current_instance_state,
    r#"Class Counter
...
vb_full_spec!(
    object_model_spec_property_can_return_object_field,
    r#"Class Address
...
vb_full_spec!(
    object_model_spec_object_initializer_sets_field,
    r#"Class Person
    Public Name As String
End Class
Module M
...
vb_full_spec!(
    object_model_spec_object_initializer_sets_property,
    r#"Class Person
    Public Property Name As String
End Class
Module M
...
vb_full_spec!(
    object_model_spec_nested_class_can_be_instantiated_through_outer_type,
    r#"Class Outer
    Public Class Inner
...
vb_full_spec!(
    object_model_spec_generic_class_stores_integer_value,
    r#"Class Box(Of T)
    Public Value As T
...
vb_full_spec!(
    object_model_spec_generic_class_stores_string_value,
    r#"Class Box(Of T)
    Public Value As T
    Public Sub New(v As T)
        Value = v
...
vb_full_spec!(
    object_model_spec_generic_method_echoes_argument,
    r#"Class Echoer
...
vb_full_spec!(
    object_model_spec_class_can_contain_list_field,
    r#"Class Bag
...
vb_full_spec!(
    object_model_spec_constructor_can_allocate_list_field,
    r#"Class Bag
...
vb_full_spec!(
    object_model_spec_method_can_return_me_for_fluent_usage,
    r#"Class Counter
    Public Value As Integer
...
vb_full_spec!(
    object_model_spec_nullable_integer_property_can_hold_nothing,
    r#"Class Holder
...
vb_full_spec!(
    object_model_spec_class_can_expose_array_property,
    r#"Class Holder
...
vb_full_spec!(
    object_model_spec_property_can_compute_from_two_fields,
    r#"Class Pair
...
vb_full_spec!(
    object_model_spec_private_backing_field_is_hidden_behind_property,
    r#"Class Meter
...
vb_full_spec!(
    object_model_spec_base_reference_can_point_to_derived_instance,
    r#"Class Animal
    Public Overridable Function Speak() As String
        Return "animal"
    End Function
...
vb_full_spec!(
    object_model_spec_interface_can_be_implemented_by_structure,
    r#"Interface INameable
...
vb_full_spec!(
    object_model_spec_structure_property_round_trips_value,
    r#"Structure Meter
    Public Property Value As Integer
End Structure
Module M
...
vb_full_spec!(
    object_model_spec_enum_can_drive_select_case_branch,
    r#"Enum Tone
    Low
    High
End Enum
...
vb_full_spec!(
    object_model_spec_class_can_contain_const_field,
    r#"Class Config
...
vb_full_spec!(
    object_model_spec_notinheritable_class_can_be_instantiated_normally,
    r#"NotInheritable Class Token
...
vb_full_spec!(
    object_model_spec_shadows_member_can_hide_base_field,
    r#"Class BaseToken
...
vb_full_spec!(
    object_model_spec_property_setter_can_ignore_redundant_assignment,
    r#"Class Meter
    Private _value As Integer
    Public Property Value As Integer
        Get
...
vb_full_spec!(
    object_model_spec_object_collection_property_can_be_iterated,
    r#"Class Bag
...
vb_full_spec!(
    object_model_spec_property_can_store_structure_value,
    r#"Structure Point
    Public X As Integer
End Structure
Class Holder
