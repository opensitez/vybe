...
vb_spec_case!(
    named_arguments_can_reorder_all_parameters_in_function_call,
    r#"
Module M
...
vb_spec_case!(
    named_arguments_can_mix_positional_and_named_arguments,
    r#"
Module M
    Function Describe(name As String, prefix As String, suffix As String) As String
        Return prefix & ":" & name & ":" & suffix
...
vb_spec_case!(
    named_arguments_can_override_only_middle_optional_parameter,
    r#"
Module M
...
vb_spec_case!(
    named_arguments_can_override_only_final_optional_parameter,
    r#"
Module M
    Function Describe(name As String, Optional prefix As String = "start", Optional suffix As String = ".") As String
        Return prefix & ":" & name & ":" & suffix
...
vb_spec_case!(
    named_arguments_can_skip_to_last_optional_when_middle_is_positional,
    r#"
Module M
...
vb_spec_case!(
    named_arguments_can_call_sub_with_boolean_and_message,
    r#"
Module M
...
vb_spec_case!(
    named_arguments_can_call_instance_method_out_of_order,
    r#"
Class Formatter
...
vb_spec_case!(
    named_arguments_can_call_shared_method_out_of_order,
    r#"
Class Formatter
...
vb_spec_case!(
    named_arguments_can_call_constructor_with_reordered_parameters,
    r#"
Class Person
...
vb_spec_case!(
    named_arguments_can_use_expression_values,
    r#"
Module M
...
vb_spec_case!(
    named_arguments_can_use_function_results_as_values,
    r#"
Module M
...
vb_spec_case!(
    named_arguments_can_target_byref_parameter_by_name,
    r#"
Module M
...
vb_spec_case!(
    named_arguments_can_target_property_setter_parameter_order,
    r#"
Class Counter
...
vb_spec_case!(
    named_arguments_can_be_used_twice_with_different_orderings,
    r#"
Module M
    Function Describe(name As String, prefix As String, suffix As String) As String
        Return prefix & ":" & name & ":" & suffix
...
vb_spec_case!(
    named_arguments_can_work_with_strings_containing_spaces,
    r#"
Module M
    Function Describe(name As String, prefix As String, suffix As String) As String
        Return prefix & ":" & name & ":" & suffix
