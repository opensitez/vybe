...
fn load_js_profile() -> vybe_compiler::profile::LanguageProfile {
    ...
    LanguageProfile {
        ...
        // ECMA capability flags — a JS profile enables the full ECMA surface
        // (these replaced the old `is_js_profile()` checks).
        member_call_on_null_error: "TypeError".into(),
        supports_private_fields: true,
        has_function_prototype_bind: true,
        has_function_constructor: true,
        async_wraps_body_in_try: true,
        ecma_error_object_shape: true,
        has_undefined_value: true,
        supports_spread_arguments: true,
        supports_dynamic_import: true,
        has_ecma_bigint: true,
        ecma_strict_mode: true,
        ecma_switch_strict_equality: true,
        ecma_lexical_declarations: true,
        has_ecma_globals: true,
        ecma_operator_coercion: true,
        abstract_equality: true,
        has_arguments_object: true,
        relaxed_call_arity: true,
        ecma_new_dispatch: true,
        ecma_array_elisions: true,
        has_generators: true,
        ecma_object_literals: true,
        ecma_boolean_operators: true,
        dynamic_member_access: true,
        ecma_typeof_operator: true,
        ecma_to_primitive: true,
        ecma_in_operator: true,
        ecma_array_method_dispatch: true,
        ecma_promise_methods: true,
        ecma_iterator_result_shape: true,
        throwable_is_root: false,
        builtins: {
