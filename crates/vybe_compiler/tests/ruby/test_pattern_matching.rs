...
// ── Pin operator ─────────────────────────────────────────────
#[test]
fn pin_operator_matches_variable() {
    compile_ok(
        r#"
expected = 42
case [1, 42, 3]
...
#[test]
fn custom_deconstruct_for_array_pattern() {
    compile_ok(
        r#"
class Point
  attr_reader :x, :y
...
#[test]
fn custom_deconstruct_keys_for_hash_pattern() {
    compile_ok(
        r#"
class Config
...
#[test]
fn pattern_nested_hash_and_array() {
    compile_ok(
        r#"
...
// ── else branch ───────────────────────────────────────────────
#[test]
fn pattern_with_else_fallthrough() {
    compile_ok(
        r#"
case { type: :unknown }
in { type: :click }
...
#[test]
fn rightward_assignment_stores_match() {
    compile_ok(
        r#"
