...
ruby_test!(test_if_elsif, "if false; puts 1; elsif true; puts 2; else; puts 3; end", "2");
ruby_test!(test_if_modifier, "puts 1 if true", "1");
ruby_test!(test_if_modifier_false, "puts 1 if false", "");
ruby_test!(test_unless_basic, "unless false; puts 1; else; puts 2; end", "1");
ruby_test!(test_unless_else, "unless true; puts 1; else; puts 2; end", "2");
