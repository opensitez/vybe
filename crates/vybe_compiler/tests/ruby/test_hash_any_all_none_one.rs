...
ruby_test!(
    test_any_block,
    "puts ({a: 1, b: 2}.any? {|k, v| v > 1})",
    "true"
);
ruby_test!(
    test_any_block_false,
    "puts ({a: 1, b: 2}.any? {|k, v| v > 5})",
    "false"
);
ruby_test!(
    test_any_argument,
    "puts ({a: 1, b: 2}.any?([:a, 1]))",
    "true"
); // argument matches pair
ruby_test!(
    test_any_argument_false,
    "puts ({a: 1, b: 2}.any?([:a, 2]))",
    "false"
);
...
ruby_test!(
    test_all_block,
    "puts ({a: 1, b: 2}.all? {|k, v| v > 0})",
    "true"
);
ruby_test!(
    test_all_block_false,
    "puts ({a: 1, b: 2}.all? {|k, v| v > 1})",
    "false"
);
...
ruby_test!(
    test_none_block,
    "puts ({a: 1, b: 2}.none? {|k, v| v > 5})",
    "true"
);
ruby_test!(
    test_none_block_false,
    "puts ({a: 1, b: 2}.none? {|k, v| v > 1})",
    "false"
);
...
ruby_test!(
    test_one_block,
    "puts ({a: 1, b: 2}.one? {|k, v| v > 1})",
    "true"
);
ruby_test!(
    test_one_block_false,
    "puts ({a: 1, b: 2}.one? {|k, v| v > 0})",
    "false"
);
