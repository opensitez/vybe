...
// ── puts variants ────────────────────────────────────────────
#[test]
fn puts_multiple_args_each_on_line() {
    let out = run_ruby("puts 1, 2, 3\n");
    assert_eq!(out, vec!["1", "2", "3"]);
}

#[test]
fn puts_array_expands_each_element() {
    let out = run_ruby("puts [10, 20, 30]\n");
    assert_eq!(out, vec!["10", "20", "30"]);
}

#[test]
fn puts_nil_prints_blank_line() {
    compile_ok(
        r#"
puts nil
"#,
...
#[test]
fn print_multiple_args_concatenated() {
    compile_ok(
        r#"
print "a", "b", "c"
puts ""
...
// ── pp ────────────────────────────────────────────────────────
#[test]
fn pp_prints_pretty_inspection() {
    compile_ok(
        r#"
