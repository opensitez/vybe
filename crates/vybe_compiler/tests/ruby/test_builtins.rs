...
#[test]
fn puts_str() {
    compile_ok("puts 'hello'\n");
}
#[test]
fn print_str() {
    compile_ok("print 'hello'\n");
}
#[test]
fn p_value() {
    compile_ok("p 42\n");
...
#[test]
fn str_length() {
    compile_ok("x = 'hello'.length\n");
}
#[test]
fn str_upcase() {
    compile_ok("x = 'hello'.upcase\n");
}
#[test]
fn str_downcase() {
    compile_ok("x = 'HELLO'.downcase\n");
}
#[test]
fn str_strip() {
...
#[test]
fn str_reverse() {
    compile_ok("x = 'hello'.reverse\n");
}
#[test]
fn str_include() {
    compile_ok("x = 'hello'.include?('ell')\n");
}
#[test]
fn str_gsub() {
    compile_ok("x = 'hello'.gsub('l', 'r')\n");
}
#[test]
fn str_sub() {
    compile_ok("x = 'hello'.sub('l', 'r')\n");
}
#[test]
fn str_capitalize() {
...
#[test]
fn str_start_with() {
    compile_ok("x = 'hello'.start_with?('he')\n");
}
#[test]
fn str_end_with() {
    compile_ok("x = 'hello'.end_with?('lo')\n");
}
#[test]
fn str_chars() {
    compile_ok("x = 'hello'.chars\n");
}
...
#[test]
fn arr_negative_index() {
    assert_eq!(run_ruby_one("a = [1, 2, 3]\nputs a[-1]\n"), "3");
}
#[test]
fn arr_negative_index_mid() {
    assert_eq!(run_ruby_one("a = [10, 20, 30, 40]\nputs a[-2]\n"), "30");
}
#[test]
fn str_negative_index() {
...
#[test]
fn arr_first() {
    compile_ok("x = [1, 2, 3].first\n");
}
#[test]
fn arr_last() {
    compile_ok("x = [1, 2, 3].last\n");
}
#[test]
fn arr_flatten() {
    compile_ok("x = [[1, 2], [3]].flatten\n");
}
#[test]
fn arr_sort() {
    compile_ok("x = [3, 1, 2].sort\n");
}
#[test]
fn arr_uniq() {
    compile_ok("x = [1, 1, 2].uniq\n");
}
#[test]
fn arr_compact() {
    compile_ok("x = [1, nil, 2].compact\n");
}
#[test]
fn arr_min() {
    compile_ok("x = [3, 1, 2].min\n");
}
#[test]
fn arr_max() {
    compile_ok("x = [3, 1, 2].max\n");
}
#[test]
fn arr_sum() {
    compile_ok("x = [1, 2, 3].sum\n");
}
#[test]
fn arr_count() {
...
fn arr_shuffle_preserves_count() {
    assert_eq!(
        run_ruby_one("a = [1,2,3,4,5]\na.shuffle\nputs a.length\n"),
        "5"
    );
}
#[test]
fn arr_join() {
    compile_ok("x = [1, 2, 3].join(',')\n");
}
#[test]
fn arr_each() {
...
#[test]
fn arr_map() {
    compile_ok("x = [1, 2, 3].map { |x| x * 2 }\n");
}
#[test]
fn arr_select() {
    compile_ok("x = [1, 2, 3, 4].select { |x| x > 2 }\n");
}
#[test]
fn arr_reject() {
    compile_ok("x = [1, 2, 3].reject { |x| x == 2 }\n");
}
#[test]
fn arr_reduce() {
    compile_ok("x = [1, 2, 3].reduce(0) { |sum, x| sum + x }\n");
}
...
#[test]
fn to_s() {
    compile_ok("x = 42.to_s\n");
}
#[test]
fn to_i() {
    compile_ok("x = '42'.to_i\n");
}
#[test]
fn to_f() {
    compile_ok("x = '3.14'.to_f\n");
}
#[test]
fn to_a() {
    compile_ok("x = (1..3).to_a\n");
}
...
#[test]
fn math_sqrt() {
    compile_ok("x = Math.sqrt(16)\n");
}
#[test]
fn math_pi() {
    compile_ok("x = Math::PI\n");
}
