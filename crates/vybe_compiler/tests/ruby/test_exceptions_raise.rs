...
ruby_test!(
    test_raise_no_args,
    "begin; raise; rescue => e; puts e.class.name; end",
    "RuntimeError"
); // raise without args raises RuntimeError or current exception
ruby_test!(
    test_raise_class,
...
ruby_test!(
    ...
    "err1"
); // raise inside rescue re-raises
ruby_test!(
    test_fail_alias,
    "begin; fail 'err'; rescue => e; puts e.message; end",
    "err"
); // fail is alias for raise
