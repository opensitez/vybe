...
// ── Struct.members ────────────────────────────────────────────
#[test]
fn struct_members_returns_array() {
    compile_ok(
        r#"
...
#[test]
fn struct_as_immutable_value_object() {
    compile_ok(
        r#"
...
#[test]
fn struct_array_sort_by_member() {
    compile_ok(
        r#"
...
#[test]
fn struct_instance_is_a_struct() {
    compile_ok(
        r#"
...
// ── Struct enumerable ─────────────────────────────────────────
#[test]
fn struct_each_iterates_values() {
    compile_ok(
        r#"
...
#[test]
fn struct_map_transforms_values() {
    compile_ok(
        r#"
Pair = Struct.new(:a, :b)
p = Pair.new(3, 4)
...
#[test]
fn struct_deconstruct_to_array() {
    compile_ok(
        r#"
...
#[test]
fn struct_deconstruct_keys_to_hash() {
    compile_ok(
        r#"
Point3D = Struct.new(:x, :y, :z)
pt = Point3D.new(1, 2, 3)
...
// ── Struct inheritance ────────────────────────────────────────
#[test]
fn struct_subclass_adds_methods() {
    compile_ok(
        r#"
...
#[test]
fn struct_responds_to_member_methods() {
    compile_ok(
        r#"
