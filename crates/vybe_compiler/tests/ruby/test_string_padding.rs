...
ruby_test!(
    test_padding_center_char,
    "puts 'abc'.center(5, '*')",
    "*abc*"
);
ruby_test!(
    test_padding_center_even,
    "puts 'abc'.center(6, '*')",
    "*abc**"
); // Right gets extra if padding is odd
ruby_test!(
    test_padding_center_multi,
    "puts 'abc'.center(7, 'xy')",
    "xyabcxy"
);
