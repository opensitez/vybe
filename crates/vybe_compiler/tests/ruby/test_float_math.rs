...
ruby_test!(
    test_float_math_finite_infinity,
    "puts Float::INFINITY.finite?",
    "false"
);
ruby_test!(
    test_float_math_infinite,
    "puts Float::INFINITY.infinite?",
    "1"
);
ruby_test!(
    test_float_math_infinite_negative,
    "puts (-Float::INFINITY).infinite?",
    "-1"
);
