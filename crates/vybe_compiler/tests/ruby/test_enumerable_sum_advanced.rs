...
ruby_test!(test_sum_block_init, "puts [1, 2, 3].sum(10) {|x| x * 2}", "22");
ruby_test!(test_sum_strings_error, "begin; ['a', 'b'].sum; rescue TypeError; puts 'err'; end", "err"); // must supply init for strings
