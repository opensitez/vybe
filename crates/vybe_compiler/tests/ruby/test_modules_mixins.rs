...
// ── module include ────────────────────────────────────────────
#[test] fn module_include_adds_instance_methods() { compile_ok(r#"
module Greetable
...
#[test] fn module_include_multiple() { compile_ok(r#"
module Swimmable
...
// ── module extend ─────────────────────────────────────────────
#[test] fn module_extend_adds_class_methods() { compile_ok(r#"
module ClassMethods
...
#[test] fn object_extend_adds_singleton_methods() { compile_ok(r#"
module Debuggable
...
// ── module_function ───────────────────────────────────────────
#[test] fn module_function_callable_as_module_method() { compile_ok(r#"
module MathUtils
  module_function
...
// ── module constants ──────────────────────────────────────────
#[test] fn module_constant_access() { compile_ok(r#"
module Config
  VERSION = "1.0.0"
  MAX_RETRIES = 3
end
...
#[test] fn nested_module_constant() { compile_ok(r#"
module Outer
  module Inner
    VALUE = 42
  end
...
// ── ancestors chain ───────────────────────────────────────────
#[test] fn ancestors_includes_modules() { compile_ok(r#"
...
// ── prepend ───────────────────────────────────────────────────
#[test] fn prepend_intercepts_method() { compile_ok(r#"
module Logging
  def compute(x)
    result = super
    result
...
#[test] fn mixin_instance_and_class_methods() { compile_ok(r#"
module Persistable
...
#[test] fn module_as_namespace_for_classes() { compile_ok(r#"
module Animals
  class Dog
    def speak; "woof"; end
  end
...
// ── Comparable mixin ──────────────────────────────────────────
#[test] fn comparable_mixin_provides_operators() { compile_ok(r#"
class Box
  include Comparable
  attr_reader :volume
...
// ── Enumerable mixin ──────────────────────────────────────────
#[test] fn enumerable_mixin_provides_reduce() { compile_ok(r#"
class NumberSet
  include Enumerable
...
#[test] fn enumerable_mixin_provides_sort() { compile_ok(r#"
class NameList
  include Enumerable
...
// ── Forwardable ───────────────────────────────────────────────
#[test] fn forwardable_delegates_methods() { compile_ok(r#"
require 'forwardable'
class Stack
  extend Forwardable
...
// ── module reopening ──────────────────────────────────────────
#[test] fn module_can_be_reopened_and_extended() { compile_ok(r#"
module Formatter
...
// ── included hook ─────────────────────────────────────────────
#[test] fn included_callback_fires_on_include() { compile_ok(r#"
module Hookable
  def self.included(base)
...
#[test] fn module_instance_methods_list() { compile_ok(r#"
module Tools
  def hammer; "bang"; end
...
#[test] fn mixin_default_implementation_overridable() { compile_ok(r#"
module Printable
...
#[test] fn method_resolution_order_left_to_right() { compile_ok(r#"
module A
  def hello; "A"; end
end
module B
...
#[test] fn extend_on_specific_instance() { compile_ok(r#"
module Serializable
...
#[test] fn module_defines_attr_accessor_for_includers() { compile_ok(r#"
module HasName
  attr_accessor :name
end
class Product
...
#[test] fn module_include_chain_calls_super() { compile_ok(r#"
module Base
  def info; "base"; end
end
module Derived
