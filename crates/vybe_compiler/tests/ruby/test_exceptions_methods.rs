...
ruby_test!(
    test_exception_to_s,
    "begin; raise 'err'; rescue => e; puts e.to_s; end",
    "err"
);
ruby_test!(
...
ruby_test!(
    test_exception_cause_nil,
    "begin; raise 'err'; rescue => e; puts e.cause.nil?; end",
    "true"
);
ruby_test!(
    test_exception_cause_chained,
    "begin; begin; raise 'err1'; rescue; raise 'err2'; end; rescue => e; puts e.cause.message; end",
    "err1"
);
ruby_test!(
    test_exception_full_message,
