...
fn memory_init_creates_new_memory() {
    ...
    chunk.emit_op_u16(Op::r#const, pages, 0);
...
fn multiple_memories_independent() {
    ...
    chunk.emit_op_u16(Op::r#const, addr, 0);
    chunk.emit_op_u16(Op::r#const, val42, 0);
    chunk.emit_op(Op::i32_store, 0);
...
fn memory_copy_cross_between_memories() {
    ...
    chunk.emit_op_u16(Op::r#const, mem1, 0);   // dst_mem = 1
    chunk.emit_op_u16(Op::r#const, zero, 0);   // dst_addr = 0
    chunk.emit_op_u16(Op::r#const, mem0, 0);   // src_mem = 0
    chunk.emit_op_u16(Op::r#const, zero, 0);   // src_addr = 0
    chunk.emit_op_u16(Op::r#const, four, 0);   // len = 4
