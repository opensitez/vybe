...
#[test]
fn string_concat() {
    assert_eq!(run_csharp_one(r#"Console.WriteLine("hello" + " " + "world");"#), "hello world");
}
...
fn ternary_expression() {
    assert_eq!(run_csharp_one("Console.WriteLine(5 > 3 ? \"yes\" : \"no\");"), "yes");
}

#[test]
fn null_coalescing() {
    assert_eq!(run_csharp_one(r#"string s = null; Console.WriteLine(s ?? "default");"#), "default");
}
