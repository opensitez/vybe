...
#[test] fn try_catch_with_variable() {
    assert_eq!(run_csharp(r#"
try {
...
#[test] fn try_finally_always_runs() {
    assert_eq!(run_csharp(r#"
try {
...
#[test] fn try_catch_finally_together() {
    assert_eq!(run_csharp(r#"
try {
...
#[test] fn catch_finally_on_error() {
    assert_eq!(run_csharp(r#"
string result = "start";
try {
    int x = 10 / 0;
...
#[test] fn catch_hierarchy_most_specific_first() {
    assert_eq!(run_csharp(r#"
try {
...
#[test] fn catch_when_filter_fallthrough() {
    assert_eq!(run_csharp(r#"
try {
...
#[test] fn nested_try_inner_uncaught_propagates() {
    assert_eq!(run_csharp(r#"
try {
    try {
...
#[test] fn using_disposes_on_exception() {
    assert_eq!(run_csharp(r#"
...
#[test] fn exception_message_property() {
    assert_eq!(run_csharp(r#"
try {
...
#[test] fn argument_null_exception() {
    assert_eq!(run_csharp(r#"
try {
...
#[test] fn argument_out_of_range_exception() {
    assert_eq!(run_csharp(r#"
try {
