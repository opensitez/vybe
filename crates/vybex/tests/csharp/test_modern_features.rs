...
#[test] fn record_with_expression() {
    assert_eq!(run_csharp(r#"
record Person(string Name, int Age);
...
#[test] fn switch_expression_basic() {
    assert_eq!(run_csharp(r#"
int day = 3;
...
#[test] fn switch_expression_type_pattern() {
    assert_eq!(run_csharp(r#"
object obj = 42;
...
#[test] fn switch_expression_when_guard() {
    assert_eq!(run_csharp(r#"
int score = 85;
...
#[test] fn tuple_return_from_method() {
    assert_eq!(run_csharp(r#"
class MathOps {
...
#[test] fn null_coalescing_operator() {
    assert_eq!(run_csharp(r#"
string s = null;
...
#[test] fn null_coalescing_assignment() {
    assert_eq!(run_csharp(r#"
string s = null;
s ??= "assigned";
Console.WriteLine(s);
...
#[test] fn null_conditional_operator() {
    assert_eq!(run_csharp(r#"
string s = null;
...
#[test] fn null_conditional_chain() {
    assert_eq!(run_csharp(r#"
...
#[test] fn expression_bodied_method_and_property() {
    assert_eq!(run_csharp(r#"
class Circle {
