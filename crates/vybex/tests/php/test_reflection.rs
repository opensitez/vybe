...
#[test] fn reflection_class_methods() {
    compile_ok(r#"<?php
class Calculator {
...
#[test] fn reflection_class_properties() {
    compile_ok(r#"<?php
class User {
    public string $name;
    protected int $age;
...
#[test] fn reflection_class_constants() {
    compile_ok(r#"<?php
class Status {
    const OK      = 200;
    const CREATED = 201;
...
#[test] fn reflection_class_interfaces() {
    compile_ok(r#"<?php
...
#[test] fn reflection_class_is_abstract() {
    compile_ok(r#"<?php
abstract class Base {}
...
#[test] fn reflection_class_is_interface() {
    compile_ok(r#"<?php
...
#[test] fn reflection_class_parent() {
    compile_ok(r#"<?php
class Animal {}
...
#[test] fn reflection_class_instantiate() {
    compile_ok(r#"<?php
...
#[test] fn reflection_class_new_instance_without_constructor() {
    compile_ok(r#"<?php
...
#[test] fn reflection_method_name_and_visibility() {
    compile_ok(r#"<?php
class Service {
...
#[test] fn reflection_method_parameters() {
    compile_ok(r#"<?php
...
#[test] fn reflection_method_invoke() {
    compile_ok(r#"<?php
...
#[test] fn reflection_method_is_static() {
    compile_ok(r#"<?php
class Factory {
...
#[test] fn reflection_property_get_set() {
    compile_ok(r#"<?php
...
#[test] fn reflection_property_type() {
    compile_ok(r#"<?php
class TypedProps {
    public int $count = 0;
...
#[test] fn reflection_function_basic() {
    compile_ok(r#"<?php
...
#[test] fn reflection_function_closure() {
    compile_ok(r#"<?php
...
#[test] fn reflection_parameter_details() {
    compile_ok(r#"<?php
...
#[test] fn reflection_parameter_variadic() {
    compile_ok(r#"<?php
...
#[test] fn reflection_backed_enum() {
    compile_ok(r#"<?php
...
#[test] fn reflection_class_traits() {
    compile_ok(r#"<?php
...
#[test] fn reflection_has_method_property() {
    compile_ok(r#"<?php
...
#[test] fn reflection_doc_comment() {
    compile_ok(r#"<?php
