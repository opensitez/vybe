...
#[test] fn namespace_magic_constant() {
    compile_ok(r#"<?php
...
#[test] fn namespace_magic_in_function() {
    compile_ok(r#"<?php
namespace App\Core;
...
#[test] fn global_namespace_backslash() {
    compile_ok(r#"<?php
namespace App;
$len = \strlen("hello");
echo $len;
...
#[test] fn global_namespace_class() {
    compile_ok(r#"<?php
namespace App;
...
#[test] fn namespace_abstract_class() {
    compile_ok(r#"<?php
namespace Base;
...
#[test] fn multiple_namespaces_one_file() {
    compile_ok(r#"<?php
namespace Alpha;
...
#[test] fn namespace_same_class_name_different_ns() {
    compile_ok(r#"<?php
namespace V1;
...
#[test] fn namespace_fully_qualified_call() {
    compile_ok(r#"<?php
namespace Helpers;
