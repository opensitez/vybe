...
#[test] fn ob_nested_three_levels() {
    compile_ok(r#"<?php
ob_start();
    echo "L1";
    ob_start();
...
#[test] fn ob_start_with_callback() {
    compile_ok(r#"<?php
