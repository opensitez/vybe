...
#[test] fn property_hook_get_basic() {
    compile_ok(r#"<?php
class Temperature {
...
#[test] fn property_hook_set_validation() {
    compile_ok(r#"<?php
class User {
    public string $email {
        set(string $value) {
...
#[test] fn property_hook_computed() {
    compile_ok(r#"<?php
class Circle {
...
#[test] fn property_hook_with_backing() {
    compile_ok(r#"<?php
class Product {
...
#[test] fn property_hook_inherited() {
    compile_ok(r#"<?php
class Base {
    public int $value {
...
#[test] fn asymmetric_visibility_public_private_set() {
    compile_ok(r#"<?php
class Counter {
...
#[test] fn asymmetric_visibility_public_protected_set() {
    compile_ok(r#"<?php
class Entity {
...
#[test] fn asymmetric_visibility_readonly_like() {
    compile_ok(r#"<?php
class Config {
...
#[test] fn deprecated_attribute_function() {
    compile_ok(r#"<?php
...
#[test] fn deprecated_attribute_method() {
    compile_ok(r#"<?php
class Api {
...
#[test] fn new_in_const_initializer() {
    compile_ok(r#"<?php
class Config {
...
#[test] fn null_as_standalone_type() {
    compile_ok(r#"<?php
...
#[test] fn typed_class_constants_interface() {
    compile_ok(r#"<?php
...
#[test] fn dynamic_class_const_fetch() {
    compile_ok(r#"<?php
class HttpStatus {
    const OK       = 200;
    const NOT_FOUND = 404;
