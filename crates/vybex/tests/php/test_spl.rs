...
#[test] fn spl_queue_dequeue_order() {
    compile_ok(r#"<?php
$q = new SplQueue();
...
#[test] fn spl_fixed_array_from_array() {
    compile_ok(r#"<?php
...
#[test] fn spl_fixed_array_iterate() {
    compile_ok(r#"<?php
...
#[test] fn spl_fixed_array_resize() {
    compile_ok(r#"<?php
...
#[test] fn spl_priority_queue_basic() {
    compile_ok(r#"<?php
...
#[test] fn spl_priority_queue_count() {
    compile_ok(r#"<?php
$pq = new SplPriorityQueue();
$pq->insert('a', 1);
$pq->insert('b', 2);
...
#[test] fn array_object_getarraycopy() {
    compile_ok(r#"<?php
...
#[test] fn array_object_offsetexists() {
    compile_ok(r#"<?php
...
#[test] fn array_iterator_sort_flags() {
    compile_ok(r#"<?php
...
#[test] fn spl_object_storage_basic() {
    compile_ok(r#"<?php
...
#[test] fn spl_object_storage_contains() {
    compile_ok(r#"<?php
$store = new SplObjectStorage();
$obj = new stdClass();
...
#[test] fn spl_object_storage_detach() {
    compile_ok(r#"<?php
$store = new SplObjectStorage();
$a = new stdClass();
$b = new stdClass();
...
#[test] fn spl_object_storage_iterate() {
    compile_ok(r#"<?php
$store = new SplObjectStorage();
for ($i = 0; $i < 3; $i++) {
    $obj = new stdClass();
