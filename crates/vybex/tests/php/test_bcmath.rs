...
#[test] fn bcmul_decimal_precision() {
    compile_ok(r#"<?php
echo bcmul('1.23456', '9.87654', 5);
"#);
}

#[test] fn bcmul_by_zero() {
    compile_ok(r#"<?php
...
#[test] fn bcpow_large_exponent() {
    compile_ok(r#"<?php
echo bcpow('2', '64');
"#);
}

#[test] fn bcpow_decimal_base() {
    compile_ok(r#"<?php
echo bcpow('1.05', '12', 4);
"#);
}

#[test] fn bcpow_zero_exponent() {
    compile_ok(r#"<?php
echo bcpow('999', '0');
"#);
}
...
#[test] fn bcmath_financial_calculation() {
    compile_ok(r#"<?php
...
#[test] fn bcmath_factorial_large() {
    compile_ok(r#"<?php
...
#[test] fn bcmath_currency_rounding() {
    compile_ok(r#"<?php
...
#[test] fn bcmath_power_of_two_sequence() {
    compile_ok(r#"<?php
$result = [];
for ($i = 0; $i <= 10; $i++) {
