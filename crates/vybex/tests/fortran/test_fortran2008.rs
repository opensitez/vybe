...
#[test] fn impure_elemental_basic() {
    compile_ok(r#"
program test
    integer :: a(3) = [1, 2, 3]
    call print_elem(a)
...
#[test] fn impure_elemental_function() {
    compile_ok(r#"
program test
    integer :: a(3) = [1, 2, 3]
    integer :: b(3)
...
#[test] fn module_default_private() {
    compile_ok(r#"
module strict_mod
    implicit none
    private
