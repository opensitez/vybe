...
#[test] fn class_empty()       { compile_ok("class Foo\nend\n"); }
#[test] fn class_initialize()  { compile_ok("class Dog\n  def initialize(name)\n    @name = name\n  end\nend\n"); }
#[test] fn class_method()      { compile_ok("class Dog\n  def bark\n    puts 'woof'\n  end\nend\n"); }
#[test] fn class_inherit()     { compile_ok("class Animal\nend\nclass Dog < Animal\nend\n"); }
#[test] fn class_attr_reader() { compile_ok("class Dog\n  attr_reader :name\n  def initialize(name)\n    @name = name\n  end\nend\n"); }
#[test] fn class_attr_writer() { compile_ok("class Dog\n  attr_writer :name\nend\n"); }
#[test] fn class_attr_accessor() { compile_ok("class Dog\n  attr_accessor :name, :age\nend\n"); }
#[test] fn class_self_method() { compile_ok("class Util\n  def self.hello\n    puts 'hi'\n  end\nend\n"); }
#[test] fn class_class_var()   { compile_ok("class Counter\n  @@count = 0\n  def initialize\n    @@count += 1\n  end\nend\n"); }
#[test] fn class_super()       { compile_ok("class Animal\n  def speak\n    'generic'\n  end\nend\nclass Dog < Animal\n  def speak\n    super\n  end\nend\n"); }
